...
package zipcar_marketingdw.processstaging_strongviewconvdata_0_1;
...
/**
 * Job: ProcessStaging_StrongviewConvData Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_StrongviewConvData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_StrongviewConvData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("__-v1gMr9EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_StrongviewConvData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_StrongviewConvData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewConvData) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "strongview_conv_data";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_strongview_conv_data";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_strongview_conv_data\n(\n	data_captured_dt,\n	track_event_type,\n	differentiator,\n	source_ip,\n	serial_number,\n	mailing_id,\n	target_id,\n	template_id,\n	user_id,\n	email_address,\n	link_id,\n	extra,\n	conversion_tag,\n	conversion_value,\n	conversion_item,\n    imported_date\n)\nSELECT \n	data_captured_dt,\n	track_event_type,\n	differentiator,\n	source_ip,\n	serial_number,\n	mailing_id,\n	target_id,\n	template_id,\n	user_id,\n	email_address,\n	link_id,\n	extra,\n	conversion_tag,\n	conversion_value,\n	conversion_item,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.strongview_conv_data\nMINUS\nSELECT \n	data_captured_dt,\n	track_event_type,\n	differentiator,\n	source_ip,\n	serial_number,\n	mailing_id,\n	target_id,\n	template_id,\n	user_id,\n	email_address,\n	link_id,\n	extra,\n	conversion_tag,\n	conversion_value,\n	conversion_item,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_strongview_conv_data\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".strongview_conv_data";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_StrongviewConvData ProcessStaging_StrongviewConvDataClass = new ProcessStaging_StrongviewConvData();

        int exitCode = ProcessStaging_StrongviewConvDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_StrongviewConvData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_strongviewconvdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_StrongviewConvData");
        }
...
/************************************************************************************************
 *     136443 characters generated by Talend Open Studio for Data Integration 
