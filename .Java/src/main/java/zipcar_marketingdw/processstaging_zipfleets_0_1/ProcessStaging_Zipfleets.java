...
package zipcar_marketingdw.processstaging_zipfleets_0_1;
...
/**
 * Job: ProcessStaging_Zipfleets Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Zipfleets implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Zipfleets";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_YO-GUDWcEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Zipfleets.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Zipfleets.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Zipfleets) {
...
"\nINSERT INTO {{marketing.schema}}.r_zipfleet\n(\n    zipfleet_id,\n    fleet_name,\n    latitude,\n    longitude,\n    timezone_region,\n    locale,\n    country_iso,\n    university_p,\n    rollup_name,\n    rollup_path,\n    level_3_key,\n    level_4_key,\n    level_5_key,\n	level_3_id,\n	level_4_id,\n	level_5_id,\n	default_currency_iso,\n	rollup_sort,\n	fleet_market_name,\n	fleet_country_name,\n    imported_date\n)\nSELECT \n    zipfleet_id,\n    fleet_name,\n    latitude,\n    longitude,\n    timezone_region,\n    locale,\n    country_iso,\n    university_p,\n    rollup_name,\n    rollup_path,\n    level_3_key,\n    level_4_key,\n    level_5_key,\n	level_3_id,\n	level_4_id,\n	level_5_id,\n	default_currency_iso,\n	rollup_sort,\n	fleet_market_name,\n	fleet_country_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.zipfleets\nMINUS\nSELECT \n    zipfleet_id,\n    fleet_name,\n    latitude,\n    longitude,\n    timezone_region,\n    locale,\n    country_iso,\n    university_p,\n    rollup_name,\n    rollup_path,\n    level_3_key,\n    level_4_key,\n    level_5_key,\n	level_3_id,\n	level_4_id,\n	level_5_id,\n	default_currency_iso,\n	rollup_sort,\n	fleet_market_name,\n	fleet_country_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_zipfleet\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".zipfleets";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Zipfleets ProcessStaging_ZipfleetsClass = new ProcessStaging_Zipfleets();

        int exitCode = ProcessStaging_ZipfleetsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Zipfleets.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_zipfleets_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Zipfleets");
        }
...
/************************************************************************************************
 *     136421 characters generated by Talend Open Studio for Data Integration 
