...
package zipcar_marketingdw.stagefeed_waiverplans_0_1;
...
/**
 * Job: StageFeed_WaiverPlans Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_WaiverPlans implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_WaiverPlans";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_VW-foMu0EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_WaiverPlans.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_WaiverPlans.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.WAIVER_PLANS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.WAIVER_PLANS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.WAIVER_PLANS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WaiverPlans = new byte[0];
			    ...
			    public Long WAIVER_PLAN_CLASS_ID;

				public Long getWAIVER_PLAN_CLASS_ID () {
					return this.WAIVER_PLAN_CLASS_ID;
				}
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.WAIVER_PLAN_ID = dis.readLong();
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.WAIVER_PLAN_CLASS_ID = null;
           				} else {
           			    	this.WAIVER_PLAN_CLASS_ID = dis.readLong();
           				}
					...
					this.PRO_RATE_P = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.DEDUCTIBLE = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.WAIVER_PLAN_CLASS_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.WAIVER_PLAN_CLASS_ID);
		            	}
					...
					// Double
						...
						if(this.DEDUCTIBLE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.DEDUCTIBLE);
		            	}
    ...
    public String toString() {
		...
		sb.append(",WAIVER_PLAN_CLASS_ID="+String.valueOf(WAIVER_PLAN_CLASS_ID));
		sb.append(",NAME="+NAME);
		sb.append(",PUBLIC_NAME="+PUBLIC_NAME);
		sb.append(",PLAN_KEY="+PLAN_KEY);
		sb.append(",DESCRIPTION="+DESCRIPTION);
		sb.append(",FREQUENCY="+FREQUENCY);
		sb.append(",FEE="+String.valueOf(FEE));
		sb.append(",PRO_RATE_P="+PRO_RATE_P);
		sb.append(",DEDUCTIBLE="+String.valueOf(DEDUCTIBLE));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(long WAIVER_PLAN_ID){
							this.WAIVER_PLAN_ID = WAIVER_PLAN_ID;
							return this;
						}				
						Long WAIVER_PLAN_CLASS_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c1(Long WAIVER_PLAN_CLASS_ID){
							this.WAIVER_PLAN_CLASS_ID = WAIVER_PLAN_CLASS_ID;
							return this;
						}				
						String NAME;
	            		...
	            		public BufferLine_tRedshiftOutput_1 c3(String PUBLIC_NAME){
							this.PUBLIC_NAME = PUBLIC_NAME;
							return this;
						}				
						String PLAN_KEY;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String PLAN_KEY){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c6(String FREQUENCY){
							this.FREQUENCY = FREQUENCY;
							return this;
						}				
						Double FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Double FEE){
							this.FEE = FEE;
							return this;
						}				
						String PRO_RATE_P;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String PRO_RATE_P){
							this.PRO_RATE_P = PRO_RATE_P;
							return this;
						}				
						Double DEDUCTIBLE;
						
	            		public BufferLine_tRedshiftOutput_1 c9(Double DEDUCTIBLE){
							this.DEDUCTIBLE = DEDUCTIBLE;
							return this;
						}				
						String ACTIVE_P;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String ACTIVE_P){
							this.ACTIVE_P = ACTIVE_P;
							return this;
						}				
						String PUBLIC_P;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String PUBLIC_P){
							this.PUBLIC_P = PUBLIC_P;
							return this;
						}				
						String CORPORATE_P;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String CORPORATE_P){
							this.CORPORATE_P = CORPORATE_P;
							return this;
						}				
						String AUTORENEW_P;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String AUTORENEW_P){
							this.AUTORENEW_P = AUTORENEW_P;
							return this;
						}				
						String OPERATION;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String OPERATION){
							this.OPERATION = OPERATION;
							return this;
						}				
						Long RISK_TIER_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Long RISK_TIER_ID){
							this.RISK_TIER_ID = RISK_TIER_ID;
							return this;
						}				
						String CHARGE_MODEL;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String CHARGE_MODEL){
							this.CHARGE_MODEL = CHARGE_MODEL;
							return this;
						}				
						Long ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c17(Long ZIPFLEET_ID){
							this.ZIPFLEET_ID = ZIPFLEET_ID;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c18(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c19(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c20(java.util.Date DELETED_DATE){
							this.DELETED_DATE = DELETED_DATE;
							return this;
						}				
						String NEW_PLAN_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c21(String NEW_PLAN_NAME){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"WAIVER_PLAN_ID\",\"WAIVER_PLAN_CLASS_ID\",\"NAME\",\"PUBLIC_NAME\",\"PLAN_KEY\",\"DESCRIPTION\",\"FREQUENCY\",\"FEE\",\"PRO_RATE_P\",\"DEDUCTIBLE\",\"ACTIVE_P\",\"PUBLIC_P\",\"CORPORATE_P\",\"AUTORENEW_P\",\"OPERATION\",\"RISK_TIER_ID\",\"CHARGE_MODEL\",\"ZIPFLEET_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"NEW_PLAN_NAME\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.WAIVER_PLAN_ID = 0;
					
							Row_FeedRecord.WAIVER_PLAN_CLASS_ID = null;
					
							Row_FeedRecord.NAME = null;
					
							Row_FeedRecord.PUBLIC_NAME = null;
					
							Row_FeedRecord.PLAN_KEY = null;
					
							Row_FeedRecord.DESCRIPTION = null;
					
							Row_FeedRecord.FREQUENCY = null;
					
							Row_FeedRecord.FEE = null;
					
							Row_FeedRecord.PRO_RATE_P = null;
					
							Row_FeedRecord.DEDUCTIBLE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.WAIVER_PLAN_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'WAIVER_PLAN_ID' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.WAIVER_PLAN_CLASS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PUBLIC_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PLAN_KEY = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.FREQUENCY = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.DEDUCTIBLE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.WAIVER_PLAN_CLASS_ID = Row_FeedRecord.WAIVER_PLAN_CLASS_ID;
Record_OutputToDB.NAME = StringUtils.trimToNull(Row_FeedRecord.NAME);
Record_OutputToDB.PUBLIC_NAME = StringUtils.trimToNull(Row_FeedRecord.PUBLIC_NAME);
Record_OutputToDB.PLAN_KEY = StringUtils.trimToNull(Row_FeedRecord.PLAN_KEY);
Record_OutputToDB.DESCRIPTION = StringUtils.trimToNull(Row_FeedRecord.DESCRIPTION);
Record_OutputToDB.FREQUENCY = StringUtils.trimToNull(Row_FeedRecord.FREQUENCY);
Record_OutputToDB.FEE = Row_FeedRecord.FEE;
Record_OutputToDB.PRO_RATE_P = BooleanUtils.boolChar(Row_FeedRecord.PRO_RATE_P);
Record_OutputToDB.DEDUCTIBLE = Row_FeedRecord.DEDUCTIBLE;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.WAIVER_PLAN_CLASS_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.WAIVER_PLAN_CLASS_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PUBLIC_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PUBLIC_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PLAN_KEY==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PLAN_KEY);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FREQUENCY==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.FREQUENCY);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FEE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.FEE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DEDUCTIBLE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.DEDUCTIBLE);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.WAIVER_PLAN_ID)
                        .c1(Record_OutputToDB.WAIVER_PLAN_CLASS_ID)
                        .c2(Record_OutputToDB.NAME)
                        .c3(Record_OutputToDB.PUBLIC_NAME)
                        .c4(Record_OutputToDB.PLAN_KEY)
                        .c5(Record_OutputToDB.DESCRIPTION)
                        .c6(Record_OutputToDB.FREQUENCY)
                        .c7(Record_OutputToDB.FEE)
                        .c8(Record_OutputToDB.PRO_RATE_P)
                        .c9(Record_OutputToDB.DEDUCTIBLE)
                        .c10(Record_OutputToDB.ACTIVE_P)
                        .c11(Record_OutputToDB.PUBLIC_P)
                        .c12(Record_OutputToDB.CORPORATE_P)
                        .c13(Record_OutputToDB.AUTORENEW_P)
                        .c14(Record_OutputToDB.OPERATION)
                        .c15(Record_OutputToDB.RISK_TIER_ID)
                        .c16(Record_OutputToDB.CHARGE_MODEL)
                        .c17(Record_OutputToDB.ZIPFLEET_ID)
                        .c18(Record_OutputToDB.CREATION_DATE)
                        .c19(Record_OutputToDB.LAST_MODIFIED)
                        .c20(Record_OutputToDB.DELETED_DATE)
                        .c21(Record_OutputToDB.NEW_PLAN_NAME)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.WAIVER_PLAN_CLASS_ID = Record_OutputToDB.WAIVER_PLAN_CLASS_ID;
                                After_Insert.NAME = Record_OutputToDB.NAME;
                                After_Insert.PUBLIC_NAME = Record_OutputToDB.PUBLIC_NAME;
                                After_Insert.PLAN_KEY = Record_OutputToDB.PLAN_KEY;
                                After_Insert.DESCRIPTION = Record_OutputToDB.DESCRIPTION;
                                After_Insert.FREQUENCY = Record_OutputToDB.FREQUENCY;
                                After_Insert.FEE = Record_OutputToDB.FEE;
                                After_Insert.PRO_RATE_P = Record_OutputToDB.PRO_RATE_P;
                                After_Insert.DEDUCTIBLE = Record_OutputToDB.DEDUCTIBLE;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.WAIVER_PLAN_CLASS_ID = After_Insert.WAIVER_PLAN_CLASS_ID;
               Log_Rows.NAME = After_Insert.NAME;
               Log_Rows.PUBLIC_NAME = After_Insert.PUBLIC_NAME;
               Log_Rows.PLAN_KEY = After_Insert.PLAN_KEY;
               Log_Rows.DESCRIPTION = After_Insert.DESCRIPTION;
               Log_Rows.FREQUENCY = After_Insert.FREQUENCY;
               Log_Rows.FEE = After_Insert.FEE;
               Log_Rows.PRO_RATE_P = After_Insert.PRO_RATE_P;
               Log_Rows.DEDUCTIBLE = After_Insert.DEDUCTIBLE;
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.WAIVER_PLAN_CLASS_ID==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.WAIVER_PLAN_CLASS_ID);
					...
					if(bufferLtRedshiftOutput_1.PUBLIC_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PUBLIC_NAME);
					...
					if(bufferLtRedshiftOutput_1.PLAN_KEY==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PLAN_KEY);
					...
					if(bufferLtRedshiftOutput_1.FREQUENCY==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FREQUENCY);
					...
					if(bufferLtRedshiftOutput_1.FEE==null){
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FEE);
					...
					if(bufferLtRedshiftOutput_1.DEDUCTIBLE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DEDUCTIBLE);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.WAIVER_PLAN_ID = 0;
					
							row1.WAIVER_PLAN_CLASS_ID = null;
					
							row1.NAME = null;
					
							row1.PUBLIC_NAME = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.WAIVER_PLAN_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'WAIVER_PLAN_ID' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.WAIVER_PLAN_CLASS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PUBLIC_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PLAN_KEY = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.FREQUENCY = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.DEDUCTIBLE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.WAIVER_PLAN_CLASS_ID = row1.WAIVER_PLAN_CLASS_ID;
row2.NAME = StringUtils.trimToNull(row1.NAME);
row2.PUBLIC_NAME = StringUtils.trimToNull(row1.PUBLIC_NAME);
row2.PLAN_KEY = StringUtils.trimToNull(row1.PLAN_KEY);
row2.DESCRIPTION = StringUtils.trimToNull(row1.DESCRIPTION);
row2.FREQUENCY = StringUtils.trimToNull(row1.FREQUENCY);
row2.FEE = row1.FEE;
row2.PRO_RATE_P = BooleanUtils.boolChar(row1.PRO_RATE_P);
row2.DEDUCTIBLE = row1.DEDUCTIBLE;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[22];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.WAIVER_PLAN_ID);
                            rowtFileOutputDelimited_1[1]=row2.WAIVER_PLAN_CLASS_ID == null ? null : String.valueOf(row2.WAIVER_PLAN_CLASS_ID);
                            rowtFileOutputDelimited_1[2]=row2.NAME == null ? null : row2.NAME;
                            rowtFileOutputDelimited_1[3]=row2.PUBLIC_NAME == null ? null : row2.PUBLIC_NAME;
                            rowtFileOutputDelimited_1[4]=row2.PLAN_KEY == null ? null : row2.PLAN_KEY;
                            rowtFileOutputDelimited_1[5]=row2.DESCRIPTION == null ? null : row2.DESCRIPTION;
                            rowtFileOutputDelimited_1[6]=row2.FREQUENCY == null ? null : row2.FREQUENCY;
                            rowtFileOutputDelimited_1[7]=row2.FEE == null ? null : String.valueOf(row2.FEE);
                            rowtFileOutputDelimited_1[8]=row2.PRO_RATE_P == null ? null : row2.PRO_RATE_P;
                            rowtFileOutputDelimited_1[9]=row2.DEDUCTIBLE == null ? null : String.valueOf(row2.DEDUCTIBLE);
                            rowtFileOutputDelimited_1[10]=row2.ACTIVE_P == null ? null : row2.ACTIVE_P;
                            rowtFileOutputDelimited_1[11]=row2.PUBLIC_P == null ? null : row2.PUBLIC_P;
                            rowtFileOutputDelimited_1[12]=row2.CORPORATE_P == null ? null : row2.CORPORATE_P;
                            rowtFileOutputDelimited_1[13]=row2.AUTORENEW_P == null ? null : row2.AUTORENEW_P;
                            rowtFileOutputDelimited_1[14]=row2.OPERATION == null ? null : row2.OPERATION;
                            rowtFileOutputDelimited_1[15]=row2.RISK_TIER_ID == null ? null : String.valueOf(row2.RISK_TIER_ID);
                            rowtFileOutputDelimited_1[16]=row2.CHARGE_MODEL == null ? null : row2.CHARGE_MODEL;
                            rowtFileOutputDelimited_1[17]=row2.ZIPFLEET_ID == null ? null : String.valueOf(row2.ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[18]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[19]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[20]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[21]=row2.NEW_PLAN_NAME == null ? null : row2.NEW_PLAN_NAME;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_WaiverPlans StageFeed_WaiverPlansClass = new StageFeed_WaiverPlans();

        int exitCode = StageFeed_WaiverPlansClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_WaiverPlans.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_waiverplans_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_WaiverPlans");
        }
...
/************************************************************************************************
 *     382744 characters generated by Talend Open Studio for Data Integration 
