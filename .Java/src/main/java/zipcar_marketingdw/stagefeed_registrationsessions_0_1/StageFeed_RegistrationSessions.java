...
package zipcar_marketingdw.stagefeed_registrationsessions_0_1;
...
/**
 * Job: StageFeed_RegistrationSessions Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_RegistrationSessions implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_RegistrationSessions";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_BZqdsMrlEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_RegistrationSessions.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_RegistrationSessions.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.REGISTRATION_SESSIONS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.REGISTRATION_SESSIONS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.REGISTRATION_SESSIONS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions = new byte[0];
				...
				public String getARCHIVAL_REASON () {
					return this.ARCHIVAL_REASON;
				}
			    ...
			    public Long PREFERRED_ZIPFLEET_ID;

				public Long getPREFERRED_ZIPFLEET_ID () {
					return this.PREFERRED_ZIPFLEET_ID;
				}
				
			    public Long RESIDENCE_COUNTRY_ID;

				public Long getRESIDENCE_COUNTRY_ID () {
					return this.RESIDENCE_COUNTRY_ID;
				}
				
			    public String RESIDENCE_YEAR_P;

				public String getRESIDENCE_YEAR_P () {
					return this.RESIDENCE_YEAR_P;
				}
			    ...
			    public String PARTNER_TOKEN_ID;

				public String getPARTNER_TOKEN_ID () {
					return this.PARTNER_TOKEN_ID;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessions) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ARCHIVAL_REASON = readString(dis);
					
					this.APP_MODE = readString(dis);
					
					this.APP_STEP = readString(dis);
					
					this.REMARKETED = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.PREFERRED_ZIPFLEET_ID = null;
           				} else {
           			    	this.PREFERRED_ZIPFLEET_ID = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.RESIDENCE_COUNTRY_ID = dis.readLong();
           				}
					
					this.RESIDENCE_YEAR_P = readString(dis);
					
					this.CORPORATE_ID = readString(dis);
					...
					this.PARTNER_TOKEN_ID = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ARCHIVAL_REASON,dos);
					
					// String
				
						writeString(this.APP_MODE,dos);
					
					// String
				
						writeString(this.APP_STEP,dos);
					
					// String
				
						writeString(this.REMARKETED,dos);
					...
					// Long
						...
						if(this.PREFERRED_ZIPFLEET_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.PREFERRED_ZIPFLEET_ID);
		            	}
					
					// Long
				
						if(this.RESIDENCE_COUNTRY_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.RESIDENCE_COUNTRY_ID);
		            	}
					
					// String
				
						writeString(this.RESIDENCE_YEAR_P,dos);
					
					// String
				
						writeString(this.CORPORATE_ID,dos);
					...
					// String
						...
						writeString(this.PARTNER_TOKEN_ID,dos);
    ...
    public String toString() {
		...
		sb.append(",ARCHIVAL_REASON="+ARCHIVAL_REASON);
		sb.append(",APP_MODE="+APP_MODE);
		sb.append(",APP_STEP="+APP_STEP);
		sb.append(",REMARKETED="+REMARKETED);
		sb.append(",PREFERRED_ADDRESS_ID="+String.valueOf(PREFERRED_ADDRESS_ID));
		sb.append(",PREFERRED_ZIPFLEET_ID="+String.valueOf(PREFERRED_ZIPFLEET_ID));
		sb.append(",RESIDENCE_COUNTRY_ID="+String.valueOf(RESIDENCE_COUNTRY_ID));
		sb.append(",RESIDENCE_YEAR_P="+RESIDENCE_YEAR_P);
		sb.append(",CORPORATE_ID="+CORPORATE_ID);
		...
		sb.append(",PARTNER_TOKEN_ID="+PARTNER_TOKEN_ID);
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(long USER_ID){
							this.USER_ID = USER_ID;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c1(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c2(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						String APP_STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String APP_STATUS){
							this.APP_STATUS = APP_STATUS;
							return this;
						}				
						String ARCHIVAL_REASON;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String ARCHIVAL_REASON){
							this.ARCHIVAL_REASON = ARCHIVAL_REASON;
							return this;
						}				
						String APP_MODE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String APP_MODE){
							this.APP_MODE = APP_MODE;
							return this;
						}				
						String APP_STEP;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String APP_STEP){
							this.APP_STEP = APP_STEP;
							return this;
						}				
						String REMARKETED;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String REMARKETED){
							this.REMARKETED = REMARKETED;
							return this;
						}				
						Long PREFERRED_ADDRESS_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Long PREFERRED_ADDRESS_ID){
							this.PREFERRED_ADDRESS_ID = PREFERRED_ADDRESS_ID;
							return this;
						}				
						Long PREFERRED_ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c9(Long PREFERRED_ZIPFLEET_ID){
							this.PREFERRED_ZIPFLEET_ID = PREFERRED_ZIPFLEET_ID;
							return this;
						}				
						Long RESIDENCE_COUNTRY_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Long RESIDENCE_COUNTRY_ID){
							this.RESIDENCE_COUNTRY_ID = RESIDENCE_COUNTRY_ID;
							return this;
						}				
						String RESIDENCE_YEAR_P;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String RESIDENCE_YEAR_P){
							this.RESIDENCE_YEAR_P = RESIDENCE_YEAR_P;
							return this;
						}				
						String CORPORATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String CORPORATE_ID){
							this.CORPORATE_ID = CORPORATE_ID;
							return this;
						}				
						String PHONE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String PHONE){
							this.PHONE = PHONE;
							return this;
						}				
						String PHONE_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String PHONE_TYPE){
							this.PHONE_TYPE = PHONE_TYPE;
							return this;
						}				
						java.util.Date BIRTH_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c15(java.util.Date BIRTH_DATE){
							this.BIRTH_DATE = BIRTH_DATE;
							return this;
						}				
						Long ACCOUNT_ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c16(Long ACCOUNT_ZIPFLEET_ID){
							this.ACCOUNT_ZIPFLEET_ID = ACCOUNT_ZIPFLEET_ID;
							return this;
						}				
						Long ACCOUNT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c17(Long ACCOUNT_ID){
							this.ACCOUNT_ID = ACCOUNT_ID;
							return this;
						}				
						Long AFFILIATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c18(Long AFFILIATE_ID){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c20(String PROMO_CODE){
							this.PROMO_CODE = PROMO_CODE;
							return this;
						}				
						Long WAIVER_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c21(Long WAIVER_PLAN_ID){
							this.WAIVER_PLAN_ID = WAIVER_PLAN_ID;
							return this;
						}				
						String PARTNER_TOKEN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c22(String PARTNER_TOKEN_ID){
							this.PARTNER_TOKEN_ID = PARTNER_TOKEN_ID;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"USER_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"APP_STATUS\",\"ARCHIVAL_REASON\",\"APP_MODE\",\"APP_STEP\",\"REMARKETED\",\"PREFERRED_ADDRESS_ID\",\"PREFERRED_ZIPFLEET_ID\",\"RESIDENCE_COUNTRY_ID\",\"RESIDENCE_YEAR_P\",\"CORPORATE_ID\",\"PHONE\",\"PHONE_TYPE\",\"BIRTH_DATE\",\"ACCOUNT_ZIPFLEET_ID\",\"ACCOUNT_ID\",\"AFFILIATE_ID\",\"RATE_PLAN_ID\",\"PROMO_CODE\",\"WAIVER_PLAN_ID\",\"PARTNER_TOKEN_ID\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.ARCHIVAL_REASON = null;
					
							Row_FeedRecord.APP_MODE = null;
					
							Row_FeedRecord.APP_STEP = null;
					
							Row_FeedRecord.REMARKETED = null;
					
							Row_FeedRecord.PREFERRED_ADDRESS_ID = null;
					
							Row_FeedRecord.PREFERRED_ZIPFLEET_ID = null;
					
							Row_FeedRecord.RESIDENCE_COUNTRY_ID = null;
					
							Row_FeedRecord.RESIDENCE_YEAR_P = null;
					
							Row_FeedRecord.CORPORATE_ID = null;
					
							Row_FeedRecord.PHONE = null;
					
							Row_FeedRecord.PHONE_TYPE = null;
					
							Row_FeedRecord.BIRTH_DATE = null;
					
							Row_FeedRecord.ACCOUNT_ZIPFLEET_ID = null;
							...
							Row_FeedRecord.PROMO_CODE = null;
					
							Row_FeedRecord.WAIVER_PLAN_ID = null;
					
							Row_FeedRecord.PARTNER_TOKEN_ID = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.USER_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'USER_ID' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ARCHIVAL_REASON = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.APP_MODE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.APP_STEP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.REMARKETED = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.PREFERRED_ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.PREFERRED_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.RESIDENCE_COUNTRY_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.RESIDENCE_YEAR_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.CORPORATE_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PHONE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PHONE_TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.BIRTH_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], "yyyy-M-d", false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ACCOUNT_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PROMO_CODE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PARTNER_TOKEN_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.ARCHIVAL_REASON = StringUtils.trimToNull(Row_FeedRecord.ARCHIVAL_REASON);
Record_OutputToDB.APP_MODE = StringUtils.trimToNull(Row_FeedRecord.APP_MODE);
Record_OutputToDB.APP_STEP = StringUtils.trimToNull(Row_FeedRecord.APP_STEP);
Record_OutputToDB.REMARKETED = BooleanUtils.boolChar(Row_FeedRecord.REMARKETED);
Record_OutputToDB.PREFERRED_ADDRESS_ID = Row_FeedRecord.PREFERRED_ADDRESS_ID;
Record_OutputToDB.PREFERRED_ZIPFLEET_ID = Row_FeedRecord.PREFERRED_ZIPFLEET_ID;
Record_OutputToDB.RESIDENCE_COUNTRY_ID = Row_FeedRecord.RESIDENCE_COUNTRY_ID;
Record_OutputToDB.RESIDENCE_YEAR_P = BooleanUtils.boolChar(Row_FeedRecord.RESIDENCE_YEAR_P);
Record_OutputToDB.CORPORATE_ID = StringUtils.trimToNull(Row_FeedRecord.CORPORATE_ID);
Record_OutputToDB.PHONE = StringUtils.trimToNull(Row_FeedRecord.PHONE);
Record_OutputToDB.PHONE_TYPE = StringUtils.trimToNull(Row_FeedRecord.PHONE_TYPE);
Record_OutputToDB.BIRTH_DATE = Row_FeedRecord.BIRTH_DATE;
Record_OutputToDB.ACCOUNT_ZIPFLEET_ID = Row_FeedRecord.ACCOUNT_ZIPFLEET_ID;
...
Record_OutputToDB.PROMO_CODE = StringUtils.trimToNull(Row_FeedRecord.PROMO_CODE);
Record_OutputToDB.WAIVER_PLAN_ID = Row_FeedRecord.WAIVER_PLAN_ID;
Record_OutputToDB.PARTNER_TOKEN_ID = StringUtils.trimToNull(Row_FeedRecord.PARTNER_TOKEN_ID);
    nb_line_tJavaRow_3++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ARCHIVAL_REASON==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ARCHIVAL_REASON);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APP_MODE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.APP_MODE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APP_STEP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.APP_STEP);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.REMARKETED==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.REMARKETED);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PREFERRED_ADDRESS_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.PREFERRED_ADDRESS_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PREFERRED_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.PREFERRED_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RESIDENCE_COUNTRY_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.RESIDENCE_COUNTRY_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RESIDENCE_YEAR_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.RESIDENCE_YEAR_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CORPORATE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.CORPORATE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PHONE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PHONE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PHONE_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PHONE_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.BIRTH_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.BIRTH_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ACCOUNT_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ACCOUNT_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PROMO_CODE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PROMO_CODE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PARTNER_TOKEN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PARTNER_TOKEN_ID);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.USER_ID)
                        .c1(Record_OutputToDB.CREATION_DATE)
                        .c2(Record_OutputToDB.LAST_MODIFIED)
                        .c3(Record_OutputToDB.APP_STATUS)
                        .c4(Record_OutputToDB.ARCHIVAL_REASON)
                        .c5(Record_OutputToDB.APP_MODE)
                        .c6(Record_OutputToDB.APP_STEP)
                        .c7(Record_OutputToDB.REMARKETED)
                        .c8(Record_OutputToDB.PREFERRED_ADDRESS_ID)
                        .c9(Record_OutputToDB.PREFERRED_ZIPFLEET_ID)
                        .c10(Record_OutputToDB.RESIDENCE_COUNTRY_ID)
                        .c11(Record_OutputToDB.RESIDENCE_YEAR_P)
                        .c12(Record_OutputToDB.CORPORATE_ID)
                        .c13(Record_OutputToDB.PHONE)
                        .c14(Record_OutputToDB.PHONE_TYPE)
                        .c15(Record_OutputToDB.BIRTH_DATE)
                        .c16(Record_OutputToDB.ACCOUNT_ZIPFLEET_ID)
                        .c17(Record_OutputToDB.ACCOUNT_ID)
                        .c18(Record_OutputToDB.AFFILIATE_ID)
                        .c19(Record_OutputToDB.RATE_PLAN_ID)
                        .c20(Record_OutputToDB.PROMO_CODE)
                        .c21(Record_OutputToDB.WAIVER_PLAN_ID)
                        .c22(Record_OutputToDB.PARTNER_TOKEN_ID)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.ARCHIVAL_REASON = Record_OutputToDB.ARCHIVAL_REASON;
                                After_Insert.APP_MODE = Record_OutputToDB.APP_MODE;
                                After_Insert.APP_STEP = Record_OutputToDB.APP_STEP;
                                After_Insert.REMARKETED = Record_OutputToDB.REMARKETED;
                                After_Insert.PREFERRED_ADDRESS_ID = Record_OutputToDB.PREFERRED_ADDRESS_ID;
                                After_Insert.PREFERRED_ZIPFLEET_ID = Record_OutputToDB.PREFERRED_ZIPFLEET_ID;
                                After_Insert.RESIDENCE_COUNTRY_ID = Record_OutputToDB.RESIDENCE_COUNTRY_ID;
                                After_Insert.RESIDENCE_YEAR_P = Record_OutputToDB.RESIDENCE_YEAR_P;
                                After_Insert.CORPORATE_ID = Record_OutputToDB.CORPORATE_ID;
                                After_Insert.PHONE = Record_OutputToDB.PHONE;
                                After_Insert.PHONE_TYPE = Record_OutputToDB.PHONE_TYPE;
                                After_Insert.BIRTH_DATE = Record_OutputToDB.BIRTH_DATE;
                                After_Insert.ACCOUNT_ZIPFLEET_ID = Record_OutputToDB.ACCOUNT_ZIPFLEET_ID;
                                ...
                                After_Insert.PROMO_CODE = Record_OutputToDB.PROMO_CODE;
                                After_Insert.WAIVER_PLAN_ID = Record_OutputToDB.WAIVER_PLAN_ID;
                                After_Insert.PARTNER_TOKEN_ID = Record_OutputToDB.PARTNER_TOKEN_ID;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.ARCHIVAL_REASON = After_Insert.ARCHIVAL_REASON;
               Log_Rows.APP_MODE = After_Insert.APP_MODE;
               Log_Rows.APP_STEP = After_Insert.APP_STEP;
               Log_Rows.REMARKETED = After_Insert.REMARKETED;
               Log_Rows.PREFERRED_ADDRESS_ID = After_Insert.PREFERRED_ADDRESS_ID;
               Log_Rows.PREFERRED_ZIPFLEET_ID = After_Insert.PREFERRED_ZIPFLEET_ID;
               Log_Rows.RESIDENCE_COUNTRY_ID = After_Insert.RESIDENCE_COUNTRY_ID;
               Log_Rows.RESIDENCE_YEAR_P = After_Insert.RESIDENCE_YEAR_P;
               Log_Rows.CORPORATE_ID = After_Insert.CORPORATE_ID;
               Log_Rows.PHONE = After_Insert.PHONE;
               Log_Rows.PHONE_TYPE = After_Insert.PHONE_TYPE;
               Log_Rows.BIRTH_DATE = After_Insert.BIRTH_DATE;
               ...
               Log_Rows.PROMO_CODE = After_Insert.PROMO_CODE;
               Log_Rows.WAIVER_PLAN_ID = After_Insert.WAIVER_PLAN_ID;
               Log_Rows.PARTNER_TOKEN_ID = After_Insert.PARTNER_TOKEN_ID;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"USER_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"APP_STATUS\",\"ARCHIVAL_REASON\",\"APP_MODE\",\"APP_STEP\",\"REMARKETED\",\"PREFERRED_ADDRESS_ID\",\"PREFERRED_ZIPFLEET_ID\",\"RESIDENCE_COUNTRY_ID\",\"RESIDENCE_YEAR_P\",\"CORPORATE_ID\",\"PHONE\",\"PHONE_TYPE\",\"BIRTH_DATE\",\"ACCOUNT_ZIPFLEET_ID\",\"ACCOUNT_ID\",\"AFFILIATE_ID\",\"RATE_PLAN_ID\",\"PROMO_CODE\",\"WAIVER_PLAN_ID\",\"PARTNER_TOKEN_ID\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.ARCHIVAL_REASON==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ARCHIVAL_REASON);
					...
					if(bufferLtRedshiftOutput_1.APP_MODE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.APP_MODE);
					...
					if(bufferLtRedshiftOutput_1.APP_STEP==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.APP_STEP);
					...
					if(bufferLtRedshiftOutput_1.REMARKETED==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.REMARKETED);
					...
					if(bufferLtRedshiftOutput_1.PREFERRED_ZIPFLEET_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PREFERRED_ZIPFLEET_ID);
					...
					if(bufferLtRedshiftOutput_1.RESIDENCE_COUNTRY_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RESIDENCE_COUNTRY_ID);
					...
					if(bufferLtRedshiftOutput_1.RESIDENCE_YEAR_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RESIDENCE_YEAR_P);
					...
					if(bufferLtRedshiftOutput_1.CORPORATE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CORPORATE_ID);
					...
					if(bufferLtRedshiftOutput_1.PHONE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PHONE);
					...
					if(bufferLtRedshiftOutput_1.PHONE_TYPE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PHONE_TYPE);
					...
					if(bufferLtRedshiftOutput_1.BIRTH_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.BIRTH_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.ACCOUNT_ZIPFLEET_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ACCOUNT_ZIPFLEET_ID);
					...
					if(bufferLtRedshiftOutput_1.PROMO_CODE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PROMO_CODE);
					...
					if(bufferLtRedshiftOutput_1.PARTNER_TOKEN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PARTNER_TOKEN_ID);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.ARCHIVAL_REASON = null;
					
							row1.APP_MODE = null;
					
							row1.APP_STEP = null;
					
							row1.REMARKETED = null;
					
							row1.PREFERRED_ADDRESS_ID = null;
					
							row1.PREFERRED_ZIPFLEET_ID = null;
					
							row1.RESIDENCE_COUNTRY_ID = null;
					
							row1.RESIDENCE_YEAR_P = null;
					
							row1.CORPORATE_ID = null;
					
							row1.PHONE = null;
					
							row1.PHONE_TYPE = null;
							...
							row1.PROMO_CODE = null;
					
							row1.WAIVER_PLAN_ID = null;
					
							row1.PARTNER_TOKEN_ID = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.USER_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'USER_ID' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ARCHIVAL_REASON = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.APP_MODE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.APP_STEP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.REMARKETED = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.PREFERRED_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.RESIDENCE_COUNTRY_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.RESIDENCE_YEAR_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.CORPORATE_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PHONE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PHONE_TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.BIRTH_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], "yyyy-M-d", false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PROMO_CODE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PARTNER_TOKEN_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.ARCHIVAL_REASON = StringUtils.trimToNull(row1.ARCHIVAL_REASON);
row2.APP_MODE = StringUtils.trimToNull(row1.APP_MODE);
row2.APP_STEP = StringUtils.trimToNull(row1.APP_STEP);
row2.REMARKETED = BooleanUtils.boolChar(row1.REMARKETED);
row2.PREFERRED_ADDRESS_ID = row1.PREFERRED_ADDRESS_ID;
row2.PREFERRED_ZIPFLEET_ID = row1.PREFERRED_ZIPFLEET_ID;
row2.RESIDENCE_COUNTRY_ID = row1.RESIDENCE_COUNTRY_ID;
row2.RESIDENCE_YEAR_P = BooleanUtils.boolChar(row1.RESIDENCE_YEAR_P);
row2.CORPORATE_ID = StringUtils.trimToNull(row1.CORPORATE_ID);
row2.PHONE = StringUtils.trimToNull(row1.PHONE);
row2.PHONE_TYPE = StringUtils.trimToNull(row1.PHONE_TYPE);
...
row2.PROMO_CODE = StringUtils.trimToNull(row1.PROMO_CODE);
row2.WAIVER_PLAN_ID = row1.WAIVER_PLAN_ID;
row2.PARTNER_TOKEN_ID = StringUtils.trimToNull(row1.PARTNER_TOKEN_ID);
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[23];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.USER_ID);
                            rowtFileOutputDelimited_1[1]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[2]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[3]=row2.APP_STATUS == null ? null : row2.APP_STATUS;
                            rowtFileOutputDelimited_1[4]=row2.ARCHIVAL_REASON == null ? null : row2.ARCHIVAL_REASON;
                            rowtFileOutputDelimited_1[5]=row2.APP_MODE == null ? null : row2.APP_MODE;
                            rowtFileOutputDelimited_1[6]=row2.APP_STEP == null ? null : row2.APP_STEP;
                            rowtFileOutputDelimited_1[7]=row2.REMARKETED == null ? null : row2.REMARKETED;
                            rowtFileOutputDelimited_1[8]=row2.PREFERRED_ADDRESS_ID == null ? null : String.valueOf(row2.PREFERRED_ADDRESS_ID);
                            rowtFileOutputDelimited_1[9]=row2.PREFERRED_ZIPFLEET_ID == null ? null : String.valueOf(row2.PREFERRED_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[10]=row2.RESIDENCE_COUNTRY_ID == null ? null : String.valueOf(row2.RESIDENCE_COUNTRY_ID);
                            rowtFileOutputDelimited_1[11]=row2.RESIDENCE_YEAR_P == null ? null : row2.RESIDENCE_YEAR_P;
                            rowtFileOutputDelimited_1[12]=row2.CORPORATE_ID == null ? null : row2.CORPORATE_ID;
                            rowtFileOutputDelimited_1[13]=row2.PHONE == null ? null : row2.PHONE;
                            rowtFileOutputDelimited_1[14]=row2.PHONE_TYPE == null ? null : row2.PHONE_TYPE;
                            rowtFileOutputDelimited_1[15]=row2.BIRTH_DATE == null ? null : FormatterUtils.format_Date(row2.BIRTH_DATE, FeedFile.DF_DATE);
                            rowtFileOutputDelimited_1[16]=row2.ACCOUNT_ZIPFLEET_ID == null ? null : String.valueOf(row2.ACCOUNT_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[17]=row2.ACCOUNT_ID == null ? null : String.valueOf(row2.ACCOUNT_ID);
                            rowtFileOutputDelimited_1[18]=row2.AFFILIATE_ID == null ? null : String.valueOf(row2.AFFILIATE_ID);
                            rowtFileOutputDelimited_1[19]=row2.RATE_PLAN_ID == null ? null : String.valueOf(row2.RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[20]=row2.PROMO_CODE == null ? null : row2.PROMO_CODE;
                            rowtFileOutputDelimited_1[21]=row2.WAIVER_PLAN_ID == null ? null : String.valueOf(row2.WAIVER_PLAN_ID);
                            rowtFileOutputDelimited_1[22]=row2.PARTNER_TOKEN_ID == null ? null : row2.PARTNER_TOKEN_ID;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_RegistrationSessions StageFeed_RegistrationSessionsClass = new StageFeed_RegistrationSessions();

        int exitCode = StageFeed_RegistrationSessionsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_RegistrationSessions.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_registrationsessions_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_RegistrationSessions");
        }
...
/************************************************************************************************
 *     400087 characters generated by Talend Open Studio for Data Integration 
