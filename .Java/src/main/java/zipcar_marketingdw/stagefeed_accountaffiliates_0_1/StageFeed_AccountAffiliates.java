...
package zipcar_marketingdw.stagefeed_accountaffiliates_0_1;
...
/**
 * Job: StageFeed_AccountAffiliates Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_AccountAffiliates implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_AccountAffiliates";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_1B-AYDTHEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_AccountAffiliates.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_AccountAffiliates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.ACCOUNT_AFFILIATES.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.ACCOUNT_AFFILIATES.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.ACCOUNT_AFFILIATES;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public String CUME_AFFILIATES;

				public String getCUME_AFFILIATES () {
					return this.CUME_AFFILIATES;
				}
				
			    public Long ROW_NUM_BY_ACCOUNT;

				public Long getROW_NUM_BY_ACCOUNT () {
					return this.ROW_NUM_BY_ACCOUNT;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.AFFILIATE_ID;
	...
	public boolean equals(Object obj) {
		...
		final Log_RowsStruct other = (Log_RowsStruct) obj;
						...
						if (this.AFFILIATE_ID != other.AFFILIATE_ID)
							return false;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.AFFILIATE_ID = this.AFFILIATE_ID;
	            ...
	            other.AFFILIATE_NAME = this.AFFILIATE_NAME;
	            other.CUME_AFFILIATES = this.CUME_AFFILIATES;
	            other.ROW_NUM_BY_ACCOUNT = this.ROW_NUM_BY_ACCOUNT;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountAffiliates) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CUME_AFFILIATES = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.ROW_NUM_BY_ACCOUNT = null;
           				} else {
           			    	this.ROW_NUM_BY_ACCOUNT = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CUME_AFFILIATES,dos);
					
					// Long
				
						if(this.ROW_NUM_BY_ACCOUNT == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.ROW_NUM_BY_ACCOUNT);
		            	}
    ...
    public String toString() {
		...
		sb.append(",CUME_AFFILIATES="+CUME_AFFILIATES);
		sb.append(",ROW_NUM_BY_ACCOUNT="+String.valueOf(ROW_NUM_BY_ACCOUNT));
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.AFFILIATE_ID, other.AFFILIATE_ID);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c3(String AFFILIATE_NAME){
							this.AFFILIATE_NAME = AFFILIATE_NAME;
							return this;
						}				
						String CUME_AFFILIATES;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String CUME_AFFILIATES){
							this.CUME_AFFILIATES = CUME_AFFILIATES;
							return this;
						}				
						Long ROW_NUM_BY_ACCOUNT;
						
	            		public BufferLine_tRedshiftOutput_1 c5(Long ROW_NUM_BY_ACCOUNT){
							this.ROW_NUM_BY_ACCOUNT = ROW_NUM_BY_ACCOUNT;
							return this;
						}				
						java.util.Date START_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c6(java.util.Date START_DATE){
							this.START_DATE = START_DATE;
							return this;
						}				
						java.util.Date END_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(java.util.Date END_DATE){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"AFFILIATE_ID\",\"ZIPFLEET_ID\",\"ACCOUNT_ID\",\"AFFILIATE_NAME\",\"CUME_AFFILIATES\",\"ROW_NUM_BY_ACCOUNT\",\"START_DATE\",\"END_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.CUME_AFFILIATES = null;
					
							Row_FeedRecord.ROW_NUM_BY_ACCOUNT = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.CUME_AFFILIATES = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ROW_NUM_BY_ACCOUNT = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.CUME_AFFILIATES = StringUtils.trimToNull(Row_FeedRecord.CUME_AFFILIATES);
Record_OutputToDB.ROW_NUM_BY_ACCOUNT = Row_FeedRecord.ROW_NUM_BY_ACCOUNT;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CUME_AFFILIATES==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.CUME_AFFILIATES);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ROW_NUM_BY_ACCOUNT==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ROW_NUM_BY_ACCOUNT);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c3(Record_OutputToDB.AFFILIATE_NAME)
                        .c4(Record_OutputToDB.CUME_AFFILIATES)
                        .c5(Record_OutputToDB.ROW_NUM_BY_ACCOUNT)
                        .c6(Record_OutputToDB.START_DATE)
                        .c7(Record_OutputToDB.END_DATE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.CUME_AFFILIATES = Record_OutputToDB.CUME_AFFILIATES;
                                After_Insert.ROW_NUM_BY_ACCOUNT = Record_OutputToDB.ROW_NUM_BY_ACCOUNT;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.CUME_AFFILIATES = After_Insert.CUME_AFFILIATES;
               Log_Rows.ROW_NUM_BY_ACCOUNT = After_Insert.ROW_NUM_BY_ACCOUNT;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"AFFILIATE_ID\",\"ZIPFLEET_ID\",\"ACCOUNT_ID\",\"AFFILIATE_NAME\",\"CUME_AFFILIATES\",\"ROW_NUM_BY_ACCOUNT\",\"START_DATE\",\"END_DATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.CUME_AFFILIATES==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CUME_AFFILIATES);
					...
					if(bufferLtRedshiftOutput_1.ROW_NUM_BY_ACCOUNT==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ROW_NUM_BY_ACCOUNT);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.CUME_AFFILIATES = null;
					
							row1.ROW_NUM_BY_ACCOUNT = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.CUME_AFFILIATES = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ROW_NUM_BY_ACCOUNT = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.CUME_AFFILIATES = StringUtils.trimToNull(row1.CUME_AFFILIATES);
row2.ROW_NUM_BY_ACCOUNT = row1.ROW_NUM_BY_ACCOUNT;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[8];
                            ...
                            rowtFileOutputDelimited_1[3]=row2.AFFILIATE_NAME == null ? null : row2.AFFILIATE_NAME;
                            rowtFileOutputDelimited_1[4]=row2.CUME_AFFILIATES == null ? null : row2.CUME_AFFILIATES;
                            rowtFileOutputDelimited_1[5]=row2.ROW_NUM_BY_ACCOUNT == null ? null : String.valueOf(row2.ROW_NUM_BY_ACCOUNT);
                            rowtFileOutputDelimited_1[6]=row2.START_DATE == null ? null : FormatterUtils.format_Date(row2.START_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[7]=row2.END_DATE == null ? null : FormatterUtils.format_Date(row2.END_DATE, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_AccountAffiliates StageFeed_AccountAffiliatesClass = new StageFeed_AccountAffiliates();

        int exitCode = StageFeed_AccountAffiliatesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_AccountAffiliates.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_accountaffiliates_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_AccountAffiliates");
        }
...
/************************************************************************************************
 *     329295 characters generated by Talend Open Studio for Data Integration 
