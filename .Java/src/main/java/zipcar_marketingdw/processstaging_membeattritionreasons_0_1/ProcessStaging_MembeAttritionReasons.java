...
package zipcar_marketingdw.processstaging_membeattritionreasons_0_1;
...
/**
 * Job: ProcessStaging_MembeAttritionReasons Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_MembeAttritionReasons implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_MembeAttritionReasons";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_9oiAwMpoEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_MembeAttritionReasons.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_MembeAttritionReasons.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MembeAttritionReasons) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "member_attrition_reasons";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_member_attrition_reason";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_member_attrition_reason\n(\n    member_id,\n	active_p,\n	left_date,\n	quit_reason,\n	transaction_reason,\n	creation_date,\n	deleted_date,\n	last_comment_date,\n	source,\n    imported_date\n)\nSELECT \n    member_id,\n	active_p,\n	left_date,\n	quit_reason,\n	transaction_reason,\n	creation_date,\n	deleted_date,\n	last_comment_date,\n	source,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.member_attrition_reasons\nMINUS\nSELECT \n    member_id,\n	active_p,\n	left_date,\n	quit_reason,\n	transaction_reason,\n	creation_date,\n	deleted_date,\n	last_comment_date,\n	source,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_member_attrition_reason\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".member_attrition_reasons";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_MembeAttritionReasons ProcessStaging_MembeAttritionReasonsClass = new ProcessStaging_MembeAttritionReasons();

        int exitCode = ProcessStaging_MembeAttritionReasonsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_MembeAttritionReasons.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_membeattritionreasons_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_MembeAttritionReasons");
        }
...
/************************************************************************************************
 *     136277 characters generated by Talend Open Studio for Data Integration 
