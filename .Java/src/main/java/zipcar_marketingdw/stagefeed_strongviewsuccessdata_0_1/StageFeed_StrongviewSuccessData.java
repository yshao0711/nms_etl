...
package zipcar_marketingdw.stagefeed_strongviewsuccessdata_0_1;
...
/**
 * Job: StageFeed_StrongviewSuccessData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewSuccessData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewSuccessData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_3tkigMtKEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewSuccessData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewSuccessData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_SUCCESS_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_SUCCESS_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_SUCCESS_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData = new byte[0];
			    ...
			    public String DATABASE_ROW_NUMBER;

				public String getDATABASE_ROW_NUMBER () {
					return this.DATABASE_ROW_NUMBER;
				}
			    ...
			    public Long MESSAGE_SERIAL_NO;

				public Long getMESSAGE_SERIAL_NO () {
					return this.MESSAGE_SERIAL_NO;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewSuccessData) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DATABASE_ROW_NUMBER = readString(dis);
					
					this.DATABASE_NAME = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.MESSAGE_SERIAL_NO = null;
           				} else {
           			    	this.MESSAGE_SERIAL_NO = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DATABASE_ROW_NUMBER,dos);
					...
					// Long
						...
						if(this.MESSAGE_SERIAL_NO == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.MESSAGE_SERIAL_NO);
		            	}
    ...
    public String toString() {
		...
		sb.append(",DATABASE_ROW_NUMBER="+DATABASE_ROW_NUMBER);
		sb.append(",DATABASE_NAME="+DATABASE_NAME);
		sb.append(",MESSAGE_SERIAL_NO="+String.valueOf(MESSAGE_SERIAL_NO));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c1(String SERIAL_NUMBER){
							this.SERIAL_NUMBER = SERIAL_NUMBER;
							return this;
						}				
						String MAILING_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String MAILING_ID){
							this.MAILING_ID = MAILING_ID;
							return this;
						}				
						String DATABASE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String DATABASE_ID){
							this.DATABASE_ID = DATABASE_ID;
							return this;
						}				
						String MESSAGE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String MESSAGE_ID){
							this.MESSAGE_ID = MESSAGE_ID;
							return this;
						}				
						String USER_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String USER_ID){
							this.USER_ID = USER_ID;
							return this;
						}				
						String DATABASE_ROW_NUMBER;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String DATABASE_ROW_NUMBER){
							this.DATABASE_ROW_NUMBER = DATABASE_ROW_NUMBER;
							return this;
						}				
						String DATABASE_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String DATABASE_NAME){
							this.DATABASE_NAME = DATABASE_NAME;
							return this;
						}				
						Long MESSAGE_SERIAL_NO;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Long MESSAGE_SERIAL_NO){
							this.MESSAGE_SERIAL_NO = MESSAGE_SERIAL_NO;
							return this;
						}				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c10(String VSG_NAME){
							this.VSG_NAME = VSG_NAME;
							return this;
						}				
						String OUTBOUND_IP;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String OUTBOUND_IP){
							this.OUTBOUND_IP = OUTBOUND_IP;
							return this;
						}				
						String MX_IP;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String MX_IP){
							this.MX_IP = MX_IP;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"DATA_CAPTURED_DT\",\"SERIAL_NUMBER\",\"MAILING_ID\",\"DATABASE_ID\",\"MESSAGE_ID\",\"USER_ID\",\"DATABASE_ROW_NUMBER\",\"DATABASE_NAME\",\"MESSAGE_SERIAL_NO\",\"EMAIL_ADDRESS\",\"VSG_NAME\",\"OUTBOUND_IP\",\"MX_IP\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.DATABASE_ROW_NUMBER = null;
					
							Row_FeedRecord.DATABASE_NAME = null;
					
							Row_FeedRecord.MESSAGE_SERIAL_NO = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DATABASE_ROW_NUMBER = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.MESSAGE_SERIAL_NO = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.DATABASE_ROW_NUMBER = StringUtils.trimToNull(Row_FeedRecord.DATABASE_ROW_NUMBER);
Record_OutputToDB.DATABASE_NAME = StringUtils.trimToNull(Row_FeedRecord.DATABASE_NAME);
Record_OutputToDB.MESSAGE_SERIAL_NO = Row_FeedRecord.MESSAGE_SERIAL_NO;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DATABASE_ROW_NUMBER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DATABASE_ROW_NUMBER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MESSAGE_SERIAL_NO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.MESSAGE_SERIAL_NO);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.SERIAL_NUMBER)
                        .c2(Record_OutputToDB.MAILING_ID)
                        .c3(Record_OutputToDB.DATABASE_ID)
                        .c4(Record_OutputToDB.MESSAGE_ID)
                        .c5(Record_OutputToDB.USER_ID)
                        .c6(Record_OutputToDB.DATABASE_ROW_NUMBER)
                        .c7(Record_OutputToDB.DATABASE_NAME)
                        .c8(Record_OutputToDB.MESSAGE_SERIAL_NO)
                        .c9(Record_OutputToDB.EMAIL_ADDRESS)
                        .c10(Record_OutputToDB.VSG_NAME)
                        .c11(Record_OutputToDB.OUTBOUND_IP)
                        .c12(Record_OutputToDB.MX_IP)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.DATABASE_ROW_NUMBER = Record_OutputToDB.DATABASE_ROW_NUMBER;
                                After_Insert.DATABASE_NAME = Record_OutputToDB.DATABASE_NAME;
                                After_Insert.MESSAGE_SERIAL_NO = Record_OutputToDB.MESSAGE_SERIAL_NO;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.DATABASE_ROW_NUMBER = After_Insert.DATABASE_ROW_NUMBER;
               Log_Rows.DATABASE_NAME = After_Insert.DATABASE_NAME;
               Log_Rows.MESSAGE_SERIAL_NO = After_Insert.MESSAGE_SERIAL_NO;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"DATA_CAPTURED_DT\",\"SERIAL_NUMBER\",\"MAILING_ID\",\"DATABASE_ID\",\"MESSAGE_ID\",\"USER_ID\",\"DATABASE_ROW_NUMBER\",\"DATABASE_NAME\",\"MESSAGE_SERIAL_NO\",\"EMAIL_ADDRESS\",\"VSG_NAME\",\"OUTBOUND_IP\",\"MX_IP\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.DATABASE_ROW_NUMBER==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DATABASE_ROW_NUMBER);
					...
					if(bufferLtRedshiftOutput_1.MESSAGE_SERIAL_NO==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MESSAGE_SERIAL_NO);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.DATABASE_ROW_NUMBER = null;
					
							row1.DATABASE_NAME = null;
					
							row1.MESSAGE_SERIAL_NO = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DATABASE_ROW_NUMBER = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.MESSAGE_SERIAL_NO = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.DATABASE_ROW_NUMBER = StringUtils.trimToNull(row1.DATABASE_ROW_NUMBER);
row2.DATABASE_NAME = StringUtils.trimToNull(row1.DATABASE_NAME);
row2.MESSAGE_SERIAL_NO = row1.MESSAGE_SERIAL_NO;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[13];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.SERIAL_NUMBER == null ? null : row2.SERIAL_NUMBER;
                            rowtFileOutputDelimited_1[2]=row2.MAILING_ID == null ? null : row2.MAILING_ID;
                            rowtFileOutputDelimited_1[3]=row2.DATABASE_ID == null ? null : row2.DATABASE_ID;
                            rowtFileOutputDelimited_1[4]=row2.MESSAGE_ID == null ? null : row2.MESSAGE_ID;
                            rowtFileOutputDelimited_1[5]=row2.USER_ID == null ? null : row2.USER_ID;
                            rowtFileOutputDelimited_1[6]=row2.DATABASE_ROW_NUMBER == null ? null : row2.DATABASE_ROW_NUMBER;
                            rowtFileOutputDelimited_1[7]=row2.DATABASE_NAME == null ? null : row2.DATABASE_NAME;
                            rowtFileOutputDelimited_1[8]=row2.MESSAGE_SERIAL_NO == null ? null : String.valueOf(row2.MESSAGE_SERIAL_NO);
                            rowtFileOutputDelimited_1[9]=row2.EMAIL_ADDRESS == null ? null : row2.EMAIL_ADDRESS;
                            rowtFileOutputDelimited_1[10]=row2.VSG_NAME == null ? null : row2.VSG_NAME;
                            rowtFileOutputDelimited_1[11]=row2.OUTBOUND_IP == null ? null : row2.OUTBOUND_IP;
                            rowtFileOutputDelimited_1[12]=row2.MX_IP == null ? null : row2.MX_IP;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewSuccessData StageFeed_StrongviewSuccessDataClass = new StageFeed_StrongviewSuccessData();

        int exitCode = StageFeed_StrongviewSuccessDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewSuccessData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewsuccessdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewSuccessData");
        }
...
/************************************************************************************************
 *     334055 characters generated by Talend Open Studio for Data Integration 
