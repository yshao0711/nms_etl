...
package zipcar_marketingdw.stagefeed_coupons_0_1;
...
/**
 * Job: StageFeed_Coupons Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Coupons implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Coupons";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_hOVxQJzQEeiRFIAwSyk92Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Coupons.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Coupons.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Coupons = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Coupons = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Coupons.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Coupons.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Coupons = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Coupons = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Coupons, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Coupons, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Coupons) {
...
globalMap.put("currentFeed", FeedFile.FileType.COUPONS);
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public Double amount_redeemed;

				public Double getAmount_redeemed () {
					return this.amount_redeemed;
				}
				
			    public Double annual_fee_discount;

				public Double getAnnual_fee_discount () {
					return this.annual_fee_discount;
				}
				
			    public Double app_fee_discount;

				public Double getApp_fee_discount () {
					return this.app_fee_discount;
				}
				
			    public String base_coupon_p;

				public String getBase_coupon_p () {
					return this.base_coupon_p;
				}
				
			    public Integer bonus_points;
			    ...
			    public Long commission_base_coupon_id;

				public Long getCommission_base_coupon_id () {
					return this.commission_base_coupon_id;
				}
			    ...
			    public String coupon_type_admin;

				public String getCoupon_type_admin () {
					return this.coupon_type_admin;
				}
			    ...
			    public String deleted_p;

				public String getDeleted_p () {
					return this.deleted_p;
				}
			    ...
			    public String fee_type_discount;

				public String getFee_type_discount () {
					return this.fee_type_discount;
				}
			    ...
			    public Integer number_members_claimed;

				public Integer getNumber_members_claimed () {
					return this.number_members_claimed;
				}
				
			    public Integer number_redeemed;

				public Integer getNumber_redeemed () {
					return this.number_redeemed;
				}
				
			    public Integer number_uses;
			    ...
			    public String redeemed_p;

				public String getRedeemed_p () {
					return this.redeemed_p;
				}
				
			    public Long referral_base_coupon_id;

				public Long getReferral_base_coupon_id () {
					return this.referral_base_coupon_id;
				}
			    ...
			    public Long referral_program_id;

				public Long getReferral_program_id () {
					return this.referral_program_id;
				}
				
			    public String referral_program_key;

				public String getReferral_program_key () {
					return this.referral_program_key;
				}
				
			    public Long referree_person_id;

				public Long getReferree_person_id () {
					return this.referree_person_id;
				}
				
			    public Long referrer_account_id;

				public Long getReferrer_account_id () {
					return this.referrer_account_id;
				}
				
			    public Long referrer_coupon_id;

				public Long getReferrer_coupon_id () {
					return this.referrer_coupon_id;
				}
				
			    public Long referrer_member_id;

				public Long getReferrer_member_id () {
					return this.referrer_member_id;
				}
			    ...
			    public String voided_p;

				public String getVoided_p () {
					return this.voided_p;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.coupon_id;
	...
	public boolean equals(Object obj) {
		...
		final Log_RowsStruct other = (Log_RowsStruct) obj;
						...
						if (this.coupon_id != other.coupon_id)
							return false;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.coupon_id = this.coupon_id;
	            other.amount_redeemed = this.amount_redeemed;
	            other.annual_fee_discount = this.annual_fee_discount;
	            other.app_fee_discount = this.app_fee_discount;
	            other.base_coupon_p = this.base_coupon_p;
	            other.bonus_points = this.bonus_points;
	            other.campaign_id = this.campaign_id;
	            other.commission_base_coupon_id = this.commission_base_coupon_id;
	            other.coupon_code = this.coupon_code;
	            other.coupon_type = this.coupon_type;
	            other.coupon_type_admin = this.coupon_type_admin;
	            other.creation_date = this.creation_date;
	            other.creation_user = this.creation_user;
	            other.currency_iso = this.currency_iso;
	            other.deleted_p = this.deleted_p;
	            other.description = this.description;
	            other.end_date = this.end_date;
	            other.fee_type_discount = this.fee_type_discount;
	            other.last_modified = this.last_modified;
	            other.member_id = this.member_id;
	            other.number_members_claimed = this.number_members_claimed;
	            other.number_redeemed = this.number_redeemed;
	            other.number_uses = this.number_uses;
	            other.operation = this.operation;
	            other.points = this.points;
	            other.redeemed_p = this.redeemed_p;
	            other.referral_base_coupon_id = this.referral_base_coupon_id;
	            other.referral_id = this.referral_id;
	            other.referral_program_id = this.referral_program_id;
	            other.referral_program_key = this.referral_program_key;
	            other.referree_person_id = this.referree_person_id;
	            other.referrer_account_id = this.referrer_account_id;
	            other.referrer_coupon_id = this.referrer_coupon_id;
	            other.referrer_member_id = this.referrer_member_id;
	            other.reimburse_type = this.reimburse_type;
	            other.start_date = this.start_date;
	            other.use_type = this.use_type;
	            other.value = this.value;
	            other.void_date = this.void_date;
	            other.voided_p = this.voided_p;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Coupons) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.coupon_id = dis.readLong();
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.amount_redeemed = null;
           				} else {
           			    	this.amount_redeemed = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.annual_fee_discount = null;
           				} else {
           			    	this.annual_fee_discount = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.app_fee_discount = null;
           				} else {
           			    	this.app_fee_discount = dis.readDouble();
           				}
					
					this.base_coupon_p = readString(dis);
					
						this.bonus_points = readInteger(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.commission_base_coupon_id = null;
           				} else {
           			    	this.commission_base_coupon_id = dis.readLong();
           				}
					
					this.coupon_code = readString(dis);
					
					this.coupon_type = readString(dis);
					
					this.coupon_type_admin = readString(dis);
					...
					this.deleted_p = readString(dis);
					
					this.description = readString(dis);
					
					this.end_date = readDate(dis);
					
					this.fee_type_discount = readString(dis);
					...
					this.last_modified = readDate(dis);
						...
						this.number_members_claimed = readInteger(dis);
					
						this.number_redeemed = readInteger(dis);
					
						this.number_uses = readInteger(dis);
					
					this.operation = readString(dis);
					
						this.points = readInteger(dis);
					
					this.redeemed_p = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.referral_base_coupon_id = null;
           				} else {
           			    	this.referral_base_coupon_id = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.referral_id = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.referral_program_id = null;
           				} else {
           			    	this.referral_program_id = dis.readLong();
           				}
					
					this.referral_program_key = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.referree_person_id = null;
           				} else {
           			    	this.referree_person_id = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.referrer_account_id = null;
           				} else {
           			    	this.referrer_account_id = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.referrer_coupon_id = null;
           				} else {
           			    	this.referrer_coupon_id = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.referrer_member_id = null;
           				} else {
           			    	this.referrer_member_id = dis.readLong();
           				}
					
					this.reimburse_type = readString(dis);
					
					this.start_date = readDate(dis);
					
					this.use_type = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// long
		            	...
		            	dos.writeLong(this.coupon_id);
					
					// Double
				
						if(this.amount_redeemed == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.amount_redeemed);
		            	}
					
					// Double
				
						if(this.annual_fee_discount == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.annual_fee_discount);
		            	}
					
					// Double
				
						if(this.app_fee_discount == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.app_fee_discount);
		            	}
					
					// String
				
						writeString(this.base_coupon_p,dos);
					
					// Integer
				
						writeInteger(this.bonus_points,dos);
					...
					// Long
						...
						if(this.commission_base_coupon_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.commission_base_coupon_id);
		            	}
					
					// String
				
						writeString(this.coupon_code,dos);
					
					// String
				
						writeString(this.coupon_type,dos);
					
					// String
				
						writeString(this.coupon_type_admin,dos);
					...
					// String
						...
						writeString(this.deleted_p,dos);
					...
					// String
						...
						writeString(this.fee_type_discount,dos);
					...
					// Integer
						...
						writeInteger(this.number_members_claimed,dos);
					
					// Integer
				
						writeInteger(this.number_redeemed,dos);
					
					// Integer
				
						writeInteger(this.number_uses,dos);
					...
					// String
						...
						writeString(this.redeemed_p,dos);
					
					// Long
				
						if(this.referral_base_coupon_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.referral_base_coupon_id);
		            	}
					...
					// Long
						...
						if(this.referral_id == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeLong(this.referral_id);
		            	}
					
					// Long
				
						if(this.referral_program_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.referral_program_id);
		            	}
					
					// String
				
						writeString(this.referral_program_key,dos);
					
					// Long
				
						if(this.referree_person_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.referree_person_id);
		            	}
					
					// Long
				
						if(this.referrer_account_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.referrer_account_id);
		            	}
					
					// Long
				
						if(this.referrer_coupon_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.referrer_coupon_id);
		            	}
					
					// Long
				
						if(this.referrer_member_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.referrer_member_id);
		            	}
					
					// String
				
						writeString(this.reimburse_type,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("coupon_id="+String.valueOf(coupon_id));
		sb.append(",amount_redeemed="+String.valueOf(amount_redeemed));
		sb.append(",annual_fee_discount="+String.valueOf(annual_fee_discount));
		sb.append(",app_fee_discount="+String.valueOf(app_fee_discount));
		sb.append(",base_coupon_p="+base_coupon_p);
		sb.append(",bonus_points="+String.valueOf(bonus_points));
		sb.append(",campaign_id="+String.valueOf(campaign_id));
		sb.append(",commission_base_coupon_id="+String.valueOf(commission_base_coupon_id));
		sb.append(",coupon_code="+coupon_code);
		sb.append(",coupon_type="+coupon_type);
		sb.append(",coupon_type_admin="+coupon_type_admin);
		...
		sb.append(",deleted_p="+deleted_p);
		sb.append(",description="+description);
		sb.append(",end_date="+String.valueOf(end_date));
		sb.append(",fee_type_discount="+fee_type_discount);
		sb.append(",last_modified="+String.valueOf(last_modified));
		sb.append(",member_id="+String.valueOf(member_id));
		sb.append(",number_members_claimed="+String.valueOf(number_members_claimed));
		sb.append(",number_redeemed="+String.valueOf(number_redeemed));
		sb.append(",number_uses="+String.valueOf(number_uses));
		sb.append(",operation="+operation);
		sb.append(",points="+String.valueOf(points));
		sb.append(",redeemed_p="+redeemed_p);
		sb.append(",referral_base_coupon_id="+String.valueOf(referral_base_coupon_id));
		sb.append(",referral_id="+String.valueOf(referral_id));
		sb.append(",referral_program_id="+String.valueOf(referral_program_id));
		sb.append(",referral_program_key="+referral_program_key);
		sb.append(",referree_person_id="+String.valueOf(referree_person_id));
		sb.append(",referrer_account_id="+String.valueOf(referrer_account_id));
		sb.append(",referrer_coupon_id="+String.valueOf(referrer_coupon_id));
		sb.append(",referrer_member_id="+String.valueOf(referrer_member_id));
		sb.append(",reimburse_type="+reimburse_type);
		sb.append(",start_date="+String.valueOf(start_date));
		sb.append(",use_type="+use_type);
		sb.append(",value="+String.valueOf(value));
		sb.append(",void_date="+String.valueOf(void_date));
		sb.append(",voided_p="+voided_p);
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.coupon_id, other.coupon_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_2=0;
			...
			class BufferLine_tRedshiftOutput_2 {				
	            		...
	            		public BufferLine_tRedshiftOutput_2 c0(long coupon_id){
							this.coupon_id = coupon_id;
							return this;
						}				
						Double amount_redeemed;
						
	            		public BufferLine_tRedshiftOutput_2 c1(Double amount_redeemed){
							this.amount_redeemed = amount_redeemed;
							return this;
						}				
						Double annual_fee_discount;
						
	            		public BufferLine_tRedshiftOutput_2 c2(Double annual_fee_discount){
							this.annual_fee_discount = annual_fee_discount;
							return this;
						}				
						Double app_fee_discount;
						
	            		public BufferLine_tRedshiftOutput_2 c3(Double app_fee_discount){
							this.app_fee_discount = app_fee_discount;
							return this;
						}				
						String base_coupon_p;
						
	            		public BufferLine_tRedshiftOutput_2 c4(String base_coupon_p){
							this.base_coupon_p = base_coupon_p;
							return this;
						}				
						Integer bonus_points;
						
	            		public BufferLine_tRedshiftOutput_2 c5(Integer bonus_points){
							this.bonus_points = bonus_points;
							return this;
						}				
						Long campaign_id;
						
	            		public BufferLine_tRedshiftOutput_2 c6(Long campaign_id){
							this.campaign_id = campaign_id;
							return this;
						}				
						Long commission_base_coupon_id;
						
	            		public BufferLine_tRedshiftOutput_2 c7(Long commission_base_coupon_id){
							this.commission_base_coupon_id = commission_base_coupon_id;
							return this;
						}				
						String coupon_code;
						
	            		public BufferLine_tRedshiftOutput_2 c8(String coupon_code){
							this.coupon_code = coupon_code;
							return this;
						}				
						String coupon_type;
						
	            		public BufferLine_tRedshiftOutput_2 c9(String coupon_type){
							this.coupon_type = coupon_type;
							return this;
						}				
						String coupon_type_admin;
						
	            		public BufferLine_tRedshiftOutput_2 c10(String coupon_type_admin){
							this.coupon_type_admin = coupon_type_admin;
							return this;
						}				
						java.util.Date creation_date;
						
	            		public BufferLine_tRedshiftOutput_2 c11(java.util.Date creation_date){
							this.creation_date = creation_date;
							return this;
						}				
						Long creation_user;
						
	            		public BufferLine_tRedshiftOutput_2 c12(Long creation_user){
							this.creation_user = creation_user;
							return this;
						}				
						String currency_iso;
						
	            		public BufferLine_tRedshiftOutput_2 c13(String currency_iso){
							this.currency_iso = currency_iso;
							return this;
						}				
						String deleted_p;
						
	            		public BufferLine_tRedshiftOutput_2 c14(String deleted_p){
							this.deleted_p = deleted_p;
							return this;
						}				
						String description;
						
	            		public BufferLine_tRedshiftOutput_2 c15(String description){
							this.description = description;
							return this;
						}				
						java.util.Date end_date;
						
	            		public BufferLine_tRedshiftOutput_2 c16(java.util.Date end_date){
							this.end_date = end_date;
							return this;
						}				
						String fee_type_discount;
						
	            		public BufferLine_tRedshiftOutput_2 c17(String fee_type_discount){
							this.fee_type_discount = fee_type_discount;
							return this;
						}				
						java.util.Date last_modified;
						
	            		public BufferLine_tRedshiftOutput_2 c18(java.util.Date last_modified){
							this.last_modified = last_modified;
							return this;
						}				
						Long member_id;
						
	            		public BufferLine_tRedshiftOutput_2 c19(Long member_id){
							this.member_id = member_id;
							return this;
						}				
						Integer number_members_claimed;
						
	            		public BufferLine_tRedshiftOutput_2 c20(Integer number_members_claimed){
							this.number_members_claimed = number_members_claimed;
							return this;
						}				
						Integer number_redeemed;
						
	            		public BufferLine_tRedshiftOutput_2 c21(Integer number_redeemed){
							this.number_redeemed = number_redeemed;
							return this;
						}				
						Integer number_uses;
						
	            		public BufferLine_tRedshiftOutput_2 c22(Integer number_uses){
							this.number_uses = number_uses;
							return this;
						}				
						String operation;
						
	            		public BufferLine_tRedshiftOutput_2 c23(String operation){
							this.operation = operation;
							return this;
						}				
						Integer points;
						
	            		public BufferLine_tRedshiftOutput_2 c24(Integer points){
							this.points = points;
							return this;
						}				
						String redeemed_p;
						
	            		public BufferLine_tRedshiftOutput_2 c25(String redeemed_p){
							this.redeemed_p = redeemed_p;
							return this;
						}				
						Long referral_base_coupon_id;
						
	            		public BufferLine_tRedshiftOutput_2 c26(Long referral_base_coupon_id){
							this.referral_base_coupon_id = referral_base_coupon_id;
							return this;
						}				
						Long referral_id;
						
	            		public BufferLine_tRedshiftOutput_2 c27(Long referral_id){
							this.referral_id = referral_id;
							return this;
						}				
						Long referral_program_id;
						
	            		public BufferLine_tRedshiftOutput_2 c28(Long referral_program_id){
							this.referral_program_id = referral_program_id;
							return this;
						}				
						String referral_program_key;
						
	            		public BufferLine_tRedshiftOutput_2 c29(String referral_program_key){
							this.referral_program_key = referral_program_key;
							return this;
						}				
						Long referree_person_id;
						
	            		public BufferLine_tRedshiftOutput_2 c30(Long referree_person_id){
							this.referree_person_id = referree_person_id;
							return this;
						}				
						Long referrer_account_id;
						
	            		public BufferLine_tRedshiftOutput_2 c31(Long referrer_account_id){
							this.referrer_account_id = referrer_account_id;
							return this;
						}				
						Long referrer_coupon_id;
						
	            		public BufferLine_tRedshiftOutput_2 c32(Long referrer_coupon_id){
							this.referrer_coupon_id = referrer_coupon_id;
							return this;
						}				
						Long referrer_member_id;
						
	            		public BufferLine_tRedshiftOutput_2 c33(Long referrer_member_id){
							this.referrer_member_id = referrer_member_id;
							return this;
						}				
						String reimburse_type;
						
	            		public BufferLine_tRedshiftOutput_2 c34(String reimburse_type){
							this.reimburse_type = reimburse_type;
							return this;
						}				
						java.util.Date start_date;
						
	            		public BufferLine_tRedshiftOutput_2 c35(java.util.Date start_date){
							this.start_date = start_date;
							return this;
						}				
						String use_type;
						
	            		public BufferLine_tRedshiftOutput_2 c36(String use_type){
							this.use_type = use_type;
							return this;
						}				
						Double value;
						
	            		public BufferLine_tRedshiftOutput_2 c37(Double value){
							this.value = value;
							return this;
						}				
						java.util.Date void_date;
						
	            		public BufferLine_tRedshiftOutput_2 c38(java.util.Date void_date){
							this.void_date = void_date;
							return this;
						}				
						String voided_p;
						
	            		public BufferLine_tRedshiftOutput_2 c39(String voided_p){
							this.voided_p = voided_p;
							return this;
						}				
						Long zipfleet_id;
						
	            		public BufferLine_tRedshiftOutput_2 c40(Long zipfleet_id){
			...
			for(int i_tRedshiftOutput_2=0;i_tRedshiftOutput_2 < 500;i_tRedshiftOutput_2++){
				 extendInsertValueStmt_tRedshiftOutput_2.append("(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				 if (i_tRedshiftOutput_2!=500-1) extendInsertValueStmt_tRedshiftOutput_2.append(",");
			}

			String insert_tRedshiftOutput_2 = "INSERT INTO \"" + tableName_tRedshiftOutput_2 + "\" (\"coupon_id\",\"amount_redeemed\",\"annual_fee_discount\",\"app_fee_discount\",\"base_coupon_p\",\"bonus_points\",\"campaign_id\",\"commission_base_coupon_id\",\"coupon_code\",\"coupon_type\",\"coupon_type_admin\",\"creation_date\",\"creation_user\",\"currency_iso\",\"deleted_p\",\"description\",\"end_date\",\"fee_type_discount\",\"last_modified\",\"member_id\",\"number_members_claimed\",\"number_redeemed\",\"number_uses\",\"operation\",\"points\",\"redeemed_p\",\"referral_base_coupon_id\",\"referral_id\",\"referral_program_id\",\"referral_program_key\",\"referree_person_id\",\"referrer_account_id\",\"referrer_coupon_id\",\"referrer_member_id\",\"reimburse_type\",\"start_date\",\"use_type\",\"value\",\"void_date\",\"voided_p\",\"zipfleet_id\") VALUES " + extendInsertValueStmt_tRedshiftOutput_2.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_Feed.coupon_id = 0;
					
							Row_Feed.amount_redeemed = null;
					
							Row_Feed.annual_fee_discount = null;
					
							Row_Feed.app_fee_discount = null;
					
							Row_Feed.base_coupon_p = null;
					
							Row_Feed.bonus_points = null;
					
							Row_Feed.campaign_id = null;
					
							Row_Feed.commission_base_coupon_id = null;
					
							Row_Feed.coupon_code = null;
					
							Row_Feed.coupon_type = null;
					
							Row_Feed.coupon_type_admin = null;
							...
							Row_Feed.deleted_p = null;
					
							Row_Feed.description = null;
					
							Row_Feed.end_date = null;
					
							Row_Feed.fee_type_discount = null;
					
							Row_Feed.last_modified = null;
					
							Row_Feed.member_id = null;
					
							Row_Feed.number_members_claimed = null;
					
							Row_Feed.number_redeemed = null;
					
							Row_Feed.number_uses = null;
					
							Row_Feed.operation = null;
					
							Row_Feed.points = null;
					
							Row_Feed.redeemed_p = null;
					
							Row_Feed.referral_base_coupon_id = null;
					
							Row_Feed.referral_id = null;
					
							Row_Feed.referral_program_id = null;
					
							Row_Feed.referral_program_key = null;
					
							Row_Feed.referree_person_id = null;
					
							Row_Feed.referrer_account_id = null;
					
							Row_Feed.referrer_coupon_id = null;
					
							Row_Feed.referrer_member_id = null;
					
							Row_Feed.reimburse_type = null;
					
							Row_Feed.start_date = null;
					
							Row_Feed.use_type = null;
					
							Row_Feed.value = null;
					
							Row_Feed.void_date = null;
					
							Row_Feed.voided_p = null;
					
							Row_Feed.zipfleet_id = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.coupon_id = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'coupon_id' in 'Row_Feed' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.amount_redeemed = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.annual_fee_discount = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.app_fee_discount = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.base_coupon_p = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.bonus_points = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.campaign_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.commission_base_coupon_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.coupon_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.coupon_type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.coupon_type_admin = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.deleted_p = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.description = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.fee_type_discount = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.member_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.number_members_claimed = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.number_redeemed = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.number_uses = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.operation = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.points = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.redeemed_p = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.referral_base_coupon_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.referral_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.referral_program_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.referral_program_key = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.referree_person_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.referrer_account_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.referrer_coupon_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.referrer_member_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.reimburse_type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.use_type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.value = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Feed.void_date = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.voided_p = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.zipfleet_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Row_Mapped.coupon_id = Row_Feed.coupon_id;
Row_Mapped.amount_redeemed = Row_Feed.amount_redeemed;
Row_Mapped.annual_fee_discount = Row_Feed.annual_fee_discount;
Row_Mapped.app_fee_discount = Row_Feed.app_fee_discount;
Row_Mapped.base_coupon_p = BooleanUtils.boolChar(Row_Feed.base_coupon_p);
Row_Mapped.bonus_points = Row_Feed.bonus_points;
Row_Mapped.campaign_id = Row_Feed.campaign_id;
Row_Mapped.commission_base_coupon_id = Row_Feed.commission_base_coupon_id;
Row_Mapped.coupon_code = StringUtils.trimToNull(Row_Feed.coupon_code);
Row_Mapped.coupon_type = StringUtils.trimToNull(Row_Feed.coupon_type);
Row_Mapped.coupon_type_admin = StringUtils.trimToNull(Row_Feed.coupon_type_admin);
...
Row_Mapped.deleted_p = BooleanUtils.boolChar(Row_Feed.deleted_p);
Row_Mapped.description = StringUtils.trimToNull(Row_Feed.description);
Row_Mapped.end_date = Row_Feed.end_date;
Row_Mapped.fee_type_discount = StringUtils.trimToNull(Row_Feed.fee_type_discount);
Row_Mapped.last_modified = Row_Feed.last_modified;
Row_Mapped.member_id = Row_Feed.member_id;
Row_Mapped.number_members_claimed = Row_Feed.number_members_claimed;
Row_Mapped.number_redeemed = Row_Feed.number_redeemed;
Row_Mapped.number_uses = Row_Feed.number_uses;
Row_Mapped.operation = StringUtils.trimToNull(Row_Feed.operation);
Row_Mapped.points = Row_Feed.points;
Row_Mapped.redeemed_p = BooleanUtils.boolChar(Row_Feed.redeemed_p);
Row_Mapped.referral_base_coupon_id = Row_Feed.referral_base_coupon_id;
Row_Mapped.referral_id = Row_Feed.referral_id;
Row_Mapped.referral_program_id = Row_Feed.referral_program_id;
Row_Mapped.referral_program_key = StringUtils.trimToNull(Row_Feed.referral_program_key);
Row_Mapped.referree_person_id = Row_Feed.referree_person_id;
Row_Mapped.referrer_account_id = Row_Feed.referrer_account_id;
Row_Mapped.referrer_coupon_id = Row_Feed.referrer_coupon_id;
Row_Mapped.referrer_member_id = Row_Feed.referrer_member_id;
Row_Mapped.reimburse_type = StringUtils.trimToNull(Row_Feed.reimburse_type);
Row_Mapped.start_date = Row_Feed.start_date;
Row_Mapped.use_type = StringUtils.trimToNull(Row_Feed.use_type);
Row_Mapped.value = Row_Feed.value;
Row_Mapped.void_date = Row_Feed.void_date;
Row_Mapped.voided_p = BooleanUtils.boolChar(Row_Feed.voided_p);
Row_Mapped.zipfleet_id = Row_Feed.zipfleet_id;
	...
	currentComponent="tRedshiftOutput_2";
        ...
        whetherReject_tRedshiftOutput_2 = false;
				...
				+ 1;
							...
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.coupon_id);
							
						countertRedshiftOutput_2++;
						

						
							if(Row_Mapped.amount_redeemed==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setDouble(countertRedshiftOutput_2,Row_Mapped.amount_redeemed);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.annual_fee_discount==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setDouble(countertRedshiftOutput_2,Row_Mapped.annual_fee_discount);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.app_fee_discount==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setDouble(countertRedshiftOutput_2,Row_Mapped.app_fee_discount);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.base_coupon_p==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.base_coupon_p);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.bonus_points==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setInt(countertRedshiftOutput_2,Row_Mapped.bonus_points);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.campaign_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.campaign_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.commission_base_coupon_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.commission_base_coupon_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.coupon_code==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.coupon_code);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.coupon_type==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.coupon_type);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.coupon_type_admin==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.coupon_type_admin);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.deleted_p==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.deleted_p);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.description==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.description);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.fee_type_discount==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.fee_type_discount);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.member_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.member_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.number_members_claimed==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setInt(countertRedshiftOutput_2,Row_Mapped.number_members_claimed);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.number_redeemed==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setInt(countertRedshiftOutput_2,Row_Mapped.number_redeemed);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.number_uses==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setInt(countertRedshiftOutput_2,Row_Mapped.number_uses);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.operation==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.operation);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.points==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setInt(countertRedshiftOutput_2,Row_Mapped.points);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.redeemed_p==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.redeemed_p);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referral_base_coupon_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.referral_base_coupon_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referral_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.referral_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referral_program_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.referral_program_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referral_program_key==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.referral_program_key);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referree_person_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.referree_person_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referrer_account_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.referrer_account_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referrer_coupon_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.referrer_coupon_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.referrer_member_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.referrer_member_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.reimburse_type==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.reimburse_type);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.use_type==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.use_type);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.value==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setDouble(countertRedshiftOutput_2,Row_Mapped.value);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.void_date!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_2 = Row_Mapped.void_date.getTime();
								if (date_tRedshiftOutput_2 < year1_tRedshiftOutput_2 || date_tRedshiftOutput_2 >= year10000_tRedshiftOutput_2) {
									pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_2.setTimestamp(countertRedshiftOutput_2, new java.sql.Timestamp(date_tRedshiftOutput_2));
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.voided_p==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2,Row_Mapped.voided_p);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.zipfleet_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.zipfleet_id);
				...
				exInsertColValuetRedshiftOutput_2 = new BufferLine_tRedshiftOutput_2();
                        ...
                        .c0(Row_Mapped.coupon_id)
                        .c1(Row_Mapped.amount_redeemed)
                        .c2(Row_Mapped.annual_fee_discount)
                        .c3(Row_Mapped.app_fee_discount)
                        .c4(Row_Mapped.base_coupon_p)
                        .c5(Row_Mapped.bonus_points)
                        .c6(Row_Mapped.campaign_id)
                        .c7(Row_Mapped.commission_base_coupon_id)
                        .c8(Row_Mapped.coupon_code)
                        .c9(Row_Mapped.coupon_type)
                        .c10(Row_Mapped.coupon_type_admin)
                        .c11(Row_Mapped.creation_date)
                        .c12(Row_Mapped.creation_user)
                        .c13(Row_Mapped.currency_iso)
                        .c14(Row_Mapped.deleted_p)
                        .c15(Row_Mapped.description)
                        .c16(Row_Mapped.end_date)
                        .c17(Row_Mapped.fee_type_discount)
                        .c18(Row_Mapped.last_modified)
                        .c19(Row_Mapped.member_id)
                        .c20(Row_Mapped.number_members_claimed)
                        .c21(Row_Mapped.number_redeemed)
                        .c22(Row_Mapped.number_uses)
                        .c23(Row_Mapped.operation)
                        .c24(Row_Mapped.points)
                        .c25(Row_Mapped.redeemed_p)
                        .c26(Row_Mapped.referral_base_coupon_id)
                        .c27(Row_Mapped.referral_id)
                        .c28(Row_Mapped.referral_program_id)
                        .c29(Row_Mapped.referral_program_key)
                        .c30(Row_Mapped.referree_person_id)
                        .c31(Row_Mapped.referrer_account_id)
                        .c32(Row_Mapped.referrer_coupon_id)
                        .c33(Row_Mapped.referrer_member_id)
                        .c34(Row_Mapped.reimburse_type)
                        .c35(Row_Mapped.start_date)
                        .c36(Row_Mapped.use_type)
                        .c37(Row_Mapped.value)
                        .c38(Row_Mapped.void_date)
                        .c39(Row_Mapped.voided_p)
                        .c40(Row_Mapped.zipfleet_id)
				;
				...
				if(rowCounttRedshiftOutput_2 == 500){
            ...
            if(!whetherReject_tRedshiftOutput_2) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.coupon_id = Row_Mapped.coupon_id;
                                After_Insert.amount_redeemed = Row_Mapped.amount_redeemed;
                                After_Insert.annual_fee_discount = Row_Mapped.annual_fee_discount;
                                After_Insert.app_fee_discount = Row_Mapped.app_fee_discount;
                                After_Insert.base_coupon_p = Row_Mapped.base_coupon_p;
                                After_Insert.bonus_points = Row_Mapped.bonus_points;
                                After_Insert.campaign_id = Row_Mapped.campaign_id;
                                After_Insert.commission_base_coupon_id = Row_Mapped.commission_base_coupon_id;
                                After_Insert.coupon_code = Row_Mapped.coupon_code;
                                After_Insert.coupon_type = Row_Mapped.coupon_type;
                                After_Insert.coupon_type_admin = Row_Mapped.coupon_type_admin;
                                ...
                                After_Insert.deleted_p = Row_Mapped.deleted_p;
                                After_Insert.description = Row_Mapped.description;
                                After_Insert.end_date = Row_Mapped.end_date;
                                After_Insert.fee_type_discount = Row_Mapped.fee_type_discount;
                                After_Insert.last_modified = Row_Mapped.last_modified;
                                After_Insert.member_id = Row_Mapped.member_id;
                                After_Insert.number_members_claimed = Row_Mapped.number_members_claimed;
                                After_Insert.number_redeemed = Row_Mapped.number_redeemed;
                                After_Insert.number_uses = Row_Mapped.number_uses;
                                After_Insert.operation = Row_Mapped.operation;
                                After_Insert.points = Row_Mapped.points;
                                After_Insert.redeemed_p = Row_Mapped.redeemed_p;
                                After_Insert.referral_base_coupon_id = Row_Mapped.referral_base_coupon_id;
                                After_Insert.referral_id = Row_Mapped.referral_id;
                                After_Insert.referral_program_id = Row_Mapped.referral_program_id;
                                After_Insert.referral_program_key = Row_Mapped.referral_program_key;
                                After_Insert.referree_person_id = Row_Mapped.referree_person_id;
                                After_Insert.referrer_account_id = Row_Mapped.referrer_account_id;
                                After_Insert.referrer_coupon_id = Row_Mapped.referrer_coupon_id;
                                After_Insert.referrer_member_id = Row_Mapped.referrer_member_id;
                                After_Insert.reimburse_type = Row_Mapped.reimburse_type;
                                After_Insert.start_date = Row_Mapped.start_date;
                                After_Insert.use_type = Row_Mapped.use_type;
                                After_Insert.value = Row_Mapped.value;
                                After_Insert.void_date = Row_Mapped.void_date;
                                After_Insert.voided_p = Row_Mapped.voided_p;
                                After_Insert.zipfleet_id = Row_Mapped.zipfleet_id;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.coupon_id = After_Insert.coupon_id;
               Log_Rows.amount_redeemed = After_Insert.amount_redeemed;
               Log_Rows.annual_fee_discount = After_Insert.annual_fee_discount;
               Log_Rows.app_fee_discount = After_Insert.app_fee_discount;
               Log_Rows.base_coupon_p = After_Insert.base_coupon_p;
               Log_Rows.bonus_points = After_Insert.bonus_points;
               Log_Rows.campaign_id = After_Insert.campaign_id;
               Log_Rows.commission_base_coupon_id = After_Insert.commission_base_coupon_id;
               Log_Rows.coupon_code = After_Insert.coupon_code;
               Log_Rows.coupon_type = After_Insert.coupon_type;
               Log_Rows.coupon_type_admin = After_Insert.coupon_type_admin;
               ...
               Log_Rows.deleted_p = After_Insert.deleted_p;
               Log_Rows.description = After_Insert.description;
               Log_Rows.end_date = After_Insert.end_date;
               Log_Rows.fee_type_discount = After_Insert.fee_type_discount;
               Log_Rows.last_modified = After_Insert.last_modified;
               Log_Rows.member_id = After_Insert.member_id;
               Log_Rows.number_members_claimed = After_Insert.number_members_claimed;
               Log_Rows.number_redeemed = After_Insert.number_redeemed;
               Log_Rows.number_uses = After_Insert.number_uses;
               Log_Rows.operation = After_Insert.operation;
               Log_Rows.points = After_Insert.points;
               Log_Rows.redeemed_p = After_Insert.redeemed_p;
               Log_Rows.referral_base_coupon_id = After_Insert.referral_base_coupon_id;
               Log_Rows.referral_id = After_Insert.referral_id;
               Log_Rows.referral_program_id = After_Insert.referral_program_id;
               Log_Rows.referral_program_key = After_Insert.referral_program_key;
               Log_Rows.referree_person_id = After_Insert.referree_person_id;
               Log_Rows.referrer_account_id = After_Insert.referrer_account_id;
               Log_Rows.referrer_coupon_id = After_Insert.referrer_coupon_id;
               Log_Rows.referrer_member_id = After_Insert.referrer_member_id;
               Log_Rows.reimburse_type = After_Insert.reimburse_type;
               Log_Rows.start_date = After_Insert.start_date;
               Log_Rows.use_type = After_Insert.use_type;
               Log_Rows.value = After_Insert.value;
               Log_Rows.void_date = After_Insert.void_date;
               Log_Rows.voided_p = After_Insert.voided_p;
	...
	currentComponent="tRedshiftOutput_2";
	    ...
	    if(rowCounttRedshiftOutput_2!=0){
	        ...
	        for(int i_tRedshiftOutput_2=0 ; i_tRedshiftOutput_2 < rowCounttRedshiftOutput_2 ; i_tRedshiftOutput_2++){
				...
				insert_tRedshiftOutput_2 = "INSERT INTO \"" + tableName_tRedshiftOutput_2 + "\" (\"coupon_id\",\"amount_redeemed\",\"annual_fee_discount\",\"app_fee_discount\",\"base_coupon_p\",\"bonus_points\",\"campaign_id\",\"commission_base_coupon_id\",\"coupon_code\",\"coupon_type\",\"coupon_type_admin\",\"creation_date\",\"creation_user\",\"currency_iso\",\"deleted_p\",\"description\",\"end_date\",\"fee_type_discount\",\"last_modified\",\"member_id\",\"number_members_claimed\",\"number_redeemed\",\"number_uses\",\"operation\",\"points\",\"redeemed_p\",\"referral_base_coupon_id\",\"referral_id\",\"referral_program_id\",\"referral_program_key\",\"referree_person_id\",\"referrer_account_id\",\"referrer_coupon_id\",\"referrer_member_id\",\"reimburse_type\",\"start_date\",\"use_type\",\"value\",\"void_date\",\"voided_p\",\"zipfleet_id\") VALUES "+extendInsertValue_tRedshiftOutput_2.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_2 bufferLtRedshiftOutput_2 : exInsertColValueListtRedshiftOutput_2){
				...
				+ 1;
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.coupon_id);
					
	                    counttRedshiftOutput_2++;
	                    
					if(bufferLtRedshiftOutput_2.amount_redeemed==null){
					...
					pstmt_tRedshiftOutput_2.setDouble(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.amount_redeemed);
					...
					if(bufferLtRedshiftOutput_2.annual_fee_discount==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_2.setDouble(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.annual_fee_discount);
					...
					if(bufferLtRedshiftOutput_2.app_fee_discount==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_2.setDouble(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.app_fee_discount);
					...
					if(bufferLtRedshiftOutput_2.base_coupon_p==null){
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.base_coupon_p);
					...
					if(bufferLtRedshiftOutput_2.bonus_points==null){
					...
					pstmt_tRedshiftOutput_2.setInt(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.bonus_points);
					...
					if(bufferLtRedshiftOutput_2.commission_base_coupon_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.commission_base_coupon_id);
					...
					if(bufferLtRedshiftOutput_2.coupon_code==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.coupon_code);
					...
					if(bufferLtRedshiftOutput_2.coupon_type==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.coupon_type);
					...
					if(bufferLtRedshiftOutput_2.coupon_type_admin==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.coupon_type_admin);
					...
					if(bufferLtRedshiftOutput_2.deleted_p==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.deleted_p);
					...
					if(bufferLtRedshiftOutput_2.description==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.description);
					...
					if(bufferLtRedshiftOutput_2.fee_type_discount==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.fee_type_discount);
					...
					if(bufferLtRedshiftOutput_2.number_members_claimed==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setInt(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.number_members_claimed);
					...
					if(bufferLtRedshiftOutput_2.number_redeemed==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setInt(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.number_redeemed);
					...
					if(bufferLtRedshiftOutput_2.number_uses==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setInt(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.number_uses);
					...
					if(bufferLtRedshiftOutput_2.operation==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.operation);
					...
					if(bufferLtRedshiftOutput_2.points==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setInt(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.points);
					...
					if(bufferLtRedshiftOutput_2.redeemed_p==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.redeemed_p);
					...
					if(bufferLtRedshiftOutput_2.referral_base_coupon_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referral_base_coupon_id);
					...
					if(bufferLtRedshiftOutput_2.referral_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referral_id);
					...
					if(bufferLtRedshiftOutput_2.referral_program_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referral_program_id);
					...
					if(bufferLtRedshiftOutput_2.referral_program_key==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referral_program_key);
					...
					if(bufferLtRedshiftOutput_2.referree_person_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referree_person_id);
					...
					if(bufferLtRedshiftOutput_2.referrer_account_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referrer_account_id);
					...
					if(bufferLtRedshiftOutput_2.referrer_coupon_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referrer_coupon_id);
					...
					if(bufferLtRedshiftOutput_2.referrer_member_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.referrer_member_id);
					...
					if(bufferLtRedshiftOutput_2.reimburse_type==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.reimburse_type);
					...
					if(bufferLtRedshiftOutput_2.use_type==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.use_type);
					...
					if(bufferLtRedshiftOutput_2.value==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_2.setDouble(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.value);
					...
					if(bufferLtRedshiftOutput_2.void_date!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_2 = bufferLtRedshiftOutput_2.void_date.getTime();
						if (date_tRedshiftOutput_2 < year1_tRedshiftOutput_2 || date_tRedshiftOutput_2 >= year10000_tRedshiftOutput_2) {
							pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_2.setTimestamp(counttRedshiftOutput_2, new java.sql.Timestamp(date_tRedshiftOutput_2));
					...
					if(bufferLtRedshiftOutput_2.voided_p==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.voided_p);
					...
					if(bufferLtRedshiftOutput_2.zipfleet_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.zipfleet_id);
...
String fileName_tFileOutputDelimited_1 = "";
    ...
    globalMap.put("tFileOutputDelimited_1_FILE_NAME",fileName_tFileOutputDelimited_1);
                String[] headColutFileOutputDelimited_1=new String[41];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.amount_redeemed = null;
					
							row1.annual_fee_discount = null;
					
							row1.app_fee_discount = null;
					
							row1.base_coupon_p = null;
					
							row1.bonus_points = null;
					
							row1.campaign_id = null;
					
							row1.commission_base_coupon_id = null;
					
							row1.coupon_code = null;
					
							row1.coupon_type = null;
					
							row1.coupon_type_admin = null;
							...
							row1.fee_type_discount = null;
					
							row1.last_modified = null;
					
							row1.member_id = null;
					
							row1.number_members_claimed = null;
					
							row1.number_redeemed = null;
					
							row1.number_uses = null;
					
							row1.operation = null;
					
							row1.points = null;
					
							row1.redeemed_p = null;
					
							row1.referral_base_coupon_id = null;
					
							row1.referral_id = null;
					
							row1.referral_program_id = null;
					
							row1.referral_program_key = null;
					
							row1.referree_person_id = null;
					
							row1.referrer_account_id = null;
					
							row1.referrer_coupon_id = null;
					
							row1.referrer_member_id = null;
					
							row1.reimburse_type = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.coupon_id = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'coupon_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.amount_redeemed = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.annual_fee_discount = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.app_fee_discount = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.base_coupon_p = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.bonus_points = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.campaign_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.commission_base_coupon_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.coupon_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.coupon_type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.coupon_type_admin = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.deleted_p = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.fee_type_discount = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.number_members_claimed = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.number_redeemed = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.number_uses = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.points = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.redeemed_p = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.referral_base_coupon_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.referral_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.referral_program_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.referral_program_key = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.referree_person_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.referrer_account_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.referrer_coupon_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.referrer_member_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.reimburse_type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.use_type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.voided_p = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.coupon_id = row1.coupon_id;
row2.amount_redeemed = row1.amount_redeemed;
row2.annual_fee_discount = row1.annual_fee_discount;
row2.app_fee_discount = row1.app_fee_discount;
row2.base_coupon_p = BooleanUtils.boolChar(row1.base_coupon_p);
row2.bonus_points = row1.bonus_points;
row2.campaign_id = row1.campaign_id;
row2.commission_base_coupon_id = row1.commission_base_coupon_id;
row2.coupon_code = StringUtils.trimToNull(row1.coupon_code);
row2.coupon_type = StringUtils.trimToNull(row1.coupon_type);
row2.coupon_type_admin = StringUtils.trimToNull(row1.coupon_type_admin);
...
row2.deleted_p = BooleanUtils.boolChar(row1.deleted_p);
row2.description = StringUtils.trimToNull(row1.description);
row2.end_date = row1.end_date;
row2.fee_type_discount = StringUtils.trimToNull(row1.fee_type_discount);
row2.last_modified = row1.last_modified;
row2.member_id = row1.member_id;
row2.number_members_claimed = row1.number_members_claimed;
row2.number_redeemed = row1.number_redeemed;
row2.number_uses = row1.number_uses;
row2.operation = StringUtils.trimToNull(row1.operation);
row2.points = row1.points;
row2.redeemed_p = BooleanUtils.boolChar(row1.redeemed_p);
row2.referral_base_coupon_id = row1.referral_base_coupon_id;
row2.referral_id = row1.referral_id;
row2.referral_program_id = row1.referral_program_id;
row2.referral_program_key = StringUtils.trimToNull(row1.referral_program_key);
row2.referree_person_id = row1.referree_person_id;
row2.referrer_account_id = row1.referrer_account_id;
row2.referrer_coupon_id = row1.referrer_coupon_id;
row2.referrer_member_id = row1.referrer_member_id;
row2.reimburse_type = StringUtils.trimToNull(row1.reimburse_type);
row2.start_date = row1.start_date;
row2.use_type = StringUtils.trimToNull(row1.use_type);
row2.value = row1.value;
row2.void_date = row1.void_date;
row2.voided_p = BooleanUtils.boolChar(row1.voided_p);
			...
			//row2
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[41];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.coupon_id);
                            rowtFileOutputDelimited_1[1]=row2.amount_redeemed == null ? null : String.valueOf(row2.amount_redeemed);
                            rowtFileOutputDelimited_1[2]=row2.annual_fee_discount == null ? null : String.valueOf(row2.annual_fee_discount);
                            rowtFileOutputDelimited_1[3]=row2.app_fee_discount == null ? null : String.valueOf(row2.app_fee_discount);
                            rowtFileOutputDelimited_1[4]=row2.base_coupon_p == null ? null : row2.base_coupon_p;
                            rowtFileOutputDelimited_1[5]=row2.bonus_points == null ? null : String.valueOf(row2.bonus_points);
                            rowtFileOutputDelimited_1[6]=row2.campaign_id == null ? null : String.valueOf(row2.campaign_id);
                            rowtFileOutputDelimited_1[7]=row2.commission_base_coupon_id == null ? null : String.valueOf(row2.commission_base_coupon_id);
                            rowtFileOutputDelimited_1[8]=row2.coupon_code == null ? null : row2.coupon_code;
                            rowtFileOutputDelimited_1[9]=row2.coupon_type == null ? null : row2.coupon_type;
                            rowtFileOutputDelimited_1[10]=row2.coupon_type_admin == null ? null : row2.coupon_type_admin;
                            rowtFileOutputDelimited_1[11]=row2.creation_date == null ? null : FormatterUtils.format_Date(row2.creation_date, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[12]=row2.creation_user == null ? null : String.valueOf(row2.creation_user);
                            rowtFileOutputDelimited_1[13]=row2.currency_iso == null ? null : row2.currency_iso;
                            rowtFileOutputDelimited_1[14]=row2.deleted_p == null ? null : row2.deleted_p;
                            rowtFileOutputDelimited_1[15]=row2.description == null ? null : row2.description;
                            rowtFileOutputDelimited_1[16]=row2.end_date == null ? null : FormatterUtils.format_Date(row2.end_date, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[17]=row2.fee_type_discount == null ? null : row2.fee_type_discount;
                            rowtFileOutputDelimited_1[18]=row2.last_modified == null ? null : FormatterUtils.format_Date(row2.last_modified, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[19]=row2.member_id == null ? null : String.valueOf(row2.member_id);
                            rowtFileOutputDelimited_1[20]=row2.number_members_claimed == null ? null : String.valueOf(row2.number_members_claimed);
                            rowtFileOutputDelimited_1[21]=row2.number_redeemed == null ? null : String.valueOf(row2.number_redeemed);
                            rowtFileOutputDelimited_1[22]=row2.number_uses == null ? null : String.valueOf(row2.number_uses);
                            rowtFileOutputDelimited_1[23]=row2.operation == null ? null : row2.operation;
                            rowtFileOutputDelimited_1[24]=row2.points == null ? null : String.valueOf(row2.points);
                            rowtFileOutputDelimited_1[25]=row2.redeemed_p == null ? null : row2.redeemed_p;
                            rowtFileOutputDelimited_1[26]=row2.referral_base_coupon_id == null ? null : String.valueOf(row2.referral_base_coupon_id);
                            rowtFileOutputDelimited_1[27]=row2.referral_id == null ? null : String.valueOf(row2.referral_id);
                            rowtFileOutputDelimited_1[28]=row2.referral_program_id == null ? null : String.valueOf(row2.referral_program_id);
                            rowtFileOutputDelimited_1[29]=row2.referral_program_key == null ? null : row2.referral_program_key;
                            rowtFileOutputDelimited_1[30]=row2.referree_person_id == null ? null : String.valueOf(row2.referree_person_id);
                            rowtFileOutputDelimited_1[31]=row2.referrer_account_id == null ? null : String.valueOf(row2.referrer_account_id);
                            rowtFileOutputDelimited_1[32]=row2.referrer_coupon_id == null ? null : String.valueOf(row2.referrer_coupon_id);
                            rowtFileOutputDelimited_1[33]=row2.referrer_member_id == null ? null : String.valueOf(row2.referrer_member_id);
                            rowtFileOutputDelimited_1[34]=row2.reimburse_type == null ? null : row2.reimburse_type;
                            rowtFileOutputDelimited_1[35]=row2.start_date == null ? null : FormatterUtils.format_Date(row2.start_date, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[36]=row2.use_type == null ? null : row2.use_type;
                            rowtFileOutputDelimited_1[37]=row2.value == null ? null : String.valueOf(row2.value);
                            rowtFileOutputDelimited_1[38]=row2.void_date == null ? null : FormatterUtils.format_Date(row2.void_date, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[39]=row2.voided_p == null ? null : row2.voided_p;
                            rowtFileOutputDelimited_1[40]=row2.zipfleet_id == null ? null : String.valueOf(row2.zipfleet_id);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Coupons StageFeed_CouponsClass = new StageFeed_Coupons();

        int exitCode = StageFeed_CouponsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Coupons.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_coupons_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Coupons");
        }
...
/************************************************************************************************
 *     517681 characters generated by Talend Open Studio for Data Integration 
