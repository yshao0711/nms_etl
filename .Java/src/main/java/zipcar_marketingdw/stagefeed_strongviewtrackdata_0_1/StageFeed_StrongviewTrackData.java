...
package zipcar_marketingdw.stagefeed_strongviewtrackdata_0_1;
...
/**
 * Job: StageFeed_StrongviewTrackData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewTrackData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewTrackData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_kOJSUDTREeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewTrackData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewTrackData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_TRACK_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_TRACK_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_TRACK_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData = new byte[0];
			    ...
			    public String track_event_typ;

				public String getTrack_event_typ () {
					return this.track_event_typ;
				}
				
			    public Integer count_of_events;

				public Integer getCount_of_events () {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewTrackData) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.track_event_typ = readString(dis);
					
						this.count_of_events = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.track_event_typ,dos);
					
					// Integer
				
						writeInteger(this.count_of_events,dos);
    ...
    public String toString() {
		...
		sb.append(",track_event_typ="+track_event_typ);
		sb.append(",count_of_events="+String.valueOf(count_of_events));
		...
		sb.append(",message_id="+String.valueOf(message_id));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						...
						String track_event_typ;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String track_event_typ){
							this.track_event_typ = track_event_typ;
							return this;
						}				
						Integer count_of_events;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Integer count_of_events){
							this.count_of_events = count_of_events;
							return this;
						}				
						String email_address;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String email_address){
							this.email_address = email_address;
							return this;
						}				
						String serial_no;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String serial_no){
							this.serial_no = serial_no;
							return this;
						}				
						Long link_id;
						
	            		public BufferLine_tRedshiftOutput_1 c5(Long link_id){
							this.link_id = link_id;
							return this;
						}				
						Long mailing_id;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Long mailing_id){
							this.mailing_id = mailing_id;
							return this;
						}				
						Long message_id;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Long message_id){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"data_captured_dt\",\"track_event_typ\",\"count_of_events\",\"email_address\",\"serial_no\",\"link_id\",\"mailing_id\",\"message_id\",\"user_id\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.track_event_typ = null;
					
							Row_FeedRecord.count_of_events = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.track_event_typ = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.count_of_events = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.message_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.track_event_typ = StringUtils.trimToNull(Row_FeedRecord.track_event_typ);
Record_OutputToDB.count_of_events = Row_FeedRecord.count_of_events;
...
Record_OutputToDB.message_id = Row_FeedRecord.message_id;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.track_event_typ==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.track_event_typ);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.count_of_events==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.count_of_events);
						...
						countertRedshiftOutput_1++;
							...
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.message_id);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.track_event_typ)
                        .c2(Record_OutputToDB.count_of_events)
                        .c3(Record_OutputToDB.email_address)
                        .c4(Record_OutputToDB.serial_no)
                        .c5(Record_OutputToDB.link_id)
                        .c6(Record_OutputToDB.mailing_id)
                        .c7(Record_OutputToDB.message_id)
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.track_event_typ = Record_OutputToDB.track_event_typ;
                                After_Insert.count_of_events = Record_OutputToDB.count_of_events;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.track_event_typ = After_Insert.track_event_typ;
               Log_Rows.count_of_events = After_Insert.count_of_events;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"data_captured_dt\",\"track_event_typ\",\"count_of_events\",\"email_address\",\"serial_no\",\"link_id\",\"mailing_id\",\"message_id\",\"user_id\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.track_event_typ==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.track_event_typ);
					...
					if(bufferLtRedshiftOutput_1.count_of_events==null){
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.count_of_events);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.message_id);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.track_event_typ = null;
					
							row1.count_of_events = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.track_event_typ = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.count_of_events = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.message_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.track_event_typ = StringUtils.trimToNull(row1.track_event_typ);
row2.count_of_events = row1.count_of_events;
...
row2.message_id = row1.message_id;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[9];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.track_event_typ == null ? null : row2.track_event_typ;
                            rowtFileOutputDelimited_1[2]=row2.count_of_events == null ? null : String.valueOf(row2.count_of_events);
                            rowtFileOutputDelimited_1[3]=row2.email_address == null ? null : row2.email_address;
                            rowtFileOutputDelimited_1[4]=row2.serial_no == null ? null : row2.serial_no;
                            rowtFileOutputDelimited_1[5]=row2.link_id == null ? null : String.valueOf(row2.link_id);
                            rowtFileOutputDelimited_1[6]=row2.mailing_id == null ? null : String.valueOf(row2.mailing_id);
                            rowtFileOutputDelimited_1[7]=row2.message_id == null ? null : String.valueOf(row2.message_id);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewTrackData StageFeed_StrongviewTrackDataClass = new StageFeed_StrongviewTrackData();

        int exitCode = StageFeed_StrongviewTrackDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewTrackData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewtrackdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewTrackData");
        }
...
/************************************************************************************************
 *     324144 characters generated by Talend Open Studio for Data Integration 
