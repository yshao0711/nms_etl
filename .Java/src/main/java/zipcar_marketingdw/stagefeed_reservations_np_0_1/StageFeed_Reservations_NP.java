...
package zipcar_marketingdw.stagefeed_reservations_np_0_1;
...
/**
 * Job: StageFeed_Reservations_NP Purpose: Stage the Feed files from NP<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Reservations_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Reservations_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Ymz_wHCnEeilHqJCtG9hZw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Reservations_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Reservations_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP) {
...
globalMap.put("currentFeed", FeedFile.FileType.RESERVATIONS_NP);
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Truncated Table - " + globalMap.get("tableName"),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 3, "Truncated Table - " + globalMap.get("tableName"), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Truncated Table - " + globalMap.get("tableName")); 
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Reservations_NP) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.COMMUNITY_ID = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.START_LOCATION_ID = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.START_LATITUDE = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.START_LONGITUDE = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.END_LATITUDE = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.END_LONGITUDE = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.COMMUNITY_ID,dos);
					...
					// Long
						...
						if(this.START_LOCATION_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.START_LOCATION_ID);
		            	}
					...
					// Double
						...
						if(this.START_LATITUDE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.START_LATITUDE);
		            	}
					...
					// Double
						...
						if(this.START_LONGITUDE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.START_LONGITUDE);
		            	}
					...
					// Double
						...
						if(this.END_LATITUDE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.END_LATITUDE);
		            	}
					...
					// Double
						...
						if(this.END_LONGITUDE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.END_LONGITUDE);
		            	}
    ...
    public String toString() {
		...
		sb.append(",RIDE_ID="+String.valueOf(RIDE_ID));
		...
		sb.append(",COMMUNITY_ID="+COMMUNITY_ID);
		sb.append(",DRIVER_ID="+String.valueOf(DRIVER_ID));
		sb.append(",START_LOCATION_ID="+String.valueOf(START_LOCATION_ID));
		sb.append(",END_LOCATION_ID="+String.valueOf(END_LOCATION_ID));
		sb.append(",START_LATITUDE="+String.valueOf(START_LATITUDE));
		sb.append(",START_LONGITUDE="+String.valueOf(START_LONGITUDE));
		sb.append(",END_LATITUDE="+String.valueOf(END_LATITUDE));
		sb.append(",END_LONGITUDE="+String.valueOf(END_LONGITUDE));
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c1(Long RIDE_ID){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c3(Long ACCOUNT_ID){
							this.ACCOUNT_ID = ACCOUNT_ID;
							return this;
						}				
						String TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String TYPE){
							this.TYPE = TYPE;
							return this;
						}				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c7(java.util.Date SWIPED_IN_DATE){
							this.SWIPED_IN_DATE = SWIPED_IN_DATE;
							return this;
						}				
						java.util.Date SWIPED_OUT_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c8(java.util.Date SWIPED_OUT_DATE){
							this.SWIPED_OUT_DATE = SWIPED_OUT_DATE;
							return this;
						}				
						java.util.Date CANCEL_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c9(java.util.Date CANCEL_DATE){
							this.CANCEL_DATE = CANCEL_DATE;
							return this;
						}				
						Double TOTAL_HOURS;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Double TOTAL_HOURS){
							this.TOTAL_HOURS = TOTAL_HOURS;
							return this;
						}				
						Double TOTAL_DISTANCE;
						
	            		public BufferLine_tRedshiftOutput_1 c11(Double TOTAL_DISTANCE){
							this.TOTAL_DISTANCE = TOTAL_DISTANCE;
							return this;
						}				
						Double UP_REVENUE;
						
	            		public BufferLine_tRedshiftOutput_1 c12(Double UP_REVENUE){
							this.UP_REVENUE = UP_REVENUE;
							return this;
						}				
						String CURRENCY_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String CURRENCY_ISO){
							this.CURRENCY_ISO = CURRENCY_ISO;
							return this;
						}				
						String STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String STATUS){
							this.STATUS = STATUS;
							return this;
						}				
						Long VEHICLE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Long VEHICLE_ID){
							this.VEHICLE_ID = VEHICLE_ID;
							return this;
						}				
						String FLEET_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String FLEET_NAME){
							this.FLEET_NAME = FLEET_NAME;
							return this;
						}				
						String NOBILL_P;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String NOBILL_P){
							this.NOBILL_P = NOBILL_P;
							return this;
						}				
						String DISTANCE_MEASURE;
						
	            		public BufferLine_tRedshiftOutput_1 c18(String DISTANCE_MEASURE){
							this.DISTANCE_MEASURE = DISTANCE_MEASURE;
							return this;
						}				
						String LATE_RETURNS_P;
						
	            		public BufferLine_tRedshiftOutput_1 c19(String LATE_RETURNS_P){
							this.LATE_RETURNS_P = LATE_RETURNS_P;
							return this;
						}				
						String COMMUNITY_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c20(String COMMUNITY_ID){
							this.COMMUNITY_ID = COMMUNITY_ID;
							return this;
						}				
						Long DRIVER_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c21(Long DRIVER_ID){
							this.DRIVER_ID = DRIVER_ID;
							return this;
						}				
						Long START_LOCATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c22(Long START_LOCATION_ID){
							this.START_LOCATION_ID = START_LOCATION_ID;
							return this;
						}				
						Long END_LOCATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c23(Long END_LOCATION_ID){
							this.END_LOCATION_ID = END_LOCATION_ID;
							return this;
						}				
						Double START_LATITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c24(Double START_LATITUDE){
							this.START_LATITUDE = START_LATITUDE;
							return this;
						}				
						Double START_LONGITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c25(Double START_LONGITUDE){
							this.START_LONGITUDE = START_LONGITUDE;
							return this;
						}				
						Double END_LATITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c26(Double END_LATITUDE){
							this.END_LATITUDE = END_LATITUDE;
							return this;
						}				
						Double END_LONGITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c27(Double END_LONGITUDE){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"RESERVATION_ID\",\"RIDE_ID\",\"MEMBER_ID\",\"ACCOUNT_ID\",\"TYPE\",\"START_DATE\",\"END_DATE\",\"SWIPED_IN_DATE\",\"SWIPED_OUT_DATE\",\"CANCEL_DATE\",\"TOTAL_HOURS\",\"TOTAL_DISTANCE\",\"UP_REVENUE\",\"CURRENCY_ISO\",\"STATUS\",\"VEHICLE_ID\",\"FLEET_NAME\",\"NOBILL_P\",\"DISTANCE_MEASURE\",\"LATE_RETURNS_P\",\"COMMUNITY_ID\",\"DRIVER_ID\",\"START_LOCATION_ID\",\"END_LOCATION_ID\",\"START_LATITUDE\",\"START_LONGITUDE\",\"END_LATITUDE\",\"END_LONGITUDE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_Feed.SWIPED_IN_DATE = null;
					
							Row_Feed.SWIPED_OUT_DATE = null;
					
							Row_Feed.CANCEL_DATE = null;
					
							Row_Feed.TOTAL_HOURS = null;
					
							Row_Feed.TOTAL_DISTANCE = null;
					
							Row_Feed.UP_REVENUE = null;
					
							Row_Feed.CURRENCY_ISO = null;
					
							Row_Feed.STATUS = null;
					
							Row_Feed.VEHICLE_ID = null;
					
							Row_Feed.FLEET_NAME = null;
					
							Row_Feed.NOBILL_P = null;
					
							Row_Feed.DISTANCE_MEASURE = null;
					
							Row_Feed.LATE_RETURNS_P = null;
					
							Row_Feed.COMMUNITY_ID = null;
					
							Row_Feed.DRIVER_ID = null;
					
							Row_Feed.START_LOCATION_ID = null;
					
							Row_Feed.END_LOCATION_ID = null;
					
							Row_Feed.START_LATITUDE = null;
					
							Row_Feed.START_LONGITUDE = null;
					
							Row_Feed.END_LATITUDE = null;
					
							Row_Feed.END_LONGITUDE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.RIDE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Feed.SWIPED_IN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Feed.SWIPED_OUT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Feed.CANCEL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.TOTAL_HOURS = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.TOTAL_DISTANCE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.UP_REVENUE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.VEHICLE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.FLEET_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.NOBILL_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.DISTANCE_MEASURE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.LATE_RETURNS_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Feed.COMMUNITY_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.START_LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.END_LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.START_LATITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.START_LONGITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.END_LATITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.END_LONGITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Row_Mapped.RIDE_ID = Row_Feed.RIDE_ID;
Row_Mapped.MEMBER_ID = Row_Feed.MEMBER_ID;
Row_Mapped.ACCOUNT_ID = Row_Feed.ACCOUNT_ID;
Row_Mapped.TYPE = StringUtils.trimToNull(Row_Feed.TYPE);
Row_Mapped.START_DATE = Row_Feed.START_DATE;
Row_Mapped.END_DATE = Row_Feed.END_DATE;
Row_Mapped.SWIPED_IN_DATE = Row_Feed.SWIPED_IN_DATE;
Row_Mapped.SWIPED_OUT_DATE = Row_Feed.SWIPED_OUT_DATE;
Row_Mapped.CANCEL_DATE = Row_Feed.CANCEL_DATE;
Row_Mapped.TOTAL_HOURS = Row_Feed.TOTAL_HOURS;
Row_Mapped.TOTAL_DISTANCE = Row_Feed.TOTAL_DISTANCE;
Row_Mapped.DISTANCE_MEASURE = StringUtils.trimToNull(Row_Feed.DISTANCE_MEASURE);
Row_Mapped.UP_REVENUE = Row_Feed.UP_REVENUE;
Row_Mapped.CURRENCY_ISO = StringUtils.trimToNull(Row_Feed.CURRENCY_ISO);
Row_Mapped.NOBILL_P = BooleanUtils.boolChar(Row_Feed.NOBILL_P);
Row_Mapped.STATUS = StringUtils.trimToNull(Row_Feed.STATUS);
Row_Mapped.VEHICLE_ID = Row_Feed.VEHICLE_ID;
Row_Mapped.FLEET_NAME = StringUtils.trimToNull(Row_Feed.FLEET_NAME);
Row_Mapped.LATE_RETURNS_P = BooleanUtils.boolChar(Row_Feed.LATE_RETURNS_P);
Row_Mapped.COMMUNITY_ID = Row_Feed.COMMUNITY_ID;
Row_Mapped.DRIVER_ID = Row_Feed.DRIVER_ID;
Row_Mapped.START_LOCATION_ID = Row_Feed.START_LOCATION_ID;
Row_Mapped.END_LOCATION_ID = Row_Feed.END_LOCATION_ID;
Row_Mapped.START_LATITUDE = Row_Feed.START_LATITUDE;
Row_Mapped.START_LONGITUDE = Row_Feed.START_LONGITUDE;
Row_Mapped.END_LATITUDE = Row_Feed.END_LATITUDE;
Row_Mapped.END_LONGITUDE = Row_Feed.END_LONGITUDE;
    nb_line_tJavaRow_2++;   
 ...
 */
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
      ope_tFilterRow_2.matches((Row_Mapped.RESERVATION_ID != null 
&& Row_Mapped.MEMBER_ID != null
    ...
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(row3 == null){ 
               ...
               row3.RESERVATION_ID = Row_Mapped.RESERVATION_ID;
               row3.RIDE_ID = Row_Mapped.RIDE_ID;
               row3.MEMBER_ID = Row_Mapped.MEMBER_ID;
               row3.ACCOUNT_ID = Row_Mapped.ACCOUNT_ID;
               row3.TYPE = Row_Mapped.TYPE;
               row3.START_DATE = Row_Mapped.START_DATE;
               row3.END_DATE = Row_Mapped.END_DATE;
               row3.SWIPED_IN_DATE = Row_Mapped.SWIPED_IN_DATE;
               row3.SWIPED_OUT_DATE = Row_Mapped.SWIPED_OUT_DATE;
               row3.CANCEL_DATE = Row_Mapped.CANCEL_DATE;
               row3.TOTAL_HOURS = Row_Mapped.TOTAL_HOURS;
               row3.TOTAL_DISTANCE = Row_Mapped.TOTAL_DISTANCE;
               row3.UP_REVENUE = Row_Mapped.UP_REVENUE;
               row3.CURRENCY_ISO = Row_Mapped.CURRENCY_ISO;
               row3.STATUS = Row_Mapped.STATUS;
               row3.VEHICLE_ID = Row_Mapped.VEHICLE_ID;
               row3.FLEET_NAME = Row_Mapped.FLEET_NAME;
               row3.NOBILL_P = Row_Mapped.NOBILL_P;
               row3.DISTANCE_MEASURE = Row_Mapped.DISTANCE_MEASURE;
               row3.LATE_RETURNS_P = Row_Mapped.LATE_RETURNS_P;
               row3.COMMUNITY_ID = Row_Mapped.COMMUNITY_ID;
               row3.DRIVER_ID = Row_Mapped.DRIVER_ID;
               row3.START_LOCATION_ID = Row_Mapped.START_LOCATION_ID;
               row3.END_LOCATION_ID = Row_Mapped.END_LOCATION_ID;
               row3.START_LATITUDE = Row_Mapped.START_LATITUDE;
               row3.START_LONGITUDE = Row_Mapped.START_LONGITUDE;
               row3.END_LATITUDE = Row_Mapped.END_LATITUDE;
               row3.END_LONGITUDE = Row_Mapped.END_LONGITUDE;    
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(row3.RESERVATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.RESERVATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.RIDE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.RIDE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.MEMBER_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.MEMBER_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.ACCOUNT_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.ACCOUNT_ID);
						...
						countertRedshiftOutput_1++;
							...
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.START_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = row3.START_DATE.getTime();
						...
						countertRedshiftOutput_1++;
							...
							if(row3.END_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = row3.END_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(row3.SWIPED_IN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = row3.SWIPED_IN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(row3.SWIPED_OUT_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = row3.SWIPED_OUT_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(row3.CANCEL_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = row3.CANCEL_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(row3.TOTAL_HOURS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,row3.TOTAL_HOURS);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.TOTAL_DISTANCE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,row3.TOTAL_DISTANCE);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.UP_REVENUE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,row3.UP_REVENUE);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.CURRENCY_ISO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.CURRENCY_ISO);
						...
						countertRedshiftOutput_1++;
							...
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.STATUS);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.VEHICLE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.VEHICLE_ID);
						...
						countertRedshiftOutput_1++;
							...
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.FLEET_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.NOBILL_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.NOBILL_P);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.DISTANCE_MEASURE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.DISTANCE_MEASURE);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.LATE_RETURNS_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.LATE_RETURNS_P);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.COMMUNITY_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,row3.COMMUNITY_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.DRIVER_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.DRIVER_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.START_LOCATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.START_LOCATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.END_LOCATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,row3.END_LOCATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.START_LATITUDE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,row3.START_LATITUDE);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.START_LONGITUDE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,row3.START_LONGITUDE);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.END_LATITUDE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,row3.END_LATITUDE);
						...
						countertRedshiftOutput_1++;
							...
							if(row3.END_LONGITUDE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,row3.END_LONGITUDE);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c5(row3.START_DATE)
                        .c6(row3.END_DATE)
                        .c7(row3.SWIPED_IN_DATE)
                        .c8(row3.SWIPED_OUT_DATE)
                        .c9(row3.CANCEL_DATE)
                        .c10(row3.TOTAL_HOURS)
                        .c11(row3.TOTAL_DISTANCE)
                        .c12(row3.UP_REVENUE)
                        .c13(row3.CURRENCY_ISO)
                        .c14(row3.STATUS)
                        .c15(row3.VEHICLE_ID)
                        .c16(row3.FLEET_NAME)
                        .c17(row3.NOBILL_P)
                        .c18(row3.DISTANCE_MEASURE)
                        .c19(row3.LATE_RETURNS_P)
                        .c20(row3.COMMUNITY_ID)
                        .c21(row3.DRIVER_ID)
                        .c22(row3.START_LOCATION_ID)
                        .c23(row3.END_LOCATION_ID)
                        .c24(row3.START_LATITUDE)
                        .c25(row3.START_LONGITUDE)
                        .c26(row3.END_LATITUDE)
                        .c27(row3.END_LONGITUDE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.RESERVATION_ID = row3.RESERVATION_ID;
                                After_Insert.RIDE_ID = row3.RIDE_ID;
                                After_Insert.MEMBER_ID = row3.MEMBER_ID;
                                After_Insert.ACCOUNT_ID = row3.ACCOUNT_ID;
                                After_Insert.TYPE = row3.TYPE;
                                After_Insert.START_DATE = row3.START_DATE;
                                After_Insert.END_DATE = row3.END_DATE;
                                After_Insert.SWIPED_IN_DATE = row3.SWIPED_IN_DATE;
                                After_Insert.SWIPED_OUT_DATE = row3.SWIPED_OUT_DATE;
                                After_Insert.CANCEL_DATE = row3.CANCEL_DATE;
                                After_Insert.TOTAL_HOURS = row3.TOTAL_HOURS;
                                After_Insert.TOTAL_DISTANCE = row3.TOTAL_DISTANCE;
                                After_Insert.UP_REVENUE = row3.UP_REVENUE;
                                After_Insert.CURRENCY_ISO = row3.CURRENCY_ISO;
                                After_Insert.STATUS = row3.STATUS;
                                After_Insert.VEHICLE_ID = row3.VEHICLE_ID;
                                After_Insert.FLEET_NAME = row3.FLEET_NAME;
                                After_Insert.NOBILL_P = row3.NOBILL_P;
                                After_Insert.DISTANCE_MEASURE = row3.DISTANCE_MEASURE;
                                After_Insert.LATE_RETURNS_P = row3.LATE_RETURNS_P;
                                After_Insert.COMMUNITY_ID = row3.COMMUNITY_ID;
                                After_Insert.DRIVER_ID = row3.DRIVER_ID;
                                After_Insert.START_LOCATION_ID = row3.START_LOCATION_ID;
                                After_Insert.END_LOCATION_ID = row3.END_LOCATION_ID;
                                After_Insert.START_LATITUDE = row3.START_LATITUDE;
                                After_Insert.START_LONGITUDE = row3.START_LONGITUDE;
                                After_Insert.END_LATITUDE = row3.END_LATITUDE;
                                After_Insert.END_LONGITUDE = row3.END_LONGITUDE;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.RIDE_ID = After_Insert.RIDE_ID;
               ...
               Log_Rows.STATUS = After_Insert.STATUS;
               Log_Rows.VEHICLE_ID = After_Insert.VEHICLE_ID;
               Log_Rows.FLEET_NAME = After_Insert.FLEET_NAME;
               ...
               Log_Rows.COMMUNITY_ID = After_Insert.COMMUNITY_ID;
               Log_Rows.DRIVER_ID = After_Insert.DRIVER_ID;
               Log_Rows.START_LOCATION_ID = After_Insert.START_LOCATION_ID;
               Log_Rows.END_LOCATION_ID = After_Insert.END_LOCATION_ID;
               Log_Rows.START_LATITUDE = After_Insert.START_LATITUDE;
               Log_Rows.START_LONGITUDE = After_Insert.START_LONGITUDE;
               Log_Rows.END_LATITUDE = After_Insert.END_LATITUDE;
               Log_Rows.END_LONGITUDE = After_Insert.END_LONGITUDE;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"RESERVATION_ID\",\"RIDE_ID\",\"MEMBER_ID\",\"ACCOUNT_ID\",\"TYPE\",\"START_DATE\",\"END_DATE\",\"SWIPED_IN_DATE\",\"SWIPED_OUT_DATE\",\"CANCEL_DATE\",\"TOTAL_HOURS\",\"TOTAL_DISTANCE\",\"UP_REVENUE\",\"CURRENCY_ISO\",\"STATUS\",\"VEHICLE_ID\",\"FLEET_NAME\",\"NOBILL_P\",\"DISTANCE_MEASURE\",\"LATE_RETURNS_P\",\"COMMUNITY_ID\",\"DRIVER_ID\",\"START_LOCATION_ID\",\"END_LOCATION_ID\",\"START_LATITUDE\",\"START_LONGITUDE\",\"END_LATITUDE\",\"END_LONGITUDE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.RIDE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RIDE_ID);
					...
					if(bufferLtRedshiftOutput_1.STATUS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.STATUS);
					...
					if(bufferLtRedshiftOutput_1.FLEET_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FLEET_NAME);
					...
					if(bufferLtRedshiftOutput_1.COMMUNITY_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.COMMUNITY_ID);
					...
					if(bufferLtRedshiftOutput_1.START_LOCATION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.START_LOCATION_ID);
					...
					if(bufferLtRedshiftOutput_1.START_LATITUDE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.START_LATITUDE);
					...
					if(bufferLtRedshiftOutput_1.START_LONGITUDE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.START_LONGITUDE);
					...
					if(bufferLtRedshiftOutput_1.END_LATITUDE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.END_LATITUDE);
					...
					if(bufferLtRedshiftOutput_1.END_LONGITUDE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.END_LONGITUDE);
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Archived Feed File: " + ((String)globalMap.get("fileName")),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Archived Feed File: " + ((String)globalMap.get("fileName")), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Archived Feed File: " + ((String)globalMap.get("fileName"))); 
...
String fileName_tFileOutputDelimited_1 = "";
    ...
    globalMap.put("tFileOutputDelimited_1_FILE_NAME",fileName_tFileOutputDelimited_1);
                String[] headColutFileOutputDelimited_1=new String[28];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.COMMUNITY_ID = null;
					
							row1.DRIVER_ID = null;
					
							row1.START_LOCATION_ID = null;
					
							row1.END_LOCATION_ID = null;
					
							row1.START_LATITUDE = null;
					
							row1.START_LONGITUDE = null;
					
							row1.END_LATITUDE = null;
					
							row1.END_LONGITUDE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.RIDE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.FLEET_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.COMMUNITY_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.START_LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.START_LATITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.START_LONGITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.END_LATITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.END_LONGITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.STATUS = StringUtils.trimToNull(row1.STATUS);
row2.VEHICLE_ID = row1.VEHICLE_ID;
row2.FLEET_NAME = StringUtils.trimToNull(row1.FLEET_NAME);
row2.LATE_RETURNS_P = BooleanUtils.boolChar(row1.LATE_RETURNS_P);
row2.COMMUNITY_ID = row1.COMMUNITY_ID;
row2.DRIVER_ID = row1.DRIVER_ID;
row2.START_LOCATION_ID = row1.START_LOCATION_ID;
row2.END_LOCATION_ID = row1.END_LOCATION_ID;
row2.START_LATITUDE = row1.START_LATITUDE;
row2.START_LONGITUDE = row1.START_LONGITUDE;
row2.END_LATITUDE = row1.END_LATITUDE;
row2.END_LONGITUDE = row1.END_LONGITUDE;
    nb_line_tJavaRow_3++;   
			...
			//row2
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[28];
                            rowtFileOutputDelimited_1[0]=row2.RESERVATION_ID == null ? null : String.valueOf(row2.RESERVATION_ID);
                            rowtFileOutputDelimited_1[1]=row2.RIDE_ID == null ? null : String.valueOf(row2.RIDE_ID);
                            rowtFileOutputDelimited_1[2]=row2.MEMBER_ID == null ? null : String.valueOf(row2.MEMBER_ID);
                            rowtFileOutputDelimited_1[3]=row2.ACCOUNT_ID == null ? null : String.valueOf(row2.ACCOUNT_ID);
                            rowtFileOutputDelimited_1[4]=row2.TYPE == null ? null : row2.TYPE;
                            rowtFileOutputDelimited_1[5]=row2.START_DATE == null ? null : FormatterUtils.format_Date(row2.START_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[6]=row2.END_DATE == null ? null : FormatterUtils.format_Date(row2.END_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[7]=row2.SWIPED_IN_DATE == null ? null : FormatterUtils.format_Date(row2.SWIPED_IN_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[8]=row2.SWIPED_OUT_DATE == null ? null : FormatterUtils.format_Date(row2.SWIPED_OUT_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[9]=row2.CANCEL_DATE == null ? null : FormatterUtils.format_Date(row2.CANCEL_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[10]=row2.TOTAL_HOURS == null ? null : String.valueOf(row2.TOTAL_HOURS);
                            rowtFileOutputDelimited_1[11]=row2.TOTAL_DISTANCE == null ? null : String.valueOf(row2.TOTAL_DISTANCE);
                            rowtFileOutputDelimited_1[12]=row2.UP_REVENUE == null ? null : String.valueOf(row2.UP_REVENUE);
                            rowtFileOutputDelimited_1[13]=row2.CURRENCY_ISO == null ? null : row2.CURRENCY_ISO;
                            rowtFileOutputDelimited_1[14]=row2.STATUS == null ? null : row2.STATUS;
                            rowtFileOutputDelimited_1[15]=row2.VEHICLE_ID == null ? null : String.valueOf(row2.VEHICLE_ID);
                            rowtFileOutputDelimited_1[16]=row2.FLEET_NAME == null ? null : row2.FLEET_NAME;
                            rowtFileOutputDelimited_1[17]=row2.NOBILL_P == null ? null : row2.NOBILL_P;
                            rowtFileOutputDelimited_1[18]=row2.DISTANCE_MEASURE == null ? null : row2.DISTANCE_MEASURE;
                            rowtFileOutputDelimited_1[19]=row2.LATE_RETURNS_P == null ? null : row2.LATE_RETURNS_P;
                            rowtFileOutputDelimited_1[20]=row2.COMMUNITY_ID == null ? null : row2.COMMUNITY_ID;
                            rowtFileOutputDelimited_1[21]=row2.DRIVER_ID == null ? null : String.valueOf(row2.DRIVER_ID);
                            rowtFileOutputDelimited_1[22]=row2.START_LOCATION_ID == null ? null : String.valueOf(row2.START_LOCATION_ID);
                            rowtFileOutputDelimited_1[23]=row2.END_LOCATION_ID == null ? null : String.valueOf(row2.END_LOCATION_ID);
                            rowtFileOutputDelimited_1[24]=row2.START_LATITUDE == null ? null : String.valueOf(row2.START_LATITUDE);
                            rowtFileOutputDelimited_1[25]=row2.START_LONGITUDE == null ? null : String.valueOf(row2.START_LONGITUDE);
                            rowtFileOutputDelimited_1[26]=row2.END_LATITUDE == null ? null : String.valueOf(row2.END_LATITUDE);
                            rowtFileOutputDelimited_1[27]=row2.END_LONGITUDE == null ? null : String.valueOf(row2.END_LONGITUDE);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Reservations_NP StageFeed_Reservations_NPClass = new StageFeed_Reservations_NP();

        int exitCode = StageFeed_Reservations_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Reservations_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_reservations_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Reservations_NP");
        }
...
/************************************************************************************************
 *     457380 characters generated by Talend Open Studio for Data Integration 
 *     on the October 16, 2018 5:21:45 PM CDT
 ************************************************************************************************/