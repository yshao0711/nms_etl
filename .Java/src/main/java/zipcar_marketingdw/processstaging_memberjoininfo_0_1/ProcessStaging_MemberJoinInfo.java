...
package zipcar_marketingdw.processstaging_memberjoininfo_0_1;
...
/**
 * Job: ProcessStaging_MemberJoinInfo Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_MemberJoinInfo implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_MemberJoinInfo";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_prU3wMryEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_MemberJoinInfo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_MemberJoinInfo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberJoinInfo) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "member_join_info";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_member_join_info";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_member_join_info\n(\n	member_id,\n	account_id,\n	join_date,\n	join_zipfleet_id,\n	join_rate_plan_id,\n	join_app_fee,\n	join_app_fee_usd,\n	join_app_fee_currency_iso,\n	join_annual_fee,\n	join_annual_fee_usd,\n	join_ann_fee_currency_iso,\n	join_annlzd_ann_fee,\n	join_annlzd_ann_fee_usd,\n	join_coupon_id,\n	join_coupon,\n	join_driving_credit,\n	join_driving_credit_usd,\n	join_cash_credit,\n	join_cash_credit_usd,\n	join_rp_credit,\n	join_rp_credit_usd,\n	join_rp_credit_currency_iso,\n	join_manual_driving_credit,\n	join_manual_driving_credit_usd,\n	join_manual_currency_iso,\n	join_waive_first_annual_fee_p,\n	last_join_date,\n	last_join_zipfleet_id,\n	last_join_rate_plan_id,\n	last_rejoin_date,\n	last_rejoin_rate_plan_id,\n	last_rejoin_zipfleet_id,\n	deleted_date,\n	last_join_account_id,\n	last_join_affiliate_id,\n	join_account_id,\n	join_affiliate_id,\n	last_changed_rate_plan_id,\n	last_changed_rate_plan_date,\n    imported_date\n)\nSELECT \n	member_id,\n	account_id,\n	join_date,\n	join_zipfleet_id,\n	join_rate_plan_id,\n	join_app_fee,\n	join_app_fee_usd,\n	join_app_fee_currency_iso,\n	join_annual_fee,\n	join_annual_fee_usd,\n	join_ann_fee_currency_iso,\n	join_annlzd_ann_fee,\n	join_annlzd_ann_fee_usd,\n	join_coupon_id,\n	join_coupon,\n	join_driving_credit,\n	join_driving_credit_usd,\n	join_cash_credit,\n	join_cash_credit_usd,\n	join_rp_credit,\n	join_rp_credit_usd,\n	join_rp_credit_currency_iso,\n	join_manual_driving_credit,\n	join_manual_driving_credit_usd,\n	join_manual_currency_iso,\n	join_waive_first_annual_fee_p,\n	last_join_date,\n	last_join_zipfleet_id,\n	last_join_rate_plan_id,\n	last_rejoin_date,\n	last_rejoin_rate_plan_id,\n	last_rejoin_zipfleet_id,\n	deleted_date,\n	last_join_account_id,\n	last_join_affiliate_id,\n	join_account_id,\n	join_affiliate_id,\n	last_changed_rate_plan_id,\n	last_changed_rate_plan_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.member_join_info\nMINUS\nSELECT \n	member_id,\n	account_id,\n	join_date,\n	join_zipfleet_id,\n	join_rate_plan_id,\n	join_app_fee,\n	join_app_fee_usd,\n	join_app_fee_currency_iso,\n	join_annual_fee,\n	join_annual_fee_usd,\n	join_ann_fee_currency_iso,\n	join_annlzd_ann_fee,\n	join_annlzd_ann_fee_usd,\n	join_coupon_id,\n	join_coupon,\n	join_driving_credit,\n	join_driving_credit_usd,\n	join_cash_credit,\n	join_cash_credit_usd,\n	join_rp_credit,\n	join_rp_credit_usd,\n	join_rp_credit_currency_iso,\n	join_manual_driving_credit,\n	join_manual_driving_credit_usd,\n	join_manual_currency_iso,\n	join_waive_first_annual_fee_p,\n	last_join_date,\n	last_join_zipfleet_id,\n	last_join_rate_plan_id,\n	last_rejoin_date,\n	last_rejoin_rate_plan_id,\n	last_rejoin_zipfleet_id,\n	deleted_date,\n	last_join_account_id,\n	last_join_affiliate_id,\n	join_account_id,\n	join_affiliate_id,\n	last_changed_rate_plan_id,\n	last_changed_rate_plan_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_member_join_info\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".member_join_info";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_MemberJoinInfo ProcessStaging_MemberJoinInfoClass = new ProcessStaging_MemberJoinInfo();

        int exitCode = ProcessStaging_MemberJoinInfoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_MemberJoinInfo.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_memberjoininfo_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_MemberJoinInfo");
        }
...
/************************************************************************************************
 *     138289 characters generated by Talend Open Studio for Data Integration 
