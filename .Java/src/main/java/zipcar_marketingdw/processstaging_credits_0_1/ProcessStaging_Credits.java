...
package zipcar_marketingdw.processstaging_credits_0_1;
...
/**
 * Job: ProcessStaging_Credits Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Credits implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Credits";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_rBsiUDWYEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Credits.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Credits.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Credits = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Credits = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Credits.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Credits.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Credits = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Credits = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Credits, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Credits, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Credits) {
...
"\nINSERT INTO {{marketing.schema}}.r_credit\n(\n	credit_id,\n	account_id,\n	member_id,\n	reservation_id,\n	zipfleet_id,\n	currency_iso,\n	credit_type,\n	credit_used,\n	credit_expired,\n	credit_unused,\n	description,\n	manual_credit_p,\n	operation,\n	value,\n	start_date,\n	end_date,\n	void_date,\n	giver_account_id,\n	usage_only_p,\n	reference_id,\n	creation_user,\n	creation_date,\n	internal_description,\n	modifying_user,\n	last_modified,\n	driving_credit_reason_code_id,\n	imported_date\n)\nSELECT \n	credit_id,\n	account_id,\n	member_id,\n	reservation_id,\n	zipfleet_id,\n	currency_iso,\n	credit_type,\n	credit_used,\n	credit_expired,\n	credit_unused,\n	description,\n	manual_credit_p,\n	operation,\n	value,\n	start_date,\n	end_date,\n	void_date,\n	giver_account_id,\n	usage_only_p,\n	reference_id,\n	creation_user,\n	creation_date,\n	internal_description,\n	modifying_user,\n	last_modified,\n	driving_credit_reason_code_id,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.credits\nMINUS\nSELECT \n	credit_id,\n	account_id,\n	member_id,\n	reservation_id,\n	zipfleet_id,\n	currency_iso,\n	credit_type,\n	credit_used,\n	credit_expired,\n	credit_unused,\n	description,\n	manual_credit_p,\n	operation,\n	value,\n	start_date,\n	end_date,\n	void_date,\n	giver_account_id,\n	usage_only_p,\n	reference_id,\n	creation_user,\n	creation_date,\n	internal_description,\n	modifying_user,\n	last_modified,\n	driving_credit_reason_code_id,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_credit\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".credits";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Credits ProcessStaging_CreditsClass = new ProcessStaging_Credits();

        int exitCode = ProcessStaging_CreditsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Credits.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_credits_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Credits");
        }
...
/************************************************************************************************
 *     136563 characters generated by Talend Open Studio for Data Integration 
