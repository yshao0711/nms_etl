...
package zipcar_marketingdw.task_monitor_unmapped_postal_codes_0_1;
...
/**
 * Job: Task_Monitor_Unmapped_Postal_Codes Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Task_Monitor_Unmapped_Postal_Codes implements TalendJob {
...
public Object getSharedMap(){
	...
	private final String jobName = "Task_Monitor_Unmapped_Postal_Codes";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_oPo3YCktEeikmpP71yGSvg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Task_Monitor_Unmapped_Postal_Codes.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Task_Monitor_Unmapped_Postal_Codes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class external_configStruct implements routines.system.IPersistableRow<external_configStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes = new byte[0];
			    ...
			    public String total_unmapped_postal_codes;

				public String getTotal_unmapped_postal_codes () {
					return this.total_unmapped_postal_codes;
				}
				
			    public String total_unmapped_postal_codes_with_reservations;

				public String getTotal_unmapped_postal_codes_with_reservations () {
					return this.total_unmapped_postal_codes_with_reservations;
				}
				
			    public String total_unmapped_reservations;

				public String getTotal_unmapped_reservations () {
					return this.total_unmapped_reservations;
				}
				
			    public String average_unmapped_reservations;

				public String getAverage_unmapped_reservations () {
					return this.average_unmapped_reservations;
				}
				
			    public String total_reservations_business;

				public String getTotal_reservations_business () {
					return this.total_reservations_business;
				}
				
			    public String average_reservations_business;

				public String getAverage_reservations_business () {
					return this.average_reservations_business;
				}
				
			    public String total_reservations_collegiate;

				public String getTotal_reservations_collegiate () {
					return this.total_reservations_collegiate;
				}
				
			    public String average_reservations_collegiate;

				public String getAverage_reservations_collegiate () {
					return this.average_reservations_collegiate;
				}
				
			    public String total_reservations_consumer;

				public String getTotal_reservations_consumer () {
					return this.total_reservations_consumer;
				}
				
			    public String average_reservations_consumer;

				public String getAverage_reservations_consumer () {
					return this.average_reservations_consumer;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_Monitor_Unmapped_Postal_Codes) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.total_unmapped_postal_codes = readString(dis);
					
					this.total_unmapped_postal_codes_with_reservations = readString(dis);
					
					this.total_unmapped_reservations = readString(dis);
					
					this.average_unmapped_reservations = readString(dis);
					
					this.total_reservations_business = readString(dis);
					
					this.average_reservations_business = readString(dis);
					
					this.total_reservations_collegiate = readString(dis);
					
					this.average_reservations_collegiate = readString(dis);
					
					this.total_reservations_consumer = readString(dis);
					
					this.average_reservations_consumer = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.total_unmapped_postal_codes,dos);
					
					// String
				
						writeString(this.total_unmapped_postal_codes_with_reservations,dos);
					
					// String
				
						writeString(this.total_unmapped_reservations,dos);
					
					// String
				
						writeString(this.average_unmapped_reservations,dos);
					
					// String
				
						writeString(this.total_reservations_business,dos);
					
					// String
				
						writeString(this.average_reservations_business,dos);
					
					// String
				
						writeString(this.total_reservations_collegiate,dos);
					
					// String
				
						writeString(this.average_reservations_collegiate,dos);
					
					// String
				
						writeString(this.total_reservations_consumer,dos);
					
					// String
				
						writeString(this.average_reservations_consumer,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("total_unmapped_postal_codes="+total_unmapped_postal_codes);
		sb.append(",total_unmapped_postal_codes_with_reservations="+total_unmapped_postal_codes_with_reservations);
		sb.append(",total_unmapped_reservations="+total_unmapped_reservations);
		sb.append(",average_unmapped_reservations="+average_unmapped_reservations);
		sb.append(",total_reservations_business="+total_reservations_business);
		sb.append(",average_reservations_business="+average_reservations_business);
		sb.append(",total_reservations_collegiate="+total_reservations_collegiate);
		sb.append(",average_reservations_collegiate="+average_reservations_collegiate);
		sb.append(",total_reservations_consumer="+total_reservations_consumer);
		sb.append(",average_reservations_consumer="+average_reservations_consumer);
	    sb.append("]");
...
"\nwith location_no_metro as\n(\n	select\n	dl.location_id, dl.is_new_platform, dl.postal_code, dl.country_iso, mpm.metro_id\n	from {{marketing.schema}}.d_location dl\n	left join (\n		select mtr.metro_id, pmm.postal_code, mtr.country_iso\n		from {{marketing.schema}}.l_metro mtr\n		join {{marketing.schema}}.l_postalcode_metro_map pmm\n		on pmm.metro_id = mtr.metro_id\n		where mtr.end_date = '3199-12-31'\n		and pmm.end_date = '3199-12-31'\n	) mpm\n	on {{marketing.schema}}.f_postalcode_for_mapping(dl.postal_code, dl.country_iso) = mpm.postal_code\n	and dl.country_iso = mpm.country_iso\n	where dl.end_date='3199-12-31'\n	and dl.is_active = true\n	and dl.country_iso in ('US', 'CA')\n	and mpm.metro_id is null\n),\npostal_code_reservations as (\n	select lnm.postal_code, rp.segment_class, count(*) as reservation_count\n	from {{marketing.schema}}.s_reservation sr\n	join location_no_metro lnm\n	on sr.location_id = lnm.location_id\n	and sr.is_new_platform = lnm.is_new_platform\n	left join {{marketing.schema}}.vw_r_rate_plan rp\n	on sr.rate_plan_id = rp.rate_plan_id\n	where sr.start_date <= current_date\n	and ((sr.cancel_date is null or sr.cancel_date > current_date) and (sr.status is null or sr.status <> 'CANCELLED'))\n	group by lnm.postal_code, rp.segment_class	\n)\nselect \n	t2.total as total_unmapped_postal_codes, \n	count(DISTINCT postal_code) as total_unmapped_postal_codes_with_reservations, \n	sum(reservation_count) as total_unmapped_reservations, \n	sum(reservation_count)/count(DISTINCT postal_code) as average_unmapped_reservations,\n	t3.total_reservations_business, t3.average_reservations_business,\n	t4.total_reservations_collegiate, t4.average_reservations_collegiate,\n	t5.total_reservations_consumer, t5.average_reservations_consumer\nfrom postal_code_reservations t1\njoin (select count(*) as total from (select postal_code from location_no_metro group by postal_code)) t2\non 1=1\njoin (select sum(reservation_count) as total_reservations_business, avg(reservation_count) as average_reservations_business from postal_code_reservations where segment_class = 'Business') t3\non 1=1\njoin (select sum(reservation_count) as total_reservations_collegiate, avg(reservation_count) as average_reservations_collegiate from postal_code_reservations where segment_class = 'Collegiate') t4\non 1=1\njoin (select sum(reservation_count) as total_reservations_consumer, avg(reservation_count) as average_reservations_consumer from postal_code_reservations where segment_class = 'Consumer') t5\non 1=1\ngroup by \n	t2.total, \n	t3.total_reservations_business, t3.average_reservations_business, \n	t4.total_reservations_collegiate, t4.average_reservations_collegiate, \n	t5.total_reservations_consumer, t5.average_reservations_consumer\n;\n",
		    ...
		    while (rs_tRedshiftInput_1.next()) {
		        nb_line_tRedshiftInput_1++;
							...
							if(colQtyInRs_tRedshiftInput_1 < 1) {
								data_row.total_unmapped_postal_codes = null;
							} else {
	                         		
        	data_row.total_unmapped_postal_codes = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 1, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 2) {
								data_row.total_unmapped_postal_codes_with_reservations = null;
							} else {
	                         		
        	data_row.total_unmapped_postal_codes_with_reservations = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 2, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 3) {
								data_row.total_unmapped_reservations = null;
							} else {
	                         		
        	data_row.total_unmapped_reservations = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 3, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 4) {
								data_row.average_unmapped_reservations = null;
							} else {
	                         		
        	data_row.average_unmapped_reservations = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 4, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 5) {
								data_row.total_reservations_business = null;
							} else {
	                         		
        	data_row.total_reservations_business = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 5, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 6) {
								data_row.average_reservations_business = null;
							} else {
	                         		
        	data_row.average_reservations_business = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 6, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 7) {
								data_row.total_reservations_collegiate = null;
							} else {
	                         		
        	data_row.total_reservations_collegiate = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 7, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 8) {
								data_row.average_reservations_collegiate = null;
							} else {
	                         		
        	data_row.average_reservations_collegiate = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 8, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 9) {
								data_row.total_reservations_consumer = null;
							} else {
	                         		
        	data_row.total_reservations_consumer = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 9, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 10) {
								data_row.average_reservations_consumer = null;
							} else {
	                         		
        	data_row.average_reservations_consumer = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 10, false);
		                    }
			...
			//data_row
				...
				if(execStat){
					runStat.updateStatOnConnection("data_row"+iterateId,1, 1);
	        				...
	        				row1.total_unmapped_postal_codes = data_row.total_unmapped_postal_codes;
	        				row1.total_unmapped_postal_codes_with_reservations = data_row.total_unmapped_postal_codes_with_reservations;
	        				row1.total_unmapped_reservations = data_row.total_unmapped_reservations;
	        				row1.average_unmapped_reservations = data_row.average_unmapped_reservations;
	        				row1.total_reservations_business = data_row.total_reservations_business;
	        				row1.average_reservations_business = data_row.average_reservations_business;
	        				row1.total_reservations_collegiate = data_row.total_reservations_collegiate;
	        				row1.average_reservations_collegiate = data_row.average_reservations_collegiate;
	        				row1.total_reservations_consumer = data_row.total_reservations_consumer;
	        				row1.average_reservations_consumer = data_row.average_reservations_consumer;
...
sharedMap.put("total_unmapped_postal_codes", row1.total_unmapped_postal_codes);
sharedMap.put("total_unmapped_postal_codes_with_reservations", row1.total_unmapped_postal_codes_with_reservations);
sharedMap.put("total_unmapped_reservations", row1.total_unmapped_reservations);
sharedMap.put("average_unmapped_reservations", row1.average_unmapped_reservations);
sharedMap.put("total_reservations_business", row1.total_reservations_business);
sharedMap.put("average_reservations_business", row1.average_reservations_business);
sharedMap.put("total_reservations_collegiate", row1.total_reservations_collegiate);
sharedMap.put("average_reservations_collegiate", row1.average_reservations_collegiate);
sharedMap.put("total_reservations_consumer", row1.total_reservations_consumer);
sharedMap.put("average_reservations_consumer", row1.average_reservations_consumer);
    nb_line_tJavaRow_2++;   
...
rowLogger.logRows(jobName, Logging.PRIORITY_INFO, "LogRows", "Unmapped Postal Codes");
 ...
 */
    ...
    public static void main(String[] args){
        final Task_Monitor_Unmapped_Postal_Codes Task_Monitor_Unmapped_Postal_CodesClass = new Task_Monitor_Unmapped_Postal_Codes();

        int exitCode = Task_Monitor_Unmapped_Postal_CodesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Task_Monitor_Unmapped_Postal_Codes.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/task_monitor_unmapped_postal_codes_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Task_Monitor_Unmapped_Postal_Codes");
        }
...
/************************************************************************************************
 *     148481 characters generated by Talend Open Studio for Data Integration 
