...
package zipcar_marketingdw.stagefeed_locations_np_0_1;
...
/**
 * Job: StageFeed_Locations_NP Purpose: Stage the Feed files from NP<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Locations_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Locations_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_tLCwIKo_Eeia3dSup_1D_w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Locations_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Locations_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP) {
...
globalMap.put("currentFeed", FeedFile.FileType.LOCATIONS_NP);
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP = new byte[0];
			    ...
			    public Integer PARKING_CAPACITY;

				public Integer getPARKING_CAPACITY () {
			    ...
			    public Integer RADIUS_METERS;

				public Integer getRADIUS_METERS () {
			    ...
			    public java.util.Date CREATION_TIME_UTC;

				public java.util.Date getCREATION_TIME_UTC () {
					return this.CREATION_TIME_UTC;
				}
				
			    public java.util.Date MODIFIED_TIME_UTC;

				public java.util.Date getMODIFIED_TIME_UTC () {
					return this.MODIFIED_TIME_UTC;
				}
			    ...
			    public Long LEGACY_LOCATION_ID;

				public Long getLEGACY_LOCATION_ID () {
					return this.LEGACY_LOCATION_ID;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Locations_NP) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.BOOKING_TYPE = readString(dis);
					...
					this.LOCAL_IDENTIFIER = readString(dis);
					
						this.PARKING_CAPACITY = readInteger(dis);
					
					this.PLACE_ID = readString(dis);
					
						this.RADIUS_METERS = readInteger(dis);
					
					this.SUPPORT_EMAIL = readString(dis);
					
					this.SUPPORT_PHONE_NUMBER = readString(dis);
					
					this.TIMEZONE_ID = readString(dis);
					...
					this.CREATION_TIME_UTC = readDate(dis);
					
					this.MODIFIED_TIME_UTC = readDate(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.AUTHOR_ID = null;
           				} else {
           			    	this.AUTHOR_ID = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LEGACY_LOCATION_ID = null;
           				} else {
           			    	this.LEGACY_LOCATION_ID = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.BOOKING_TYPE,dos);
					...
					// String
						...
						writeString(this.LOCAL_IDENTIFIER,dos);
					
					// Integer
				
						writeInteger(this.PARKING_CAPACITY,dos);
					
					// String
				
						writeString(this.PLACE_ID,dos);
					
					// Integer
				
						writeInteger(this.RADIUS_METERS,dos);
					
					// String
				
						writeString(this.SUPPORT_EMAIL,dos);
					
					// String
				
						writeString(this.SUPPORT_PHONE_NUMBER,dos);
					
					// String
				
						writeString(this.TIMEZONE_ID,dos);
					...
					// java.util.Date
						...
						writeDate(this.CREATION_TIME_UTC,dos);
					
					// java.util.Date
				
						writeDate(this.MODIFIED_TIME_UTC,dos);
					...
					// Long
						...
						if(this.LEGACY_LOCATION_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LEGACY_LOCATION_ID);
		            	}
    ...
    public String toString() {
		...
		sb.append(",BOOKING_TYPE="+BOOKING_TYPE);
		sb.append(",DESCRIPTION="+DESCRIPTION);
		sb.append(",LATITUDE="+String.valueOf(LATITUDE));
		sb.append(",LONGITUDE="+String.valueOf(LONGITUDE));
		sb.append(",LOCAL_IDENTIFIER="+LOCAL_IDENTIFIER);
		sb.append(",PARKING_CAPACITY="+String.valueOf(PARKING_CAPACITY));
		sb.append(",PLACE_ID="+PLACE_ID);
		sb.append(",RADIUS_METERS="+String.valueOf(RADIUS_METERS));
		sb.append(",SUPPORT_EMAIL="+SUPPORT_EMAIL);
		sb.append(",SUPPORT_PHONE_NUMBER="+SUPPORT_PHONE_NUMBER);
		sb.append(",TIMEZONE_ID="+TIMEZONE_ID);
		sb.append(",VERSION="+String.valueOf(VERSION));
		sb.append(",CREATION_TIME_UTC="+String.valueOf(CREATION_TIME_UTC));
		sb.append(",MODIFIED_TIME_UTC="+String.valueOf(MODIFIED_TIME_UTC));
		...
		sb.append(",LEGACY_LOCATION_ID="+String.valueOf(LEGACY_LOCATION_ID));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c1(String ACTIVE_P){
							this.ACTIVE_P = ACTIVE_P;
							return this;
						}				
						String NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String NAME){
							this.NAME = NAME;
							return this;
						}				
						String ADDRESS;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String ADDRESS){
							this.ADDRESS = ADDRESS;
							return this;
						}				
						String BOOKING_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String BOOKING_TYPE){
							this.BOOKING_TYPE = BOOKING_TYPE;
							return this;
						}				
						String DESCRIPTION;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String DESCRIPTION){
							this.DESCRIPTION = DESCRIPTION;
							return this;
						}				
						Double LATITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Double LATITUDE){
							this.LATITUDE = LATITUDE;
							return this;
						}				
						Double LONGITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Double LONGITUDE){
							this.LONGITUDE = LONGITUDE;
							return this;
						}				
						String LOCAL_IDENTIFIER;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String LOCAL_IDENTIFIER){
							this.LOCAL_IDENTIFIER = LOCAL_IDENTIFIER;
							return this;
						}				
						Integer PARKING_CAPACITY;
						
	            		public BufferLine_tRedshiftOutput_1 c9(Integer PARKING_CAPACITY){
							this.PARKING_CAPACITY = PARKING_CAPACITY;
							return this;
						}				
						String PLACE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String PLACE_ID){
							this.PLACE_ID = PLACE_ID;
							return this;
						}				
						Integer RADIUS_METERS;
						
	            		public BufferLine_tRedshiftOutput_1 c11(Integer RADIUS_METERS){
							this.RADIUS_METERS = RADIUS_METERS;
							return this;
						}				
						String SUPPORT_EMAIL;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String SUPPORT_EMAIL){
							this.SUPPORT_EMAIL = SUPPORT_EMAIL;
							return this;
						}				
						String SUPPORT_PHONE_NUMBER;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String SUPPORT_PHONE_NUMBER){
							this.SUPPORT_PHONE_NUMBER = SUPPORT_PHONE_NUMBER;
							return this;
						}				
						String TIMEZONE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String TIMEZONE_ID){
							this.TIMEZONE_ID = TIMEZONE_ID;
							return this;
						}				
						Long VERSION;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Long VERSION){
							this.VERSION = VERSION;
							return this;
						}				
						java.util.Date CREATION_TIME_UTC;
						
	            		public BufferLine_tRedshiftOutput_1 c16(java.util.Date CREATION_TIME_UTC){
							this.CREATION_TIME_UTC = CREATION_TIME_UTC;
							return this;
						}				
						java.util.Date MODIFIED_TIME_UTC;
						
	            		public BufferLine_tRedshiftOutput_1 c17(java.util.Date MODIFIED_TIME_UTC){
							this.MODIFIED_TIME_UTC = MODIFIED_TIME_UTC;
							return this;
						}				
						Long AUTHOR_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c18(Long AUTHOR_ID){
							this.AUTHOR_ID = AUTHOR_ID;
							return this;
						}				
						Long COMMUNITY_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c19(Long COMMUNITY_ID){
							this.COMMUNITY_ID = COMMUNITY_ID;
							return this;
						}				
						Long USER_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c20(Long USER_ID){
							this.USER_ID = USER_ID;
							return this;
						}				
						Long LEGACY_LOCATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c21(Long LEGACY_LOCATION_ID){
							this.LEGACY_LOCATION_ID = LEGACY_LOCATION_ID;
							return this;
						}				
						String STATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c22(String STATION_ID){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"LOCATION_ID\",\"ACTIVE_P\",\"NAME\",\"ADDRESS\",\"BOOKING_TYPE\",\"DESCRIPTION\",\"LATITUDE\",\"LONGITUDE\",\"LOCAL_IDENTIFIER\",\"PARKING_CAPACITY\",\"PLACE_ID\",\"RADIUS_METERS\",\"SUPPORT_EMAIL\",\"SUPPORT_PHONE_NUMBER\",\"TIMEZONE_ID\",\"VERSION\",\"CREATION_TIME_UTC\",\"MODIFIED_TIME_UTC\",\"AUTHOR_ID\",\"COMMUNITY_ID\",\"USER_ID\",\"LEGACY_LOCATION_ID\",\"STATION_ID\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.NAME = null;
					
							Row_FeedRecord.ADDRESS = null;
					
							Row_FeedRecord.BOOKING_TYPE = null;
					
							Row_FeedRecord.DESCRIPTION = null;
					
							Row_FeedRecord.LATITUDE = null;
					
							Row_FeedRecord.LONGITUDE = null;
					
							Row_FeedRecord.LOCAL_IDENTIFIER = null;
					
							Row_FeedRecord.PARKING_CAPACITY = null;
					
							Row_FeedRecord.PLACE_ID = null;
					
							Row_FeedRecord.RADIUS_METERS = null;
					
							Row_FeedRecord.SUPPORT_EMAIL = null;
					
							Row_FeedRecord.SUPPORT_PHONE_NUMBER = null;
					
							Row_FeedRecord.TIMEZONE_ID = null;
					
							Row_FeedRecord.VERSION = null;
					
							Row_FeedRecord.CREATION_TIME_UTC = null;
					
							Row_FeedRecord.MODIFIED_TIME_UTC = null;
					
							Row_FeedRecord.AUTHOR_ID = null;
					
							Row_FeedRecord.COMMUNITY_ID = null;
					
							Row_FeedRecord.USER_ID = null;
					
							Row_FeedRecord.LEGACY_LOCATION_ID = null;
					
							Row_FeedRecord.STATION_ID = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ADDRESS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.BOOKING_TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LATITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LONGITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LOCAL_IDENTIFIER = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.PARKING_CAPACITY = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PLACE_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.RADIUS_METERS = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SUPPORT_EMAIL = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SUPPORT_PHONE_NUMBER = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.TIMEZONE_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.VERSION = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.CREATION_TIME_UTC = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.MODIFIED_TIME_UTC = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.AUTHOR_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.USER_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LEGACY_LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.STATION_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.NAME = StringUtils.trimToNull(Row_FeedRecord.NAME);
Record_OutputToDB.ADDRESS = StringUtils.trimToNull(Row_FeedRecord.ADDRESS);
Record_OutputToDB.BOOKING_TYPE = StringUtils.trimToNull(Row_FeedRecord.BOOKING_TYPE);
Record_OutputToDB.DESCRIPTION = StringUtils.trimToNull(Row_FeedRecord.DESCRIPTION);
Record_OutputToDB.LATITUDE = Row_FeedRecord.LATITUDE;
Record_OutputToDB.LONGITUDE = Row_FeedRecord.LONGITUDE;
Record_OutputToDB.LOCAL_IDENTIFIER = StringUtils.trimToNull(Row_FeedRecord.LOCAL_IDENTIFIER);
Record_OutputToDB.PARKING_CAPACITY = Row_FeedRecord.PARKING_CAPACITY;
Record_OutputToDB.PLACE_ID = StringUtils.trimToNull(Row_FeedRecord.PLACE_ID);
Record_OutputToDB.RADIUS_METERS = Row_FeedRecord.RADIUS_METERS;
Record_OutputToDB.SUPPORT_EMAIL = StringUtils.trimToNull(Row_FeedRecord.SUPPORT_EMAIL);
Record_OutputToDB.SUPPORT_PHONE_NUMBER = StringUtils.trimToNull(Row_FeedRecord.SUPPORT_PHONE_NUMBER);
Record_OutputToDB.TIMEZONE_ID = StringUtils.trimToNull(Row_FeedRecord.TIMEZONE_ID);
Record_OutputToDB.VERSION = Row_FeedRecord.VERSION;
Record_OutputToDB.CREATION_TIME_UTC = Row_FeedRecord.CREATION_TIME_UTC;
Record_OutputToDB.MODIFIED_TIME_UTC = Row_FeedRecord.MODIFIED_TIME_UTC;
Record_OutputToDB.AUTHOR_ID = Row_FeedRecord.AUTHOR_ID;
Record_OutputToDB.COMMUNITY_ID = Row_FeedRecord.COMMUNITY_ID;
Record_OutputToDB.USER_ID = Row_FeedRecord.USER_ID;
Record_OutputToDB.LEGACY_LOCATION_ID = Row_FeedRecord.LEGACY_LOCATION_ID;
Record_OutputToDB.STATION_ID = StringUtils.trimToNull(Row_FeedRecord.STATION_ID);
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ADDRESS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ADDRESS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.BOOKING_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.BOOKING_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LATITUDE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.LATITUDE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LONGITUDE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.LONGITUDE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LOCAL_IDENTIFIER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LOCAL_IDENTIFIER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PARKING_CAPACITY==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.PARKING_CAPACITY);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PLACE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PLACE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RADIUS_METERS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.RADIUS_METERS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SUPPORT_EMAIL==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SUPPORT_EMAIL);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SUPPORT_PHONE_NUMBER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SUPPORT_PHONE_NUMBER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TIMEZONE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.TIMEZONE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.VERSION==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.VERSION);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CREATION_TIME_UTC!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.CREATION_TIME_UTC.getTime();
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MODIFIED_TIME_UTC!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.MODIFIED_TIME_UTC.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.AUTHOR_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.AUTHOR_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.COMMUNITY_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.USER_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.USER_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LEGACY_LOCATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LEGACY_LOCATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.STATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.STATION_ID);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.LOCATION_ID)
                        .c1(Record_OutputToDB.ACTIVE_P)
                        .c2(Record_OutputToDB.NAME)
                        .c3(Record_OutputToDB.ADDRESS)
                        .c4(Record_OutputToDB.BOOKING_TYPE)
                        .c5(Record_OutputToDB.DESCRIPTION)
                        .c6(Record_OutputToDB.LATITUDE)
                        .c7(Record_OutputToDB.LONGITUDE)
                        .c8(Record_OutputToDB.LOCAL_IDENTIFIER)
                        .c9(Record_OutputToDB.PARKING_CAPACITY)
                        .c10(Record_OutputToDB.PLACE_ID)
                        .c11(Record_OutputToDB.RADIUS_METERS)
                        .c12(Record_OutputToDB.SUPPORT_EMAIL)
                        .c13(Record_OutputToDB.SUPPORT_PHONE_NUMBER)
                        .c14(Record_OutputToDB.TIMEZONE_ID)
                        .c15(Record_OutputToDB.VERSION)
                        .c16(Record_OutputToDB.CREATION_TIME_UTC)
                        .c17(Record_OutputToDB.MODIFIED_TIME_UTC)
                        .c18(Record_OutputToDB.AUTHOR_ID)
                        .c19(Record_OutputToDB.COMMUNITY_ID)
                        .c20(Record_OutputToDB.USER_ID)
                        .c21(Record_OutputToDB.LEGACY_LOCATION_ID)
                        .c22(Record_OutputToDB.STATION_ID)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.NAME = Record_OutputToDB.NAME;
                                After_Insert.ADDRESS = Record_OutputToDB.ADDRESS;
                                After_Insert.BOOKING_TYPE = Record_OutputToDB.BOOKING_TYPE;
                                After_Insert.DESCRIPTION = Record_OutputToDB.DESCRIPTION;
                                After_Insert.LATITUDE = Record_OutputToDB.LATITUDE;
                                After_Insert.LONGITUDE = Record_OutputToDB.LONGITUDE;
                                After_Insert.LOCAL_IDENTIFIER = Record_OutputToDB.LOCAL_IDENTIFIER;
                                After_Insert.PARKING_CAPACITY = Record_OutputToDB.PARKING_CAPACITY;
                                After_Insert.PLACE_ID = Record_OutputToDB.PLACE_ID;
                                After_Insert.RADIUS_METERS = Record_OutputToDB.RADIUS_METERS;
                                After_Insert.SUPPORT_EMAIL = Record_OutputToDB.SUPPORT_EMAIL;
                                After_Insert.SUPPORT_PHONE_NUMBER = Record_OutputToDB.SUPPORT_PHONE_NUMBER;
                                After_Insert.TIMEZONE_ID = Record_OutputToDB.TIMEZONE_ID;
                                After_Insert.VERSION = Record_OutputToDB.VERSION;
                                After_Insert.CREATION_TIME_UTC = Record_OutputToDB.CREATION_TIME_UTC;
                                After_Insert.MODIFIED_TIME_UTC = Record_OutputToDB.MODIFIED_TIME_UTC;
                                After_Insert.AUTHOR_ID = Record_OutputToDB.AUTHOR_ID;
                                After_Insert.COMMUNITY_ID = Record_OutputToDB.COMMUNITY_ID;
                                After_Insert.USER_ID = Record_OutputToDB.USER_ID;
                                After_Insert.LEGACY_LOCATION_ID = Record_OutputToDB.LEGACY_LOCATION_ID;
                                After_Insert.STATION_ID = Record_OutputToDB.STATION_ID;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.NAME = After_Insert.NAME;
               Log_Rows.ADDRESS = After_Insert.ADDRESS;
               Log_Rows.BOOKING_TYPE = After_Insert.BOOKING_TYPE;
               Log_Rows.DESCRIPTION = After_Insert.DESCRIPTION;
               Log_Rows.LATITUDE = After_Insert.LATITUDE;
               Log_Rows.LONGITUDE = After_Insert.LONGITUDE;
               Log_Rows.LOCAL_IDENTIFIER = After_Insert.LOCAL_IDENTIFIER;
               Log_Rows.PARKING_CAPACITY = After_Insert.PARKING_CAPACITY;
               Log_Rows.PLACE_ID = After_Insert.PLACE_ID;
               Log_Rows.RADIUS_METERS = After_Insert.RADIUS_METERS;
               Log_Rows.SUPPORT_EMAIL = After_Insert.SUPPORT_EMAIL;
               Log_Rows.SUPPORT_PHONE_NUMBER = After_Insert.SUPPORT_PHONE_NUMBER;
               Log_Rows.TIMEZONE_ID = After_Insert.TIMEZONE_ID;
               Log_Rows.VERSION = After_Insert.VERSION;
               Log_Rows.CREATION_TIME_UTC = After_Insert.CREATION_TIME_UTC;
               Log_Rows.MODIFIED_TIME_UTC = After_Insert.MODIFIED_TIME_UTC;
               Log_Rows.AUTHOR_ID = After_Insert.AUTHOR_ID;
               Log_Rows.COMMUNITY_ID = After_Insert.COMMUNITY_ID;
               Log_Rows.USER_ID = After_Insert.USER_ID;
               Log_Rows.LEGACY_LOCATION_ID = After_Insert.LEGACY_LOCATION_ID;
               Log_Rows.STATION_ID = After_Insert.STATION_ID;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"LOCATION_ID\",\"ACTIVE_P\",\"NAME\",\"ADDRESS\",\"BOOKING_TYPE\",\"DESCRIPTION\",\"LATITUDE\",\"LONGITUDE\",\"LOCAL_IDENTIFIER\",\"PARKING_CAPACITY\",\"PLACE_ID\",\"RADIUS_METERS\",\"SUPPORT_EMAIL\",\"SUPPORT_PHONE_NUMBER\",\"TIMEZONE_ID\",\"VERSION\",\"CREATION_TIME_UTC\",\"MODIFIED_TIME_UTC\",\"AUTHOR_ID\",\"COMMUNITY_ID\",\"USER_ID\",\"LEGACY_LOCATION_ID\",\"STATION_ID\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.NAME);
					...
					if(bufferLtRedshiftOutput_1.ADDRESS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ADDRESS);
					...
					if(bufferLtRedshiftOutput_1.BOOKING_TYPE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.BOOKING_TYPE);
					...
					if(bufferLtRedshiftOutput_1.LOCAL_IDENTIFIER==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LOCAL_IDENTIFIER);
					...
					if(bufferLtRedshiftOutput_1.PARKING_CAPACITY==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PARKING_CAPACITY);
					...
					if(bufferLtRedshiftOutput_1.PLACE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PLACE_ID);
					...
					if(bufferLtRedshiftOutput_1.RADIUS_METERS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RADIUS_METERS);
					...
					if(bufferLtRedshiftOutput_1.SUPPORT_EMAIL==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SUPPORT_EMAIL);
					...
					if(bufferLtRedshiftOutput_1.SUPPORT_PHONE_NUMBER==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SUPPORT_PHONE_NUMBER);
					...
					if(bufferLtRedshiftOutput_1.TIMEZONE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TIMEZONE_ID);
					...
					if(bufferLtRedshiftOutput_1.VERSION==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.VERSION);
					...
					if(bufferLtRedshiftOutput_1.CREATION_TIME_UTC!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.CREATION_TIME_UTC.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.MODIFIED_TIME_UTC!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.MODIFIED_TIME_UTC.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.AUTHOR_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.AUTHOR_ID);
					...
					if(bufferLtRedshiftOutput_1.USER_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.USER_ID);
					...
					if(bufferLtRedshiftOutput_1.LEGACY_LOCATION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LEGACY_LOCATION_ID);
					...
					if(bufferLtRedshiftOutput_1.STATION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.STATION_ID);
...
String fileName_tFileOutputDelimited_1 = "";
    ...
    globalMap.put("tFileOutputDelimited_1_FILE_NAME",fileName_tFileOutputDelimited_1);
                String[] headColutFileOutputDelimited_1=new String[23];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.LOCAL_IDENTIFIER = null;
					
							row1.PARKING_CAPACITY = null;
					
							row1.PLACE_ID = null;
					
							row1.RADIUS_METERS = null;
					
							row1.SUPPORT_EMAIL = null;
					
							row1.SUPPORT_PHONE_NUMBER = null;
					
							row1.TIMEZONE_ID = null;
					
							row1.VERSION = null;
					
							row1.CREATION_TIME_UTC = null;
					
							row1.MODIFIED_TIME_UTC = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.BOOKING_TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LATITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LONGITUDE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LOCAL_IDENTIFIER = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.PARKING_CAPACITY = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PLACE_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.RADIUS_METERS = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SUPPORT_EMAIL = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SUPPORT_PHONE_NUMBER = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.TIMEZONE_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.VERSION = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.CREATION_TIME_UTC = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.MODIFIED_TIME_UTC = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.AUTHOR_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.USER_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LEGACY_LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.STATION_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.NAME = StringUtils.trimToNull(row1.NAME);
row2.ADDRESS = StringUtils.trimToNull(row1.ADDRESS);
row2.BOOKING_TYPE = StringUtils.trimToNull(row1.BOOKING_TYPE);
row2.DESCRIPTION = StringUtils.trimToNull(row1.DESCRIPTION);
row2.LATITUDE = row1.LATITUDE;
row2.LONGITUDE = row1.LONGITUDE;
row2.LOCAL_IDENTIFIER = StringUtils.trimToNull(row1.LOCAL_IDENTIFIER);
row2.PARKING_CAPACITY = row1.PARKING_CAPACITY;
row2.PLACE_ID = StringUtils.trimToNull(row1.PLACE_ID);
row2.RADIUS_METERS = row1.RADIUS_METERS;
row2.SUPPORT_EMAIL = StringUtils.trimToNull(row1.SUPPORT_EMAIL);
row2.SUPPORT_PHONE_NUMBER = StringUtils.trimToNull(row1.SUPPORT_PHONE_NUMBER);
row2.TIMEZONE_ID = StringUtils.trimToNull(row1.TIMEZONE_ID);
row2.VERSION = row1.VERSION;
row2.CREATION_TIME_UTC = row1.CREATION_TIME_UTC;
row2.MODIFIED_TIME_UTC = row1.MODIFIED_TIME_UTC;
row2.AUTHOR_ID = row1.AUTHOR_ID;
row2.COMMUNITY_ID = row1.COMMUNITY_ID;
row2.USER_ID = row1.USER_ID;
row2.LEGACY_LOCATION_ID = row1.LEGACY_LOCATION_ID;
row2.STATION_ID = StringUtils.trimToNull(row1.STATION_ID);
			...
			//row2
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[23];
                            rowtFileOutputDelimited_1[0]=row2.LOCATION_ID == null ? null : String.valueOf(row2.LOCATION_ID);
                            rowtFileOutputDelimited_1[1]=row2.ACTIVE_P == null ? null : row2.ACTIVE_P;
                            rowtFileOutputDelimited_1[2]=row2.NAME == null ? null : row2.NAME;
                            rowtFileOutputDelimited_1[3]=row2.ADDRESS == null ? null : row2.ADDRESS;
                            rowtFileOutputDelimited_1[4]=row2.BOOKING_TYPE == null ? null : row2.BOOKING_TYPE;
                            rowtFileOutputDelimited_1[5]=row2.DESCRIPTION == null ? null : row2.DESCRIPTION;
                            rowtFileOutputDelimited_1[6]=row2.LATITUDE == null ? null : String.valueOf(row2.LATITUDE);
                            rowtFileOutputDelimited_1[7]=row2.LONGITUDE == null ? null : String.valueOf(row2.LONGITUDE);
                            rowtFileOutputDelimited_1[8]=row2.LOCAL_IDENTIFIER == null ? null : row2.LOCAL_IDENTIFIER;
                            rowtFileOutputDelimited_1[9]=row2.PARKING_CAPACITY == null ? null : String.valueOf(row2.PARKING_CAPACITY);
                            rowtFileOutputDelimited_1[10]=row2.PLACE_ID == null ? null : row2.PLACE_ID;
                            rowtFileOutputDelimited_1[11]=row2.RADIUS_METERS == null ? null : String.valueOf(row2.RADIUS_METERS);
                            rowtFileOutputDelimited_1[12]=row2.SUPPORT_EMAIL == null ? null : row2.SUPPORT_EMAIL;
                            rowtFileOutputDelimited_1[13]=row2.SUPPORT_PHONE_NUMBER == null ? null : row2.SUPPORT_PHONE_NUMBER;
                            rowtFileOutputDelimited_1[14]=row2.TIMEZONE_ID == null ? null : row2.TIMEZONE_ID;
                            rowtFileOutputDelimited_1[15]=row2.VERSION == null ? null : String.valueOf(row2.VERSION);
                            rowtFileOutputDelimited_1[16]=row2.CREATION_TIME_UTC == null ? null : FormatterUtils.format_Date(row2.CREATION_TIME_UTC, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[17]=row2.MODIFIED_TIME_UTC == null ? null : FormatterUtils.format_Date(row2.MODIFIED_TIME_UTC, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[18]=row2.AUTHOR_ID == null ? null : String.valueOf(row2.AUTHOR_ID);
                            rowtFileOutputDelimited_1[19]=row2.COMMUNITY_ID == null ? null : String.valueOf(row2.COMMUNITY_ID);
                            rowtFileOutputDelimited_1[20]=row2.USER_ID == null ? null : String.valueOf(row2.USER_ID);
                            rowtFileOutputDelimited_1[21]=row2.LEGACY_LOCATION_ID == null ? null : String.valueOf(row2.LEGACY_LOCATION_ID);
                            rowtFileOutputDelimited_1[22]=row2.STATION_ID == null ? null : row2.STATION_ID;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Locations_NP StageFeed_Locations_NPClass = new StageFeed_Locations_NP();

        int exitCode = StageFeed_Locations_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Locations_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_locations_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Locations_NP");
        }
...
/************************************************************************************************
 *     393889 characters generated by Talend Open Studio for Data Integration 
