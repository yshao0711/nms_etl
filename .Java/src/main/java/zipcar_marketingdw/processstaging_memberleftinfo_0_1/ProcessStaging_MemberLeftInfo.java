...
package zipcar_marketingdw.processstaging_memberleftinfo_0_1;
...
/**
 * Job: ProcessStaging_MemberLeftInfo Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_MemberLeftInfo implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_MemberLeftInfo";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_H43kgMrfEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_MemberLeftInfo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_MemberLeftInfo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLeftInfo) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "member_left_info";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_member_left_info";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_member_left_info\n(\n	member_id,\n	last_left_date,\n	creation_date,\n	last_modified,\n	deleted_date,\n	last_left_zipfleet_id,\n	last_left_rate_plan_id,\n	last_left_account_id,\n	last_left_affiliate_id,\n	last_left_reason,\n    imported_date\n)\nSELECT \n	member_id,\n	last_left_date,\n	creation_date,\n	last_modified,\n	deleted_date,\n	last_left_zipfleet_id,\n	last_left_rate_plan_id,\n	last_left_account_id,\n	last_left_affiliate_id,\n	last_left_reason,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.member_left_info\nMINUS\nSELECT \n	member_id,\n	last_left_date,\n	creation_date,\n	last_modified,\n	deleted_date,\n	last_left_zipfleet_id,\n	last_left_rate_plan_id,\n	last_left_account_id,\n	last_left_affiliate_id,\n	last_left_reason,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_member_left_info\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".member_left_info";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_MemberLeftInfo ProcessStaging_MemberLeftInfoClass = new ProcessStaging_MemberLeftInfo();

        int exitCode = ProcessStaging_MemberLeftInfoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_MemberLeftInfo.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_memberleftinfo_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_MemberLeftInfo");
        }
...
/************************************************************************************************
 *     136196 characters generated by Talend Open Studio for Data Integration 
