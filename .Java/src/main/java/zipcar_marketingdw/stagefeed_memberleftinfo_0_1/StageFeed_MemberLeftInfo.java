...
package zipcar_marketingdw.stagefeed_memberleftinfo_0_1;
...
/**
 * Job: StageFeed_MemberLeftInfo Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_MemberLeftInfo implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_MemberLeftInfo";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_YGyPgMrdEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_MemberLeftInfo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_MemberLeftInfo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.MEMBER_LEFT_INFO.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.MEMBER_LEFT_INFO.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.MEMBER_LEFT_INFO;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLeftInfo = new byte[0];
			    ...
			    public Long LAST_LEFT_ZIPFLEET_ID;

				public Long getLAST_LEFT_ZIPFLEET_ID () {
					return this.LAST_LEFT_ZIPFLEET_ID;
				}
				
			    public Long LAST_LEFT_RATE_PLAN_ID;

				public Long getLAST_LEFT_RATE_PLAN_ID () {
					return this.LAST_LEFT_RATE_PLAN_ID;
				}
				
			    public Long LAST_LEFT_ACCOUNT_ID;

				public Long getLAST_LEFT_ACCOUNT_ID () {
					return this.LAST_LEFT_ACCOUNT_ID;
				}
				
			    public Long LAST_LEFT_AFFILIATE_ID;

				public Long getLAST_LEFT_AFFILIATE_ID () {
					return this.LAST_LEFT_AFFILIATE_ID;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DELETED_DATE = readDate(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_LEFT_ZIPFLEET_ID = null;
           				} else {
           			    	this.LAST_LEFT_ZIPFLEET_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_LEFT_RATE_PLAN_ID = null;
           				} else {
           			    	this.LAST_LEFT_RATE_PLAN_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_LEFT_ACCOUNT_ID = null;
           				} else {
           			    	this.LAST_LEFT_ACCOUNT_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_LEFT_AFFILIATE_ID = null;
           				} else {
           			    	this.LAST_LEFT_AFFILIATE_ID = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.LAST_LEFT_ZIPFLEET_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_LEFT_ZIPFLEET_ID);
		            	}
					
					// Long
				
						if(this.LAST_LEFT_RATE_PLAN_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_LEFT_RATE_PLAN_ID);
		            	}
					
					// Long
				
						if(this.LAST_LEFT_ACCOUNT_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_LEFT_ACCOUNT_ID);
		            	}
					
					// Long
				
						if(this.LAST_LEFT_AFFILIATE_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_LEFT_AFFILIATE_ID);
		            	}
    ...
    public String toString() {
		...
		sb.append(",LAST_LEFT_ZIPFLEET_ID="+String.valueOf(LAST_LEFT_ZIPFLEET_ID));
		sb.append(",LAST_LEFT_RATE_PLAN_ID="+String.valueOf(LAST_LEFT_RATE_PLAN_ID));
		sb.append(",LAST_LEFT_ACCOUNT_ID="+String.valueOf(LAST_LEFT_ACCOUNT_ID));
		sb.append(",LAST_LEFT_AFFILIATE_ID="+String.valueOf(LAST_LEFT_AFFILIATE_ID));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						...
						java.util.Date LAST_LEFT_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c1(java.util.Date LAST_LEFT_DATE){
							this.LAST_LEFT_DATE = LAST_LEFT_DATE;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c2(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c3(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(java.util.Date DELETED_DATE){
							this.DELETED_DATE = DELETED_DATE;
							return this;
						}				
						Long LAST_LEFT_ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c5(Long LAST_LEFT_ZIPFLEET_ID){
							this.LAST_LEFT_ZIPFLEET_ID = LAST_LEFT_ZIPFLEET_ID;
							return this;
						}				
						Long LAST_LEFT_RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Long LAST_LEFT_RATE_PLAN_ID){
							this.LAST_LEFT_RATE_PLAN_ID = LAST_LEFT_RATE_PLAN_ID;
							return this;
						}				
						Long LAST_LEFT_ACCOUNT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Long LAST_LEFT_ACCOUNT_ID){
							this.LAST_LEFT_ACCOUNT_ID = LAST_LEFT_ACCOUNT_ID;
							return this;
						}				
						Long LAST_LEFT_AFFILIATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Long LAST_LEFT_AFFILIATE_ID){
							this.LAST_LEFT_AFFILIATE_ID = LAST_LEFT_AFFILIATE_ID;
							return this;
						}				
						String LAST_LEFT_REASON;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String LAST_LEFT_REASON){
							this.LAST_LEFT_REASON = LAST_LEFT_REASON;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"LAST_LEFT_DATE\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"LAST_LEFT_ZIPFLEET_ID\",\"LAST_LEFT_RATE_PLAN_ID\",\"LAST_LEFT_ACCOUNT_ID\",\"LAST_LEFT_AFFILIATE_ID\",\"LAST_LEFT_REASON\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.LAST_LEFT_DATE = null;
							...
							Row_FeedRecord.LAST_LEFT_ZIPFLEET_ID = null;
					
							Row_FeedRecord.LAST_LEFT_RATE_PLAN_ID = null;
					
							Row_FeedRecord.LAST_LEFT_ACCOUNT_ID = null;
					
							Row_FeedRecord.LAST_LEFT_AFFILIATE_ID = null;
					
							Row_FeedRecord.LAST_LEFT_REASON = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.LAST_LEFT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_LEFT_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_LEFT_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_LEFT_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_LEFT_AFFILIATE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LAST_LEFT_REASON = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.LAST_LEFT_DATE = Row_FeedRecord.LAST_LEFT_DATE;
...
Record_OutputToDB.LAST_LEFT_ZIPFLEET_ID = Row_FeedRecord.LAST_LEFT_ZIPFLEET_ID;
Record_OutputToDB.LAST_LEFT_RATE_PLAN_ID = Row_FeedRecord.LAST_LEFT_RATE_PLAN_ID;
Record_OutputToDB.LAST_LEFT_ACCOUNT_ID = Row_FeedRecord.LAST_LEFT_ACCOUNT_ID;
Record_OutputToDB.LAST_LEFT_AFFILIATE_ID = Row_FeedRecord.LAST_LEFT_AFFILIATE_ID;
Record_OutputToDB.LAST_LEFT_REASON = StringUtils.trimToNull(Row_FeedRecord.LAST_LEFT_REASON);
    nb_line_tJavaRow_3++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_LEFT_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_LEFT_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_LEFT_RATE_PLAN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_LEFT_RATE_PLAN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_LEFT_ACCOUNT_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_LEFT_ACCOUNT_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_LEFT_AFFILIATE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_LEFT_AFFILIATE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_LEFT_REASON==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LAST_LEFT_REASON);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.LAST_LEFT_DATE)
                        .c2(Record_OutputToDB.CREATION_DATE)
                        .c3(Record_OutputToDB.LAST_MODIFIED)
                        .c4(Record_OutputToDB.DELETED_DATE)
                        .c5(Record_OutputToDB.LAST_LEFT_ZIPFLEET_ID)
                        .c6(Record_OutputToDB.LAST_LEFT_RATE_PLAN_ID)
                        .c7(Record_OutputToDB.LAST_LEFT_ACCOUNT_ID)
                        .c8(Record_OutputToDB.LAST_LEFT_AFFILIATE_ID)
                        .c9(Record_OutputToDB.LAST_LEFT_REASON)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.LAST_LEFT_DATE = Record_OutputToDB.LAST_LEFT_DATE;
                                ...
                                After_Insert.LAST_LEFT_ZIPFLEET_ID = Record_OutputToDB.LAST_LEFT_ZIPFLEET_ID;
                                After_Insert.LAST_LEFT_RATE_PLAN_ID = Record_OutputToDB.LAST_LEFT_RATE_PLAN_ID;
                                After_Insert.LAST_LEFT_ACCOUNT_ID = Record_OutputToDB.LAST_LEFT_ACCOUNT_ID;
                                After_Insert.LAST_LEFT_AFFILIATE_ID = Record_OutputToDB.LAST_LEFT_AFFILIATE_ID;
                                After_Insert.LAST_LEFT_REASON = Record_OutputToDB.LAST_LEFT_REASON;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.LAST_LEFT_DATE = After_Insert.LAST_LEFT_DATE;
               ...
               Log_Rows.LAST_LEFT_ZIPFLEET_ID = After_Insert.LAST_LEFT_ZIPFLEET_ID;
               Log_Rows.LAST_LEFT_RATE_PLAN_ID = After_Insert.LAST_LEFT_RATE_PLAN_ID;
               Log_Rows.LAST_LEFT_ACCOUNT_ID = After_Insert.LAST_LEFT_ACCOUNT_ID;
               Log_Rows.LAST_LEFT_AFFILIATE_ID = After_Insert.LAST_LEFT_AFFILIATE_ID;
               Log_Rows.LAST_LEFT_REASON = After_Insert.LAST_LEFT_REASON;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"LAST_LEFT_DATE\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"LAST_LEFT_ZIPFLEET_ID\",\"LAST_LEFT_RATE_PLAN_ID\",\"LAST_LEFT_ACCOUNT_ID\",\"LAST_LEFT_AFFILIATE_ID\",\"LAST_LEFT_REASON\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.LAST_LEFT_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.LAST_LEFT_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.LAST_LEFT_ZIPFLEET_ID==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_LEFT_ZIPFLEET_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_LEFT_RATE_PLAN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_LEFT_RATE_PLAN_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_LEFT_ACCOUNT_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_LEFT_ACCOUNT_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_LEFT_AFFILIATE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_LEFT_AFFILIATE_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_LEFT_REASON==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_LEFT_REASON);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.LAST_LEFT_ZIPFLEET_ID = null;
					
							row1.LAST_LEFT_RATE_PLAN_ID = null;
					
							row1.LAST_LEFT_ACCOUNT_ID = null;
					
							row1.LAST_LEFT_AFFILIATE_ID = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.LAST_LEFT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_LEFT_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_LEFT_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_LEFT_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_LEFT_AFFILIATE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LAST_LEFT_REASON = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.LAST_LEFT_DATE = row1.LAST_LEFT_DATE;
row2.CREATION_DATE = row1.CREATION_DATE;
row2.LAST_MODIFIED = row1.LAST_MODIFIED;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.LAST_LEFT_ZIPFLEET_ID = row1.LAST_LEFT_ZIPFLEET_ID;
row2.LAST_LEFT_RATE_PLAN_ID = row1.LAST_LEFT_RATE_PLAN_ID;
row2.LAST_LEFT_ACCOUNT_ID = row1.LAST_LEFT_ACCOUNT_ID;
row2.LAST_LEFT_AFFILIATE_ID = row1.LAST_LEFT_AFFILIATE_ID;
row2.LAST_LEFT_REASON = StringUtils.trimToNull(row1.LAST_LEFT_REASON);
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[10];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.LAST_LEFT_DATE == null ? null : FormatterUtils.format_Date(row2.LAST_LEFT_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[2]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[3]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[4]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[5]=row2.LAST_LEFT_ZIPFLEET_ID == null ? null : String.valueOf(row2.LAST_LEFT_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[6]=row2.LAST_LEFT_RATE_PLAN_ID == null ? null : String.valueOf(row2.LAST_LEFT_RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[7]=row2.LAST_LEFT_ACCOUNT_ID == null ? null : String.valueOf(row2.LAST_LEFT_ACCOUNT_ID);
                            rowtFileOutputDelimited_1[8]=row2.LAST_LEFT_AFFILIATE_ID == null ? null : String.valueOf(row2.LAST_LEFT_AFFILIATE_ID);
                            rowtFileOutputDelimited_1[9]=row2.LAST_LEFT_REASON == null ? null : row2.LAST_LEFT_REASON;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_MemberLeftInfo StageFeed_MemberLeftInfoClass = new StageFeed_MemberLeftInfo();

        int exitCode = StageFeed_MemberLeftInfoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_MemberLeftInfo.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_memberleftinfo_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_MemberLeftInfo");
        }
...
/************************************************************************************************
 *     340803 characters generated by Talend Open Studio for Data Integration 
