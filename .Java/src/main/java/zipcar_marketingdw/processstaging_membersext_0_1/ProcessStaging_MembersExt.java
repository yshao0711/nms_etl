...
package zipcar_marketingdw.processstaging_membersext_0_1;
...
/**
 * Job: ProcessStaging_MembersExt Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_MembersExt implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_MembersExt";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_wFvs4M5oEeeiQrW9_8Zexg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_MembersExt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_MembersExt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MembersExt) {
...
"\nINSERT INTO {{marketing.schema}}.r_members_ext\n(\n	member_id,\n	affiliate_id_1,\n	affiliate_name_1,\n	affiliate_id_2,\n	affiliate_name_2,\n	affiliate_id_3,\n	affiliate_name_3,\n	affiliate_id_4,\n	affiliate_name_4,\n	affiliate_id_5,\n	affiliate_name_5,\n	affiliate_id_6,\n	affiliate_name_6,\n	affiliate_id_7,\n	affiliate_name_7,\n	affiliate_id_8,\n	affiliate_name_8,\n	affiliate_id_9,\n	affiliate_name_9,\n	deleted_date,\n	last_modified,\n	affiliate_refresh_date,\n	waiver_eligible_p,\n	per_trip_waiver_eligible_p,\n	current_waiver_plan_id,\n	current_waiver_plan_name,\n	current_waiver_plan_fee,\n	current_waiver_tier,\n	current_waiver_deductible,\n	current_w_auto_renew_p,\n	current_waiver_start_date,\n	current_waiver_end_date,\n	per_trip_waiver_cnt,\n	last_per_trip_waiver_date,\n	ever_had_any_waiver_p,\n	waiver_refresh_date,\n	driver_risk_tier_info_p,\n	first_risk_tier_key,\n	last_risk_tier_key,\n	first_min_level,\n	last_min_level,\n	total_risk_tier_changes,\n	trips_completed,\n	last_accident_karma_date,\n	last_lic_points_karma_date,\n	driver_risk_refresh_date,\n	last_res_date,\n	last_res_type,\n	days_since_last_drive,\n	next_res_type,\n	days_until_next_drive,\n	first_gas_fillup_date,\n	first_gas_fillup_amount,\n	first_gas_fillup_charge,\n	last_gas_fillup_date,\n	last_gas_fillup_amount,\n	last_gas_fillup_charge,\n	fillup_cnt,\n	wex_refresh_date,\n	first_nps_response_date,\n	first_nps_complete,\n	first_nps_score,\n	last_nps_response_date,\n	last_nps_complete,\n	last_nps_score,\n	nps_survey_refresh,\n	first_res_search_date,\n	first_res_search_completion_p,\n	first_res_local_start_date,\n	first_overnight_res,\n	first_wkday_hrly_am_start_res,\n	first_wkday_hrly_pm_start_res,\n	first_wkend_hrly_am_start_res,\n	first_wkend_hrly_pm_start_res,\n	first_wkday_daily_res,\n	first_wkend_daily_res,\n	member_first_res_refresh_date,\n	refer_a_friend_cnt,\n	total_gift_card_cnt,\n	total_gift_card_amt_usd,\n	last_gift_card_purchase_date,\n	last_gift_card_purchas_amt_usd,\n	last_gift_card_purchase_curr,\n	gift_card_cnt,\n	late_return_cnt,\n	last_late_return_date,\n	last_late_return_minutes,\n	last_late_return_charge,\n	major_accidents_cnt,\n	minor_accidents_cnt,\n	last_accident_date,\n	last_accident_classification,\n	member_behavior_refresh_date,\n	zcorporate_cnt,\n	corporate_cnt,\n	personal_cnt,\n	evpersonal_cnt,\n	sponsored_cnt,\n	evsponsored_cnt,\n	z2b_large_accounts_cnt,\n	subscription_cnt,\n	univ_depts_cnt,\n	van_restricted_cnt,\n	access_cnt,\n	zcorporate_hist_cnt,\n	corporate_hist_cnt,\n	personal_hist_cnt,\n	evpersonal_hist_cnt,\n	sponsored_hist_cnt,\n	evsponsored_hist_cnt,\n	z2b_large_accounts_hist_cnt,\n	subscription_hist_cnt,\n	univ_depts_hist_cnt,\n	van_restricted_hist_cnt,\n	access_hist_cnt,\n	last_res_search_date,\n	last_res_search_source,\n	last_res_search_completion_p,\n	last_overnight_res,\n	last_wkday_hrly_res,\n	last_wkday_daily_res,\n	last_wkend_hrly_res,\n	last_wkend_daily_res,\n	last_overnight_res_date,\n	last_wkday_hrly_res_date,\n	last_wkday_daily_res_date,\n	last_wkend_hrly_res_date,\n	last_wkend_daily_res_date,\n	last_res_search_type,\n	member_last_res_refresh_date,\n	last_reservation_id,\n	res_source,\n	res_source_description,\n	first_wkday_hrly_res,\n	first_wkend_hrly_res,\n	first_res_type,\n	days_from_join_to_first_res,\n	first_nps_cohort,\n	last_nps_cohort,\n	nps_survey_cnt,\n	total_hours_1_to_3mths,\n	total_hours_4_to_6mths,\n	total_hours_7_to_9mths,\n	total_hours_10_to_12mths,\n	total_distance_1_to_3mths,\n	total_distance_4_to_6mths,\n	total_distance_7_to_9mths,\n	total_distance_10_to_12mths,\n	distance_units,\n	next_fee_date,\n	next_fee_charge,\n	next_fee_freq,\n	first_res_search_source,\n	first_other_res,\n	first_noshow_res,\n	first_cancellation_res,\n	last_other_res,\n	last_noshow_res,\n	last_cancellation_res,\n	completed_res_3mths_s,\n	completed_res_6mths_s,\n	completed_res_9mths_s,\n	completed_res_1year_s,\n	completed_res_6mths_wrkday_s,\n	completed_res_1year_wrkday_s,\n	total_up_revenue_3mths_s,\n	total_up_revenue_6mths_s,\n	total_up_revenue_9mths_s,\n	total_up_revenue_1year_s,\n	avg_up_revenue_3mths_s,\n	avg_up_revenue_6mths_s,\n	avg_up_revenue_9mths_s,\n	avg_up_revenue_1year_s,\n	res_search_3mths_s,\n	res_search_turndown_3mths_s,\n	res_search_completions_3mths_s,\n	next_res_date_s,\n	res_refresh_date_s,\n	canceled_res_1year,\n	billed_noshow_res_1year,\n	total_res_1year,\n	affiliate_type,\n	anniversary_date,\n	last_res_rate_plan_key,\n	last_res_vehicle_class,\n	last_res_vehicle_id,\n	active_uni_p,\n	current_member_p,\n	first_join_account_id,\n	last_digit_first_account_id,\n	first_corporate_id,\n	current_suspension_reason_id,\n	first_application_id,\n	first_app_ijd_session_id,\n	first_application_ijd_p,\n	first_res_type_daily_hourly,\n	first_wkday_daily_am_start_res,\n	first_wkday_daily_pm_start_res,\n	first_wkend_daily_am_start_res,\n	first_wkend_daily_pm_start_res,\n	first_res_source,\n	first_res_source_desc,\n	first_res_vehicle_id,\n	first_res_zipfleet_id,\n	first_res_date,\n	second_res_date,\n	first_waiver_start_date,\n    imported_date\n)\nSELECT \n	member_id,\n	affiliate_id_1,\n	affiliate_name_1,\n	affiliate_id_2,\n	affiliate_name_2,\n	affiliate_id_3,\n	affiliate_name_3,\n	affiliate_id_4,\n	affiliate_name_4,\n	affiliate_id_5,\n	affiliate_name_5,\n	affiliate_id_6,\n	affiliate_name_6,\n	affiliate_id_7,\n	affiliate_name_7,\n	affiliate_id_8,\n	affiliate_name_8,\n	affiliate_id_9,\n	affiliate_name_9,\n	deleted_date,\n	last_modified,\n	affiliate_refresh_date,\n	waiver_eligible_p,\n	per_trip_waiver_eligible_p,\n	current_waiver_plan_id,\n	current_waiver_plan_name,\n	current_waiver_plan_fee,\n	current_waiver_tier,\n	current_waiver_deductible,\n	current_w_auto_renew_p,\n	current_waiver_start_date,\n	current_waiver_end_date,\n	per_trip_waiver_cnt,\n	last_per_trip_waiver_date,\n	ever_had_any_waiver_p,\n	waiver_refresh_date,\n	driver_risk_tier_info_p,\n	first_risk_tier_key,\n	last_risk_tier_key,\n	first_min_level,\n	last_min_level,\n	total_risk_tier_changes,\n	trips_completed,\n	last_accident_karma_date,\n	last_lic_points_karma_date,\n	driver_risk_refresh_date,\n	last_res_date,\n	last_res_type,\n	days_since_last_drive,\n	next_res_type,\n	days_until_next_drive,\n	first_gas_fillup_date,\n	first_gas_fillup_amount,\n	first_gas_fillup_charge,\n	last_gas_fillup_date,\n	last_gas_fillup_amount,\n	last_gas_fillup_charge,\n	fillup_cnt,\n	wex_refresh_date,\n	first_nps_response_date,\n	first_nps_complete,\n	first_nps_score,\n	last_nps_response_date,\n	last_nps_complete,\n	last_nps_score,\n	nps_survey_refresh,\n	first_res_search_date,\n	first_res_search_completion_p,\n	first_res_local_start_date,\n	first_overnight_res,\n	first_wkday_hrly_am_start_res,\n	first_wkday_hrly_pm_start_res,\n	first_wkend_hrly_am_start_res,\n	first_wkend_hrly_pm_start_res,\n	first_wkday_daily_res,\n	first_wkend_daily_res,\n	member_first_res_refresh_date,\n	refer_a_friend_cnt,\n	total_gift_card_cnt,\n	total_gift_card_amt_usd,\n	last_gift_card_purchase_date,\n	last_gift_card_purchas_amt_usd,\n	last_gift_card_purchase_curr,\n	gift_card_cnt,\n	late_return_cnt,\n	last_late_return_date,\n	last_late_return_minutes,\n	last_late_return_charge,\n	major_accidents_cnt,\n	minor_accidents_cnt,\n	last_accident_date,\n	last_accident_classification,\n	member_behavior_refresh_date,\n	zcorporate_cnt,\n	corporate_cnt,\n	personal_cnt,\n	evpersonal_cnt,\n	sponsored_cnt,\n	evsponsored_cnt,\n	z2b_large_accounts_cnt,\n	subscription_cnt,\n	univ_depts_cnt,\n	van_restricted_cnt,\n	access_cnt,\n	zcorporate_hist_cnt,\n	corporate_hist_cnt,\n	personal_hist_cnt,\n	evpersonal_hist_cnt,\n	sponsored_hist_cnt,\n	evsponsored_hist_cnt,\n	z2b_large_accounts_hist_cnt,\n	subscription_hist_cnt,\n	univ_depts_hist_cnt,\n	van_restricted_hist_cnt,\n	access_hist_cnt,\n	last_res_search_date,\n	last_res_search_source,\n	last_res_search_completion_p,\n	last_overnight_res,\n	last_wkday_hrly_res,\n	last_wkday_daily_res,\n	last_wkend_hrly_res,\n	last_wkend_daily_res,\n	last_overnight_res_date,\n	last_wkday_hrly_res_date,\n	last_wkday_daily_res_date,\n	last_wkend_hrly_res_date,\n	last_wkend_daily_res_date,\n	last_res_search_type,\n	member_last_res_refresh_date,\n	last_reservation_id,\n	res_source,\n	res_source_description,\n	first_wkday_hrly_res,\n	first_wkend_hrly_res,\n	first_res_type,\n	days_from_join_to_first_res,\n	first_nps_cohort,\n	last_nps_cohort,\n	nps_survey_cnt,\n	total_hours_1_to_3mths,\n	total_hours_4_to_6mths,\n	total_hours_7_to_9mths,\n	total_hours_10_to_12mths,\n	total_distance_1_to_3mths,\n	total_distance_4_to_6mths,\n	total_distance_7_to_9mths,\n	total_distance_10_to_12mths,\n	distance_units,\n	next_fee_date,\n	next_fee_charge,\n	next_fee_freq,\n	first_res_search_source,\n	first_other_res,\n	first_noshow_res,\n	first_cancellation_res,\n	last_other_res,\n	last_noshow_res,\n	last_cancellation_res,\n	completed_res_3mths_s,\n	completed_res_6mths_s,\n	completed_res_9mths_s,\n	completed_res_1year_s,\n	completed_res_6mths_wrkday_s,\n	completed_res_1year_wrkday_s,\n	total_up_revenue_3mths_s,\n	total_up_revenue_6mths_s,\n	total_up_revenue_9mths_s,\n	total_up_revenue_1year_s,\n	avg_up_revenue_3mths_s,\n	avg_up_revenue_6mths_s,\n	avg_up_revenue_9mths_s,\n	avg_up_revenue_1year_s,\n	res_search_3mths_s,\n	res_search_turndown_3mths_s,\n	res_search_completions_3mths_s,\n	next_res_date_s,\n	res_refresh_date_s,\n	canceled_res_1year,\n	billed_noshow_res_1year,\n	total_res_1year,\n	affiliate_type,\n	anniversary_date,\n	last_res_rate_plan_key,\n	last_res_vehicle_class,\n	last_res_vehicle_id,\n	active_uni_p,\n	current_member_p,\n	first_join_account_id,\n	last_digit_first_account_id,\n	first_corporate_id,\n	current_suspension_reason_id,\n	first_application_id,\n	first_app_ijd_session_id,\n	first_application_ijd_p,\n	first_res_type_daily_hourly,\n	first_wkday_daily_am_start_res,\n	first_wkday_daily_pm_start_res,\n	first_wkend_daily_am_start_res,\n	first_wkend_daily_pm_start_res,\n	first_res_source,\n	first_res_source_desc,\n	first_res_vehicle_id,\n	first_res_zipfleet_id,\n	first_res_date,\n	second_res_date,\n	first_waiver_start_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.members_ext\nMINUS\nSELECT \n	member_id,\n	affiliate_id_1,\n	affiliate_name_1,\n	affiliate_id_2,\n	affiliate_name_2,\n	affiliate_id_3,\n	affiliate_name_3,\n	affiliate_id_4,\n	affiliate_name_4,\n	affiliate_id_5,\n	affiliate_name_5,\n	affiliate_id_6,\n	affiliate_name_6,\n	affiliate_id_7,\n	affiliate_name_7,\n	affiliate_id_8,\n	affiliate_name_8,\n	affiliate_id_9,\n	affiliate_name_9,\n	deleted_date,\n	last_modified,\n	affiliate_refresh_date,\n	waiver_eligible_p,\n	per_trip_waiver_eligible_p,\n	current_waiver_plan_id,\n	current_waiver_plan_name,\n	current_waiver_plan_fee,\n	current_waiver_tier,\n	current_waiver_deductible,\n	current_w_auto_renew_p,\n	current_waiver_start_date,\n	current_waiver_end_date,\n	per_trip_waiver_cnt,\n	last_per_trip_waiver_date,\n	ever_had_any_waiver_p,\n	waiver_refresh_date,\n	driver_risk_tier_info_p,\n	first_risk_tier_key,\n	last_risk_tier_key,\n	first_min_level,\n	last_min_level,\n	total_risk_tier_changes,\n	trips_completed,\n	last_accident_karma_date,\n	last_lic_points_karma_date,\n	driver_risk_refresh_date,\n	last_res_date,\n	last_res_type,\n	days_since_last_drive,\n	next_res_type,\n	days_until_next_drive,\n	first_gas_fillup_date,\n	first_gas_fillup_amount,\n	first_gas_fillup_charge,\n	last_gas_fillup_date,\n	last_gas_fillup_amount,\n	last_gas_fillup_charge,\n	fillup_cnt,\n	wex_refresh_date,\n	first_nps_response_date,\n	first_nps_complete,\n	first_nps_score,\n	last_nps_response_date,\n	last_nps_complete,\n	last_nps_score,\n	nps_survey_refresh,\n	first_res_search_date,\n	first_res_search_completion_p,\n	first_res_local_start_date,\n	first_overnight_res,\n	first_wkday_hrly_am_start_res,\n	first_wkday_hrly_pm_start_res,\n	first_wkend_hrly_am_start_res,\n	first_wkend_hrly_pm_start_res,\n	first_wkday_daily_res,\n	first_wkend_daily_res,\n	member_first_res_refresh_date,\n	refer_a_friend_cnt,\n	total_gift_card_cnt,\n	total_gift_card_amt_usd,\n	last_gift_card_purchase_date,\n	last_gift_card_purchas_amt_usd,\n	last_gift_card_purchase_curr,\n	gift_card_cnt,\n	late_return_cnt,\n	last_late_return_date,\n	last_late_return_minutes,\n	last_late_return_charge,\n	major_accidents_cnt,\n	minor_accidents_cnt,\n	last_accident_date,\n	last_accident_classification,\n	member_behavior_refresh_date,\n	zcorporate_cnt,\n	corporate_cnt,\n	personal_cnt,\n	evpersonal_cnt,\n	sponsored_cnt,\n	evsponsored_cnt,\n	z2b_large_accounts_cnt,\n	subscription_cnt,\n	univ_depts_cnt,\n	van_restricted_cnt,\n	access_cnt,\n	zcorporate_hist_cnt,\n	corporate_hist_cnt,\n	personal_hist_cnt,\n	evpersonal_hist_cnt,\n	sponsored_hist_cnt,\n	evsponsored_hist_cnt,\n	z2b_large_accounts_hist_cnt,\n	subscription_hist_cnt,\n	univ_depts_hist_cnt,\n	van_restricted_hist_cnt,\n	access_hist_cnt,\n	last_res_search_date,\n	last_res_search_source,\n	last_res_search_completion_p,\n	last_overnight_res,\n	last_wkday_hrly_res,\n	last_wkday_daily_res,\n	last_wkend_hrly_res,\n	last_wkend_daily_res,\n	last_overnight_res_date,\n	last_wkday_hrly_res_date,\n	last_wkday_daily_res_date,\n	last_wkend_hrly_res_date,\n	last_wkend_daily_res_date,\n	last_res_search_type,\n	member_last_res_refresh_date,\n	last_reservation_id,\n	res_source,\n	res_source_description,\n	first_wkday_hrly_res,\n	first_wkend_hrly_res,\n	first_res_type,\n	days_from_join_to_first_res,\n	first_nps_cohort,\n	last_nps_cohort,\n	nps_survey_cnt,\n	total_hours_1_to_3mths,\n	total_hours_4_to_6mths,\n	total_hours_7_to_9mths,\n	total_hours_10_to_12mths,\n	total_distance_1_to_3mths,\n	total_distance_4_to_6mths,\n	total_distance_7_to_9mths,\n	total_distance_10_to_12mths,\n	distance_units,\n	next_fee_date,\n	next_fee_charge,\n	next_fee_freq,\n	first_res_search_source,\n	first_other_res,\n	first_noshow_res,\n	first_cancellation_res,\n	last_other_res,\n	last_noshow_res,\n	last_cancellation_res,\n	completed_res_3mths_s,\n	completed_res_6mths_s,\n	completed_res_9mths_s,\n	completed_res_1year_s,\n	completed_res_6mths_wrkday_s,\n	completed_res_1year_wrkday_s,\n	total_up_revenue_3mths_s,\n	total_up_revenue_6mths_s,\n	total_up_revenue_9mths_s,\n	total_up_revenue_1year_s,\n	avg_up_revenue_3mths_s,\n	avg_up_revenue_6mths_s,\n	avg_up_revenue_9mths_s,\n	avg_up_revenue_1year_s,\n	res_search_3mths_s,\n	res_search_turndown_3mths_s,\n	res_search_completions_3mths_s,\n	next_res_date_s,\n	res_refresh_date_s,\n	canceled_res_1year,\n	billed_noshow_res_1year,\n	total_res_1year,\n	affiliate_type,\n	anniversary_date,\n	last_res_rate_plan_key,\n	last_res_vehicle_class,\n	last_res_vehicle_id,\n	active_uni_p,\n	current_member_p,\n	first_join_account_id,\n	last_digit_first_account_id,\n	first_corporate_id,\n	current_suspension_reason_id,\n	first_application_id,\n	first_app_ijd_session_id,\n	first_application_ijd_p,\n	first_res_type_daily_hourly,\n	first_wkday_daily_am_start_res,\n	first_wkday_daily_pm_start_res,\n	first_wkend_daily_am_start_res,\n	first_wkend_daily_pm_start_res,\n	first_res_source,\n	first_res_source_desc,\n	first_res_vehicle_id,\n	first_res_zipfleet_id,\n	first_res_date,\n	second_res_date,\n	first_waiver_start_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_members_ext\n",
...
"\nCREATE TEMP TABLE tmp_members_ext AS\n	SELECT\n        t1.*\n    FROM {{marketing.schema}}.r_members_ext t1\n    LEFT JOIN {{marketing.schema}}.r_members_ext t2 \n		ON t1.member_id = t2.member_id\n        AND t1.imported_date < t2.imported_date\n    WHERE\n        t2.imported_date IS NULL;\n\nTRUNCATE {{marketing.schema}}.r_members_ext;\n\nINSERT INTO {{marketing.schema}}.r_members_ext\n	SELECT * FROM tmp_members_ext;\n",
"marketing.schema",  StringHandling.DQUOTE(context.Redshift_Marketing_Schema),
"staging.schema",  StringHandling.DQUOTE(context.Redshift_Staging_Schema),
"rundate",  DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate))
);
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".members_ext";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_MembersExt ProcessStaging_MembersExtClass = new ProcessStaging_MembersExt();

        int exitCode = ProcessStaging_MembersExtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_MembersExt.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_membersext_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_MembersExt");
        }
...
/************************************************************************************************
 *     154997 characters generated by Talend Open Studio for Data Integration 
 *     on the October 16, 2018 5:21:52 PM CDT
 ************************************************************************************************/