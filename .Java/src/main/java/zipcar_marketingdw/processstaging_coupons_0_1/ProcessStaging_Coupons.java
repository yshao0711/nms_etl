...
package zipcar_marketingdw.processstaging_coupons_0_1;
...
/**
 * Job: ProcessStaging_Coupons Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Coupons implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Coupons";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_kdqtoJ85EeiRFIAwSyk92Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Coupons.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Coupons.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Coupons) {
...
"\nINSERT INTO {{marketing.schema}}.r_coupon\n(\n	coupon_id,\n	amount_redeemed,\n	annual_fee_discount,\n	app_fee_discount,\n	base_coupon_p,\n	bonus_points,\n	campaign_id,\n	commission_base_coupon_id,\n	coupon_code,\n	coupon_type,\n	coupon_type_admin,\n	creation_date,\n	creation_user,\n	currency_iso,\n	deleted_p,\n	description,\n	end_date,\n	fee_type_discount,\n	last_modified,\n	member_id,\n	number_members_claimed,\n	number_redeemed,\n	number_uses,\n	operation,\n	points,\n	redeemed_p,\n	referral_base_coupon_id,\n	referral_id,\n	referral_program_id,\n	referral_program_key,\n	referree_person_id,\n	referrer_account_id,\n	referrer_coupon_id,\n	referrer_member_id,\n	reimburse_type,\n	start_date,\n	use_type,\n	value,\n	void_date,\n	voided_p,\n	zipfleet_id,\n    imported_date\n)\nSELECT \n	coupon_id,\n	amount_redeemed,\n	annual_fee_discount,\n	app_fee_discount,\n	base_coupon_p,\n	bonus_points,\n	campaign_id,\n	commission_base_coupon_id,\n	coupon_code,\n	coupon_type,\n	coupon_type_admin,\n	creation_date,\n	creation_user,\n	currency_iso,\n	deleted_p,\n	description,\n	end_date,\n	fee_type_discount,\n	last_modified,\n	member_id,\n	number_members_claimed,\n	number_redeemed,\n	number_uses,\n	operation,\n	points,\n	redeemed_p,\n	referral_base_coupon_id,\n	referral_id,\n	referral_program_id,\n	referral_program_key,\n	referree_person_id,\n	referrer_account_id,\n	referrer_coupon_id,\n	referrer_member_id,\n	reimburse_type,\n	start_date,\n	use_type,\n	value,\n	void_date,\n	voided_p,\n	zipfleet_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.coupons\nMINUS\nSELECT \n	coupon_id,\n	amount_redeemed,\n	annual_fee_discount,\n	app_fee_discount,\n	base_coupon_p,\n	bonus_points,\n	campaign_id,\n	commission_base_coupon_id,\n	coupon_code,\n	coupon_type,\n	coupon_type_admin,\n	creation_date,\n	creation_user,\n	currency_iso,\n	deleted_p,\n	description,\n	end_date,\n	fee_type_discount,\n	last_modified,\n	member_id,\n	number_members_claimed,\n	number_redeemed,\n	number_uses,\n	operation,\n	points,\n	redeemed_p,\n	referral_base_coupon_id,\n	referral_id,\n	referral_program_id,\n	referral_program_key,\n	referree_person_id,\n	referrer_account_id,\n	referrer_coupon_id,\n	referrer_member_id,\n	reimburse_type,\n	start_date,\n	use_type,\n	value,\n	void_date,\n	voided_p,\n	zipfleet_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_coupon\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".coupons";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Coupons ProcessStaging_CouponsClass = new ProcessStaging_Coupons();

        int exitCode = ProcessStaging_CouponsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Coupons.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_coupons_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Coupons");
        }
...
/************************************************************************************************
 *     137427 characters generated by Talend Open Studio for Data Integration 
