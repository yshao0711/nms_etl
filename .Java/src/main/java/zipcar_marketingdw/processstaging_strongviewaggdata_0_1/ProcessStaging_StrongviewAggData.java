...
package zipcar_marketingdw.processstaging_strongviewaggdata_0_1;
...
/**
 * Job: ProcessStaging_StrongviewAggData Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_StrongviewAggData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_StrongviewAggData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Wq5aIMr6EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_StrongviewAggData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_StrongviewAggData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewAggData) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "strongview_agg_data";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_strongview_agg_data";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_strongview_agg_data\n(\n	log_type,\n	log_name,\n	data_captured_dt,\n	serial_no,\n	mailing_id,\n	database_id,\n	message_id,\n	user_id,\n	database_row_no,\n	database_name,\n	msg_serial_no,\n	email_address,\n	bounce_reason,\n	faliure_category,\n	faliure_type,\n	faliure_code,\n	vsg_name,\n	outbound_ip,\n	mx_ip,\n    imported_date\n)\nSELECT \n	log_type,\n	log_name,\n	data_captured_dt,\n	serial_no,\n	mailing_id,\n	database_id,\n	message_id,\n	user_id,\n	database_row_no,\n	database_name,\n	msg_serial_no,\n	email_address,\n	bounce_reason,\n	faliure_category,\n	faliure_type,\n	faliure_code,\n	vsg_name,\n	outbound_ip,\n	mx_ip,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.strongview_agg_data\nMINUS\nSELECT \n	log_type,\n	log_name,\n	data_captured_dt,\n	serial_no,\n	mailing_id,\n	database_id,\n	message_id,\n	user_id,\n	database_row_no,\n	database_name,\n	msg_serial_no,\n	email_address,\n	bounce_reason,\n	faliure_category,\n	faliure_type,\n	faliure_code,\n	vsg_name,\n	outbound_ip,\n	mx_ip,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_strongview_agg_data\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".strongview_agg_data";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_StrongviewAggData ProcessStaging_StrongviewAggDataClass = new ProcessStaging_StrongviewAggData();

        int exitCode = ProcessStaging_StrongviewAggDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_StrongviewAggData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_strongviewaggdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_StrongviewAggData");
        }
...
/************************************************************************************************
 *     136559 characters generated by Talend Open Studio for Data Integration 
