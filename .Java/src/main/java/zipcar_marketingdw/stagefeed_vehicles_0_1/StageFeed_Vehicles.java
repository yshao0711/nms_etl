...
package zipcar_marketingdw.stagefeed_vehicles_0_1;
...
/**
 * Job: StageFeed_Vehicles Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Vehicles implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Vehicles";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Ak3QQDTSEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Vehicles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Vehicles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Vehicles = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Vehicles) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.VEHICLES.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.VEHICLES.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.VEHICLES;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public String zipvan_p;

				public String getZipvan_p () {
					return this.zipvan_p;
				}
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.vehicle_id = this.vehicle_id;
	            ...
	            other.vin = this.vin;
	            other.zipvan_p = this.zipvan_p;
	            other.last_class = this.last_class;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Vehicles) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.zipvan_p = readString(dis);
					
					this.last_class = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.zipvan_p,dos);
					
					// String
				
						writeString(this.last_class,dos);
    ...
    public String toString() {
		...
		sb.append(",vin="+vin);
		sb.append(",zipvan_p="+zipvan_p);
		sb.append(",last_class="+last_class);
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c8(String zipvan_p){
							this.zipvan_p = zipvan_p;
							return this;
						}				
						String last_class;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String last_class){
							this.last_class = last_class;
							return this;
						}				
						String primary_maintainer;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String primary_maintainer){
							this.primary_maintainer = primary_maintainer;
							return this;
						}				
						Long zipfleet_id;
						
	            		public BufferLine_tRedshiftOutput_1 c11(Long zipfleet_id){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"vehicle_id\",\"year\",\"make\",\"model\",\"vehicle\",\"primary_style\",\"exterior_color\",\"vin\",\"zipvan_p\",\"last_class\",\"primary_maintainer\",\"zipfleet_id\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.zipvan_p = null;
					
							Row_FeedRecord.last_class = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.zipvan_p = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.last_class = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.zipvan_p = BooleanUtils.boolChar(Row_FeedRecord.zipvan_p);
Record_OutputToDB.last_class = StringUtils.trimToNull(Row_FeedRecord.last_class);
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.zipvan_p==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.zipvan_p);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.last_class==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.last_class);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c8(Record_OutputToDB.zipvan_p)
                        .c9(Record_OutputToDB.last_class)
                        .c10(Record_OutputToDB.primary_maintainer)
                        .c11(Record_OutputToDB.zipfleet_id)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.zipvan_p = Record_OutputToDB.zipvan_p;
                                After_Insert.last_class = Record_OutputToDB.last_class;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.zipvan_p = After_Insert.zipvan_p;
               Log_Rows.last_class = After_Insert.last_class;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"vehicle_id\",\"year\",\"make\",\"model\",\"vehicle\",\"primary_style\",\"exterior_color\",\"vin\",\"zipvan_p\",\"last_class\",\"primary_maintainer\",\"zipfleet_id\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.zipvan_p==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.zipvan_p);
					...
					if(bufferLtRedshiftOutput_1.last_class==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.last_class);
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.zipvan_p = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.last_class = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.zipvan_p = BooleanUtils.boolChar(row1.zipvan_p);
row2.last_class = StringUtils.trimToNull(row1.last_class);
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[12];
                            ...
                            rowtFileOutputDelimited_1[8]=row2.zipvan_p == null ? null : row2.zipvan_p;
                            rowtFileOutputDelimited_1[9]=row2.last_class == null ? null : row2.last_class;
                            rowtFileOutputDelimited_1[10]=row2.primary_maintainer == null ? null : row2.primary_maintainer;
                            rowtFileOutputDelimited_1[11]=row2.zipfleet_id == null ? null : String.valueOf(row2.zipfleet_id);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Vehicles StageFeed_VehiclesClass = new StageFeed_Vehicles();

        int exitCode = StageFeed_VehiclesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Vehicles.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_vehicles_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Vehicles");
        }
...
/************************************************************************************************
 *     329305 characters generated by Talend Open Studio for Data Integration 
