...
package zipcar_marketingdw.stagefeed_zipfleets_0_1;
...
/**
 * Job: StageFeed_Zipfleets Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Zipfleets implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Zipfleets";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_lQPzEDTSEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Zipfleets.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Zipfleets.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.ZIPFLEETS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.ZIPFLEETS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.ZIPFLEETS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public String timezone_region;

				public String getTimezone_region () {
					return this.timezone_region;
				}
			    ...
			    public String university_p;

				public String getUniversity_p () {
					return this.university_p;
				}
			    ...
			    public String rollup_path;

				public String getRollup_path () {
					return this.rollup_path;
				}
				
			    public String level_3_key;

				public String getLevel_3_key () {
					return this.level_3_key;
				}
				
			    public String level_4_key;

				public String getLevel_4_key () {
					return this.level_4_key;
				}
				
			    public String level_5_key;

				public String getLevel_5_key () {
					return this.level_5_key;
				}
				
			    public Long level_3_id;

				public Long getLevel_3_id () {
					return this.level_3_id;
				}
				
			    public Long level_4_id;

				public Long getLevel_4_id () {
					return this.level_4_id;
				}
				
			    public Long level_5_id;

				public Long getLevel_5_id () {
					return this.level_5_id;
				}
				
			    public String default_currency_iso;

				public String getDefault_currency_iso () {
					return this.default_currency_iso;
				}
				
			    public String rollup_sort;

				public String getRollup_sort () {
					return this.rollup_sort;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.zipfleet_id;
	...
	public boolean equals(Object obj) {
		...
		final Log_RowsStruct other = (Log_RowsStruct) obj;
						...
						if (this.zipfleet_id != other.zipfleet_id)
							return false;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.zipfleet_id = this.zipfleet_id;
	            other.fleet_name = this.fleet_name;
	            other.latitude = this.latitude;
	            other.longitude = this.longitude;
	            other.timezone_region = this.timezone_region;
	            other.locale = this.locale;
	            other.country_iso = this.country_iso;
	            other.university_p = this.university_p;
	            other.rollup_name = this.rollup_name;
	            other.rollup_path = this.rollup_path;
	            other.level_3_key = this.level_3_key;
	            other.level_4_key = this.level_4_key;
	            other.level_5_key = this.level_5_key;
	            other.level_3_id = this.level_3_id;
	            other.level_4_id = this.level_4_id;
	            other.level_5_id = this.level_5_id;
	            other.default_currency_iso = this.default_currency_iso;
	            other.rollup_sort = this.rollup_sort;
	            other.fleet_market_name = this.fleet_market_name;
	            other.fleet_country_name = this.fleet_country_name;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Zipfleets) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.timezone_region = readString(dis);
					
					this.locale = readString(dis);
					
					this.country_iso = readString(dis);
					
					this.university_p = readString(dis);
					
					this.rollup_name = readString(dis);
					
					this.rollup_path = readString(dis);
					
					this.level_3_key = readString(dis);
					
					this.level_4_key = readString(dis);
					
					this.level_5_key = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.level_3_id = null;
           				} else {
           			    	this.level_3_id = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.level_4_id = null;
           				} else {
           			    	this.level_4_id = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.level_5_id = null;
           				} else {
           			    	this.level_5_id = dis.readLong();
           				}
					
					this.default_currency_iso = readString(dis);
					
					this.rollup_sort = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.timezone_region,dos);
					...
					// String
						...
						writeString(this.university_p,dos);
					
					// String
				
						writeString(this.rollup_name,dos);
					
					// String
				
						writeString(this.rollup_path,dos);
					
					// String
				
						writeString(this.level_3_key,dos);
					
					// String
				
						writeString(this.level_4_key,dos);
					
					// String
				
						writeString(this.level_5_key,dos);
					
					// Long
				
						if(this.level_3_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.level_3_id);
		            	}
					
					// Long
				
						if(this.level_4_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.level_4_id);
		            	}
					
					// Long
				
						if(this.level_5_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.level_5_id);
		            	}
					
					// String
				
						writeString(this.default_currency_iso,dos);
					
					// String
				
						writeString(this.rollup_sort,dos);
    ...
    public String toString() {
		...
		sb.append(",timezone_region="+timezone_region);
		sb.append(",locale="+locale);
		sb.append(",country_iso="+country_iso);
		sb.append(",university_p="+university_p);
		sb.append(",rollup_name="+rollup_name);
		sb.append(",rollup_path="+rollup_path);
		sb.append(",level_3_key="+level_3_key);
		sb.append(",level_4_key="+level_4_key);
		sb.append(",level_5_key="+level_5_key);
		sb.append(",level_3_id="+String.valueOf(level_3_id));
		sb.append(",level_4_id="+String.valueOf(level_4_id));
		sb.append(",level_5_id="+String.valueOf(level_5_id));
		sb.append(",default_currency_iso="+default_currency_iso);
		sb.append(",rollup_sort="+rollup_sort);
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.zipfleet_id, other.zipfleet_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(long zipfleet_id){
							this.zipfleet_id = zipfleet_id;
							return this;
						}				
						String fleet_name;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String fleet_name){
							this.fleet_name = fleet_name;
							return this;
						}				
						Double latitude;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Double latitude){
							this.latitude = latitude;
							return this;
						}				
						Double longitude;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Double longitude){
							this.longitude = longitude;
							return this;
						}				
						String timezone_region;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String timezone_region){
							this.timezone_region = timezone_region;
							return this;
						}				
						String locale;
	            		...
	            		public BufferLine_tRedshiftOutput_1 c6(String country_iso){
							this.country_iso = country_iso;
							return this;
						}				
						String university_p;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String university_p){
							this.university_p = university_p;
							return this;
						}				
						String rollup_name;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String rollup_name){
							this.rollup_name = rollup_name;
							return this;
						}				
						String rollup_path;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String rollup_path){
							this.rollup_path = rollup_path;
							return this;
						}				
						String level_3_key;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String level_3_key){
							this.level_3_key = level_3_key;
							return this;
						}				
						String level_4_key;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String level_4_key){
							this.level_4_key = level_4_key;
							return this;
						}				
						String level_5_key;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String level_5_key){
							this.level_5_key = level_5_key;
							return this;
						}				
						Long level_3_id;
						
	            		public BufferLine_tRedshiftOutput_1 c13(Long level_3_id){
							this.level_3_id = level_3_id;
							return this;
						}				
						Long level_4_id;
						
	            		public BufferLine_tRedshiftOutput_1 c14(Long level_4_id){
							this.level_4_id = level_4_id;
							return this;
						}				
						Long level_5_id;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Long level_5_id){
							this.level_5_id = level_5_id;
							return this;
						}				
						String default_currency_iso;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String default_currency_iso){
							this.default_currency_iso = default_currency_iso;
							return this;
						}				
						String rollup_sort;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String rollup_sort){
							this.rollup_sort = rollup_sort;
							return this;
						}				
						String fleet_market_name;
						
	            		public BufferLine_tRedshiftOutput_1 c18(String fleet_market_name){
							this.fleet_market_name = fleet_market_name;
							return this;
						}				
						String fleet_country_name;
						
	            		public BufferLine_tRedshiftOutput_1 c19(String fleet_country_name){
							this.fleet_country_name = fleet_country_name;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"zipfleet_id\",\"fleet_name\",\"latitude\",\"longitude\",\"timezone_region\",\"locale\",\"country_iso\",\"university_p\",\"rollup_name\",\"rollup_path\",\"level_3_key\",\"level_4_key\",\"level_5_key\",\"level_3_id\",\"level_4_id\",\"level_5_id\",\"default_currency_iso\",\"rollup_sort\",\"fleet_market_name\",\"fleet_country_name\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.zipfleet_id = 0;
					
							Row_FeedRecord.fleet_name = null;
					
							Row_FeedRecord.latitude = null;
					
							Row_FeedRecord.longitude = null;
					
							Row_FeedRecord.timezone_region = null;
					
							Row_FeedRecord.locale = null;
					
							Row_FeedRecord.country_iso = null;
					
							Row_FeedRecord.university_p = null;
					
							Row_FeedRecord.rollup_name = null;
					
							Row_FeedRecord.rollup_path = null;
					
							Row_FeedRecord.level_3_key = null;
					
							Row_FeedRecord.level_4_key = null;
					
							Row_FeedRecord.level_5_key = null;
					
							Row_FeedRecord.level_3_id = null;
					
							Row_FeedRecord.level_4_id = null;
					
							Row_FeedRecord.level_5_id = null;
					
							Row_FeedRecord.default_currency_iso = null;
					
							Row_FeedRecord.rollup_sort = null;
					
							Row_FeedRecord.fleet_market_name = null;
					
							Row_FeedRecord.fleet_country_name = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.zipfleet_id = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'zipfleet_id' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.fleet_name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.timezone_region = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.country_iso = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.university_p = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.rollup_name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.rollup_path = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.level_3_key = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.level_4_key = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.level_5_key = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.level_3_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.level_4_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.level_5_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.default_currency_iso = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.rollup_sort = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.fleet_market_name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.fleet_country_name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.fleet_name = StringUtils.trimToNull(Row_FeedRecord.fleet_name);
Record_OutputToDB.latitude = Row_FeedRecord.latitude;
Record_OutputToDB.longitude = Row_FeedRecord.longitude;
Record_OutputToDB.timezone_region = StringUtils.trimToNull(Row_FeedRecord.timezone_region);
Record_OutputToDB.locale = StringUtils.trimToNull(Row_FeedRecord.locale);
Record_OutputToDB.country_iso = StringUtils.trimToNull(Row_FeedRecord.country_iso);
Record_OutputToDB.university_p = BooleanUtils.boolChar(Row_FeedRecord.university_p);
Record_OutputToDB.rollup_name = StringUtils.trimToNull(Row_FeedRecord.rollup_name);
Record_OutputToDB.rollup_path = StringUtils.trimToNull(Row_FeedRecord.rollup_path);
Record_OutputToDB.level_3_key = StringUtils.trimToNull(Row_FeedRecord.level_3_key);
Record_OutputToDB.level_4_key = StringUtils.trimToNull(Row_FeedRecord.level_4_key);
Record_OutputToDB.level_5_key = StringUtils.trimToNull(Row_FeedRecord.level_5_key);
Record_OutputToDB.level_3_id = Row_FeedRecord.level_3_id;
Record_OutputToDB.level_4_id = Row_FeedRecord.level_4_id;
Record_OutputToDB.level_5_id = Row_FeedRecord.level_5_id;
Record_OutputToDB.default_currency_iso = StringUtils.trimToNull(Row_FeedRecord.default_currency_iso);
Record_OutputToDB.rollup_sort = StringUtils.trimToNull(Row_FeedRecord.rollup_sort);
Record_OutputToDB.fleet_market_name = StringUtils.trimToNull(Row_FeedRecord.fleet_market_name);
Record_OutputToDB.fleet_country_name = StringUtils.trimToNull(Row_FeedRecord.fleet_country_name);
    nb_line_tJavaRow_2++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.fleet_name==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.fleet_name);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.timezone_region==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.timezone_region);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.country_iso==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.country_iso);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.university_p==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.university_p);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.rollup_name==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.rollup_name);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.rollup_path==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.rollup_path);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.level_3_key==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.level_3_key);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.level_4_key==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.level_4_key);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.level_5_key==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.level_5_key);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.level_3_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.level_3_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.level_4_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.level_4_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.level_5_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.level_5_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.default_currency_iso==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.default_currency_iso);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.rollup_sort==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.rollup_sort);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.fleet_market_name==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.fleet_market_name);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.fleet_country_name==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.fleet_country_name);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.zipfleet_id)
                        .c1(Record_OutputToDB.fleet_name)
                        .c2(Record_OutputToDB.latitude)
                        .c3(Record_OutputToDB.longitude)
                        .c4(Record_OutputToDB.timezone_region)
                        .c5(Record_OutputToDB.locale)
                        .c6(Record_OutputToDB.country_iso)
                        .c7(Record_OutputToDB.university_p)
                        .c8(Record_OutputToDB.rollup_name)
                        .c9(Record_OutputToDB.rollup_path)
                        .c10(Record_OutputToDB.level_3_key)
                        .c11(Record_OutputToDB.level_4_key)
                        .c12(Record_OutputToDB.level_5_key)
                        .c13(Record_OutputToDB.level_3_id)
                        .c14(Record_OutputToDB.level_4_id)
                        .c15(Record_OutputToDB.level_5_id)
                        .c16(Record_OutputToDB.default_currency_iso)
                        .c17(Record_OutputToDB.rollup_sort)
                        .c18(Record_OutputToDB.fleet_market_name)
                        .c19(Record_OutputToDB.fleet_country_name)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.fleet_name = Record_OutputToDB.fleet_name;
                                After_Insert.latitude = Record_OutputToDB.latitude;
                                After_Insert.longitude = Record_OutputToDB.longitude;
                                After_Insert.timezone_region = Record_OutputToDB.timezone_region;
                                After_Insert.locale = Record_OutputToDB.locale;
                                After_Insert.country_iso = Record_OutputToDB.country_iso;
                                After_Insert.university_p = Record_OutputToDB.university_p;
                                After_Insert.rollup_name = Record_OutputToDB.rollup_name;
                                After_Insert.rollup_path = Record_OutputToDB.rollup_path;
                                After_Insert.level_3_key = Record_OutputToDB.level_3_key;
                                After_Insert.level_4_key = Record_OutputToDB.level_4_key;
                                After_Insert.level_5_key = Record_OutputToDB.level_5_key;
                                After_Insert.level_3_id = Record_OutputToDB.level_3_id;
                                After_Insert.level_4_id = Record_OutputToDB.level_4_id;
                                After_Insert.level_5_id = Record_OutputToDB.level_5_id;
                                After_Insert.default_currency_iso = Record_OutputToDB.default_currency_iso;
                                After_Insert.rollup_sort = Record_OutputToDB.rollup_sort;
                                After_Insert.fleet_market_name = Record_OutputToDB.fleet_market_name;
                                After_Insert.fleet_country_name = Record_OutputToDB.fleet_country_name;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.timezone_region = After_Insert.timezone_region;
               Log_Rows.locale = After_Insert.locale;
               Log_Rows.country_iso = After_Insert.country_iso;
               Log_Rows.university_p = After_Insert.university_p;
               Log_Rows.rollup_name = After_Insert.rollup_name;
               Log_Rows.rollup_path = After_Insert.rollup_path;
               Log_Rows.level_3_key = After_Insert.level_3_key;
               Log_Rows.level_4_key = After_Insert.level_4_key;
               Log_Rows.level_5_key = After_Insert.level_5_key;
               Log_Rows.level_3_id = After_Insert.level_3_id;
               Log_Rows.level_4_id = After_Insert.level_4_id;
               Log_Rows.level_5_id = After_Insert.level_5_id;
               Log_Rows.default_currency_iso = After_Insert.default_currency_iso;
               Log_Rows.rollup_sort = After_Insert.rollup_sort;
               Log_Rows.fleet_market_name = After_Insert.fleet_market_name;
               Log_Rows.fleet_country_name = After_Insert.fleet_country_name;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"zipfleet_id\",\"fleet_name\",\"latitude\",\"longitude\",\"timezone_region\",\"locale\",\"country_iso\",\"university_p\",\"rollup_name\",\"rollup_path\",\"level_3_key\",\"level_4_key\",\"level_5_key\",\"level_3_id\",\"level_4_id\",\"level_5_id\",\"default_currency_iso\",\"rollup_sort\",\"fleet_market_name\",\"fleet_country_name\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.timezone_region==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.timezone_region);
					...
					if(bufferLtRedshiftOutput_1.university_p==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.university_p);
					...
					if(bufferLtRedshiftOutput_1.rollup_name==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.rollup_name);
					...
					if(bufferLtRedshiftOutput_1.rollup_path==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.rollup_path);
					...
					if(bufferLtRedshiftOutput_1.level_3_key==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.level_3_key);
					...
					if(bufferLtRedshiftOutput_1.level_4_key==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.level_4_key);
					...
					if(bufferLtRedshiftOutput_1.level_5_key==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.level_5_key);
					...
					if(bufferLtRedshiftOutput_1.level_3_id==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.level_3_id);
					...
					if(bufferLtRedshiftOutput_1.level_4_id==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.level_4_id);
					...
					if(bufferLtRedshiftOutput_1.level_5_id==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.level_5_id);
					...
					if(bufferLtRedshiftOutput_1.default_currency_iso==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.default_currency_iso);
					...
					if(bufferLtRedshiftOutput_1.rollup_sort==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.rollup_sort);
					...
					if(bufferLtRedshiftOutput_1.fleet_market_name==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.fleet_market_name);
					...
					if(bufferLtRedshiftOutput_1.fleet_country_name==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.fleet_country_name);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.timezone_region = null;
					
							row1.locale = null;
					
							row1.country_iso = null;
					
							row1.university_p = null;
					
							row1.rollup_name = null;
					
							row1.rollup_path = null;
					
							row1.level_3_key = null;
					
							row1.level_4_key = null;
					
							row1.level_5_key = null;
					
							row1.level_3_id = null;
					
							row1.level_4_id = null;
					
							row1.level_5_id = null;
					
							row1.default_currency_iso = null;
					
							row1.rollup_sort = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.zipfleet_id = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'zipfleet_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.timezone_region = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.country_iso = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.university_p = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.rollup_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.rollup_path = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.level_3_key = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.level_4_key = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.level_5_key = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.level_3_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.level_4_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.level_5_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.default_currency_iso = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.rollup_sort = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.fleet_market_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.fleet_country_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.timezone_region = StringUtils.trimToNull(row1.timezone_region);
row2.locale = StringUtils.trimToNull(row1.locale);
row2.country_iso = StringUtils.trimToNull(row1.country_iso);
row2.university_p = BooleanUtils.boolChar(row1.university_p);
row2.rollup_name = StringUtils.trimToNull(row1.rollup_name);
row2.rollup_path = StringUtils.trimToNull(row1.rollup_path);
row2.level_3_key = StringUtils.trimToNull(row1.level_3_key);
row2.level_4_key = StringUtils.trimToNull(row1.level_4_key);
row2.level_5_key = StringUtils.trimToNull(row1.level_5_key);
row2.level_3_id = row1.level_3_id;
row2.level_4_id = row1.level_4_id;
row2.level_5_id = row1.level_5_id;
row2.default_currency_iso = StringUtils.trimToNull(row1.default_currency_iso);
row2.rollup_sort = StringUtils.trimToNull(row1.rollup_sort);
row2.fleet_market_name = StringUtils.trimToNull(row1.fleet_market_name);
row2.fleet_country_name = StringUtils.trimToNull(row1.fleet_country_name);
    nb_line_tJavaRow_3++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[20];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.zipfleet_id);
                            rowtFileOutputDelimited_1[1]=row2.fleet_name == null ? null : row2.fleet_name;
                            rowtFileOutputDelimited_1[2]=row2.latitude == null ? null : String.valueOf(row2.latitude);
                            rowtFileOutputDelimited_1[3]=row2.longitude == null ? null : String.valueOf(row2.longitude);
                            rowtFileOutputDelimited_1[4]=row2.timezone_region == null ? null : row2.timezone_region;
                            rowtFileOutputDelimited_1[5]=row2.locale == null ? null : row2.locale;
                            rowtFileOutputDelimited_1[6]=row2.country_iso == null ? null : row2.country_iso;
                            rowtFileOutputDelimited_1[7]=row2.university_p == null ? null : row2.university_p;
                            rowtFileOutputDelimited_1[8]=row2.rollup_name == null ? null : row2.rollup_name;
                            rowtFileOutputDelimited_1[9]=row2.rollup_path == null ? null : row2.rollup_path;
                            rowtFileOutputDelimited_1[10]=row2.level_3_key == null ? null : row2.level_3_key;
                            rowtFileOutputDelimited_1[11]=row2.level_4_key == null ? null : row2.level_4_key;
                            rowtFileOutputDelimited_1[12]=row2.level_5_key == null ? null : row2.level_5_key;
                            rowtFileOutputDelimited_1[13]=row2.level_3_id == null ? null : String.valueOf(row2.level_3_id);
                            rowtFileOutputDelimited_1[14]=row2.level_4_id == null ? null : String.valueOf(row2.level_4_id);
                            rowtFileOutputDelimited_1[15]=row2.level_5_id == null ? null : String.valueOf(row2.level_5_id);
                            rowtFileOutputDelimited_1[16]=row2.default_currency_iso == null ? null : row2.default_currency_iso;
                            rowtFileOutputDelimited_1[17]=row2.rollup_sort == null ? null : row2.rollup_sort;
                            rowtFileOutputDelimited_1[18]=row2.fleet_market_name == null ? null : row2.fleet_market_name;
                            rowtFileOutputDelimited_1[19]=row2.fleet_country_name == null ? null : row2.fleet_country_name;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Zipfleets StageFeed_ZipfleetsClass = new StageFeed_Zipfleets();

        int exitCode = StageFeed_ZipfleetsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Zipfleets.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_zipfleets_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Zipfleets");
        }
...
/************************************************************************************************
 *     377540 characters generated by Talend Open Studio for Data Integration 
