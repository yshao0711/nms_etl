...
package zipcar_marketingdw.stagefeed_strongviewaggdata_0_1;
...
/**
 * Job: StageFeed_StrongviewAggData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewAggData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewAggData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_mkU4UMr3EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewAggData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewAggData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_AGG_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_AGG_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_AGG_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData = new byte[0];
			    ...
			    public java.util.Date DATA_CAPTURED_DT;

				public java.util.Date getDATA_CAPTURED_DT () {
					return this.DATA_CAPTURED_DT;
				}
			    ...
			    public String MAILING_ID;

				public String getMAILING_ID () {
			    ...
			    public String DATABASE_ROW_NO;

				public String getDATABASE_ROW_NO () {
					return this.DATABASE_ROW_NO;
				}
			    ...
			    public Long MSG_SERIAL_NO;

				public Long getMSG_SERIAL_NO () {
			    ...
			    public String BOUNCE_REASON;

				public String getBOUNCE_REASON () {
					return this.BOUNCE_REASON;
				}
				
			    public Integer FALIURE_CATEGORY;

				public Integer getFALIURE_CATEGORY () {
					return this.FALIURE_CATEGORY;
				}
				
			    public Integer FALIURE_TYPE;

				public Integer getFALIURE_TYPE () {
					return this.FALIURE_TYPE;
				}
				
			    public Integer FALIURE_CODE;

				public Integer getFALIURE_CODE () {
					return this.FALIURE_CODE;
				}
				
			    public String VSG_NAME;

				public String getVSG_NAME () {
					return this.VSG_NAME;
				}
				
			    public String OUTBOUND_IP;

				public String getOUTBOUND_IP () {
					return this.OUTBOUND_IP;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewAggData) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.LOG_TYPE = readInteger(dis);
					
					this.LOG_NAME = readString(dis);
					
					this.DATA_CAPTURED_DT = readDate(dis);
					
					this.SERIAL_NO = readString(dis);
					
					this.MAILING_ID = readString(dis);
					
					this.DATABASE_ID = readString(dis);
					
					this.MESSAGE_ID = readString(dis);
					
					this.USER_ID = readString(dis);
					
					this.DATABASE_ROW_NO = readString(dis);
					
					this.DATABASE_NAME = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.MSG_SERIAL_NO = null;
           				} else {
           			    	this.MSG_SERIAL_NO = dis.readLong();
           				}
					
					this.EMAIL_ADDRESS = readString(dis);
					
					this.BOUNCE_REASON = readString(dis);
					
						this.FALIURE_CATEGORY = readInteger(dis);
					
						this.FALIURE_TYPE = readInteger(dis);
					
						this.FALIURE_CODE = readInteger(dis);
					
					this.VSG_NAME = readString(dis);
					
					this.OUTBOUND_IP = readString(dis);
					
					this.MX_IP = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.LOG_TYPE,dos);
					
					// String
				
						writeString(this.LOG_NAME,dos);
					
					// java.util.Date
				
						writeDate(this.DATA_CAPTURED_DT,dos);
					...
					// String
						...
						writeString(this.MAILING_ID,dos);
					
					// String
				
						writeString(this.DATABASE_ID,dos);
					...
					// String
						...
						writeString(this.DATABASE_ROW_NO,dos);
					
					// String
				
						writeString(this.DATABASE_NAME,dos);
					
					// Long
				
						if(this.MSG_SERIAL_NO == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.MSG_SERIAL_NO);
		            	}
					...
					// String
						...
						writeString(this.BOUNCE_REASON,dos);
					
					// Integer
				
						writeInteger(this.FALIURE_CATEGORY,dos);
					
					// Integer
				
						writeInteger(this.FALIURE_TYPE,dos);
					
					// Integer
				
						writeInteger(this.FALIURE_CODE,dos);
					
					// String
				
						writeString(this.VSG_NAME,dos);
					
					// String
				
						writeString(this.OUTBOUND_IP,dos);
					
					// String
				
						writeString(this.MX_IP,dos);
    ...
    public String toString() {
		...
		sb.append(",LOG_NAME="+LOG_NAME);
		sb.append(",DATA_CAPTURED_DT="+String.valueOf(DATA_CAPTURED_DT));
		sb.append(",SERIAL_NO="+SERIAL_NO);
		sb.append(",MAILING_ID="+MAILING_ID);
		sb.append(",DATABASE_ID="+DATABASE_ID);
		sb.append(",MESSAGE_ID="+MESSAGE_ID);
		sb.append(",USER_ID="+USER_ID);
		sb.append(",DATABASE_ROW_NO="+DATABASE_ROW_NO);
		sb.append(",DATABASE_NAME="+DATABASE_NAME);
		sb.append(",MSG_SERIAL_NO="+String.valueOf(MSG_SERIAL_NO));
		sb.append(",EMAIL_ADDRESS="+EMAIL_ADDRESS);
		sb.append(",BOUNCE_REASON="+BOUNCE_REASON);
		sb.append(",FALIURE_CATEGORY="+String.valueOf(FALIURE_CATEGORY));
		sb.append(",FALIURE_TYPE="+String.valueOf(FALIURE_TYPE));
		sb.append(",FALIURE_CODE="+String.valueOf(FALIURE_CODE));
		sb.append(",VSG_NAME="+VSG_NAME);
		sb.append(",OUTBOUND_IP="+OUTBOUND_IP);
		sb.append(",MX_IP="+MX_IP);
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(Integer LOG_TYPE){
							this.LOG_TYPE = LOG_TYPE;
							return this;
						}				
						String LOG_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String LOG_NAME){
							this.LOG_NAME = LOG_NAME;
							return this;
						}				
						java.util.Date DATA_CAPTURED_DT;
						
	            		public BufferLine_tRedshiftOutput_1 c2(java.util.Date DATA_CAPTURED_DT){
							this.DATA_CAPTURED_DT = DATA_CAPTURED_DT;
							return this;
						}				
						String SERIAL_NO;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String SERIAL_NO){
							this.SERIAL_NO = SERIAL_NO;
							return this;
						}				
						String MAILING_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String MAILING_ID){
							this.MAILING_ID = MAILING_ID;
							return this;
						}				
						String DATABASE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String DATABASE_ID){
							this.DATABASE_ID = DATABASE_ID;
							return this;
						}				
						String MESSAGE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String MESSAGE_ID){
							this.MESSAGE_ID = MESSAGE_ID;
							return this;
						}				
						String USER_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String USER_ID){
							this.USER_ID = USER_ID;
							return this;
						}				
						String DATABASE_ROW_NO;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String DATABASE_ROW_NO){
							this.DATABASE_ROW_NO = DATABASE_ROW_NO;
							return this;
						}				
						String DATABASE_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String DATABASE_NAME){
							this.DATABASE_NAME = DATABASE_NAME;
							return this;
						}				
						Long MSG_SERIAL_NO;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Long MSG_SERIAL_NO){
							this.MSG_SERIAL_NO = MSG_SERIAL_NO;
							return this;
						}				
						String EMAIL_ADDRESS;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String EMAIL_ADDRESS){
							this.EMAIL_ADDRESS = EMAIL_ADDRESS;
							return this;
						}				
						String BOUNCE_REASON;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String BOUNCE_REASON){
							this.BOUNCE_REASON = BOUNCE_REASON;
							return this;
						}				
						Integer FALIURE_CATEGORY;
						
	            		public BufferLine_tRedshiftOutput_1 c13(Integer FALIURE_CATEGORY){
							this.FALIURE_CATEGORY = FALIURE_CATEGORY;
							return this;
						}				
						Integer FALIURE_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c14(Integer FALIURE_TYPE){
							this.FALIURE_TYPE = FALIURE_TYPE;
							return this;
						}				
						Integer FALIURE_CODE;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Integer FALIURE_CODE){
							this.FALIURE_CODE = FALIURE_CODE;
							return this;
						}				
						String VSG_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String VSG_NAME){
							this.VSG_NAME = VSG_NAME;
							return this;
						}				
						String OUTBOUND_IP;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String OUTBOUND_IP){
							this.OUTBOUND_IP = OUTBOUND_IP;
							return this;
						}				
						String MX_IP;
						
	            		public BufferLine_tRedshiftOutput_1 c18(String MX_IP){
							this.MX_IP = MX_IP;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"LOG_TYPE\",\"LOG_NAME\",\"DATA_CAPTURED_DT\",\"SERIAL_NO\",\"MAILING_ID\",\"DATABASE_ID\",\"MESSAGE_ID\",\"USER_ID\",\"DATABASE_ROW_NO\",\"DATABASE_NAME\",\"MSG_SERIAL_NO\",\"EMAIL_ADDRESS\",\"BOUNCE_REASON\",\"FALIURE_CATEGORY\",\"FALIURE_TYPE\",\"FALIURE_CODE\",\"VSG_NAME\",\"OUTBOUND_IP\",\"MX_IP\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.LOG_TYPE = null;
					
							Row_FeedRecord.LOG_NAME = null;
					
							Row_FeedRecord.DATA_CAPTURED_DT = null;
					
							Row_FeedRecord.SERIAL_NO = null;
					
							Row_FeedRecord.MAILING_ID = null;
					
							Row_FeedRecord.DATABASE_ID = null;
					
							Row_FeedRecord.MESSAGE_ID = null;
					
							Row_FeedRecord.USER_ID = null;
					
							Row_FeedRecord.DATABASE_ROW_NO = null;
					
							Row_FeedRecord.DATABASE_NAME = null;
					
							Row_FeedRecord.MSG_SERIAL_NO = null;
					
							Row_FeedRecord.EMAIL_ADDRESS = null;
					
							Row_FeedRecord.BOUNCE_REASON = null;
					
							Row_FeedRecord.FALIURE_CATEGORY = null;
					
							Row_FeedRecord.FALIURE_TYPE = null;
					
							Row_FeedRecord.FALIURE_CODE = null;
					
							Row_FeedRecord.VSG_NAME = null;
					
							Row_FeedRecord.OUTBOUND_IP = null;
					
							Row_FeedRecord.MX_IP = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LOG_TYPE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LOG_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.DATA_CAPTURED_DT = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SERIAL_NO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.MAILING_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DATABASE_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.MESSAGE_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.USER_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DATABASE_ROW_NO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DATABASE_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.MSG_SERIAL_NO = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.EMAIL_ADDRESS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.BOUNCE_REASON = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.FALIURE_CATEGORY = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.FALIURE_TYPE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.FALIURE_CODE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.VSG_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.OUTBOUND_IP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.MX_IP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.LOG_TYPE = Row_FeedRecord.LOG_TYPE;
Record_OutputToDB.LOG_NAME = StringUtils.trimToNull(Row_FeedRecord.LOG_NAME);
Record_OutputToDB.DATA_CAPTURED_DT = Row_FeedRecord.DATA_CAPTURED_DT;
Record_OutputToDB.SERIAL_NO = StringUtils.trimToNull(Row_FeedRecord.SERIAL_NO);
Record_OutputToDB.MAILING_ID = StringUtils.trimToNull(Row_FeedRecord.MAILING_ID);
Record_OutputToDB.DATABASE_ID = StringUtils.trimToNull(Row_FeedRecord.DATABASE_ID);
Record_OutputToDB.MESSAGE_ID = StringUtils.trimToNull(Row_FeedRecord.MESSAGE_ID);
Record_OutputToDB.USER_ID = StringUtils.trimToNull(Row_FeedRecord.USER_ID);
Record_OutputToDB.DATABASE_ROW_NO = StringUtils.trimToNull(Row_FeedRecord.DATABASE_ROW_NO);
Record_OutputToDB.DATABASE_NAME = StringUtils.trimToNull(Row_FeedRecord.DATABASE_NAME);
Record_OutputToDB.MSG_SERIAL_NO = Row_FeedRecord.MSG_SERIAL_NO;
Record_OutputToDB.EMAIL_ADDRESS = StringUtils.trimToNull(Row_FeedRecord.EMAIL_ADDRESS);
Record_OutputToDB.BOUNCE_REASON = StringUtils.trimToNull(Row_FeedRecord.BOUNCE_REASON);
Record_OutputToDB.FALIURE_CATEGORY = Row_FeedRecord.FALIURE_CATEGORY;
Record_OutputToDB.FALIURE_TYPE = Row_FeedRecord.FALIURE_TYPE;
Record_OutputToDB.FALIURE_CODE = Row_FeedRecord.FALIURE_CODE;
Record_OutputToDB.VSG_NAME = StringUtils.trimToNull(Row_FeedRecord.VSG_NAME);
Record_OutputToDB.OUTBOUND_IP = StringUtils.trimToNull(Row_FeedRecord.OUTBOUND_IP);
Record_OutputToDB.MX_IP = StringUtils.trimToNull(Row_FeedRecord.MX_IP);
    nb_line_tJavaRow_3++;   
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(Record_OutputToDB.LOG_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.LOG_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LOG_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LOG_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DATA_CAPTURED_DT!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.DATA_CAPTURED_DT.getTime();
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SERIAL_NO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SERIAL_NO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MAILING_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.MAILING_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DATABASE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DATABASE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MESSAGE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.MESSAGE_ID);
						...
						countertRedshiftOutput_1++;
							...
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.USER_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DATABASE_ROW_NO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DATABASE_ROW_NO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DATABASE_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DATABASE_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MSG_SERIAL_NO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.MSG_SERIAL_NO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.EMAIL_ADDRESS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.EMAIL_ADDRESS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.BOUNCE_REASON==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.BOUNCE_REASON);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FALIURE_CATEGORY==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.FALIURE_CATEGORY);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FALIURE_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.FALIURE_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FALIURE_CODE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.FALIURE_CODE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.VSG_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.VSG_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.OUTBOUND_IP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.OUTBOUND_IP);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MX_IP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.MX_IP);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.LOG_TYPE)
                        .c1(Record_OutputToDB.LOG_NAME)
                        .c2(Record_OutputToDB.DATA_CAPTURED_DT)
                        .c3(Record_OutputToDB.SERIAL_NO)
                        .c4(Record_OutputToDB.MAILING_ID)
                        .c5(Record_OutputToDB.DATABASE_ID)
                        .c6(Record_OutputToDB.MESSAGE_ID)
                        .c7(Record_OutputToDB.USER_ID)
                        .c8(Record_OutputToDB.DATABASE_ROW_NO)
                        .c9(Record_OutputToDB.DATABASE_NAME)
                        .c10(Record_OutputToDB.MSG_SERIAL_NO)
                        .c11(Record_OutputToDB.EMAIL_ADDRESS)
                        .c12(Record_OutputToDB.BOUNCE_REASON)
                        .c13(Record_OutputToDB.FALIURE_CATEGORY)
                        .c14(Record_OutputToDB.FALIURE_TYPE)
                        .c15(Record_OutputToDB.FALIURE_CODE)
                        .c16(Record_OutputToDB.VSG_NAME)
                        .c17(Record_OutputToDB.OUTBOUND_IP)
                        .c18(Record_OutputToDB.MX_IP)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.LOG_TYPE = Record_OutputToDB.LOG_TYPE;
                                After_Insert.LOG_NAME = Record_OutputToDB.LOG_NAME;
                                After_Insert.DATA_CAPTURED_DT = Record_OutputToDB.DATA_CAPTURED_DT;
                                After_Insert.SERIAL_NO = Record_OutputToDB.SERIAL_NO;
                                After_Insert.MAILING_ID = Record_OutputToDB.MAILING_ID;
                                After_Insert.DATABASE_ID = Record_OutputToDB.DATABASE_ID;
                                After_Insert.MESSAGE_ID = Record_OutputToDB.MESSAGE_ID;
                                After_Insert.USER_ID = Record_OutputToDB.USER_ID;
                                After_Insert.DATABASE_ROW_NO = Record_OutputToDB.DATABASE_ROW_NO;
                                After_Insert.DATABASE_NAME = Record_OutputToDB.DATABASE_NAME;
                                After_Insert.MSG_SERIAL_NO = Record_OutputToDB.MSG_SERIAL_NO;
                                After_Insert.EMAIL_ADDRESS = Record_OutputToDB.EMAIL_ADDRESS;
                                After_Insert.BOUNCE_REASON = Record_OutputToDB.BOUNCE_REASON;
                                After_Insert.FALIURE_CATEGORY = Record_OutputToDB.FALIURE_CATEGORY;
                                After_Insert.FALIURE_TYPE = Record_OutputToDB.FALIURE_TYPE;
                                After_Insert.FALIURE_CODE = Record_OutputToDB.FALIURE_CODE;
                                After_Insert.VSG_NAME = Record_OutputToDB.VSG_NAME;
                                After_Insert.OUTBOUND_IP = Record_OutputToDB.OUTBOUND_IP;
                                After_Insert.MX_IP = Record_OutputToDB.MX_IP;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.LOG_TYPE = After_Insert.LOG_TYPE;
               Log_Rows.LOG_NAME = After_Insert.LOG_NAME;
               Log_Rows.DATA_CAPTURED_DT = After_Insert.DATA_CAPTURED_DT;
               Log_Rows.SERIAL_NO = After_Insert.SERIAL_NO;
               Log_Rows.MAILING_ID = After_Insert.MAILING_ID;
               Log_Rows.DATABASE_ID = After_Insert.DATABASE_ID;
               Log_Rows.MESSAGE_ID = After_Insert.MESSAGE_ID;
               Log_Rows.USER_ID = After_Insert.USER_ID;
               Log_Rows.DATABASE_ROW_NO = After_Insert.DATABASE_ROW_NO;
               Log_Rows.DATABASE_NAME = After_Insert.DATABASE_NAME;
               Log_Rows.MSG_SERIAL_NO = After_Insert.MSG_SERIAL_NO;
               Log_Rows.EMAIL_ADDRESS = After_Insert.EMAIL_ADDRESS;
               Log_Rows.BOUNCE_REASON = After_Insert.BOUNCE_REASON;
               Log_Rows.FALIURE_CATEGORY = After_Insert.FALIURE_CATEGORY;
               Log_Rows.FALIURE_TYPE = After_Insert.FALIURE_TYPE;
               Log_Rows.FALIURE_CODE = After_Insert.FALIURE_CODE;
               Log_Rows.VSG_NAME = After_Insert.VSG_NAME;
               Log_Rows.OUTBOUND_IP = After_Insert.OUTBOUND_IP;
               Log_Rows.MX_IP = After_Insert.MX_IP;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"LOG_TYPE\",\"LOG_NAME\",\"DATA_CAPTURED_DT\",\"SERIAL_NO\",\"MAILING_ID\",\"DATABASE_ID\",\"MESSAGE_ID\",\"USER_ID\",\"DATABASE_ROW_NO\",\"DATABASE_NAME\",\"MSG_SERIAL_NO\",\"EMAIL_ADDRESS\",\"BOUNCE_REASON\",\"FALIURE_CATEGORY\",\"FALIURE_TYPE\",\"FALIURE_CODE\",\"VSG_NAME\",\"OUTBOUND_IP\",\"MX_IP\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					if(bufferLtRedshiftOutput_1.LOG_TYPE==null){
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LOG_TYPE);
					...
					if(bufferLtRedshiftOutput_1.LOG_NAME==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LOG_NAME);
					...
					if(bufferLtRedshiftOutput_1.DATA_CAPTURED_DT!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.DATA_CAPTURED_DT.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.SERIAL_NO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SERIAL_NO);
					...
					if(bufferLtRedshiftOutput_1.MAILING_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MAILING_ID);
					...
					if(bufferLtRedshiftOutput_1.DATABASE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DATABASE_ID);
					...
					if(bufferLtRedshiftOutput_1.MESSAGE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MESSAGE_ID);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.USER_ID);
					...
					if(bufferLtRedshiftOutput_1.DATABASE_ROW_NO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DATABASE_ROW_NO);
					...
					if(bufferLtRedshiftOutput_1.DATABASE_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DATABASE_NAME);
					...
					if(bufferLtRedshiftOutput_1.MSG_SERIAL_NO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MSG_SERIAL_NO);
					...
					if(bufferLtRedshiftOutput_1.EMAIL_ADDRESS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.EMAIL_ADDRESS);
					...
					if(bufferLtRedshiftOutput_1.BOUNCE_REASON==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.BOUNCE_REASON);
					...
					if(bufferLtRedshiftOutput_1.FALIURE_CATEGORY==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FALIURE_CATEGORY);
					...
					if(bufferLtRedshiftOutput_1.FALIURE_TYPE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FALIURE_TYPE);
					...
					if(bufferLtRedshiftOutput_1.FALIURE_CODE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FALIURE_CODE);
					...
					if(bufferLtRedshiftOutput_1.VSG_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.VSG_NAME);
					...
					if(bufferLtRedshiftOutput_1.OUTBOUND_IP==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.OUTBOUND_IP);
					...
					if(bufferLtRedshiftOutput_1.MX_IP==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MX_IP);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.DATA_CAPTURED_DT = null;
					
							row1.SERIAL_NO = null;
					
							row1.MAILING_ID = null;
					
							row1.DATABASE_ID = null;
					
							row1.MESSAGE_ID = null;
					
							row1.USER_ID = null;
					
							row1.DATABASE_ROW_NO = null;
					
							row1.DATABASE_NAME = null;
					
							row1.MSG_SERIAL_NO = null;
					
							row1.EMAIL_ADDRESS = null;
					
							row1.BOUNCE_REASON = null;
					
							row1.FALIURE_CATEGORY = null;
					
							row1.FALIURE_TYPE = null;
					
							row1.FALIURE_CODE = null;
					
							row1.VSG_NAME = null;
					
							row1.OUTBOUND_IP = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LOG_TYPE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LOG_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.DATA_CAPTURED_DT = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SERIAL_NO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.MAILING_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DATABASE_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.MESSAGE_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.USER_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DATABASE_ROW_NO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DATABASE_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.MSG_SERIAL_NO = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.EMAIL_ADDRESS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.BOUNCE_REASON = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.FALIURE_CATEGORY = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.FALIURE_TYPE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.FALIURE_CODE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.VSG_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.OUTBOUND_IP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.MX_IP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.LOG_TYPE = row1.LOG_TYPE;
row2.LOG_NAME = StringUtils.trimToNull(row1.LOG_NAME);
row2.DATA_CAPTURED_DT = row1.DATA_CAPTURED_DT;
row2.SERIAL_NO = StringUtils.trimToNull(row1.SERIAL_NO);
row2.MAILING_ID = StringUtils.trimToNull(row1.MAILING_ID);
row2.DATABASE_ID = StringUtils.trimToNull(row1.DATABASE_ID);
row2.MESSAGE_ID = StringUtils.trimToNull(row1.MESSAGE_ID);
row2.USER_ID = StringUtils.trimToNull(row1.USER_ID);
row2.DATABASE_ROW_NO = StringUtils.trimToNull(row1.DATABASE_ROW_NO);
row2.DATABASE_NAME = StringUtils.trimToNull(row1.DATABASE_NAME);
row2.MSG_SERIAL_NO = row1.MSG_SERIAL_NO;
row2.EMAIL_ADDRESS = StringUtils.trimToNull(row1.EMAIL_ADDRESS);
row2.BOUNCE_REASON = StringUtils.trimToNull(row1.BOUNCE_REASON);
row2.FALIURE_CATEGORY = row1.FALIURE_CATEGORY;
row2.FALIURE_TYPE = row1.FALIURE_TYPE;
row2.FALIURE_CODE = row1.FALIURE_CODE;
row2.VSG_NAME = StringUtils.trimToNull(row1.VSG_NAME);
row2.OUTBOUND_IP = StringUtils.trimToNull(row1.OUTBOUND_IP);
row2.MX_IP = StringUtils.trimToNull(row1.MX_IP);
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[19];
                            rowtFileOutputDelimited_1[0]=row2.LOG_TYPE == null ? null : String.valueOf(row2.LOG_TYPE);
                            rowtFileOutputDelimited_1[1]=row2.LOG_NAME == null ? null : row2.LOG_NAME;
                            rowtFileOutputDelimited_1[2]=row2.DATA_CAPTURED_DT == null ? null : FormatterUtils.format_Date(row2.DATA_CAPTURED_DT, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[3]=row2.SERIAL_NO == null ? null : row2.SERIAL_NO;
                            rowtFileOutputDelimited_1[4]=row2.MAILING_ID == null ? null : row2.MAILING_ID;
                            rowtFileOutputDelimited_1[5]=row2.DATABASE_ID == null ? null : row2.DATABASE_ID;
                            rowtFileOutputDelimited_1[6]=row2.MESSAGE_ID == null ? null : row2.MESSAGE_ID;
                            rowtFileOutputDelimited_1[7]=row2.USER_ID == null ? null : row2.USER_ID;
                            rowtFileOutputDelimited_1[8]=row2.DATABASE_ROW_NO == null ? null : row2.DATABASE_ROW_NO;
                            rowtFileOutputDelimited_1[9]=row2.DATABASE_NAME == null ? null : row2.DATABASE_NAME;
                            rowtFileOutputDelimited_1[10]=row2.MSG_SERIAL_NO == null ? null : String.valueOf(row2.MSG_SERIAL_NO);
                            rowtFileOutputDelimited_1[11]=row2.EMAIL_ADDRESS == null ? null : row2.EMAIL_ADDRESS;
                            rowtFileOutputDelimited_1[12]=row2.BOUNCE_REASON == null ? null : row2.BOUNCE_REASON;
                            rowtFileOutputDelimited_1[13]=row2.FALIURE_CATEGORY == null ? null : String.valueOf(row2.FALIURE_CATEGORY);
                            rowtFileOutputDelimited_1[14]=row2.FALIURE_TYPE == null ? null : String.valueOf(row2.FALIURE_TYPE);
                            rowtFileOutputDelimited_1[15]=row2.FALIURE_CODE == null ? null : String.valueOf(row2.FALIURE_CODE);
                            rowtFileOutputDelimited_1[16]=row2.VSG_NAME == null ? null : row2.VSG_NAME;
                            rowtFileOutputDelimited_1[17]=row2.OUTBOUND_IP == null ? null : row2.OUTBOUND_IP;
                            rowtFileOutputDelimited_1[18]=row2.MX_IP == null ? null : row2.MX_IP;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewAggData StageFeed_StrongviewAggDataClass = new StageFeed_StrongviewAggData();

        int exitCode = StageFeed_StrongviewAggDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewAggData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewaggdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewAggData");
        }
...
/************************************************************************************************
 *     362806 characters generated by Talend Open Studio for Data Integration 
