...
package zipcar_marketingdw.stagefeed_applicationsfinal_0_1;
...
/**
 * Job: StageFeed_ApplicationsFinal Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_ApplicationsFinal implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_ApplicationsFinal";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_E9zWUAinEee4FKVeJl0OkQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_ApplicationsFinal.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_ApplicationsFinal.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.APPLICATIONS_FINAL.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.APPLICATIONS_FINAL.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.APPLICATIONS_FINAL.name();
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ApplicationsFinal = new byte[0];
			    ...
			    public String APPLICATION_APPROVAL_STATE;

				public String getAPPLICATION_APPROVAL_STATE () {
					return this.APPLICATION_APPROVAL_STATE;
				}
			    ...
			    public java.util.Date FINISHED_DATE;

				public java.util.Date getFINISHED_DATE () {
			    ...
			    public String CALLBACK_NOTE;

				public String getCALLBACK_NOTE () {
					return this.CALLBACK_NOTE;
				}
				
			    public String INCOMPLETE_APP_P;

				public String getINCOMPLETE_APP_P () {
					return this.INCOMPLETE_APP_P;
				}
				
			    public java.util.Date APPLICATION_CREATION_DATE;

				public java.util.Date getAPPLICATION_CREATION_DATE () {
					return this.APPLICATION_CREATION_DATE;
				}
				
			    public java.util.Date APPLICATION_APPROVAL_DATE;

				public java.util.Date getAPPLICATION_APPROVAL_DATE () {
					return this.APPLICATION_APPROVAL_DATE;
				}
				
			    public String DRIVER_CONFIRMED_ZIPCARD_P;

				public String getDRIVER_CONFIRMED_ZIPCARD_P () {
					return this.DRIVER_CONFIRMED_ZIPCARD_P;
				}
				
			    public String DRIVER_ZIPCARD;

				public String getDRIVER_ZIPCARD () {
					return this.DRIVER_ZIPCARD;
				}
				
			    public java.util.Date REJECTION_DATE;

				public java.util.Date getREJECTION_DATE () {
					return this.REJECTION_DATE;
				}
				
			    public String ZIPCARD_ACTIVATED_P;

				public String getZIPCARD_ACTIVATED_P () {
					return this.ZIPCARD_ACTIVATED_P;
				}
				
			    public Long ZIPCARD_ADDRESS_ID;

				public Long getZIPCARD_ADDRESS_ID () {
					return this.ZIPCARD_ADDRESS_ID;
				}
				
			    public java.util.Date ZIPCARD_ARRIVAL_DATE;

				public java.util.Date getZIPCARD_ARRIVAL_DATE () {
					return this.ZIPCARD_ARRIVAL_DATE;
				}
				
			    public String ZIPCARD_ARRIVAL_STATE;

				public String getZIPCARD_ARRIVAL_STATE () {
					return this.ZIPCARD_ARRIVAL_STATE;
				}
				
			    public Long ZIPCARD_ARRIVAL_USER;

				public Long getZIPCARD_ARRIVAL_USER () {
					return this.ZIPCARD_ARRIVAL_USER;
				}
				
			    public String ZIPCARD_RECEIVED_P;

				public String getZIPCARD_RECEIVED_P () {
					return this.ZIPCARD_RECEIVED_P;
				}
				
			    public String ZIPCARD;

				public String getZIPCARD () {
					return this.ZIPCARD;
				}
        		...
        		int length = 0;
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.APPLICATION_ID = dis.readLong();
           				}
					...
					this.DRIVER_STATUS = readString(dis);
					
					this.APPLICATION_TYPE = readString(dis);
					
					this.APPLICATION_APPROVAL_STATE = readString(dis);
					
					this.CREATION_DATE = readDate(dis);
					
					this.FINISHED_DATE = readDate(dis);
					...
					this.APPLICATION_CATEGORY = readString(dis);
					
					this.CALLBACK_NOTE = readString(dis);
					
					this.INCOMPLETE_APP_P = readString(dis);
					
					this.APPLICATION_CREATION_DATE = readDate(dis);
					
					this.APPLICATION_APPROVAL_DATE = readDate(dis);
					
					this.DRIVER_CONFIRMED_ZIPCARD_P = readString(dis);
					
					this.DRIVER_ZIPCARD = readString(dis);
					
					this.REJECTION_DATE = readDate(dis);
					
					this.ZIPCARD_ACTIVATED_P = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.ZIPCARD_ADDRESS_ID = null;
           				} else {
           			    	this.ZIPCARD_ADDRESS_ID = dis.readLong();
           				}
					
					this.ZIPCARD_ARRIVAL_DATE = readDate(dis);
					
					this.ZIPCARD_ARRIVAL_STATE = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.ZIPCARD_ARRIVAL_USER = null;
           				} else {
           			    	this.ZIPCARD_ARRIVAL_USER = dis.readLong();
           				}
					
					this.ZIPCARD_RECEIVED_P = readString(dis);
					
					this.ZIPCARD = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.APPLICATION_ID == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeLong(this.APPLICATION_ID);
		            	}
					...
					// String
						...
						writeString(this.DRIVER_STATUS,dos);
					...
					// String
						...
						writeString(this.APPLICATION_APPROVAL_STATE,dos);
					...
					// java.util.Date
						...
						writeDate(this.FINISHED_DATE,dos);
					...
					// String
						...
						writeString(this.APPLICATION_CATEGORY,dos);
					
					// String
				
						writeString(this.CALLBACK_NOTE,dos);
					
					// String
				
						writeString(this.INCOMPLETE_APP_P,dos);
					
					// java.util.Date
				
						writeDate(this.APPLICATION_CREATION_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.APPLICATION_APPROVAL_DATE,dos);
					
					// String
				
						writeString(this.DRIVER_CONFIRMED_ZIPCARD_P,dos);
					
					// String
				
						writeString(this.DRIVER_ZIPCARD,dos);
					
					// java.util.Date
				
						writeDate(this.REJECTION_DATE,dos);
					
					// String
				
						writeString(this.ZIPCARD_ACTIVATED_P,dos);
					
					// Long
				
						if(this.ZIPCARD_ADDRESS_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.ZIPCARD_ADDRESS_ID);
		            	}
					
					// java.util.Date
				
						writeDate(this.ZIPCARD_ARRIVAL_DATE,dos);
					
					// String
				
						writeString(this.ZIPCARD_ARRIVAL_STATE,dos);
					
					// Long
				
						if(this.ZIPCARD_ARRIVAL_USER == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.ZIPCARD_ARRIVAL_USER);
		            	}
					
					// String
				
						writeString(this.ZIPCARD_RECEIVED_P,dos);
					
					// String
				
						writeString(this.ZIPCARD,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("APPLICATION_ID="+String.valueOf(APPLICATION_ID));
		...
		sb.append(",DRIVER_STATUS="+DRIVER_STATUS);
		sb.append(",APPLICATION_TYPE="+APPLICATION_TYPE);
		sb.append(",APPLICATION_APPROVAL_STATE="+APPLICATION_APPROVAL_STATE);
		sb.append(",CREATION_DATE="+String.valueOf(CREATION_DATE));
		sb.append(",FINISHED_DATE="+String.valueOf(FINISHED_DATE));
		sb.append(",DELETED_DATE="+String.valueOf(DELETED_DATE));
		sb.append(",MEMBER_ZIPFLEET_ID="+String.valueOf(MEMBER_ZIPFLEET_ID));
		sb.append(",APPLICATION_CATEGORY="+APPLICATION_CATEGORY);
		sb.append(",CALLBACK_NOTE="+CALLBACK_NOTE);
		sb.append(",INCOMPLETE_APP_P="+INCOMPLETE_APP_P);
		sb.append(",APPLICATION_CREATION_DATE="+String.valueOf(APPLICATION_CREATION_DATE));
		sb.append(",APPLICATION_APPROVAL_DATE="+String.valueOf(APPLICATION_APPROVAL_DATE));
		sb.append(",DRIVER_CONFIRMED_ZIPCARD_P="+DRIVER_CONFIRMED_ZIPCARD_P);
		sb.append(",DRIVER_ZIPCARD="+DRIVER_ZIPCARD);
		sb.append(",REJECTION_DATE="+String.valueOf(REJECTION_DATE));
		sb.append(",ZIPCARD_ACTIVATED_P="+ZIPCARD_ACTIVATED_P);
		sb.append(",ZIPCARD_ADDRESS_ID="+String.valueOf(ZIPCARD_ADDRESS_ID));
		sb.append(",ZIPCARD_ARRIVAL_DATE="+String.valueOf(ZIPCARD_ARRIVAL_DATE));
		sb.append(",ZIPCARD_ARRIVAL_STATE="+ZIPCARD_ARRIVAL_STATE);
		sb.append(",ZIPCARD_ARRIVAL_USER="+String.valueOf(ZIPCARD_ARRIVAL_USER));
		sb.append(",ZIPCARD_RECEIVED_P="+ZIPCARD_RECEIVED_P);
		sb.append(",ZIPCARD="+ZIPCARD);
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(Long APPLICATION_ID){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c2(Long ACCOUNT_ID){
							this.ACCOUNT_ID = ACCOUNT_ID;
							return this;
						}				
						Long RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Long RATE_PLAN_ID){
							this.RATE_PLAN_ID = RATE_PLAN_ID;
							return this;
						}				
						String SOURCE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String SOURCE){
							this.SOURCE = SOURCE;
							return this;
						}				
						String DRIVER_STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String DRIVER_STATUS){
							this.DRIVER_STATUS = DRIVER_STATUS;
							return this;
						}				
						String APPLICATION_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String APPLICATION_TYPE){
							this.APPLICATION_TYPE = APPLICATION_TYPE;
							return this;
						}				
						String APPLICATION_APPROVAL_STATE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String APPLICATION_APPROVAL_STATE){
							this.APPLICATION_APPROVAL_STATE = APPLICATION_APPROVAL_STATE;
							return this;
						}				
						...
						java.util.Date FINISHED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c9(java.util.Date FINISHED_DATE){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c11(Long MEMBER_ZIPFLEET_ID){
							this.MEMBER_ZIPFLEET_ID = MEMBER_ZIPFLEET_ID;
							return this;
						}				
						String APPLICATION_CATEGORY;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String APPLICATION_CATEGORY){
							this.APPLICATION_CATEGORY = APPLICATION_CATEGORY;
							return this;
						}				
						String CALLBACK_NOTE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String CALLBACK_NOTE){
							this.CALLBACK_NOTE = CALLBACK_NOTE;
							return this;
						}				
						String INCOMPLETE_APP_P;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String INCOMPLETE_APP_P){
							this.INCOMPLETE_APP_P = INCOMPLETE_APP_P;
							return this;
						}				
						java.util.Date APPLICATION_CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c15(java.util.Date APPLICATION_CREATION_DATE){
							this.APPLICATION_CREATION_DATE = APPLICATION_CREATION_DATE;
							return this;
						}				
						java.util.Date APPLICATION_APPROVAL_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c16(java.util.Date APPLICATION_APPROVAL_DATE){
							this.APPLICATION_APPROVAL_DATE = APPLICATION_APPROVAL_DATE;
							return this;
						}				
						String DRIVER_CONFIRMED_ZIPCARD_P;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String DRIVER_CONFIRMED_ZIPCARD_P){
							this.DRIVER_CONFIRMED_ZIPCARD_P = DRIVER_CONFIRMED_ZIPCARD_P;
							return this;
						}				
						String DRIVER_ZIPCARD;
						
	            		public BufferLine_tRedshiftOutput_1 c18(String DRIVER_ZIPCARD){
							this.DRIVER_ZIPCARD = DRIVER_ZIPCARD;
							return this;
						}				
						java.util.Date REJECTION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c19(java.util.Date REJECTION_DATE){
							this.REJECTION_DATE = REJECTION_DATE;
							return this;
						}				
						String ZIPCARD_ACTIVATED_P;
						
	            		public BufferLine_tRedshiftOutput_1 c20(String ZIPCARD_ACTIVATED_P){
							this.ZIPCARD_ACTIVATED_P = ZIPCARD_ACTIVATED_P;
							return this;
						}				
						Long ZIPCARD_ADDRESS_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c21(Long ZIPCARD_ADDRESS_ID){
							this.ZIPCARD_ADDRESS_ID = ZIPCARD_ADDRESS_ID;
							return this;
						}				
						java.util.Date ZIPCARD_ARRIVAL_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c22(java.util.Date ZIPCARD_ARRIVAL_DATE){
							this.ZIPCARD_ARRIVAL_DATE = ZIPCARD_ARRIVAL_DATE;
							return this;
						}				
						String ZIPCARD_ARRIVAL_STATE;
						
	            		public BufferLine_tRedshiftOutput_1 c23(String ZIPCARD_ARRIVAL_STATE){
							this.ZIPCARD_ARRIVAL_STATE = ZIPCARD_ARRIVAL_STATE;
							return this;
						}				
						Long ZIPCARD_ARRIVAL_USER;
						
	            		public BufferLine_tRedshiftOutput_1 c24(Long ZIPCARD_ARRIVAL_USER){
							this.ZIPCARD_ARRIVAL_USER = ZIPCARD_ARRIVAL_USER;
							return this;
						}				
						String ZIPCARD_RECEIVED_P;
						
	            		public BufferLine_tRedshiftOutput_1 c25(String ZIPCARD_RECEIVED_P){
							this.ZIPCARD_RECEIVED_P = ZIPCARD_RECEIVED_P;
							return this;
						}				
						String ZIPCARD;
						
	            		public BufferLine_tRedshiftOutput_1 c26(String ZIPCARD){
							this.ZIPCARD = ZIPCARD;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"APPLICATION_ID\",\"MEMBER_ID\",\"ACCOUNT_ID\",\"RATE_PLAN_ID\",\"SOURCE\",\"DRIVER_STATUS\",\"APPLICATION_TYPE\",\"APPLICATION_APPROVAL_STATE\",\"CREATION_DATE\",\"FINISHED_DATE\",\"DELETED_DATE\",\"MEMBER_ZIPFLEET_ID\",\"APPLICATION_CATEGORY\",\"CALLBACK_NOTE\",\"INCOMPLETE_APP_P\",\"APPLICATION_CREATION_DATE\",\"APPLICATION_APPROVAL_DATE\",\"DRIVER_CONFIRMED_ZIPCARD_P\",\"DRIVER_ZIPCARD\",\"REJECTION_DATE\",\"ZIPCARD_ACTIVATED_P\",\"ZIPCARD_ADDRESS_ID\",\"ZIPCARD_ARRIVAL_DATE\",\"ZIPCARD_ARRIVAL_STATE\",\"ZIPCARD_ARRIVAL_USER\",\"ZIPCARD_RECEIVED_P\",\"ZIPCARD\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.APPLICATION_ID = null;
							...
							Row_FeedRecord.DRIVER_STATUS = null;
					
							Row_FeedRecord.APPLICATION_TYPE = null;
					
							Row_FeedRecord.APPLICATION_APPROVAL_STATE = null;
					
							Row_FeedRecord.CREATION_DATE = null;
					
							Row_FeedRecord.FINISHED_DATE = null;
					
							Row_FeedRecord.DELETED_DATE = null;
					
							Row_FeedRecord.MEMBER_ZIPFLEET_ID = null;
					
							Row_FeedRecord.APPLICATION_CATEGORY = null;
					
							Row_FeedRecord.CALLBACK_NOTE = null;
					
							Row_FeedRecord.INCOMPLETE_APP_P = null;
					
							Row_FeedRecord.APPLICATION_CREATION_DATE = null;
					
							Row_FeedRecord.APPLICATION_APPROVAL_DATE = null;
					
							Row_FeedRecord.DRIVER_CONFIRMED_ZIPCARD_P = null;
					
							Row_FeedRecord.DRIVER_ZIPCARD = null;
					
							Row_FeedRecord.REJECTION_DATE = null;
					
							Row_FeedRecord.ZIPCARD_ACTIVATED_P = null;
					
							Row_FeedRecord.ZIPCARD_ADDRESS_ID = null;
					
							Row_FeedRecord.ZIPCARD_ARRIVAL_DATE = null;
					
							Row_FeedRecord.ZIPCARD_ARRIVAL_STATE = null;
					
							Row_FeedRecord.ZIPCARD_ARRIVAL_USER = null;
					
							Row_FeedRecord.ZIPCARD_RECEIVED_P = null;
					
							Row_FeedRecord.ZIPCARD = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.APPLICATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DRIVER_STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.APPLICATION_TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.APPLICATION_APPROVAL_STATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.FINISHED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.MEMBER_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.APPLICATION_CATEGORY = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.CALLBACK_NOTE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.INCOMPLETE_APP_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.APPLICATION_CREATION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.APPLICATION_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DRIVER_CONFIRMED_ZIPCARD_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DRIVER_ZIPCARD = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.REJECTION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ZIPCARD_ACTIVATED_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ZIPCARD_ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.ZIPCARD_ARRIVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ZIPCARD_ARRIVAL_STATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ZIPCARD_ARRIVAL_USER = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ZIPCARD_RECEIVED_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ZIPCARD = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.APPLICATION_ID = Row_FeedRecord.APPLICATION_ID;
...
Record_OutputToDB.DRIVER_STATUS = StringUtils.trimToNull(Row_FeedRecord.DRIVER_STATUS);
Record_OutputToDB.APPLICATION_TYPE = StringUtils.trimToNull(Row_FeedRecord.APPLICATION_TYPE);
Record_OutputToDB.APPLICATION_APPROVAL_STATE = StringUtils.trimToNull(Row_FeedRecord.APPLICATION_APPROVAL_STATE);
Record_OutputToDB.CREATION_DATE = Row_FeedRecord.CREATION_DATE;
Record_OutputToDB.FINISHED_DATE = Row_FeedRecord.FINISHED_DATE;
Record_OutputToDB.DELETED_DATE = Row_FeedRecord.DELETED_DATE;
Record_OutputToDB.MEMBER_ZIPFLEET_ID = Row_FeedRecord.MEMBER_ZIPFLEET_ID;
Record_OutputToDB.APPLICATION_CATEGORY = StringUtils.trimToNull(Row_FeedRecord.APPLICATION_CATEGORY);
Record_OutputToDB.CALLBACK_NOTE = StringUtils.trimToNull(Row_FeedRecord.CALLBACK_NOTE);
Record_OutputToDB.INCOMPLETE_APP_P = BooleanUtils.boolChar(Row_FeedRecord.INCOMPLETE_APP_P);
Record_OutputToDB.APPLICATION_CREATION_DATE = Row_FeedRecord.APPLICATION_CREATION_DATE;
Record_OutputToDB.APPLICATION_APPROVAL_DATE = Row_FeedRecord.APPLICATION_APPROVAL_DATE;
Record_OutputToDB.DRIVER_CONFIRMED_ZIPCARD_P = BooleanUtils.boolChar(Row_FeedRecord.DRIVER_CONFIRMED_ZIPCARD_P);
Record_OutputToDB.DRIVER_ZIPCARD = StringUtils.trimToNull(Row_FeedRecord.DRIVER_ZIPCARD);
Record_OutputToDB.REJECTION_DATE = Row_FeedRecord.REJECTION_DATE;
Record_OutputToDB.ZIPCARD_ACTIVATED_P = BooleanUtils.boolChar(Row_FeedRecord.ZIPCARD_ACTIVATED_P);
Record_OutputToDB.ZIPCARD_ADDRESS_ID = Row_FeedRecord.ZIPCARD_ADDRESS_ID;
Record_OutputToDB.ZIPCARD_ARRIVAL_DATE = Row_FeedRecord.ZIPCARD_ARRIVAL_DATE;
Record_OutputToDB.ZIPCARD_ARRIVAL_STATE = StringUtils.trimToNull(Row_FeedRecord.ZIPCARD_ARRIVAL_STATE);
Record_OutputToDB.ZIPCARD_ARRIVAL_USER = Row_FeedRecord.ZIPCARD_ARRIVAL_USER;
Record_OutputToDB.ZIPCARD_RECEIVED_P = BooleanUtils.boolChar(Row_FeedRecord.ZIPCARD_RECEIVED_P);
Record_OutputToDB.ZIPCARD = StringUtils.trimToNull(Row_FeedRecord.ZIPCARD);
    nb_line_tJavaRow_2++;   
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(Record_OutputToDB.APPLICATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.APPLICATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DRIVER_STATUS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DRIVER_STATUS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APPLICATION_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.APPLICATION_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APPLICATION_APPROVAL_STATE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.APPLICATION_APPROVAL_STATE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FINISHED_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.FINISHED_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MEMBER_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.MEMBER_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APPLICATION_CATEGORY==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.APPLICATION_CATEGORY);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CALLBACK_NOTE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.CALLBACK_NOTE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.INCOMPLETE_APP_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.INCOMPLETE_APP_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APPLICATION_CREATION_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.APPLICATION_CREATION_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APPLICATION_APPROVAL_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.APPLICATION_APPROVAL_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DRIVER_CONFIRMED_ZIPCARD_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DRIVER_CONFIRMED_ZIPCARD_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DRIVER_ZIPCARD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DRIVER_ZIPCARD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.REJECTION_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.REJECTION_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZIPCARD_ACTIVATED_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ZIPCARD_ACTIVATED_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZIPCARD_ADDRESS_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ZIPCARD_ADDRESS_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZIPCARD_ARRIVAL_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.ZIPCARD_ARRIVAL_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZIPCARD_ARRIVAL_STATE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ZIPCARD_ARRIVAL_STATE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZIPCARD_ARRIVAL_USER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ZIPCARD_ARRIVAL_USER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZIPCARD_RECEIVED_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ZIPCARD_RECEIVED_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZIPCARD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ZIPCARD);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.APPLICATION_ID)
                        .c1(Record_OutputToDB.MEMBER_ID)
                        .c2(Record_OutputToDB.ACCOUNT_ID)
                        .c3(Record_OutputToDB.RATE_PLAN_ID)
                        .c4(Record_OutputToDB.SOURCE)
                        .c5(Record_OutputToDB.DRIVER_STATUS)
                        .c6(Record_OutputToDB.APPLICATION_TYPE)
                        .c7(Record_OutputToDB.APPLICATION_APPROVAL_STATE)
                        .c8(Record_OutputToDB.CREATION_DATE)
                        .c9(Record_OutputToDB.FINISHED_DATE)
                        .c10(Record_OutputToDB.DELETED_DATE)
                        .c11(Record_OutputToDB.MEMBER_ZIPFLEET_ID)
                        .c12(Record_OutputToDB.APPLICATION_CATEGORY)
                        .c13(Record_OutputToDB.CALLBACK_NOTE)
                        .c14(Record_OutputToDB.INCOMPLETE_APP_P)
                        .c15(Record_OutputToDB.APPLICATION_CREATION_DATE)
                        .c16(Record_OutputToDB.APPLICATION_APPROVAL_DATE)
                        .c17(Record_OutputToDB.DRIVER_CONFIRMED_ZIPCARD_P)
                        .c18(Record_OutputToDB.DRIVER_ZIPCARD)
                        .c19(Record_OutputToDB.REJECTION_DATE)
                        .c20(Record_OutputToDB.ZIPCARD_ACTIVATED_P)
                        .c21(Record_OutputToDB.ZIPCARD_ADDRESS_ID)
                        .c22(Record_OutputToDB.ZIPCARD_ARRIVAL_DATE)
                        .c23(Record_OutputToDB.ZIPCARD_ARRIVAL_STATE)
                        .c24(Record_OutputToDB.ZIPCARD_ARRIVAL_USER)
                        .c25(Record_OutputToDB.ZIPCARD_RECEIVED_P)
                        .c26(Record_OutputToDB.ZIPCARD)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.APPLICATION_ID = Record_OutputToDB.APPLICATION_ID;
                                ...
                                After_Insert.DRIVER_STATUS = Record_OutputToDB.DRIVER_STATUS;
                                After_Insert.APPLICATION_TYPE = Record_OutputToDB.APPLICATION_TYPE;
                                After_Insert.APPLICATION_APPROVAL_STATE = Record_OutputToDB.APPLICATION_APPROVAL_STATE;
                                After_Insert.CREATION_DATE = Record_OutputToDB.CREATION_DATE;
                                After_Insert.FINISHED_DATE = Record_OutputToDB.FINISHED_DATE;
                                After_Insert.DELETED_DATE = Record_OutputToDB.DELETED_DATE;
                                After_Insert.MEMBER_ZIPFLEET_ID = Record_OutputToDB.MEMBER_ZIPFLEET_ID;
                                After_Insert.APPLICATION_CATEGORY = Record_OutputToDB.APPLICATION_CATEGORY;
                                After_Insert.CALLBACK_NOTE = Record_OutputToDB.CALLBACK_NOTE;
                                After_Insert.INCOMPLETE_APP_P = Record_OutputToDB.INCOMPLETE_APP_P;
                                After_Insert.APPLICATION_CREATION_DATE = Record_OutputToDB.APPLICATION_CREATION_DATE;
                                After_Insert.APPLICATION_APPROVAL_DATE = Record_OutputToDB.APPLICATION_APPROVAL_DATE;
                                After_Insert.DRIVER_CONFIRMED_ZIPCARD_P = Record_OutputToDB.DRIVER_CONFIRMED_ZIPCARD_P;
                                After_Insert.DRIVER_ZIPCARD = Record_OutputToDB.DRIVER_ZIPCARD;
                                After_Insert.REJECTION_DATE = Record_OutputToDB.REJECTION_DATE;
                                After_Insert.ZIPCARD_ACTIVATED_P = Record_OutputToDB.ZIPCARD_ACTIVATED_P;
                                After_Insert.ZIPCARD_ADDRESS_ID = Record_OutputToDB.ZIPCARD_ADDRESS_ID;
                                After_Insert.ZIPCARD_ARRIVAL_DATE = Record_OutputToDB.ZIPCARD_ARRIVAL_DATE;
                                After_Insert.ZIPCARD_ARRIVAL_STATE = Record_OutputToDB.ZIPCARD_ARRIVAL_STATE;
                                After_Insert.ZIPCARD_ARRIVAL_USER = Record_OutputToDB.ZIPCARD_ARRIVAL_USER;
                                After_Insert.ZIPCARD_RECEIVED_P = Record_OutputToDB.ZIPCARD_RECEIVED_P;
                                After_Insert.ZIPCARD = Record_OutputToDB.ZIPCARD;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.APPLICATION_ID = After_Insert.APPLICATION_ID;
               ...
               Log_Rows.DRIVER_STATUS = After_Insert.DRIVER_STATUS;
               Log_Rows.APPLICATION_TYPE = After_Insert.APPLICATION_TYPE;
               Log_Rows.APPLICATION_APPROVAL_STATE = After_Insert.APPLICATION_APPROVAL_STATE;
               Log_Rows.CREATION_DATE = After_Insert.CREATION_DATE;
               Log_Rows.FINISHED_DATE = After_Insert.FINISHED_DATE;
               Log_Rows.DELETED_DATE = After_Insert.DELETED_DATE;
               Log_Rows.MEMBER_ZIPFLEET_ID = After_Insert.MEMBER_ZIPFLEET_ID;
               Log_Rows.APPLICATION_CATEGORY = After_Insert.APPLICATION_CATEGORY;
               Log_Rows.CALLBACK_NOTE = After_Insert.CALLBACK_NOTE;
               Log_Rows.INCOMPLETE_APP_P = After_Insert.INCOMPLETE_APP_P;
               Log_Rows.APPLICATION_CREATION_DATE = After_Insert.APPLICATION_CREATION_DATE;
               Log_Rows.APPLICATION_APPROVAL_DATE = After_Insert.APPLICATION_APPROVAL_DATE;
               Log_Rows.DRIVER_CONFIRMED_ZIPCARD_P = After_Insert.DRIVER_CONFIRMED_ZIPCARD_P;
               Log_Rows.DRIVER_ZIPCARD = After_Insert.DRIVER_ZIPCARD;
               Log_Rows.REJECTION_DATE = After_Insert.REJECTION_DATE;
               Log_Rows.ZIPCARD_ACTIVATED_P = After_Insert.ZIPCARD_ACTIVATED_P;
               Log_Rows.ZIPCARD_ADDRESS_ID = After_Insert.ZIPCARD_ADDRESS_ID;
               Log_Rows.ZIPCARD_ARRIVAL_DATE = After_Insert.ZIPCARD_ARRIVAL_DATE;
               Log_Rows.ZIPCARD_ARRIVAL_STATE = After_Insert.ZIPCARD_ARRIVAL_STATE;
               Log_Rows.ZIPCARD_ARRIVAL_USER = After_Insert.ZIPCARD_ARRIVAL_USER;
               Log_Rows.ZIPCARD_RECEIVED_P = After_Insert.ZIPCARD_RECEIVED_P;
               Log_Rows.ZIPCARD = After_Insert.ZIPCARD;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"APPLICATION_ID\",\"MEMBER_ID\",\"ACCOUNT_ID\",\"RATE_PLAN_ID\",\"SOURCE\",\"DRIVER_STATUS\",\"APPLICATION_TYPE\",\"APPLICATION_APPROVAL_STATE\",\"CREATION_DATE\",\"FINISHED_DATE\",\"DELETED_DATE\",\"MEMBER_ZIPFLEET_ID\",\"APPLICATION_CATEGORY\",\"CALLBACK_NOTE\",\"INCOMPLETE_APP_P\",\"APPLICATION_CREATION_DATE\",\"APPLICATION_APPROVAL_DATE\",\"DRIVER_CONFIRMED_ZIPCARD_P\",\"DRIVER_ZIPCARD\",\"REJECTION_DATE\",\"ZIPCARD_ACTIVATED_P\",\"ZIPCARD_ADDRESS_ID\",\"ZIPCARD_ARRIVAL_DATE\",\"ZIPCARD_ARRIVAL_STATE\",\"ZIPCARD_ARRIVAL_USER\",\"ZIPCARD_RECEIVED_P\",\"ZIPCARD\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					if(bufferLtRedshiftOutput_1.APPLICATION_ID==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.APPLICATION_ID);
					...
					if(bufferLtRedshiftOutput_1.DRIVER_STATUS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DRIVER_STATUS);
					...
					if(bufferLtRedshiftOutput_1.APPLICATION_TYPE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.APPLICATION_TYPE);
					...
					if(bufferLtRedshiftOutput_1.APPLICATION_APPROVAL_STATE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.APPLICATION_APPROVAL_STATE);
					...
					if(bufferLtRedshiftOutput_1.FINISHED_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.FINISHED_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.MEMBER_ZIPFLEET_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MEMBER_ZIPFLEET_ID);
					...
					if(bufferLtRedshiftOutput_1.APPLICATION_CATEGORY==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.APPLICATION_CATEGORY);
					...
					if(bufferLtRedshiftOutput_1.CALLBACK_NOTE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CALLBACK_NOTE);
					...
					if(bufferLtRedshiftOutput_1.INCOMPLETE_APP_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.INCOMPLETE_APP_P);
					...
					if(bufferLtRedshiftOutput_1.APPLICATION_CREATION_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.APPLICATION_CREATION_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.APPLICATION_APPROVAL_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.APPLICATION_APPROVAL_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.DRIVER_CONFIRMED_ZIPCARD_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DRIVER_CONFIRMED_ZIPCARD_P);
					...
					if(bufferLtRedshiftOutput_1.DRIVER_ZIPCARD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DRIVER_ZIPCARD);
					...
					if(bufferLtRedshiftOutput_1.REJECTION_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.REJECTION_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.ZIPCARD_ACTIVATED_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ZIPCARD_ACTIVATED_P);
					...
					if(bufferLtRedshiftOutput_1.ZIPCARD_ADDRESS_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ZIPCARD_ADDRESS_ID);
					...
					if(bufferLtRedshiftOutput_1.ZIPCARD_ARRIVAL_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.ZIPCARD_ARRIVAL_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.ZIPCARD_ARRIVAL_STATE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ZIPCARD_ARRIVAL_STATE);
					...
					if(bufferLtRedshiftOutput_1.ZIPCARD_ARRIVAL_USER==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ZIPCARD_ARRIVAL_USER);
					...
					if(bufferLtRedshiftOutput_1.ZIPCARD_RECEIVED_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ZIPCARD_RECEIVED_P);
					...
					if(bufferLtRedshiftOutput_1.ZIPCARD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ZIPCARD);
...
String fileName_tFileOutputDelimited_1 = "";
    ...
    globalMap.put("tFileOutputDelimited_1_FILE_NAME",fileName_tFileOutputDelimited_1);
                String[] headColutFileOutputDelimited_1=new String[27];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.DRIVER_STATUS = null;
					
							row1.APPLICATION_TYPE = null;
					
							row1.APPLICATION_APPROVAL_STATE = null;
					
							row1.CREATION_DATE = null;
					
							row1.FINISHED_DATE = null;
					
							row1.DELETED_DATE = null;
					
							row1.MEMBER_ZIPFLEET_ID = null;
					
							row1.APPLICATION_CATEGORY = null;
					
							row1.CALLBACK_NOTE = null;
					
							row1.INCOMPLETE_APP_P = null;
					
							row1.APPLICATION_CREATION_DATE = null;
					
							row1.APPLICATION_APPROVAL_DATE = null;
					
							row1.DRIVER_CONFIRMED_ZIPCARD_P = null;
					
							row1.DRIVER_ZIPCARD = null;
					
							row1.REJECTION_DATE = null;
					
							row1.ZIPCARD_ACTIVATED_P = null;
					
							row1.ZIPCARD_ADDRESS_ID = null;
					
							row1.ZIPCARD_ARRIVAL_DATE = null;
					
							row1.ZIPCARD_ARRIVAL_STATE = null;
					
							row1.ZIPCARD_ARRIVAL_USER = null;
					
							row1.ZIPCARD_RECEIVED_P = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.APPLICATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DRIVER_STATUS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.APPLICATION_TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.APPLICATION_APPROVAL_STATE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.FINISHED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.APPLICATION_CATEGORY = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.CALLBACK_NOTE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.INCOMPLETE_APP_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.APPLICATION_CREATION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.APPLICATION_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DRIVER_CONFIRMED_ZIPCARD_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DRIVER_ZIPCARD = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.REJECTION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ZIPCARD_ACTIVATED_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ZIPCARD_ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.ZIPCARD_ARRIVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ZIPCARD_ARRIVAL_STATE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ZIPCARD_ARRIVAL_USER = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ZIPCARD_RECEIVED_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ZIPCARD = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.APPLICATION_ID = row1.APPLICATION_ID;
...
row2.DRIVER_STATUS = StringUtils.trimToNull(row1.DRIVER_STATUS);
row2.APPLICATION_TYPE = StringUtils.trimToNull(row1.APPLICATION_TYPE);
row2.APPLICATION_APPROVAL_STATE = StringUtils.trimToNull(row1.APPLICATION_APPROVAL_STATE);
row2.CREATION_DATE = row1.CREATION_DATE;
row2.FINISHED_DATE = row1.FINISHED_DATE;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.MEMBER_ZIPFLEET_ID = row1.MEMBER_ZIPFLEET_ID;
row2.APPLICATION_CATEGORY = StringUtils.trimToNull(row1.APPLICATION_CATEGORY);
row2.CALLBACK_NOTE = StringUtils.trimToNull(row1.CALLBACK_NOTE);
row2.INCOMPLETE_APP_P = BooleanUtils.boolChar(row1.INCOMPLETE_APP_P);
row2.APPLICATION_CREATION_DATE = row1.APPLICATION_CREATION_DATE;
row2.APPLICATION_APPROVAL_DATE = row1.APPLICATION_APPROVAL_DATE;
row2.DRIVER_CONFIRMED_ZIPCARD_P = BooleanUtils.boolChar(row1.DRIVER_CONFIRMED_ZIPCARD_P);
row2.DRIVER_ZIPCARD = StringUtils.trimToNull(row1.DRIVER_ZIPCARD);
row2.REJECTION_DATE = row1.REJECTION_DATE;
row2.ZIPCARD_ACTIVATED_P = BooleanUtils.boolChar(row1.ZIPCARD_ACTIVATED_P);
row2.ZIPCARD_ADDRESS_ID = row1.ZIPCARD_ADDRESS_ID;
row2.ZIPCARD_ARRIVAL_DATE = row1.ZIPCARD_ARRIVAL_DATE;
row2.ZIPCARD_ARRIVAL_STATE = StringUtils.trimToNull(row1.ZIPCARD_ARRIVAL_STATE);
row2.ZIPCARD_ARRIVAL_USER = row1.ZIPCARD_ARRIVAL_USER;
row2.ZIPCARD_RECEIVED_P = BooleanUtils.boolChar(row1.ZIPCARD_RECEIVED_P);
row2.ZIPCARD = StringUtils.trimToNull(row1.ZIPCARD);
    nb_line_tJavaRow_3++;   
			...
			//row2
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[27];
                            rowtFileOutputDelimited_1[0]=row2.APPLICATION_ID == null ? null : String.valueOf(row2.APPLICATION_ID);
                            rowtFileOutputDelimited_1[1]=row2.MEMBER_ID == null ? null : String.valueOf(row2.MEMBER_ID);
                            rowtFileOutputDelimited_1[2]=row2.ACCOUNT_ID == null ? null : String.valueOf(row2.ACCOUNT_ID);
                            rowtFileOutputDelimited_1[3]=row2.RATE_PLAN_ID == null ? null : String.valueOf(row2.RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[4]=row2.SOURCE == null ? null : row2.SOURCE;
                            rowtFileOutputDelimited_1[5]=row2.DRIVER_STATUS == null ? null : row2.DRIVER_STATUS;
                            rowtFileOutputDelimited_1[6]=row2.APPLICATION_TYPE == null ? null : row2.APPLICATION_TYPE;
                            rowtFileOutputDelimited_1[7]=row2.APPLICATION_APPROVAL_STATE == null ? null : row2.APPLICATION_APPROVAL_STATE;
                            ...
                            rowtFileOutputDelimited_1[9]=row2.FINISHED_DATE == null ? null : FormatterUtils.format_Date(row2.FINISHED_DATE, FeedFile.DF_DATETIME);
                            ...
                            rowtFileOutputDelimited_1[11]=row2.MEMBER_ZIPFLEET_ID == null ? null : String.valueOf(row2.MEMBER_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[12]=row2.APPLICATION_CATEGORY == null ? null : row2.APPLICATION_CATEGORY;
                            rowtFileOutputDelimited_1[13]=row2.CALLBACK_NOTE == null ? null : row2.CALLBACK_NOTE;
                            rowtFileOutputDelimited_1[14]=row2.INCOMPLETE_APP_P == null ? null : row2.INCOMPLETE_APP_P;
                            rowtFileOutputDelimited_1[15]=row2.APPLICATION_CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.APPLICATION_CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[16]=row2.APPLICATION_APPROVAL_DATE == null ? null : FormatterUtils.format_Date(row2.APPLICATION_APPROVAL_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[17]=row2.DRIVER_CONFIRMED_ZIPCARD_P == null ? null : row2.DRIVER_CONFIRMED_ZIPCARD_P;
                            rowtFileOutputDelimited_1[18]=row2.DRIVER_ZIPCARD == null ? null : row2.DRIVER_ZIPCARD;
                            rowtFileOutputDelimited_1[19]=row2.REJECTION_DATE == null ? null : FormatterUtils.format_Date(row2.REJECTION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[20]=row2.ZIPCARD_ACTIVATED_P == null ? null : row2.ZIPCARD_ACTIVATED_P;
                            rowtFileOutputDelimited_1[21]=row2.ZIPCARD_ADDRESS_ID == null ? null : String.valueOf(row2.ZIPCARD_ADDRESS_ID);
                            rowtFileOutputDelimited_1[22]=row2.ZIPCARD_ARRIVAL_DATE == null ? null : FormatterUtils.format_Date(row2.ZIPCARD_ARRIVAL_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[23]=row2.ZIPCARD_ARRIVAL_STATE == null ? null : row2.ZIPCARD_ARRIVAL_STATE;
                            rowtFileOutputDelimited_1[24]=row2.ZIPCARD_ARRIVAL_USER == null ? null : String.valueOf(row2.ZIPCARD_ARRIVAL_USER);
                            rowtFileOutputDelimited_1[25]=row2.ZIPCARD_RECEIVED_P == null ? null : row2.ZIPCARD_RECEIVED_P;
                            rowtFileOutputDelimited_1[26]=row2.ZIPCARD == null ? null : row2.ZIPCARD;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_ApplicationsFinal StageFeed_ApplicationsFinalClass = new StageFeed_ApplicationsFinal();

        int exitCode = StageFeed_ApplicationsFinalClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_ApplicationsFinal.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_applicationsfinal_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_ApplicationsFinal");
        }
...
/************************************************************************************************
 *     426508 characters generated by Talend Open Studio for Data Integration 
