...
package zipcar_marketingdw.subjobs_weekly_0_1;
...
/**
 * Job: Subjobs_Weekly Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Subjobs_Weekly implements TalendJob {
	...
	private final String jobName = "Subjobs_Weekly";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Subjobs_Weekly.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Subjobs_Weekly.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		zipcar_marketingdw.process_update_member_activity_0_1.Process_Update_Member_Activity childJob_tRunJob_4 = new zipcar_marketingdw.process_update_member_activity_0_1.Process_Update_Member_Activity();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.process_rfm_member_data_0_1.Process_RFM_Member_Data childJob_tRunJob_3 = new zipcar_marketingdw.process_rfm_member_data_0_1.Process_RFM_Member_Data();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.process_member_performance_0_1.Process_Member_Performance childJob_tRunJob_2 = new zipcar_marketingdw.process_member_performance_0_1.Process_Member_Performance();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.process_location_segments_0_1.Process_Location_Segments childJob_tRunJob_1 = new zipcar_marketingdw.process_location_segments_0_1.Process_Location_Segments();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		zipcar_marketingdw.process_engagement_report_0_1.Process_Engagement_Report childJob_tRunJob_5 = new zipcar_marketingdw.process_engagement_report_0_1.Process_Engagement_Report();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param isSubJob=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param isSubJob=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("isSubJob", obj_tRunJob_6);
	
	
		zipcar_marketingdw.process_member_segment_report_0_1.Process_Member_Segment_Report childJob_tRunJob_6 = new zipcar_marketingdw.process_member_segment_report_0_1.Process_Member_Segment_Report();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		zipcar_marketingdw.data_consistency_monitor_0_1.Data_Consistency_Monitor childJob_tRunJob_7 = new zipcar_marketingdw.data_consistency_monitor_0_1.Data_Consistency_Monitor();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Subjobs_Weekly Subjobs_WeeklyClass = new Subjobs_Weekly();

        int exitCode = Subjobs_WeeklyClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Subjobs_Weekly.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/subjobs_weekly_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Subjobs_Weekly");
        }
...
/************************************************************************************************
 *     68169 characters generated by Talend Open Studio for Data Integration 
