...
package zipcar_marketingdw.stagefeed_memberlastregistrationsess_0_1;
...
/**
 * Job: StageFeed_MemberLastRegistrationSess Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_MemberLastRegistrationSess implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_MemberLastRegistrationSess";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_hbtHMMp_EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_MemberLastRegistrationSess.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_MemberLastRegistrationSess.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.MEMBER_LAST_REGISTRATION_SESS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.MEMBER_LAST_REGISTRATION_SESS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.MEMBER_LAST_REGISTRATION_SESS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastRegistrationSess = new byte[0];
			    ...
			    public Long SESS_ACCOUNT_ID;

				public Long getSESS_ACCOUNT_ID () {
					return this.SESS_ACCOUNT_ID;
				}
				
			    public Long SESS_APPLICATION_ID;

				public Long getSESS_APPLICATION_ID () {
					return this.SESS_APPLICATION_ID;
				}
				
			    public String SESS_SOURCE_CD;

				public String getSESS_SOURCE_CD () {
					return this.SESS_SOURCE_CD;
				}
				
			    public String SESS_RATE_PLAN_CLASS;

				public String getSESS_RATE_PLAN_CLASS () {
					return this.SESS_RATE_PLAN_CLASS;
				}
				
			    public String SESS_AFFILIATE;

				public String getSESS_AFFILIATE () {
					return this.SESS_AFFILIATE;
				}
				
			    public Double SESS_ANNUAL_FEE;

				public Double getSESS_ANNUAL_FEE () {
					return this.SESS_ANNUAL_FEE;
				}
				
			    public Double SESS_APP_FEE;

				public Double getSESS_APP_FEE () {
					return this.SESS_APP_FEE;
				}
				
			    public Long SESS_COUPON_CD;

				public Long getSESS_COUPON_CD () {
					return this.SESS_COUPON_CD;
				}
				
			    public String SESS_COUPON_DESC;

				public String getSESS_COUPON_DESC () {
					return this.SESS_COUPON_DESC;
				}
				
			    public Double SESS_DRIVING_CREDIT_USD;

				public Double getSESS_DRIVING_CREDIT_USD () {
					return this.SESS_DRIVING_CREDIT_USD;
				}
				
			    public java.util.Date SESS_APP_START_DATE;

				public java.util.Date getSESS_APP_START_DATE () {
					return this.SESS_APP_START_DATE;
				}
				
			    public java.util.Date SESS_APP_BEGIN_DATE;

				public java.util.Date getSESS_APP_BEGIN_DATE () {
					return this.SESS_APP_BEGIN_DATE;
				}
				
			    public java.util.Date SESS_APP_SUBMITTED_DATE;

				public java.util.Date getSESS_APP_SUBMITTED_DATE () {
					return this.SESS_APP_SUBMITTED_DATE;
				}
				
			    public java.util.Date SESS_APP_PROCESS_FINISHED_DATE;

				public java.util.Date getSESS_APP_PROCESS_FINISHED_DATE () {
					return this.SESS_APP_PROCESS_FINISHED_DATE;
				}
				
			    public String SESS_APP_LAST_STEP;

				public String getSESS_APP_LAST_STEP () {
					return this.SESS_APP_LAST_STEP;
				}
				
			    public String SESS_INCOMPLETE_APP_P;

				public String getSESS_INCOMPLETE_APP_P () {
					return this.SESS_INCOMPLETE_APP_P;
				}
				
			    public String SESS_SUBMITTED_APP_P;

				public String getSESS_SUBMITTED_APP_P () {
					return this.SESS_SUBMITTED_APP_P;
				}
				
			    public java.util.Date SESS_APP_ACCOUNT_APPROVAL_DATE;

				public java.util.Date getSESS_APP_ACCOUNT_APPROVAL_DATE () {
					return this.SESS_APP_ACCOUNT_APPROVAL_DATE;
				}
				
			    public java.util.Date SESS_APP_REJECTION_DATE;

				public java.util.Date getSESS_APP_REJECTION_DATE () {
					return this.SESS_APP_REJECTION_DATE;
				}
				
			    public String SESS_APP_STATUS;

				public String getSESS_APP_STATUS () {
					return this.SESS_APP_STATUS;
				}
				
			    public String SESS_REFERRAL_P;

				public String getSESS_REFERRAL_P () {
					return this.SESS_REFERRAL_P;
				}
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.MEMBER_ID = dis.readLong();
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SESS_ACCOUNT_ID = null;
           				} else {
           			    	this.SESS_ACCOUNT_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SESS_APPLICATION_ID = null;
           				} else {
           			    	this.SESS_APPLICATION_ID = dis.readLong();
           				}
					
					this.SESS_SOURCE_CD = readString(dis);
					
					this.SESS_RATE_PLAN_CLASS = readString(dis);
					
					this.SESS_AFFILIATE = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SESS_ANNUAL_FEE = null;
           				} else {
           			    	this.SESS_ANNUAL_FEE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SESS_APP_FEE = null;
           				} else {
           			    	this.SESS_APP_FEE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SESS_COUPON_CD = null;
           				} else {
           			    	this.SESS_COUPON_CD = dis.readLong();
           				}
					
					this.SESS_COUPON_DESC = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SESS_DRIVING_CREDIT_USD = null;
           				} else {
           			    	this.SESS_DRIVING_CREDIT_USD = dis.readDouble();
           				}
					
					this.SESS_APP_START_DATE = readDate(dis);
					
					this.SESS_APP_BEGIN_DATE = readDate(dis);
					
					this.SESS_APP_SUBMITTED_DATE = readDate(dis);
					
					this.SESS_APP_PROCESS_FINISHED_DATE = readDate(dis);
					
					this.SESS_APP_LAST_STEP = readString(dis);
					
					this.SESS_INCOMPLETE_APP_P = readString(dis);
					
					this.SESS_SUBMITTED_APP_P = readString(dis);
					
					this.SESS_APP_ACCOUNT_APPROVAL_DATE = readDate(dis);
					
					this.SESS_APP_REJECTION_DATE = readDate(dis);
					
					this.SESS_APP_STATUS = readString(dis);
					
					this.SESS_REFERRAL_P = readString(dis);
					
					this.CREATION_DATE = readDate(dis);
					
					this.DELETED_DATE = readDate(dis);
					
					this.APP_STATUS = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.SESS_ACCOUNT_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.SESS_ACCOUNT_ID);
		            	}
					
					// Long
				
						if(this.SESS_APPLICATION_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.SESS_APPLICATION_ID);
		            	}
					
					// String
				
						writeString(this.SESS_SOURCE_CD,dos);
					
					// String
				
						writeString(this.SESS_RATE_PLAN_CLASS,dos);
					
					// String
				
						writeString(this.SESS_AFFILIATE,dos);
					
					// Double
				
						if(this.SESS_ANNUAL_FEE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.SESS_ANNUAL_FEE);
		            	}
					
					// Double
				
						if(this.SESS_APP_FEE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.SESS_APP_FEE);
		            	}
					
					// Long
				
						if(this.SESS_COUPON_CD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.SESS_COUPON_CD);
		            	}
					
					// String
				
						writeString(this.SESS_COUPON_DESC,dos);
					
					// Double
				
						if(this.SESS_DRIVING_CREDIT_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.SESS_DRIVING_CREDIT_USD);
		            	}
					
					// java.util.Date
				
						writeDate(this.SESS_APP_START_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.SESS_APP_BEGIN_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.SESS_APP_SUBMITTED_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.SESS_APP_PROCESS_FINISHED_DATE,dos);
					
					// String
				
						writeString(this.SESS_APP_LAST_STEP,dos);
					
					// String
				
						writeString(this.SESS_INCOMPLETE_APP_P,dos);
					
					// String
				
						writeString(this.SESS_SUBMITTED_APP_P,dos);
					
					// java.util.Date
				
						writeDate(this.SESS_APP_ACCOUNT_APPROVAL_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.SESS_APP_REJECTION_DATE,dos);
					
					// String
				
						writeString(this.SESS_APP_STATUS,dos);
					
					// String
				
						writeString(this.SESS_REFERRAL_P,dos);
					...
					// String
						...
						writeString(this.APP_STATUS,dos);
    ...
    public String toString() {
		...
		sb.append(",SESS_ACCOUNT_ID="+String.valueOf(SESS_ACCOUNT_ID));
		sb.append(",SESS_APPLICATION_ID="+String.valueOf(SESS_APPLICATION_ID));
		sb.append(",SESS_SOURCE_CD="+SESS_SOURCE_CD);
		sb.append(",SESS_RATE_PLAN_CLASS="+SESS_RATE_PLAN_CLASS);
		sb.append(",SESS_AFFILIATE="+SESS_AFFILIATE);
		sb.append(",SESS_ANNUAL_FEE="+String.valueOf(SESS_ANNUAL_FEE));
		sb.append(",SESS_APP_FEE="+String.valueOf(SESS_APP_FEE));
		sb.append(",SESS_COUPON_CD="+String.valueOf(SESS_COUPON_CD));
		sb.append(",SESS_COUPON_DESC="+SESS_COUPON_DESC);
		sb.append(",SESS_DRIVING_CREDIT_USD="+String.valueOf(SESS_DRIVING_CREDIT_USD));
		sb.append(",SESS_APP_START_DATE="+String.valueOf(SESS_APP_START_DATE));
		sb.append(",SESS_APP_BEGIN_DATE="+String.valueOf(SESS_APP_BEGIN_DATE));
		sb.append(",SESS_APP_SUBMITTED_DATE="+String.valueOf(SESS_APP_SUBMITTED_DATE));
		sb.append(",SESS_APP_PROCESS_FINISHED_DATE="+String.valueOf(SESS_APP_PROCESS_FINISHED_DATE));
		sb.append(",SESS_APP_LAST_STEP="+SESS_APP_LAST_STEP);
		sb.append(",SESS_INCOMPLETE_APP_P="+SESS_INCOMPLETE_APP_P);
		sb.append(",SESS_SUBMITTED_APP_P="+SESS_SUBMITTED_APP_P);
		sb.append(",SESS_APP_ACCOUNT_APPROVAL_DATE="+String.valueOf(SESS_APP_ACCOUNT_APPROVAL_DATE));
		sb.append(",SESS_APP_REJECTION_DATE="+String.valueOf(SESS_APP_REJECTION_DATE));
		sb.append(",SESS_APP_STATUS="+SESS_APP_STATUS);
		sb.append(",SESS_REFERRAL_P="+SESS_REFERRAL_P);
		sb.append(",CREATION_DATE="+String.valueOf(CREATION_DATE));
		sb.append(",DELETED_DATE="+String.valueOf(DELETED_DATE));
		sb.append(",APP_STATUS="+APP_STATUS);
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						...
						Long SESS_ACCOUNT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c1(Long SESS_ACCOUNT_ID){
							this.SESS_ACCOUNT_ID = SESS_ACCOUNT_ID;
							return this;
						}				
						Long SESS_APPLICATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Long SESS_APPLICATION_ID){
							this.SESS_APPLICATION_ID = SESS_APPLICATION_ID;
							return this;
						}				
						String SESS_SOURCE_CD;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String SESS_SOURCE_CD){
							this.SESS_SOURCE_CD = SESS_SOURCE_CD;
							return this;
						}				
						String SESS_RATE_PLAN_CLASS;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String SESS_RATE_PLAN_CLASS){
							this.SESS_RATE_PLAN_CLASS = SESS_RATE_PLAN_CLASS;
							return this;
						}				
						String SESS_AFFILIATE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String SESS_AFFILIATE){
							this.SESS_AFFILIATE = SESS_AFFILIATE;
							return this;
						}				
						Double SESS_ANNUAL_FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Double SESS_ANNUAL_FEE){
							this.SESS_ANNUAL_FEE = SESS_ANNUAL_FEE;
							return this;
						}				
						Double SESS_APP_FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Double SESS_APP_FEE){
							this.SESS_APP_FEE = SESS_APP_FEE;
							return this;
						}				
						Long SESS_COUPON_CD;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Long SESS_COUPON_CD){
							this.SESS_COUPON_CD = SESS_COUPON_CD;
							return this;
						}				
						String SESS_COUPON_DESC;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String SESS_COUPON_DESC){
							this.SESS_COUPON_DESC = SESS_COUPON_DESC;
							return this;
						}				
						Double SESS_DRIVING_CREDIT_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Double SESS_DRIVING_CREDIT_USD){
							this.SESS_DRIVING_CREDIT_USD = SESS_DRIVING_CREDIT_USD;
							return this;
						}				
						java.util.Date SESS_APP_START_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c11(java.util.Date SESS_APP_START_DATE){
							this.SESS_APP_START_DATE = SESS_APP_START_DATE;
							return this;
						}				
						java.util.Date SESS_APP_BEGIN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c12(java.util.Date SESS_APP_BEGIN_DATE){
							this.SESS_APP_BEGIN_DATE = SESS_APP_BEGIN_DATE;
							return this;
						}				
						java.util.Date SESS_APP_SUBMITTED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(java.util.Date SESS_APP_SUBMITTED_DATE){
							this.SESS_APP_SUBMITTED_DATE = SESS_APP_SUBMITTED_DATE;
							return this;
						}				
						java.util.Date SESS_APP_PROCESS_FINISHED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c14(java.util.Date SESS_APP_PROCESS_FINISHED_DATE){
							this.SESS_APP_PROCESS_FINISHED_DATE = SESS_APP_PROCESS_FINISHED_DATE;
							return this;
						}				
						String SESS_APP_LAST_STEP;
						
	            		public BufferLine_tRedshiftOutput_1 c15(String SESS_APP_LAST_STEP){
							this.SESS_APP_LAST_STEP = SESS_APP_LAST_STEP;
							return this;
						}				
						String SESS_INCOMPLETE_APP_P;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String SESS_INCOMPLETE_APP_P){
							this.SESS_INCOMPLETE_APP_P = SESS_INCOMPLETE_APP_P;
							return this;
						}				
						String SESS_SUBMITTED_APP_P;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String SESS_SUBMITTED_APP_P){
							this.SESS_SUBMITTED_APP_P = SESS_SUBMITTED_APP_P;
							return this;
						}				
						java.util.Date SESS_APP_ACCOUNT_APPROVAL_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c18(java.util.Date SESS_APP_ACCOUNT_APPROVAL_DATE){
							this.SESS_APP_ACCOUNT_APPROVAL_DATE = SESS_APP_ACCOUNT_APPROVAL_DATE;
							return this;
						}				
						java.util.Date SESS_APP_REJECTION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c19(java.util.Date SESS_APP_REJECTION_DATE){
							this.SESS_APP_REJECTION_DATE = SESS_APP_REJECTION_DATE;
							return this;
						}				
						String SESS_APP_STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c20(String SESS_APP_STATUS){
							this.SESS_APP_STATUS = SESS_APP_STATUS;
							return this;
						}				
						String SESS_REFERRAL_P;
						
	            		public BufferLine_tRedshiftOutput_1 c21(String SESS_REFERRAL_P){
							this.SESS_REFERRAL_P = SESS_REFERRAL_P;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c22(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c23(java.util.Date DELETED_DATE){
							this.DELETED_DATE = DELETED_DATE;
							return this;
						}				
						String APP_STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c24(String APP_STATUS){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"SESS_ACCOUNT_ID\",\"SESS_APPLICATION_ID\",\"SESS_SOURCE_CD\",\"SESS_RATE_PLAN_CLASS\",\"SESS_AFFILIATE\",\"SESS_ANNUAL_FEE\",\"SESS_APP_FEE\",\"SESS_COUPON_CD\",\"SESS_COUPON_DESC\",\"SESS_DRIVING_CREDIT_USD\",\"SESS_APP_START_DATE\",\"SESS_APP_BEGIN_DATE\",\"SESS_APP_SUBMITTED_DATE\",\"SESS_APP_PROCESS_FINISHED_DATE\",\"SESS_APP_LAST_STEP\",\"SESS_INCOMPLETE_APP_P\",\"SESS_SUBMITTED_APP_P\",\"SESS_APP_ACCOUNT_APPROVAL_DATE\",\"SESS_APP_REJECTION_DATE\",\"SESS_APP_STATUS\",\"SESS_REFERRAL_P\",\"CREATION_DATE\",\"DELETED_DATE\",\"APP_STATUS\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.SESS_ACCOUNT_ID = null;
					
							Row_FeedRecord.SESS_APPLICATION_ID = null;
					
							Row_FeedRecord.SESS_SOURCE_CD = null;
					
							Row_FeedRecord.SESS_RATE_PLAN_CLASS = null;
					
							Row_FeedRecord.SESS_AFFILIATE = null;
					
							Row_FeedRecord.SESS_ANNUAL_FEE = null;
					
							Row_FeedRecord.SESS_APP_FEE = null;
					
							Row_FeedRecord.SESS_COUPON_CD = null;
					
							Row_FeedRecord.SESS_COUPON_DESC = null;
					
							Row_FeedRecord.SESS_DRIVING_CREDIT_USD = null;
					
							Row_FeedRecord.SESS_APP_START_DATE = null;
					
							Row_FeedRecord.SESS_APP_BEGIN_DATE = null;
					
							Row_FeedRecord.SESS_APP_SUBMITTED_DATE = null;
					
							Row_FeedRecord.SESS_APP_PROCESS_FINISHED_DATE = null;
					
							Row_FeedRecord.SESS_APP_LAST_STEP = null;
					
							Row_FeedRecord.SESS_INCOMPLETE_APP_P = null;
					
							Row_FeedRecord.SESS_SUBMITTED_APP_P = null;
					
							Row_FeedRecord.SESS_APP_ACCOUNT_APPROVAL_DATE = null;
					
							Row_FeedRecord.SESS_APP_REJECTION_DATE = null;
					
							Row_FeedRecord.SESS_APP_STATUS = null;
					
							Row_FeedRecord.SESS_REFERRAL_P = null;
					
							Row_FeedRecord.CREATION_DATE = null;
					
							Row_FeedRecord.DELETED_DATE = null;
					
							Row_FeedRecord.APP_STATUS = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SESS_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SESS_APPLICATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_SOURCE_CD = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_RATE_PLAN_CLASS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_AFFILIATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SESS_ANNUAL_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SESS_APP_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SESS_COUPON_CD = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_COUPON_DESC = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SESS_DRIVING_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SESS_APP_START_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SESS_APP_BEGIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SESS_APP_SUBMITTED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SESS_APP_PROCESS_FINISHED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_APP_LAST_STEP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_INCOMPLETE_APP_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_SUBMITTED_APP_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SESS_APP_ACCOUNT_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SESS_APP_REJECTION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_APP_STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SESS_REFERRAL_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.APP_STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.SESS_ACCOUNT_ID = Row_FeedRecord.SESS_ACCOUNT_ID;
Record_OutputToDB.SESS_APPLICATION_ID = Row_FeedRecord.SESS_APPLICATION_ID;
Record_OutputToDB.SESS_SOURCE_CD = StringUtils.trimToNull(Row_FeedRecord.SESS_SOURCE_CD);
Record_OutputToDB.SESS_RATE_PLAN_CLASS = StringUtils.trimToNull(Row_FeedRecord.SESS_RATE_PLAN_CLASS);
Record_OutputToDB.SESS_AFFILIATE = StringUtils.trimToNull(Row_FeedRecord.SESS_AFFILIATE);
Record_OutputToDB.SESS_ANNUAL_FEE = Row_FeedRecord.SESS_ANNUAL_FEE;
Record_OutputToDB.SESS_APP_FEE = Row_FeedRecord.SESS_APP_FEE;
Record_OutputToDB.SESS_COUPON_CD = Row_FeedRecord.SESS_COUPON_CD;
Record_OutputToDB.SESS_COUPON_DESC = StringUtils.trimToNull(Row_FeedRecord.SESS_COUPON_DESC);
Record_OutputToDB.SESS_DRIVING_CREDIT_USD = Row_FeedRecord.SESS_DRIVING_CREDIT_USD;
Record_OutputToDB.SESS_APP_START_DATE = Row_FeedRecord.SESS_APP_START_DATE;
Record_OutputToDB.SESS_APP_BEGIN_DATE = Row_FeedRecord.SESS_APP_BEGIN_DATE;
Record_OutputToDB.SESS_APP_SUBMITTED_DATE = Row_FeedRecord.SESS_APP_SUBMITTED_DATE;
Record_OutputToDB.SESS_APP_PROCESS_FINISHED_DATE = Row_FeedRecord.SESS_APP_PROCESS_FINISHED_DATE;
Record_OutputToDB.SESS_APP_LAST_STEP = StringUtils.trimToNull(Row_FeedRecord.SESS_APP_LAST_STEP);
Record_OutputToDB.SESS_INCOMPLETE_APP_P = BooleanUtils.boolChar(Row_FeedRecord.SESS_INCOMPLETE_APP_P);
Record_OutputToDB.SESS_SUBMITTED_APP_P = BooleanUtils.boolChar(Row_FeedRecord.SESS_SUBMITTED_APP_P);
Record_OutputToDB.SESS_APP_ACCOUNT_APPROVAL_DATE = Row_FeedRecord.SESS_APP_ACCOUNT_APPROVAL_DATE;
Record_OutputToDB.SESS_APP_REJECTION_DATE = Row_FeedRecord.SESS_APP_REJECTION_DATE;
Record_OutputToDB.SESS_APP_STATUS = StringUtils.trimToNull(Row_FeedRecord.SESS_APP_STATUS);
Record_OutputToDB.SESS_REFERRAL_P = BooleanUtils.boolChar(Row_FeedRecord.SESS_REFERRAL_P);
Record_OutputToDB.CREATION_DATE = Row_FeedRecord.CREATION_DATE;
Record_OutputToDB.DELETED_DATE = Row_FeedRecord.DELETED_DATE;
Record_OutputToDB.APP_STATUS = StringUtils.trimToNull(Row_FeedRecord.APP_STATUS);
    nb_line_tJavaRow_3++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_ACCOUNT_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.SESS_ACCOUNT_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APPLICATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.SESS_APPLICATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_SOURCE_CD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_SOURCE_CD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_RATE_PLAN_CLASS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_RATE_PLAN_CLASS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_AFFILIATE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_AFFILIATE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_ANNUAL_FEE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.SESS_ANNUAL_FEE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_FEE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.SESS_APP_FEE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_COUPON_CD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.SESS_COUPON_CD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_COUPON_DESC==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_COUPON_DESC);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_DRIVING_CREDIT_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.SESS_DRIVING_CREDIT_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_START_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SESS_APP_START_DATE.getTime();
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_BEGIN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SESS_APP_BEGIN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_SUBMITTED_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SESS_APP_SUBMITTED_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_PROCESS_FINISHED_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SESS_APP_PROCESS_FINISHED_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_LAST_STEP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_APP_LAST_STEP);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_INCOMPLETE_APP_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_INCOMPLETE_APP_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_SUBMITTED_APP_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_SUBMITTED_APP_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_ACCOUNT_APPROVAL_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SESS_APP_ACCOUNT_APPROVAL_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_REJECTION_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SESS_APP_REJECTION_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_APP_STATUS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_APP_STATUS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SESS_REFERRAL_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SESS_REFERRAL_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.APP_STATUS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.APP_STATUS);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.SESS_ACCOUNT_ID)
                        .c2(Record_OutputToDB.SESS_APPLICATION_ID)
                        .c3(Record_OutputToDB.SESS_SOURCE_CD)
                        .c4(Record_OutputToDB.SESS_RATE_PLAN_CLASS)
                        .c5(Record_OutputToDB.SESS_AFFILIATE)
                        .c6(Record_OutputToDB.SESS_ANNUAL_FEE)
                        .c7(Record_OutputToDB.SESS_APP_FEE)
                        .c8(Record_OutputToDB.SESS_COUPON_CD)
                        .c9(Record_OutputToDB.SESS_COUPON_DESC)
                        .c10(Record_OutputToDB.SESS_DRIVING_CREDIT_USD)
                        .c11(Record_OutputToDB.SESS_APP_START_DATE)
                        .c12(Record_OutputToDB.SESS_APP_BEGIN_DATE)
                        .c13(Record_OutputToDB.SESS_APP_SUBMITTED_DATE)
                        .c14(Record_OutputToDB.SESS_APP_PROCESS_FINISHED_DATE)
                        .c15(Record_OutputToDB.SESS_APP_LAST_STEP)
                        .c16(Record_OutputToDB.SESS_INCOMPLETE_APP_P)
                        .c17(Record_OutputToDB.SESS_SUBMITTED_APP_P)
                        .c18(Record_OutputToDB.SESS_APP_ACCOUNT_APPROVAL_DATE)
                        .c19(Record_OutputToDB.SESS_APP_REJECTION_DATE)
                        .c20(Record_OutputToDB.SESS_APP_STATUS)
                        .c21(Record_OutputToDB.SESS_REFERRAL_P)
                        .c22(Record_OutputToDB.CREATION_DATE)
                        .c23(Record_OutputToDB.DELETED_DATE)
                        .c24(Record_OutputToDB.APP_STATUS)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.SESS_ACCOUNT_ID = Record_OutputToDB.SESS_ACCOUNT_ID;
                                After_Insert.SESS_APPLICATION_ID = Record_OutputToDB.SESS_APPLICATION_ID;
                                After_Insert.SESS_SOURCE_CD = Record_OutputToDB.SESS_SOURCE_CD;
                                After_Insert.SESS_RATE_PLAN_CLASS = Record_OutputToDB.SESS_RATE_PLAN_CLASS;
                                After_Insert.SESS_AFFILIATE = Record_OutputToDB.SESS_AFFILIATE;
                                After_Insert.SESS_ANNUAL_FEE = Record_OutputToDB.SESS_ANNUAL_FEE;
                                After_Insert.SESS_APP_FEE = Record_OutputToDB.SESS_APP_FEE;
                                After_Insert.SESS_COUPON_CD = Record_OutputToDB.SESS_COUPON_CD;
                                After_Insert.SESS_COUPON_DESC = Record_OutputToDB.SESS_COUPON_DESC;
                                After_Insert.SESS_DRIVING_CREDIT_USD = Record_OutputToDB.SESS_DRIVING_CREDIT_USD;
                                After_Insert.SESS_APP_START_DATE = Record_OutputToDB.SESS_APP_START_DATE;
                                After_Insert.SESS_APP_BEGIN_DATE = Record_OutputToDB.SESS_APP_BEGIN_DATE;
                                After_Insert.SESS_APP_SUBMITTED_DATE = Record_OutputToDB.SESS_APP_SUBMITTED_DATE;
                                After_Insert.SESS_APP_PROCESS_FINISHED_DATE = Record_OutputToDB.SESS_APP_PROCESS_FINISHED_DATE;
                                After_Insert.SESS_APP_LAST_STEP = Record_OutputToDB.SESS_APP_LAST_STEP;
                                After_Insert.SESS_INCOMPLETE_APP_P = Record_OutputToDB.SESS_INCOMPLETE_APP_P;
                                After_Insert.SESS_SUBMITTED_APP_P = Record_OutputToDB.SESS_SUBMITTED_APP_P;
                                After_Insert.SESS_APP_ACCOUNT_APPROVAL_DATE = Record_OutputToDB.SESS_APP_ACCOUNT_APPROVAL_DATE;
                                After_Insert.SESS_APP_REJECTION_DATE = Record_OutputToDB.SESS_APP_REJECTION_DATE;
                                After_Insert.SESS_APP_STATUS = Record_OutputToDB.SESS_APP_STATUS;
                                After_Insert.SESS_REFERRAL_P = Record_OutputToDB.SESS_REFERRAL_P;
                                After_Insert.CREATION_DATE = Record_OutputToDB.CREATION_DATE;
                                After_Insert.DELETED_DATE = Record_OutputToDB.DELETED_DATE;
                                After_Insert.APP_STATUS = Record_OutputToDB.APP_STATUS;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.SESS_ACCOUNT_ID = After_Insert.SESS_ACCOUNT_ID;
               Log_Rows.SESS_APPLICATION_ID = After_Insert.SESS_APPLICATION_ID;
               Log_Rows.SESS_SOURCE_CD = After_Insert.SESS_SOURCE_CD;
               Log_Rows.SESS_RATE_PLAN_CLASS = After_Insert.SESS_RATE_PLAN_CLASS;
               Log_Rows.SESS_AFFILIATE = After_Insert.SESS_AFFILIATE;
               Log_Rows.SESS_ANNUAL_FEE = After_Insert.SESS_ANNUAL_FEE;
               Log_Rows.SESS_APP_FEE = After_Insert.SESS_APP_FEE;
               Log_Rows.SESS_COUPON_CD = After_Insert.SESS_COUPON_CD;
               Log_Rows.SESS_COUPON_DESC = After_Insert.SESS_COUPON_DESC;
               Log_Rows.SESS_DRIVING_CREDIT_USD = After_Insert.SESS_DRIVING_CREDIT_USD;
               Log_Rows.SESS_APP_START_DATE = After_Insert.SESS_APP_START_DATE;
               Log_Rows.SESS_APP_BEGIN_DATE = After_Insert.SESS_APP_BEGIN_DATE;
               Log_Rows.SESS_APP_SUBMITTED_DATE = After_Insert.SESS_APP_SUBMITTED_DATE;
               Log_Rows.SESS_APP_PROCESS_FINISHED_DATE = After_Insert.SESS_APP_PROCESS_FINISHED_DATE;
               Log_Rows.SESS_APP_LAST_STEP = After_Insert.SESS_APP_LAST_STEP;
               Log_Rows.SESS_INCOMPLETE_APP_P = After_Insert.SESS_INCOMPLETE_APP_P;
               Log_Rows.SESS_SUBMITTED_APP_P = After_Insert.SESS_SUBMITTED_APP_P;
               Log_Rows.SESS_APP_ACCOUNT_APPROVAL_DATE = After_Insert.SESS_APP_ACCOUNT_APPROVAL_DATE;
               Log_Rows.SESS_APP_REJECTION_DATE = After_Insert.SESS_APP_REJECTION_DATE;
               Log_Rows.SESS_APP_STATUS = After_Insert.SESS_APP_STATUS;
               Log_Rows.SESS_REFERRAL_P = After_Insert.SESS_REFERRAL_P;
               Log_Rows.CREATION_DATE = After_Insert.CREATION_DATE;
               Log_Rows.DELETED_DATE = After_Insert.DELETED_DATE;
               Log_Rows.APP_STATUS = After_Insert.APP_STATUS;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"SESS_ACCOUNT_ID\",\"SESS_APPLICATION_ID\",\"SESS_SOURCE_CD\",\"SESS_RATE_PLAN_CLASS\",\"SESS_AFFILIATE\",\"SESS_ANNUAL_FEE\",\"SESS_APP_FEE\",\"SESS_COUPON_CD\",\"SESS_COUPON_DESC\",\"SESS_DRIVING_CREDIT_USD\",\"SESS_APP_START_DATE\",\"SESS_APP_BEGIN_DATE\",\"SESS_APP_SUBMITTED_DATE\",\"SESS_APP_PROCESS_FINISHED_DATE\",\"SESS_APP_LAST_STEP\",\"SESS_INCOMPLETE_APP_P\",\"SESS_SUBMITTED_APP_P\",\"SESS_APP_ACCOUNT_APPROVAL_DATE\",\"SESS_APP_REJECTION_DATE\",\"SESS_APP_STATUS\",\"SESS_REFERRAL_P\",\"CREATION_DATE\",\"DELETED_DATE\",\"APP_STATUS\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.SESS_ACCOUNT_ID==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_ACCOUNT_ID);
					...
					if(bufferLtRedshiftOutput_1.SESS_APPLICATION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_APPLICATION_ID);
					...
					if(bufferLtRedshiftOutput_1.SESS_SOURCE_CD==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_SOURCE_CD);
					...
					if(bufferLtRedshiftOutput_1.SESS_RATE_PLAN_CLASS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_RATE_PLAN_CLASS);
					...
					if(bufferLtRedshiftOutput_1.SESS_AFFILIATE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_AFFILIATE);
					...
					if(bufferLtRedshiftOutput_1.SESS_ANNUAL_FEE==null){
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_ANNUAL_FEE);
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_FEE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_APP_FEE);
					...
					if(bufferLtRedshiftOutput_1.SESS_COUPON_CD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_COUPON_CD);
					...
					if(bufferLtRedshiftOutput_1.SESS_COUPON_DESC==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_COUPON_DESC);
					...
					if(bufferLtRedshiftOutput_1.SESS_DRIVING_CREDIT_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_DRIVING_CREDIT_USD);
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_START_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SESS_APP_START_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_BEGIN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SESS_APP_BEGIN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_SUBMITTED_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SESS_APP_SUBMITTED_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_PROCESS_FINISHED_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SESS_APP_PROCESS_FINISHED_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_LAST_STEP==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_APP_LAST_STEP);
					...
					if(bufferLtRedshiftOutput_1.SESS_INCOMPLETE_APP_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_INCOMPLETE_APP_P);
					...
					if(bufferLtRedshiftOutput_1.SESS_SUBMITTED_APP_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_SUBMITTED_APP_P);
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_ACCOUNT_APPROVAL_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SESS_APP_ACCOUNT_APPROVAL_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_REJECTION_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SESS_APP_REJECTION_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.SESS_APP_STATUS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_APP_STATUS);
					...
					if(bufferLtRedshiftOutput_1.SESS_REFERRAL_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESS_REFERRAL_P);
					...
					if(bufferLtRedshiftOutput_1.APP_STATUS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.APP_STATUS);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.SESS_ACCOUNT_ID = null;
					
							row1.SESS_APPLICATION_ID = null;
					
							row1.SESS_SOURCE_CD = null;
					
							row1.SESS_RATE_PLAN_CLASS = null;
					
							row1.SESS_AFFILIATE = null;
					
							row1.SESS_ANNUAL_FEE = null;
					
							row1.SESS_APP_FEE = null;
					
							row1.SESS_COUPON_CD = null;
					
							row1.SESS_COUPON_DESC = null;
					
							row1.SESS_DRIVING_CREDIT_USD = null;
					
							row1.SESS_APP_START_DATE = null;
					
							row1.SESS_APP_BEGIN_DATE = null;
					
							row1.SESS_APP_SUBMITTED_DATE = null;
					
							row1.SESS_APP_PROCESS_FINISHED_DATE = null;
					
							row1.SESS_APP_LAST_STEP = null;
					
							row1.SESS_INCOMPLETE_APP_P = null;
					
							row1.SESS_SUBMITTED_APP_P = null;
					
							row1.SESS_APP_ACCOUNT_APPROVAL_DATE = null;
					
							row1.SESS_APP_REJECTION_DATE = null;
					
							row1.SESS_APP_STATUS = null;
					
							row1.SESS_REFERRAL_P = null;
					
							row1.CREATION_DATE = null;
					
							row1.DELETED_DATE = null;
					
							row1.APP_STATUS = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SESS_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SESS_APPLICATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_SOURCE_CD = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_RATE_PLAN_CLASS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_AFFILIATE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SESS_ANNUAL_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SESS_APP_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SESS_COUPON_CD = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_COUPON_DESC = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SESS_DRIVING_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SESS_APP_START_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SESS_APP_BEGIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SESS_APP_SUBMITTED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SESS_APP_PROCESS_FINISHED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_APP_LAST_STEP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_INCOMPLETE_APP_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_SUBMITTED_APP_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SESS_APP_ACCOUNT_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SESS_APP_REJECTION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_APP_STATUS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SESS_REFERRAL_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.APP_STATUS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.SESS_ACCOUNT_ID = row1.SESS_ACCOUNT_ID;
row2.SESS_APPLICATION_ID = row1.SESS_APPLICATION_ID;
row2.SESS_SOURCE_CD = StringUtils.trimToNull(row1.SESS_SOURCE_CD);
row2.SESS_RATE_PLAN_CLASS = StringUtils.trimToNull(row1.SESS_RATE_PLAN_CLASS);
row2.SESS_AFFILIATE = StringUtils.trimToNull(row1.SESS_AFFILIATE);
row2.SESS_ANNUAL_FEE = row1.SESS_ANNUAL_FEE;
row2.SESS_APP_FEE = row1.SESS_APP_FEE;
row2.SESS_COUPON_CD = row1.SESS_COUPON_CD;
row2.SESS_COUPON_DESC = StringUtils.trimToNull(row1.SESS_COUPON_DESC);
row2.SESS_DRIVING_CREDIT_USD = row1.SESS_DRIVING_CREDIT_USD;
row2.SESS_APP_START_DATE = row1.SESS_APP_START_DATE;
row2.SESS_APP_BEGIN_DATE = row1.SESS_APP_BEGIN_DATE;
row2.SESS_APP_SUBMITTED_DATE = row1.SESS_APP_SUBMITTED_DATE;
row2.SESS_APP_PROCESS_FINISHED_DATE = row1.SESS_APP_PROCESS_FINISHED_DATE;
row2.SESS_APP_LAST_STEP = StringUtils.trimToNull(row1.SESS_APP_LAST_STEP);
row2.SESS_INCOMPLETE_APP_P = BooleanUtils.boolChar(row1.SESS_INCOMPLETE_APP_P);
row2.SESS_SUBMITTED_APP_P = BooleanUtils.boolChar(row1.SESS_SUBMITTED_APP_P);
row2.SESS_APP_ACCOUNT_APPROVAL_DATE = row1.SESS_APP_ACCOUNT_APPROVAL_DATE;
row2.SESS_APP_REJECTION_DATE = row1.SESS_APP_REJECTION_DATE;
row2.SESS_APP_STATUS = StringUtils.trimToNull(row1.SESS_APP_STATUS);
row2.SESS_REFERRAL_P = BooleanUtils.boolChar(row1.SESS_REFERRAL_P);
row2.CREATION_DATE = row1.CREATION_DATE;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.APP_STATUS = StringUtils.trimToNull(row1.APP_STATUS);
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[25];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.SESS_ACCOUNT_ID == null ? null : String.valueOf(row2.SESS_ACCOUNT_ID);
                            rowtFileOutputDelimited_1[2]=row2.SESS_APPLICATION_ID == null ? null : String.valueOf(row2.SESS_APPLICATION_ID);
                            rowtFileOutputDelimited_1[3]=row2.SESS_SOURCE_CD == null ? null : row2.SESS_SOURCE_CD;
                            rowtFileOutputDelimited_1[4]=row2.SESS_RATE_PLAN_CLASS == null ? null : row2.SESS_RATE_PLAN_CLASS;
                            rowtFileOutputDelimited_1[5]=row2.SESS_AFFILIATE == null ? null : row2.SESS_AFFILIATE;
                            rowtFileOutputDelimited_1[6]=row2.SESS_ANNUAL_FEE == null ? null : String.valueOf(row2.SESS_ANNUAL_FEE);
                            rowtFileOutputDelimited_1[7]=row2.SESS_APP_FEE == null ? null : String.valueOf(row2.SESS_APP_FEE);
                            rowtFileOutputDelimited_1[8]=row2.SESS_COUPON_CD == null ? null : String.valueOf(row2.SESS_COUPON_CD);
                            rowtFileOutputDelimited_1[9]=row2.SESS_COUPON_DESC == null ? null : row2.SESS_COUPON_DESC;
                            rowtFileOutputDelimited_1[10]=row2.SESS_DRIVING_CREDIT_USD == null ? null : String.valueOf(row2.SESS_DRIVING_CREDIT_USD);
                            rowtFileOutputDelimited_1[11]=row2.SESS_APP_START_DATE == null ? null : FormatterUtils.format_Date(row2.SESS_APP_START_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[12]=row2.SESS_APP_BEGIN_DATE == null ? null : FormatterUtils.format_Date(row2.SESS_APP_BEGIN_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[13]=row2.SESS_APP_SUBMITTED_DATE == null ? null : FormatterUtils.format_Date(row2.SESS_APP_SUBMITTED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[14]=row2.SESS_APP_PROCESS_FINISHED_DATE == null ? null : FormatterUtils.format_Date(row2.SESS_APP_PROCESS_FINISHED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[15]=row2.SESS_APP_LAST_STEP == null ? null : row2.SESS_APP_LAST_STEP;
                            rowtFileOutputDelimited_1[16]=row2.SESS_INCOMPLETE_APP_P == null ? null : row2.SESS_INCOMPLETE_APP_P;
                            rowtFileOutputDelimited_1[17]=row2.SESS_SUBMITTED_APP_P == null ? null : row2.SESS_SUBMITTED_APP_P;
                            rowtFileOutputDelimited_1[18]=row2.SESS_APP_ACCOUNT_APPROVAL_DATE == null ? null : FormatterUtils.format_Date(row2.SESS_APP_ACCOUNT_APPROVAL_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[19]=row2.SESS_APP_REJECTION_DATE == null ? null : FormatterUtils.format_Date(row2.SESS_APP_REJECTION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[20]=row2.SESS_APP_STATUS == null ? null : row2.SESS_APP_STATUS;
                            rowtFileOutputDelimited_1[21]=row2.SESS_REFERRAL_P == null ? null : row2.SESS_REFERRAL_P;
                            rowtFileOutputDelimited_1[22]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[23]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[24]=row2.APP_STATUS == null ? null : row2.APP_STATUS;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_MemberLastRegistrationSess StageFeed_MemberLastRegistrationSessClass = new StageFeed_MemberLastRegistrationSess();

        int exitCode = StageFeed_MemberLastRegistrationSessClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_MemberLastRegistrationSess.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_memberlastregistrationsess_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_MemberLastRegistrationSess");
        }
...
/************************************************************************************************
 *     422134 characters generated by Talend Open Studio for Data Integration 
 *     on the October 16, 2018 5:21:43 PM CDT
 ************************************************************************************************/