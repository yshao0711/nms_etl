...
package zipcar_marketingdw.processstaging_log_control_0_1;
...
/**
 * Job: ProcessStaging_Log_Control Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Log_Control implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Log_Control";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_2MUrQFreEei_EJm82Z_azQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Log_Control.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Log_Control.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Log_Control) {
...
Logging.componentName(jobName, "tWarn_1", "Log_JobCompleted");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "salesforce_log_control";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_salesforce_log_control";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_salesforce_log_control\n(\n	member_id,\n	control_date_time,\n	control_name,\n	mailing_name,\n	campaign_name,\n	mailer_type,\n	job_id,\n    imported_date\n)\nSELECT \n	REGEXP_REPLACE(subscriber_key, '_.*$') AS member_id,\n	control_date_time,\n	control_name,\n	mailing_name,\n	campaign_name,\n	mailer_type,\n	job_id,\n	to_date({{rundate}}, 'yyyy-MM-dd') AS imported_date \nFROM	{{staging.schema}}.salesforce_log_control\nWHERE subscriber_key IS NOT NULL\n;\n",
...
"\nTRUNCATE {{staging.schema}}.salesforce_log_control;\n",
"staging.schema",  StringHandling.DQUOTE(context.Redshift_Staging_Schema)
);
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Historical Records Inserted for r_salesforce_log_control on: " + DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate)),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Historical Records Inserted for r_salesforce_log_control on: " + DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate)), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Historical Records Inserted for r_salesforce_log_control on: " + DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate))); 
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Log_Control ProcessStaging_Log_ControlClass = new ProcessStaging_Log_Control();

        int exitCode = ProcessStaging_Log_ControlClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Log_Control.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_log_control_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Log_Control");
        }
...
/************************************************************************************************
 *     134817 characters generated by Talend Open Studio for Data Integration 
