...
package zipcar_marketingdw.stagefeed_memberlastapplicationinfo_0_1;
...
/**
 * Job: StageFeed_MemberLastApplicationInfo Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_MemberLastApplicationInfo implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_MemberLastApplicationInfo";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_gE1K8MprEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_MemberLastApplicationInfo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_MemberLastApplicationInfo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.MEMBER_LAST_APPLICATION_INFO.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.MEMBER_LAST_APPLICATION_INFO.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.MEMBER_LAST_APPLICATION_INFO;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberLastApplicationInfo = new byte[0];
			    ...
			    public Long JOIN_APPLICATION_ID;

				public Long getJOIN_APPLICATION_ID () {
					return this.JOIN_APPLICATION_ID;
				}
				
			    public String JOIN_APPLICATION_TYPE;

				public String getJOIN_APPLICATION_TYPE () {
					return this.JOIN_APPLICATION_TYPE;
				}
			    ...
			    public String JOIN_SOURCE_CD;

				public String getJOIN_SOURCE_CD () {
					return this.JOIN_SOURCE_CD;
				}
				
			    public String JOIN_REFERRAL_P;

				public String getJOIN_REFERRAL_P () {
					return this.JOIN_REFERRAL_P;
				}
				
			    public String JOIN_RATE_PLAN_CLASS;

				public String getJOIN_RATE_PLAN_CLASS () {
					return this.JOIN_RATE_PLAN_CLASS;
				}
				
			    public Long JOIN_AFFILIATE;

				public Long getJOIN_AFFILIATE () {
					return this.JOIN_AFFILIATE;
				}
			    ...
			    public Long JOIN_COUPON_CD;

				public Long getJOIN_COUPON_CD () {
					return this.JOIN_COUPON_CD;
				}
				
			    public String JOIN_COUPON_DESC;

				public String getJOIN_COUPON_DESC () {
					return this.JOIN_COUPON_DESC;
				}
			    ...
			    public java.util.Date JOIN_APP_START_DATE;

				public java.util.Date getJOIN_APP_START_DATE () {
					return this.JOIN_APP_START_DATE;
				}
				
			    public java.util.Date JOIN_APP_FINISH_DATE;

				public java.util.Date getJOIN_APP_FINISH_DATE () {
					return this.JOIN_APP_FINISH_DATE;
				}
				
			    public String JOIN_APP_LAST_STEP;

				public String getJOIN_APP_LAST_STEP () {
					return this.JOIN_APP_LAST_STEP;
				}
				
			    public String JOIN_INCOMPLETE_APP_P;

				public String getJOIN_INCOMPLETE_APP_P () {
					return this.JOIN_INCOMPLETE_APP_P;
				}
				
			    public java.util.Date JOIN_APP_APPROVAL_DATE;

				public java.util.Date getJOIN_APP_APPROVAL_DATE () {
					return this.JOIN_APP_APPROVAL_DATE;
				}
				
			    public java.util.Date JOIN_APP_REJECTION_DATE;

				public java.util.Date getJOIN_APP_REJECTION_DATE () {
					return this.JOIN_APP_REJECTION_DATE;
				}
				
			    public java.util.Date JOIN_APP_ACCT_APPROV_TSTAMP_TZ;

				public java.util.Date getJOIN_APP_ACCT_APPROV_TSTAMP_TZ () {
					return this.JOIN_APP_ACCT_APPROV_TSTAMP_TZ;
				}
				
			    public java.util.Date JOIN_APP_SUBMITTED_DATE;

				public java.util.Date getJOIN_APP_SUBMITTED_DATE () {
					return this.JOIN_APP_SUBMITTED_DATE;
				}
				
			    public java.util.Date JOIN_APP_PROCESS_FINISHED_DATE;

				public java.util.Date getJOIN_APP_PROCESS_FINISHED_DATE () {
					return this.JOIN_APP_PROCESS_FINISHED_DATE;
				}
				
			    public java.util.Date JOIN_APP_ACCOUNT_APPROVAL_DATE;

				public java.util.Date getJOIN_APP_ACCOUNT_APPROVAL_DATE () {
					return this.JOIN_APP_ACCOUNT_APPROVAL_DATE;
				}
				
			    public String JOIN_APP_STATUS;

				public String getJOIN_APP_STATUS () {
					return this.JOIN_APP_STATUS;
				}
				
			    public java.util.Date JOIN_APP_BEGIN_DATE;

				public java.util.Date getJOIN_APP_BEGIN_DATE () {
					return this.JOIN_APP_BEGIN_DATE;
				}
				
			    public String JOIN_SUBMITTED_APP_P;

				public String getJOIN_SUBMITTED_APP_P () {
					return this.JOIN_SUBMITTED_APP_P;
				}
				
			    public String JOIN_FIRST_CORPORATE_ID;

				public String getJOIN_FIRST_CORPORATE_ID () {
					return this.JOIN_FIRST_CORPORATE_ID;
				}
				
			    public String JOIN_TIMEZONE_REGION;

				public String getJOIN_TIMEZONE_REGION () {
					return this.JOIN_TIMEZONE_REGION;
				}
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.MEMBER_ID = dis.readLong();
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_APPLICATION_ID = null;
           				} else {
           			    	this.JOIN_APPLICATION_ID = dis.readLong();
           				}
					
					this.JOIN_APPLICATION_TYPE = readString(dis);
					...
					this.JOIN_SOURCE_CD = readString(dis);
					
					this.JOIN_REFERRAL_P = readString(dis);
					
					this.JOIN_RATE_PLAN_CLASS = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_AFFILIATE = null;
           				} else {
           			    	this.JOIN_AFFILIATE = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_COUPON_CD = null;
           				} else {
           			    	this.JOIN_COUPON_CD = dis.readLong();
           				}
					
					this.JOIN_COUPON_DESC = readString(dis);
					...
					this.JOIN_APP_START_DATE = readDate(dis);
					
					this.JOIN_APP_FINISH_DATE = readDate(dis);
					
					this.JOIN_APP_LAST_STEP = readString(dis);
					
					this.JOIN_INCOMPLETE_APP_P = readString(dis);
					
					this.JOIN_APP_APPROVAL_DATE = readDate(dis);
					
					this.JOIN_APP_REJECTION_DATE = readDate(dis);
					
					this.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = readDate(dis);
					
					this.JOIN_APP_SUBMITTED_DATE = readDate(dis);
					
					this.JOIN_APP_PROCESS_FINISHED_DATE = readDate(dis);
					
					this.JOIN_APP_ACCOUNT_APPROVAL_DATE = readDate(dis);
					
					this.JOIN_APP_STATUS = readString(dis);
					
					this.JOIN_APP_BEGIN_DATE = readDate(dis);
					
					this.JOIN_SUBMITTED_APP_P = readString(dis);
					
					this.JOIN_FIRST_CORPORATE_ID = readString(dis);
					
					this.JOIN_TIMEZONE_REGION = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.JOIN_APPLICATION_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.JOIN_APPLICATION_ID);
		            	}
					
					// String
				
						writeString(this.JOIN_APPLICATION_TYPE,dos);
					...
					// String
						...
						writeString(this.JOIN_SOURCE_CD,dos);
					
					// String
				
						writeString(this.JOIN_REFERRAL_P,dos);
					
					// String
				
						writeString(this.JOIN_RATE_PLAN_CLASS,dos);
					
					// Long
				
						if(this.JOIN_AFFILIATE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.JOIN_AFFILIATE);
		            	}
					...
					// Long
						...
						if(this.JOIN_COUPON_CD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.JOIN_COUPON_CD);
		            	}
					
					// String
				
						writeString(this.JOIN_COUPON_DESC,dos);
					...
					// java.util.Date
						...
						writeDate(this.JOIN_APP_START_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_FINISH_DATE,dos);
					
					// String
				
						writeString(this.JOIN_APP_LAST_STEP,dos);
					
					// String
				
						writeString(this.JOIN_INCOMPLETE_APP_P,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_APPROVAL_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_REJECTION_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_ACCT_APPROV_TSTAMP_TZ,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_SUBMITTED_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_PROCESS_FINISHED_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_ACCOUNT_APPROVAL_DATE,dos);
					
					// String
				
						writeString(this.JOIN_APP_STATUS,dos);
					
					// java.util.Date
				
						writeDate(this.JOIN_APP_BEGIN_DATE,dos);
					
					// String
				
						writeString(this.JOIN_SUBMITTED_APP_P,dos);
					
					// String
				
						writeString(this.JOIN_FIRST_CORPORATE_ID,dos);
					
					// String
				
						writeString(this.JOIN_TIMEZONE_REGION,dos);
    ...
    public String toString() {
		...
		sb.append(",JOIN_APPLICATION_ID="+String.valueOf(JOIN_APPLICATION_ID));
		sb.append(",JOIN_APPLICATION_TYPE="+JOIN_APPLICATION_TYPE);
		sb.append(",JOIN_ACCOUNT_ID="+String.valueOf(JOIN_ACCOUNT_ID));
		sb.append(",JOIN_SOURCE_CD="+JOIN_SOURCE_CD);
		sb.append(",JOIN_REFERRAL_P="+JOIN_REFERRAL_P);
		sb.append(",JOIN_RATE_PLAN_CLASS="+JOIN_RATE_PLAN_CLASS);
		sb.append(",JOIN_AFFILIATE="+String.valueOf(JOIN_AFFILIATE));
		sb.append(",JOIN_ANNUAL_FEE="+String.valueOf(JOIN_ANNUAL_FEE));
		sb.append(",JOIN_APP_FEE="+String.valueOf(JOIN_APP_FEE));
		sb.append(",JOIN_COUPON_CD="+String.valueOf(JOIN_COUPON_CD));
		sb.append(",JOIN_COUPON_DESC="+JOIN_COUPON_DESC);
		sb.append(",JOIN_DRIVING_CREDIT_USD="+String.valueOf(JOIN_DRIVING_CREDIT_USD));
		sb.append(",JOIN_APP_START_DATE="+String.valueOf(JOIN_APP_START_DATE));
		sb.append(",JOIN_APP_FINISH_DATE="+String.valueOf(JOIN_APP_FINISH_DATE));
		sb.append(",JOIN_APP_LAST_STEP="+JOIN_APP_LAST_STEP);
		sb.append(",JOIN_INCOMPLETE_APP_P="+JOIN_INCOMPLETE_APP_P);
		sb.append(",JOIN_APP_APPROVAL_DATE="+String.valueOf(JOIN_APP_APPROVAL_DATE));
		sb.append(",JOIN_APP_REJECTION_DATE="+String.valueOf(JOIN_APP_REJECTION_DATE));
		sb.append(",JOIN_APP_ACCT_APPROV_TSTAMP_TZ="+String.valueOf(JOIN_APP_ACCT_APPROV_TSTAMP_TZ));
		sb.append(",JOIN_APP_SUBMITTED_DATE="+String.valueOf(JOIN_APP_SUBMITTED_DATE));
		sb.append(",JOIN_APP_PROCESS_FINISHED_DATE="+String.valueOf(JOIN_APP_PROCESS_FINISHED_DATE));
		sb.append(",JOIN_APP_ACCOUNT_APPROVAL_DATE="+String.valueOf(JOIN_APP_ACCOUNT_APPROVAL_DATE));
		sb.append(",JOIN_APP_STATUS="+JOIN_APP_STATUS);
		sb.append(",JOIN_APP_BEGIN_DATE="+String.valueOf(JOIN_APP_BEGIN_DATE));
		sb.append(",JOIN_SUBMITTED_APP_P="+JOIN_SUBMITTED_APP_P);
		sb.append(",JOIN_FIRST_CORPORATE_ID="+JOIN_FIRST_CORPORATE_ID);
		sb.append(",JOIN_TIMEZONE_REGION="+JOIN_TIMEZONE_REGION);
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						...
						Long JOIN_APPLICATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c1(Long JOIN_APPLICATION_ID){
							this.JOIN_APPLICATION_ID = JOIN_APPLICATION_ID;
							return this;
						}				
						String JOIN_APPLICATION_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String JOIN_APPLICATION_TYPE){
							this.JOIN_APPLICATION_TYPE = JOIN_APPLICATION_TYPE;
							return this;
						}				
						Long JOIN_ACCOUNT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Long JOIN_ACCOUNT_ID){
							this.JOIN_ACCOUNT_ID = JOIN_ACCOUNT_ID;
							return this;
						}				
						String JOIN_SOURCE_CD;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String JOIN_SOURCE_CD){
							this.JOIN_SOURCE_CD = JOIN_SOURCE_CD;
							return this;
						}				
						String JOIN_REFERRAL_P;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String JOIN_REFERRAL_P){
							this.JOIN_REFERRAL_P = JOIN_REFERRAL_P;
							return this;
						}				
						String JOIN_RATE_PLAN_CLASS;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String JOIN_RATE_PLAN_CLASS){
							this.JOIN_RATE_PLAN_CLASS = JOIN_RATE_PLAN_CLASS;
							return this;
						}				
						Long JOIN_AFFILIATE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Long JOIN_AFFILIATE){
							this.JOIN_AFFILIATE = JOIN_AFFILIATE;
							return this;
						}				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c9(Double JOIN_APP_FEE){
							this.JOIN_APP_FEE = JOIN_APP_FEE;
							return this;
						}				
						Long JOIN_COUPON_CD;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Long JOIN_COUPON_CD){
							this.JOIN_COUPON_CD = JOIN_COUPON_CD;
							return this;
						}				
						String JOIN_COUPON_DESC;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String JOIN_COUPON_DESC){
							this.JOIN_COUPON_DESC = JOIN_COUPON_DESC;
							return this;
						}				
						Double JOIN_DRIVING_CREDIT_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c12(Double JOIN_DRIVING_CREDIT_USD){
							this.JOIN_DRIVING_CREDIT_USD = JOIN_DRIVING_CREDIT_USD;
							return this;
						}				
						java.util.Date JOIN_APP_START_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(java.util.Date JOIN_APP_START_DATE){
							this.JOIN_APP_START_DATE = JOIN_APP_START_DATE;
							return this;
						}				
						java.util.Date JOIN_APP_FINISH_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c14(java.util.Date JOIN_APP_FINISH_DATE){
							this.JOIN_APP_FINISH_DATE = JOIN_APP_FINISH_DATE;
							return this;
						}				
						String JOIN_APP_LAST_STEP;
						
	            		public BufferLine_tRedshiftOutput_1 c15(String JOIN_APP_LAST_STEP){
							this.JOIN_APP_LAST_STEP = JOIN_APP_LAST_STEP;
							return this;
						}				
						String JOIN_INCOMPLETE_APP_P;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String JOIN_INCOMPLETE_APP_P){
							this.JOIN_INCOMPLETE_APP_P = JOIN_INCOMPLETE_APP_P;
							return this;
						}				
						java.util.Date JOIN_APP_APPROVAL_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c17(java.util.Date JOIN_APP_APPROVAL_DATE){
							this.JOIN_APP_APPROVAL_DATE = JOIN_APP_APPROVAL_DATE;
							return this;
						}				
						java.util.Date JOIN_APP_REJECTION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c18(java.util.Date JOIN_APP_REJECTION_DATE){
							this.JOIN_APP_REJECTION_DATE = JOIN_APP_REJECTION_DATE;
							return this;
						}				
						java.util.Date JOIN_APP_ACCT_APPROV_TSTAMP_TZ;
						
	            		public BufferLine_tRedshiftOutput_1 c19(java.util.Date JOIN_APP_ACCT_APPROV_TSTAMP_TZ){
							this.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = JOIN_APP_ACCT_APPROV_TSTAMP_TZ;
							return this;
						}				
						java.util.Date JOIN_APP_SUBMITTED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c20(java.util.Date JOIN_APP_SUBMITTED_DATE){
							this.JOIN_APP_SUBMITTED_DATE = JOIN_APP_SUBMITTED_DATE;
							return this;
						}				
						java.util.Date JOIN_APP_PROCESS_FINISHED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c21(java.util.Date JOIN_APP_PROCESS_FINISHED_DATE){
							this.JOIN_APP_PROCESS_FINISHED_DATE = JOIN_APP_PROCESS_FINISHED_DATE;
							return this;
						}				
						java.util.Date JOIN_APP_ACCOUNT_APPROVAL_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c22(java.util.Date JOIN_APP_ACCOUNT_APPROVAL_DATE){
							this.JOIN_APP_ACCOUNT_APPROVAL_DATE = JOIN_APP_ACCOUNT_APPROVAL_DATE;
							return this;
						}				
						String JOIN_APP_STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c23(String JOIN_APP_STATUS){
							this.JOIN_APP_STATUS = JOIN_APP_STATUS;
							return this;
						}				
						java.util.Date JOIN_APP_BEGIN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c24(java.util.Date JOIN_APP_BEGIN_DATE){
							this.JOIN_APP_BEGIN_DATE = JOIN_APP_BEGIN_DATE;
							return this;
						}				
						String JOIN_SUBMITTED_APP_P;
						
	            		public BufferLine_tRedshiftOutput_1 c25(String JOIN_SUBMITTED_APP_P){
							this.JOIN_SUBMITTED_APP_P = JOIN_SUBMITTED_APP_P;
							return this;
						}				
						String JOIN_FIRST_CORPORATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c26(String JOIN_FIRST_CORPORATE_ID){
							this.JOIN_FIRST_CORPORATE_ID = JOIN_FIRST_CORPORATE_ID;
							return this;
						}				
						String JOIN_TIMEZONE_REGION;
						
	            		public BufferLine_tRedshiftOutput_1 c27(String JOIN_TIMEZONE_REGION){
							this.JOIN_TIMEZONE_REGION = JOIN_TIMEZONE_REGION;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c28(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c29(java.util.Date DELETED_DATE){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"JOIN_APPLICATION_ID\",\"JOIN_APPLICATION_TYPE\",\"JOIN_ACCOUNT_ID\",\"JOIN_SOURCE_CD\",\"JOIN_REFERRAL_P\",\"JOIN_RATE_PLAN_CLASS\",\"JOIN_AFFILIATE\",\"JOIN_ANNUAL_FEE\",\"JOIN_APP_FEE\",\"JOIN_COUPON_CD\",\"JOIN_COUPON_DESC\",\"JOIN_DRIVING_CREDIT_USD\",\"JOIN_APP_START_DATE\",\"JOIN_APP_FINISH_DATE\",\"JOIN_APP_LAST_STEP\",\"JOIN_INCOMPLETE_APP_P\",\"JOIN_APP_APPROVAL_DATE\",\"JOIN_APP_REJECTION_DATE\",\"JOIN_APP_ACCT_APPROV_TSTAMP_TZ\",\"JOIN_APP_SUBMITTED_DATE\",\"JOIN_APP_PROCESS_FINISHED_DATE\",\"JOIN_APP_ACCOUNT_APPROVAL_DATE\",\"JOIN_APP_STATUS\",\"JOIN_APP_BEGIN_DATE\",\"JOIN_SUBMITTED_APP_P\",\"JOIN_FIRST_CORPORATE_ID\",\"JOIN_TIMEZONE_REGION\",\"CREATION_DATE\",\"DELETED_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.JOIN_APPLICATION_ID = null;
					
							Row_FeedRecord.JOIN_APPLICATION_TYPE = null;
					
							Row_FeedRecord.JOIN_ACCOUNT_ID = null;
					
							Row_FeedRecord.JOIN_SOURCE_CD = null;
					
							Row_FeedRecord.JOIN_REFERRAL_P = null;
					
							Row_FeedRecord.JOIN_RATE_PLAN_CLASS = null;
					
							Row_FeedRecord.JOIN_AFFILIATE = null;
					
							Row_FeedRecord.JOIN_ANNUAL_FEE = null;
					
							Row_FeedRecord.JOIN_APP_FEE = null;
					
							Row_FeedRecord.JOIN_COUPON_CD = null;
					
							Row_FeedRecord.JOIN_COUPON_DESC = null;
					
							Row_FeedRecord.JOIN_DRIVING_CREDIT_USD = null;
					
							Row_FeedRecord.JOIN_APP_START_DATE = null;
					
							Row_FeedRecord.JOIN_APP_FINISH_DATE = null;
					
							Row_FeedRecord.JOIN_APP_LAST_STEP = null;
					
							Row_FeedRecord.JOIN_INCOMPLETE_APP_P = null;
					
							Row_FeedRecord.JOIN_APP_APPROVAL_DATE = null;
					
							Row_FeedRecord.JOIN_APP_REJECTION_DATE = null;
					
							Row_FeedRecord.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = null;
					
							Row_FeedRecord.JOIN_APP_SUBMITTED_DATE = null;
					
							Row_FeedRecord.JOIN_APP_PROCESS_FINISHED_DATE = null;
					
							Row_FeedRecord.JOIN_APP_ACCOUNT_APPROVAL_DATE = null;
					
							Row_FeedRecord.JOIN_APP_STATUS = null;
					
							Row_FeedRecord.JOIN_APP_BEGIN_DATE = null;
					
							Row_FeedRecord.JOIN_SUBMITTED_APP_P = null;
					
							Row_FeedRecord.JOIN_FIRST_CORPORATE_ID = null;
					
							Row_FeedRecord.JOIN_TIMEZONE_REGION = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_APPLICATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_APPLICATION_TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_SOURCE_CD = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_REFERRAL_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_RATE_PLAN_CLASS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_AFFILIATE = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_COUPON_CD = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_COUPON_DESC = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_START_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_FINISH_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_APP_LAST_STEP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_INCOMPLETE_APP_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_REJECTION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_SUBMITTED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_PROCESS_FINISHED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_ACCOUNT_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_APP_STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_APP_BEGIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_SUBMITTED_APP_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_FIRST_CORPORATE_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_TIMEZONE_REGION = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.JOIN_APPLICATION_ID = Row_FeedRecord.JOIN_APPLICATION_ID;
Record_OutputToDB.JOIN_APPLICATION_TYPE = StringUtils.trimToNull(Row_FeedRecord.JOIN_APPLICATION_TYPE);
Record_OutputToDB.JOIN_ACCOUNT_ID = Row_FeedRecord.JOIN_ACCOUNT_ID;
Record_OutputToDB.JOIN_SOURCE_CD = StringUtils.trimToNull(Row_FeedRecord.JOIN_SOURCE_CD);
Record_OutputToDB.JOIN_REFERRAL_P = BooleanUtils.boolChar(Row_FeedRecord.JOIN_REFERRAL_P);
Record_OutputToDB.JOIN_RATE_PLAN_CLASS = StringUtils.trimToNull(Row_FeedRecord.JOIN_RATE_PLAN_CLASS);
Record_OutputToDB.JOIN_AFFILIATE = Row_FeedRecord.JOIN_AFFILIATE;
...
Record_OutputToDB.JOIN_COUPON_CD = Row_FeedRecord.JOIN_COUPON_CD;
Record_OutputToDB.JOIN_COUPON_DESC = StringUtils.trimToNull(Row_FeedRecord.JOIN_COUPON_DESC);
Record_OutputToDB.JOIN_DRIVING_CREDIT_USD = Row_FeedRecord.JOIN_DRIVING_CREDIT_USD;
Record_OutputToDB.JOIN_APP_START_DATE = Row_FeedRecord.JOIN_APP_START_DATE;
Record_OutputToDB.JOIN_APP_FINISH_DATE = Row_FeedRecord.JOIN_APP_FINISH_DATE;
Record_OutputToDB.JOIN_APP_LAST_STEP = StringUtils.trimToNull(Row_FeedRecord.JOIN_APP_LAST_STEP);
Record_OutputToDB.JOIN_INCOMPLETE_APP_P = BooleanUtils.boolChar(Row_FeedRecord.JOIN_INCOMPLETE_APP_P);
Record_OutputToDB.JOIN_APP_APPROVAL_DATE = Row_FeedRecord.JOIN_APP_APPROVAL_DATE;
Record_OutputToDB.JOIN_APP_REJECTION_DATE = Row_FeedRecord.JOIN_APP_REJECTION_DATE;
Record_OutputToDB.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = Row_FeedRecord.JOIN_APP_ACCT_APPROV_TSTAMP_TZ;
Record_OutputToDB.JOIN_APP_SUBMITTED_DATE = Row_FeedRecord.JOIN_APP_SUBMITTED_DATE;
Record_OutputToDB.JOIN_APP_PROCESS_FINISHED_DATE = Row_FeedRecord.JOIN_APP_PROCESS_FINISHED_DATE;
Record_OutputToDB.JOIN_APP_ACCOUNT_APPROVAL_DATE = Row_FeedRecord.JOIN_APP_ACCOUNT_APPROVAL_DATE;
Record_OutputToDB.JOIN_APP_STATUS = StringUtils.trimToNull(Row_FeedRecord.JOIN_APP_STATUS);
Record_OutputToDB.JOIN_APP_BEGIN_DATE = Row_FeedRecord.JOIN_APP_BEGIN_DATE;
Record_OutputToDB.JOIN_SUBMITTED_APP_P = BooleanUtils.boolChar(Row_FeedRecord.JOIN_SUBMITTED_APP_P);
Record_OutputToDB.JOIN_FIRST_CORPORATE_ID = StringUtils.trimToNull(Row_FeedRecord.JOIN_FIRST_CORPORATE_ID);
Record_OutputToDB.JOIN_TIMEZONE_REGION = StringUtils.trimToNull(Row_FeedRecord.JOIN_TIMEZONE_REGION);
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APPLICATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_APPLICATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APPLICATION_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_APPLICATION_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_SOURCE_CD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_SOURCE_CD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_REFERRAL_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_REFERRAL_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_RATE_PLAN_CLASS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_RATE_PLAN_CLASS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_AFFILIATE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_AFFILIATE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_COUPON_CD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_COUPON_CD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_COUPON_DESC==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_COUPON_DESC);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_START_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_START_DATE.getTime();
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_FINISH_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_FINISH_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_LAST_STEP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_APP_LAST_STEP);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_INCOMPLETE_APP_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_INCOMPLETE_APP_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_APPROVAL_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_APPROVAL_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_REJECTION_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_REJECTION_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_ACCT_APPROV_TSTAMP_TZ!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_ACCT_APPROV_TSTAMP_TZ.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_SUBMITTED_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_SUBMITTED_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_PROCESS_FINISHED_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_PROCESS_FINISHED_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_ACCOUNT_APPROVAL_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_ACCOUNT_APPROVAL_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_STATUS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_APP_STATUS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_BEGIN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.JOIN_APP_BEGIN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_SUBMITTED_APP_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_SUBMITTED_APP_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_FIRST_CORPORATE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_FIRST_CORPORATE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_TIMEZONE_REGION==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_TIMEZONE_REGION);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.JOIN_APPLICATION_ID)
                        .c2(Record_OutputToDB.JOIN_APPLICATION_TYPE)
                        .c3(Record_OutputToDB.JOIN_ACCOUNT_ID)
                        .c4(Record_OutputToDB.JOIN_SOURCE_CD)
                        .c5(Record_OutputToDB.JOIN_REFERRAL_P)
                        .c6(Record_OutputToDB.JOIN_RATE_PLAN_CLASS)
                        .c7(Record_OutputToDB.JOIN_AFFILIATE)
                        .c8(Record_OutputToDB.JOIN_ANNUAL_FEE)
                        .c9(Record_OutputToDB.JOIN_APP_FEE)
                        .c10(Record_OutputToDB.JOIN_COUPON_CD)
                        .c11(Record_OutputToDB.JOIN_COUPON_DESC)
                        .c12(Record_OutputToDB.JOIN_DRIVING_CREDIT_USD)
                        .c13(Record_OutputToDB.JOIN_APP_START_DATE)
                        .c14(Record_OutputToDB.JOIN_APP_FINISH_DATE)
                        .c15(Record_OutputToDB.JOIN_APP_LAST_STEP)
                        .c16(Record_OutputToDB.JOIN_INCOMPLETE_APP_P)
                        .c17(Record_OutputToDB.JOIN_APP_APPROVAL_DATE)
                        .c18(Record_OutputToDB.JOIN_APP_REJECTION_DATE)
                        .c19(Record_OutputToDB.JOIN_APP_ACCT_APPROV_TSTAMP_TZ)
                        .c20(Record_OutputToDB.JOIN_APP_SUBMITTED_DATE)
                        .c21(Record_OutputToDB.JOIN_APP_PROCESS_FINISHED_DATE)
                        .c22(Record_OutputToDB.JOIN_APP_ACCOUNT_APPROVAL_DATE)
                        .c23(Record_OutputToDB.JOIN_APP_STATUS)
                        .c24(Record_OutputToDB.JOIN_APP_BEGIN_DATE)
                        .c25(Record_OutputToDB.JOIN_SUBMITTED_APP_P)
                        .c26(Record_OutputToDB.JOIN_FIRST_CORPORATE_ID)
                        .c27(Record_OutputToDB.JOIN_TIMEZONE_REGION)
                        .c28(Record_OutputToDB.CREATION_DATE)
                        .c29(Record_OutputToDB.DELETED_DATE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.JOIN_APPLICATION_ID = Record_OutputToDB.JOIN_APPLICATION_ID;
                                After_Insert.JOIN_APPLICATION_TYPE = Record_OutputToDB.JOIN_APPLICATION_TYPE;
                                After_Insert.JOIN_ACCOUNT_ID = Record_OutputToDB.JOIN_ACCOUNT_ID;
                                After_Insert.JOIN_SOURCE_CD = Record_OutputToDB.JOIN_SOURCE_CD;
                                After_Insert.JOIN_REFERRAL_P = Record_OutputToDB.JOIN_REFERRAL_P;
                                After_Insert.JOIN_RATE_PLAN_CLASS = Record_OutputToDB.JOIN_RATE_PLAN_CLASS;
                                After_Insert.JOIN_AFFILIATE = Record_OutputToDB.JOIN_AFFILIATE;
                                After_Insert.JOIN_ANNUAL_FEE = Record_OutputToDB.JOIN_ANNUAL_FEE;
                                After_Insert.JOIN_APP_FEE = Record_OutputToDB.JOIN_APP_FEE;
                                After_Insert.JOIN_COUPON_CD = Record_OutputToDB.JOIN_COUPON_CD;
                                After_Insert.JOIN_COUPON_DESC = Record_OutputToDB.JOIN_COUPON_DESC;
                                After_Insert.JOIN_DRIVING_CREDIT_USD = Record_OutputToDB.JOIN_DRIVING_CREDIT_USD;
                                After_Insert.JOIN_APP_START_DATE = Record_OutputToDB.JOIN_APP_START_DATE;
                                After_Insert.JOIN_APP_FINISH_DATE = Record_OutputToDB.JOIN_APP_FINISH_DATE;
                                After_Insert.JOIN_APP_LAST_STEP = Record_OutputToDB.JOIN_APP_LAST_STEP;
                                After_Insert.JOIN_INCOMPLETE_APP_P = Record_OutputToDB.JOIN_INCOMPLETE_APP_P;
                                After_Insert.JOIN_APP_APPROVAL_DATE = Record_OutputToDB.JOIN_APP_APPROVAL_DATE;
                                After_Insert.JOIN_APP_REJECTION_DATE = Record_OutputToDB.JOIN_APP_REJECTION_DATE;
                                After_Insert.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = Record_OutputToDB.JOIN_APP_ACCT_APPROV_TSTAMP_TZ;
                                After_Insert.JOIN_APP_SUBMITTED_DATE = Record_OutputToDB.JOIN_APP_SUBMITTED_DATE;
                                After_Insert.JOIN_APP_PROCESS_FINISHED_DATE = Record_OutputToDB.JOIN_APP_PROCESS_FINISHED_DATE;
                                After_Insert.JOIN_APP_ACCOUNT_APPROVAL_DATE = Record_OutputToDB.JOIN_APP_ACCOUNT_APPROVAL_DATE;
                                After_Insert.JOIN_APP_STATUS = Record_OutputToDB.JOIN_APP_STATUS;
                                After_Insert.JOIN_APP_BEGIN_DATE = Record_OutputToDB.JOIN_APP_BEGIN_DATE;
                                After_Insert.JOIN_SUBMITTED_APP_P = Record_OutputToDB.JOIN_SUBMITTED_APP_P;
                                After_Insert.JOIN_FIRST_CORPORATE_ID = Record_OutputToDB.JOIN_FIRST_CORPORATE_ID;
                                After_Insert.JOIN_TIMEZONE_REGION = Record_OutputToDB.JOIN_TIMEZONE_REGION;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.JOIN_APPLICATION_ID = After_Insert.JOIN_APPLICATION_ID;
               Log_Rows.JOIN_APPLICATION_TYPE = After_Insert.JOIN_APPLICATION_TYPE;
               Log_Rows.JOIN_ACCOUNT_ID = After_Insert.JOIN_ACCOUNT_ID;
               Log_Rows.JOIN_SOURCE_CD = After_Insert.JOIN_SOURCE_CD;
               Log_Rows.JOIN_REFERRAL_P = After_Insert.JOIN_REFERRAL_P;
               Log_Rows.JOIN_RATE_PLAN_CLASS = After_Insert.JOIN_RATE_PLAN_CLASS;
               Log_Rows.JOIN_AFFILIATE = After_Insert.JOIN_AFFILIATE;
               Log_Rows.JOIN_ANNUAL_FEE = After_Insert.JOIN_ANNUAL_FEE;
               Log_Rows.JOIN_APP_FEE = After_Insert.JOIN_APP_FEE;
               Log_Rows.JOIN_COUPON_CD = After_Insert.JOIN_COUPON_CD;
               Log_Rows.JOIN_COUPON_DESC = After_Insert.JOIN_COUPON_DESC;
               Log_Rows.JOIN_DRIVING_CREDIT_USD = After_Insert.JOIN_DRIVING_CREDIT_USD;
               Log_Rows.JOIN_APP_START_DATE = After_Insert.JOIN_APP_START_DATE;
               Log_Rows.JOIN_APP_FINISH_DATE = After_Insert.JOIN_APP_FINISH_DATE;
               Log_Rows.JOIN_APP_LAST_STEP = After_Insert.JOIN_APP_LAST_STEP;
               Log_Rows.JOIN_INCOMPLETE_APP_P = After_Insert.JOIN_INCOMPLETE_APP_P;
               Log_Rows.JOIN_APP_APPROVAL_DATE = After_Insert.JOIN_APP_APPROVAL_DATE;
               Log_Rows.JOIN_APP_REJECTION_DATE = After_Insert.JOIN_APP_REJECTION_DATE;
               Log_Rows.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = After_Insert.JOIN_APP_ACCT_APPROV_TSTAMP_TZ;
               Log_Rows.JOIN_APP_SUBMITTED_DATE = After_Insert.JOIN_APP_SUBMITTED_DATE;
               Log_Rows.JOIN_APP_PROCESS_FINISHED_DATE = After_Insert.JOIN_APP_PROCESS_FINISHED_DATE;
               Log_Rows.JOIN_APP_ACCOUNT_APPROVAL_DATE = After_Insert.JOIN_APP_ACCOUNT_APPROVAL_DATE;
               Log_Rows.JOIN_APP_STATUS = After_Insert.JOIN_APP_STATUS;
               Log_Rows.JOIN_APP_BEGIN_DATE = After_Insert.JOIN_APP_BEGIN_DATE;
               Log_Rows.JOIN_SUBMITTED_APP_P = After_Insert.JOIN_SUBMITTED_APP_P;
               Log_Rows.JOIN_FIRST_CORPORATE_ID = After_Insert.JOIN_FIRST_CORPORATE_ID;
               Log_Rows.JOIN_TIMEZONE_REGION = After_Insert.JOIN_TIMEZONE_REGION;
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.JOIN_APPLICATION_ID==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_APPLICATION_ID);
					...
					if(bufferLtRedshiftOutput_1.JOIN_APPLICATION_TYPE==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_APPLICATION_TYPE);
					...
					if(bufferLtRedshiftOutput_1.JOIN_SOURCE_CD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_SOURCE_CD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_REFERRAL_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_REFERRAL_P);
					...
					if(bufferLtRedshiftOutput_1.JOIN_RATE_PLAN_CLASS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_RATE_PLAN_CLASS);
					...
					if(bufferLtRedshiftOutput_1.JOIN_AFFILIATE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_AFFILIATE);
					...
					if(bufferLtRedshiftOutput_1.JOIN_COUPON_CD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_COUPON_CD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_COUPON_DESC==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_COUPON_DESC);
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_START_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_START_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_FINISH_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_FINISH_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_LAST_STEP==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_APP_LAST_STEP);
					...
					if(bufferLtRedshiftOutput_1.JOIN_INCOMPLETE_APP_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_INCOMPLETE_APP_P);
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_APPROVAL_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_APPROVAL_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_REJECTION_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_REJECTION_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_ACCT_APPROV_TSTAMP_TZ!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_ACCT_APPROV_TSTAMP_TZ.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_SUBMITTED_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_SUBMITTED_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_PROCESS_FINISHED_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_PROCESS_FINISHED_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_ACCOUNT_APPROVAL_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_ACCOUNT_APPROVAL_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_STATUS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_APP_STATUS);
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_BEGIN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_APP_BEGIN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.JOIN_SUBMITTED_APP_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_SUBMITTED_APP_P);
					...
					if(bufferLtRedshiftOutput_1.JOIN_FIRST_CORPORATE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_FIRST_CORPORATE_ID);
					...
					if(bufferLtRedshiftOutput_1.JOIN_TIMEZONE_REGION==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_TIMEZONE_REGION);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.JOIN_APPLICATION_ID = null;
					
							row1.JOIN_APPLICATION_TYPE = null;
					
							row1.JOIN_ACCOUNT_ID = null;
					
							row1.JOIN_SOURCE_CD = null;
					
							row1.JOIN_REFERRAL_P = null;
					
							row1.JOIN_RATE_PLAN_CLASS = null;
					
							row1.JOIN_AFFILIATE = null;
					
							row1.JOIN_ANNUAL_FEE = null;
					
							row1.JOIN_APP_FEE = null;
					
							row1.JOIN_COUPON_CD = null;
					
							row1.JOIN_COUPON_DESC = null;
					
							row1.JOIN_DRIVING_CREDIT_USD = null;
					
							row1.JOIN_APP_START_DATE = null;
					
							row1.JOIN_APP_FINISH_DATE = null;
					
							row1.JOIN_APP_LAST_STEP = null;
					
							row1.JOIN_INCOMPLETE_APP_P = null;
					
							row1.JOIN_APP_APPROVAL_DATE = null;
					
							row1.JOIN_APP_REJECTION_DATE = null;
					
							row1.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = null;
					
							row1.JOIN_APP_SUBMITTED_DATE = null;
					
							row1.JOIN_APP_PROCESS_FINISHED_DATE = null;
					
							row1.JOIN_APP_ACCOUNT_APPROVAL_DATE = null;
					
							row1.JOIN_APP_STATUS = null;
					
							row1.JOIN_APP_BEGIN_DATE = null;
					
							row1.JOIN_SUBMITTED_APP_P = null;
					
							row1.JOIN_FIRST_CORPORATE_ID = null;
					
							row1.JOIN_TIMEZONE_REGION = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_APPLICATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_APPLICATION_TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_SOURCE_CD = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_REFERRAL_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_RATE_PLAN_CLASS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_AFFILIATE = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_COUPON_CD = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_COUPON_DESC = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_START_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_FINISH_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_APP_LAST_STEP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_INCOMPLETE_APP_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_REJECTION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_SUBMITTED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_PROCESS_FINISHED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_ACCOUNT_APPROVAL_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_APP_STATUS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_APP_BEGIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_SUBMITTED_APP_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_FIRST_CORPORATE_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_TIMEZONE_REGION = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.JOIN_APPLICATION_ID = row1.JOIN_APPLICATION_ID;
row2.JOIN_APPLICATION_TYPE = StringUtils.trimToNull(row1.JOIN_APPLICATION_TYPE);
row2.JOIN_ACCOUNT_ID = row1.JOIN_ACCOUNT_ID;
row2.JOIN_SOURCE_CD = StringUtils.trimToNull(row1.JOIN_SOURCE_CD);
row2.JOIN_REFERRAL_P = BooleanUtils.boolChar(row1.JOIN_REFERRAL_P);
row2.JOIN_RATE_PLAN_CLASS = StringUtils.trimToNull(row1.JOIN_RATE_PLAN_CLASS);
row2.JOIN_AFFILIATE = row1.JOIN_AFFILIATE;
row2.JOIN_ANNUAL_FEE = row1.JOIN_ANNUAL_FEE;
row2.JOIN_APP_FEE = row1.JOIN_APP_FEE;
row2.JOIN_COUPON_CD = row1.JOIN_COUPON_CD;
row2.JOIN_COUPON_DESC = StringUtils.trimToNull(row1.JOIN_COUPON_DESC);
row2.JOIN_DRIVING_CREDIT_USD = row1.JOIN_DRIVING_CREDIT_USD;
row2.JOIN_APP_START_DATE = row1.JOIN_APP_START_DATE;
row2.JOIN_APP_FINISH_DATE = row1.JOIN_APP_FINISH_DATE;
row2.JOIN_APP_LAST_STEP = StringUtils.trimToNull(row1.JOIN_APP_LAST_STEP);
row2.JOIN_INCOMPLETE_APP_P = BooleanUtils.boolChar(row1.JOIN_INCOMPLETE_APP_P);
row2.JOIN_APP_APPROVAL_DATE = row1.JOIN_APP_APPROVAL_DATE;
row2.JOIN_APP_REJECTION_DATE = row1.JOIN_APP_REJECTION_DATE;
row2.JOIN_APP_ACCT_APPROV_TSTAMP_TZ = row1.JOIN_APP_ACCT_APPROV_TSTAMP_TZ;
row2.JOIN_APP_SUBMITTED_DATE = row1.JOIN_APP_SUBMITTED_DATE;
row2.JOIN_APP_PROCESS_FINISHED_DATE = row1.JOIN_APP_PROCESS_FINISHED_DATE;
row2.JOIN_APP_ACCOUNT_APPROVAL_DATE = row1.JOIN_APP_ACCOUNT_APPROVAL_DATE;
row2.JOIN_APP_STATUS = StringUtils.trimToNull(row1.JOIN_APP_STATUS);
row2.JOIN_APP_BEGIN_DATE = row1.JOIN_APP_BEGIN_DATE;
row2.JOIN_SUBMITTED_APP_P = BooleanUtils.boolChar(row1.JOIN_SUBMITTED_APP_P);
row2.JOIN_FIRST_CORPORATE_ID = StringUtils.trimToNull(row1.JOIN_FIRST_CORPORATE_ID);
row2.JOIN_TIMEZONE_REGION = StringUtils.trimToNull(row1.JOIN_TIMEZONE_REGION);
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[30];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.JOIN_APPLICATION_ID == null ? null : String.valueOf(row2.JOIN_APPLICATION_ID);
                            rowtFileOutputDelimited_1[2]=row2.JOIN_APPLICATION_TYPE == null ? null : row2.JOIN_APPLICATION_TYPE;
                            rowtFileOutputDelimited_1[3]=row2.JOIN_ACCOUNT_ID == null ? null : String.valueOf(row2.JOIN_ACCOUNT_ID);
                            rowtFileOutputDelimited_1[4]=row2.JOIN_SOURCE_CD == null ? null : row2.JOIN_SOURCE_CD;
                            rowtFileOutputDelimited_1[5]=row2.JOIN_REFERRAL_P == null ? null : row2.JOIN_REFERRAL_P;
                            rowtFileOutputDelimited_1[6]=row2.JOIN_RATE_PLAN_CLASS == null ? null : row2.JOIN_RATE_PLAN_CLASS;
                            rowtFileOutputDelimited_1[7]=row2.JOIN_AFFILIATE == null ? null : String.valueOf(row2.JOIN_AFFILIATE);
                            rowtFileOutputDelimited_1[8]=row2.JOIN_ANNUAL_FEE == null ? null : String.valueOf(row2.JOIN_ANNUAL_FEE);
                            rowtFileOutputDelimited_1[9]=row2.JOIN_APP_FEE == null ? null : String.valueOf(row2.JOIN_APP_FEE);
                            rowtFileOutputDelimited_1[10]=row2.JOIN_COUPON_CD == null ? null : String.valueOf(row2.JOIN_COUPON_CD);
                            rowtFileOutputDelimited_1[11]=row2.JOIN_COUPON_DESC == null ? null : row2.JOIN_COUPON_DESC;
                            rowtFileOutputDelimited_1[12]=row2.JOIN_DRIVING_CREDIT_USD == null ? null : String.valueOf(row2.JOIN_DRIVING_CREDIT_USD);
                            rowtFileOutputDelimited_1[13]=row2.JOIN_APP_START_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_START_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[14]=row2.JOIN_APP_FINISH_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_FINISH_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[15]=row2.JOIN_APP_LAST_STEP == null ? null : row2.JOIN_APP_LAST_STEP;
                            rowtFileOutputDelimited_1[16]=row2.JOIN_INCOMPLETE_APP_P == null ? null : row2.JOIN_INCOMPLETE_APP_P;
                            rowtFileOutputDelimited_1[17]=row2.JOIN_APP_APPROVAL_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_APPROVAL_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[18]=row2.JOIN_APP_REJECTION_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_REJECTION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[19]=row2.JOIN_APP_ACCT_APPROV_TSTAMP_TZ == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_ACCT_APPROV_TSTAMP_TZ, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[20]=row2.JOIN_APP_SUBMITTED_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_SUBMITTED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[21]=row2.JOIN_APP_PROCESS_FINISHED_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_PROCESS_FINISHED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[22]=row2.JOIN_APP_ACCOUNT_APPROVAL_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_ACCOUNT_APPROVAL_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[23]=row2.JOIN_APP_STATUS == null ? null : row2.JOIN_APP_STATUS;
                            rowtFileOutputDelimited_1[24]=row2.JOIN_APP_BEGIN_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_APP_BEGIN_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[25]=row2.JOIN_SUBMITTED_APP_P == null ? null : row2.JOIN_SUBMITTED_APP_P;
                            rowtFileOutputDelimited_1[26]=row2.JOIN_FIRST_CORPORATE_ID == null ? null : row2.JOIN_FIRST_CORPORATE_ID;
                            rowtFileOutputDelimited_1[27]=row2.JOIN_TIMEZONE_REGION == null ? null : row2.JOIN_TIMEZONE_REGION;
                            rowtFileOutputDelimited_1[28]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[29]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_MemberLastApplicationInfo StageFeed_MemberLastApplicationInfoClass = new StageFeed_MemberLastApplicationInfo();

        int exitCode = StageFeed_MemberLastApplicationInfoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_MemberLastApplicationInfo.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_memberlastapplicationinfo_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_MemberLastApplicationInfo");
        }
...
/************************************************************************************************
 *     455362 characters generated by Talend Open Studio for Data Integration 
