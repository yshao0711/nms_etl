...
package zipcar_marketingdw.task_monitor_suspended_members_0_1;
...
/**
 * Job: Task_Monitor_Suspended_Members Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Task_Monitor_Suspended_Members implements TalendJob {
...
public Object getSharedMap(){
	...
	private final String jobName = "Task_Monitor_Suspended_Members";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_7E87IChqEeikmpP71yGSvg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Task_Monitor_Suspended_Members.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Task_Monitor_Suspended_Members.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class external_configStruct implements routines.system.IPersistableRow<external_configStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_Monitor_Suspended_Members) {
...
"\nSELECT COUNT(*) as members, NVL(SUM(reservations), 0) AS reservations\nFROM (\n	SELECT dm.member_id, count(sr.reservation_id) as reservations\n	FROM {{marketing.schema}}.d_member dm\n	JOIN {{marketing.schema}}.vw_r_member rm\n	ON dm.member_id = rm.member_id\n	AND rm.current_status = 'suspended'\n	JOIN {{marketing.schema}}.s_reservation sr\n	ON dm.member_id = sr.member_id\n	AND (sr.cancel_date IS NULL OR sr.cancel_date >= CURRENT_DATE)\n	AND (sr.end_date >= CURRENT_DATE)\n	WHERE dm.end_date = '3199-12-31'\n	AND sr.creation_date >= dm.start_date\n	GROUP BY dm.member_id\n	ORDER BY dm.member_id\n);\n",
		    ...
		    while (rs_tRedshiftInput_1.next()) {
		        nb_line_tRedshiftInput_1++;
							...
							if(colQtyInRs_tRedshiftInput_1 < 1) {
								data_row.members = null;
							} else {
	                         		
        	data_row.members = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 1, false);
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 2) {
								data_row.reservations = null;
							} else {
	                         		
        	data_row.reservations = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 2, false);
		                    }
			...
			//data_row
				...
				if(execStat){
					runStat.updateStatOnConnection("data_row"+iterateId,1, 1);
	        				...
	        				row1.members = data_row.members;
	        				row1.reservations = data_row.reservations;
...
sharedMap.put("members", row1.members);
sharedMap.put("reservations", row1.reservations);
    nb_line_tJavaRow_2++;   
...
rowLogger.logRows(jobName, Logging.PRIORITY_INFO, "LogRows", "Suspended members and reservations");
 ...
 */
    ...
    public static void main(String[] args){
        final Task_Monitor_Suspended_Members Task_Monitor_Suspended_MembersClass = new Task_Monitor_Suspended_Members();

        int exitCode = Task_Monitor_Suspended_MembersClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Task_Monitor_Suspended_Members.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/task_monitor_suspended_members_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Task_Monitor_Suspended_Members");
        }
...
/************************************************************************************************
 *     135119 characters generated by Talend Open Studio for Data Integration 
