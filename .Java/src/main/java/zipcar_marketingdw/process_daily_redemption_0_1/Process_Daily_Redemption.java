...
package zipcar_marketingdw.process_daily_redemption_0_1;
...
/**
 * Job: Process_Daily_Redemption Purpose: calculate daily coupon/credit redemption data<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Process_Daily_Redemption implements TalendJob {
...
public String getRedshift_Monitoring_Server(){
	...
	private final String jobName = "Process_Daily_Redemption";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_9MlLIM1fEeiI6KFGhaAC5Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Process_Daily_Redemption.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Process_Daily_Redemption.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Daily_Redemption = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Daily_Redemption = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Process_Daily_Redemption.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Process_Daily_Redemption.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Daily_Redemption = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Daily_Redemption = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Process_Daily_Redemption, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Process_Daily_Redemption, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Daily_Redemption) {
...
Logging.componentName(jobName, "tWarn_1", "Log_Process_Redemption_Done");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = getErrorCode();
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param errorCode=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param errorCode=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("errorCode", obj_tRunJob_1);
	
		obj_tRunJob_1 = getStatus();
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param status=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param status=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("status", obj_tRunJob_1);
	
		obj_tRunJob_1 =  jobName + " - " + TalendDate.formatDate("yyyy-MM-dd", DateUtils.runDate(context.RunDate));;
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param emailSubject=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param emailSubject=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("emailSubject", obj_tRunJob_1);
	
	
		zipcar_marketingdw.task_sendjobnotification_0_1.Task_SendJobNotification childJob_tRunJob_1 = new zipcar_marketingdw.task_sendjobnotification_0_1.Task_SendJobNotification();
	    // pass DataSources
...
"\n-- truncate redemption tables first\nTRUNCATE {{marketing.schema}}.s_redemption_credit;\nTRUNCATE {{marketing.schema}}.s_redemption_coupon;\n\nCREATE TEMP TABLE tmp_transactions\ndistkey (source_id)\nsortkey (source_id)\nAS (\n	select * from {{marketing.schema}}.vw_r_transaction\n	where voided_by is null\n	and voids_transaction_id is null\n	and source_id is not null\n	and transaction_type = 'credit'\n);\n\nINSERT INTO {{marketing.schema}}.s_redemption_credit\nWITH credit_value as (\n	select distinct\n		cr.credit_id,\n		case when cr.value=0 then (case when nvl(cr.credit_used, 0)=0 then tr.amount else cr.credit_used end) else cr.value end as value\n	from {{marketing.schema}}.vw_r_credit cr\n	left join tmp_transactions tr\n	on cr.credit_id = tr.source_id\n	and tr.amount > 0\n)\n,credit_reservations as (\n	select\n		cr.credit_id,\n		tr.reservation_id,\n		min(tr.bill_date) as bill_date,\n		sum(tr.amount) as amount\n	from {{marketing.schema}}.vw_r_credit cr\n	join tmp_transactions tr\n	on tr.source_id = cr.credit_id\n	group by cr.credit_id, tr.reservation_id\n	order by cr.credit_id\n)\n,credit_usage as (\n	select\n		cr.credit_id,\n		cr.credit_type,\n		cv.value,\n		cr.currency_iso,\n		cr.account_id,\n		cr.member_id,\n		cr.creation_date as credit_offered_date,\n		tr.bill_date,\n		tr.amount,\n		tr.reservation_id,\n		row_number() over (partition by cr.credit_id order by tr.bill_date) as row_num\n	from {{marketing.schema}}.vw_r_credit cr\n	left join credit_value cv\n	on cr.credit_id = cv.credit_id\n	left join credit_reservations tr\n	on cr.credit_id = tr.credit_id\n	where cr.void_date is null\n	order by cr.credit_id, tr.bill_date\n)\n,total_credit_usage as (\n	select credit_id, abs(sum(amount)) as total_credit_used\n	from credit_usage\n	group by credit_id\n)\nselect\n	cu.credit_id,\n	credit_type,\n	nvl(value, 0) as credit_value,\n	currency_iso,\n	account_id,\n	member_id,\n	credit_offered_date,\n	to_char(credit_offered_date, 'MM') as credit_offered_month,\n	to_char(credit_offered_date, 'YYYY') as credit_offered_year,\n	bill_date as credit_first_used_date,\n	to_char(bill_date, 'MM') as credit_first_used_month,\n	to_char(bill_date, 'YYYY') as credit_first_used_year,\n	abs(amount) as credit_first_used_amount,\n	case when value = 0 then 0 else round(abs(amount)*100.0/value, 0) end as pct_first_credit_use,\n	reservation_id as credit_first_used_reservation_id,\n	tcu.total_credit_used,\n	case when value = 0 then 0 else round(tcu.total_credit_used*100.0/value, 0) end as pct_total_credit_use\nfrom credit_usage cu\nleft join total_credit_usage tcu\non cu.credit_id = tcu.credit_id\nwhere row_num = 1\n;\n\nCREATE TEMP TABLE coupon_redeemed\ndistkey (coupon_id)\nsortkey (coupon_id)\nAS (\nWITH credit_reservations as (\n	select\n		cr.credit_id,\n		tr.reservation_id,\n		min(tr.bill_date) as bill_date,\n		sum(tr.amount) as amount\n	from {{marketing.schema}}.vw_r_credit cr\n	join tmp_transactions tr\n	on tr.source_id = cr.credit_id\n	group by cr.credit_id, tr.reservation_id\n	order by cr.credit_id\n)\n,coupon_usage as (\n	select\n		c.coupon_id,\n		c.coupon_code,\n		c.value as coupon_value,\n		c.currency_iso,\n		nvl(sfls.send_date_time, c.start_date) as coupon_offered_date,\n		c.description,\n		c.campaign_id,\n		c.use_type,\n		cc.claim_id,\n		cr.account_id,\n		cc.person_id as member_id,\n		cc.creation_date as coupon_claimed_date,\n		cr.credit_id,\n		cr.value as credit_value,\n		cr.credit_type,\n		tr.bill_date,\n		tr.amount,\n		tr.reservation_id,\n		row_number() over (partition by cr.credit_id order by tr.bill_date) as row_num\n	from {{marketing.schema}}.vw_r_coupon c\n	join {{marketing.schema}}.vw_r_coupon_claim cc\n	on c.coupon_id = cc.coupon_id\n	left join {{marketing.schema}}.vw_r_credit cr\n	on cc.credit_id = cr.credit_id\n	left join credit_reservations tr\n	on cr.credit_id = tr.credit_id\n	left join {{marketing.schema}}.r_salesforce_log_send sfls\n	on sfls.coupon_code = c.coupon_code\n	and sfls.member_id = cc.person_id\n	where cc.deleted_date is NULL\n	and c.deleted_p = 'f'\n	and cr.void_date is null\n),\ntotal_coupon_usage as (\n	select coupon_id, credit_id, abs(sum(amount)) as total_credit_used\n	from coupon_usage\n	group by coupon_id, credit_id\n)\nselect\n	cu.coupon_id,\n	coupon_code,\n	coupon_value,\n	currency_iso,\n	coupon_offered_date,\n	to_char(coupon_offered_date, 'MM') as coupon_offered_month,\n	to_char(coupon_offered_date, 'YYYY') as coupon_offered_year,\n	description as coupon_desc,\n	campaign_id,\n	use_type as coupon_use_type,\n	account_id,\n	member_id,\n	claim_id,\n	coupon_claimed_date,\n	to_char(coupon_claimed_date, 'MM') as coupon_claimed_month,\n	to_char(coupon_claimed_date, 'YYYY') as coupon_claimed_year,\n	cu.credit_id,\n	credit_value,\n	credit_type,\n	bill_date as credit_first_used_date,\n	to_char(bill_date, 'MM') as credit_first_used_month,\n	to_char(bill_date, 'YYYY') as credit_first_used_year,\n	abs(amount) as credit_first_used_amount,\n	case when credit_value = 0 then 0 else round(abs(amount)*100.0/credit_value, 0) end as pct_first_credit_use,\n	reservation_id as credit_first_used_reservation_id,\n	tcu.total_credit_used,\n	case when credit_value = 0 then 0 else round(tcu.total_credit_used*100.0/credit_value, 0) end as pct_total_credit_use\nfrom coupon_usage cu\nleft join total_coupon_usage tcu\non cu.coupon_id = tcu.coupon_id\nand cu.credit_id = tcu.credit_id\nwhere row_num = 1\n);\n\nCREATE TEMP TABLE coupon_not_redeemed\ndistkey (coupon_id)\nsortkey (coupon_id)\nAS (\nselect DISTINCT\n	c.coupon_id,\n	c.coupon_code,\n	c.value as coupon_value,\n	c.currency_iso,\n	c.start_date as coupon_offered_date,\n	to_char(c.start_date, 'MM') as coupon_offered_month,\n	to_char(c.start_date, 'YYYY') as coupon_offered_year,\n	c.description as coupon_desc,\n	c.campaign_id,\n	c.use_type\nfrom {{marketing.schema}}.vw_r_coupon c \nleft join coupon_redeemed rc\non c.coupon_id = rc.coupon_id\nwhere rc.coupon_id is null\n);\n\nINSERT INTO {{marketing.schema}}.s_redemption_coupon\nselect * from coupon_redeemed\nUNION ALL\nselect c.*,\n	null::BIGINT as account_id,\n	null::BIGINT as member_id,\n	null::BIGINT as claim_id,\n	null::TIMESTAMP as coupon_claimed_date,\n	null as coupon_claimed_month,\n	null as coupon_claimed_year,\n	null::BIGINT as credit_id,\n	null::DECIMAL as credit_value,\n	null as credit_type,\n	null::TIMESTAMP as credit_first_used_date,\n	null as credit_first_used_month,\n	null as credit_first_used_year,\n	null::DECIMAL as credit_first_used_amount,\n	null::SMALLINT as pct_first_credit_use,\n	null::BIGINT as credit_first_used_reservation_id,\n	null::DECIMAL as total_credit_used,\n	null::SMALLINT as pct_total_credit_use\nfrom coupon_not_redeemed c\n;\n\nANALYZE {{marketing.schema}}.s_redemption_credit;\nANALYZE {{marketing.schema}}.s_redemption_coupon;\n",
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Redemption summary tables re-built","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Redemption summary tables re-built", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Redemption summary tables re-built"); 
 ...
 */
    ...
    public static void main(String[] args){
        final Process_Daily_Redemption Process_Daily_RedemptionClass = new Process_Daily_Redemption();

        int exitCode = Process_Daily_RedemptionClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Process_Daily_Redemption.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/process_daily_redemption_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Process_Daily_Redemption");
        }
...
/************************************************************************************************
 *     143392 characters generated by Talend Open Studio for Data Integration 
