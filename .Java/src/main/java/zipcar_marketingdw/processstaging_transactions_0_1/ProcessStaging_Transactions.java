...
package zipcar_marketingdw.processstaging_transactions_0_1;
...
/**
 * Job: ProcessStaging_Transactions Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Transactions implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Transactions";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_LonDIJ86EeiRFIAwSyk92Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Transactions.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Transactions.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Transactions) {
...
"\nINSERT INTO {{marketing.schema}}.r_transaction\n(\n	transaction_id,\n	account_id,\n	account_zipfleet_id,\n	admin_comment,\n	affiliate_id,\n	affiliate_zipfleet_id,\n	amount,\n	billable_p,\n	billing_code,\n	bill_date,\n	code_key,\n	comment_key,\n	creation_date,\n	creation_ip,\n	creation_user,\n	currency_iso,\n	day,\n	member_id,\n	end_date,\n	group_id,\n	invoice_id,\n	jurisdiction_id,\n	last_modified,\n	member_zipfleet_id,\n	parameters,\n	processed_p,\n	quantity,\n	reservation_id,\n	revenue_p,\n	rewarded_p,\n	source_id,\n	source_type,\n	start_date,\n	transaction_type,\n	transaction_zipfleet_id,\n	unit_amount,\n	voided_by,\n	voids_transaction_id,\n    imported_date\n)\nSELECT \n	transaction_id,\n	account_id,\n	account_zipfleet_id,\n	admin_comment,\n	affiliate_id,\n	affiliate_zipfleet_id,\n	amount,\n	billable_p,\n	billing_code,\n	bill_date,\n	code_key,\n	comment_key,\n	creation_date,\n	creation_ip,\n	creation_user,\n	currency_iso,\n	day,\n	driver_id as member_id,\n	end_date,\n	group_id,\n	invoice_id,\n	jurisdiction_id,\n	last_modified,\n	member_zipfleet_id,\n	parameters,\n	processed_p,\n	quantity,\n	reservation_id,\n	revenue_p,\n	rewarded_p,\n	source_id,\n	source_type,\n	start_date,\n	transaction_type,\n	transaction_zipfleet_id,\n	unit_amount,\n	voided_by,\n	voids_transaction_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.transactions\nMINUS\nSELECT \n	transaction_id,\n	account_id,\n	account_zipfleet_id,\n	admin_comment,\n	affiliate_id,\n	affiliate_zipfleet_id,\n	amount,\n	billable_p,\n	billing_code,\n	bill_date,\n	code_key,\n	comment_key,\n	creation_date,\n	creation_ip,\n	creation_user,\n	currency_iso,\n	day,\n	member_id,\n	end_date,\n	group_id,\n	invoice_id,\n	jurisdiction_id,\n	last_modified,\n	member_zipfleet_id,\n	parameters,\n	processed_p,\n	quantity,\n	reservation_id,\n	revenue_p,\n	rewarded_p,\n	source_id,\n	source_type,\n	start_date,\n	transaction_type,\n	transaction_zipfleet_id,\n	unit_amount,\n	voided_by,\n	voids_transaction_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_transaction\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".transactions";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Transactions ProcessStaging_TransactionsClass = new ProcessStaging_Transactions();

        int exitCode = ProcessStaging_TransactionsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Transactions.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_transactions_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Transactions");
        }
...
/************************************************************************************************
 *     137292 characters generated by Talend Open Studio for Data Integration 
