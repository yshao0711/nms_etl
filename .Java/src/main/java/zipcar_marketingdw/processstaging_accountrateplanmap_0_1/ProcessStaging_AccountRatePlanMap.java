...
package zipcar_marketingdw.processstaging_accountrateplanmap_0_1;
...
/**
 * Job: ProcessStaging_AccountRatePlanMap Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_AccountRatePlanMap implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_AccountRatePlanMap";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_u_oOYNNqEeaiUa65Mpdokg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_AccountRatePlanMap.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_AccountRatePlanMap.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_AccountRatePlanMap) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "account_rate_plan_map";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_account_rate_plan_map";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_account_rate_plan_map \n(\naccount_id,\nstart_date,\nstart_date_tz,\nend_date,\nend_date_tz,\nrate_plan_id,\ncreation_date,\nlast_modified,\ndeleted_date,\nimported_date\n)\nSELECT\n    account_id,\n    start_date,\n    start_date_tz,\n    end_date,\n    end_date_tz,\n    rate_plan_id,\n    creation_date,\n    last_modified,\n    deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.account_rate_plan_map\nMINUS\nSELECT\n    account_id,\n    start_date,\n    start_date_tz,\n    end_date,\n    end_date_tz,\n    rate_plan_id,\n    creation_date,\n    last_modified,\n    deleted_date, \n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM  {{marketing.schema}}.vw_r_account_rate_plan_map\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".account_rate_plan_map";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_AccountRatePlanMap ProcessStaging_AccountRatePlanMapClass = new ProcessStaging_AccountRatePlanMap();

        int exitCode = ProcessStaging_AccountRatePlanMapClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_AccountRatePlanMap.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_accountrateplanmap_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_AccountRatePlanMap");
        }
...
/************************************************************************************************
 *     136175 characters generated by Talend Open Studio for Data Integration 
