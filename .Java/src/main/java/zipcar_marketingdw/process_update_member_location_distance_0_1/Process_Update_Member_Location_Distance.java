...
package zipcar_marketingdw.process_update_member_location_distance_0_1;
...
/**
 * Job: Process_Update_Member_Location_Distance Purpose: Updates the member location distance cache<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Process_Update_Member_Location_Distance implements TalendJob {
...
public Boolean getClearStagingTable(){
	...
	private final String jobName = "Process_Update_Member_Location_Distance";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("___AmQFa0EeeQ1qlL72Siww", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Process_Update_Member_Location_Distance.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Process_Update_Member_Location_Distance.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Member_Location_Distance) {
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Update Member Location Distance Completed","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Update Member Location Distance Completed", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Update Member Location Distance Completed"); 
...
Logging.componentName(jobName, "tWarn_2", "Log_ResetMemberLocationDistanceTable");
Logging.componentName(jobName, "tWarn_3", "Log_ResetMemberLocationDistanceTable");
...
"\nDELETE FROM {{marketing.schema}}.a_reservation_to_location_distance\nWHERE start_date >= {{runDate}}\n",
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.update_existingmemberlocationdistance_0_1.Update_ExistingMemberLocationDistance childJob_tRunJob_3 = new zipcar_marketingdw.update_existingmemberlocationdistance_0_1.Update_ExistingMemberLocationDistance();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.insert_newmemberlocationdistance_0_1.Insert_NewMemberLocationDistance childJob_tRunJob_1 = new zipcar_marketingdw.insert_newmemberlocationdistance_0_1.Insert_NewMemberLocationDistance();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Process_Update_Member_Location_Distance Process_Update_Member_Location_DistanceClass = new Process_Update_Member_Location_Distance();

        int exitCode = Process_Update_Member_Location_DistanceClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Process_Update_Member_Location_Distance.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/process_update_member_location_distance_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Process_Update_Member_Location_Distance");
        }
...
/************************************************************************************************
 *     136550 characters generated by Talend Open Studio for Data Integration 
