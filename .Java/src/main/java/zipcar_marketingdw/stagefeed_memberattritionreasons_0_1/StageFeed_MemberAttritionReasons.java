...
package zipcar_marketingdw.stagefeed_memberattritionreasons_0_1;
...
/**
 * Job: StageFeed_MemberAttritionReasons Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_MemberAttritionReasons implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_MemberAttritionReasons";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_4SQC8MpEEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_MemberAttritionReasons.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_MemberAttritionReasons.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.MEMBER_ATTRITION_REASONS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.MEMBER_ATTRITION_REASONS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.MEMBER_ATTRITION_REASONS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons = new byte[0];
			    ...
			    public java.util.Date LEFT_DATE;
			    ...
			    public java.util.Date LAST_COMMENT_DATE;

				public java.util.Date getLAST_COMMENT_DATE () {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberAttritionReasons) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.LEFT_DATE = readDate(dis);
					
					this.QUIT_REASON = readString(dis);
					
					this.TRANSACTION_REASON = readString(dis);
					
					this.CREATION_DATE = readDate(dis);
					
					this.DELETED_DATE = readDate(dis);
					
					this.LAST_COMMENT_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.LEFT_DATE,dos);
					
					// String
				
						writeString(this.QUIT_REASON,dos);
					
					// String
				
						writeString(this.TRANSACTION_REASON,dos);
					...
					// java.util.Date
						...
						writeDate(this.LAST_COMMENT_DATE,dos);
    ...
    public String toString() {
		...
		sb.append(",LEFT_DATE="+String.valueOf(LEFT_DATE));
		sb.append(",QUIT_REASON="+QUIT_REASON);
		sb.append(",TRANSACTION_REASON="+TRANSACTION_REASON);
		sb.append(",CREATION_DATE="+String.valueOf(CREATION_DATE));
		sb.append(",DELETED_DATE="+String.valueOf(DELETED_DATE));
		sb.append(",LAST_COMMENT_DATE="+String.valueOf(LAST_COMMENT_DATE));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						...
						java.util.Date LEFT_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c2(java.util.Date LEFT_DATE){
							this.LEFT_DATE = LEFT_DATE;
							return this;
						}				
						String QUIT_REASON;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String QUIT_REASON){
							this.QUIT_REASON = QUIT_REASON;
							return this;
						}				
						String TRANSACTION_REASON;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String TRANSACTION_REASON){
							this.TRANSACTION_REASON = TRANSACTION_REASON;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(java.util.Date CREATION_DATE){
						...
						java.util.Date LAST_COMMENT_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(java.util.Date LAST_COMMENT_DATE){
							this.LAST_COMMENT_DATE = LAST_COMMENT_DATE;
							return this;
						}				
						String SOURCE;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String SOURCE){
							this.SOURCE = SOURCE;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"ACTIVE_P\",\"LEFT_DATE\",\"QUIT_REASON\",\"TRANSACTION_REASON\",\"CREATION_DATE\",\"DELETED_DATE\",\"LAST_COMMENT_DATE\",\"SOURCE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.LEFT_DATE = null;
					
							Row_FeedRecord.QUIT_REASON = null;
					
							Row_FeedRecord.TRANSACTION_REASON = null;
					
							Row_FeedRecord.CREATION_DATE = null;
					
							Row_FeedRecord.DELETED_DATE = null;
					
							Row_FeedRecord.LAST_COMMENT_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.LEFT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.QUIT_REASON = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.TRANSACTION_REASON = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.LAST_COMMENT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
...
Record_OutputToDB.LEFT_DATE = Row_FeedRecord.LEFT_DATE;
Record_OutputToDB.QUIT_REASON = StringUtils.trimToNull(Row_FeedRecord.QUIT_REASON);
Record_OutputToDB.TRANSACTION_REASON = StringUtils.trimToNull(Row_FeedRecord.TRANSACTION_REASON);
Record_OutputToDB.CREATION_DATE = Row_FeedRecord.CREATION_DATE;
Record_OutputToDB.DELETED_DATE = Row_FeedRecord.DELETED_DATE;
Record_OutputToDB.LAST_COMMENT_DATE = Row_FeedRecord.LAST_COMMENT_DATE;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.QUIT_REASON==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.QUIT_REASON);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TRANSACTION_REASON==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.TRANSACTION_REASON);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_COMMENT_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.LAST_COMMENT_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c2(Record_OutputToDB.LEFT_DATE)
                        .c3(Record_OutputToDB.QUIT_REASON)
                        .c4(Record_OutputToDB.TRANSACTION_REASON)
                        .c5(Record_OutputToDB.CREATION_DATE)
                        .c6(Record_OutputToDB.DELETED_DATE)
                        .c7(Record_OutputToDB.LAST_COMMENT_DATE)
                        .c8(Record_OutputToDB.SOURCE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.LEFT_DATE = Record_OutputToDB.LEFT_DATE;
                                After_Insert.QUIT_REASON = Record_OutputToDB.QUIT_REASON;
                                After_Insert.TRANSACTION_REASON = Record_OutputToDB.TRANSACTION_REASON;
                                After_Insert.CREATION_DATE = Record_OutputToDB.CREATION_DATE;
                                After_Insert.DELETED_DATE = Record_OutputToDB.DELETED_DATE;
                                After_Insert.LAST_COMMENT_DATE = Record_OutputToDB.LAST_COMMENT_DATE;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.LEFT_DATE = After_Insert.LEFT_DATE;
               Log_Rows.QUIT_REASON = After_Insert.QUIT_REASON;
               Log_Rows.TRANSACTION_REASON = After_Insert.TRANSACTION_REASON;
               Log_Rows.CREATION_DATE = After_Insert.CREATION_DATE;
               Log_Rows.DELETED_DATE = After_Insert.DELETED_DATE;
               Log_Rows.LAST_COMMENT_DATE = After_Insert.LAST_COMMENT_DATE;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"ACTIVE_P\",\"LEFT_DATE\",\"QUIT_REASON\",\"TRANSACTION_REASON\",\"CREATION_DATE\",\"DELETED_DATE\",\"LAST_COMMENT_DATE\",\"SOURCE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.LEFT_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.LEFT_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.QUIT_REASON==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.QUIT_REASON);
					...
					if(bufferLtRedshiftOutput_1.TRANSACTION_REASON==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TRANSACTION_REASON);
					...
					if(bufferLtRedshiftOutput_1.LAST_COMMENT_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.LAST_COMMENT_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.QUIT_REASON = null;
					
							row1.TRANSACTION_REASON = null;
					
							row1.CREATION_DATE = null;
					
							row1.DELETED_DATE = null;
					
							row1.LAST_COMMENT_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.LEFT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.QUIT_REASON = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.TRANSACTION_REASON = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.LAST_COMMENT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
...
row2.LEFT_DATE = row1.LEFT_DATE;
row2.QUIT_REASON = StringUtils.trimToNull(row1.QUIT_REASON);
row2.TRANSACTION_REASON = StringUtils.trimToNull(row1.TRANSACTION_REASON);
row2.CREATION_DATE = row1.CREATION_DATE;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.LAST_COMMENT_DATE = row1.LAST_COMMENT_DATE;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[9];
                            ...
                            rowtFileOutputDelimited_1[2]=row2.LEFT_DATE == null ? null : FormatterUtils.format_Date(row2.LEFT_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[3]=row2.QUIT_REASON == null ? null : row2.QUIT_REASON;
                            rowtFileOutputDelimited_1[4]=row2.TRANSACTION_REASON == null ? null : row2.TRANSACTION_REASON;
                            rowtFileOutputDelimited_1[5]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            ...
                            rowtFileOutputDelimited_1[7]=row2.LAST_COMMENT_DATE == null ? null : FormatterUtils.format_Date(row2.LAST_COMMENT_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[8]=row2.SOURCE == null ? null : row2.SOURCE;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_MemberAttritionReasons StageFeed_MemberAttritionReasonsClass = new StageFeed_MemberAttritionReasons();

        int exitCode = StageFeed_MemberAttritionReasonsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_MemberAttritionReasons.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_memberattritionreasons_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_MemberAttritionReasons");
        }
...
/************************************************************************************************
 *     322575 characters generated by Talend Open Studio for Data Integration 
