...
package zipcar_marketingdw.post_process_subjobs_0_1;
...
/**
 * Job: Post_Process_Subjobs Purpose: <br>
 * Description: Post processing sub jobs after daily and weekly <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Post_Process_Subjobs implements TalendJob {
...
public String getRedshift_Monitoring_Server(){
	...
	private final String jobName = "Post_Process_Subjobs";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_NBTvQDQtEeiVM7NT3xJ87g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Post_Process_Subjobs.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Post_Process_Subjobs.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.update_membersummarytable_0_1.Update_MemberSummaryTable childJob_tRunJob_3 = new zipcar_marketingdw.update_membersummarytable_0_1.Update_MemberSummaryTable();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param isSubJob=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param isSubJob=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("isSubJob", obj_tRunJob_4);
	
	
		zipcar_marketingdw.process_daily_campaign_report_data_0_1.Process_Daily_Campaign_Report_Data childJob_tRunJob_4 = new zipcar_marketingdw.process_daily_campaign_report_data_0_1.Process_Daily_Campaign_Report_Data();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = context.Redshift_Marketing_Schema;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param SchemaName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param SchemaName=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("SchemaName", obj_tRunJob_2);
	
	
		zipcar_marketingdw.task_optimizeschema_0_1.Task_OptimizeSchema childJob_tRunJob_2 = new zipcar_marketingdw.task_optimizeschema_0_1.Task_OptimizeSchema();
	    // pass DataSources
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Post_Process_Subjobs = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Post_Process_Subjobs = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Post_Process_Subjobs.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Post_Process_Subjobs.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Post_Process_Subjobs = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Post_Process_Subjobs = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Post_Process_Subjobs, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Post_Process_Subjobs, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Post_Process_Subjobs) {
 ...
 */
    ...
    public static void main(String[] args){
        final Post_Process_Subjobs Post_Process_SubjobsClass = new Post_Process_Subjobs();

        int exitCode = Post_Process_SubjobsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Post_Process_Subjobs.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/post_process_subjobs_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Post_Process_Subjobs");
        }
...
/************************************************************************************************
 *     108156 characters generated by Talend Open Studio for Data Integration 
