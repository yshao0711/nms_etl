...
package zipcar_marketingdw.processstaging_corporateapplications_0_1;
...
/**
 * Job: ProcessStaging_CorporateApplications Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_CorporateApplications implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_CorporateApplications";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_TrHxoBfuEeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_CorporateApplications.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_CorporateApplications.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_CorporateApplications) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "corporate_applications";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_corporate_application";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_corporate_application\n(\n	corporate_application_id,\n	member_id,\n	zipfleet_id,\n	state,\n	address_id,\n	coupon_code,\n	rate_plan_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n    imported_date\n)\nSELECT \n	corporate_application_id,\n	user_id as member_id,\n	zipfleet_id,\n	state,\n	address_id,\n	coupon_code,\n	rate_plan_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.corporate_applications\nMINUS\nSELECT \n	corporate_application_id,\n	member_id,\n	zipfleet_id,\n	state,\n	address_id,\n	coupon_code,\n	rate_plan_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_corporate_application\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".corporate_applications";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_CorporateApplications ProcessStaging_CorporateApplicationsClass = new ProcessStaging_CorporateApplications();

        int exitCode = ProcessStaging_CorporateApplicationsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_CorporateApplications.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_corporateapplications_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_CorporateApplications");
        }
...
/************************************************************************************************
 *     136306 characters generated by Talend Open Studio for Data Integration 
