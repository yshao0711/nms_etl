...
package zipcar_marketingdw.task_checkjobrunning_0_1;
...
/**
 * Job: Task_CheckJobRunning Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Task_CheckJobRunning implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(currentRunningJob != null){
					...
					this.setProperty("currentRunningJob", currentRunningJob.toString());
				
			}
			
		}

public String currentRunningJob;
public String getCurrentRunningJob(){
	...
	private final String jobName = "Task_CheckJobRunning";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Task_CheckJobRunning.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Task_CheckJobRunning.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "ps aux" ,env_tSystem_1);
...
//System.out.println(globalMap.get("tSystem_1_OUTPUT"));
int count = StringHandling.COUNT((String)globalMap.get("tSystem_1_OUTPUT"), context.currentRunningJob);
if(count > 1) {
	org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger("Task_CheckJobRunning");
	logger.warn("The same job is running and not finished yet.");
	System.exit(4);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Task_CheckJobRunning Task_CheckJobRunningClass = new Task_CheckJobRunning();

        int exitCode = Task_CheckJobRunningClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Task_CheckJobRunning.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/task_checkjobrunning_0_1/contexts/"+contextStr+".properties");
            ...
            if(!context_param.isEmpty()) {
				...
				for (Object key: context_param.keySet()){
				    ...
				    context.setContextType("currentRunningJob", "id_String");
				
                context.currentRunningJob=(String) context.getProperty("currentRunningJob");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("currentRunningJob")) {
                context.currentRunningJob = (String) parentContextMap.get("currentRunningJob");
            }
        }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Task_CheckJobRunning");
        }
...
/************************************************************************************************
 *     28177 characters generated by Talend Open Studio for Data Integration 
