...
package zipcar_marketingdw.stagefeed_strongviewprogramfiles_0_1;
...
/**
 * Job: StageFeed_StrongviewProgramFiles Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewProgramFiles implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewProgramFiles";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_A2StQMsZEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewProgramFiles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewProgramFiles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_PROGRAM_FILES.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_PROGRAM_FILES.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_PROGRAM_FILES;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgramFiles) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DIRECTORY_NAME = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DIRECTORY_NAME,dos);
    ...
    public String toString() {
		...
		sb.append(",DIRECTORY_NAME="+DIRECTORY_NAME);
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c11(String CONTINENT){
							this.CONTINENT = CONTINENT;
							return this;
						}				
						String DIRECTORY_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String DIRECTORY_NAME){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"FILEID\",\"FILENAME\",\"FILE_CREATION_DT\",\"COLLECTDATE\",\"LOADED_P\",\"LOADDATE\",\"ERROR\",\"ERRORCOUNT\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"CONTINENT\",\"DIRECTORY_NAME\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.CONTINENT = null;
					
							Row_FeedRecord.DIRECTORY_NAME = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.CONTINENT = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DIRECTORY_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.CONTINENT = StringUtils.trimToNull(Row_FeedRecord.CONTINENT);
Record_OutputToDB.DIRECTORY_NAME = StringUtils.trimToNull(Row_FeedRecord.DIRECTORY_NAME);
    nb_line_tJavaRow_3++;   
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(Record_OutputToDB.FILEID==null){
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CONTINENT==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.CONTINENT);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DIRECTORY_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DIRECTORY_NAME);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c11(Record_OutputToDB.CONTINENT)
                        .c12(Record_OutputToDB.DIRECTORY_NAME)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.CONTINENT = Record_OutputToDB.CONTINENT;
                                After_Insert.DIRECTORY_NAME = Record_OutputToDB.DIRECTORY_NAME;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.CONTINENT = After_Insert.CONTINENT;
               Log_Rows.DIRECTORY_NAME = After_Insert.DIRECTORY_NAME;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"FILEID\",\"FILENAME\",\"FILE_CREATION_DT\",\"COLLECTDATE\",\"LOADED_P\",\"LOADDATE\",\"ERROR\",\"ERRORCOUNT\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"CONTINENT\",\"DIRECTORY_NAME\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					if(bufferLtRedshiftOutput_1.FILEID==null){
					...
					if(bufferLtRedshiftOutput_1.CONTINENT==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CONTINENT);
					...
					if(bufferLtRedshiftOutput_1.DIRECTORY_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DIRECTORY_NAME);
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.CONTINENT = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DIRECTORY_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.CONTINENT = StringUtils.trimToNull(row1.CONTINENT);
row2.DIRECTORY_NAME = StringUtils.trimToNull(row1.DIRECTORY_NAME);
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[13];
                            rowtFileOutputDelimited_1[0]=row2.FILEID == null ? null : String.valueOf(row2.FILEID);
                            ...
                            rowtFileOutputDelimited_1[11]=row2.CONTINENT == null ? null : row2.CONTINENT;
                            rowtFileOutputDelimited_1[12]=row2.DIRECTORY_NAME == null ? null : row2.DIRECTORY_NAME;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewProgramFiles StageFeed_StrongviewProgramFilesClass = new StageFeed_StrongviewProgramFiles();

        int exitCode = StageFeed_StrongviewProgramFilesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewProgramFiles.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewprogramfiles_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewProgramFiles");
        }
...
/************************************************************************************************
 *     346867 characters generated by Talend Open Studio for Data Integration 
