...
package zipcar_marketingdw.task_optimizeschema_0_1;
...
/**
 * Job: Task_OptimizeSchema Purpose: Optimize schema tables<br>
 * Description: Optimizes the tables in a schema using vacuum and analyze on all tables in the schema that require optimization. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Task_OptimizeSchema implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(SchemaName != null){
					...
					this.setProperty("SchemaName", SchemaName.toString());
			...
			if(minPctUnsorted != null){
				
					this.setProperty("minPctUnsorted", minPctUnsorted.toString());
				
			}
			
			if(minPctStats != null){
				
					this.setProperty("minPctStats", minPctStats.toString());
...
public Float minPctUnsorted;
public Float getMinPctUnsorted(){
	return this.minPctUnsorted;
}
public Float minPctStats;
public Float getMinPctStats(){
	return this.minPctStats;
}
...
public java.lang.String getRedshift_Monitoring_Password(){
	...
	private final String jobName = "Task_OptimizeSchema";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_YRx0ECtnEeePv-qeJ0cJcA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Task_OptimizeSchema.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Task_OptimizeSchema.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_OptimizeSchema) {
...
public static class optimized_tableStruct implements routines.system.IPersistableRow<optimized_tableStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(optimized_tableStruct other) {
...
public static class table_toOptimizeStruct implements routines.system.IPersistableRow<table_toOptimizeStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(table_toOptimizeStruct other) {
...
public static class tableNameStruct implements routines.system.IPersistableRow<tableNameStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_OptimizeSchema = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(tableNameStruct other) {
...
public void tRedshiftInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		tableNameStruct tableName = new tableNameStruct();
tableNameStruct table_toOptimize = tableName;
optimized_tableStruct optimized_table = new optimized_tableStruct();
	...
	currentComponent="tWarn_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("optimized_table" + iterateId, 0, 0);
	...
	currentComponent="tRedshiftRow_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("table_toOptimize" + iterateId, 0, 0);
	...
	currentComponent="tWarn_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("tableName" + iterateId, 0, 0);
...
"\nselect \n	 \"table\" as tableName  from svv_table_info\nWHERE  schema = {{schemaName}}\n	AND \n	( unsorted > {{min.unsorted}} OR stats_off > {{min.stats}});\n",
"schemaName", StringHandling.SQUOTE(context.SchemaName),
"min.unsorted", String.valueOf(context.minPctUnsorted),
"min.stats", String.valueOf(context.minPctStats)
);
		...
		try{
        	...
        	tableName.tableName = routines.system.JDBCUtil.getString(rs_tRedshiftInput_1, 1, false);
		                    }
 ...
 */
	...
	currentComponent="tWarn_1";
			...
			//tableName
				...
				if(execStat){
					runStat.updateStatOnConnection("tableName"+iterateId,1, 1);
				} 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Table Requires Vacuum/Analyze: " + context.SchemaName + "." + tableName.tableName,"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Table Requires Vacuum/Analyze: " + context.SchemaName + "." + tableName.tableName, 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Table Requires Vacuum/Analyze: " + context.SchemaName + "." + tableName.tableName); 
globalMap.put("tWarn_1_WARN_PRIORITY", 3);
globalMap.put("tWarn_1_WARN_CODE", 42);


 
     table_toOptimize = tableName;
 ...
 */
	...
	currentComponent="tRedshiftRow_1";
			...
			//table_toOptimize
				...
				if(execStat){
					runStat.updateStatOnConnection("table_toOptimize"+iterateId,1, 1);
				} 
...
"\nvacuum {{schema.name}}.{{table.name}};\nanalyze {{schema.name}}.{{table.name}};\n",
"schema.name", StringHandling.DQUOTE(context.SchemaName),
"table.name", StringHandling.DQUOTE(table_toOptimize.tableName)
);
...
try {
	...
	if(!whetherReject_tRedshiftRow_1) {
					...
					optimized_table = new optimized_tableStruct();
					
							optimized_table.tableName = table_toOptimize.tableName;
 ...
 */
// Start of branch "optimized_table"
if(optimized_table != null) { 
	...
	currentComponent="tWarn_2";
			...
			//optimized_table
				...
				if(execStat){
					runStat.updateStatOnConnection("optimized_table"+iterateId,1, 1);
				} 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Completed Vacuum/Analyze: " + context.SchemaName + "." + tableName.tableName,"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 3, "Completed Vacuum/Analyze: " + context.SchemaName + "." + tableName.tableName, 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Completed Vacuum/Analyze: " + context.SchemaName + "." + tableName.tableName); 
 ...
 */
	...
	currentComponent="tWarn_1";
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("tableName"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	stmt_tRedshiftRow_1.close();	
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("table_toOptimize"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	currentComponent="tWarn_2";
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("optimized_table"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO","","Total Tables Optimized: " + ((Integer)globalMap.get("tRedshiftInput_1_NB_LINE")),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_3", 3, "Total Tables Optimized: " + ((Integer)globalMap.get("tRedshiftInput_1_NB_LINE")), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_3_WARN_MESSAGES", "Total Tables Optimized: " + ((Integer)globalMap.get("tRedshiftInput_1_NB_LINE"))); 
 ...
 */
    ...
    public static void main(String[] args){
        final Task_OptimizeSchema Task_OptimizeSchemaClass = new Task_OptimizeSchema();

        int exitCode = Task_OptimizeSchemaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Task_OptimizeSchema.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/task_optimizeschema_0_1/contexts/"+contextStr+".properties");
            ...
            if(!context_param.isEmpty()) {
                ...
                context.Redshift_Marketing_Schema=(String) context.getProperty("Redshift_Marketing_Schema");
				    context.setContextType("SchemaName", "id_String");
				
                context.SchemaName=(String) context.getProperty("SchemaName");
                ...
                context.Redshift_Marketing_Server=(String) context.getProperty("Redshift_Marketing_Server");
				    context.setContextType("minPctUnsorted", "id_Float");
				
             try{
                 context.minPctUnsorted=routines.system.ParserUtils.parseTo_Float (context.getProperty("minPctUnsorted"));
             }catch(NumberFormatException e){
                 context.minPctUnsorted=null;
              }
				    context.setContextType("minPctStats", "id_Float");
				
             try{
                 context.minPctStats=routines.system.ParserUtils.parseTo_Float (context.getProperty("minPctStats"));
             }catch(NumberFormatException e){
                 context.minPctStats=null;
              }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("Redshift_Marketing_AdditionalParams")) {
            ...
            }if (parentContextMap.containsKey("SchemaName")) {
                context.SchemaName = (String) parentContextMap.get("SchemaName");
            ...
            }if (parentContextMap.containsKey("minPctUnsorted")) {
                context.minPctUnsorted = (Float) parentContextMap.get("minPctUnsorted");
            }if (parentContextMap.containsKey("minPctStats")) {
                context.minPctStats = (Float) parentContextMap.get("minPctStats");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Task_OptimizeSchema");
        }
...
/************************************************************************************************
 *     123891 characters generated by Talend Open Studio for Data Integration 
