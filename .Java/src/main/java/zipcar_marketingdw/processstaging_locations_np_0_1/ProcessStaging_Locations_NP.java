...
package zipcar_marketingdw.processstaging_locations_np_0_1;
...
/**
 * Job: ProcessStaging_Locations_NP Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Locations_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Locations_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_lSZuAKpBEeia3dSup_1D_w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Locations_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Locations_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Locations_NP) {
...
"\nINSERT INTO{{marketing.schema}}.r_location_np\n(\n	location_id,\n	active_p,\n	name,\n	address,\n	booking_type,\n	description,\n	latitude,\n	longitude,\n	local_identifier,\n	parking_capacity,\n	place_id,\n	radius_meters,\n	support_email,\n	support_phone_number,\n	timezone_id,\n	version,\n	creation_time_utc,\n	modified_time_utc,\n	author_id,\n	community_id,\n	user_id,\n	legacy_location_id,\n	station_id,\n	imported_date \n)\nSELECT \n	location_id,\n	active_p,\n	name,\n	address,\n	booking_type,\n	description,\n	latitude,\n	longitude,\n	local_identifier,\n	parking_capacity,\n	place_id,\n	radius_meters,\n	support_email,\n	support_phone_number,\n	timezone_id,\n	version,\n	creation_time_utc,\n	modified_time_utc,\n	author_id,\n	community_id,\n	user_id,\n	legacy_location_id,\n	station_id,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM	{{staging.schema}}.locations_np\nMINUS\nSELECT \n	location_id,\n	active_p,\n	name,\n	address,\n	booking_type,\n	description,\n	latitude,\n	longitude,\n	local_identifier,\n	parking_capacity,\n	place_id,\n	radius_meters,\n	support_email,\n	support_phone_number,\n	timezone_id,\n	version,\n	creation_time_utc,\n	modified_time_utc,\n	author_id,\n	community_id,\n	user_id,\n	legacy_location_id,\n	station_id,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM	{{marketing.schema}}.vw_r_location_np\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".locations_np";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Locations_NP ProcessStaging_Locations_NPClass = new ProcessStaging_Locations_NP();

        int exitCode = ProcessStaging_Locations_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Locations_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_locations_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Locations_NP");
        }
...
/************************************************************************************************
 *     136560 characters generated by Talend Open Studio for Data Integration 
