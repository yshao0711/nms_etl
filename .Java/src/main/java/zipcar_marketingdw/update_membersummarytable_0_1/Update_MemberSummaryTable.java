...
package zipcar_marketingdw.update_membersummarytable_0_1;
...
/**
 * Job: Update_MemberSummaryTable Purpose: Updates the Member Summary Table<br>
 * Description: Use flat summary table s_member to improve query performance <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status DEV
 */
public class Update_MemberSummaryTable implements TalendJob {
...
public String getRedshift_Monitoring_Server(){
	...
	private final String jobName = "Update_MemberSummaryTable";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_oDeOsDQlEeiVM7NT3xJ87g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Update_MemberSummaryTable.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Update_MemberSummaryTable.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
Logging.componentName(jobName, "tWarn_3", "Summary");
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Update_MemberSummaryTable) {
...
"\n/* temp table that holds NPS data before adding it to s_member */\nDROP TABLE IF EXISTS t_nps\n;\n\nCREATE TEMP TABLE t_nps DISTSTYLE KEY DISTKEY(member_id) AS\nWITH survey_fields_of_interest AS (\n   SELECT DISTINCT surveyid_for_internal_use AS survey_id\n          , driver_id AS member_id\n          , responsedate\n          , survey_type\n          , fd_likelihood_to_recommend AS first_drive_ltr\n          , tn_likelihood_to_recommend AS trans_ltr\n          , floating_likelihood_to_recommend AS float_ltr\n     FROM {{marketing.schema}}.r_medallia_survey_data\n    WHERE survey_type IN ('First Drive', 'Transactional NPS', 'Floating')\n)\n\n/* total survey count by member_id (not counting call center surveys or Zipcar on Deck) */\n, survey_count AS (\n  SELECT member_id\n         , COUNT(DISTINCT survey_id) AS nps_survey_total\n    FROM survey_fields_of_interest\n   GROUP BY member_id\n)\n\n/* rolling 12 month window of LTR scores */\n, past_year AS (\n  SELECT *\n         , COALESCE(first_drive_ltr, trans_ltr, float_ltr) AS survey_ltr\n    FROM survey_fields_of_interest\n   WHERE responsedate > DATEADD(month, -12, CURRENT_DATE)\n)\n\n/* Ascending Ranked First Drive surveys */\n, ranked_first_drive AS (\n  SELECT member_id\n         , responsedate\n         , first_drive_ltr\n         , survey_type\n         , ROW_NUMBER() OVER (PARTITION BY member_id ORDER BY responsedate) AS rnk\n    FROM survey_fields_of_interest\n   WHERE survey_type = 'First Drive'\n)\n\n/* Descending Ranked Transactional NPS Surveys */\n, ranked_trans_survey AS (\n  SELECT member_id\n         , responsedate\n         , trans_ltr\n         , survey_type\n         , ROW_NUMBER() OVER (PARTITION BY member_id ORDER BY responsedate DESC) AS rnk\n    FROM survey_fields_of_interest\n   WHERE survey_type = 'Transactional NPS'\n)\n\n/* First Drive Survey */\n, first_drive_ltr AS (\n  SELECT member_id\n         , first_drive_ltr AS nps_first_ltr_score\n         , TO_DATE(responsedate, 'YYYY-MM-DD') AS nps_first_ltr_date\n    FROM ranked_first_drive\n   WHERE rnk = 1\n)\n\n/* latest Transactional Survey */\n, last_trans_survey AS (\n  SELECT member_id\n         , trans_ltr AS nps_last_ltr_score\n         , TO_DATE(responsedate, 'YYYY-MM-DD') AS nps_last_ltr_date\n    FROM ranked_trans_survey\n   WHERE rnk = 1\n)\n\n/* Rolling 12 month average LTR from all surveys */\n, ltr_average AS (\n  SELECT member_id\n         , TRUNC(AVG(survey_ltr)) AS rolling_avg_ltr\n         , COUNT(DISTINCT survey_id) AS rolling_survey_count\n    FROM past_year\n   GROUP BY member_id\n)\n\n/* NPS Cohort based on rolling 12 month window */\n, nps_cohort AS (\n  SELECT member_id\n         , rolling_avg_ltr\n         , rolling_survey_count AS nps_survey_count\n         , CASE\n           WHEN rolling_avg_ltr BETWEEN 9 AND 10 THEN 'promoter'\n           WHEN rolling_avg_ltr BETWEEN 7 AND 8 THEN 'passive'\n           WHEN rolling_avg_ltr < 7 THEN 'detractor'\n           END AS nps_average_cohort\n    FROM ltr_average\n)\n\nSELECT a.member_id\n       , b.nps_first_ltr_score\n       , b.nps_first_ltr_date\n       , c.nps_last_ltr_score\n       , c.nps_last_ltr_date\n       , d.nps_average_cohort\n       , d.nps_survey_count\n       , a.nps_survey_total\n  FROM survey_count AS a\n       LEFT JOIN first_drive_ltr AS b\n       ON a.member_id = b.member_id\n\n       LEFT JOIN last_trans_survey AS c\n       ON a.member_id = c.member_id\n\n       LEFT JOIN nps_cohort AS d\n       ON a.member_id = d.member_id\n;\n",
...
"\nTRUNCATE {{marketing.schema}}.s_member;\n\nINSERT INTO {{marketing.schema}}.s_member\nSELECT\n   dm.person_id,\n   dm.member_id,\n   dm.is_active,\n   dm.is_member,\n   dm.name_first,\n   dm.name_last,\n   dm.phone_main,\n   iso.calling_code,\n   dm.is_mobile_phone,\n   dm.is_textable,\n   dm.email,\n   dm.is_emailable,\n   dm.birthdate,\n   {{marketing.schema}}.f_get_age(dm.end_date, dm.birthdate) as age,\n   dm.is_multi_account,\n   dm.is_employee,\n   dm.is_admin,\n   dm.is_driver,\n   dm.has_service_account,\n   dm.has_nonservice_account,\n   dm.first_active_date,\n   dm.first_active_channel,\n   dm.join_zipfleet_id,\n   dm.join_country,\n   dm.current_zipfleet_id,\n   dm.current_country,\n   ct.name as current_country_name,\n   ct.currency_iso as current_currency,\n   NVL(crd.current_credit, 0) as current_credit,\n   mem_act.metro_id,\n   mem_act.primary_affiliate_id,\n   mem_act.primary_account_id,\n   mem_act.primary_rate_plan_id,\n   mem_act.primary_plan_category,\n   mem_act.primary_segment_class,\n   mem_act.has_segment_consumer,\n   mem_act.has_segment_business,\n   mem_act.has_segment_collegiate,\n   lm.metro_name,\n   metro_region.region,\n   zf.level_5_key as market,\n   mem_act.tenure_category,\n   mem_rfm.end_date as profile_date,\n   mem_rfm.profile as rfm_profile,\n   mem_location_segment.segment as location_segment,\n   first_res.reservation_id as first_reservation_id,\n   first_res.is_new_platform as is_first_reservation_np,\n   last_res.reservation_id as last_reservation_id,\n   last_res.is_new_platform as is_last_reservation_np,\n   next_res.reservation_id as next_reservation_id,\n   next_res.is_new_platform as is_next_reservation_np,\n   rp.segment_class as join_segment,\n   mji.join_rate_plan_id,\n   mli.last_left_date,\n   rm.first_join_date,\n   COALESCE(rm.rejoin_date, rm.first_join_date) as last_join_date,\n   nps.nps_first_ltr_score,\n   nps.nps_first_ltr_date,\n   nps.nps_last_ltr_score,\n   nps.nps_last_ltr_date,\n   nps.nps_average_cohort,\n   nps.nps_survey_count,\n   nps.nps_survey_total\nFROM {{marketing.schema}}.d_member dm\nJOIN {{marketing.schema}}.vw_r_member rm\n	ON dm.member_id = rm.member_id\nLEFT JOIN (\n	SELECT\n      t1.person_id,\n      t1.metro_id,\n      t1.tenure_category,\n      t1.primary_affiliate_id,\n      t1.primary_account_id,\n      t1.primary_rate_plan_id,\n      t1.primary_plan_category,\n      t1.primary_segment_class,\n      t1.has_segment_consumer,\n      t1.has_segment_business,\n      t1.has_segment_collegiate\n	FROM {{marketing.schema}}.s_member_activity t1\n	LEFT JOIN {{marketing.schema}}.s_member_activity t2 ON\n		t1.person_id = t2.person_id\n		AND t1.end_date < t2.end_date\n	WHERE\n		t2.end_date IS NULL\n) mem_act ON dm.person_id = mem_act.person_id\nLEFT JOIN (\n	SELECT\n		t1.person_id,\n		t1.profile,\n		t1.end_date\n	FROM {{marketing.schema}}.s_rfm t1\n	LEFT JOIN {{marketing.schema}}.s_rfm t2 ON\n		t1.person_id = t2.person_id\n		AND t1.end_date < t2.end_date\n	WHERE\n		t2.end_date IS NULL\n) mem_rfm ON dm.person_id = mem_rfm.person_id\nLEFT JOIN {{marketing.schema}}.l_metro lm ON\n	mem_act.metro_id = lm.metro_id\n	AND lm.end_date='3199-12-31'\nLEFT JOIN {{marketing.schema}}.vw_r_zipfleet zf ON\n	dm.current_zipfleet_id = zf.zipfleet_id\nLEFT JOIN (\n	SELECT member_id, reservation_id, is_new_platform FROM\n	(\n		SELECT\n			res.member_id,\n			res.reservation_id,\n			res.is_new_platform,\n			row_number() over (partition by res.member_id order by res.start_date asc) as row_num\n			FROM {{marketing.schema}}.s_reservation res\n		WHERE\n			res.start_date < CURRENT_DATE\n			AND (res.cancel_date is null)\n         AND res.nobill_p = 'f'\n	)\n	WHERE\n		row_num = 1\n) first_res ON dm.member_id=first_res.member_id\nLEFT JOIN (\n	SELECT member_id, reservation_id, is_new_platform FROM\n	(\n		SELECT\n			res.member_id,\n			res.reservation_id,\n			res.is_new_platform,\n			row_number() over (partition by res.member_id order by res.start_date desc) as row_num\n			FROM {{marketing.schema}}.s_reservation res\n		WHERE\n			res.start_date < CURRENT_DATE\n			AND (res.cancel_date is null)\n         AND res.nobill_p = 'f'\n	)\n	WHERE\n		row_num = 1\n) last_res ON dm.member_id=last_res.member_id\nLEFT JOIN (\n	SELECT member_id, reservation_id, is_new_platform FROM\n	(\n		SELECT\n			res.member_id,\n			res.reservation_id,\n			res.is_new_platform,\n			row_number() over (partition by res.member_id order by res.start_date asc) as row_num\n			FROM {{marketing.schema}}.s_reservation res\n		WHERE\n			res.start_date >= CURRENT_DATE\n			AND (res.cancel_date is null)\n         AND res.nobill_p = 'f'\n	)\n	WHERE\n		row_num = 1\n) next_res ON dm.member_id=next_res.member_id\nLEFT JOIN {{marketing.schema}}.l_iso_country ct ON\n	ct.country_id = dm.current_country\nLEFT JOIN {{marketing.schema}}.vw_member_total_credit crd ON\n	crd.member_id = dm.member_id\n	AND crd.currency_iso = ct.currency_iso\nLEFT JOIN (\n	SELECT\n		t1.person_id,\n		t1.segment\n	FROM {{marketing.schema}}.s_member_location_segment t1\n	LEFT JOIN {{marketing.schema}}.s_member_location_segment t2 ON\n		t1.person_id = t2.person_id\n		AND t1.end_date < t2.end_date\n	WHERE\n		t2.end_date IS NULL\n) mem_location_segment ON dm.person_id = mem_location_segment.person_id\nLEFT JOIN {{marketing.schema}}.l_iso_country iso\nON dm.current_country = iso.country_id\nLEFT JOIN (\n	SELECT lm.metro_id, listagg(region_name, ', ') WITHIN GROUP (ORDER BY region_name) AS region\n	FROM {{marketing.schema}}.l_region lr\n	JOIN {{marketing.schema}}.l_metro lm\n	ON lr.metro_id = lm.metro_id\n	GROUP BY lm.metro_id\n) metro_region ON lm.metro_id = metro_region.metro_id\nLEFT JOIN {{marketing.schema}}.vw_r_member_join_info mji\nON dm.member_id = mji.member_id\nLEFT JOIN {{marketing.schema}}.vw_r_rate_plan rp\nON mji.join_rate_plan_id = rp.rate_plan_id\nLEFT JOIN {{marketing.schema}}.vw_r_member_left_info mli\nON dm.member_id = mli.member_id\nLEFT JOIN t_nps AS nps\nON nps.member_id = dm.member_id\nWHERE\n	dm.end_date='3199-12-31'\n;\n\nANALYZE {{marketing.schema}}.s_member;\n",
"marketing.schema", context.Redshift_Marketing_Schema
);
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO","","Member summary table: s_member updated","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_3", 3, "Member summary table: s_member updated", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_3_WARN_MESSAGES", "Member summary table: s_member updated"); 
 ...
 */
    ...
    public static void main(String[] args){
        final Update_MemberSummaryTable Update_MemberSummaryTableClass = new Update_MemberSummaryTable();

        int exitCode = Update_MemberSummaryTableClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Update_MemberSummaryTable.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/update_membersummarytable_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Update_MemberSummaryTable");
        }
...
/************************************************************************************************
 *     118509 characters generated by Talend Open Studio for Data Integration 
