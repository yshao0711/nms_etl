...
package zipcar_marketingdw.stagefeed_accounts_0_1;
...
/**
 * Job: StageFeed_Accounts Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Accounts implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Accounts";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_ESVyYDQ0Eee0Yqo4GlYExQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Accounts.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Accounts.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Accounts = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Accounts = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Accounts.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Accounts.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Accounts = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Accounts = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Accounts, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Accounts, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Accounts) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.ACCOUNTS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.ACCOUNTS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.ACCOUNTS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public java.util.Date LOCAL_NEXT_FEE_DATE;

				public java.util.Date getLOCAL_NEXT_FEE_DATE () {
					return this.LOCAL_NEXT_FEE_DATE;
				}
				
			    public Long SETTLEMENT_DOM;

				public Long getSETTLEMENT_DOM () {
					return this.SETTLEMENT_DOM;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.ACCOUNT_ID == null) ? 0 : this.ACCOUNT_ID.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final Log_RowsStruct other = (Log_RowsStruct) obj;
						...
						} else if (!this.ACCOUNT_ID.equals(other.ACCOUNT_ID))
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.ACCOUNT_ID = this.ACCOUNT_ID;
	            ...
	            other.FIRST_ACCOUNT_ADMIN_ID = this.FIRST_ACCOUNT_ADMIN_ID;
	            other.PRIMARY_BILLING_ADDRESS_ID = this.PRIMARY_BILLING_ADDRESS_ID;
	            other.SERVICE_ACCOUNT_P = this.SERVICE_ACCOUNT_P;
	            other.ZIPFLEET_ID = this.ZIPFLEET_ID;
	            other.ACCOUNT_NAME = this.ACCOUNT_NAME;
	            other.LOCAL_NEXT_FEE_DATE = this.LOCAL_NEXT_FEE_DATE;
	            other.SETTLEMENT_DOM = this.SETTLEMENT_DOM;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Accounts) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.LOCAL_NEXT_FEE_DATE = readDate(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SETTLEMENT_DOM = null;
           				} else {
           			    	this.SETTLEMENT_DOM = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.LOCAL_NEXT_FEE_DATE,dos);
					
					// Long
				
						if(this.SETTLEMENT_DOM == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.SETTLEMENT_DOM);
		            	}
    ...
    public String toString() {
		...
		sb.append(",LOCAL_NEXT_FEE_DATE="+String.valueOf(LOCAL_NEXT_FEE_DATE));
		sb.append(",SETTLEMENT_DOM="+String.valueOf(SETTLEMENT_DOM));
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(Long ACCOUNT_ID){
							this.ACCOUNT_ID = ACCOUNT_ID;
							return this;
						}				
						String ACCOUNT_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String ACCOUNT_TYPE){
							this.ACCOUNT_TYPE = ACCOUNT_TYPE;
							return this;
						}				
						Long FIRST_ACCOUNT_ADMIN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Long FIRST_ACCOUNT_ADMIN_ID){
							this.FIRST_ACCOUNT_ADMIN_ID = FIRST_ACCOUNT_ADMIN_ID;
							return this;
						}				
						Long PRIMARY_BILLING_ADDRESS_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Long PRIMARY_BILLING_ADDRESS_ID){
							this.PRIMARY_BILLING_ADDRESS_ID = PRIMARY_BILLING_ADDRESS_ID;
							return this;
						}				
						String SERVICE_ACCOUNT_P;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String SERVICE_ACCOUNT_P){
							this.SERVICE_ACCOUNT_P = SERVICE_ACCOUNT_P;
							return this;
						}				
						Long ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c5(Long ZIPFLEET_ID){
							this.ZIPFLEET_ID = ZIPFLEET_ID;
							return this;
						}				
						String ACCOUNT_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String ACCOUNT_NAME){
							this.ACCOUNT_NAME = ACCOUNT_NAME;
							return this;
						}				
						java.util.Date LOCAL_NEXT_FEE_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(java.util.Date LOCAL_NEXT_FEE_DATE){
							this.LOCAL_NEXT_FEE_DATE = LOCAL_NEXT_FEE_DATE;
							return this;
						}				
						Long SETTLEMENT_DOM;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Long SETTLEMENT_DOM){
							this.SETTLEMENT_DOM = SETTLEMENT_DOM;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ACCOUNT_ID\",\"ACCOUNT_TYPE\",\"FIRST_ACCOUNT_ADMIN_ID\",\"PRIMARY_BILLING_ADDRESS_ID\",\"SERVICE_ACCOUNT_P\",\"ZIPFLEET_ID\",\"ACCOUNT_NAME\",\"LOCAL_NEXT_FEE_DATE\",\"SETTLEMENT_DOM\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.ACCOUNT_TYPE = null;
					
							Row_FeedRecord.FIRST_ACCOUNT_ADMIN_ID = null;
					
							Row_FeedRecord.PRIMARY_BILLING_ADDRESS_ID = null;
					
							Row_FeedRecord.SERVICE_ACCOUNT_P = null;
					
							Row_FeedRecord.ZIPFLEET_ID = null;
					
							Row_FeedRecord.ACCOUNT_NAME = null;
					
							Row_FeedRecord.LOCAL_NEXT_FEE_DATE = null;
					
							Row_FeedRecord.SETTLEMENT_DOM = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ACCOUNT_TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.FIRST_ACCOUNT_ADMIN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.PRIMARY_BILLING_ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SERVICE_ACCOUNT_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ACCOUNT_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.LOCAL_NEXT_FEE_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SETTLEMENT_DOM = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.ACCOUNT_TYPE = StringUtils.trimToNull(Row_FeedRecord.ACCOUNT_TYPE);
Record_OutputToDB.FIRST_ACCOUNT_ADMIN_ID = Row_FeedRecord.FIRST_ACCOUNT_ADMIN_ID;
Record_OutputToDB.PRIMARY_BILLING_ADDRESS_ID = Row_FeedRecord.PRIMARY_BILLING_ADDRESS_ID;
Record_OutputToDB.SERVICE_ACCOUNT_P = BooleanUtils.boolChar(Row_FeedRecord.SERVICE_ACCOUNT_P);
Record_OutputToDB.ZIPFLEET_ID = Row_FeedRecord.ZIPFLEET_ID;
Record_OutputToDB.ACCOUNT_NAME = StringUtils.trimToNull(Row_FeedRecord.ACCOUNT_NAME);
Record_OutputToDB.LOCAL_NEXT_FEE_DATE = Row_FeedRecord.LOCAL_NEXT_FEE_DATE;
Record_OutputToDB.SETTLEMENT_DOM = Row_FeedRecord.SETTLEMENT_DOM;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ACCOUNT_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ACCOUNT_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FIRST_ACCOUNT_ADMIN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.FIRST_ACCOUNT_ADMIN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PRIMARY_BILLING_ADDRESS_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.PRIMARY_BILLING_ADDRESS_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SERVICE_ACCOUNT_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SERVICE_ACCOUNT_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ACCOUNT_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ACCOUNT_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LOCAL_NEXT_FEE_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.LOCAL_NEXT_FEE_DATE.getTime();
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SETTLEMENT_DOM==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.SETTLEMENT_DOM);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.ACCOUNT_ID)
                        .c1(Record_OutputToDB.ACCOUNT_TYPE)
                        .c2(Record_OutputToDB.FIRST_ACCOUNT_ADMIN_ID)
                        .c3(Record_OutputToDB.PRIMARY_BILLING_ADDRESS_ID)
                        .c4(Record_OutputToDB.SERVICE_ACCOUNT_P)
                        .c5(Record_OutputToDB.ZIPFLEET_ID)
                        .c6(Record_OutputToDB.ACCOUNT_NAME)
                        .c7(Record_OutputToDB.LOCAL_NEXT_FEE_DATE)
                        .c8(Record_OutputToDB.SETTLEMENT_DOM)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.ACCOUNT_TYPE = Record_OutputToDB.ACCOUNT_TYPE;
                                After_Insert.FIRST_ACCOUNT_ADMIN_ID = Record_OutputToDB.FIRST_ACCOUNT_ADMIN_ID;
                                After_Insert.PRIMARY_BILLING_ADDRESS_ID = Record_OutputToDB.PRIMARY_BILLING_ADDRESS_ID;
                                After_Insert.SERVICE_ACCOUNT_P = Record_OutputToDB.SERVICE_ACCOUNT_P;
                                After_Insert.ZIPFLEET_ID = Record_OutputToDB.ZIPFLEET_ID;
                                After_Insert.ACCOUNT_NAME = Record_OutputToDB.ACCOUNT_NAME;
                                After_Insert.LOCAL_NEXT_FEE_DATE = Record_OutputToDB.LOCAL_NEXT_FEE_DATE;
                                After_Insert.SETTLEMENT_DOM = Record_OutputToDB.SETTLEMENT_DOM;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.ACCOUNT_TYPE = After_Insert.ACCOUNT_TYPE;
               Log_Rows.FIRST_ACCOUNT_ADMIN_ID = After_Insert.FIRST_ACCOUNT_ADMIN_ID;
               Log_Rows.PRIMARY_BILLING_ADDRESS_ID = After_Insert.PRIMARY_BILLING_ADDRESS_ID;
               Log_Rows.SERVICE_ACCOUNT_P = After_Insert.SERVICE_ACCOUNT_P;
               Log_Rows.ZIPFLEET_ID = After_Insert.ZIPFLEET_ID;
               Log_Rows.ACCOUNT_NAME = After_Insert.ACCOUNT_NAME;
               Log_Rows.LOCAL_NEXT_FEE_DATE = After_Insert.LOCAL_NEXT_FEE_DATE;
               Log_Rows.SETTLEMENT_DOM = After_Insert.SETTLEMENT_DOM;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ACCOUNT_ID\",\"ACCOUNT_TYPE\",\"FIRST_ACCOUNT_ADMIN_ID\",\"PRIMARY_BILLING_ADDRESS_ID\",\"SERVICE_ACCOUNT_P\",\"ZIPFLEET_ID\",\"ACCOUNT_NAME\",\"LOCAL_NEXT_FEE_DATE\",\"SETTLEMENT_DOM\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.ACCOUNT_TYPE==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ACCOUNT_TYPE);
					...
					if(bufferLtRedshiftOutput_1.FIRST_ACCOUNT_ADMIN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FIRST_ACCOUNT_ADMIN_ID);
					...
					if(bufferLtRedshiftOutput_1.PRIMARY_BILLING_ADDRESS_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PRIMARY_BILLING_ADDRESS_ID);
					...
					if(bufferLtRedshiftOutput_1.SERVICE_ACCOUNT_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SERVICE_ACCOUNT_P);
					...
					if(bufferLtRedshiftOutput_1.ACCOUNT_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ACCOUNT_NAME);
					...
					if(bufferLtRedshiftOutput_1.LOCAL_NEXT_FEE_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.LOCAL_NEXT_FEE_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.SETTLEMENT_DOM==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SETTLEMENT_DOM);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.FIRST_ACCOUNT_ADMIN_ID = null;
					
							row1.PRIMARY_BILLING_ADDRESS_ID = null;
					
							row1.SERVICE_ACCOUNT_P = null;
					
							row1.ZIPFLEET_ID = null;
					
							row1.ACCOUNT_NAME = null;
					
							row1.LOCAL_NEXT_FEE_DATE = null;
					
							row1.SETTLEMENT_DOM = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ACCOUNT_TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.FIRST_ACCOUNT_ADMIN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.PRIMARY_BILLING_ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SERVICE_ACCOUNT_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ACCOUNT_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.LOCAL_NEXT_FEE_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SETTLEMENT_DOM = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.ACCOUNT_TYPE = StringUtils.trimToNull(row1.ACCOUNT_TYPE);
row2.FIRST_ACCOUNT_ADMIN_ID = row1.FIRST_ACCOUNT_ADMIN_ID;
row2.PRIMARY_BILLING_ADDRESS_ID = row1.PRIMARY_BILLING_ADDRESS_ID;
row2.SERVICE_ACCOUNT_P = BooleanUtils.boolChar(row1.SERVICE_ACCOUNT_P);
row2.ZIPFLEET_ID = row1.ZIPFLEET_ID;
row2.ACCOUNT_NAME = StringUtils.trimToNull(row1.ACCOUNT_NAME);
row2.LOCAL_NEXT_FEE_DATE = row1.LOCAL_NEXT_FEE_DATE;
row2.SETTLEMENT_DOM = row1.SETTLEMENT_DOM;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[9];
                            rowtFileOutputDelimited_1[0]=row2.ACCOUNT_ID == null ? null : String.valueOf(row2.ACCOUNT_ID);
                            rowtFileOutputDelimited_1[1]=row2.ACCOUNT_TYPE == null ? null : row2.ACCOUNT_TYPE;
                            rowtFileOutputDelimited_1[2]=row2.FIRST_ACCOUNT_ADMIN_ID == null ? null : String.valueOf(row2.FIRST_ACCOUNT_ADMIN_ID);
                            rowtFileOutputDelimited_1[3]=row2.PRIMARY_BILLING_ADDRESS_ID == null ? null : String.valueOf(row2.PRIMARY_BILLING_ADDRESS_ID);
                            rowtFileOutputDelimited_1[4]=row2.SERVICE_ACCOUNT_P == null ? null : row2.SERVICE_ACCOUNT_P;
                            rowtFileOutputDelimited_1[5]=row2.ZIPFLEET_ID == null ? null : String.valueOf(row2.ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[6]=row2.ACCOUNT_NAME == null ? null : row2.ACCOUNT_NAME;
                            rowtFileOutputDelimited_1[7]=row2.LOCAL_NEXT_FEE_DATE == null ? null : FormatterUtils.format_Date(row2.LOCAL_NEXT_FEE_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[8]=row2.SETTLEMENT_DOM == null ? null : String.valueOf(row2.SETTLEMENT_DOM);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Accounts StageFeed_AccountsClass = new StageFeed_Accounts();

        int exitCode = StageFeed_AccountsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Accounts.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_accounts_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Accounts");
        }
...
/************************************************************************************************
 *     338961 characters generated by Talend Open Studio for Data Integration 
