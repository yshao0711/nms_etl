...
package zipcar_marketingdw.stagefeed_memberjoininfo_0_1;
...
/**
 * Job: StageFeed_MemberJoinInfo Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_MemberJoinInfo implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_MemberJoinInfo";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_T1U8MMrvEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_MemberJoinInfo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_MemberJoinInfo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.MEMBER_JOIN_INFO.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.MEMBER_JOIN_INFO.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.MEMBER_JOIN_INFO;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_MemberJoinInfo = new byte[0];
			    ...
			    public Long JOIN_RATE_PLAN_ID;

				public Long getJOIN_RATE_PLAN_ID () {
					return this.JOIN_RATE_PLAN_ID;
				}
				
			    public Double JOIN_APP_FEE;

				public Double getJOIN_APP_FEE () {
					return this.JOIN_APP_FEE;
				}
				
			    public Double JOIN_APP_FEE_USD;

				public Double getJOIN_APP_FEE_USD () {
					return this.JOIN_APP_FEE_USD;
				}
				
			    public String JOIN_APP_FEE_CURRENCY_ISO;

				public String getJOIN_APP_FEE_CURRENCY_ISO () {
					return this.JOIN_APP_FEE_CURRENCY_ISO;
				}
				
			    public Double JOIN_ANNUAL_FEE;

				public Double getJOIN_ANNUAL_FEE () {
					return this.JOIN_ANNUAL_FEE;
				}
				
			    public Double JOIN_ANNUAL_FEE_USD;

				public Double getJOIN_ANNUAL_FEE_USD () {
					return this.JOIN_ANNUAL_FEE_USD;
				}
				
			    public String JOIN_ANN_FEE_CURRENCY_ISO;

				public String getJOIN_ANN_FEE_CURRENCY_ISO () {
					return this.JOIN_ANN_FEE_CURRENCY_ISO;
				}
				
			    public Double JOIN_ANNLZD_ANN_FEE;

				public Double getJOIN_ANNLZD_ANN_FEE () {
					return this.JOIN_ANNLZD_ANN_FEE;
				}
				
			    public Double JOIN_ANNLZD_ANN_FEE_USD;

				public Double getJOIN_ANNLZD_ANN_FEE_USD () {
					return this.JOIN_ANNLZD_ANN_FEE_USD;
				}
				
			    public Long JOIN_COUPON_ID;

				public Long getJOIN_COUPON_ID () {
					return this.JOIN_COUPON_ID;
				}
				
			    public String JOIN_COUPON;

				public String getJOIN_COUPON () {
					return this.JOIN_COUPON;
				}
				
			    public Double JOIN_DRIVING_CREDIT;

				public Double getJOIN_DRIVING_CREDIT () {
					return this.JOIN_DRIVING_CREDIT;
				}
				
			    public Double JOIN_DRIVING_CREDIT_USD;

				public Double getJOIN_DRIVING_CREDIT_USD () {
					return this.JOIN_DRIVING_CREDIT_USD;
				}
				
			    public Double JOIN_CASH_CREDIT;

				public Double getJOIN_CASH_CREDIT () {
					return this.JOIN_CASH_CREDIT;
				}
				
			    public Double JOIN_CASH_CREDIT_USD;

				public Double getJOIN_CASH_CREDIT_USD () {
					return this.JOIN_CASH_CREDIT_USD;
				}
				
			    public Double JOIN_RP_CREDIT;

				public Double getJOIN_RP_CREDIT () {
					return this.JOIN_RP_CREDIT;
				}
				
			    public Double JOIN_RP_CREDIT_USD;

				public Double getJOIN_RP_CREDIT_USD () {
					return this.JOIN_RP_CREDIT_USD;
				}
				
			    public String JOIN_RP_CREDIT_CURRENCY_ISO;

				public String getJOIN_RP_CREDIT_CURRENCY_ISO () {
					return this.JOIN_RP_CREDIT_CURRENCY_ISO;
				}
				
			    public Double JOIN_MANUAL_DRIVING_CREDIT;

				public Double getJOIN_MANUAL_DRIVING_CREDIT () {
					return this.JOIN_MANUAL_DRIVING_CREDIT;
				}
				
			    public Double JOIN_MANUAL_DRIVING_CREDIT_USD;

				public Double getJOIN_MANUAL_DRIVING_CREDIT_USD () {
					return this.JOIN_MANUAL_DRIVING_CREDIT_USD;
				}
				
			    public String JOIN_MANUAL_CURRENCY_ISO;

				public String getJOIN_MANUAL_CURRENCY_ISO () {
					return this.JOIN_MANUAL_CURRENCY_ISO;
				}
				
			    public String JOIN_WAIVE_FIRST_ANNUAL_FEE_P;

				public String getJOIN_WAIVE_FIRST_ANNUAL_FEE_P () {
					return this.JOIN_WAIVE_FIRST_ANNUAL_FEE_P;
				}
			    ...
			    public Long LAST_JOIN_ZIPFLEET_ID;

				public Long getLAST_JOIN_ZIPFLEET_ID () {
					return this.LAST_JOIN_ZIPFLEET_ID;
				}
				
			    public Long LAST_JOIN_RATE_PLAN_ID;

				public Long getLAST_JOIN_RATE_PLAN_ID () {
					return this.LAST_JOIN_RATE_PLAN_ID;
				}
				
			    public java.util.Date LAST_REJOIN_DATE;

				public java.util.Date getLAST_REJOIN_DATE () {
					return this.LAST_REJOIN_DATE;
				}
				
			    public Long LAST_REJOIN_RATE_PLAN_ID;

				public Long getLAST_REJOIN_RATE_PLAN_ID () {
					return this.LAST_REJOIN_RATE_PLAN_ID;
				}
				
			    public Long LAST_REJOIN_ZIPFLEET_ID;

				public Long getLAST_REJOIN_ZIPFLEET_ID () {
					return this.LAST_REJOIN_ZIPFLEET_ID;
				}
			    ...
			    public Long LAST_JOIN_ACCOUNT_ID;

				public Long getLAST_JOIN_ACCOUNT_ID () {
					return this.LAST_JOIN_ACCOUNT_ID;
				}
				
			    public Long LAST_JOIN_AFFILIATE_ID;

				public Long getLAST_JOIN_AFFILIATE_ID () {
					return this.LAST_JOIN_AFFILIATE_ID;
				}
				
			    public Long JOIN_ACCOUNT_ID;

				public Long getJOIN_ACCOUNT_ID () {
					return this.JOIN_ACCOUNT_ID;
				}
				
			    public Long JOIN_AFFILIATE_ID;

				public Long getJOIN_AFFILIATE_ID () {
					return this.JOIN_AFFILIATE_ID;
				}
				
			    public Long LAST_CHANGED_RATE_PLAN_ID;

				public Long getLAST_CHANGED_RATE_PLAN_ID () {
					return this.LAST_CHANGED_RATE_PLAN_ID;
				}
				
			    public java.util.Date LAST_CHANGED_RATE_PLAN_DATE;

				public java.util.Date getLAST_CHANGED_RATE_PLAN_DATE () {
					return this.LAST_CHANGED_RATE_PLAN_DATE;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.JOIN_DATE = readDate(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_RATE_PLAN_ID = null;
           				} else {
           			    	this.JOIN_RATE_PLAN_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_APP_FEE = null;
           				} else {
           			    	this.JOIN_APP_FEE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_APP_FEE_USD = null;
           				} else {
           			    	this.JOIN_APP_FEE_USD = dis.readDouble();
           				}
					
					this.JOIN_APP_FEE_CURRENCY_ISO = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_ANNUAL_FEE = null;
           				} else {
           			    	this.JOIN_ANNUAL_FEE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_ANNUAL_FEE_USD = null;
           				} else {
           			    	this.JOIN_ANNUAL_FEE_USD = dis.readDouble();
           				}
					
					this.JOIN_ANN_FEE_CURRENCY_ISO = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_ANNLZD_ANN_FEE = null;
           				} else {
           			    	this.JOIN_ANNLZD_ANN_FEE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_ANNLZD_ANN_FEE_USD = null;
           				} else {
           			    	this.JOIN_ANNLZD_ANN_FEE_USD = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_COUPON_ID = null;
           				} else {
           			    	this.JOIN_COUPON_ID = dis.readLong();
           				}
					
					this.JOIN_COUPON = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_DRIVING_CREDIT = null;
           				} else {
           			    	this.JOIN_DRIVING_CREDIT = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_DRIVING_CREDIT_USD = null;
           				} else {
           			    	this.JOIN_DRIVING_CREDIT_USD = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_CASH_CREDIT = null;
           				} else {
           			    	this.JOIN_CASH_CREDIT = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_CASH_CREDIT_USD = null;
           				} else {
           			    	this.JOIN_CASH_CREDIT_USD = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_RP_CREDIT = null;
           				} else {
           			    	this.JOIN_RP_CREDIT = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_RP_CREDIT_USD = null;
           				} else {
           			    	this.JOIN_RP_CREDIT_USD = dis.readDouble();
           				}
					
					this.JOIN_RP_CREDIT_CURRENCY_ISO = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_MANUAL_DRIVING_CREDIT = null;
           				} else {
           			    	this.JOIN_MANUAL_DRIVING_CREDIT = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_MANUAL_DRIVING_CREDIT_USD = null;
           				} else {
           			    	this.JOIN_MANUAL_DRIVING_CREDIT_USD = dis.readDouble();
           				}
					
					this.JOIN_MANUAL_CURRENCY_ISO = readString(dis);
					
					this.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = readString(dis);
					
					this.LAST_JOIN_DATE = readDate(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_JOIN_ZIPFLEET_ID = null;
           				} else {
           			    	this.LAST_JOIN_ZIPFLEET_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_JOIN_RATE_PLAN_ID = null;
           				} else {
           			    	this.LAST_JOIN_RATE_PLAN_ID = dis.readLong();
           				}
					
					this.LAST_REJOIN_DATE = readDate(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_REJOIN_RATE_PLAN_ID = null;
           				} else {
           			    	this.LAST_REJOIN_RATE_PLAN_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_REJOIN_ZIPFLEET_ID = null;
           				} else {
           			    	this.LAST_REJOIN_ZIPFLEET_ID = dis.readLong();
           				}
					...
					this.DELETED_DATE = readDate(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_JOIN_ACCOUNT_ID = null;
           				} else {
           			    	this.LAST_JOIN_ACCOUNT_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_JOIN_AFFILIATE_ID = null;
           				} else {
           			    	this.LAST_JOIN_AFFILIATE_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_ACCOUNT_ID = null;
           				} else {
           			    	this.JOIN_ACCOUNT_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.JOIN_AFFILIATE_ID = null;
           				} else {
           			    	this.JOIN_AFFILIATE_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.LAST_CHANGED_RATE_PLAN_ID = null;
           				} else {
           			    	this.LAST_CHANGED_RATE_PLAN_ID = dis.readLong();
           				}
					
					this.LAST_CHANGED_RATE_PLAN_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.JOIN_RATE_PLAN_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.JOIN_RATE_PLAN_ID);
		            	}
					
					// Double
				
						if(this.JOIN_APP_FEE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_APP_FEE);
		            	}
					
					// Double
				
						if(this.JOIN_APP_FEE_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_APP_FEE_USD);
		            	}
					
					// String
				
						writeString(this.JOIN_APP_FEE_CURRENCY_ISO,dos);
					
					// Double
				
						if(this.JOIN_ANNUAL_FEE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_ANNUAL_FEE);
		            	}
					
					// Double
				
						if(this.JOIN_ANNUAL_FEE_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_ANNUAL_FEE_USD);
		            	}
					
					// String
				
						writeString(this.JOIN_ANN_FEE_CURRENCY_ISO,dos);
					
					// Double
				
						if(this.JOIN_ANNLZD_ANN_FEE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_ANNLZD_ANN_FEE);
		            	}
					
					// Double
				
						if(this.JOIN_ANNLZD_ANN_FEE_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_ANNLZD_ANN_FEE_USD);
		            	}
					
					// Long
				
						if(this.JOIN_COUPON_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.JOIN_COUPON_ID);
		            	}
					
					// String
				
						writeString(this.JOIN_COUPON,dos);
					
					// Double
				
						if(this.JOIN_DRIVING_CREDIT == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_DRIVING_CREDIT);
		            	}
					
					// Double
				
						if(this.JOIN_DRIVING_CREDIT_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_DRIVING_CREDIT_USD);
		            	}
					
					// Double
				
						if(this.JOIN_CASH_CREDIT == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_CASH_CREDIT);
		            	}
					
					// Double
				
						if(this.JOIN_CASH_CREDIT_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_CASH_CREDIT_USD);
		            	}
					
					// Double
				
						if(this.JOIN_RP_CREDIT == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_RP_CREDIT);
		            	}
					
					// Double
				
						if(this.JOIN_RP_CREDIT_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_RP_CREDIT_USD);
		            	}
					
					// String
				
						writeString(this.JOIN_RP_CREDIT_CURRENCY_ISO,dos);
					
					// Double
				
						if(this.JOIN_MANUAL_DRIVING_CREDIT == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_MANUAL_DRIVING_CREDIT);
		            	}
					
					// Double
				
						if(this.JOIN_MANUAL_DRIVING_CREDIT_USD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.JOIN_MANUAL_DRIVING_CREDIT_USD);
		            	}
					
					// String
				
						writeString(this.JOIN_MANUAL_CURRENCY_ISO,dos);
					
					// String
				
						writeString(this.JOIN_WAIVE_FIRST_ANNUAL_FEE_P,dos);
					...
					// Long
						...
						if(this.LAST_JOIN_ZIPFLEET_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_JOIN_ZIPFLEET_ID);
		            	}
					
					// Long
				
						if(this.LAST_JOIN_RATE_PLAN_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_JOIN_RATE_PLAN_ID);
		            	}
					
					// java.util.Date
				
						writeDate(this.LAST_REJOIN_DATE,dos);
					
					// Long
				
						if(this.LAST_REJOIN_RATE_PLAN_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_REJOIN_RATE_PLAN_ID);
		            	}
					
					// Long
				
						if(this.LAST_REJOIN_ZIPFLEET_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_REJOIN_ZIPFLEET_ID);
		            	}
					...
					// Long
						...
						if(this.LAST_JOIN_ACCOUNT_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_JOIN_ACCOUNT_ID);
		            	}
					
					// Long
				
						if(this.LAST_JOIN_AFFILIATE_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_JOIN_AFFILIATE_ID);
		            	}
					
					// Long
				
						if(this.JOIN_ACCOUNT_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.JOIN_ACCOUNT_ID);
		            	}
					
					// Long
				
						if(this.JOIN_AFFILIATE_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.JOIN_AFFILIATE_ID);
		            	}
					
					// Long
				
						if(this.LAST_CHANGED_RATE_PLAN_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.LAST_CHANGED_RATE_PLAN_ID);
		            	}
					
					// java.util.Date
				
						writeDate(this.LAST_CHANGED_RATE_PLAN_DATE,dos);
    ...
    public String toString() {
		...
		sb.append(",JOIN_RATE_PLAN_ID="+String.valueOf(JOIN_RATE_PLAN_ID));
		sb.append(",JOIN_APP_FEE="+String.valueOf(JOIN_APP_FEE));
		sb.append(",JOIN_APP_FEE_USD="+String.valueOf(JOIN_APP_FEE_USD));
		sb.append(",JOIN_APP_FEE_CURRENCY_ISO="+JOIN_APP_FEE_CURRENCY_ISO);
		sb.append(",JOIN_ANNUAL_FEE="+String.valueOf(JOIN_ANNUAL_FEE));
		sb.append(",JOIN_ANNUAL_FEE_USD="+String.valueOf(JOIN_ANNUAL_FEE_USD));
		sb.append(",JOIN_ANN_FEE_CURRENCY_ISO="+JOIN_ANN_FEE_CURRENCY_ISO);
		sb.append(",JOIN_ANNLZD_ANN_FEE="+String.valueOf(JOIN_ANNLZD_ANN_FEE));
		sb.append(",JOIN_ANNLZD_ANN_FEE_USD="+String.valueOf(JOIN_ANNLZD_ANN_FEE_USD));
		sb.append(",JOIN_COUPON_ID="+String.valueOf(JOIN_COUPON_ID));
		sb.append(",JOIN_COUPON="+JOIN_COUPON);
		sb.append(",JOIN_DRIVING_CREDIT="+String.valueOf(JOIN_DRIVING_CREDIT));
		sb.append(",JOIN_DRIVING_CREDIT_USD="+String.valueOf(JOIN_DRIVING_CREDIT_USD));
		sb.append(",JOIN_CASH_CREDIT="+String.valueOf(JOIN_CASH_CREDIT));
		sb.append(",JOIN_CASH_CREDIT_USD="+String.valueOf(JOIN_CASH_CREDIT_USD));
		sb.append(",JOIN_RP_CREDIT="+String.valueOf(JOIN_RP_CREDIT));
		sb.append(",JOIN_RP_CREDIT_USD="+String.valueOf(JOIN_RP_CREDIT_USD));
		sb.append(",JOIN_RP_CREDIT_CURRENCY_ISO="+JOIN_RP_CREDIT_CURRENCY_ISO);
		sb.append(",JOIN_MANUAL_DRIVING_CREDIT="+String.valueOf(JOIN_MANUAL_DRIVING_CREDIT));
		sb.append(",JOIN_MANUAL_DRIVING_CREDIT_USD="+String.valueOf(JOIN_MANUAL_DRIVING_CREDIT_USD));
		sb.append(",JOIN_MANUAL_CURRENCY_ISO="+JOIN_MANUAL_CURRENCY_ISO);
		sb.append(",JOIN_WAIVE_FIRST_ANNUAL_FEE_P="+JOIN_WAIVE_FIRST_ANNUAL_FEE_P);
		sb.append(",LAST_JOIN_DATE="+String.valueOf(LAST_JOIN_DATE));
		sb.append(",LAST_JOIN_ZIPFLEET_ID="+String.valueOf(LAST_JOIN_ZIPFLEET_ID));
		sb.append(",LAST_JOIN_RATE_PLAN_ID="+String.valueOf(LAST_JOIN_RATE_PLAN_ID));
		sb.append(",LAST_REJOIN_DATE="+String.valueOf(LAST_REJOIN_DATE));
		sb.append(",LAST_REJOIN_RATE_PLAN_ID="+String.valueOf(LAST_REJOIN_RATE_PLAN_ID));
		sb.append(",LAST_REJOIN_ZIPFLEET_ID="+String.valueOf(LAST_REJOIN_ZIPFLEET_ID));
		sb.append(",DELETED_DATE="+String.valueOf(DELETED_DATE));
		sb.append(",LAST_JOIN_ACCOUNT_ID="+String.valueOf(LAST_JOIN_ACCOUNT_ID));
		sb.append(",LAST_JOIN_AFFILIATE_ID="+String.valueOf(LAST_JOIN_AFFILIATE_ID));
		sb.append(",JOIN_ACCOUNT_ID="+String.valueOf(JOIN_ACCOUNT_ID));
		sb.append(",JOIN_AFFILIATE_ID="+String.valueOf(JOIN_AFFILIATE_ID));
		sb.append(",LAST_CHANGED_RATE_PLAN_ID="+String.valueOf(LAST_CHANGED_RATE_PLAN_ID));
		sb.append(",LAST_CHANGED_RATE_PLAN_DATE="+String.valueOf(LAST_CHANGED_RATE_PLAN_DATE));
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						...
						java.util.Date JOIN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c2(java.util.Date JOIN_DATE){
							this.JOIN_DATE = JOIN_DATE;
							return this;
						}				
						Long JOIN_ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Long JOIN_ZIPFLEET_ID){
							this.JOIN_ZIPFLEET_ID = JOIN_ZIPFLEET_ID;
							return this;
						}				
						Long JOIN_RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c4(Long JOIN_RATE_PLAN_ID){
							this.JOIN_RATE_PLAN_ID = JOIN_RATE_PLAN_ID;
							return this;
						}				
						Double JOIN_APP_FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(Double JOIN_APP_FEE){
							this.JOIN_APP_FEE = JOIN_APP_FEE;
							return this;
						}				
						Double JOIN_APP_FEE_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Double JOIN_APP_FEE_USD){
							this.JOIN_APP_FEE_USD = JOIN_APP_FEE_USD;
							return this;
						}				
						String JOIN_APP_FEE_CURRENCY_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String JOIN_APP_FEE_CURRENCY_ISO){
							this.JOIN_APP_FEE_CURRENCY_ISO = JOIN_APP_FEE_CURRENCY_ISO;
							return this;
						}				
						Double JOIN_ANNUAL_FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Double JOIN_ANNUAL_FEE){
							this.JOIN_ANNUAL_FEE = JOIN_ANNUAL_FEE;
							return this;
						}				
						Double JOIN_ANNUAL_FEE_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c9(Double JOIN_ANNUAL_FEE_USD){
							this.JOIN_ANNUAL_FEE_USD = JOIN_ANNUAL_FEE_USD;
							return this;
						}				
						String JOIN_ANN_FEE_CURRENCY_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String JOIN_ANN_FEE_CURRENCY_ISO){
							this.JOIN_ANN_FEE_CURRENCY_ISO = JOIN_ANN_FEE_CURRENCY_ISO;
							return this;
						}				
						Double JOIN_ANNLZD_ANN_FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c11(Double JOIN_ANNLZD_ANN_FEE){
							this.JOIN_ANNLZD_ANN_FEE = JOIN_ANNLZD_ANN_FEE;
							return this;
						}				
						Double JOIN_ANNLZD_ANN_FEE_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c12(Double JOIN_ANNLZD_ANN_FEE_USD){
							this.JOIN_ANNLZD_ANN_FEE_USD = JOIN_ANNLZD_ANN_FEE_USD;
							return this;
						}				
						Long JOIN_COUPON_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c13(Long JOIN_COUPON_ID){
							this.JOIN_COUPON_ID = JOIN_COUPON_ID;
							return this;
						}				
						String JOIN_COUPON;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String JOIN_COUPON){
							this.JOIN_COUPON = JOIN_COUPON;
							return this;
						}				
						Double JOIN_DRIVING_CREDIT;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Double JOIN_DRIVING_CREDIT){
							this.JOIN_DRIVING_CREDIT = JOIN_DRIVING_CREDIT;
							return this;
						}				
						Double JOIN_DRIVING_CREDIT_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c16(Double JOIN_DRIVING_CREDIT_USD){
							this.JOIN_DRIVING_CREDIT_USD = JOIN_DRIVING_CREDIT_USD;
							return this;
						}				
						Double JOIN_CASH_CREDIT;
						
	            		public BufferLine_tRedshiftOutput_1 c17(Double JOIN_CASH_CREDIT){
							this.JOIN_CASH_CREDIT = JOIN_CASH_CREDIT;
							return this;
						}				
						Double JOIN_CASH_CREDIT_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c18(Double JOIN_CASH_CREDIT_USD){
							this.JOIN_CASH_CREDIT_USD = JOIN_CASH_CREDIT_USD;
							return this;
						}				
						Double JOIN_RP_CREDIT;
						
	            		public BufferLine_tRedshiftOutput_1 c19(Double JOIN_RP_CREDIT){
							this.JOIN_RP_CREDIT = JOIN_RP_CREDIT;
							return this;
						}				
						Double JOIN_RP_CREDIT_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c20(Double JOIN_RP_CREDIT_USD){
							this.JOIN_RP_CREDIT_USD = JOIN_RP_CREDIT_USD;
							return this;
						}				
						String JOIN_RP_CREDIT_CURRENCY_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c21(String JOIN_RP_CREDIT_CURRENCY_ISO){
							this.JOIN_RP_CREDIT_CURRENCY_ISO = JOIN_RP_CREDIT_CURRENCY_ISO;
							return this;
						}				
						Double JOIN_MANUAL_DRIVING_CREDIT;
						
	            		public BufferLine_tRedshiftOutput_1 c22(Double JOIN_MANUAL_DRIVING_CREDIT){
							this.JOIN_MANUAL_DRIVING_CREDIT = JOIN_MANUAL_DRIVING_CREDIT;
							return this;
						}				
						Double JOIN_MANUAL_DRIVING_CREDIT_USD;
						
	            		public BufferLine_tRedshiftOutput_1 c23(Double JOIN_MANUAL_DRIVING_CREDIT_USD){
							this.JOIN_MANUAL_DRIVING_CREDIT_USD = JOIN_MANUAL_DRIVING_CREDIT_USD;
							return this;
						}				
						String JOIN_MANUAL_CURRENCY_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c24(String JOIN_MANUAL_CURRENCY_ISO){
							this.JOIN_MANUAL_CURRENCY_ISO = JOIN_MANUAL_CURRENCY_ISO;
							return this;
						}				
						String JOIN_WAIVE_FIRST_ANNUAL_FEE_P;
						
	            		public BufferLine_tRedshiftOutput_1 c25(String JOIN_WAIVE_FIRST_ANNUAL_FEE_P){
							this.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = JOIN_WAIVE_FIRST_ANNUAL_FEE_P;
							return this;
						}				
						java.util.Date LAST_JOIN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c26(java.util.Date LAST_JOIN_DATE){
							this.LAST_JOIN_DATE = LAST_JOIN_DATE;
							return this;
						}				
						Long LAST_JOIN_ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c27(Long LAST_JOIN_ZIPFLEET_ID){
							this.LAST_JOIN_ZIPFLEET_ID = LAST_JOIN_ZIPFLEET_ID;
							return this;
						}				
						Long LAST_JOIN_RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c28(Long LAST_JOIN_RATE_PLAN_ID){
							this.LAST_JOIN_RATE_PLAN_ID = LAST_JOIN_RATE_PLAN_ID;
							return this;
						}				
						java.util.Date LAST_REJOIN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c29(java.util.Date LAST_REJOIN_DATE){
							this.LAST_REJOIN_DATE = LAST_REJOIN_DATE;
							return this;
						}				
						Long LAST_REJOIN_RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c30(Long LAST_REJOIN_RATE_PLAN_ID){
							this.LAST_REJOIN_RATE_PLAN_ID = LAST_REJOIN_RATE_PLAN_ID;
							return this;
						}				
						Long LAST_REJOIN_ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c31(Long LAST_REJOIN_ZIPFLEET_ID){
							this.LAST_REJOIN_ZIPFLEET_ID = LAST_REJOIN_ZIPFLEET_ID;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c32(java.util.Date DELETED_DATE){
							this.DELETED_DATE = DELETED_DATE;
							return this;
						}				
						Long LAST_JOIN_ACCOUNT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c33(Long LAST_JOIN_ACCOUNT_ID){
							this.LAST_JOIN_ACCOUNT_ID = LAST_JOIN_ACCOUNT_ID;
							return this;
						}				
						Long LAST_JOIN_AFFILIATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c34(Long LAST_JOIN_AFFILIATE_ID){
							this.LAST_JOIN_AFFILIATE_ID = LAST_JOIN_AFFILIATE_ID;
							return this;
						}				
						Long JOIN_ACCOUNT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c35(Long JOIN_ACCOUNT_ID){
							this.JOIN_ACCOUNT_ID = JOIN_ACCOUNT_ID;
							return this;
						}				
						Long JOIN_AFFILIATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c36(Long JOIN_AFFILIATE_ID){
							this.JOIN_AFFILIATE_ID = JOIN_AFFILIATE_ID;
							return this;
						}				
						Long LAST_CHANGED_RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c37(Long LAST_CHANGED_RATE_PLAN_ID){
							this.LAST_CHANGED_RATE_PLAN_ID = LAST_CHANGED_RATE_PLAN_ID;
							return this;
						}				
						java.util.Date LAST_CHANGED_RATE_PLAN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c38(java.util.Date LAST_CHANGED_RATE_PLAN_DATE){
							this.LAST_CHANGED_RATE_PLAN_DATE = LAST_CHANGED_RATE_PLAN_DATE;
							return this;
						}		
			}
			...
			for(int i_tRedshiftOutput_1=0;i_tRedshiftOutput_1 < 500;i_tRedshiftOutput_1++){
				 extendInsertValueStmt_tRedshiftOutput_1.append("(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				 if (i_tRedshiftOutput_1!=500-1) extendInsertValueStmt_tRedshiftOutput_1.append(",");
			}

			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"ACCOUNT_ID\",\"JOIN_DATE\",\"JOIN_ZIPFLEET_ID\",\"JOIN_RATE_PLAN_ID\",\"JOIN_APP_FEE\",\"JOIN_APP_FEE_USD\",\"JOIN_APP_FEE_CURRENCY_ISO\",\"JOIN_ANNUAL_FEE\",\"JOIN_ANNUAL_FEE_USD\",\"JOIN_ANN_FEE_CURRENCY_ISO\",\"JOIN_ANNLZD_ANN_FEE\",\"JOIN_ANNLZD_ANN_FEE_USD\",\"JOIN_COUPON_ID\",\"JOIN_COUPON\",\"JOIN_DRIVING_CREDIT\",\"JOIN_DRIVING_CREDIT_USD\",\"JOIN_CASH_CREDIT\",\"JOIN_CASH_CREDIT_USD\",\"JOIN_RP_CREDIT\",\"JOIN_RP_CREDIT_USD\",\"JOIN_RP_CREDIT_CURRENCY_ISO\",\"JOIN_MANUAL_DRIVING_CREDIT\",\"JOIN_MANUAL_DRIVING_CREDIT_USD\",\"JOIN_MANUAL_CURRENCY_ISO\",\"JOIN_WAIVE_FIRST_ANNUAL_FEE_P\",\"LAST_JOIN_DATE\",\"LAST_JOIN_ZIPFLEET_ID\",\"LAST_JOIN_RATE_PLAN_ID\",\"LAST_REJOIN_DATE\",\"LAST_REJOIN_RATE_PLAN_ID\",\"LAST_REJOIN_ZIPFLEET_ID\",\"DELETED_DATE\",\"LAST_JOIN_ACCOUNT_ID\",\"LAST_JOIN_AFFILIATE_ID\",\"JOIN_ACCOUNT_ID\",\"JOIN_AFFILIATE_ID\",\"LAST_CHANGED_RATE_PLAN_ID\",\"LAST_CHANGED_RATE_PLAN_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.JOIN_DATE = null;
					
							Row_FeedRecord.JOIN_ZIPFLEET_ID = null;
					
							Row_FeedRecord.JOIN_RATE_PLAN_ID = null;
					
							Row_FeedRecord.JOIN_APP_FEE = null;
					
							Row_FeedRecord.JOIN_APP_FEE_USD = null;
					
							Row_FeedRecord.JOIN_APP_FEE_CURRENCY_ISO = null;
					
							Row_FeedRecord.JOIN_ANNUAL_FEE = null;
					
							Row_FeedRecord.JOIN_ANNUAL_FEE_USD = null;
					
							Row_FeedRecord.JOIN_ANN_FEE_CURRENCY_ISO = null;
					
							Row_FeedRecord.JOIN_ANNLZD_ANN_FEE = null;
					
							Row_FeedRecord.JOIN_ANNLZD_ANN_FEE_USD = null;
					
							Row_FeedRecord.JOIN_COUPON_ID = null;
					
							Row_FeedRecord.JOIN_COUPON = null;
					
							Row_FeedRecord.JOIN_DRIVING_CREDIT = null;
					
							Row_FeedRecord.JOIN_DRIVING_CREDIT_USD = null;
					
							Row_FeedRecord.JOIN_CASH_CREDIT = null;
					
							Row_FeedRecord.JOIN_CASH_CREDIT_USD = null;
					
							Row_FeedRecord.JOIN_RP_CREDIT = null;
					
							Row_FeedRecord.JOIN_RP_CREDIT_USD = null;
					
							Row_FeedRecord.JOIN_RP_CREDIT_CURRENCY_ISO = null;
					
							Row_FeedRecord.JOIN_MANUAL_DRIVING_CREDIT = null;
					
							Row_FeedRecord.JOIN_MANUAL_DRIVING_CREDIT_USD = null;
					
							Row_FeedRecord.JOIN_MANUAL_CURRENCY_ISO = null;
					
							Row_FeedRecord.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = null;
					
							Row_FeedRecord.LAST_JOIN_DATE = null;
					
							Row_FeedRecord.LAST_JOIN_ZIPFLEET_ID = null;
					
							Row_FeedRecord.LAST_JOIN_RATE_PLAN_ID = null;
					
							Row_FeedRecord.LAST_REJOIN_DATE = null;
					
							Row_FeedRecord.LAST_REJOIN_RATE_PLAN_ID = null;
					
							Row_FeedRecord.LAST_REJOIN_ZIPFLEET_ID = null;
					
							Row_FeedRecord.DELETED_DATE = null;
					
							Row_FeedRecord.LAST_JOIN_ACCOUNT_ID = null;
					
							Row_FeedRecord.LAST_JOIN_AFFILIATE_ID = null;
					
							Row_FeedRecord.JOIN_ACCOUNT_ID = null;
					
							Row_FeedRecord.JOIN_AFFILIATE_ID = null;
					
							Row_FeedRecord.LAST_CHANGED_RATE_PLAN_ID = null;
					
							Row_FeedRecord.LAST_CHANGED_RATE_PLAN_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.JOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_APP_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_APP_FEE_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_APP_FEE_CURRENCY_ISO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_ANNUAL_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_ANNUAL_FEE_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_ANN_FEE_CURRENCY_ISO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_ANNLZD_ANN_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_ANNLZD_ANN_FEE_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_COUPON_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_COUPON = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_DRIVING_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_DRIVING_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_CASH_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_CASH_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_RP_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_RP_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_RP_CREDIT_CURRENCY_ISO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_MANUAL_DRIVING_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_MANUAL_DRIVING_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_MANUAL_CURRENCY_ISO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.LAST_JOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_JOIN_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_JOIN_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.LAST_REJOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_REJOIN_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_REJOIN_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_JOIN_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_JOIN_AFFILIATE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.JOIN_AFFILIATE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LAST_CHANGED_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.LAST_CHANGED_RATE_PLAN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
...
Record_OutputToDB.JOIN_DATE = Row_FeedRecord.JOIN_DATE;
Record_OutputToDB.JOIN_ZIPFLEET_ID = Row_FeedRecord.JOIN_ZIPFLEET_ID;
Record_OutputToDB.JOIN_RATE_PLAN_ID = Row_FeedRecord.JOIN_RATE_PLAN_ID;
Record_OutputToDB.JOIN_APP_FEE = Row_FeedRecord.JOIN_APP_FEE;
Record_OutputToDB.JOIN_APP_FEE_USD = Row_FeedRecord.JOIN_APP_FEE_USD;
Record_OutputToDB.JOIN_APP_FEE_CURRENCY_ISO = StringUtils.trimToNull(Row_FeedRecord.JOIN_APP_FEE_CURRENCY_ISO);
Record_OutputToDB.JOIN_ANNUAL_FEE = Row_FeedRecord.JOIN_ANNUAL_FEE;
Record_OutputToDB.JOIN_ANNUAL_FEE_USD = Row_FeedRecord.JOIN_ANNUAL_FEE_USD;
Record_OutputToDB.JOIN_ANN_FEE_CURRENCY_ISO = StringUtils.trimToNull(Row_FeedRecord.JOIN_ANN_FEE_CURRENCY_ISO);
Record_OutputToDB.JOIN_ANNLZD_ANN_FEE = Row_FeedRecord.JOIN_ANNLZD_ANN_FEE;
Record_OutputToDB.JOIN_ANNLZD_ANN_FEE_USD = Row_FeedRecord.JOIN_ANNLZD_ANN_FEE_USD;
Record_OutputToDB.JOIN_COUPON_ID = Row_FeedRecord.JOIN_COUPON_ID;
Record_OutputToDB.JOIN_COUPON = Row_FeedRecord.JOIN_COUPON;
Record_OutputToDB.JOIN_DRIVING_CREDIT = Row_FeedRecord.JOIN_DRIVING_CREDIT;
Record_OutputToDB.JOIN_DRIVING_CREDIT_USD = Row_FeedRecord.JOIN_DRIVING_CREDIT_USD;
Record_OutputToDB.JOIN_CASH_CREDIT = Row_FeedRecord.JOIN_CASH_CREDIT;
Record_OutputToDB.JOIN_CASH_CREDIT_USD = Row_FeedRecord.JOIN_CASH_CREDIT_USD;
Record_OutputToDB.JOIN_RP_CREDIT = Row_FeedRecord.JOIN_RP_CREDIT;
Record_OutputToDB.JOIN_RP_CREDIT_USD = Row_FeedRecord.JOIN_RP_CREDIT_USD;
Record_OutputToDB.JOIN_RP_CREDIT_CURRENCY_ISO = StringUtils.trimToNull(Row_FeedRecord.JOIN_RP_CREDIT_CURRENCY_ISO);
Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT = Row_FeedRecord.JOIN_MANUAL_DRIVING_CREDIT;
Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT_USD = Row_FeedRecord.JOIN_MANUAL_DRIVING_CREDIT_USD;
Record_OutputToDB.JOIN_MANUAL_CURRENCY_ISO = StringUtils.trimToNull(Row_FeedRecord.JOIN_MANUAL_CURRENCY_ISO);
Record_OutputToDB.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = BooleanUtils.boolChar(Row_FeedRecord.JOIN_WAIVE_FIRST_ANNUAL_FEE_P);
Record_OutputToDB.LAST_JOIN_DATE = Row_FeedRecord.LAST_JOIN_DATE;
Record_OutputToDB.LAST_JOIN_ZIPFLEET_ID = Row_FeedRecord.LAST_JOIN_ZIPFLEET_ID;
Record_OutputToDB.LAST_JOIN_RATE_PLAN_ID = Row_FeedRecord.LAST_JOIN_RATE_PLAN_ID;
Record_OutputToDB.LAST_REJOIN_DATE = Row_FeedRecord.LAST_REJOIN_DATE;
Record_OutputToDB.LAST_REJOIN_RATE_PLAN_ID = Row_FeedRecord.LAST_REJOIN_RATE_PLAN_ID;
Record_OutputToDB.LAST_REJOIN_ZIPFLEET_ID = Row_FeedRecord.LAST_REJOIN_ZIPFLEET_ID;
Record_OutputToDB.DELETED_DATE = Row_FeedRecord.DELETED_DATE;
Record_OutputToDB.LAST_JOIN_ACCOUNT_ID = Row_FeedRecord.LAST_JOIN_ACCOUNT_ID;
Record_OutputToDB.LAST_JOIN_AFFILIATE_ID = Row_FeedRecord.LAST_JOIN_AFFILIATE_ID;
Record_OutputToDB.JOIN_ACCOUNT_ID = Row_FeedRecord.JOIN_ACCOUNT_ID;
Record_OutputToDB.JOIN_AFFILIATE_ID = Row_FeedRecord.JOIN_AFFILIATE_ID;
Record_OutputToDB.LAST_CHANGED_RATE_PLAN_ID = Row_FeedRecord.LAST_CHANGED_RATE_PLAN_ID;
Record_OutputToDB.LAST_CHANGED_RATE_PLAN_DATE = Row_FeedRecord.LAST_CHANGED_RATE_PLAN_DATE;
    nb_line_tJavaRow_3++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_RATE_PLAN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_RATE_PLAN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_FEE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_APP_FEE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_FEE_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_APP_FEE_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_APP_FEE_CURRENCY_ISO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_APP_FEE_CURRENCY_ISO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_ANNUAL_FEE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_ANNUAL_FEE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_ANNUAL_FEE_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_ANNUAL_FEE_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_ANN_FEE_CURRENCY_ISO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_ANN_FEE_CURRENCY_ISO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_ANNLZD_ANN_FEE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_ANNLZD_ANN_FEE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_ANNLZD_ANN_FEE_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_ANNLZD_ANN_FEE_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_COUPON_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_COUPON_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_COUPON==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_COUPON);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_DRIVING_CREDIT==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_DRIVING_CREDIT);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_DRIVING_CREDIT_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_DRIVING_CREDIT_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_CASH_CREDIT==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_CASH_CREDIT);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_CASH_CREDIT_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_CASH_CREDIT_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_RP_CREDIT==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_RP_CREDIT);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_RP_CREDIT_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_RP_CREDIT_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_RP_CREDIT_CURRENCY_ISO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_RP_CREDIT_CURRENCY_ISO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT_USD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT_USD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_MANUAL_CURRENCY_ISO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_MANUAL_CURRENCY_ISO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_WAIVE_FIRST_ANNUAL_FEE_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.JOIN_WAIVE_FIRST_ANNUAL_FEE_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_JOIN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.LAST_JOIN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_JOIN_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_JOIN_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_JOIN_RATE_PLAN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_JOIN_RATE_PLAN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_REJOIN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.LAST_REJOIN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_REJOIN_RATE_PLAN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_REJOIN_RATE_PLAN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_REJOIN_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_REJOIN_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_JOIN_ACCOUNT_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_JOIN_ACCOUNT_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_JOIN_AFFILIATE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_JOIN_AFFILIATE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_ACCOUNT_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_ACCOUNT_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.JOIN_AFFILIATE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.JOIN_AFFILIATE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_CHANGED_RATE_PLAN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LAST_CHANGED_RATE_PLAN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LAST_CHANGED_RATE_PLAN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.LAST_CHANGED_RATE_PLAN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c2(Record_OutputToDB.JOIN_DATE)
                        .c3(Record_OutputToDB.JOIN_ZIPFLEET_ID)
                        .c4(Record_OutputToDB.JOIN_RATE_PLAN_ID)
                        .c5(Record_OutputToDB.JOIN_APP_FEE)
                        .c6(Record_OutputToDB.JOIN_APP_FEE_USD)
                        .c7(Record_OutputToDB.JOIN_APP_FEE_CURRENCY_ISO)
                        .c8(Record_OutputToDB.JOIN_ANNUAL_FEE)
                        .c9(Record_OutputToDB.JOIN_ANNUAL_FEE_USD)
                        .c10(Record_OutputToDB.JOIN_ANN_FEE_CURRENCY_ISO)
                        .c11(Record_OutputToDB.JOIN_ANNLZD_ANN_FEE)
                        .c12(Record_OutputToDB.JOIN_ANNLZD_ANN_FEE_USD)
                        .c13(Record_OutputToDB.JOIN_COUPON_ID)
                        .c14(Record_OutputToDB.JOIN_COUPON)
                        .c15(Record_OutputToDB.JOIN_DRIVING_CREDIT)
                        .c16(Record_OutputToDB.JOIN_DRIVING_CREDIT_USD)
                        .c17(Record_OutputToDB.JOIN_CASH_CREDIT)
                        .c18(Record_OutputToDB.JOIN_CASH_CREDIT_USD)
                        .c19(Record_OutputToDB.JOIN_RP_CREDIT)
                        .c20(Record_OutputToDB.JOIN_RP_CREDIT_USD)
                        .c21(Record_OutputToDB.JOIN_RP_CREDIT_CURRENCY_ISO)
                        .c22(Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT)
                        .c23(Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT_USD)
                        .c24(Record_OutputToDB.JOIN_MANUAL_CURRENCY_ISO)
                        .c25(Record_OutputToDB.JOIN_WAIVE_FIRST_ANNUAL_FEE_P)
                        .c26(Record_OutputToDB.LAST_JOIN_DATE)
                        .c27(Record_OutputToDB.LAST_JOIN_ZIPFLEET_ID)
                        .c28(Record_OutputToDB.LAST_JOIN_RATE_PLAN_ID)
                        .c29(Record_OutputToDB.LAST_REJOIN_DATE)
                        .c30(Record_OutputToDB.LAST_REJOIN_RATE_PLAN_ID)
                        .c31(Record_OutputToDB.LAST_REJOIN_ZIPFLEET_ID)
                        .c32(Record_OutputToDB.DELETED_DATE)
                        .c33(Record_OutputToDB.LAST_JOIN_ACCOUNT_ID)
                        .c34(Record_OutputToDB.LAST_JOIN_AFFILIATE_ID)
                        .c35(Record_OutputToDB.JOIN_ACCOUNT_ID)
                        .c36(Record_OutputToDB.JOIN_AFFILIATE_ID)
                        .c37(Record_OutputToDB.LAST_CHANGED_RATE_PLAN_ID)
                        .c38(Record_OutputToDB.LAST_CHANGED_RATE_PLAN_DATE)
				;
				...
				if(rowCounttRedshiftOutput_1 == 500){
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.JOIN_DATE = Record_OutputToDB.JOIN_DATE;
                                After_Insert.JOIN_ZIPFLEET_ID = Record_OutputToDB.JOIN_ZIPFLEET_ID;
                                After_Insert.JOIN_RATE_PLAN_ID = Record_OutputToDB.JOIN_RATE_PLAN_ID;
                                After_Insert.JOIN_APP_FEE = Record_OutputToDB.JOIN_APP_FEE;
                                After_Insert.JOIN_APP_FEE_USD = Record_OutputToDB.JOIN_APP_FEE_USD;
                                After_Insert.JOIN_APP_FEE_CURRENCY_ISO = Record_OutputToDB.JOIN_APP_FEE_CURRENCY_ISO;
                                After_Insert.JOIN_ANNUAL_FEE = Record_OutputToDB.JOIN_ANNUAL_FEE;
                                After_Insert.JOIN_ANNUAL_FEE_USD = Record_OutputToDB.JOIN_ANNUAL_FEE_USD;
                                After_Insert.JOIN_ANN_FEE_CURRENCY_ISO = Record_OutputToDB.JOIN_ANN_FEE_CURRENCY_ISO;
                                After_Insert.JOIN_ANNLZD_ANN_FEE = Record_OutputToDB.JOIN_ANNLZD_ANN_FEE;
                                After_Insert.JOIN_ANNLZD_ANN_FEE_USD = Record_OutputToDB.JOIN_ANNLZD_ANN_FEE_USD;
                                After_Insert.JOIN_COUPON_ID = Record_OutputToDB.JOIN_COUPON_ID;
                                After_Insert.JOIN_COUPON = Record_OutputToDB.JOIN_COUPON;
                                After_Insert.JOIN_DRIVING_CREDIT = Record_OutputToDB.JOIN_DRIVING_CREDIT;
                                After_Insert.JOIN_DRIVING_CREDIT_USD = Record_OutputToDB.JOIN_DRIVING_CREDIT_USD;
                                After_Insert.JOIN_CASH_CREDIT = Record_OutputToDB.JOIN_CASH_CREDIT;
                                After_Insert.JOIN_CASH_CREDIT_USD = Record_OutputToDB.JOIN_CASH_CREDIT_USD;
                                After_Insert.JOIN_RP_CREDIT = Record_OutputToDB.JOIN_RP_CREDIT;
                                After_Insert.JOIN_RP_CREDIT_USD = Record_OutputToDB.JOIN_RP_CREDIT_USD;
                                After_Insert.JOIN_RP_CREDIT_CURRENCY_ISO = Record_OutputToDB.JOIN_RP_CREDIT_CURRENCY_ISO;
                                After_Insert.JOIN_MANUAL_DRIVING_CREDIT = Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT;
                                After_Insert.JOIN_MANUAL_DRIVING_CREDIT_USD = Record_OutputToDB.JOIN_MANUAL_DRIVING_CREDIT_USD;
                                After_Insert.JOIN_MANUAL_CURRENCY_ISO = Record_OutputToDB.JOIN_MANUAL_CURRENCY_ISO;
                                After_Insert.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = Record_OutputToDB.JOIN_WAIVE_FIRST_ANNUAL_FEE_P;
                                After_Insert.LAST_JOIN_DATE = Record_OutputToDB.LAST_JOIN_DATE;
                                After_Insert.LAST_JOIN_ZIPFLEET_ID = Record_OutputToDB.LAST_JOIN_ZIPFLEET_ID;
                                After_Insert.LAST_JOIN_RATE_PLAN_ID = Record_OutputToDB.LAST_JOIN_RATE_PLAN_ID;
                                After_Insert.LAST_REJOIN_DATE = Record_OutputToDB.LAST_REJOIN_DATE;
                                After_Insert.LAST_REJOIN_RATE_PLAN_ID = Record_OutputToDB.LAST_REJOIN_RATE_PLAN_ID;
                                After_Insert.LAST_REJOIN_ZIPFLEET_ID = Record_OutputToDB.LAST_REJOIN_ZIPFLEET_ID;
                                After_Insert.DELETED_DATE = Record_OutputToDB.DELETED_DATE;
                                After_Insert.LAST_JOIN_ACCOUNT_ID = Record_OutputToDB.LAST_JOIN_ACCOUNT_ID;
                                After_Insert.LAST_JOIN_AFFILIATE_ID = Record_OutputToDB.LAST_JOIN_AFFILIATE_ID;
                                After_Insert.JOIN_ACCOUNT_ID = Record_OutputToDB.JOIN_ACCOUNT_ID;
                                After_Insert.JOIN_AFFILIATE_ID = Record_OutputToDB.JOIN_AFFILIATE_ID;
                                After_Insert.LAST_CHANGED_RATE_PLAN_ID = Record_OutputToDB.LAST_CHANGED_RATE_PLAN_ID;
                                After_Insert.LAST_CHANGED_RATE_PLAN_DATE = Record_OutputToDB.LAST_CHANGED_RATE_PLAN_DATE;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.JOIN_DATE = After_Insert.JOIN_DATE;
               Log_Rows.JOIN_ZIPFLEET_ID = After_Insert.JOIN_ZIPFLEET_ID;
               Log_Rows.JOIN_RATE_PLAN_ID = After_Insert.JOIN_RATE_PLAN_ID;
               Log_Rows.JOIN_APP_FEE = After_Insert.JOIN_APP_FEE;
               Log_Rows.JOIN_APP_FEE_USD = After_Insert.JOIN_APP_FEE_USD;
               Log_Rows.JOIN_APP_FEE_CURRENCY_ISO = After_Insert.JOIN_APP_FEE_CURRENCY_ISO;
               Log_Rows.JOIN_ANNUAL_FEE = After_Insert.JOIN_ANNUAL_FEE;
               Log_Rows.JOIN_ANNUAL_FEE_USD = After_Insert.JOIN_ANNUAL_FEE_USD;
               Log_Rows.JOIN_ANN_FEE_CURRENCY_ISO = After_Insert.JOIN_ANN_FEE_CURRENCY_ISO;
               Log_Rows.JOIN_ANNLZD_ANN_FEE = After_Insert.JOIN_ANNLZD_ANN_FEE;
               Log_Rows.JOIN_ANNLZD_ANN_FEE_USD = After_Insert.JOIN_ANNLZD_ANN_FEE_USD;
               Log_Rows.JOIN_COUPON_ID = After_Insert.JOIN_COUPON_ID;
               Log_Rows.JOIN_COUPON = After_Insert.JOIN_COUPON;
               Log_Rows.JOIN_DRIVING_CREDIT = After_Insert.JOIN_DRIVING_CREDIT;
               Log_Rows.JOIN_DRIVING_CREDIT_USD = After_Insert.JOIN_DRIVING_CREDIT_USD;
               Log_Rows.JOIN_CASH_CREDIT = After_Insert.JOIN_CASH_CREDIT;
               Log_Rows.JOIN_CASH_CREDIT_USD = After_Insert.JOIN_CASH_CREDIT_USD;
               Log_Rows.JOIN_RP_CREDIT = After_Insert.JOIN_RP_CREDIT;
               Log_Rows.JOIN_RP_CREDIT_USD = After_Insert.JOIN_RP_CREDIT_USD;
               Log_Rows.JOIN_RP_CREDIT_CURRENCY_ISO = After_Insert.JOIN_RP_CREDIT_CURRENCY_ISO;
               Log_Rows.JOIN_MANUAL_DRIVING_CREDIT = After_Insert.JOIN_MANUAL_DRIVING_CREDIT;
               Log_Rows.JOIN_MANUAL_DRIVING_CREDIT_USD = After_Insert.JOIN_MANUAL_DRIVING_CREDIT_USD;
               Log_Rows.JOIN_MANUAL_CURRENCY_ISO = After_Insert.JOIN_MANUAL_CURRENCY_ISO;
               Log_Rows.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = After_Insert.JOIN_WAIVE_FIRST_ANNUAL_FEE_P;
               Log_Rows.LAST_JOIN_DATE = After_Insert.LAST_JOIN_DATE;
               Log_Rows.LAST_JOIN_ZIPFLEET_ID = After_Insert.LAST_JOIN_ZIPFLEET_ID;
               Log_Rows.LAST_JOIN_RATE_PLAN_ID = After_Insert.LAST_JOIN_RATE_PLAN_ID;
               Log_Rows.LAST_REJOIN_DATE = After_Insert.LAST_REJOIN_DATE;
               Log_Rows.LAST_REJOIN_RATE_PLAN_ID = After_Insert.LAST_REJOIN_RATE_PLAN_ID;
               Log_Rows.LAST_REJOIN_ZIPFLEET_ID = After_Insert.LAST_REJOIN_ZIPFLEET_ID;
               Log_Rows.DELETED_DATE = After_Insert.DELETED_DATE;
               Log_Rows.LAST_JOIN_ACCOUNT_ID = After_Insert.LAST_JOIN_ACCOUNT_ID;
               Log_Rows.LAST_JOIN_AFFILIATE_ID = After_Insert.LAST_JOIN_AFFILIATE_ID;
               Log_Rows.JOIN_ACCOUNT_ID = After_Insert.JOIN_ACCOUNT_ID;
               Log_Rows.JOIN_AFFILIATE_ID = After_Insert.JOIN_AFFILIATE_ID;
               Log_Rows.LAST_CHANGED_RATE_PLAN_ID = After_Insert.LAST_CHANGED_RATE_PLAN_ID;
               Log_Rows.LAST_CHANGED_RATE_PLAN_DATE = After_Insert.LAST_CHANGED_RATE_PLAN_DATE;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"ACCOUNT_ID\",\"JOIN_DATE\",\"JOIN_ZIPFLEET_ID\",\"JOIN_RATE_PLAN_ID\",\"JOIN_APP_FEE\",\"JOIN_APP_FEE_USD\",\"JOIN_APP_FEE_CURRENCY_ISO\",\"JOIN_ANNUAL_FEE\",\"JOIN_ANNUAL_FEE_USD\",\"JOIN_ANN_FEE_CURRENCY_ISO\",\"JOIN_ANNLZD_ANN_FEE\",\"JOIN_ANNLZD_ANN_FEE_USD\",\"JOIN_COUPON_ID\",\"JOIN_COUPON\",\"JOIN_DRIVING_CREDIT\",\"JOIN_DRIVING_CREDIT_USD\",\"JOIN_CASH_CREDIT\",\"JOIN_CASH_CREDIT_USD\",\"JOIN_RP_CREDIT\",\"JOIN_RP_CREDIT_USD\",\"JOIN_RP_CREDIT_CURRENCY_ISO\",\"JOIN_MANUAL_DRIVING_CREDIT\",\"JOIN_MANUAL_DRIVING_CREDIT_USD\",\"JOIN_MANUAL_CURRENCY_ISO\",\"JOIN_WAIVE_FIRST_ANNUAL_FEE_P\",\"LAST_JOIN_DATE\",\"LAST_JOIN_ZIPFLEET_ID\",\"LAST_JOIN_RATE_PLAN_ID\",\"LAST_REJOIN_DATE\",\"LAST_REJOIN_RATE_PLAN_ID\",\"LAST_REJOIN_ZIPFLEET_ID\",\"DELETED_DATE\",\"LAST_JOIN_ACCOUNT_ID\",\"LAST_JOIN_AFFILIATE_ID\",\"JOIN_ACCOUNT_ID\",\"JOIN_AFFILIATE_ID\",\"LAST_CHANGED_RATE_PLAN_ID\",\"LAST_CHANGED_RATE_PLAN_DATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.JOIN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.JOIN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.JOIN_RATE_PLAN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_RATE_PLAN_ID);
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_FEE==null){
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_APP_FEE);
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_FEE_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_APP_FEE_USD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_APP_FEE_CURRENCY_ISO==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_APP_FEE_CURRENCY_ISO);
					...
					if(bufferLtRedshiftOutput_1.JOIN_ANNUAL_FEE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_ANNUAL_FEE);
					...
					if(bufferLtRedshiftOutput_1.JOIN_ANNUAL_FEE_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_ANNUAL_FEE_USD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_ANN_FEE_CURRENCY_ISO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_ANN_FEE_CURRENCY_ISO);
					...
					if(bufferLtRedshiftOutput_1.JOIN_ANNLZD_ANN_FEE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_ANNLZD_ANN_FEE);
					...
					if(bufferLtRedshiftOutput_1.JOIN_ANNLZD_ANN_FEE_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_ANNLZD_ANN_FEE_USD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_COUPON_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_COUPON_ID);
					...
					if(bufferLtRedshiftOutput_1.JOIN_COUPON==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_COUPON);
					...
					if(bufferLtRedshiftOutput_1.JOIN_DRIVING_CREDIT==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_DRIVING_CREDIT);
					...
					if(bufferLtRedshiftOutput_1.JOIN_DRIVING_CREDIT_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_DRIVING_CREDIT_USD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_CASH_CREDIT==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_CASH_CREDIT);
					...
					if(bufferLtRedshiftOutput_1.JOIN_CASH_CREDIT_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_CASH_CREDIT_USD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_RP_CREDIT==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_RP_CREDIT);
					...
					if(bufferLtRedshiftOutput_1.JOIN_RP_CREDIT_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_RP_CREDIT_USD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_RP_CREDIT_CURRENCY_ISO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_RP_CREDIT_CURRENCY_ISO);
					...
					if(bufferLtRedshiftOutput_1.JOIN_MANUAL_DRIVING_CREDIT==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_MANUAL_DRIVING_CREDIT);
					...
					if(bufferLtRedshiftOutput_1.JOIN_MANUAL_DRIVING_CREDIT_USD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_MANUAL_DRIVING_CREDIT_USD);
					...
					if(bufferLtRedshiftOutput_1.JOIN_MANUAL_CURRENCY_ISO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_MANUAL_CURRENCY_ISO);
					...
					if(bufferLtRedshiftOutput_1.JOIN_WAIVE_FIRST_ANNUAL_FEE_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_WAIVE_FIRST_ANNUAL_FEE_P);
					...
					if(bufferLtRedshiftOutput_1.LAST_JOIN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.LAST_JOIN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.LAST_JOIN_ZIPFLEET_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_JOIN_ZIPFLEET_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_JOIN_RATE_PLAN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_JOIN_RATE_PLAN_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_REJOIN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.LAST_REJOIN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.LAST_REJOIN_RATE_PLAN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_REJOIN_RATE_PLAN_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_REJOIN_ZIPFLEET_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_REJOIN_ZIPFLEET_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_JOIN_ACCOUNT_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_JOIN_ACCOUNT_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_JOIN_AFFILIATE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_JOIN_AFFILIATE_ID);
					...
					if(bufferLtRedshiftOutput_1.JOIN_ACCOUNT_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_ACCOUNT_ID);
					...
					if(bufferLtRedshiftOutput_1.JOIN_AFFILIATE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.JOIN_AFFILIATE_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_CHANGED_RATE_PLAN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_CHANGED_RATE_PLAN_ID);
					...
					if(bufferLtRedshiftOutput_1.LAST_CHANGED_RATE_PLAN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.LAST_CHANGED_RATE_PLAN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
...
String fileName_tFileOutputDelimited_1 = "";
    ...
    globalMap.put("tFileOutputDelimited_1_FILE_NAME",fileName_tFileOutputDelimited_1);
                String[] headColutFileOutputDelimited_1=new String[39];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.JOIN_ZIPFLEET_ID = null;
					
							row1.JOIN_RATE_PLAN_ID = null;
					
							row1.JOIN_APP_FEE = null;
					
							row1.JOIN_APP_FEE_USD = null;
					
							row1.JOIN_APP_FEE_CURRENCY_ISO = null;
					
							row1.JOIN_ANNUAL_FEE = null;
					
							row1.JOIN_ANNUAL_FEE_USD = null;
					
							row1.JOIN_ANN_FEE_CURRENCY_ISO = null;
					
							row1.JOIN_ANNLZD_ANN_FEE = null;
					
							row1.JOIN_ANNLZD_ANN_FEE_USD = null;
					
							row1.JOIN_COUPON_ID = null;
					
							row1.JOIN_COUPON = null;
					
							row1.JOIN_DRIVING_CREDIT = null;
					
							row1.JOIN_DRIVING_CREDIT_USD = null;
					
							row1.JOIN_CASH_CREDIT = null;
					
							row1.JOIN_CASH_CREDIT_USD = null;
					
							row1.JOIN_RP_CREDIT = null;
					
							row1.JOIN_RP_CREDIT_USD = null;
					
							row1.JOIN_RP_CREDIT_CURRENCY_ISO = null;
					
							row1.JOIN_MANUAL_DRIVING_CREDIT = null;
					
							row1.JOIN_MANUAL_DRIVING_CREDIT_USD = null;
					
							row1.JOIN_MANUAL_CURRENCY_ISO = null;
					
							row1.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = null;
					
							row1.LAST_JOIN_DATE = null;
					
							row1.LAST_JOIN_ZIPFLEET_ID = null;
					
							row1.LAST_JOIN_RATE_PLAN_ID = null;
					
							row1.LAST_REJOIN_DATE = null;
					
							row1.LAST_REJOIN_RATE_PLAN_ID = null;
					
							row1.LAST_REJOIN_ZIPFLEET_ID = null;
					
							row1.DELETED_DATE = null;
					
							row1.LAST_JOIN_ACCOUNT_ID = null;
					
							row1.LAST_JOIN_AFFILIATE_ID = null;
					
							row1.JOIN_ACCOUNT_ID = null;
					
							row1.JOIN_AFFILIATE_ID = null;
					
							row1.LAST_CHANGED_RATE_PLAN_ID = null;
					
							row1.LAST_CHANGED_RATE_PLAN_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.JOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_APP_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_APP_FEE_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_APP_FEE_CURRENCY_ISO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_ANNUAL_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_ANNUAL_FEE_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_ANN_FEE_CURRENCY_ISO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_ANNLZD_ANN_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_ANNLZD_ANN_FEE_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_COUPON_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_COUPON = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_DRIVING_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_DRIVING_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_CASH_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_CASH_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_RP_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_RP_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_RP_CREDIT_CURRENCY_ISO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_MANUAL_DRIVING_CREDIT = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_MANUAL_DRIVING_CREDIT_USD = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_MANUAL_CURRENCY_ISO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.LAST_JOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_JOIN_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_JOIN_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.LAST_REJOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_REJOIN_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_REJOIN_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_JOIN_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_JOIN_AFFILIATE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.JOIN_AFFILIATE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LAST_CHANGED_RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.LAST_CHANGED_RATE_PLAN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
...
row2.JOIN_DATE = row1.JOIN_DATE;
row2.JOIN_ZIPFLEET_ID = row1.JOIN_ZIPFLEET_ID;
row2.JOIN_RATE_PLAN_ID = row1.JOIN_RATE_PLAN_ID;
row2.JOIN_APP_FEE = row1.JOIN_APP_FEE;
row2.JOIN_APP_FEE_USD = row1.JOIN_APP_FEE_USD;
row2.JOIN_APP_FEE_CURRENCY_ISO = StringUtils.trimToNull(row1.JOIN_APP_FEE_CURRENCY_ISO);
row2.JOIN_ANNUAL_FEE = row1.JOIN_ANNUAL_FEE;
row2.JOIN_ANNUAL_FEE_USD = row1.JOIN_ANNUAL_FEE_USD;
row2.JOIN_ANN_FEE_CURRENCY_ISO = StringUtils.trimToNull(row1.JOIN_ANN_FEE_CURRENCY_ISO);
row2.JOIN_ANNLZD_ANN_FEE = row1.JOIN_ANNLZD_ANN_FEE;
row2.JOIN_ANNLZD_ANN_FEE_USD = row1.JOIN_ANNLZD_ANN_FEE_USD;
row2.JOIN_COUPON_ID = row1.JOIN_COUPON_ID;
row2.JOIN_COUPON = row1.JOIN_COUPON;
row2.JOIN_DRIVING_CREDIT = row1.JOIN_DRIVING_CREDIT;
row2.JOIN_DRIVING_CREDIT_USD = row1.JOIN_DRIVING_CREDIT_USD;
row2.JOIN_CASH_CREDIT = row1.JOIN_CASH_CREDIT;
row2.JOIN_CASH_CREDIT_USD = row1.JOIN_CASH_CREDIT_USD;
row2.JOIN_RP_CREDIT = row1.JOIN_RP_CREDIT;
row2.JOIN_RP_CREDIT_USD = row1.JOIN_RP_CREDIT_USD;
row2.JOIN_RP_CREDIT_CURRENCY_ISO = StringUtils.trimToNull(row1.JOIN_RP_CREDIT_CURRENCY_ISO);
row2.JOIN_MANUAL_DRIVING_CREDIT = row1.JOIN_MANUAL_DRIVING_CREDIT;
row2.JOIN_MANUAL_DRIVING_CREDIT_USD = row1.JOIN_MANUAL_DRIVING_CREDIT_USD;
row2.JOIN_MANUAL_CURRENCY_ISO = StringUtils.trimToNull(row1.JOIN_MANUAL_CURRENCY_ISO);
row2.JOIN_WAIVE_FIRST_ANNUAL_FEE_P = BooleanUtils.boolChar(row1.JOIN_WAIVE_FIRST_ANNUAL_FEE_P);
row2.LAST_JOIN_DATE = row1.LAST_JOIN_DATE;
row2.LAST_JOIN_ZIPFLEET_ID = row1.LAST_JOIN_ZIPFLEET_ID;
row2.LAST_JOIN_RATE_PLAN_ID = row1.LAST_JOIN_RATE_PLAN_ID;
row2.LAST_REJOIN_DATE = row1.LAST_REJOIN_DATE;
row2.LAST_REJOIN_RATE_PLAN_ID = row1.LAST_REJOIN_RATE_PLAN_ID;
row2.LAST_REJOIN_ZIPFLEET_ID = row1.LAST_REJOIN_ZIPFLEET_ID;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.LAST_JOIN_ACCOUNT_ID = row1.LAST_JOIN_ACCOUNT_ID;
row2.LAST_JOIN_AFFILIATE_ID = row1.LAST_JOIN_AFFILIATE_ID;
row2.JOIN_ACCOUNT_ID = row1.JOIN_ACCOUNT_ID;
row2.JOIN_AFFILIATE_ID = row1.JOIN_AFFILIATE_ID;
row2.LAST_CHANGED_RATE_PLAN_ID = row1.LAST_CHANGED_RATE_PLAN_ID;
row2.LAST_CHANGED_RATE_PLAN_DATE = row1.LAST_CHANGED_RATE_PLAN_DATE;
    nb_line_tJavaRow_2++;   
			...
			//row2
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[39];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.MEMBER_ID);
                            rowtFileOutputDelimited_1[1]=row2.ACCOUNT_ID == null ? null : String.valueOf(row2.ACCOUNT_ID);
                            rowtFileOutputDelimited_1[2]=row2.JOIN_DATE == null ? null : FormatterUtils.format_Date(row2.JOIN_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[3]=row2.JOIN_ZIPFLEET_ID == null ? null : String.valueOf(row2.JOIN_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[4]=row2.JOIN_RATE_PLAN_ID == null ? null : String.valueOf(row2.JOIN_RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[5]=row2.JOIN_APP_FEE == null ? null : String.valueOf(row2.JOIN_APP_FEE);
                            rowtFileOutputDelimited_1[6]=row2.JOIN_APP_FEE_USD == null ? null : String.valueOf(row2.JOIN_APP_FEE_USD);
                            rowtFileOutputDelimited_1[7]=row2.JOIN_APP_FEE_CURRENCY_ISO == null ? null : row2.JOIN_APP_FEE_CURRENCY_ISO;
                            rowtFileOutputDelimited_1[8]=row2.JOIN_ANNUAL_FEE == null ? null : String.valueOf(row2.JOIN_ANNUAL_FEE);
                            rowtFileOutputDelimited_1[9]=row2.JOIN_ANNUAL_FEE_USD == null ? null : String.valueOf(row2.JOIN_ANNUAL_FEE_USD);
                            rowtFileOutputDelimited_1[10]=row2.JOIN_ANN_FEE_CURRENCY_ISO == null ? null : row2.JOIN_ANN_FEE_CURRENCY_ISO;
                            rowtFileOutputDelimited_1[11]=row2.JOIN_ANNLZD_ANN_FEE == null ? null : String.valueOf(row2.JOIN_ANNLZD_ANN_FEE);
                            rowtFileOutputDelimited_1[12]=row2.JOIN_ANNLZD_ANN_FEE_USD == null ? null : String.valueOf(row2.JOIN_ANNLZD_ANN_FEE_USD);
                            rowtFileOutputDelimited_1[13]=row2.JOIN_COUPON_ID == null ? null : String.valueOf(row2.JOIN_COUPON_ID);
                            rowtFileOutputDelimited_1[14]=row2.JOIN_COUPON == null ? null : row2.JOIN_COUPON;
                            rowtFileOutputDelimited_1[15]=row2.JOIN_DRIVING_CREDIT == null ? null : String.valueOf(row2.JOIN_DRIVING_CREDIT);
                            rowtFileOutputDelimited_1[16]=row2.JOIN_DRIVING_CREDIT_USD == null ? null : String.valueOf(row2.JOIN_DRIVING_CREDIT_USD);
                            rowtFileOutputDelimited_1[17]=row2.JOIN_CASH_CREDIT == null ? null : String.valueOf(row2.JOIN_CASH_CREDIT);
                            rowtFileOutputDelimited_1[18]=row2.JOIN_CASH_CREDIT_USD == null ? null : String.valueOf(row2.JOIN_CASH_CREDIT_USD);
                            rowtFileOutputDelimited_1[19]=row2.JOIN_RP_CREDIT == null ? null : String.valueOf(row2.JOIN_RP_CREDIT);
                            rowtFileOutputDelimited_1[20]=row2.JOIN_RP_CREDIT_USD == null ? null : String.valueOf(row2.JOIN_RP_CREDIT_USD);
                            rowtFileOutputDelimited_1[21]=row2.JOIN_RP_CREDIT_CURRENCY_ISO == null ? null : row2.JOIN_RP_CREDIT_CURRENCY_ISO;
                            rowtFileOutputDelimited_1[22]=row2.JOIN_MANUAL_DRIVING_CREDIT == null ? null : String.valueOf(row2.JOIN_MANUAL_DRIVING_CREDIT);
                            rowtFileOutputDelimited_1[23]=row2.JOIN_MANUAL_DRIVING_CREDIT_USD == null ? null : String.valueOf(row2.JOIN_MANUAL_DRIVING_CREDIT_USD);
                            rowtFileOutputDelimited_1[24]=row2.JOIN_MANUAL_CURRENCY_ISO == null ? null : row2.JOIN_MANUAL_CURRENCY_ISO;
                            rowtFileOutputDelimited_1[25]=row2.JOIN_WAIVE_FIRST_ANNUAL_FEE_P == null ? null : row2.JOIN_WAIVE_FIRST_ANNUAL_FEE_P;
                            rowtFileOutputDelimited_1[26]=row2.LAST_JOIN_DATE == null ? null : FormatterUtils.format_Date(row2.LAST_JOIN_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[27]=row2.LAST_JOIN_ZIPFLEET_ID == null ? null : String.valueOf(row2.LAST_JOIN_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[28]=row2.LAST_JOIN_RATE_PLAN_ID == null ? null : String.valueOf(row2.LAST_JOIN_RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[29]=row2.LAST_REJOIN_DATE == null ? null : FormatterUtils.format_Date(row2.LAST_REJOIN_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[30]=row2.LAST_REJOIN_RATE_PLAN_ID == null ? null : String.valueOf(row2.LAST_REJOIN_RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[31]=row2.LAST_REJOIN_ZIPFLEET_ID == null ? null : String.valueOf(row2.LAST_REJOIN_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[32]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[33]=row2.LAST_JOIN_ACCOUNT_ID == null ? null : String.valueOf(row2.LAST_JOIN_ACCOUNT_ID);
                            rowtFileOutputDelimited_1[34]=row2.LAST_JOIN_AFFILIATE_ID == null ? null : String.valueOf(row2.LAST_JOIN_AFFILIATE_ID);
                            rowtFileOutputDelimited_1[35]=row2.JOIN_ACCOUNT_ID == null ? null : String.valueOf(row2.JOIN_ACCOUNT_ID);
                            rowtFileOutputDelimited_1[36]=row2.JOIN_AFFILIATE_ID == null ? null : String.valueOf(row2.JOIN_AFFILIATE_ID);
                            rowtFileOutputDelimited_1[37]=row2.LAST_CHANGED_RATE_PLAN_ID == null ? null : String.valueOf(row2.LAST_CHANGED_RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[38]=row2.LAST_CHANGED_RATE_PLAN_DATE == null ? null : FormatterUtils.format_Date(row2.LAST_CHANGED_RATE_PLAN_DATE, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_MemberJoinInfo StageFeed_MemberJoinInfoClass = new StageFeed_MemberJoinInfo();

        int exitCode = StageFeed_MemberJoinInfoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_MemberJoinInfo.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_memberjoininfo_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_MemberJoinInfo");
        }
...
/************************************************************************************************
 *     542486 characters generated by Talend Open Studio for Data Integration 
 *     on the October 16, 2018 5:21:42 PM CDT
 ************************************************************************************************/