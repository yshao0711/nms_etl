...
package zipcar_marketingdw.processstaging_strongviewdevicedata_0_1;
...
/**
 * Job: ProcessStaging_StrongviewDeviceData Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_StrongviewDeviceData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_StrongviewDeviceData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_lF2tMMsNEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_StrongviewDeviceData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_StrongviewDeviceData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDeviceData) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "strongview_device_data";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_strongview_device_data";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_strongview_device_data\n(\n	data_captured_dt,\n	device_event_typ,\n	source_ip,\n	serial_no,\n	mailing_id,\n	database_id,\n	message_id,\n	user_id,\n	link_id,\n	user_agent_header,\n	url_path,\n	composite_device_cat_code,\n    imported_date\n)\nSELECT \n	data_captured_dt,\n	device_event_typ,\n	source_ip,\n	serial_no,\n	mailing_id,\n	database_id,\n	message_id,\n	user_id,\n	link_id,\n	user_agent_header,\n	url_path,\n	composite_device_cat_code,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.strongview_device_data\nMINUS\nSELECT \n	data_captured_dt,\n	device_event_typ,\n	source_ip,\n	serial_no,\n	mailing_id,\n	database_id,\n	message_id,\n	user_id,\n	link_id,\n	user_agent_header,\n	url_path,\n	composite_device_cat_code,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_strongview_device_data\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".strongview_device_data";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_StrongviewDeviceData ProcessStaging_StrongviewDeviceDataClass = new ProcessStaging_StrongviewDeviceData();

        int exitCode = ProcessStaging_StrongviewDeviceDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_StrongviewDeviceData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_strongviewdevicedata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_StrongviewDeviceData");
        }
...
/************************************************************************************************
 *     136391 characters generated by Talend Open Studio for Data Integration 
