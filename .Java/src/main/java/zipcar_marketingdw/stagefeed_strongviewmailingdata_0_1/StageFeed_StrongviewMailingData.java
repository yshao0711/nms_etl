...
package zipcar_marketingdw.stagefeed_strongviewmailingdata_0_1;
...
/**
 * Job: StageFeed_StrongviewMailingData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewMailingData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewMailingData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_tfSjADTQEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewMailingData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewMailingData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_MAILING_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_MAILING_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_MAILING_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public Integer actual_sent_count;

				public Integer getActual_sent_count () {
					return this.actual_sent_count;
				}
				
			    public Integer bounce_count;

				public Integer getBounce_count () {
			    ...
			    public Integer mailed_count;

				public Integer getMailed_count () {
					return this.mailed_count;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.mailing_id;
	...
	public boolean equals(Object obj) {
		...
		final Log_RowsStruct other = (Log_RowsStruct) obj;
						...
						if (this.mailing_id != other.mailing_id)
							return false;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.actual_sent_count = this.actual_sent_count;
	            other.bounce_count = this.bounce_count;
	            other.campaign_id = this.campaign_id;
	            other.campaign_name = this.campaign_name;
	            other.click_count = this.click_count;
	            other.data_source_id = this.data_source_id;
	            other.department_id = this.department_id;
	            other.mailed_count = this.mailed_count;
	            other.mailing_id = this.mailing_id;
	            other.open_count = this.open_count;
	            other.parent_id = this.parent_id;
	            other.subject_line = this.subject_line;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewMailingData) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.actual_sent_count = readInteger(dis);
					
						this.bounce_count = readInteger(dis);
					...
					this.campaign_name = readString(dis);
						...
						this.click_count = readInteger(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.data_source_id = null;
           				} else {
           			    	this.data_source_id = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.department_id = dis.readLong();
           				}
					
						this.mailed_count = readInteger(dis);
					
			        this.mailing_id = dis.readLong();
					
						this.open_count = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.actual_sent_count,dos);
					
					// Integer
				
						writeInteger(this.bounce_count,dos);
					...
					// Integer
						...
						writeInteger(this.click_count,dos);
					...
					// Long
						...
						if(this.data_source_id == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeLong(this.data_source_id);
		            	}
					...
					// Long
						...
						if(this.department_id == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeLong(this.department_id);
		            	}
					
					// Integer
				
						writeInteger(this.mailed_count,dos);
					...
					// Integer
						...
						writeInteger(this.open_count,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("actual_sent_count="+String.valueOf(actual_sent_count));
		sb.append(",bounce_count="+String.valueOf(bounce_count));
		sb.append(",campaign_id="+String.valueOf(campaign_id));
		sb.append(",campaign_name="+campaign_name);
		sb.append(",click_count="+String.valueOf(click_count));
		sb.append(",data_source_id="+String.valueOf(data_source_id));
		sb.append(",department_id="+String.valueOf(department_id));
		sb.append(",mailed_count="+String.valueOf(mailed_count));
		sb.append(",mailing_id="+String.valueOf(mailing_id));
		sb.append(",open_count="+String.valueOf(open_count));
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.mailing_id, other.mailing_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						Integer actual_sent_count;
						
	            		public BufferLine_tRedshiftOutput_1 c0(Integer actual_sent_count){
							this.actual_sent_count = actual_sent_count;
							return this;
						}				
						Integer bounce_count;
						
	            		public BufferLine_tRedshiftOutput_1 c1(Integer bounce_count){
							this.bounce_count = bounce_count;
							return this;
						}				
						Long campaign_id;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Long campaign_id){
							this.campaign_id = campaign_id;
							return this;
						}				
						String campaign_name;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String campaign_name){
							this.campaign_name = campaign_name;
							return this;
						}				
						Integer click_count;
						
	            		public BufferLine_tRedshiftOutput_1 c4(Integer click_count){
							this.click_count = click_count;
							return this;
						}				
						Long data_source_id;
						
	            		public BufferLine_tRedshiftOutput_1 c5(Long data_source_id){
							this.data_source_id = data_source_id;
							return this;
						}				
						Long department_id;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Long department_id){
							this.department_id = department_id;
							return this;
						}				
						Integer mailed_count;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Integer mailed_count){
							this.mailed_count = mailed_count;
							return this;
						}				
						long mailing_id;
						
	            		public BufferLine_tRedshiftOutput_1 c8(long mailing_id){
							this.mailing_id = mailing_id;
							return this;
						}				
						Integer open_count;
						
	            		public BufferLine_tRedshiftOutput_1 c9(Integer open_count){
							this.open_count = open_count;
							return this;
						}				
						Long parent_id;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Long parent_id){
							this.parent_id = parent_id;
							return this;
						}				
						String subject_line;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String subject_line){
							this.subject_line = subject_line;
							return this;
						}				
						java.util.Date start_time;
						
	            		public BufferLine_tRedshiftOutput_1 c12(java.util.Date start_time){
							this.start_time = start_time;
							return this;
						}				
						java.util.Date end_time;
						
	            		public BufferLine_tRedshiftOutput_1 c13(java.util.Date end_time){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"actual_sent_count\",\"bounce_count\",\"campaign_id\",\"campaign_name\",\"click_count\",\"data_source_id\",\"department_id\",\"mailed_count\",\"mailing_id\",\"open_count\",\"parent_id\",\"subject_line\",\"start_time\",\"end_time\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.actual_sent_count = null;
					
							Row_FeedRecord.bounce_count = null;
					
							Row_FeedRecord.campaign_id = null;
					
							Row_FeedRecord.campaign_name = null;
					
							Row_FeedRecord.click_count = null;
					
							Row_FeedRecord.data_source_id = null;
					
							Row_FeedRecord.department_id = null;
					
							Row_FeedRecord.mailed_count = null;
					
							Row_FeedRecord.mailing_id = 0;
					
							Row_FeedRecord.open_count = null;
					
							Row_FeedRecord.parent_id = null;
					
							Row_FeedRecord.subject_line = null;
					
							Row_FeedRecord.start_time = null;
					
							Row_FeedRecord.end_time = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.actual_sent_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.bounce_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.campaign_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.campaign_name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.click_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.data_source_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.department_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.mailed_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.mailing_id = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'mailing_id' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.open_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.parent_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.subject_line = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.start_time = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.end_time = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
...
Record_OutputToDB.actual_sent_count = Row_FeedRecord.actual_sent_count;
Record_OutputToDB.bounce_count = Row_FeedRecord.bounce_count;
Record_OutputToDB.campaign_id = Row_FeedRecord.campaign_id;
Record_OutputToDB.campaign_name = StringUtils.trimToNull(Row_FeedRecord.campaign_name);
Record_OutputToDB.click_count = Row_FeedRecord.click_count;
Record_OutputToDB.data_source_id = Row_FeedRecord.data_source_id;
Record_OutputToDB.department_id = Row_FeedRecord.department_id;
Record_OutputToDB.mailed_count = Row_FeedRecord.mailed_count;
Record_OutputToDB.mailing_id = Row_FeedRecord.mailing_id;
Record_OutputToDB.open_count = Row_FeedRecord.open_count;
Record_OutputToDB.parent_id = Row_FeedRecord.parent_id;
Record_OutputToDB.subject_line = StringUtils.trimToNull(Row_FeedRecord.subject_line);
Record_OutputToDB.start_time = Row_FeedRecord.start_time;
Record_OutputToDB.end_time = Row_FeedRecord.end_time;
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(Record_OutputToDB.actual_sent_count==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.actual_sent_count);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.bounce_count==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.bounce_count);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.campaign_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.campaign_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.campaign_name==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.campaign_name);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.click_count==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.click_count);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.data_source_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.data_source_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.department_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.department_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.mailed_count==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.mailed_count);
						...
						countertRedshiftOutput_1++;
							...
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.mailing_id);
							
						countertRedshiftOutput_1++;
						

						
							if(Record_OutputToDB.open_count==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.open_count);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.parent_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.parent_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.subject_line==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.subject_line);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.end_time!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.end_time.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.actual_sent_count)
                        .c1(Record_OutputToDB.bounce_count)
                        .c2(Record_OutputToDB.campaign_id)
                        .c3(Record_OutputToDB.campaign_name)
                        .c4(Record_OutputToDB.click_count)
                        .c5(Record_OutputToDB.data_source_id)
                        .c6(Record_OutputToDB.department_id)
                        .c7(Record_OutputToDB.mailed_count)
                        .c8(Record_OutputToDB.mailing_id)
                        .c9(Record_OutputToDB.open_count)
                        .c10(Record_OutputToDB.parent_id)
                        .c11(Record_OutputToDB.subject_line)
                        .c12(Record_OutputToDB.start_time)
                        .c13(Record_OutputToDB.end_time)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.actual_sent_count = Record_OutputToDB.actual_sent_count;
                                After_Insert.bounce_count = Record_OutputToDB.bounce_count;
                                After_Insert.campaign_id = Record_OutputToDB.campaign_id;
                                After_Insert.campaign_name = Record_OutputToDB.campaign_name;
                                After_Insert.click_count = Record_OutputToDB.click_count;
                                After_Insert.data_source_id = Record_OutputToDB.data_source_id;
                                After_Insert.department_id = Record_OutputToDB.department_id;
                                After_Insert.mailed_count = Record_OutputToDB.mailed_count;
                                After_Insert.mailing_id = Record_OutputToDB.mailing_id;
                                After_Insert.open_count = Record_OutputToDB.open_count;
                                After_Insert.parent_id = Record_OutputToDB.parent_id;
                                After_Insert.subject_line = Record_OutputToDB.subject_line;
                                After_Insert.start_time = Record_OutputToDB.start_time;
                                After_Insert.end_time = Record_OutputToDB.end_time;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.actual_sent_count = After_Insert.actual_sent_count;
               Log_Rows.bounce_count = After_Insert.bounce_count;
               Log_Rows.campaign_id = After_Insert.campaign_id;
               Log_Rows.campaign_name = After_Insert.campaign_name;
               Log_Rows.click_count = After_Insert.click_count;
               Log_Rows.data_source_id = After_Insert.data_source_id;
               Log_Rows.department_id = After_Insert.department_id;
               Log_Rows.mailed_count = After_Insert.mailed_count;
               Log_Rows.mailing_id = After_Insert.mailing_id;
               Log_Rows.open_count = After_Insert.open_count;
               Log_Rows.parent_id = After_Insert.parent_id;
               Log_Rows.subject_line = After_Insert.subject_line;
               Log_Rows.start_time = After_Insert.start_time;
               Log_Rows.end_time = After_Insert.end_time;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"actual_sent_count\",\"bounce_count\",\"campaign_id\",\"campaign_name\",\"click_count\",\"data_source_id\",\"department_id\",\"mailed_count\",\"mailing_id\",\"open_count\",\"parent_id\",\"subject_line\",\"start_time\",\"end_time\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					if(bufferLtRedshiftOutput_1.actual_sent_count==null){
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.actual_sent_count);
					...
					if(bufferLtRedshiftOutput_1.bounce_count==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.bounce_count);
					...
					if(bufferLtRedshiftOutput_1.campaign_id==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.campaign_id);
					...
					if(bufferLtRedshiftOutput_1.campaign_name==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.campaign_name);
					...
					if(bufferLtRedshiftOutput_1.click_count==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.click_count);
					...
					if(bufferLtRedshiftOutput_1.data_source_id==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.data_source_id);
					...
					if(bufferLtRedshiftOutput_1.department_id==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.department_id);
					...
					if(bufferLtRedshiftOutput_1.mailed_count==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.mailed_count);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.mailing_id);
					
	                    counttRedshiftOutput_1++;
	                    
					if(bufferLtRedshiftOutput_1.open_count==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.open_count);
					...
					if(bufferLtRedshiftOutput_1.parent_id==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.parent_id);
					...
					if(bufferLtRedshiftOutput_1.subject_line==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.subject_line);
					...
					if(bufferLtRedshiftOutput_1.start_time!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.start_time.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.end_time!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.end_time.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.actual_sent_count = null;
					
							row1.bounce_count = null;
					
							row1.campaign_id = null;
					
							row1.campaign_name = null;
					
							row1.click_count = null;
					
							row1.data_source_id = null;
					
							row1.department_id = null;
					
							row1.mailed_count = null;
					
							row1.mailing_id = 0;
					
							row1.open_count = null;
					
							row1.parent_id = null;
					
							row1.subject_line = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.actual_sent_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.bounce_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.campaign_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.click_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.data_source_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.department_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.mailed_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.mailing_id = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'mailing_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.open_count = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.parent_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.subject_line = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.start_time = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.end_time = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.actual_sent_count = row1.actual_sent_count;
row2.bounce_count = row1.bounce_count;
row2.campaign_id = row1.campaign_id;
row2.campaign_name = StringUtils.trimToNull(row1.campaign_name);
row2.click_count = row1.click_count;
row2.data_source_id = row1.data_source_id;
row2.department_id = row1.department_id;
row2.mailed_count = row1.mailed_count;
row2.mailing_id = row1.mailing_id;
row2.open_count = row1.open_count;
row2.parent_id = row1.parent_id;
row2.subject_line = StringUtils.trimToNull(row1.subject_line);
row2.start_time = row1.start_time;
row2.end_time = row1.end_time;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[14];
                            rowtFileOutputDelimited_1[0]=row2.actual_sent_count == null ? null : String.valueOf(row2.actual_sent_count);
                            rowtFileOutputDelimited_1[1]=row2.bounce_count == null ? null : String.valueOf(row2.bounce_count);
                            rowtFileOutputDelimited_1[2]=row2.campaign_id == null ? null : String.valueOf(row2.campaign_id);
                            rowtFileOutputDelimited_1[3]=row2.campaign_name == null ? null : row2.campaign_name;
                            rowtFileOutputDelimited_1[4]=row2.click_count == null ? null : String.valueOf(row2.click_count);
                            rowtFileOutputDelimited_1[5]=row2.data_source_id == null ? null : String.valueOf(row2.data_source_id);
                            rowtFileOutputDelimited_1[6]=row2.department_id == null ? null : String.valueOf(row2.department_id);
                            rowtFileOutputDelimited_1[7]=row2.mailed_count == null ? null : String.valueOf(row2.mailed_count);
                            rowtFileOutputDelimited_1[8]=String.valueOf(row2.mailing_id);
                            rowtFileOutputDelimited_1[9]=row2.open_count == null ? null : String.valueOf(row2.open_count);
                            rowtFileOutputDelimited_1[10]=row2.parent_id == null ? null : String.valueOf(row2.parent_id);
                            rowtFileOutputDelimited_1[11]=row2.subject_line == null ? null : row2.subject_line;
                            rowtFileOutputDelimited_1[12]=row2.start_time == null ? null : FormatterUtils.format_Date(row2.start_time, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[13]=row2.end_time == null ? null : FormatterUtils.format_Date(row2.end_time, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewMailingData StageFeed_StrongviewMailingDataClass = new StageFeed_StrongviewMailingData();

        int exitCode = StageFeed_StrongviewMailingDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewMailingData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewmailingdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewMailingData");
        }
...
/************************************************************************************************
 *     365234 characters generated by Talend Open Studio for Data Integration 
