...
package zipcar_marketingdw.processstaging_vehicles_0_1;
...
/**
 * Job: ProcessStaging_Vehicles Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Vehicles implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Vehicles";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_uemmsDWbEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Vehicles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Vehicles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles) {
...
"\nINSERT INTO {{marketing.schema}}.r_vehicle\n(\n    vehicle_id,\n    year,\n    make,\n    model,\n    vehicle,\n    primary_style,\n    exterior_color,\n    vin,\n    zipvan_p,\n	last_class,\n	primary_maintainer,\n	zipfleet_id,\n    imported_date\n)\nSELECT \n    vehicle_id,\n    year,\n    make,\n    model,\n    vehicle,\n    primary_style,\n    exterior_color,\n    vin,\n    zipvan_p,\n	last_class,\n	primary_maintainer,\n	zipfleet_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.vehicles\nMINUS\nSELECT \n    vehicle_id,\n    year,\n    make,\n    model,\n    vehicle,\n    primary_style,\n    exterior_color,\n    vin,\n    zipvan_p,\n	last_class,\n	primary_maintainer,\n	zipfleet_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_vehicle\n;\n\n-- truncate staging table\nTRUNCATE TABLE {{staging.schema}}.vehicles;\n\n",
...
"\n	SELECT COUNT(*) AS COUNT FROM {{marketing.schema}}.vw_vehicle\n	WHERE imported_date = {{rundate}};\n",
"marketing.schema", context.Redshift_Marketing_Schema,
"rundate", DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate))
);
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Refreshing Vehicle Summary Snapshot Table","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Refreshing Vehicle Summary Snapshot Table", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Refreshing Vehicle Summary Snapshot Table"); 
...
"\n-- truncate s_vehicle table first\nTRUNCATE TABLE {{marketing.schema}}.s_vehicle;\n\nINSERT INTO {{marketing.schema}}.s_vehicle\n(\n	vehicle_id,\n	exterior_color,\n	imported_date,\n	last_class,\n	make,\n	model,\n	primary_maintainer,\n	primary_style,\n	vehicle,\n	vin,\n	year,\n	community_id,\n	zipfleet_id,\n	zipvan_p,\n	is_new_platform\n)	\nSELECT\n	t1.vehicle_id,\n	t1.exterior_color,\n	t1.imported_date,\n	t1.last_class,\n	t1.make,\n	t1.model,\n	case when lower(t1.primary_maintainer) = 'zip' then 'zipcar' else t1.primary_maintainer end as primary_maintainer,\n	t1.primary_style,\n	t1.vehicle,\n	t1.vin,\n	t1.year,\n	NULL::BIGINT as community_id,\n	t1.zipfleet_id,\n	t1.zipvan_p,\n	false as is_new_platform\nFROM {{marketing.schema}}.vw_r_vehicle t1\nUNION ALL\nSELECT\n	t2.vehicle_id,\n	t2.exterior_color,\n	t2.imported_date,\n	NULL as last_class,\n	t2.make,\n	t2.model,\n	lower(t2.primary_maintainer) as primary_maintainer,\n	t2.primary_style,\n	t2.vehicle,\n	t2.vin,\n	t2.year,\n	t2.community_id,\n	NULL::BIGINT as zipfleet_id,\n	NULL as zipvan_p,\n	true as is_new_platform\nFROM {{marketing.schema}}.vw_r_vehicle_np t2\n;\n\n-- analyze table\nANALYZE {{marketing.schema}}.s_vehicle;\n",
"marketing.schema", context.Redshift_Marketing_Schema
);
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Vehicle Summary Snapshot Refreshed","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 3, "Vehicle Summary Snapshot Refreshed", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Vehicle Summary Snapshot Refreshed"); 
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Vehicles ProcessStaging_VehiclesClass = new ProcessStaging_Vehicles();

        int exitCode = ProcessStaging_VehiclesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Vehicles.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_vehicles_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Vehicles");
        }
...
/************************************************************************************************
 *     153568 characters generated by Talend Open Studio for Data Integration 
