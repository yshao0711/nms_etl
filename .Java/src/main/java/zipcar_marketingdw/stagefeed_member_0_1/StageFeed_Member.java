...
package zipcar_marketingdw.stagefeed_member_0_1;
...
/**
 * Job: StageFeed_Member Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Member implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Member";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_87XFIMFxEeaR3Zs1xbl6gw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Member.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Member.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Member) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.MEMBER.filePattern());  
 ...
 */
	...
	NB_ITERATE_tJava_2++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("Row_Member", 3, 0);
					}           			
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("Record_Member", 3, 0);
					}           			
...
globalMap.put("tableName", FeedFile.FileType.MEMBER.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.MEMBER;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public Long FIRST_ZIPFLEET_ID;

				public Long getFIRST_ZIPFLEET_ID () {
					return this.FIRST_ZIPFLEET_ID;
				}
			    ...
			    public String SMS_VERIFIED_P;

				public String getSMS_VERIFIED_P () {
					return this.SMS_VERIFIED_P;
				}
				
			    public Long PREFERRED_ADDRESS_ID;

				public Long getPREFERRED_ADDRESS_ID () {
					return this.PREFERRED_ADDRESS_ID;
				}
				
			    public String MOBILE_PROMO_P;

				public String getMOBILE_PROMO_P () {
					return this.MOBILE_PROMO_P;
				}
				
			    public java.util.Date GRADUATION_DATE;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.MEMBER_ID = this.MEMBER_ID;
	            ...
	            other.FIRST_ZIPFLEET_ID = this.FIRST_ZIPFLEET_ID;
	            other.SMS_NUMBER = this.SMS_NUMBER;
	            other.SMS_VERIFIED_P = this.SMS_VERIFIED_P;
	            other.PREFERRED_ADDRESS_ID = this.PREFERRED_ADDRESS_ID;
	            other.MOBILE_PROMO_P = this.MOBILE_PROMO_P;
	            other.GRADUATION_DATE = this.GRADUATION_DATE;
	            other.USER_NAME = this.USER_NAME;
	            other.ZIPCARD = this.ZIPCARD;
	            other.DRIVER_CONFIRMED_ZIPCARD_P = this.DRIVER_CONFIRMED_ZIPCARD_P;
	            other.FIRST_JOIN_DATE = this.FIRST_JOIN_DATE;
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DELETED_DATE = readDate(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.FIRST_ZIPFLEET_ID = null;
           				} else {
           			    	this.FIRST_ZIPFLEET_ID = dis.readLong();
           				}
					
					this.SMS_NUMBER = readString(dis);
					
					this.SMS_VERIFIED_P = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.PREFERRED_ADDRESS_ID = null;
           				} else {
           			    	this.PREFERRED_ADDRESS_ID = dis.readLong();
           				}
					
					this.MOBILE_PROMO_P = readString(dis);
					
					this.GRADUATION_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.FIRST_ZIPFLEET_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.FIRST_ZIPFLEET_ID);
		            	}
					
					// String
				
						writeString(this.SMS_NUMBER,dos);
					
					// String
				
						writeString(this.SMS_VERIFIED_P,dos);
					
					// Long
				
						if(this.PREFERRED_ADDRESS_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.PREFERRED_ADDRESS_ID);
		            	}
					
					// String
				
						writeString(this.MOBILE_PROMO_P,dos);
					
					// java.util.Date
				
						writeDate(this.GRADUATION_DATE,dos);
    ...
    public String toString() {
		...
		sb.append(",FIRST_ZIPFLEET_ID="+String.valueOf(FIRST_ZIPFLEET_ID));
		sb.append(",SMS_NUMBER="+SMS_NUMBER);
		sb.append(",SMS_VERIFIED_P="+SMS_VERIFIED_P);
		sb.append(",PREFERRED_ADDRESS_ID="+String.valueOf(PREFERRED_ADDRESS_ID));
		sb.append(",MOBILE_PROMO_P="+MOBILE_PROMO_P);
		sb.append(",GRADUATION_DATE="+String.valueOf(GRADUATION_DATE));
...
public static class Record_MemberStruct implements routines.system.IPersistableRow<Record_MemberStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Record_MemberStruct other = (Record_MemberStruct) obj;
	...
	public void copyDataTo(Record_MemberStruct other) {
	...
	public void copyKeysDataTo(Record_MemberStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(Record_MemberStruct other) {
...
public static class Row_MemberStruct implements routines.system.IPersistableRow<Row_MemberStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Member = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Row_MemberStruct other = (Row_MemberStruct) obj;
	...
	public void copyDataTo(Row_MemberStruct other) {
	...
	public void copyKeysDataTo(Row_MemberStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(Row_MemberStruct other) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		Row_MemberStruct Row_Member = new Row_MemberStruct();
Record_MemberStruct Record_Member = new Record_MemberStruct();
	...
	currentComponent="tRedshiftOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Record_Member" + iterateId, 0, 0);
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c1(String FIRST_NAME){
							this.FIRST_NAME = FIRST_NAME;
							return this;
						}				
						String LAST_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String LAST_NAME){
							this.LAST_NAME = LAST_NAME;
							return this;
						}				
						java.util.Date BIRTHDATE;
						
	            		public BufferLine_tRedshiftOutput_1 c3(java.util.Date BIRTHDATE){
							this.BIRTHDATE = BIRTHDATE;
							return this;
						}				
						String EMAIL;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String EMAIL){
							this.EMAIL = EMAIL;
							return this;
						}				
						String EMAILABLE_P;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String EMAILABLE_P){
							this.EMAILABLE_P = EMAILABLE_P;
							return this;
						}				
						String CURRENT_STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String CURRENT_STATUS){
							this.CURRENT_STATUS = CURRENT_STATUS;
							return this;
						}				
						String IS_DRIVER;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String IS_DRIVER){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c11(Long CURRENT_ZIPFLEET_ID){
							this.CURRENT_ZIPFLEET_ID = CURRENT_ZIPFLEET_ID;
							return this;
						}				
						Long FIRST_ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c12(Long FIRST_ZIPFLEET_ID){
							this.FIRST_ZIPFLEET_ID = FIRST_ZIPFLEET_ID;
							return this;
						}				
						String SMS_NUMBER;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String SMS_NUMBER){
							this.SMS_NUMBER = SMS_NUMBER;
							return this;
						}				
						String SMS_VERIFIED_P;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String SMS_VERIFIED_P){
							this.SMS_VERIFIED_P = SMS_VERIFIED_P;
							return this;
						}				
						Long PREFERRED_ADDRESS_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Long PREFERRED_ADDRESS_ID){
							this.PREFERRED_ADDRESS_ID = PREFERRED_ADDRESS_ID;
							return this;
						}				
						String MOBILE_PROMO_P;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String MOBILE_PROMO_P){
							this.MOBILE_PROMO_P = MOBILE_PROMO_P;
							return this;
						}				
						java.util.Date GRADUATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c17(java.util.Date GRADUATION_DATE){
							this.GRADUATION_DATE = GRADUATION_DATE;
							return this;
						}				
						String USER_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c18(String USER_NAME){
							this.USER_NAME = USER_NAME;
							return this;
						}				
						String ZIPCARD;
						
	            		public BufferLine_tRedshiftOutput_1 c19(String ZIPCARD){
							this.ZIPCARD = ZIPCARD;
							return this;
						}				
						String DRIVER_CONFIRMED_ZIPCARD_P;
						
	            		public BufferLine_tRedshiftOutput_1 c20(String DRIVER_CONFIRMED_ZIPCARD_P){
							this.DRIVER_CONFIRMED_ZIPCARD_P = DRIVER_CONFIRMED_ZIPCARD_P;
							return this;
						}				
						java.util.Date FIRST_JOIN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c21(java.util.Date FIRST_JOIN_DATE){
							this.FIRST_JOIN_DATE = FIRST_JOIN_DATE;
							return this;
						}				
						String LOCALE;
						
	            		public BufferLine_tRedshiftOutput_1 c22(String LOCALE){
							this.LOCALE = LOCALE;
							return this;
						}				
						String OCCUPATION;
						
	            		public BufferLine_tRedshiftOutput_1 c23(String OCCUPATION){
							this.OCCUPATION = OCCUPATION;
							return this;
						}				
						java.util.Date REJOIN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c24(java.util.Date REJOIN_DATE){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MEMBER_ID\",\"FIRST_NAME\",\"LAST_NAME\",\"BIRTHDATE\",\"EMAIL\",\"EMAILABLE_P\",\"CURRENT_STATUS\",\"IS_DRIVER\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"CURRENT_ZIPFLEET_ID\",\"FIRST_ZIPFLEET_ID\",\"SMS_NUMBER\",\"SMS_VERIFIED_P\",\"PREFERRED_ADDRESS_ID\",\"MOBILE_PROMO_P\",\"GRADUATION_DATE\",\"USER_NAME\",\"ZIPCARD\",\"DRIVER_CONFIRMED_ZIPCARD_P\",\"FIRST_JOIN_DATE\",\"LOCALE\",\"OCCUPATION\",\"REJOIN_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
	...
	currentComponent="tJavaRow_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Row_Member" + iterateId, 0, 0);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
	        	...
	        	while ( limittFileInputDelimited_1 != 0 && csvReadertFileInputDelimited_1!=null && csvReadertFileInputDelimited_1.readNext() ) { 
	            	...
	            	if (limittFileInputDelimited_1 > 0 && outputLinetFileInputDelimited_1 > limittFileInputDelimited_1) {
	                	break;
								...
								Row_Member = new Row_MemberStruct();
								try {			
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_Member.MEMBER_ID = null;
					
							Row_Member.FIRST_NAME = null;
					
							Row_Member.LAST_NAME = null;
					
							Row_Member.BIRTHDATE = null;
					
							Row_Member.EMAIL = null;
					
							Row_Member.EMAILABLE_P = null;
					
							Row_Member.CURRENT_STATUS = null;
					
							Row_Member.IS_DRIVER = null;
					
							Row_Member.CREATION_DATE = null;
					
							Row_Member.LAST_MODIFIED = null;
					
							Row_Member.DELETED_DATE = null;
					
							Row_Member.CURRENT_ZIPFLEET_ID = null;
					
							Row_Member.FIRST_ZIPFLEET_ID = null;
					
							Row_Member.SMS_NUMBER = null;
					
							Row_Member.SMS_VERIFIED_P = null;
					
							Row_Member.PREFERRED_ADDRESS_ID = null;
					
							Row_Member.MOBILE_PROMO_P = null;
					
							Row_Member.GRADUATION_DATE = null;
					
							Row_Member.USER_NAME = null;
					
							Row_Member.ZIPCARD = null;
					
							Row_Member.DRIVER_CONFIRMED_ZIPCARD_P = null;
					
							Row_Member.FIRST_JOIN_DATE = null;
					
							Row_Member.LOCALE = null;
					
							Row_Member.OCCUPATION = null;
					
							Row_Member.REJOIN_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Member.MEMBER_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.FIRST_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.LAST_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Member.BIRTHDATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATE, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.EMAIL = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.EMAILABLE_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.CURRENT_STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.IS_DRIVER = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Member.CREATION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Member.LAST_MODIFIED = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Member.DELETED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Member.CURRENT_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Member.FIRST_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.SMS_NUMBER = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.SMS_VERIFIED_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Member.PREFERRED_ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.MOBILE_PROMO_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Member.GRADUATION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATE, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.USER_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.ZIPCARD = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.DRIVER_CONFIRMED_ZIPCARD_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Member.FIRST_JOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATE, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.LOCALE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Member.OCCUPATION = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Member.REJOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATE, false);
...
if(Row_Member != null) { 
	...
	currentComponent="tJavaRow_2";
			...
			//Row_Member
				...
				if(execStat){
					runStat.updateStatOnConnection("Row_Member"+iterateId,1, 1);
				} 
...
Record_Member.MEMBER_ID = Row_Member.MEMBER_ID;
Record_Member.FIRST_NAME = StringUtils.trimToNull(Row_Member.FIRST_NAME);
Record_Member.LAST_NAME = StringUtils.trimToNull(Row_Member.LAST_NAME);
Record_Member.BIRTHDATE = Row_Member.BIRTHDATE;
Record_Member.EMAIL = StringUtils.trimToNull(Row_Member.EMAIL);
Record_Member.EMAILABLE_P = BooleanUtils.boolChar(Row_Member.EMAILABLE_P);
Record_Member.CURRENT_STATUS = StringUtils.trimToNull(Row_Member.CURRENT_STATUS);
Record_Member.IS_DRIVER = BooleanUtils.boolChar(Row_Member.IS_DRIVER);
Record_Member.CREATION_DATE = Row_Member.CREATION_DATE;
Record_Member.LAST_MODIFIED = Row_Member.LAST_MODIFIED;
Record_Member.DELETED_DATE = Row_Member.DELETED_DATE;
Record_Member.CURRENT_ZIPFLEET_ID = Row_Member.CURRENT_ZIPFLEET_ID;
Record_Member.FIRST_ZIPFLEET_ID = Row_Member.FIRST_ZIPFLEET_ID;
Record_Member.SMS_NUMBER = StringUtils.trimToNull(Row_Member.SMS_NUMBER);
Record_Member.SMS_VERIFIED_P = BooleanUtils.boolChar(Row_Member.SMS_VERIFIED_P);
Record_Member.PREFERRED_ADDRESS_ID = Row_Member.PREFERRED_ADDRESS_ID;
Record_Member.MOBILE_PROMO_P = BooleanUtils.boolChar(Row_Member.MOBILE_PROMO_P);
Record_Member.GRADUATION_DATE = Row_Member.GRADUATION_DATE;
Record_Member.USER_NAME = StringUtils.trimToNull(Row_Member.USER_NAME);
Record_Member.ZIPCARD = StringUtils.trimToNull(Row_Member.ZIPCARD);
Record_Member.DRIVER_CONFIRMED_ZIPCARD_P = BooleanUtils.boolChar(Row_Member.DRIVER_CONFIRMED_ZIPCARD_P);
Record_Member.FIRST_JOIN_DATE = Row_Member.FIRST_JOIN_DATE;
Record_Member.LOCALE = StringUtils.trimToNull(Row_Member.LOCALE);
Record_Member.OCCUPATION = StringUtils.trimToNull(Row_Member.OCCUPATION);
Record_Member.REJOIN_DATE = Row_Member.REJOIN_DATE;
    nb_line_tJavaRow_2++;   
 ...
 */
	...
	currentComponent="tRedshiftOutput_1";
			...
			//Record_Member
				...
				if(execStat){
					runStat.updateStatOnConnection("Record_Member"+iterateId,1, 1);
				} 
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(Record_Member.MEMBER_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_Member.MEMBER_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.FIRST_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.FIRST_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.LAST_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.LAST_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.EMAIL==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.EMAIL);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.EMAILABLE_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.EMAILABLE_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.CURRENT_STATUS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.CURRENT_STATUS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.IS_DRIVER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.IS_DRIVER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.CREATION_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Member.CREATION_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.LAST_MODIFIED!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Member.LAST_MODIFIED.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.DELETED_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Member.DELETED_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.CURRENT_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_Member.CURRENT_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.FIRST_ZIPFLEET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_Member.FIRST_ZIPFLEET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.SMS_NUMBER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.SMS_NUMBER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.SMS_VERIFIED_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.SMS_VERIFIED_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.PREFERRED_ADDRESS_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_Member.PREFERRED_ADDRESS_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.MOBILE_PROMO_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.MOBILE_PROMO_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.GRADUATION_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Member.GRADUATION_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.USER_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.USER_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.ZIPCARD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.ZIPCARD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.DRIVER_CONFIRMED_ZIPCARD_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.DRIVER_CONFIRMED_ZIPCARD_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.FIRST_JOIN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Member.FIRST_JOIN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.LOCALE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.LOCALE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.OCCUPATION==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Member.OCCUPATION);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Member.REJOIN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Member.REJOIN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_Member.MEMBER_ID)
                        .c1(Record_Member.FIRST_NAME)
                        .c2(Record_Member.LAST_NAME)
                        .c3(Record_Member.BIRTHDATE)
                        .c4(Record_Member.EMAIL)
                        .c5(Record_Member.EMAILABLE_P)
                        .c6(Record_Member.CURRENT_STATUS)
                        .c7(Record_Member.IS_DRIVER)
                        .c8(Record_Member.CREATION_DATE)
                        .c9(Record_Member.LAST_MODIFIED)
                        .c10(Record_Member.DELETED_DATE)
                        .c11(Record_Member.CURRENT_ZIPFLEET_ID)
                        .c12(Record_Member.FIRST_ZIPFLEET_ID)
                        .c13(Record_Member.SMS_NUMBER)
                        .c14(Record_Member.SMS_VERIFIED_P)
                        .c15(Record_Member.PREFERRED_ADDRESS_ID)
                        .c16(Record_Member.MOBILE_PROMO_P)
                        .c17(Record_Member.GRADUATION_DATE)
                        .c18(Record_Member.USER_NAME)
                        .c19(Record_Member.ZIPCARD)
                        .c20(Record_Member.DRIVER_CONFIRMED_ZIPCARD_P)
                        .c21(Record_Member.FIRST_JOIN_DATE)
                        .c22(Record_Member.LOCALE)
                        .c23(Record_Member.OCCUPATION)
                        .c24(Record_Member.REJOIN_DATE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.MEMBER_ID = Record_Member.MEMBER_ID;
                                After_Insert.FIRST_NAME = Record_Member.FIRST_NAME;
                                After_Insert.LAST_NAME = Record_Member.LAST_NAME;
                                After_Insert.BIRTHDATE = Record_Member.BIRTHDATE;
                                After_Insert.EMAIL = Record_Member.EMAIL;
                                After_Insert.EMAILABLE_P = Record_Member.EMAILABLE_P;
                                After_Insert.CURRENT_STATUS = Record_Member.CURRENT_STATUS;
                                After_Insert.IS_DRIVER = Record_Member.IS_DRIVER;
                                After_Insert.CREATION_DATE = Record_Member.CREATION_DATE;
                                After_Insert.LAST_MODIFIED = Record_Member.LAST_MODIFIED;
                                After_Insert.DELETED_DATE = Record_Member.DELETED_DATE;
                                After_Insert.CURRENT_ZIPFLEET_ID = Record_Member.CURRENT_ZIPFLEET_ID;
                                After_Insert.FIRST_ZIPFLEET_ID = Record_Member.FIRST_ZIPFLEET_ID;
                                After_Insert.SMS_NUMBER = Record_Member.SMS_NUMBER;
                                After_Insert.SMS_VERIFIED_P = Record_Member.SMS_VERIFIED_P;
                                After_Insert.PREFERRED_ADDRESS_ID = Record_Member.PREFERRED_ADDRESS_ID;
                                After_Insert.MOBILE_PROMO_P = Record_Member.MOBILE_PROMO_P;
                                After_Insert.GRADUATION_DATE = Record_Member.GRADUATION_DATE;
                                After_Insert.USER_NAME = Record_Member.USER_NAME;
                                After_Insert.ZIPCARD = Record_Member.ZIPCARD;
                                After_Insert.DRIVER_CONFIRMED_ZIPCARD_P = Record_Member.DRIVER_CONFIRMED_ZIPCARD_P;
                                After_Insert.FIRST_JOIN_DATE = Record_Member.FIRST_JOIN_DATE;
                                After_Insert.LOCALE = Record_Member.LOCALE;
                                After_Insert.OCCUPATION = Record_Member.OCCUPATION;
                                After_Insert.REJOIN_DATE = Record_Member.REJOIN_DATE;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.FIRST_NAME = After_Insert.FIRST_NAME;
               Log_Rows.LAST_NAME = After_Insert.LAST_NAME;
               Log_Rows.BIRTHDATE = After_Insert.BIRTHDATE;
               Log_Rows.EMAIL = After_Insert.EMAIL;
               Log_Rows.EMAILABLE_P = After_Insert.EMAILABLE_P;
               Log_Rows.CURRENT_STATUS = After_Insert.CURRENT_STATUS;
               Log_Rows.IS_DRIVER = After_Insert.IS_DRIVER;
               ...
               Log_Rows.CURRENT_ZIPFLEET_ID = After_Insert.CURRENT_ZIPFLEET_ID;
               Log_Rows.FIRST_ZIPFLEET_ID = After_Insert.FIRST_ZIPFLEET_ID;
               Log_Rows.SMS_NUMBER = After_Insert.SMS_NUMBER;
               Log_Rows.SMS_VERIFIED_P = After_Insert.SMS_VERIFIED_P;
               Log_Rows.PREFERRED_ADDRESS_ID = After_Insert.PREFERRED_ADDRESS_ID;
               Log_Rows.MOBILE_PROMO_P = After_Insert.MOBILE_PROMO_P;
               Log_Rows.GRADUATION_DATE = After_Insert.GRADUATION_DATE;
               Log_Rows.USER_NAME = After_Insert.USER_NAME;
               Log_Rows.ZIPCARD = After_Insert.ZIPCARD;
               Log_Rows.DRIVER_CONFIRMED_ZIPCARD_P = After_Insert.DRIVER_CONFIRMED_ZIPCARD_P;
               Log_Rows.FIRST_JOIN_DATE = After_Insert.FIRST_JOIN_DATE;
               Log_Rows.LOCALE = After_Insert.LOCALE;
               Log_Rows.OCCUPATION = After_Insert.OCCUPATION;
               Log_Rows.REJOIN_DATE = After_Insert.REJOIN_DATE;    
...
globalMap.put("tJavaRow_2_NB_LINE",nb_line_tJavaRow_2);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Row_Member"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.FIRST_NAME==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FIRST_NAME);
					...
					if(bufferLtRedshiftOutput_1.LAST_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LAST_NAME);
					...
					if(bufferLtRedshiftOutput_1.EMAILABLE_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.EMAILABLE_P);
					...
					if(bufferLtRedshiftOutput_1.CURRENT_STATUS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CURRENT_STATUS);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.IS_DRIVER);
					...
					if(bufferLtRedshiftOutput_1.FIRST_ZIPFLEET_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FIRST_ZIPFLEET_ID);
					...
					if(bufferLtRedshiftOutput_1.SMS_NUMBER==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SMS_NUMBER);
					...
					if(bufferLtRedshiftOutput_1.SMS_VERIFIED_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SMS_VERIFIED_P);
					...
					if(bufferLtRedshiftOutput_1.PREFERRED_ADDRESS_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PREFERRED_ADDRESS_ID);
					...
					if(bufferLtRedshiftOutput_1.MOBILE_PROMO_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MOBILE_PROMO_P);
					...
					if(bufferLtRedshiftOutput_1.GRADUATION_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.GRADUATION_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.USER_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.USER_NAME);
					...
					if(bufferLtRedshiftOutput_1.FIRST_JOIN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.FIRST_JOIN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.OCCUPATION==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.OCCUPATION);
					...
					if(bufferLtRedshiftOutput_1.REJOIN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.REJOIN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
	...
	nb_line_rejected_tRedshiftOutput_1=nb_line_rejected_tRedshiftOutput_1 + rejectedCount_tRedshiftOutput_1;
        ...
        globalMap.put("tRedshiftOutput_1_NB_LINE_REJECTED", nb_line_rejected_tRedshiftOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Record_Member"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.CURRENT_ZIPFLEET_ID = null;
					
							row1.FIRST_ZIPFLEET_ID = null;
					
							row1.SMS_NUMBER = null;
					
							row1.SMS_VERIFIED_P = null;
					
							row1.PREFERRED_ADDRESS_ID = null;
					
							row1.MOBILE_PROMO_P = null;
					
							row1.GRADUATION_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.BIRTHDATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATE, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.EMAILABLE_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.CURRENT_STATUS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.IS_DRIVER = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.CURRENT_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.FIRST_ZIPFLEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SMS_NUMBER = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SMS_VERIFIED_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.PREFERRED_ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.MOBILE_PROMO_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.GRADUATION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATE, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.USER_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.FIRST_JOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATE, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.OCCUPATION = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.REJOIN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATE, false);
...
row2.FIRST_NAME = StringUtils.trimToNull(row1.FIRST_NAME);
row2.LAST_NAME = StringUtils.trimToNull(row1.LAST_NAME);
row2.BIRTHDATE = row1.BIRTHDATE;
row2.EMAIL = StringUtils.trimToNull(row1.EMAIL);
row2.EMAILABLE_P = BooleanUtils.boolChar(row1.EMAILABLE_P);
row2.CURRENT_STATUS = StringUtils.trimToNull(row1.CURRENT_STATUS);
row2.IS_DRIVER = BooleanUtils.boolChar(row1.IS_DRIVER);
row2.CREATION_DATE = row1.CREATION_DATE;
row2.LAST_MODIFIED = row1.LAST_MODIFIED;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.CURRENT_ZIPFLEET_ID = row1.CURRENT_ZIPFLEET_ID;
row2.FIRST_ZIPFLEET_ID = row1.FIRST_ZIPFLEET_ID;
row2.SMS_NUMBER = StringUtils.trimToNull(row1.SMS_NUMBER);
row2.SMS_VERIFIED_P = BooleanUtils.boolChar(row1.SMS_VERIFIED_P);
row2.PREFERRED_ADDRESS_ID = row1.PREFERRED_ADDRESS_ID;
row2.MOBILE_PROMO_P = BooleanUtils.boolChar(row1.MOBILE_PROMO_P);
row2.GRADUATION_DATE = row1.GRADUATION_DATE;
row2.USER_NAME = StringUtils.trimToNull(row1.USER_NAME);
...
row2.FIRST_JOIN_DATE = row1.FIRST_JOIN_DATE;
row2.LOCALE = StringUtils.trimToNull(row1.LOCALE);
row2.OCCUPATION = StringUtils.trimToNull(row1.OCCUPATION);
row2.REJOIN_DATE = row1.REJOIN_DATE;
    nb_line_tJavaRow_3++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[25];
                            rowtFileOutputDelimited_1[0]=row2.MEMBER_ID == null ? null : String.valueOf(row2.MEMBER_ID);
                            rowtFileOutputDelimited_1[1]=row2.FIRST_NAME == null ? null : row2.FIRST_NAME;
                            rowtFileOutputDelimited_1[2]=row2.LAST_NAME == null ? null : row2.LAST_NAME;
                            rowtFileOutputDelimited_1[3]=row2.BIRTHDATE == null ? null : FormatterUtils.format_Date(row2.BIRTHDATE, FeedFile.DF_DATE);
                            rowtFileOutputDelimited_1[4]=row2.EMAIL == null ? null : row2.EMAIL;
                            rowtFileOutputDelimited_1[5]=row2.EMAILABLE_P == null ? null : row2.EMAILABLE_P;
                            rowtFileOutputDelimited_1[6]=row2.CURRENT_STATUS == null ? null : row2.CURRENT_STATUS;
                            rowtFileOutputDelimited_1[7]=row2.IS_DRIVER == null ? null : row2.IS_DRIVER;
                            ...
                            rowtFileOutputDelimited_1[11]=row2.CURRENT_ZIPFLEET_ID == null ? null : String.valueOf(row2.CURRENT_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[12]=row2.FIRST_ZIPFLEET_ID == null ? null : String.valueOf(row2.FIRST_ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[13]=row2.SMS_NUMBER == null ? null : row2.SMS_NUMBER;
                            rowtFileOutputDelimited_1[14]=row2.SMS_VERIFIED_P == null ? null : row2.SMS_VERIFIED_P;
                            rowtFileOutputDelimited_1[15]=row2.PREFERRED_ADDRESS_ID == null ? null : String.valueOf(row2.PREFERRED_ADDRESS_ID);
                            rowtFileOutputDelimited_1[16]=row2.MOBILE_PROMO_P == null ? null : row2.MOBILE_PROMO_P;
                            rowtFileOutputDelimited_1[17]=row2.GRADUATION_DATE == null ? null : FormatterUtils.format_Date(row2.GRADUATION_DATE, FeedFile.DF_DATE);
                            rowtFileOutputDelimited_1[18]=row2.USER_NAME == null ? null : row2.USER_NAME;
                            rowtFileOutputDelimited_1[19]=row2.ZIPCARD == null ? null : row2.ZIPCARD;
                            rowtFileOutputDelimited_1[20]=row2.DRIVER_CONFIRMED_ZIPCARD_P == null ? null : row2.DRIVER_CONFIRMED_ZIPCARD_P;
                            rowtFileOutputDelimited_1[21]=row2.FIRST_JOIN_DATE == null ? null : FormatterUtils.format_Date(row2.FIRST_JOIN_DATE, FeedFile.DF_DATE);
                            rowtFileOutputDelimited_1[22]=row2.LOCALE == null ? null : row2.LOCALE;
                            rowtFileOutputDelimited_1[23]=row2.OCCUPATION == null ? null : row2.OCCUPATION;
                            rowtFileOutputDelimited_1[24]=row2.REJOIN_DATE == null ? null : FormatterUtils.format_Date(row2.REJOIN_DATE, FeedFile.DF_DATE);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Member StageFeed_MemberClass = new StageFeed_Member();

        int exitCode = StageFeed_MemberClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Member.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_member_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Member");
        }
...
/************************************************************************************************
 *     414840 characters generated by Talend Open Studio for Data Integration 
