...
package zipcar_marketingdw.salesforceimport_0_1;
...
/**
 * Job: SalesforceImport Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class SalesforceImport implements TalendJob {
...
public String getS3_datalake_secretkey(){
	...
	private final String jobName = "SalesforceImport";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Ryv7EFh2Eei_EJm82Z_azQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SalesforceImport.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SalesforceImport.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_SalesforceImport = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_SalesforceImport) {
...
Logging.componentName(jobName, "tWarn_1", "Log_FTP");
 ...
 */
  ...
  try{
        ...
        if(key_tContextLoad_1!=null && "bulkLoadPath".equals(key_tContextLoad_1))
        {
           context.bulkLoadPath=value_tContextLoad_1;
        }
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_1.put("s3_datalake_accesskey", context.s3_datalake_accesskey);
			paraList_tRunJob_1.add("--context_type " + "s3_datalake_accesskey" + "=" + "id_String");
		
			parentContextMap_tRunJob_1.put("s3_datalake_bucket", context.s3_datalake_bucket);
			paraList_tRunJob_1.add("--context_type " + "s3_datalake_bucket" + "=" + "id_String");
		
			parentContextMap_tRunJob_1.put("s3_datalake_folder", context.s3_datalake_folder);
			paraList_tRunJob_1.add("--context_type " + "s3_datalake_folder" + "=" + "id_String");
		
			parentContextMap_tRunJob_1.put("s3_datalake_secretkey", context.s3_datalake_secretkey);
			paraList_tRunJob_1.add("--context_type " + "s3_datalake_secretkey" + "=" + "id_String");
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.salesforceimport_process_feeds_0_1.SalesforceImport_Process_Feeds childJob_tRunJob_1 = new zipcar_marketingdw.salesforceimport_process_feeds_0_1.SalesforceImport_Process_Feeds();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_2.put("s3_datalake_accesskey", context.s3_datalake_accesskey);
			paraList_tRunJob_2.add("--context_type " + "s3_datalake_accesskey" + "=" + "id_String");
		
			parentContextMap_tRunJob_2.put("s3_datalake_bucket", context.s3_datalake_bucket);
			paraList_tRunJob_2.add("--context_type " + "s3_datalake_bucket" + "=" + "id_String");
		
			parentContextMap_tRunJob_2.put("s3_datalake_folder", context.s3_datalake_folder);
			paraList_tRunJob_2.add("--context_type " + "s3_datalake_folder" + "=" + "id_String");
		
			parentContextMap_tRunJob_2.put("s3_datalake_secretkey", context.s3_datalake_secretkey);
			paraList_tRunJob_2.add("--context_type " + "s3_datalake_secretkey" + "=" + "id_String");
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.salesforceimport_process_staging_0_1.SalesforceImport_Process_Staging childJob_tRunJob_2 = new zipcar_marketingdw.salesforceimport_process_staging_0_1.SalesforceImport_Process_Staging();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_3 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_3.put("isSubJob", context.isSubJob);
			paraList_tRunJob_3.add("--context_type " + "isSubJob" + "=" + "id_Boolean");
		
			parentContextMap_tRunJob_3.put("localArchiveDir", context.localArchiveDir);
			paraList_tRunJob_3.add("--context_type " + "localArchiveDir" + "=" + "id_String");
			...
			parentContextMap_tRunJob_3.put("bulkLoadPath", context.bulkLoadPath);
			paraList_tRunJob_3.add("--context_type " + "bulkLoadPath" + "=" + "id_String");
			...
			parentContextMap_tRunJob_3.put("ftpHost", context.ftpHost);
			paraList_tRunJob_3.add("--context_type " + "ftpHost" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("ftpPass", context.ftpPass);
			paraList_tRunJob_3.add("--context_type " + "ftpPass" + "=" + "id_Password");
		
			parentContextMap_tRunJob_3.put("ftpPort", context.ftpPort);
			paraList_tRunJob_3.add("--context_type " + "ftpPort" + "=" + "id_Integer");
		
			parentContextMap_tRunJob_3.put("ftpUser", context.ftpUser);
			paraList_tRunJob_3.add("--context_type " + "ftpUser" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("localExportDir", context.localExportDir);
			paraList_tRunJob_3.add("--context_type " + "localExportDir" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("localImportDir", context.localImportDir);
			paraList_tRunJob_3.add("--context_type " + "localImportDir" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("remoteExportDir", context.remoteExportDir);
			paraList_tRunJob_3.add("--context_type " + "remoteExportDir" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("remoteImportDir", context.remoteImportDir);
			paraList_tRunJob_3.add("--context_type " + "remoteImportDir" + "=" + "id_String");
			...
			parentContextMap_tRunJob_3.put("s3_datalake_accesskey", context.s3_datalake_accesskey);
			paraList_tRunJob_3.add("--context_type " + "s3_datalake_accesskey" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("s3_datalake_bucket", context.s3_datalake_bucket);
			paraList_tRunJob_3.add("--context_type " + "s3_datalake_bucket" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("s3_datalake_folder", context.s3_datalake_folder);
			paraList_tRunJob_3.add("--context_type " + "s3_datalake_folder" + "=" + "id_String");
		
			parentContextMap_tRunJob_3.put("s3_datalake_secretkey", context.s3_datalake_secretkey);
			paraList_tRunJob_3.add("--context_type " + "s3_datalake_secretkey" + "=" + "id_String");
	...
	Object obj_tRunJob_3 = null;
		...
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param isSubJob=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param isSubJob=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("isSubJob", obj_tRunJob_3);
	
	
		zipcar_marketingdw.salesforceimport_push_feeds_0_1.SalesforceImport_Push_Feeds childJob_tRunJob_3 = new zipcar_marketingdw.salesforceimport_push_feeds_0_1.SalesforceImport_Push_Feeds();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final SalesforceImport SalesforceImportClass = new SalesforceImport();

        int exitCode = SalesforceImportClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SalesforceImport.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/salesforceimport_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SalesforceImport");
        }
...
/************************************************************************************************
 *     182775 characters generated by Talend Open Studio for Data Integration 
