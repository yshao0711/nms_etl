...
package zipcar_marketingdw.stagefeed_wexfueldata_0_1;
...
/**
 * Job: StageFeed_WexFuelData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_WexFuelData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_WexFuelData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_sUiTMBf1EeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_WexFuelData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_WexFuelData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.WEX_FUEL_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.WEX_FUEL_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.WEX_FUEL_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
				...
				public java.util.Date getTRANSACTION_TIME () {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.FILEID;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.FILEID = this.FILEID;
	            ...
	            other.TRANSACTION_TIME = this.TRANSACTION_TIME;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_WexFuelData) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.TRANSACTION_TIME = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.TRANSACTION_TIME,dos);
    ...
    public String toString() {
		...
		sb.append(",TRANSACTION_TIME="+String.valueOf(TRANSACTION_TIME));
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.FILEID, other.FILEID);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c1(Long DRIVER_ID){
							this.DRIVER_ID = DRIVER_ID;
							return this;
						}				
						Long VEHICLE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Long VEHICLE_ID){
							this.VEHICLE_ID = VEHICLE_ID;
							return this;
						}				
						Long ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Long ZIPFLEET_ID){
							this.ZIPFLEET_ID = ZIPFLEET_ID;
							return this;
						}				
						java.util.Date TRANSACTION_TIME;
						
	            		public BufferLine_tRedshiftOutput_1 c4(java.util.Date TRANSACTION_TIME){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c6(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(java.util.Date DELETED_DATE){
			...
			for(int i_tRedshiftOutput_1=0;i_tRedshiftOutput_1 < 4000;i_tRedshiftOutput_1++){
				 extendInsertValueStmt_tRedshiftOutput_1.append("(?,?,?,?,?,?,?,?)");
				 if (i_tRedshiftOutput_1!=4000-1) extendInsertValueStmt_tRedshiftOutput_1.append(",");
			}

			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"FILEID\",\"DRIVER_ID\",\"VEHICLE_ID\",\"ZIPFLEET_ID\",\"TRANSACTION_TIME\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.TRANSACTION_TIME = null;
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.TRANSACTION_TIME = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
...
Record_OutputToDB.TRANSACTION_TIME = Row_FeedRecord.TRANSACTION_TIME;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TRANSACTION_TIME!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.TRANSACTION_TIME.getTime();
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.DRIVER_ID)
                        .c2(Record_OutputToDB.VEHICLE_ID)
                        .c3(Record_OutputToDB.ZIPFLEET_ID)
                        .c4(Record_OutputToDB.TRANSACTION_TIME)
                        .c5(Record_OutputToDB.CREATION_DATE)
                        .c6(Record_OutputToDB.LAST_MODIFIED)
                        .c7(Record_OutputToDB.DELETED_DATE)
				;
				...
				if(rowCounttRedshiftOutput_1 == 4000){
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.TRANSACTION_TIME = Record_OutputToDB.TRANSACTION_TIME;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.TRANSACTION_TIME = After_Insert.TRANSACTION_TIME;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"FILEID\",\"DRIVER_ID\",\"VEHICLE_ID\",\"ZIPFLEET_ID\",\"TRANSACTION_TIME\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.TRANSACTION_TIME!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.TRANSACTION_TIME.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.TRANSACTION_TIME = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
...
row2.TRANSACTION_TIME = row1.TRANSACTION_TIME;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[8];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.DRIVER_ID == null ? null : String.valueOf(row2.DRIVER_ID);
                            rowtFileOutputDelimited_1[2]=row2.VEHICLE_ID == null ? null : String.valueOf(row2.VEHICLE_ID);
                            rowtFileOutputDelimited_1[3]=row2.ZIPFLEET_ID == null ? null : String.valueOf(row2.ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[4]=row2.TRANSACTION_TIME == null ? null : FormatterUtils.format_Date(row2.TRANSACTION_TIME, FeedFile.DF_DATETIME);
                            ...
                            rowtFileOutputDelimited_1[6]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[7]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_WexFuelData StageFeed_WexFuelDataClass = new StageFeed_WexFuelData();

        int exitCode = StageFeed_WexFuelDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_WexFuelData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_wexfueldata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_WexFuelData");
        }
...
/************************************************************************************************
 *     325150 characters generated by Talend Open Studio for Data Integration 
