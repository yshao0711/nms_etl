...
package zipcar_marketingdw.processstaging_memberlastregistrationsess_0_1;
...
/**
 * Job: ProcessStaging_MemberLastRegistrationSess Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_MemberLastRegistrationSess implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_MemberLastRegistrationSess";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_n3JOsMqBEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_MemberLastRegistrationSess.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_MemberLastRegistrationSess.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastRegistrationSess) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "member_last_registration_sess";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_member_last_registration_sess";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_member_last_registration_sess\n(\n	member_id,\n	sess_account_id,\n	sess_application_id,\n	sess_source_cd,\n	sess_rate_plan_class,\n	sess_affiliate,\n	sess_annual_fee,\n	sess_app_fee,\n	sess_coupon_cd,\n	sess_coupon_desc,\n	sess_driving_credit_usd,\n	sess_app_start_date,\n	sess_app_begin_date,\n	sess_app_submitted_date,\n	sess_app_process_finished_date,\n	sess_app_last_step,\n	sess_incomplete_app_p,\n	sess_submitted_app_p,\n	sess_app_account_approval_date,\n	sess_app_rejection_date,\n	sess_app_status,\n	sess_referral_p,\n	creation_date,\n	deleted_date,\n	app_status,\n	imported_date\n)\nSELECT \n	member_id,\n	sess_account_id,\n	sess_application_id,\n	sess_source_cd,\n	sess_rate_plan_class,\n	sess_affiliate,\n	sess_annual_fee,\n	sess_app_fee,\n	sess_coupon_cd,\n	sess_coupon_desc,\n	sess_driving_credit_usd,\n	sess_app_start_date,\n	sess_app_begin_date,\n	sess_app_submitted_date,\n	sess_app_process_finished_date,\n	sess_app_last_step,\n	sess_incomplete_app_p,\n	sess_submitted_app_p,\n	sess_app_account_approval_date,\n	sess_app_rejection_date,\n	sess_app_status,\n	sess_referral_p,\n	creation_date,\n	deleted_date,\n	app_status,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.member_last_registration_sess\nMINUS\nSELECT \n	member_id,\n	sess_account_id,\n	sess_application_id,\n	sess_source_cd,\n	sess_rate_plan_class,\n	sess_affiliate,\n	sess_annual_fee,\n	sess_app_fee,\n	sess_coupon_cd,\n	sess_coupon_desc,\n	sess_driving_credit_usd,\n	sess_app_start_date,\n	sess_app_begin_date,\n	sess_app_submitted_date,\n	sess_app_process_finished_date,\n	sess_app_last_step,\n	sess_incomplete_app_p,\n	sess_submitted_app_p,\n	sess_app_account_approval_date,\n	sess_app_rejection_date,\n	sess_app_status,\n	sess_referral_p,\n	creation_date,\n	deleted_date,\n	app_status,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_member_last_registration_sess\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".member_last_registration_sess";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_MemberLastRegistrationSess ProcessStaging_MemberLastRegistrationSessClass = new ProcessStaging_MemberLastRegistrationSess();

        int exitCode = ProcessStaging_MemberLastRegistrationSessClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_MemberLastRegistrationSess.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_memberlastregistrationsess_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_MemberLastRegistrationSess");
        }
...
/************************************************************************************************
 *     137622 characters generated by Talend Open Studio for Data Integration 
