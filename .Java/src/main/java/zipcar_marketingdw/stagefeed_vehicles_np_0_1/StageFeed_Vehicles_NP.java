...
package zipcar_marketingdw.stagefeed_vehicles_np_0_1;
...
/**
 * Job: StageFeed_Vehicles_NP Purpose: Stage the Feed files from NP<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Vehicles_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Vehicles_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_xiidgHCnEeilHqJCtG9hZw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Vehicles_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Vehicles_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP) {
...
globalMap.put("currentFeed", FeedFile.FileType.VEHICLES_NP);
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public String primary_style;

				public String getPrimary_style () {
					return this.primary_style;
				}
			    ...
			    public String primary_maintainer;

				public String getPrimary_maintainer () {
					return this.primary_maintainer;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.vehicle_id;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.vehicle_id = this.vehicle_id;
	            ...
	            other.primary_style = this.primary_style;
	            other.exterior_color = this.exterior_color;
	            other.vin = this.vin;
	            other.primary_maintainer = this.primary_maintainer;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Vehicles_NP) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.vehicle = readString(dis);
					
					this.primary_style = readString(dis);
					
					this.exterior_color = readString(dis);
					
					this.vin = readString(dis);
					
					this.primary_maintainer = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.vehicle,dos);
					
					// String
				
						writeString(this.primary_style,dos);
					
					// String
				
						writeString(this.exterior_color,dos);
					...
					// String
						...
						writeString(this.primary_maintainer,dos);
    ...
    public String toString() {
		...
		sb.append(",primary_style="+primary_style);
		sb.append(",exterior_color="+exterior_color);
		sb.append(",vin="+vin);
		sb.append(",primary_maintainer="+primary_maintainer);
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(long vehicle_id){
							this.vehicle_id = vehicle_id;
							return this;
						}				
						Short year;
						
	            		public BufferLine_tRedshiftOutput_1 c1(Short year){
							this.year = year;
							return this;
						}				
						String make;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String make){
							this.make = make;
							return this;
						}				
						String model;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String model){
							this.model = model;
							return this;
						}				
						String vehicle;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String vehicle){
							this.vehicle = vehicle;
							return this;
						}				
						String primary_style;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String primary_style){
							this.primary_style = primary_style;
							return this;
						}				
						String exterior_color;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String exterior_color){
							this.exterior_color = exterior_color;
							return this;
						}				
						String vin;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String vin){
							this.vin = vin;
							return this;
						}				
						String primary_maintainer;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String primary_maintainer){
							this.primary_maintainer = primary_maintainer;
							return this;
						}				
						Long community_id;
						
	            		public BufferLine_tRedshiftOutput_1 c9(Long community_id){
			...
			for(int i_tRedshiftOutput_1=0;i_tRedshiftOutput_1 < 3000;i_tRedshiftOutput_1++){
				 extendInsertValueStmt_tRedshiftOutput_1.append("(?,?,?,?,?,?,?,?,?,?)");
				 if (i_tRedshiftOutput_1!=3000-1) extendInsertValueStmt_tRedshiftOutput_1.append(",");
			}

			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"vehicle_id\",\"year\",\"make\",\"model\",\"vehicle\",\"primary_style\",\"exterior_color\",\"vin\",\"primary_maintainer\",\"community_id\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.vehicle_id = 0;
					
							Row_FeedRecord.year = null;
					
							Row_FeedRecord.make = null;
					
							Row_FeedRecord.model = null;
					
							Row_FeedRecord.vehicle = null;
					
							Row_FeedRecord.primary_style = null;
					
							Row_FeedRecord.exterior_color = null;
					
							Row_FeedRecord.vin = null;
					
							Row_FeedRecord.primary_maintainer = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.vehicle_id = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'vehicle_id' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.year = ParserUtils.parseTo_Short(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.make = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.model = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.vehicle = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.primary_style = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.exterior_color = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.vin = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.primary_maintainer = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.year = Row_FeedRecord.year;
Record_OutputToDB.make = StringUtils.trimToNull(Row_FeedRecord.make);
Record_OutputToDB.model = StringUtils.trimToNull(Row_FeedRecord.model);
Record_OutputToDB.vehicle = StringUtils.trimToNull(Row_FeedRecord.vehicle);
Record_OutputToDB.primary_style = StringUtils.trimToNull(Row_FeedRecord.primary_style);
Record_OutputToDB.exterior_color = StringUtils.trimToNull(Row_FeedRecord.exterior_color);
Record_OutputToDB.vin = StringUtils.trimToNull(Row_FeedRecord.vin);
Record_OutputToDB.primary_maintainer = StringUtils.trimToNull(Row_FeedRecord.primary_maintainer);
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.year==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setShort(countertRedshiftOutput_1,Record_OutputToDB.year);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.make==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.make);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.model==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.model);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.vehicle==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.vehicle);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.primary_style==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.primary_style);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.exterior_color==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.exterior_color);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.vin==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.vin);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.primary_maintainer==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.primary_maintainer);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.vehicle_id)
                        .c1(Record_OutputToDB.year)
                        .c2(Record_OutputToDB.make)
                        .c3(Record_OutputToDB.model)
                        .c4(Record_OutputToDB.vehicle)
                        .c5(Record_OutputToDB.primary_style)
                        .c6(Record_OutputToDB.exterior_color)
                        .c7(Record_OutputToDB.vin)
                        .c8(Record_OutputToDB.primary_maintainer)
                        .c9(Record_OutputToDB.community_id)
				;
				...
				if(rowCounttRedshiftOutput_1 == 3000){
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.year = Record_OutputToDB.year;
                                After_Insert.make = Record_OutputToDB.make;
                                After_Insert.model = Record_OutputToDB.model;
                                After_Insert.vehicle = Record_OutputToDB.vehicle;
                                After_Insert.primary_style = Record_OutputToDB.primary_style;
                                After_Insert.exterior_color = Record_OutputToDB.exterior_color;
                                After_Insert.vin = Record_OutputToDB.vin;
                                After_Insert.primary_maintainer = Record_OutputToDB.primary_maintainer;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.year = After_Insert.year;
               Log_Rows.make = After_Insert.make;
               Log_Rows.model = After_Insert.model;
               Log_Rows.vehicle = After_Insert.vehicle;
               Log_Rows.primary_style = After_Insert.primary_style;
               Log_Rows.exterior_color = After_Insert.exterior_color;
               Log_Rows.vin = After_Insert.vin;
               Log_Rows.primary_maintainer = After_Insert.primary_maintainer;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"vehicle_id\",\"year\",\"make\",\"model\",\"vehicle\",\"primary_style\",\"exterior_color\",\"vin\",\"primary_maintainer\",\"community_id\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.year==null){
					...
					pstmt_tRedshiftOutput_1.setShort(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.year);
					...
					if(bufferLtRedshiftOutput_1.make==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.make);
					...
					if(bufferLtRedshiftOutput_1.model==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.model);
					...
					if(bufferLtRedshiftOutput_1.vehicle==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.vehicle);
					...
					if(bufferLtRedshiftOutput_1.primary_style==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.primary_style);
					...
					if(bufferLtRedshiftOutput_1.exterior_color==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.exterior_color);
					...
					if(bufferLtRedshiftOutput_1.vin==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.vin);
					...
					if(bufferLtRedshiftOutput_1.primary_maintainer==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.primary_maintainer);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.primary_style = null;
					
							row1.exterior_color = null;
					
							row1.vin = null;
					
							row1.primary_maintainer = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.vehicle_id = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'vehicle_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.year = ParserUtils.parseTo_Short(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.make = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.model = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.vehicle = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.primary_style = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.exterior_color = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.vin = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.primary_maintainer = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.year = row1.year;
row2.make = StringUtils.trimToNull(row1.make);
row2.model = StringUtils.trimToNull(row1.model);
row2.vehicle = StringUtils.trimToNull(row1.vehicle);
row2.primary_style = StringUtils.trimToNull(row1.primary_style);
row2.exterior_color = StringUtils.trimToNull(row1.exterior_color);
row2.vin = StringUtils.trimToNull(row1.vin);
row2.primary_maintainer = StringUtils.trimToNull(row1.primary_maintainer);
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[10];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.vehicle_id);
                            rowtFileOutputDelimited_1[1]=row2.year == null ? null : String.valueOf(row2.year);
                            rowtFileOutputDelimited_1[2]=row2.make == null ? null : row2.make;
                            rowtFileOutputDelimited_1[3]=row2.model == null ? null : row2.model;
                            rowtFileOutputDelimited_1[4]=row2.vehicle == null ? null : row2.vehicle;
                            rowtFileOutputDelimited_1[5]=row2.primary_style == null ? null : row2.primary_style;
                            rowtFileOutputDelimited_1[6]=row2.exterior_color == null ? null : row2.exterior_color;
                            rowtFileOutputDelimited_1[7]=row2.vin == null ? null : row2.vin;
                            rowtFileOutputDelimited_1[8]=row2.primary_maintainer == null ? null : row2.primary_maintainer;
                            rowtFileOutputDelimited_1[9]=row2.community_id == null ? null : String.valueOf(row2.community_id);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Vehicles_NP StageFeed_Vehicles_NPClass = new StageFeed_Vehicles_NP();

        int exitCode = StageFeed_Vehicles_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Vehicles_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_vehicles_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Vehicles_NP");
        }
...
/************************************************************************************************
 *     322583 characters generated by Talend Open Studio for Data Integration 
