...
package zipcar_marketingdw.processstaging_couponclaims_0_1;
...
/**
 * Job: ProcessStaging_CouponClaims Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_CouponClaims implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_CouponClaims";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Hgwu4J84EeiRFIAwSyk92Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_CouponClaims.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_CouponClaims.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_CouponClaims) {
...
"\nINSERT INTO {{marketing.schema}}.r_coupon_claim\n(\n	claim_id,\n	credit_id,\n	coupon_id,\n	person_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n    imported_date\n)\nSELECT \n	claim_id,\n	credit_id,\n	coupon_id,\n	person_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.coupon_claims\nMINUS\nSELECT \n	claim_id,\n	credit_id,\n	coupon_id,\n	person_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_coupon_claim\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".coupon_claims";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_CouponClaims ProcessStaging_CouponClaimsClass = new ProcessStaging_CouponClaims();

        int exitCode = ProcessStaging_CouponClaimsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_CouponClaims.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_couponclaims_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_CouponClaims");
        }
...
/************************************************************************************************
 *     135785 characters generated by Talend Open Studio for Data Integration 
