...
package zipcar_marketingdw.processstaging_strongviewmailingdata_0_1;
...
/**
 * Job: ProcessStaging_StrongviewMailingData Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_StrongviewMailingData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_StrongviewMailingData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_cD2NgDWZEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_StrongviewMailingData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_StrongviewMailingData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewMailingData) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "strongview_mailing_data";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_strongview_mailing_data";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_strongview_mailing_data\n(\n    mailing_id,\n    actual_sent_count,\n    bounce_count,\n    campaign_id,\n    campaign_name,\n    click_count,\n    data_source_id,\n    department_id,\n    mailed_count,\n    open_count,\n    parent_id,\n    subject_line,\n    start_time,\n    end_time,\n    imported_date\n)\nSELECT \n    mailing_id,\n    actual_sent_count,\n    bounce_count,\n    campaign_id,\n    campaign_name,\n    click_count,\n    data_source_id,\n    department_id,\n    mailed_count,\n    open_count,\n    parent_id,\n    subject_line,\n    start_time,\n    end_time,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.strongview_mailing_data\nMINUS\nSELECT \n    mailing_id,\n    actual_sent_count,\n    bounce_count,\n    campaign_id,\n    campaign_name,\n    click_count,\n    data_source_id,\n    department_id,\n    mailed_count,\n    open_count,\n    parent_id,\n    subject_line,\n    start_time,\n    end_time,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_strongview_mailing_data\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".strongview_mailing_data";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_StrongviewMailingData ProcessStaging_StrongviewMailingDataClass = new ProcessStaging_StrongviewMailingData();

        int exitCode = ProcessStaging_StrongviewMailingDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_StrongviewMailingData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_strongviewmailingdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_StrongviewMailingData");
        }
...
/************************************************************************************************
 *     136604 characters generated by Talend Open Studio for Data Integration 
