...
package zipcar_marketingdw.subjobs_daily_0_1;
...
/**
 * Job: Subjobs_Daily Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Subjobs_Daily implements TalendJob {
	...
	private final String jobName = "Subjobs_Daily";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Subjobs_Daily.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Subjobs_Daily.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.waitforfeedfiles_0_1.WaitForFeedFiles childJob_tRunJob_1 = new zipcar_marketingdw.waitforfeedfiles_0_1.WaitForFeedFiles();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.loadfeedsintostaging_0_1.LoadFeedsIntoStaging childJob_tRunJob_2 = new zipcar_marketingdw.loadfeedsintostaging_0_1.LoadFeedsIntoStaging();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.processallstagingtables_0_1.ProcessAllStagingTables childJob_tRunJob_3 = new zipcar_marketingdw.processallstagingtables_0_1.ProcessAllStagingTables();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		zipcar_marketingdw.process_update_location_data_0_1.Process_Update_Location_Data childJob_tRunJob_4 = new zipcar_marketingdw.process_update_location_data_0_1.Process_Update_Location_Data();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		zipcar_marketingdw.process_update_member_data_0_1.Process_Update_Member_Data childJob_tRunJob_5 = new zipcar_marketingdw.process_update_member_data_0_1.Process_Update_Member_Data();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		zipcar_marketingdw.process_update_member_location_distance_0_1.Process_Update_Member_Location_Distance childJob_tRunJob_6 = new zipcar_marketingdw.process_update_member_location_distance_0_1.Process_Update_Member_Location_Distance();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param isSubJob=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param isSubJob=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("isSubJob", obj_tRunJob_7);
	
	
		zipcar_marketingdw.process_daily_redemption_0_1.Process_Daily_Redemption childJob_tRunJob_7 = new zipcar_marketingdw.process_daily_redemption_0_1.Process_Daily_Redemption();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Subjobs_Daily Subjobs_DailyClass = new Subjobs_Daily();

        int exitCode = Subjobs_DailyClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Subjobs_Daily.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/subjobs_daily_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Subjobs_Daily");
        }
...
/************************************************************************************************
 *     68117 characters generated by Talend Open Studio for Data Integration 
