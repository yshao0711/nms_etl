...
package zipcar_marketingdw.processstaging_wexfueldata_0_1;
...
/**
 * Job: ProcessStaging_WexFuelData Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_WexFuelData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_WexFuelData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_20JQMBf2EeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_WexFuelData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_WexFuelData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_WexFuelData) {
...
"\nINSERT INTO {{marketing.schema}}.r_wex_fuel_data\n(\n	fileid,\n	member_id,\n	vehicle_id,\n	zipfleet_id,\n	transaction_time,\n	creation_date,\n	last_modified,\n	deleted_date,\n    imported_date\n)\nSELECT \n	fileid,\n	driver_id,\n	vehicle_id,\n	zipfleet_id,\n	transaction_time,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.wex_fuel_data\nMINUS\nSELECT \n	fileid,\n	member_id,\n	vehicle_id,\n	zipfleet_id,\n	transaction_time,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_wex_fuel_data\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".wex_fuel_data";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_WexFuelData ProcessStaging_WexFuelDataClass = new ProcessStaging_WexFuelData();

        int exitCode = ProcessStaging_WexFuelDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_WexFuelData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_wexfueldata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_WexFuelData");
        }
...
/************************************************************************************************
 *     135820 characters generated by Talend Open Studio for Data Integration 
