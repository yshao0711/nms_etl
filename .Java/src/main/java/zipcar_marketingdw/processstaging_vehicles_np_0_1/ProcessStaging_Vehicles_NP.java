...
package zipcar_marketingdw.processstaging_vehicles_np_0_1;
...
/**
 * Job: ProcessStaging_Vehicles_NP Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Vehicles_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Vehicles_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_xi43cHDWEeiSo7gaW0ZDPg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Vehicles_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Vehicles_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Vehicles_NP) {
...
"\nINSERT INTO {{marketing.schema}}.r_vehicle_np\n(\n    vehicle_id,\n    year,\n    make,\n    model,\n    vehicle,\n    primary_style,\n    exterior_color,\n    vin,\n	primary_maintainer,\n	community_id,\n    imported_date\n)\nSELECT \n    vehicle_id,\n    year,\n    make,\n    model,\n    vehicle,\n    primary_style,\n    exterior_color,\n    vin,\n	primary_maintainer,\n	community_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.vehicles_np\nMINUS\nSELECT \n    vehicle_id,\n    year,\n    make,\n    model,\n    vehicle,\n    primary_style,\n    exterior_color,\n    vin,\n	primary_maintainer,\n	community_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_vehicle_np\n",
...
"\n	truncate {{staging.schema}}.vehicles_np;\n",
"staging.schema",  StringHandling.DQUOTE(context.Redshift_Staging_Schema)
);
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Vehicles_NP ProcessStaging_Vehicles_NPClass = new ProcessStaging_Vehicles_NP();

        int exitCode = ProcessStaging_Vehicles_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Vehicles_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_vehicles_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Vehicles_NP");
        }
...
/************************************************************************************************
 *     135985 characters generated by Talend Open Studio for Data Integration 
