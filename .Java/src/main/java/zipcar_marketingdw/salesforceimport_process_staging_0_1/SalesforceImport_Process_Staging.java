...
package zipcar_marketingdw.salesforceimport_process_staging_0_1;
...
/**
 * Job: SalesforceImport_Process_Staging Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class SalesforceImport_Process_Staging implements TalendJob {
...
public String getRedshift_Marketing_Port(){
	...
	private final String jobName = "SalesforceImport_Process_Staging";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Q4eNgFrOEei_EJm82Z_azQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SalesforceImport_Process_Staging.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SalesforceImport_Process_Staging.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_SalesforceImport_Process_Staging) {
...
Logging.componentName(jobName, "tWarn_1", "Log_Process_Staging");
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Process staging tables done.","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Process staging tables done.", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Process staging tables done."); 
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.processstaging_bounces_0_1.ProcessStaging_Bounces childJob_tRunJob_1 = new zipcar_marketingdw.processstaging_bounces_0_1.ProcessStaging_Bounces();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.processstaging_clicks_0_1.ProcessStaging_Clicks childJob_tRunJob_2 = new zipcar_marketingdw.processstaging_clicks_0_1.ProcessStaging_Clicks();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.processstaging_opens_0_1.ProcessStaging_Opens childJob_tRunJob_3 = new zipcar_marketingdw.processstaging_opens_0_1.ProcessStaging_Opens();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		zipcar_marketingdw.processstaging_sent_0_1.ProcessStaging_Sent childJob_tRunJob_4 = new zipcar_marketingdw.processstaging_sent_0_1.ProcessStaging_Sent();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		zipcar_marketingdw.processstaging_unsubs_0_1.ProcessStaging_Unsubs childJob_tRunJob_5 = new zipcar_marketingdw.processstaging_unsubs_0_1.ProcessStaging_Unsubs();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		zipcar_marketingdw.processstaging_log_send_0_1.ProcessStaging_Log_Send childJob_tRunJob_6 = new zipcar_marketingdw.processstaging_log_send_0_1.ProcessStaging_Log_Send();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		zipcar_marketingdw.processstaging_log_control_0_1.ProcessStaging_Log_Control childJob_tRunJob_7 = new zipcar_marketingdw.processstaging_log_control_0_1.ProcessStaging_Log_Control();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final SalesforceImport_Process_Staging SalesforceImport_Process_StagingClass = new SalesforceImport_Process_Staging();

        int exitCode = SalesforceImport_Process_StagingClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SalesforceImport_Process_Staging.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/salesforceimport_process_staging_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SalesforceImport_Process_Staging");
        }
...
/************************************************************************************************
 *     176014 characters generated by Talend Open Studio for Data Integration 
