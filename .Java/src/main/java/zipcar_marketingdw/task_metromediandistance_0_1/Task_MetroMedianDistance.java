...
package zipcar_marketingdw.task_metromediandistance_0_1;
...
/**
 * Job: Task_MetroMedianDistance Purpose: calculate metro median distance used for  proximity calculation in location segmentation<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Task_MetroMedianDistance implements TalendJob {
...
public String getRedshift_Monitoring_Server(){
	...
	private final String jobName = "Task_MetroMedianDistance";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_-ZFB0FKkEeeqT_QylVjy4Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Task_MetroMedianDistance.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Task_MetroMedianDistance.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_MetroMedianDistance) {
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRedshiftConnection_1:OnSubjobOk1", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
							...
							tRedshiftRow_4Process(globalMap); 
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRedshiftConnection_1:OnSubjobOk2", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
"\nDELETE FROM {{marketing.schema}}.l_metro_median_distance\nWHERE start_date >= {{startDate}}\n",
"marketing.schema", StringHandling.DQUOTE(context.Redshift_Marketing_Schema),
"startDate", DateUtils.dateToSqlStr(context.MetroMedianStartDate),
"endDate", DateUtils.dateToSqlStr(context.MetroMedianEndDate)
);
...
"\nUPDATE {{marketing.schema}}.l_metro_median_distance\nSET end_date = '3199-12-31'\nWHERE end_date = {{endDate}} \n",
"marketing.schema", StringHandling.DQUOTE(context.Redshift_Marketing_Schema),
"endDate", DateUtils.dateToSqlStr(TalendDate.addDate(context.MetroMedianStartDate, -1, "dd"))
);
...
"\nDELETE FROM {{marketing.schema}}.l_metro_median_distance WHERE end_date <= start_date\n",
"marketing.schema", StringHandling.DQUOTE(context.Redshift_Marketing_Schema),
"startDate", DateUtils.dateToSqlStr(context.MetroMedianStartDate),
"endDate", DateUtils.dateToSqlStr(context.MetroMedianEndDate)
);
 ...
 */
    ...
    public static void main(String[] args){
        final Task_MetroMedianDistance Task_MetroMedianDistanceClass = new Task_MetroMedianDistance();

        int exitCode = Task_MetroMedianDistanceClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Task_MetroMedianDistance.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/task_metromediandistance_0_1/contexts/"+contextStr+".properties");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("MetroMedianStartDate")) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Task_MetroMedianDistance");
        }
...
/************************************************************************************************
 *     140809 characters generated by Talend Open Studio for Data Integration 
