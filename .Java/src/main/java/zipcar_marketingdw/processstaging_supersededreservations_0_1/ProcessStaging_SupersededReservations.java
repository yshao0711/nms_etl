...
package zipcar_marketingdw.processstaging_supersededreservations_0_1;
...
/**
 * Job: ProcessStaging_SupersededReservations Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_SupersededReservations implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_SupersededReservations";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_OdV_oH3nEeetQ55dI4r5MA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_SupersededReservations.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_SupersededReservations.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_SupersededReservations) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "superseded_reservations";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_superseded_reservation";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_superseded_reservation\n(\n    reservation_id,\n    superseded_by,\n	original_reservation_id,\n	member_id,\n    imported_date\n)\nSELECT \n    reservation_id,\n    superseded_by,\n	original_reservation_id,\n	driver_id as member_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.superseded_reservations\nMINUS\nSELECT \n    reservation_id,\n    superseded_by,\n	original_reservation_id,\n	member_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_superseded_reservation\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".superseded_reservations";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_SupersededReservations ProcessStaging_SupersededReservationsClass = new ProcessStaging_SupersededReservations();

        int exitCode = ProcessStaging_SupersededReservationsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_SupersededReservations.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_supersededreservations_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_SupersededReservations");
        }
...
/************************************************************************************************
 *     136108 characters generated by Talend Open Studio for Data Integration 
