...
package zipcar_marketingdw.processstaging_accountmembermap_0_1;
...
/**
 * Job: ProcessStaging_AccountMemberMap Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_AccountMemberMap implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_AccountMemberMap";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_4DxyoNNuEeaadNPhZo4P-Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_AccountMemberMap.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_AccountMemberMap.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_AccountMemberMap) {
...
Logging.componentName(jobName, "tWarn_2", "Log_JobCompleted");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "account_member_map";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_account_member_map";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_account_member_map \n(\naccount_id,\nmember_id,\nstart_date,\nstart_date_tz,\nend_date,\nend_date_tz,\nstatus,\ncreation_date,\nlast_modified,\ndeleted_date,\nimported_date\n)\nSELECT\n    account_id,\n    member_id,\n    start_date,\n    start_date_tz,\n    end_date,\n    end_date_tz,\n    status,\n    creation_date,\n    last_modified,\n    deleted_date, \n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.account_member_map\nMINUS\nSELECT\n    account_id,\n    member_id,\n    start_date,\n    start_date_tz,\n    end_date,\n    end_date_tz,\n    status,\n    creation_date,\n    last_modified,\n    deleted_date, \n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM  {{marketing.schema}}.vw_r_account_member_map\n",
...
query_tRedshiftRow_1 = "truncate table " + context.Redshift_Staging_Schema + ".account_member_map";
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Historical Records Inserted for: " + DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate)),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 3, "Historical Records Inserted for: " + DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate)), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Historical Records Inserted for: " + DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate))); 
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_AccountMemberMap ProcessStaging_AccountMemberMapClass = new ProcessStaging_AccountMemberMap();

        int exitCode = ProcessStaging_AccountMemberMapClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_AccountMemberMap.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_accountmembermap_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_AccountMemberMap");
        }
...
/************************************************************************************************
 *     136122 characters generated by Talend Open Studio for Data Integration 
