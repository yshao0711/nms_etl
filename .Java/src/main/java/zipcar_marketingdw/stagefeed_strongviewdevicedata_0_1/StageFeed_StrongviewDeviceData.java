...
package zipcar_marketingdw.stagefeed_strongviewdevicedata_0_1;
...
/**
 * Job: StageFeed_StrongviewDeviceData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewDeviceData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewDeviceData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_YAYokMsJEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewDeviceData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewDeviceData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_DEVICE_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_DEVICE_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_DEVICE_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData = new byte[0];
			    ...
			    public String DEVICE_EVENT_TYP;

				public String getDEVICE_EVENT_TYP () {
					return this.DEVICE_EVENT_TYP;
				}
				...
				public String getUSER_AGENT_HEADER () {
			    ...
			    public String COMPOSITE_DEVICE_CAT_CODE;

				public String getCOMPOSITE_DEVICE_CAT_CODE () {
					return this.COMPOSITE_DEVICE_CAT_CODE;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewDeviceData) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DEVICE_EVENT_TYP = readString(dis);
					...
					this.LINK_ID = readString(dis);
					
					this.USER_AGENT_HEADER = readString(dis);
					
					this.URL_PATH = readString(dis);
					
					this.COMPOSITE_DEVICE_CAT_CODE = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DEVICE_EVENT_TYP,dos);
					...
					// String
						...
						writeString(this.LINK_ID,dos);
					
					// String
				
						writeString(this.USER_AGENT_HEADER,dos);
					
					// String
				
						writeString(this.URL_PATH,dos);
					
					// String
				
						writeString(this.COMPOSITE_DEVICE_CAT_CODE,dos);
    ...
    public String toString() {
		...
		sb.append(",DEVICE_EVENT_TYP="+DEVICE_EVENT_TYP);
		...
		sb.append(",LINK_ID="+LINK_ID);
		sb.append(",USER_AGENT_HEADER="+USER_AGENT_HEADER);
		sb.append(",URL_PATH="+URL_PATH);
		sb.append(",COMPOSITE_DEVICE_CAT_CODE="+COMPOSITE_DEVICE_CAT_CODE);
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						...
						String DEVICE_EVENT_TYP;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String DEVICE_EVENT_TYP){
							this.DEVICE_EVENT_TYP = DEVICE_EVENT_TYP;
							return this;
						}				
						String SOURCE_IP;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String SOURCE_IP){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c8(String LINK_ID){
							this.LINK_ID = LINK_ID;
							return this;
						}				
						String USER_AGENT_HEADER;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String USER_AGENT_HEADER){
							this.USER_AGENT_HEADER = USER_AGENT_HEADER;
							return this;
						}				
						String URL_PATH;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String URL_PATH){
							this.URL_PATH = URL_PATH;
							return this;
						}				
						String COMPOSITE_DEVICE_CAT_CODE;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String COMPOSITE_DEVICE_CAT_CODE){
							this.COMPOSITE_DEVICE_CAT_CODE = COMPOSITE_DEVICE_CAT_CODE;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"DATA_CAPTURED_DT\",\"DEVICE_EVENT_TYP\",\"SOURCE_IP\",\"SERIAL_NO\",\"MAILING_ID\",\"DATABASE_ID\",\"MESSAGE_ID\",\"USER_ID\",\"LINK_ID\",\"USER_AGENT_HEADER\",\"URL_PATH\",\"COMPOSITE_DEVICE_CAT_CODE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.DEVICE_EVENT_TYP = null;
							...
							Row_FeedRecord.USER_AGENT_HEADER = null;
					
							Row_FeedRecord.URL_PATH = null;
					
							Row_FeedRecord.COMPOSITE_DEVICE_CAT_CODE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DEVICE_EVENT_TYP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LINK_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.USER_AGENT_HEADER = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.URL_PATH = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.COMPOSITE_DEVICE_CAT_CODE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.DEVICE_EVENT_TYP = StringUtils.trimToNull(Row_FeedRecord.DEVICE_EVENT_TYP);
...
Record_OutputToDB.LINK_ID = StringUtils.trimToNull(Row_FeedRecord.LINK_ID);
Record_OutputToDB.USER_AGENT_HEADER = StringUtils.trimToNull(Row_FeedRecord.USER_AGENT_HEADER);
Record_OutputToDB.URL_PATH = StringUtils.trimToNull(Row_FeedRecord.URL_PATH);
Record_OutputToDB.COMPOSITE_DEVICE_CAT_CODE = StringUtils.trimToNull(Row_FeedRecord.COMPOSITE_DEVICE_CAT_CODE);
    nb_line_tJavaRow_3++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DEVICE_EVENT_TYP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DEVICE_EVENT_TYP);
						...
						countertRedshiftOutput_1++;
							...
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LINK_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.USER_AGENT_HEADER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.USER_AGENT_HEADER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.URL_PATH==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.URL_PATH);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.COMPOSITE_DEVICE_CAT_CODE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.COMPOSITE_DEVICE_CAT_CODE);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.DEVICE_EVENT_TYP)
                        .c2(Record_OutputToDB.SOURCE_IP)
                        ...
                        .c8(Record_OutputToDB.LINK_ID)
                        .c9(Record_OutputToDB.USER_AGENT_HEADER)
                        .c10(Record_OutputToDB.URL_PATH)
                        .c11(Record_OutputToDB.COMPOSITE_DEVICE_CAT_CODE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.DEVICE_EVENT_TYP = Record_OutputToDB.DEVICE_EVENT_TYP;
                                ...
                                After_Insert.USER_AGENT_HEADER = Record_OutputToDB.USER_AGENT_HEADER;
                                After_Insert.URL_PATH = Record_OutputToDB.URL_PATH;
                                After_Insert.COMPOSITE_DEVICE_CAT_CODE = Record_OutputToDB.COMPOSITE_DEVICE_CAT_CODE;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.DEVICE_EVENT_TYP = After_Insert.DEVICE_EVENT_TYP;
               ...
               Log_Rows.USER_AGENT_HEADER = After_Insert.USER_AGENT_HEADER;
               Log_Rows.URL_PATH = After_Insert.URL_PATH;
               Log_Rows.COMPOSITE_DEVICE_CAT_CODE = After_Insert.COMPOSITE_DEVICE_CAT_CODE;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"DATA_CAPTURED_DT\",\"DEVICE_EVENT_TYP\",\"SOURCE_IP\",\"SERIAL_NO\",\"MAILING_ID\",\"DATABASE_ID\",\"MESSAGE_ID\",\"USER_ID\",\"LINK_ID\",\"USER_AGENT_HEADER\",\"URL_PATH\",\"COMPOSITE_DEVICE_CAT_CODE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.DEVICE_EVENT_TYP==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DEVICE_EVENT_TYP);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LINK_ID);
					...
					if(bufferLtRedshiftOutput_1.USER_AGENT_HEADER==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.USER_AGENT_HEADER);
					...
					if(bufferLtRedshiftOutput_1.URL_PATH==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.URL_PATH);
					...
					if(bufferLtRedshiftOutput_1.COMPOSITE_DEVICE_CAT_CODE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.COMPOSITE_DEVICE_CAT_CODE);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.USER_AGENT_HEADER = null;
					
							row1.URL_PATH = null;
					
							row1.COMPOSITE_DEVICE_CAT_CODE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DEVICE_EVENT_TYP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LINK_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.USER_AGENT_HEADER = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.URL_PATH = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.COMPOSITE_DEVICE_CAT_CODE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.DEVICE_EVENT_TYP = StringUtils.trimToNull(row1.DEVICE_EVENT_TYP);
...
row2.LINK_ID = StringUtils.trimToNull(row1.LINK_ID);
row2.USER_AGENT_HEADER = StringUtils.trimToNull(row1.USER_AGENT_HEADER);
row2.URL_PATH = StringUtils.trimToNull(row1.URL_PATH);
row2.COMPOSITE_DEVICE_CAT_CODE = StringUtils.trimToNull(row1.COMPOSITE_DEVICE_CAT_CODE);
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[12];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.DEVICE_EVENT_TYP == null ? null : row2.DEVICE_EVENT_TYP;
                            rowtFileOutputDelimited_1[2]=row2.SOURCE_IP == null ? null : row2.SOURCE_IP;
                            ...
                            rowtFileOutputDelimited_1[8]=row2.LINK_ID == null ? null : row2.LINK_ID;
                            rowtFileOutputDelimited_1[9]=row2.USER_AGENT_HEADER == null ? null : row2.USER_AGENT_HEADER;
                            rowtFileOutputDelimited_1[10]=row2.URL_PATH == null ? null : row2.URL_PATH;
                            rowtFileOutputDelimited_1[11]=row2.COMPOSITE_DEVICE_CAT_CODE == null ? null : row2.COMPOSITE_DEVICE_CAT_CODE;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewDeviceData StageFeed_StrongviewDeviceDataClass = new StageFeed_StrongviewDeviceData();

        int exitCode = StageFeed_StrongviewDeviceDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewDeviceData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewdevicedata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewDeviceData");
        }
...
/************************************************************************************************
 *     327309 characters generated by Talend Open Studio for Data Integration 
