...
package zipcar_marketingdw.processstaging_waiverplans_0_1;
...
/**
 * Job: ProcessStaging_WaiverPlans Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_WaiverPlans implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_WaiverPlans";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Sm3gwMu6EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_WaiverPlans.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_WaiverPlans.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_WaiverPlans) {
...
"\nINSERT INTO {{marketing.schema}}.r_waiver_plan\n(\n	waiver_plan_id,\n	waiver_plan_class_id,\n	name,\n	public_name,\n	plan_key,\n	description,\n	frequency,\n	fee,\n	pro_rate_p,\n	deductible,\n	active_p,\n	public_p,\n	corporate_p,\n	autorenew_p,\n	operation,\n	risk_tier_id,\n	charge_model,\n	zipfleet_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n	new_plan_name,\n    imported_date\n)\nSELECT \n	waiver_plan_id,\n	waiver_plan_class_id,\n	name,\n	public_name,\n	plan_key,\n	description,\n	frequency,\n	fee,\n	pro_rate_p,\n	deductible,\n	active_p,\n	public_p,\n	corporate_p,\n	autorenew_p,\n	operation,\n	risk_tier_id,\n	charge_model,\n	zipfleet_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n	new_plan_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.waiver_plans\nMINUS\nSELECT \n	waiver_plan_id,\n	waiver_plan_class_id,\n	name,\n	public_name,\n	plan_key,\n	description,\n	frequency,\n	fee,\n	pro_rate_p,\n	deductible,\n	active_p,\n	public_p,\n	corporate_p,\n	autorenew_p,\n	operation,\n	risk_tier_id,\n	charge_model,\n	zipfleet_id,\n	creation_date,\n	last_modified,\n	deleted_date,\n	new_plan_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_waiver_plan\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".waiver_plans";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_WaiverPlans ProcessStaging_WaiverPlansClass = new ProcessStaging_WaiverPlans();

        int exitCode = ProcessStaging_WaiverPlansClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_WaiverPlans.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_waiverplans_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_WaiverPlans");
        }
...
/************************************************************************************************
 *     136432 characters generated by Talend Open Studio for Data Integration 
