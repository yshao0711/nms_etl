...
package zipcar_marketingdw.subjobs_monthly_0_1;
...
/**
 * Job: Subjobs_Monthly Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Subjobs_Monthly implements TalendJob {
	...
	private final String jobName = "Subjobs_Monthly";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Subjobs_Monthly.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Subjobs_Monthly.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.process_monthly_member_activity_0_1.Process_Monthly_Member_Activity childJob_tRunJob_1 = new zipcar_marketingdw.process_monthly_member_activity_0_1.Process_Monthly_Member_Activity();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.process_monthly_rfm_member_data_0_1.Process_Monthly_RFM_Member_Data childJob_tRunJob_2 = new zipcar_marketingdw.process_monthly_rfm_member_data_0_1.Process_Monthly_RFM_Member_Data();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.process_monthly_member_performance_0_1.Process_Monthly_Member_Performance childJob_tRunJob_3 = new zipcar_marketingdw.process_monthly_member_performance_0_1.Process_Monthly_Member_Performance();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		zipcar_marketingdw.process_monthly_location_segments_0_1.Process_Monthly_Location_Segments childJob_tRunJob_4 = new zipcar_marketingdw.process_monthly_location_segments_0_1.Process_Monthly_Location_Segments();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		zipcar_marketingdw.process_monthly_member_details_0_1.Process_Monthly_Member_Details childJob_tRunJob_5 = new zipcar_marketingdw.process_monthly_member_details_0_1.Process_Monthly_Member_Details();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Subjobs_Monthly Subjobs_MonthlyClass = new Subjobs_Monthly();

        int exitCode = Subjobs_MonthlyClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Subjobs_Monthly.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/subjobs_monthly_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Subjobs_Monthly");
        }
...
/************************************************************************************************
 *     54061 characters generated by Talend Open Studio for Data Integration 
