...
package zipcar_marketingdw.stagefeed_strongviewconvdata_0_1;
...
/**
 * Job: StageFeed_StrongviewConvData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewConvData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewConvData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_ukqPIMr7EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewConvData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewConvData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_CONV_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_CONV_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_CONV_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData = new byte[0];
			    ...
			    public String TRACK_EVENT_TYPE;

				public String getTRACK_EVENT_TYPE () {
					return this.TRACK_EVENT_TYPE;
				}
				
			    public Integer DIFFERENTIATOR;

				public Integer getDIFFERENTIATOR () {
			    ...
			    public String CONVERSION_TAG;

				public String getCONVERSION_TAG () {
					return this.CONVERSION_TAG;
				}
				
			    public Double CONVERSION_VALUE;

				public Double getCONVERSION_VALUE () {
					return this.CONVERSION_VALUE;
				}
				
			    public Integer CONVERSION_ITEM;

				public Integer getCONVERSION_ITEM () {
					return this.CONVERSION_ITEM;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewConvData) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.TRACK_EVENT_TYPE = readString(dis);
					
						this.DIFFERENTIATOR = readInteger(dis);
					
					this.SOURCE_IP = readString(dis);
					...
					this.TEMPLATE_ID = readString(dis);
					...
					this.EMAIL_ADDRESS = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.LINK_ID = dis.readLong();
           				}
					
					this.EXTRA = readString(dis);
					
					this.CONVERSION_TAG = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.CONVERSION_VALUE = null;
           				} else {
           			    	this.CONVERSION_VALUE = dis.readDouble();
           				}
					
						this.CONVERSION_ITEM = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.TRACK_EVENT_TYPE,dos);
					
					// Integer
				
						writeInteger(this.DIFFERENTIATOR,dos);
					
					// String
				
						writeString(this.SOURCE_IP,dos);
					...
					// String
						...
						writeString(this.TEMPLATE_ID,dos);
					...
					// String
						...
						writeString(this.CONVERSION_TAG,dos);
					
					// Double
				
						if(this.CONVERSION_VALUE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.CONVERSION_VALUE);
		            	}
					
					// Integer
				
						writeInteger(this.CONVERSION_ITEM,dos);
    ...
    public String toString() {
		...
		sb.append(",TRACK_EVENT_TYPE="+TRACK_EVENT_TYPE);
		sb.append(",DIFFERENTIATOR="+String.valueOf(DIFFERENTIATOR));
		sb.append(",SOURCE_IP="+SOURCE_IP);
		...
		sb.append(",LINK_ID="+String.valueOf(LINK_ID));
		sb.append(",EXTRA="+EXTRA);
		sb.append(",CONVERSION_TAG="+CONVERSION_TAG);
		sb.append(",CONVERSION_VALUE="+String.valueOf(CONVERSION_VALUE));
		sb.append(",CONVERSION_ITEM="+String.valueOf(CONVERSION_ITEM));
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(java.util.Date DATA_CAPTURED_DT){
							this.DATA_CAPTURED_DT = DATA_CAPTURED_DT;
							return this;
						}				
						String TRACK_EVENT_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String TRACK_EVENT_TYPE){
							this.TRACK_EVENT_TYPE = TRACK_EVENT_TYPE;
							return this;
						}				
						Integer DIFFERENTIATOR;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Integer DIFFERENTIATOR){
							this.DIFFERENTIATOR = DIFFERENTIATOR;
							return this;
						}				
						String SOURCE_IP;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String SOURCE_IP){
							this.SOURCE_IP = SOURCE_IP;
							return this;
						}				
						String SERIAL_NUMBER;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String SERIAL_NUMBER){
							this.SERIAL_NUMBER = SERIAL_NUMBER;
							return this;
						}				
						String MAILING_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String MAILING_ID){
							this.MAILING_ID = MAILING_ID;
							return this;
						}				
						String TARGET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String TARGET_ID){
							this.TARGET_ID = TARGET_ID;
							return this;
						}				
						String TEMPLATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String TEMPLATE_ID){
							this.TEMPLATE_ID = TEMPLATE_ID;
							return this;
						}				
						String USER_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String USER_ID){
							this.USER_ID = USER_ID;
							return this;
						}				
						String EMAIL_ADDRESS;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String EMAIL_ADDRESS){
							this.EMAIL_ADDRESS = EMAIL_ADDRESS;
							return this;
						}				
						Long LINK_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Long LINK_ID){
							this.LINK_ID = LINK_ID;
							return this;
						}				
						String EXTRA;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String EXTRA){
							this.EXTRA = EXTRA;
							return this;
						}				
						String CONVERSION_TAG;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String CONVERSION_TAG){
							this.CONVERSION_TAG = CONVERSION_TAG;
							return this;
						}				
						Double CONVERSION_VALUE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(Double CONVERSION_VALUE){
							this.CONVERSION_VALUE = CONVERSION_VALUE;
							return this;
						}				
						Integer CONVERSION_ITEM;
						
	            		public BufferLine_tRedshiftOutput_1 c14(Integer CONVERSION_ITEM){
							this.CONVERSION_ITEM = CONVERSION_ITEM;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"DATA_CAPTURED_DT\",\"TRACK_EVENT_TYPE\",\"DIFFERENTIATOR\",\"SOURCE_IP\",\"SERIAL_NUMBER\",\"MAILING_ID\",\"TARGET_ID\",\"TEMPLATE_ID\",\"USER_ID\",\"EMAIL_ADDRESS\",\"LINK_ID\",\"EXTRA\",\"CONVERSION_TAG\",\"CONVERSION_VALUE\",\"CONVERSION_ITEM\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.TRACK_EVENT_TYPE = null;
					
							Row_FeedRecord.DIFFERENTIATOR = null;
					
							Row_FeedRecord.SOURCE_IP = null;
					
							Row_FeedRecord.SERIAL_NUMBER = null;
					
							Row_FeedRecord.MAILING_ID = null;
					
							Row_FeedRecord.TARGET_ID = null;
					
							Row_FeedRecord.TEMPLATE_ID = null;
					
							Row_FeedRecord.USER_ID = null;
					
							Row_FeedRecord.EMAIL_ADDRESS = null;
					
							Row_FeedRecord.LINK_ID = null;
					
							Row_FeedRecord.EXTRA = null;
					
							Row_FeedRecord.CONVERSION_TAG = null;
					
							Row_FeedRecord.CONVERSION_VALUE = null;
					
							Row_FeedRecord.CONVERSION_ITEM = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.TRACK_EVENT_TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.DIFFERENTIATOR = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SOURCE_IP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SERIAL_NUMBER = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.TARGET_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.TEMPLATE_ID = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LINK_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.EXTRA = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.CONVERSION_TAG = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.CONVERSION_VALUE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.CONVERSION_ITEM = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.TRACK_EVENT_TYPE = StringUtils.trimToNull(Row_FeedRecord.TRACK_EVENT_TYPE);
Record_OutputToDB.DIFFERENTIATOR = Row_FeedRecord.DIFFERENTIATOR;
Record_OutputToDB.SOURCE_IP = StringUtils.trimToNull(Row_FeedRecord.SOURCE_IP);
Record_OutputToDB.SERIAL_NUMBER = StringUtils.trimToNull(Row_FeedRecord.SERIAL_NUMBER);
Record_OutputToDB.MAILING_ID = StringUtils.trimToNull(Row_FeedRecord.MAILING_ID);
Record_OutputToDB.TARGET_ID = StringUtils.trimToNull(Row_FeedRecord.TARGET_ID);
Record_OutputToDB.TEMPLATE_ID = StringUtils.trimToNull(Row_FeedRecord.TEMPLATE_ID);
...
Record_OutputToDB.LINK_ID = Row_FeedRecord.LINK_ID;
Record_OutputToDB.EXTRA = StringUtils.trimToNull(Row_FeedRecord.EXTRA);
Record_OutputToDB.CONVERSION_TAG = StringUtils.trimToNull(Row_FeedRecord.CONVERSION_TAG);
Record_OutputToDB.CONVERSION_VALUE = Row_FeedRecord.CONVERSION_VALUE;
Record_OutputToDB.CONVERSION_ITEM = Row_FeedRecord.CONVERSION_ITEM;
    nb_line_tJavaRow_3++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TRACK_EVENT_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.TRACK_EVENT_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DIFFERENTIATOR==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.DIFFERENTIATOR);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SOURCE_IP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SOURCE_IP);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SERIAL_NUMBER==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SERIAL_NUMBER);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TARGET_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.TARGET_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TEMPLATE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.TEMPLATE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LINK_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LINK_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.EXTRA==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.EXTRA);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CONVERSION_TAG==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.CONVERSION_TAG);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CONVERSION_VALUE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.CONVERSION_VALUE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CONVERSION_ITEM==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.CONVERSION_ITEM);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.DATA_CAPTURED_DT)
                        .c1(Record_OutputToDB.TRACK_EVENT_TYPE)
                        .c2(Record_OutputToDB.DIFFERENTIATOR)
                        .c3(Record_OutputToDB.SOURCE_IP)
                        .c4(Record_OutputToDB.SERIAL_NUMBER)
                        .c5(Record_OutputToDB.MAILING_ID)
                        .c6(Record_OutputToDB.TARGET_ID)
                        .c7(Record_OutputToDB.TEMPLATE_ID)
                        .c8(Record_OutputToDB.USER_ID)
                        .c9(Record_OutputToDB.EMAIL_ADDRESS)
                        .c10(Record_OutputToDB.LINK_ID)
                        .c11(Record_OutputToDB.EXTRA)
                        .c12(Record_OutputToDB.CONVERSION_TAG)
                        .c13(Record_OutputToDB.CONVERSION_VALUE)
                        .c14(Record_OutputToDB.CONVERSION_ITEM)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.TRACK_EVENT_TYPE = Record_OutputToDB.TRACK_EVENT_TYPE;
                                After_Insert.DIFFERENTIATOR = Record_OutputToDB.DIFFERENTIATOR;
                                After_Insert.SOURCE_IP = Record_OutputToDB.SOURCE_IP;
                                After_Insert.SERIAL_NUMBER = Record_OutputToDB.SERIAL_NUMBER;
                                After_Insert.MAILING_ID = Record_OutputToDB.MAILING_ID;
                                After_Insert.TARGET_ID = Record_OutputToDB.TARGET_ID;
                                After_Insert.TEMPLATE_ID = Record_OutputToDB.TEMPLATE_ID;
                                After_Insert.USER_ID = Record_OutputToDB.USER_ID;
                                After_Insert.EMAIL_ADDRESS = Record_OutputToDB.EMAIL_ADDRESS;
                                After_Insert.LINK_ID = Record_OutputToDB.LINK_ID;
                                After_Insert.EXTRA = Record_OutputToDB.EXTRA;
                                After_Insert.CONVERSION_TAG = Record_OutputToDB.CONVERSION_TAG;
                                After_Insert.CONVERSION_VALUE = Record_OutputToDB.CONVERSION_VALUE;
                                After_Insert.CONVERSION_ITEM = Record_OutputToDB.CONVERSION_ITEM;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.TRACK_EVENT_TYPE = After_Insert.TRACK_EVENT_TYPE;
               Log_Rows.DIFFERENTIATOR = After_Insert.DIFFERENTIATOR;
               Log_Rows.SOURCE_IP = After_Insert.SOURCE_IP;
               Log_Rows.SERIAL_NUMBER = After_Insert.SERIAL_NUMBER;
               Log_Rows.MAILING_ID = After_Insert.MAILING_ID;
               Log_Rows.TARGET_ID = After_Insert.TARGET_ID;
               Log_Rows.TEMPLATE_ID = After_Insert.TEMPLATE_ID;
               Log_Rows.USER_ID = After_Insert.USER_ID;
               Log_Rows.EMAIL_ADDRESS = After_Insert.EMAIL_ADDRESS;
               Log_Rows.LINK_ID = After_Insert.LINK_ID;
               Log_Rows.EXTRA = After_Insert.EXTRA;
               Log_Rows.CONVERSION_TAG = After_Insert.CONVERSION_TAG;
               Log_Rows.CONVERSION_VALUE = After_Insert.CONVERSION_VALUE;
               Log_Rows.CONVERSION_ITEM = After_Insert.CONVERSION_ITEM;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"DATA_CAPTURED_DT\",\"TRACK_EVENT_TYPE\",\"DIFFERENTIATOR\",\"SOURCE_IP\",\"SERIAL_NUMBER\",\"MAILING_ID\",\"TARGET_ID\",\"TEMPLATE_ID\",\"USER_ID\",\"EMAIL_ADDRESS\",\"LINK_ID\",\"EXTRA\",\"CONVERSION_TAG\",\"CONVERSION_VALUE\",\"CONVERSION_ITEM\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.TRACK_EVENT_TYPE==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TRACK_EVENT_TYPE);
					...
					if(bufferLtRedshiftOutput_1.DIFFERENTIATOR==null){
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DIFFERENTIATOR);
					...
					if(bufferLtRedshiftOutput_1.SOURCE_IP==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SOURCE_IP);
					...
					if(bufferLtRedshiftOutput_1.SERIAL_NUMBER==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SERIAL_NUMBER);
					...
					if(bufferLtRedshiftOutput_1.TARGET_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TARGET_ID);
					...
					if(bufferLtRedshiftOutput_1.TEMPLATE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TEMPLATE_ID);
					...
					if(bufferLtRedshiftOutput_1.LINK_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LINK_ID);
					...
					if(bufferLtRedshiftOutput_1.EXTRA==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.EXTRA);
					...
					if(bufferLtRedshiftOutput_1.CONVERSION_TAG==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CONVERSION_TAG);
					...
					if(bufferLtRedshiftOutput_1.CONVERSION_VALUE==null){
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CONVERSION_VALUE);
					...
					if(bufferLtRedshiftOutput_1.CONVERSION_ITEM==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CONVERSION_ITEM);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.TRACK_EVENT_TYPE = null;
					
							row1.DIFFERENTIATOR = null;
							...
							row1.CONVERSION_TAG = null;
					
							row1.CONVERSION_VALUE = null;
					
							row1.CONVERSION_ITEM = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.TRACK_EVENT_TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.DIFFERENTIATOR = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SOURCE_IP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SERIAL_NUMBER = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.TARGET_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.TEMPLATE_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LINK_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.EXTRA = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.CONVERSION_TAG = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.CONVERSION_VALUE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.CONVERSION_ITEM = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.TRACK_EVENT_TYPE = StringUtils.trimToNull(row1.TRACK_EVENT_TYPE);
row2.DIFFERENTIATOR = row1.DIFFERENTIATOR;
row2.SOURCE_IP = StringUtils.trimToNull(row1.SOURCE_IP);
row2.SERIAL_NUMBER = StringUtils.trimToNull(row1.SERIAL_NUMBER);
row2.MAILING_ID = StringUtils.trimToNull(row1.MAILING_ID);
row2.TARGET_ID = StringUtils.trimToNull(row1.TARGET_ID);
row2.TEMPLATE_ID = StringUtils.trimToNull(row1.TEMPLATE_ID);
row2.USER_ID = StringUtils.trimToNull(row1.USER_ID);
row2.EMAIL_ADDRESS = StringUtils.trimToNull(row1.EMAIL_ADDRESS);
row2.LINK_ID = row1.LINK_ID;
row2.EXTRA = StringUtils.trimToNull(row1.EXTRA);
row2.CONVERSION_TAG = StringUtils.trimToNull(row1.CONVERSION_TAG);
row2.CONVERSION_VALUE = row1.CONVERSION_VALUE;
row2.CONVERSION_ITEM = row1.CONVERSION_ITEM;
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[15];
                            rowtFileOutputDelimited_1[0]=row2.DATA_CAPTURED_DT == null ? null : FormatterUtils.format_Date(row2.DATA_CAPTURED_DT, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[1]=row2.TRACK_EVENT_TYPE == null ? null : row2.TRACK_EVENT_TYPE;
                            rowtFileOutputDelimited_1[2]=row2.DIFFERENTIATOR == null ? null : String.valueOf(row2.DIFFERENTIATOR);
                            rowtFileOutputDelimited_1[3]=row2.SOURCE_IP == null ? null : row2.SOURCE_IP;
                            rowtFileOutputDelimited_1[4]=row2.SERIAL_NUMBER == null ? null : row2.SERIAL_NUMBER;
                            rowtFileOutputDelimited_1[5]=row2.MAILING_ID == null ? null : row2.MAILING_ID;
                            rowtFileOutputDelimited_1[6]=row2.TARGET_ID == null ? null : row2.TARGET_ID;
                            rowtFileOutputDelimited_1[7]=row2.TEMPLATE_ID == null ? null : row2.TEMPLATE_ID;
                            rowtFileOutputDelimited_1[8]=row2.USER_ID == null ? null : row2.USER_ID;
                            rowtFileOutputDelimited_1[9]=row2.EMAIL_ADDRESS == null ? null : row2.EMAIL_ADDRESS;
                            rowtFileOutputDelimited_1[10]=row2.LINK_ID == null ? null : String.valueOf(row2.LINK_ID);
                            rowtFileOutputDelimited_1[11]=row2.EXTRA == null ? null : row2.EXTRA;
                            rowtFileOutputDelimited_1[12]=row2.CONVERSION_TAG == null ? null : row2.CONVERSION_TAG;
                            rowtFileOutputDelimited_1[13]=row2.CONVERSION_VALUE == null ? null : String.valueOf(row2.CONVERSION_VALUE);
                            rowtFileOutputDelimited_1[14]=row2.CONVERSION_ITEM == null ? null : String.valueOf(row2.CONVERSION_ITEM);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewConvData StageFeed_StrongviewConvDataClass = new StageFeed_StrongviewConvData();

        int exitCode = StageFeed_StrongviewConvDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewConvData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewconvdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewConvData");
        }
...
/************************************************************************************************
 *     349114 characters generated by Talend Open Studio for Data Integration 
