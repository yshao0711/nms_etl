...
package zipcar_marketingdw.processstaging_exchangerates_0_1;
...
/**
 * Job: ProcessStaging_ExchangeRates Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_ExchangeRates implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_ExchangeRates";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_JZVG0BfwEeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_ExchangeRates.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_ExchangeRates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_ExchangeRates) {
...
"\nINSERT INTO {{marketing.schema}}.r_exchange_rate\n(\n	month,\n	from_iso,\n	to_iso,\n	avg_rate,\n    imported_date\n)\nSELECT \n	month,\n	from_iso,\n	to_iso,\n	avg_rate,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.exchange_rates\nMINUS\nSELECT \n	month,\n	from_iso,\n	to_iso,\n	avg_rate,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_exchange_rate\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".exchange_rates";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_ExchangeRates ProcessStaging_ExchangeRatesClass = new ProcessStaging_ExchangeRates();

        int exitCode = ProcessStaging_ExchangeRatesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_ExchangeRates.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_exchangerates_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_ExchangeRates");
        }
...
/************************************************************************************************
 *     135648 characters generated by Talend Open Studio for Data Integration 
