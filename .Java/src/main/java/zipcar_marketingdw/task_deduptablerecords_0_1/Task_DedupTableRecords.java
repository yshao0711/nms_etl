...
package zipcar_marketingdw.task_deduptablerecords_0_1;
...
/**
 * Job: Task_DedupTableRecords Purpose: Remove duplicate Records from a Table<br>
 * Description: Runs all records in a table via a Distinct Filter. Used as cleanup when a process introduces duplicates into the system. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Task_DedupTableRecords implements TalendJob {
...
public java.lang.String getRedshift_Monitoring_Password(){
	...
	private final String jobName = "Task_DedupTableRecords";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_2cyhwCXjEeehW69_SwuU_g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Task_DedupTableRecords.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Task_DedupTableRecords.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
"\nDROP TABLE  IF EXISTS {{marketing.schema}}.tmp_dedup_{{table.name}}\n;\nCREATE TABLE  {{marketing.schema}}.tmp_dedup_{{table.name}} AS\n    SELECT DISTINCT * FROM {{marketing.schema}}.{{table.name}}\n;\n",
...
public static class count_differentStruct implements routines.system.IPersistableRow<count_differentStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];

	
			    public Long source_count;

				public Long getSource_count () {
					return this.source_count;
				}
				
			    public Long dedup_count;

				public Long getDedup_count () {
					return this.dedup_count;
				}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_DedupTableRecords) {
        	...
        	try {
        		...
        		int length = 0;
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.source_count = null;
           				} else {
           			    	this.source_count = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.dedup_count = null;
           				} else {
           			    	this.dedup_count = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.source_count == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.source_count);
		            	}
					
					// Long
				
						if(this.dedup_count == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.dedup_count);
		            	}
    ...
    public String toString() {
		...
		sb.append(",dedup_count="+String.valueOf(dedup_count));
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(count_differentStruct other) {
...
public static class different_totalsStruct implements routines.system.IPersistableRow<different_totalsStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(different_totalsStruct other) {
...
public static class same_totalsStruct implements routines.system.IPersistableRow<same_totalsStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords, 0, length, utf8Charset);
		}
		return strReturn;
	}
     ...
     * Compare keys
     */
    public int compareTo(same_totalsStruct other) {
...
public static class totalsStruct implements routines.system.IPersistableRow<totalsStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Task_DedupTableRecords = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(totalsStruct other) {
...
public void tRedshiftInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		totalsStruct totals = new totalsStruct();
different_totalsStruct different_totals = new different_totalsStruct();
different_totalsStruct count_different = different_totals;
same_totalsStruct same_totals = new same_totalsStruct();
	...
	currentComponent="tRedshiftRow_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("count_different" + iterateId, 0, 0);
	...
	currentComponent="tWarn_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("different_totals" + iterateId, 0, 0);
	...
	currentComponent="tWarn_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("same_totals" + iterateId, 0, 0);
	...
	currentComponent="tFilterRow_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("totals" + iterateId, 0, 0);
...
"\nSELECT\n	(SELECT COUNT(*) FROM {{marketing.schema}}.{{table.name}} ) AS source_count,\n 	(SELECT COUNT(*) FROM {{marketing.schema}}.tmp_dedup_{{table.name}} ) AS dedup_count\n;\n",
"marketing.schema", context.Redshift_Marketing_Schema,
"table.name", context.tableName
)
;
		    ...
		    while (rs_tRedshiftInput_1.next()) {
		        nb_line_tRedshiftInput_1++;
							...
							if(colQtyInRs_tRedshiftInput_1 < 1) {
								totals.source_count = null;
							} else {
		                          
            if(rs_tRedshiftInput_1.getObject(1) != null) {
                totals.source_count = rs_tRedshiftInput_1.getLong(1);
            } else {
                    totals.source_count = null;
            }
		                    }
							if(colQtyInRs_tRedshiftInput_1 < 2) {
								totals.dedup_count = null;
							} else {
		                          
            if(rs_tRedshiftInput_1.getObject(2) != null) {
                totals.dedup_count = rs_tRedshiftInput_1.getLong(2);
            } else {
                    totals.dedup_count = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tFilterRow_1";
			...
			//totals
				...
				if(execStat){
					runStat.updateStatOnConnection("totals"+iterateId,1, 1);
				} 
          ...
          same_totals = null;
          different_totals = null;
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((// If Source table has different count of rows as destination table
(totals.source_count - totals.dedup_count) > 0
			), "advanced condition failed");
    
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(different_totals == null){ 
                different_totals = new different_totalsStruct();
              }
               different_totals.source_count = totals.source_count;
               different_totals.dedup_count = totals.dedup_count;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (same_totals == null){
              same_totals = new same_totalsStruct();
            }
                same_totals.source_count = totals.source_count;
                same_totals.dedup_count = totals.dedup_count;
	            same_totals.errorMessage = ope_tFilterRow_1.getErrorMsg();
 ...
 */
// Start of branch "different_totals"
if(different_totals != null) { 
	...
	currentComponent="tWarn_1";
			...
			//different_totals
				...
				if(execStat){
					runStat.updateStatOnConnection("different_totals"+iterateId,1, 1);
				} 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Table: " + context.tableName + " has duplicate records, will be cleaned: " + (totals.source_count - totals.dedup_count),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 4, "Table: " + context.tableName + " has duplicate records, will be cleaned: " + (totals.source_count - totals.dedup_count), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Table: " + context.tableName + " has duplicate records, will be cleaned: " + (totals.source_count - totals.dedup_count)); 
globalMap.put("tWarn_1_WARN_PRIORITY", 4);
globalMap.put("tWarn_1_WARN_CODE", 42);


 
     count_different = different_totals;
 ...
 */
	...
	currentComponent="tRedshiftRow_2";
			...
			//count_different
				...
				if(execStat){
					runStat.updateStatOnConnection("count_different"+iterateId,1, 1);
				} 
...
"\nTRUNCATE {{marketing.schema}}.{{table.name}}\n;\nINSERT INTO {{marketing.schema}}.{{table.name}}\n	SELECT * FROM {{marketing.schema}}.tmp_dedup_{{table.name}}\n;\n",
"marketing.schema", context.Redshift_Marketing_Schema,
"table.name", context.tableName
)
;
...
} // End of branch "different_totals"




// Start of branch "same_totals"
if(same_totals != null) { 
	...
	currentComponent="tWarn_2";
			...
			//same_totals
				...
				if(execStat){
					runStat.updateStatOnConnection("same_totals"+iterateId,1, 1);
				} 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Table: " + context.tableName + " does not have duplicate records. Total records: " + (totals.source_count),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 3, "Table: " + context.tableName + " does not have duplicate records. Total records: " + (totals.source_count), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Table: " + context.tableName + " does not have duplicate records. Total records: " + (totals.source_count)); 
    ...
    globalMap.put("tFilterRow_1_NB_LINE_REJECT", nb_line_reject_tFilterRow_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("totals"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	currentComponent="tWarn_1";
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("different_totals"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	stmt_tRedshiftRow_2.close();	
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("count_different"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	currentComponent="tWarn_2";
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("same_totals"+iterateId,2, 0); 
			 	}
			}
...
Logging.componentName(jobName, "tWarn_1", "Duplicates");
Logging.componentName(jobName, "tWarn_2", "No Duplicates");
 ...
 */
    ...
    public static void main(String[] args){
        final Task_DedupTableRecords Task_DedupTableRecordsClass = new Task_DedupTableRecords();

        int exitCode = Task_DedupTableRecordsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Task_DedupTableRecords.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/task_deduptablerecords_0_1/contexts/"+contextStr+".properties");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("tableName")) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Task_DedupTableRecords");
        }
...
/************************************************************************************************
 *     136378 characters generated by Talend Open Studio for Data Integration 
