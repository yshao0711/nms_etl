...
package zipcar_marketingdw.processstaging_accountaffiliates_0_1;
...
/**
 * Job: ProcessStaging_AccountAffiliates Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_AccountAffiliates implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_AccountAffiliates";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_xfF5ADWXEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_AccountAffiliates.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_AccountAffiliates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_AccountAffiliates) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "account_affiliates";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_account_affiliate";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_account_affiliate\nSELECT \n	affiliate_id,\n	zipfleet_id,\n	account_id,\n	affiliate_name,\n	cume_affiliates,\n	row_num_by_account,\n	start_date,\n	end_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.account_affiliates\nMINUS\nSELECT\n	affiliate_id,\n	zipfleet_id,\n	account_id,\n	affiliate_name,\n	cume_affiliates,\n	row_num_by_account,\n	start_date,\n	end_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM  {{marketing.schema}}.vw_r_account_affiliate\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".account_affiliates";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_AccountAffiliates ProcessStaging_AccountAffiliatesClass = new ProcessStaging_AccountAffiliates();

        int exitCode = ProcessStaging_AccountAffiliatesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_AccountAffiliates.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_accountaffiliates_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_AccountAffiliates");
        }
...
/************************************************************************************************
 *     135897 characters generated by Talend Open Studio for Data Integration 
