...
package zipcar_marketingdw.processstaging_reservations_np_0_1;
...
/**
 * Job: ProcessStaging_Reservations_NP Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Reservations_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Reservations_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_rYaSMHDWEeiSo7gaW0ZDPg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Reservations_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Reservations_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations_NP) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "r_reservation_np";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_reservation_np\n(\n	reservation_id,\n	ride_id,\n	member_id,\n	account_id,\n	type,\n	start_date,\n	end_date,\n	swiped_in_date,\n	swiped_out_date,\n	cancel_date,\n	total_hours,\n	total_distance,\n	up_revenue,\n	currency_iso,\n	status,\n	vehicle_id,\n	fleet_name,\n	nobill_p,\n	distance_measure,\n	late_returns_p,\n	community_id,\n	driver_id,\n	start_location_id,\n	end_location_id,\n	start_latitude,\n	start_longitude,\n	end_latitude,\n	end_longitude,\n	imported_date\n)\nSELECT \n	reservation_id,\n	ride_id,\n	member_id,\n	account_id,\n	type,\n	start_date,\n	end_date,\n	swiped_in_date,\n	swiped_out_date,\n	cancel_date,\n	total_hours,\n	total_distance,\n	up_revenue,\n	currency_iso,\n	status,\n	vehicle_id,\n	fleet_name,\n	nobill_p,\n	distance_measure,\n	late_returns_p,\n	community_id,\n	driver_id,\n	start_location_id,\n	end_location_id,\n	start_latitude,\n	start_longitude,\n	end_latitude,\n	end_longitude,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.reservations_np\nMINUS\nSELECT\n	reservation_id,\n	ride_id,\n	member_id,\n	account_id,\n	type,\n	start_date,\n	end_date,\n	swiped_in_date,\n	swiped_out_date,\n	cancel_date,\n	total_hours,\n	total_distance,\n	up_revenue,\n	currency_iso,\n	status,\n	vehicle_id,\n	fleet_name,\n	nobill_p,\n	distance_measure,\n	late_returns_p,\n	community_id,\n	driver_id,\n	start_location_id,\n	end_location_id,\n	start_latitude,\n	start_longitude,\n	end_latitude,\n	end_longitude,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_reservation_np\n",
...
"\n	truncate {{staging.schema}}.reservations_np;\n",
"staging.schema",  StringHandling.DQUOTE(context.Redshift_Staging_Schema)
);
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Reservations_NP ProcessStaging_Reservations_NPClass = new ProcessStaging_Reservations_NP();

        int exitCode = ProcessStaging_Reservations_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Reservations_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_reservations_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Reservations_NP");
        }
...
/************************************************************************************************
 *     137089 characters generated by Talend Open Studio for Data Integration 
