...
package zipcar_marketingdw.processstaging_waivers_0_1;
...
/**
 * Job: ProcessStaging_Waivers Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Waivers implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Waivers";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_GpkWYMu8EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Waivers.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Waivers.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Waivers) {
...
"\nINSERT INTO {{marketing.schema}}.r_waiver\n(\n	waiver_reservation_id,\n	waiver_res_p,\n	waiver_id,\n	reservation_id,\n	member_id,\n	account_id,\n	zipfleet_id,\n	waiver_plan_id,\n	waiver_plan_name,\n	waiver_plan_fee,\n	waiver_plan_frequency,\n	waiver_plan_deductible,\n	start_date,\n	end_date,\n	cancel_date,\n	local_start_date,\n	local_end_date,\n	local_cancel_date,\n	reference_id,\n	creation_user,\n	modifying_user,\n	override_restrictions_p,\n	autorenew_p,\n	party_autorenew_p,\n	pending_p,\n	pro_rate_p,\n	active_p,\n	public_p,\n	corporate_p,\n	operation,\n	risk_tier_id,\n	charge_model,\n	waiver_plan_key,\n	voided_p,\n	first_start_date,\n	last_end_date,\n	creation_date,\n	last_modified,\n	deleted_date,\n	new_plan_name,\n    imported_date\n)\nSELECT \n	waiver_reservation_id,\n	waiver_res_p,\n	waiver_id,\n	reservation_id,\n	party_id,\n	account_id,\n	zipfleet_id,\n	waiver_plan_id,\n	waiver_plan_name,\n	waiver_plan_fee,\n	waiver_plan_frequency,\n	waiver_plan_deductible,\n	start_date,\n	end_date,\n	cancel_date,\n	local_start_date,\n	local_end_date,\n	local_cancel_date,\n	reference_id,\n	creation_user,\n	modifying_user,\n	override_restrictions_p,\n	autorenew_p,\n	party_autorenew_p,\n	pending_p,\n	pro_rate_p,\n	active_p,\n	public_p,\n	corporate_p,\n	operation,\n	risk_tier_id,\n	charge_model,\n	waiver_plan_key,\n	voided_p,\n	first_start_date,\n	last_end_date,\n	creation_date,\n	last_modified,\n	deleted_date,\n	new_plan_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.waivers\nMINUS\nSELECT \n	waiver_reservation_id,\n	waiver_res_p,\n	waiver_id,\n	reservation_id,\n	member_id,\n	account_id,\n	zipfleet_id,\n	waiver_plan_id,\n	waiver_plan_name,\n	waiver_plan_fee,\n	waiver_plan_frequency,\n	waiver_plan_deductible,\n	start_date,\n	end_date,\n	cancel_date,\n	local_start_date,\n	local_end_date,\n	local_cancel_date,\n	reference_id,\n	creation_user,\n	modifying_user,\n	override_restrictions_p,\n	autorenew_p,\n	party_autorenew_p,\n	pending_p,\n	pro_rate_p,\n	active_p,\n	public_p,\n	corporate_p,\n	operation,\n	risk_tier_id,\n	charge_model,\n	waiver_plan_key,\n	voided_p,\n	first_start_date,\n	last_end_date,\n	creation_date,\n	last_modified,\n	deleted_date,\n	new_plan_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_waiver\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".waivers";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Waivers ProcessStaging_WaiversClass = new ProcessStaging_Waivers();

        int exitCode = ProcessStaging_WaiversClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Waivers.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_waivers_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Waivers");
        }
...
/************************************************************************************************
 *     137360 characters generated by Talend Open Studio for Data Integration 
