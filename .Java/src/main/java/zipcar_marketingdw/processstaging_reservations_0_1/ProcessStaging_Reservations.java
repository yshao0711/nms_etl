...
package zipcar_marketingdw.processstaging_reservations_0_1;
...
/**
 * Job: ProcessStaging_Reservations Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Reservations implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Reservations";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_S1z_0NNxEeaa5t6msZEpIw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Reservations.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Reservations.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Reservations) {
...
Logging.componentName(jobName, "tWarn_1", "Log_RefreshSummary");
Logging.componentName(jobName, "tWarn_2", "Log_RefreshSummary");
...
end_Hash.put("tJava_2", System.currentTimeMillis());
   			...
   			if (((Map<String, Boolean>)globalMap.get("SharedMap")).get("StageHasData") == false) {
...
"\nINSERT INTO {{marketing.schema}}.r_reservation\n(\n	reservation_id,\n	account_id,\n	member_id,\n	start_date,\n	end_date,\n	cancel_date,\n	original_reservation_id,\n	total_hours,\n	location_id,\n	vehicle_id,\n	creation_date,\n	last_modified,\n	end_location_id,\n	total_distance,\n	total_charge,\n	total_payment,\n	up_revenue,\n	currency_iso,\n	type,\n	rate_plan_id,\n	bundle_charge,\n	credits_unconverted_rev,\n	daily_charge,\n	distance_measure,\n	hourly_charge,\n	late_returns_p,\n	mileage_charge,\n	nobill_p,\n	overnighter_p,\n	swiped_out_date,\n	vehicle_class,\n	zipfleet_id,\n	affiliate_id,\n	redeem_vouchers_p,\n	source,\n	swiped_in_date,\n	waiver_plan_id,\n	imported_date\n)\nSELECT \n	reservation_id,\n	account_id,\n	driver_id as member_id,\n	start_date,\n	end_date,\n	cancel_date,\n	original_reservation_id,\n	total_hours,\n	location_id,\n	vehicle_id,\n	creation_date,\n	last_modified,\n	end_location_id,\n	total_distance,\n	total_charge,\n	total_payment,\n	up_revenue,\n	currency_iso,\n	type,\n	rate_plan_id,\n	bundle_charge,\n	credits_unconverted_rev,\n	daily_charge,\n	distance_measure,\n	hourly_charge,\n	late_returns_p,\n	mileage_charge,\n	nobill_p,\n	overnighter_p,\n	swiped_out_date,\n	vehicle_class,\n	zipfleet_id,\n	affiliate_id,\n	redeem_vouchers_p,\n	source,\n	swiped_in_date,\n	waiver_plan_id,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.reservations\nMINUS\nSELECT \n	reservation_id,\n	account_id,\n	member_id,\n	start_date,\n	end_date,\n	cancel_date,\n	original_reservation_id,\n	total_hours,\n	location_id,\n	vehicle_id,\n	creation_date,\n	last_modified,\n	end_location_id,\n	total_distance,\n	total_charge,\n	total_payment,\n	up_revenue,\n	currency_iso,\n	type,\n	rate_plan_id,\n	bundle_charge,\n	credits_unconverted_rev,\n	daily_charge,\n	distance_measure,\n	hourly_charge,\n	late_returns_p,\n	mileage_charge,\n	nobill_p,\n	overnighter_p,\n	swiped_out_date,\n	vehicle_class,\n	zipfleet_id,\n	affiliate_id,\n	redeem_vouchers_p,\n	source,\n	swiped_in_date,\n	waiver_plan_id,\n	to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_reservation\n;\n\n-- truncate staging table\nTRUNCATE TABLE {{staging.schema}}.reservations;\n",
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tWarn_3:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
"\n	select \n		(c1.COUNT+c2.COUNT) as COUNT\n	from (\n		SELECT COUNT(*) AS COUNT \n		FROM {{marketing.schema}}.r_reservation\n	    WHERE imported_date =  {{rundate}}\n	) c1\n	JOIN (\n		SELECT COUNT(*) AS COUNT \n		FROM {{marketing.schema}}.r_reservation_np\n		WHERE imported_date =  {{rundate}}\n	) c2\n	on 1=1;\n",
"marketing.schema", context.Redshift_Marketing_Schema,
"rundate", DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate))
);
		...
		try{
            ...
            if(rs_tRedshiftInput_1.getObject(1) != null) {
                row1.COUNT = rs_tRedshiftInput_1.getLong(1);
            } else {
                    row1.COUNT = null;
            }
		                    }
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Refreshing Reservation Summary Snapshot Table","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Refreshing Reservation Summary Snapshot Table", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Refreshing Reservation Summary Snapshot Table"); 
...
"\n-- truncate s_reservation table first\nTRUNCATE TABLE {{marketing.schema}}.s_reservation;\n\nINSERT INTO {{marketing.schema}}.s_reservation\n(\n	reservation_id,\n	account_id,\n	affiliate_id,\n	bundle_charge,\n	cancel_date,\n	creation_date,\n	credits_unconverted_rev,\n	currency_iso,\n	daily_charge,\n	distance_measure,\n	end_date,\n	end_location_id,\n	hourly_charge,\n	imported_date,\n	last_modified,\n	late_returns_p,\n	location_id,\n	member_id,\n	mileage_charge,\n	nobill_p,\n	original_reservation_id,\n	overnighter_p,\n	rate_plan_id,\n	redeem_vouchers_p,\n	source,\n	start_date,\n	swiped_in_date,\n	swiped_out_date,\n	total_charge,\n	total_distance,\n	total_hours,\n	total_payment,\n	type,\n	up_revenue,\n	vehicle_class,\n	vehicle_id,\n	waiver_plan_id,\n	zipfleet_id,\n	community_id,\n	driver_id,\n	fleet_name,\n	ride_id,\n	status,\n 	start_latitude,\n	start_longitude,\n	end_latitude,\n	end_longitude,\n	is_billable,\n	has_mileage,\n	is_new_platform\n)\nSELECT\n	t1.reservation_id,\n	t1.account_id,\n	t1.affiliate_id,\n	t1.bundle_charge,\n	t1.cancel_date,\n	t1.creation_date,\n	t1.credits_unconverted_rev,\n	t1.currency_iso,\n	t1.daily_charge,\n	t1.distance_measure,\n	t1.end_date,\n	t1.end_location_id,\n	t1.hourly_charge,\n	t1.imported_date,\n	t1.last_modified,\n	t1.late_returns_p,\n	t1.location_id,\n	t1.member_id,\n	t1.mileage_charge,\n	t1.nobill_p,\n	t1.original_reservation_id,\n	t1.overnighter_p,\n	t1.rate_plan_id,\n	t1.redeem_vouchers_p,\n	t1.source,\n	t1.start_date,\n	t1.swiped_in_date,\n	t1.swiped_out_date,\n	t1.total_charge,\n	t1.total_distance,\n	t1.total_hours,\n	t1.total_payment,\n	t1.type,\n	t1.up_revenue,\n	t1.vehicle_class,\n	t1.vehicle_id,\n	t1.waiver_plan_id,\n	t1.zipfleet_id,\n	NULL::BIGINT as community_id,\n	NULL::BIGINT as driver_id,\n	NULL as fleet_name,\n	NULL::BIGINT as ride_id,\n	NULL as status,\n 	NULL::DECIMAL as start_latitude,\n	NULL::DECIMAL as start_longitude,\n	NULL::DECIMAL as end_latitude,\n	NULL::DECIMAL as end_longitude,\n	(NVL(t1.nobill_p, 'f') = 'f') AS is_billable,\n	(t1.total_distance > 0) as has_mileage,\n	false as is_new_platform\nFROM {{marketing.schema}}.vw_r_reservation t1\nWHERE (\n	t1.reservation_id NOT IN (SELECT reservation_id FROM {{marketing.schema}}.vw_r_superseded_reservation)\n)\nUNION ALL\nSELECT\n	t2.reservation_id,\n	t2.account_id,\n	NULL::BIGINT as affiliate_id,\n	NULL::DECIMAL as bundle_charge,\n	t2.cancel_date,\n	NULL as creation_date,\n	NULL::DECIMAL as credits_unconverted_rev,\n	t2.currency_iso,\n	NULL::DECIMAL as daily_charge,\n	CASE WHEN t2.distance_measure = 'Meters' THEN 'km' ELSE t2.distance_measure END AS distance_measure,\n	t2.end_date,\n	t2.end_location_id,\n	NULL::DECIMAL as hourly_charge,\n	t2.imported_date,\n	NULL as last_modified,\n	t2.late_returns_p,\n	t2.start_location_id as location_id,\n	t2.member_id,\n	NULL::DECIMAL as mileage_charge,\n	t2.nobill_p,\n	NULL::BIGINT as origi_reservation_id,\n	NULL as overnighter_p,\n	NULL::BIGINT as rate_plan_id,\n	NULL as redeem_vouchers_p,\n	NULL as source,\n	t2.start_date,\n	t2.swiped_in_date,\n	t2.swiped_out_date,\n	NULL::DECIMAL as total_charge,\n	CASE WHEN t2.distance_measure = 'Meters' THEN round(t2.total_distance/1000.0, 1) ELSE t2.total_distance END AS total_distance,\n	t2.total_hours,\n	NULL::DECIMAL as total_payment,\n	t2.type,\n	t2.up_revenue,\n	NULL as vehicle_class,\n	t2.vehicle_id,\n	NULL::BIGINT as waiver_plan_id,\n	NULL::BIGINT as zipfleet_id,\n	t2.community_id,\n	t2.driver_id,\n	t2.fleet_name,\n	t2.ride_id,\n	t2.status,\n	t2.start_latitude,\n	t2.start_longitude,\n	t2.end_latitude,\n	t2.end_longitude,\n	(NVL(t2.nobill_p, 'f') = 'f') AS is_billable,\n	(t2.total_distance > 0) as has_mileage,\n	true as is_new_platform\nFROM {{marketing.schema}}.vw_r_reservation_np t2\n;\n\n-- analyze table\nANALYZE {{marketing.schema}}.s_reservation;\n",
"marketing.schema", context.Redshift_Marketing_Schema
);
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Reservation Summary Snapshot Refreshed","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 3, "Reservation Summary Snapshot Refreshed", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Reservation Summary Snapshot Refreshed"); 
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Reservations ProcessStaging_ReservationsClass = new ProcessStaging_Reservations();

        int exitCode = ProcessStaging_ReservationsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Reservations.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_reservations_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Reservations");
        }
...
/************************************************************************************************
 *     158001 characters generated by Talend Open Studio for Data Integration 
 *     on the October 16, 2018 5:21:50 PM CDT
 ************************************************************************************************/