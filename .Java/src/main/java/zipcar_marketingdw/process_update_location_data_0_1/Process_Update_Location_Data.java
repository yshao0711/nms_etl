...
package zipcar_marketingdw.process_update_location_data_0_1;
...
/**
 * Job: Process_Update_Location_Data Purpose: Updates the Member dimensin.<br>
 * Description: This job reads the daily fact tables and updates the member tables. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Process_Update_Location_Data implements TalendJob {
...
public Boolean getClearStagingTable(){
	...
	private final String jobName = "Process_Update_Location_Data";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_4cYckAg3EeekqfzVNGsKXg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Process_Update_Location_Data.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Process_Update_Location_Data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Location_Data = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Location_Data = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Location_Data.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Location_Data.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Location_Data = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Location_Data = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Location_Data, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Location_Data, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Location_Data) {
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRedshiftClose_1:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Update Location Data Completed","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Update Location Data Completed", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Update Location Data Completed"); 
...
Logging.componentName(jobName, "tWarn_2", "Log_ResetLocationTable");
Logging.componentName(jobName, "tWarn_3", "Log_ResetLocationTable");
...
"\nDELETE FROM {{marketing.schema}}.d_location  \nWHERE start_date >= {{runDate}}\n",
...
"marketing.schema", StringHandling.DQUOTE(context.Redshift_Marketing_Schema),
"endDate", DateUtils.dateToSqlStr(TalendDate.addDate(DateUtils.runDate(context.RunDate), -1, "dd"))
);
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.update_existinglocations_0_1.Update_ExistingLocations childJob_tRunJob_2 = new zipcar_marketingdw.update_existinglocations_0_1.Update_ExistingLocations();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.insert_newlocations_0_1.Insert_NewLocations childJob_tRunJob_1 = new zipcar_marketingdw.insert_newlocations_0_1.Insert_NewLocations();
	    // pass DataSources
...
"\n-- optimize the d_location table first\nvacuum {{marketing.schema}}.d_location;\nanalyze {{marketing.schema}}.d_location;\n\n-- truncate to rebuild the cache\nTRUNCATE {{marketing.schema}}.a_location_to_location_distance;\n\n-- rebuild the distance cache\nINSERT INTO {{marketing.schema}}.a_location_to_location_distance\nSELECT \n	dl1.location_id AS from_location_id,\n	dl1.is_new_platform AS is_from_location_np,\n	dl2.location_id AS to_location_id, \n	dl2.is_new_platform AS is_to_location_np,\n	{{marketing.schema}}.f_distance_miles(dl1.latitude, dl1.longitude, dl2.latitude, dl2.longitude) AS distance,\n	{{runDate}} AS modified_date\nFROM {{marketing.schema}}.d_location dl1\nJOIN {{marketing.schema}}.d_location dl2\nON dl1.is_active = TRUE\nAND dl1.end_date = '3199-12-31'\nAND dl2.is_active = TRUE\nAND dl2.end_date = '3199-12-31'\nAND NOT (dl1.location_id = dl2.location_id AND dl1.is_new_platform = dl2.is_new_platform)\n;\n\n-- optimize the cache table\nvacuum {{marketing.schema}}.a_location_to_location_distance;\nanalyze {{marketing.schema}}.a_location_to_location_distance;\n",
"marketing.schema", StringHandling.DQUOTE(context.Redshift_Marketing_Schema),
"runDate", DateUtils.dateToSqlStr(DateUtils.runDate(context.RunDate))
);
 ...
 */
    ...
    public static void main(String[] args){
        final Process_Update_Location_Data Process_Update_Location_DataClass = new Process_Update_Location_Data();

        int exitCode = Process_Update_Location_DataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Process_Update_Location_Data.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/process_update_location_data_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Process_Update_Location_Data");
        }
...
/************************************************************************************************
 *     150002 characters generated by Talend Open Studio for Data Integration 
