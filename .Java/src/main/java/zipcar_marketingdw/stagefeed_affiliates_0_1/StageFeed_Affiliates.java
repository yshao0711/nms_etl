...
package zipcar_marketingdw.stagefeed_affiliates_0_1;
...
/**
 * Job: StageFeed_Affiliates Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Affiliates implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Affiliates";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_nij2gMoYEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Affiliates.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Affiliates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Affiliates = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Affiliates) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.AFFILIATES.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.AFFILIATES.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.AFFILIATES;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Affiliates = new byte[0];
			    ...
			    public Long MASTER_ACCOUNT_ID;

				public Long getMASTER_ACCOUNT_ID () {
			    ...
			    public String ALLOW_APP_COUPON_P;

				public String getALLOW_APP_COUPON_P () {
					return this.ALLOW_APP_COUPON_P;
				}
				
			    public String HAVE_ZIPCARD_P;

				public String getHAVE_ZIPCARD_P () {
					return this.HAVE_ZIPCARD_P;
				}
			    ...
			    public String REQUIRE_ADMIN_APPROVAL_P;

				public String getREQUIRE_ADMIN_APPROVAL_P () {
					return this.REQUIRE_ADMIN_APPROVAL_P;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Affiliates) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.AFFILIATE_NAME = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.MASTER_ACCOUNT_ID = null;
           				} else {
           			    	this.MASTER_ACCOUNT_ID = dis.readLong();
           				}
					
						this.MINIMUM_AGE = readInteger(dis);
					
					this.ALLOW_APP_COUPON_P = readString(dis);
					
					this.HAVE_ZIPCARD_P = readString(dis);
					...
					this.REQUIRE_ADMIN_APPROVAL_P = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.AFFILIATE_NAME,dos);
					...
					// Long
						...
						if(this.MASTER_ACCOUNT_ID == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeLong(this.MASTER_ACCOUNT_ID);
		            	}
					
					// Integer
				
						writeInteger(this.MINIMUM_AGE,dos);
					
					// String
				
						writeString(this.ALLOW_APP_COUPON_P,dos);
					
					// String
				
						writeString(this.HAVE_ZIPCARD_P,dos);
					...
					// String
						...
						writeString(this.REQUIRE_ADMIN_APPROVAL_P,dos);
    ...
    public String toString() {
		...
		sb.append(",AFFILIATE_NAME="+AFFILIATE_NAME);
		sb.append(",ZIPFLEET_ID="+String.valueOf(ZIPFLEET_ID));
		sb.append(",MASTER_ACCOUNT_ID="+String.valueOf(MASTER_ACCOUNT_ID));
		sb.append(",MINIMUM_AGE="+String.valueOf(MINIMUM_AGE));
		sb.append(",ALLOW_APP_COUPON_P="+ALLOW_APP_COUPON_P);
		sb.append(",HAVE_ZIPCARD_P="+HAVE_ZIPCARD_P);
		...
		sb.append(",REQUIRE_ADMIN_APPROVAL_P="+REQUIRE_ADMIN_APPROVAL_P);
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(long AFFILIATE_ID){
							this.AFFILIATE_ID = AFFILIATE_ID;
							return this;
						}				
						String AFFILIATE_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String AFFILIATE_NAME){
							this.AFFILIATE_NAME = AFFILIATE_NAME;
							return this;
						}				
						Long ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c2(Long ZIPFLEET_ID){
							this.ZIPFLEET_ID = ZIPFLEET_ID;
							return this;
						}				
						Long MASTER_ACCOUNT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Long MASTER_ACCOUNT_ID){
							this.MASTER_ACCOUNT_ID = MASTER_ACCOUNT_ID;
							return this;
						}				
						Integer MINIMUM_AGE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(Integer MINIMUM_AGE){
							this.MINIMUM_AGE = MINIMUM_AGE;
							return this;
						}				
						String ALLOW_APP_COUPON_P;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String ALLOW_APP_COUPON_P){
							this.ALLOW_APP_COUPON_P = ALLOW_APP_COUPON_P;
							return this;
						}				
						String HAVE_ZIPCARD_P;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String HAVE_ZIPCARD_P){
							this.HAVE_ZIPCARD_P = HAVE_ZIPCARD_P;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c7(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c8(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c9(java.util.Date DELETED_DATE){
							this.DELETED_DATE = DELETED_DATE;
							return this;
						}				
						String REQUIRE_ADMIN_APPROVAL_P;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String REQUIRE_ADMIN_APPROVAL_P){
							this.REQUIRE_ADMIN_APPROVAL_P = REQUIRE_ADMIN_APPROVAL_P;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"AFFILIATE_ID\",\"AFFILIATE_NAME\",\"ZIPFLEET_ID\",\"MASTER_ACCOUNT_ID\",\"MINIMUM_AGE\",\"ALLOW_APP_COUPON_P\",\"HAVE_ZIPCARD_P\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"REQUIRE_ADMIN_APPROVAL_P\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.AFFILIATE_ID = 0;
					
							Row_FeedRecord.AFFILIATE_NAME = null;
					
							Row_FeedRecord.ZIPFLEET_ID = null;
					
							Row_FeedRecord.MASTER_ACCOUNT_ID = null;
					
							Row_FeedRecord.MINIMUM_AGE = null;
					
							Row_FeedRecord.ALLOW_APP_COUPON_P = null;
					
							Row_FeedRecord.HAVE_ZIPCARD_P = null;
							...
							Row_FeedRecord.REQUIRE_ADMIN_APPROVAL_P = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.AFFILIATE_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'AFFILIATE_ID' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.AFFILIATE_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.MASTER_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.MINIMUM_AGE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ALLOW_APP_COUPON_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.HAVE_ZIPCARD_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.REQUIRE_ADMIN_APPROVAL_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.AFFILIATE_NAME = StringUtils.trimToNull(Row_FeedRecord.AFFILIATE_NAME);
Record_OutputToDB.ZIPFLEET_ID = Row_FeedRecord.ZIPFLEET_ID;
Record_OutputToDB.MASTER_ACCOUNT_ID = Row_FeedRecord.MASTER_ACCOUNT_ID;
Record_OutputToDB.MINIMUM_AGE = Row_FeedRecord.MINIMUM_AGE;
Record_OutputToDB.ALLOW_APP_COUPON_P = BooleanUtils.boolChar(Row_FeedRecord.ALLOW_APP_COUPON_P);
Record_OutputToDB.HAVE_ZIPCARD_P = BooleanUtils.boolChar(Row_FeedRecord.HAVE_ZIPCARD_P);
...
Record_OutputToDB.REQUIRE_ADMIN_APPROVAL_P = BooleanUtils.boolChar(Row_FeedRecord.REQUIRE_ADMIN_APPROVAL_P);
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.AFFILIATE_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.AFFILIATE_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MASTER_ACCOUNT_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.MASTER_ACCOUNT_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MINIMUM_AGE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.MINIMUM_AGE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ALLOW_APP_COUPON_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ALLOW_APP_COUPON_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.HAVE_ZIPCARD_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.HAVE_ZIPCARD_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.REQUIRE_ADMIN_APPROVAL_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.REQUIRE_ADMIN_APPROVAL_P);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.AFFILIATE_ID)
                        .c1(Record_OutputToDB.AFFILIATE_NAME)
                        .c2(Record_OutputToDB.ZIPFLEET_ID)
                        .c3(Record_OutputToDB.MASTER_ACCOUNT_ID)
                        .c4(Record_OutputToDB.MINIMUM_AGE)
                        .c5(Record_OutputToDB.ALLOW_APP_COUPON_P)
                        .c6(Record_OutputToDB.HAVE_ZIPCARD_P)
                        .c7(Record_OutputToDB.CREATION_DATE)
                        .c8(Record_OutputToDB.LAST_MODIFIED)
                        .c9(Record_OutputToDB.DELETED_DATE)
                        .c10(Record_OutputToDB.REQUIRE_ADMIN_APPROVAL_P)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.AFFILIATE_NAME = Record_OutputToDB.AFFILIATE_NAME;
                                After_Insert.ZIPFLEET_ID = Record_OutputToDB.ZIPFLEET_ID;
                                After_Insert.MASTER_ACCOUNT_ID = Record_OutputToDB.MASTER_ACCOUNT_ID;
                                After_Insert.MINIMUM_AGE = Record_OutputToDB.MINIMUM_AGE;
                                After_Insert.ALLOW_APP_COUPON_P = Record_OutputToDB.ALLOW_APP_COUPON_P;
                                After_Insert.HAVE_ZIPCARD_P = Record_OutputToDB.HAVE_ZIPCARD_P;
                                ...
                                After_Insert.REQUIRE_ADMIN_APPROVAL_P = Record_OutputToDB.REQUIRE_ADMIN_APPROVAL_P;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.AFFILIATE_NAME = After_Insert.AFFILIATE_NAME;
               Log_Rows.ZIPFLEET_ID = After_Insert.ZIPFLEET_ID;
               Log_Rows.MASTER_ACCOUNT_ID = After_Insert.MASTER_ACCOUNT_ID;
               Log_Rows.MINIMUM_AGE = After_Insert.MINIMUM_AGE;
               Log_Rows.ALLOW_APP_COUPON_P = After_Insert.ALLOW_APP_COUPON_P;
               Log_Rows.HAVE_ZIPCARD_P = After_Insert.HAVE_ZIPCARD_P;
               ...
               Log_Rows.REQUIRE_ADMIN_APPROVAL_P = After_Insert.REQUIRE_ADMIN_APPROVAL_P;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"AFFILIATE_ID\",\"AFFILIATE_NAME\",\"ZIPFLEET_ID\",\"MASTER_ACCOUNT_ID\",\"MINIMUM_AGE\",\"ALLOW_APP_COUPON_P\",\"HAVE_ZIPCARD_P\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"REQUIRE_ADMIN_APPROVAL_P\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.AFFILIATE_NAME==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.AFFILIATE_NAME);
					...
					if(bufferLtRedshiftOutput_1.MASTER_ACCOUNT_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MASTER_ACCOUNT_ID);
					...
					if(bufferLtRedshiftOutput_1.MINIMUM_AGE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MINIMUM_AGE);
					...
					if(bufferLtRedshiftOutput_1.ALLOW_APP_COUPON_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ALLOW_APP_COUPON_P);
					...
					if(bufferLtRedshiftOutput_1.HAVE_ZIPCARD_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.HAVE_ZIPCARD_P);
					...
					if(bufferLtRedshiftOutput_1.REQUIRE_ADMIN_APPROVAL_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.REQUIRE_ADMIN_APPROVAL_P);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.AFFILIATE_NAME = null;
					
							row1.ZIPFLEET_ID = null;
					
							row1.MASTER_ACCOUNT_ID = null;
					
							row1.MINIMUM_AGE = null;
					
							row1.ALLOW_APP_COUPON_P = null;
					
							row1.HAVE_ZIPCARD_P = null;
							...
							row1.REQUIRE_ADMIN_APPROVAL_P = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.AFFILIATE_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'AFFILIATE_ID' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.AFFILIATE_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.MASTER_ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.MINIMUM_AGE = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ALLOW_APP_COUPON_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.HAVE_ZIPCARD_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.REQUIRE_ADMIN_APPROVAL_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.AFFILIATE_NAME = StringUtils.trimToNull(row1.AFFILIATE_NAME);
row2.ZIPFLEET_ID = row1.ZIPFLEET_ID;
row2.MASTER_ACCOUNT_ID = row1.MASTER_ACCOUNT_ID;
row2.MINIMUM_AGE = row1.MINIMUM_AGE;
row2.ALLOW_APP_COUPON_P = BooleanUtils.boolChar(row1.ALLOW_APP_COUPON_P);
row2.HAVE_ZIPCARD_P = BooleanUtils.boolChar(row1.HAVE_ZIPCARD_P);
row2.CREATION_DATE = row1.CREATION_DATE;
row2.LAST_MODIFIED = row1.LAST_MODIFIED;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.REQUIRE_ADMIN_APPROVAL_P = BooleanUtils.boolChar(row1.REQUIRE_ADMIN_APPROVAL_P);
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[11];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.AFFILIATE_ID);
                            rowtFileOutputDelimited_1[1]=row2.AFFILIATE_NAME == null ? null : row2.AFFILIATE_NAME;
                            rowtFileOutputDelimited_1[2]=row2.ZIPFLEET_ID == null ? null : String.valueOf(row2.ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[3]=row2.MASTER_ACCOUNT_ID == null ? null : String.valueOf(row2.MASTER_ACCOUNT_ID);
                            rowtFileOutputDelimited_1[4]=row2.MINIMUM_AGE == null ? null : String.valueOf(row2.MINIMUM_AGE);
                            rowtFileOutputDelimited_1[5]=row2.ALLOW_APP_COUPON_P == null ? null : row2.ALLOW_APP_COUPON_P;
                            rowtFileOutputDelimited_1[6]=row2.HAVE_ZIPCARD_P == null ? null : row2.HAVE_ZIPCARD_P;
                            rowtFileOutputDelimited_1[7]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[8]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[9]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[10]=row2.REQUIRE_ADMIN_APPROVAL_P == null ? null : row2.REQUIRE_ADMIN_APPROVAL_P;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Affiliates StageFeed_AffiliatesClass = new StageFeed_Affiliates();

        int exitCode = StageFeed_AffiliatesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Affiliates.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_affiliates_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Affiliates");
        }
...
/************************************************************************************************
 *     338654 characters generated by Talend Open Studio for Data Integration 
