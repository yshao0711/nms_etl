...
package zipcar_marketingdw.stagefeed_addresses_0_1;
...
/**
 * Job: StageFeed_Addresses Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Addresses implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Addresses";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_OEOgIARFEeevvquAUS6ZRg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Addresses.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Addresses.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Addresses = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Addresses) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.ADDRESSES.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.ADDRESSES.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.ADDRESSES;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Addresses = new byte[0];
			    ...
			    public String PHONE_NUMBER_ONE;

				public String getPHONE_NUMBER_ONE () {
					return this.PHONE_NUMBER_ONE;
				}
				
			    public String PHONE_NUMBER_TWO;

				public String getPHONE_NUMBER_TWO () {
					return this.PHONE_NUMBER_TWO;
				}
				...
				public String getLINE_FOUR () {
					return this.LINE_FOUR;
				}
			    ...
			    public String PREFERRED_P;

				public String getPREFERRED_P () {
					return this.PREFERRED_P;
				}
				
			    public Long TRACT_ID;

				public Long getTRACT_ID () {
					return this.TRACT_ID;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Addresses) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.PHONE_NUMBER_ONE = readString(dis);
					
					this.PHONE_NUMBER_TWO = readString(dis);
					
					this.LINE_ONE = readString(dis);
					
					this.LINE_TWO = readString(dis);
					
					this.LINE_THREE = readString(dis);
					
					this.LINE_FOUR = readString(dis);
					
					this.MUNICIPALITY_NAME = readString(dis);
					
					this.PREFERRED_P = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.TRACT_ID = null;
           				} else {
           			    	this.TRACT_ID = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.PHONE_NUMBER_ONE,dos);
					
					// String
				
						writeString(this.PHONE_NUMBER_TWO,dos);
					
					// String
				
						writeString(this.LINE_ONE,dos);
					
					// String
				
						writeString(this.LINE_TWO,dos);
					
					// String
				
						writeString(this.LINE_THREE,dos);
					
					// String
				
						writeString(this.LINE_FOUR,dos);
					
					// String
				
						writeString(this.MUNICIPALITY_NAME,dos);
					
					// String
				
						writeString(this.PREFERRED_P,dos);
					
					// Long
				
						if(this.TRACT_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.TRACT_ID);
		            	}
    ...
    public String toString() {
		...
		sb.append(",PHONE_NUMBER_ONE="+PHONE_NUMBER_ONE);
		sb.append(",PHONE_NUMBER_TWO="+PHONE_NUMBER_TWO);
		sb.append(",LINE_ONE="+LINE_ONE);
		sb.append(",LINE_TWO="+LINE_TWO);
		sb.append(",LINE_THREE="+LINE_THREE);
		sb.append(",LINE_FOUR="+LINE_FOUR);
		sb.append(",MUNICIPALITY_NAME="+MUNICIPALITY_NAME);
		sb.append(",PREFERRED_P="+PREFERRED_P);
		sb.append(",TRACT_ID="+String.valueOf(TRACT_ID));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(Long ADDRESS_ID){
							this.ADDRESS_ID = ADDRESS_ID;
							return this;
						}				
						Long PARTY_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c1(Long PARTY_ID){
							this.PARTY_ID = PARTY_ID;
							return this;
						}				
						String ADDRESS_TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String ADDRESS_TYPE){
							this.ADDRESS_TYPE = ADDRESS_TYPE;
							return this;
						}				
						Double LATITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Double LATITUDE){
							this.LATITUDE = LATITUDE;
							return this;
						}				
						Double LONGITUDE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(Double LONGITUDE){
							this.LONGITUDE = LONGITUDE;
							return this;
						}				
						String POSTAL_CODE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String POSTAL_CODE){
							this.POSTAL_CODE = POSTAL_CODE;
							return this;
						}				
						String REGION_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String REGION_NAME){
							this.REGION_NAME = REGION_NAME;
							return this;
						}				
						String COUNTRY_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String COUNTRY_NAME){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c11(String PHONE_NUMBER_ONE){
							this.PHONE_NUMBER_ONE = PHONE_NUMBER_ONE;
							return this;
						}				
						String PHONE_NUMBER_TWO;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String PHONE_NUMBER_TWO){
							this.PHONE_NUMBER_TWO = PHONE_NUMBER_TWO;
							return this;
						}				
						String LINE_ONE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String LINE_ONE){
							this.LINE_ONE = LINE_ONE;
							return this;
						}				
						String LINE_TWO;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String LINE_TWO){
							this.LINE_TWO = LINE_TWO;
							return this;
						}				
						String LINE_THREE;
						
	            		public BufferLine_tRedshiftOutput_1 c15(String LINE_THREE){
							this.LINE_THREE = LINE_THREE;
							return this;
						}				
						String LINE_FOUR;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String LINE_FOUR){
							this.LINE_FOUR = LINE_FOUR;
							return this;
						}				
						String MUNICIPALITY_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String MUNICIPALITY_NAME){
							this.MUNICIPALITY_NAME = MUNICIPALITY_NAME;
							return this;
						}				
						String PREFERRED_P;
						
	            		public BufferLine_tRedshiftOutput_1 c18(String PREFERRED_P){
							this.PREFERRED_P = PREFERRED_P;
							return this;
						}				
						Long TRACT_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c19(Long TRACT_ID){
							this.TRACT_ID = TRACT_ID;
							return this;
						}				
						Long ZONE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c20(Long ZONE_ID){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ADDRESS_ID\",\"PARTY_ID\",\"ADDRESS_TYPE\",\"LATITUDE\",\"LONGITUDE\",\"POSTAL_CODE\",\"REGION_NAME\",\"COUNTRY_NAME\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"PHONE_NUMBER_ONE\",\"PHONE_NUMBER_TWO\",\"LINE_ONE\",\"LINE_TWO\",\"LINE_THREE\",\"LINE_FOUR\",\"MUNICIPALITY_NAME\",\"PREFERRED_P\",\"TRACT_ID\",\"ZONE_ID\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.ADDRESS_ID = null;
					
							Row_FeedRecord.PARTY_ID = null;
					
							Row_FeedRecord.ADDRESS_TYPE = null;
					
							Row_FeedRecord.LATITUDE = null;
					
							Row_FeedRecord.LONGITUDE = null;
					
							Row_FeedRecord.POSTAL_CODE = null;
					
							Row_FeedRecord.REGION_NAME = null;
					
							Row_FeedRecord.COUNTRY_NAME = null;
							...
							Row_FeedRecord.PHONE_NUMBER_ONE = null;
					
							Row_FeedRecord.PHONE_NUMBER_TWO = null;
					
							Row_FeedRecord.LINE_ONE = null;
					
							Row_FeedRecord.LINE_TWO = null;
					
							Row_FeedRecord.LINE_THREE = null;
					
							Row_FeedRecord.LINE_FOUR = null;
					
							Row_FeedRecord.MUNICIPALITY_NAME = null;
					
							Row_FeedRecord.PREFERRED_P = null;
					
							Row_FeedRecord.TRACT_ID = null;
					
							Row_FeedRecord.ZONE_ID = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ADDRESS_TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.POSTAL_CODE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.REGION_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.COUNTRY_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PHONE_NUMBER_ONE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PHONE_NUMBER_TWO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LINE_ONE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LINE_TWO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LINE_THREE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LINE_FOUR = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.MUNICIPALITY_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PREFERRED_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.TRACT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ZONE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.ADDRESS_ID = Row_FeedRecord.ADDRESS_ID;
Record_OutputToDB.PARTY_ID = Row_FeedRecord.PARTY_ID;
Record_OutputToDB.ADDRESS_TYPE = StringUtils.trimToNull(Row_FeedRecord.ADDRESS_TYPE);
Record_OutputToDB.LATITUDE = Row_FeedRecord.LATITUDE;
Record_OutputToDB.LONGITUDE = Row_FeedRecord.LONGITUDE;
Record_OutputToDB.POSTAL_CODE = StringUtils.trimToNull(Row_FeedRecord.POSTAL_CODE);
Record_OutputToDB.REGION_NAME = StringUtils.trimToNull(Row_FeedRecord.REGION_NAME);
Record_OutputToDB.COUNTRY_NAME = StringUtils.trimToNull(Row_FeedRecord.COUNTRY_NAME);
...
Record_OutputToDB.PHONE_NUMBER_ONE = StringUtils.trimToNull(Row_FeedRecord.PHONE_NUMBER_ONE);
Record_OutputToDB.PHONE_NUMBER_TWO = StringUtils.trimToNull(Row_FeedRecord.PHONE_NUMBER_TWO);
Record_OutputToDB.LINE_ONE = StringUtils.trimToNull(Row_FeedRecord.LINE_ONE);
Record_OutputToDB.LINE_TWO = StringUtils.trimToNull(Row_FeedRecord.LINE_TWO);
Record_OutputToDB.LINE_THREE = StringUtils.trimToNull(Row_FeedRecord.LINE_THREE);
Record_OutputToDB.LINE_FOUR = StringUtils.trimToNull(Row_FeedRecord.LINE_FOUR);
Record_OutputToDB.MUNICIPALITY_NAME = StringUtils.trimToNull(Row_FeedRecord.MUNICIPALITY_NAME);
Record_OutputToDB.PREFERRED_P = BooleanUtils.boolChar(Row_FeedRecord.PREFERRED_P);
Record_OutputToDB.TRACT_ID = Row_FeedRecord.TRACT_ID;
Record_OutputToDB.ZONE_ID = Row_FeedRecord.ZONE_ID;
    nb_line_tJavaRow_3++;   
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(Record_OutputToDB.ADDRESS_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ADDRESS_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ADDRESS_TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ADDRESS_TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.POSTAL_CODE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.POSTAL_CODE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.REGION_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.REGION_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.COUNTRY_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.COUNTRY_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PHONE_NUMBER_ONE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PHONE_NUMBER_ONE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PHONE_NUMBER_TWO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PHONE_NUMBER_TWO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LINE_ONE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LINE_ONE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LINE_TWO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LINE_TWO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LINE_THREE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LINE_THREE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LINE_FOUR==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LINE_FOUR);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MUNICIPALITY_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.MUNICIPALITY_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PREFERRED_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PREFERRED_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TRACT_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.TRACT_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ZONE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ZONE_ID);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.ADDRESS_ID)
                        .c1(Record_OutputToDB.PARTY_ID)
                        .c2(Record_OutputToDB.ADDRESS_TYPE)
                        .c3(Record_OutputToDB.LATITUDE)
                        .c4(Record_OutputToDB.LONGITUDE)
                        .c5(Record_OutputToDB.POSTAL_CODE)
                        .c6(Record_OutputToDB.REGION_NAME)
                        .c7(Record_OutputToDB.COUNTRY_NAME)
                        .c8(Record_OutputToDB.CREATION_DATE)
                        .c9(Record_OutputToDB.LAST_MODIFIED)
                        .c10(Record_OutputToDB.DELETED_DATE)
                        .c11(Record_OutputToDB.PHONE_NUMBER_ONE)
                        .c12(Record_OutputToDB.PHONE_NUMBER_TWO)
                        .c13(Record_OutputToDB.LINE_ONE)
                        .c14(Record_OutputToDB.LINE_TWO)
                        .c15(Record_OutputToDB.LINE_THREE)
                        .c16(Record_OutputToDB.LINE_FOUR)
                        .c17(Record_OutputToDB.MUNICIPALITY_NAME)
                        .c18(Record_OutputToDB.PREFERRED_P)
                        .c19(Record_OutputToDB.TRACT_ID)
                        .c20(Record_OutputToDB.ZONE_ID)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.ADDRESS_ID = Record_OutputToDB.ADDRESS_ID;
                                After_Insert.PARTY_ID = Record_OutputToDB.PARTY_ID;
                                After_Insert.ADDRESS_TYPE = Record_OutputToDB.ADDRESS_TYPE;
                                After_Insert.LATITUDE = Record_OutputToDB.LATITUDE;
                                After_Insert.LONGITUDE = Record_OutputToDB.LONGITUDE;
                                After_Insert.POSTAL_CODE = Record_OutputToDB.POSTAL_CODE;
                                After_Insert.REGION_NAME = Record_OutputToDB.REGION_NAME;
                                After_Insert.COUNTRY_NAME = Record_OutputToDB.COUNTRY_NAME;
                                ...
                                After_Insert.PHONE_NUMBER_ONE = Record_OutputToDB.PHONE_NUMBER_ONE;
                                After_Insert.PHONE_NUMBER_TWO = Record_OutputToDB.PHONE_NUMBER_TWO;
                                After_Insert.LINE_ONE = Record_OutputToDB.LINE_ONE;
                                After_Insert.LINE_TWO = Record_OutputToDB.LINE_TWO;
                                After_Insert.LINE_THREE = Record_OutputToDB.LINE_THREE;
                                After_Insert.LINE_FOUR = Record_OutputToDB.LINE_FOUR;
                                After_Insert.MUNICIPALITY_NAME = Record_OutputToDB.MUNICIPALITY_NAME;
                                After_Insert.PREFERRED_P = Record_OutputToDB.PREFERRED_P;
                                After_Insert.TRACT_ID = Record_OutputToDB.TRACT_ID;
                                After_Insert.ZONE_ID = Record_OutputToDB.ZONE_ID;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.ADDRESS_ID = After_Insert.ADDRESS_ID;
               Log_Rows.PARTY_ID = After_Insert.PARTY_ID;
               Log_Rows.ADDRESS_TYPE = After_Insert.ADDRESS_TYPE;
               Log_Rows.LATITUDE = After_Insert.LATITUDE;
               Log_Rows.LONGITUDE = After_Insert.LONGITUDE;
               Log_Rows.POSTAL_CODE = After_Insert.POSTAL_CODE;
               Log_Rows.REGION_NAME = After_Insert.REGION_NAME;
               Log_Rows.COUNTRY_NAME = After_Insert.COUNTRY_NAME;
               ...
               Log_Rows.PHONE_NUMBER_ONE = After_Insert.PHONE_NUMBER_ONE;
               Log_Rows.PHONE_NUMBER_TWO = After_Insert.PHONE_NUMBER_TWO;
               Log_Rows.LINE_ONE = After_Insert.LINE_ONE;
               Log_Rows.LINE_TWO = After_Insert.LINE_TWO;
               Log_Rows.LINE_THREE = After_Insert.LINE_THREE;
               Log_Rows.LINE_FOUR = After_Insert.LINE_FOUR;
               Log_Rows.MUNICIPALITY_NAME = After_Insert.MUNICIPALITY_NAME;
               Log_Rows.PREFERRED_P = After_Insert.PREFERRED_P;
               Log_Rows.TRACT_ID = After_Insert.TRACT_ID;
               Log_Rows.ZONE_ID = After_Insert.ZONE_ID;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ADDRESS_ID\",\"PARTY_ID\",\"ADDRESS_TYPE\",\"LATITUDE\",\"LONGITUDE\",\"POSTAL_CODE\",\"REGION_NAME\",\"COUNTRY_NAME\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"PHONE_NUMBER_ONE\",\"PHONE_NUMBER_TWO\",\"LINE_ONE\",\"LINE_TWO\",\"LINE_THREE\",\"LINE_FOUR\",\"MUNICIPALITY_NAME\",\"PREFERRED_P\",\"TRACT_ID\",\"ZONE_ID\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.COUNTRY_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.COUNTRY_NAME);
					...
					if(bufferLtRedshiftOutput_1.PHONE_NUMBER_ONE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PHONE_NUMBER_ONE);
					...
					if(bufferLtRedshiftOutput_1.PHONE_NUMBER_TWO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PHONE_NUMBER_TWO);
					...
					if(bufferLtRedshiftOutput_1.LINE_ONE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LINE_ONE);
					...
					if(bufferLtRedshiftOutput_1.LINE_TWO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LINE_TWO);
					...
					if(bufferLtRedshiftOutput_1.LINE_THREE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LINE_THREE);
					...
					if(bufferLtRedshiftOutput_1.LINE_FOUR==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LINE_FOUR);
					...
					if(bufferLtRedshiftOutput_1.MUNICIPALITY_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MUNICIPALITY_NAME);
					...
					if(bufferLtRedshiftOutput_1.PREFERRED_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PREFERRED_P);
					...
					if(bufferLtRedshiftOutput_1.TRACT_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TRACT_ID);
					...
					if(bufferLtRedshiftOutput_1.ZONE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ZONE_ID);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.PHONE_NUMBER_ONE = null;
					
							row1.PHONE_NUMBER_TWO = null;
					
							row1.LINE_ONE = null;
					
							row1.LINE_TWO = null;
					
							row1.LINE_THREE = null;
					
							row1.LINE_FOUR = null;
					
							row1.MUNICIPALITY_NAME = null;
					
							row1.PREFERRED_P = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ADDRESS_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ADDRESS_TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.POSTAL_CODE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.REGION_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PHONE_NUMBER_ONE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PHONE_NUMBER_TWO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LINE_ONE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LINE_TWO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LINE_THREE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LINE_FOUR = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.MUNICIPALITY_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PREFERRED_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.TRACT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ZONE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.ADDRESS_ID = row1.ADDRESS_ID;
row2.PARTY_ID = row1.PARTY_ID;
row2.ADDRESS_TYPE = StringUtils.trimToNull(row1.ADDRESS_TYPE);
row2.LATITUDE = row1.LATITUDE;
row2.LONGITUDE = row1.LONGITUDE;
row2.POSTAL_CODE = StringUtils.trimToNull(row1.POSTAL_CODE);
row2.REGION_NAME = StringUtils.trimToNull(row1.REGION_NAME);
row2.COUNTRY_NAME = StringUtils.trimToNull(row1.COUNTRY_NAME);
row2.CREATION_DATE = row1.CREATION_DATE;
row2.LAST_MODIFIED = row1.LAST_MODIFIED;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.PHONE_NUMBER_ONE = StringUtils.trimToNull(row1.PHONE_NUMBER_ONE);
row2.PHONE_NUMBER_TWO = StringUtils.trimToNull(row1.PHONE_NUMBER_TWO);
row2.LINE_ONE = StringUtils.trimToNull(row1.LINE_ONE);
row2.LINE_TWO = StringUtils.trimToNull(row1.LINE_TWO);
row2.LINE_THREE = StringUtils.trimToNull(row1.LINE_THREE);
row2.LINE_FOUR = StringUtils.trimToNull(row1.LINE_FOUR);
row2.MUNICIPALITY_NAME = StringUtils.trimToNull(row1.MUNICIPALITY_NAME);
row2.PREFERRED_P = BooleanUtils.boolChar(row1.PREFERRED_P);
row2.TRACT_ID = row1.TRACT_ID;
row2.ZONE_ID = row1.ZONE_ID;
    nb_line_tJavaRow_2++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[21];
                            rowtFileOutputDelimited_1[0]=row2.ADDRESS_ID == null ? null : String.valueOf(row2.ADDRESS_ID);
                            rowtFileOutputDelimited_1[1]=row2.PARTY_ID == null ? null : String.valueOf(row2.PARTY_ID);
                            rowtFileOutputDelimited_1[2]=row2.ADDRESS_TYPE == null ? null : row2.ADDRESS_TYPE;
                            rowtFileOutputDelimited_1[3]=row2.LATITUDE == null ? null : String.valueOf(row2.LATITUDE);
                            rowtFileOutputDelimited_1[4]=row2.LONGITUDE == null ? null : String.valueOf(row2.LONGITUDE);
                            rowtFileOutputDelimited_1[5]=row2.POSTAL_CODE == null ? null : row2.POSTAL_CODE;
                            rowtFileOutputDelimited_1[6]=row2.REGION_NAME == null ? null : row2.REGION_NAME;
                            rowtFileOutputDelimited_1[7]=row2.COUNTRY_NAME == null ? null : row2.COUNTRY_NAME;
                            ...
                            rowtFileOutputDelimited_1[11]=row2.PHONE_NUMBER_ONE == null ? null : row2.PHONE_NUMBER_ONE;
                            rowtFileOutputDelimited_1[12]=row2.PHONE_NUMBER_TWO == null ? null : row2.PHONE_NUMBER_TWO;
                            rowtFileOutputDelimited_1[13]=row2.LINE_ONE == null ? null : row2.LINE_ONE;
                            rowtFileOutputDelimited_1[14]=row2.LINE_TWO == null ? null : row2.LINE_TWO;
                            rowtFileOutputDelimited_1[15]=row2.LINE_THREE == null ? null : row2.LINE_THREE;
                            rowtFileOutputDelimited_1[16]=row2.LINE_FOUR == null ? null : row2.LINE_FOUR;
                            rowtFileOutputDelimited_1[17]=row2.MUNICIPALITY_NAME == null ? null : row2.MUNICIPALITY_NAME;
                            rowtFileOutputDelimited_1[18]=row2.PREFERRED_P == null ? null : row2.PREFERRED_P;
                            rowtFileOutputDelimited_1[19]=row2.TRACT_ID == null ? null : String.valueOf(row2.TRACT_ID);
                            rowtFileOutputDelimited_1[20]=row2.ZONE_ID == null ? null : String.valueOf(row2.ZONE_ID);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Addresses StageFeed_AddressesClass = new StageFeed_Addresses();

        int exitCode = StageFeed_AddressesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Addresses.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_addresses_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Addresses");
        }
...
/************************************************************************************************
 *     380821 characters generated by Talend Open Studio for Data Integration 
