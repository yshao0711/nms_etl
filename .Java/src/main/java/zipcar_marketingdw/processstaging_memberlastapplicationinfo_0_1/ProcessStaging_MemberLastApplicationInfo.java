...
package zipcar_marketingdw.processstaging_memberlastapplicationinfo_0_1;
...
/**
 * Job: ProcessStaging_MemberLastApplicationInfo Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_MemberLastApplicationInfo implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_MemberLastApplicationInfo";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_k0y8MMp6EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_MemberLastApplicationInfo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_MemberLastApplicationInfo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_MemberLastApplicationInfo) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "member_last_application_info";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_member_last_application_info";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_member_last_application_info\n(\n	member_id,\n	join_application_id,\n	join_application_type,\n	join_account_id,\n	join_source_cd,\n	join_referral_p,\n	join_rate_plan_class,\n	join_affiliate,\n	join_annual_fee,\n	join_app_fee,\n	join_coupon_cd,\n	join_coupon_desc,\n	join_driving_credit_usd,\n	join_app_start_date,\n	join_app_finish_date,\n	join_app_last_step,\n	join_incomplete_app_p,\n	join_app_approval_date,\n	join_app_rejection_date,\n	join_app_acct_approv_tstamp_tz,\n	join_app_submitted_date,\n	join_app_process_finished_date,\n	join_app_account_approval_date,\n	join_app_status,\n	join_app_begin_date,\n	join_submitted_app_p,\n	join_first_corporate_id,\n	join_timezone_region,\n	creation_date,\n	deleted_date,\n    imported_date\n)\nSELECT \n	member_id,\n	join_application_id,\n	join_application_type,\n	join_account_id,\n	join_source_cd,\n	join_referral_p,\n	join_rate_plan_class,\n	join_affiliate,\n	join_annual_fee,\n	join_app_fee,\n	join_coupon_cd,\n	join_coupon_desc,\n	join_driving_credit_usd,\n	join_app_start_date,\n	join_app_finish_date,\n	join_app_last_step,\n	join_incomplete_app_p,\n	join_app_approval_date,\n	join_app_rejection_date,\n	join_app_acct_approv_tstamp_tz,\n	join_app_submitted_date,\n	join_app_process_finished_date,\n	join_app_account_approval_date,\n	join_app_status,\n	join_app_begin_date,\n	join_submitted_app_p,\n	join_first_corporate_id,\n	join_timezone_region,\n	creation_date,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.member_last_application_info\nMINUS\nSELECT \n	member_id,\n	join_application_id,\n	join_application_type,\n	join_account_id,\n	join_source_cd,\n	join_referral_p,\n	join_rate_plan_class,\n	join_affiliate,\n	join_annual_fee,\n	join_app_fee,\n	join_coupon_cd,\n	join_coupon_desc,\n	join_driving_credit_usd,\n	join_app_start_date,\n	join_app_finish_date,\n	join_app_last_step,\n	join_incomplete_app_p,\n	join_app_approval_date,\n	join_app_rejection_date,\n	join_app_acct_approv_tstamp_tz,\n	join_app_submitted_date,\n	join_app_process_finished_date,\n	join_app_account_approval_date,\n	join_app_status,\n	join_app_begin_date,\n	join_submitted_app_p,\n	join_first_corporate_id,\n	join_timezone_region,\n	creation_date,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_member_last_application_info\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".member_last_application_info";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_MemberLastApplicationInfo ProcessStaging_MemberLastApplicationInfoClass = new ProcessStaging_MemberLastApplicationInfo();

        int exitCode = ProcessStaging_MemberLastApplicationInfoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_MemberLastApplicationInfo.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_memberlastapplicationinfo_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_MemberLastApplicationInfo");
        }
...
/************************************************************************************************
 *     138057 characters generated by Talend Open Studio for Data Integration 
