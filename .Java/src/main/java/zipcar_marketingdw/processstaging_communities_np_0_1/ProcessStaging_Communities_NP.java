...
package zipcar_marketingdw.processstaging_communities_np_0_1;
...
/**
 * Job: ProcessStaging_Communities_NP Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Communities_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Communities_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_0D1y4KsOEeiSS9daonsVPw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Communities_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Communities_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Communities_NP) {
...
"\nINSERT INTO {{marketing.schema}}.r_community_np (\n             community_id\n             , community_name\n             , active_p\n             , timezone\n             , parent_community_id\n             , locale\n             , currency_code\n             , default_booking_type\n             , allow_tap_and_go_p\n             , show_gps_during_ride_p\n             , early_start_grace_minutes\n             , sleep_enabled_p\n             , sleep_begin_hour\n             , sleep_end_hour\n             , sleep_weekends_p\n             , sleep_percent_cars\n             , allow_floating_p\n             , on_demand_auto_cancel_minutes\n             , overbook_limit_percent\n             , imported_date\n)\n\nSELECT community_id\n              , community_name\n              , active\n              , timezone\n              , parent_community_id\n              , locale\n              , currency_code\n              , default_booking_type\n              , allow_tap_and_go\n              , show_gps_during_ride\n              , early_start_grace_minutes\n              , sleep_enabled\n              , sleep_begin_hour\n              , sleep_end_hour\n              , sleep_weekends\n              , sleep_percent_cars\n              , allow_floating\n              , on_demand_auto_cancel_minutes\n              , overbook_limit_percent\n              , TO_DATE({{rundate}}, 'YYYY-MM-DD') AS imported_date\n   FROM {{staging.schema}}.communities_np\n\n MINUS\n\nSELECT community_id\n             , community_name\n             , active_p\n             , timezone\n             , parent_community_id\n             , locale\n             , currency_code\n             , default_booking_type\n             , allow_tap_and_go_p\n             , show_gps_during_ride_p\n             , early_start_grace_minutes\n             , sleep_enabled_p\n             , sleep_begin_hour\n             , sleep_end_hour\n             , sleep_weekends_p\n             , sleep_percent_cars\n             , allow_floating_p\n             , on_demand_auto_cancel_minutes\n             , overbook_limit_percent\n              , TO_DATE({{rundate}}, 'YYYY-MM-DD') AS imported_date\n   FROM {{marketing.schema}}.vw_r_community_np\n",
...
"\n	truncate {{staging.schema}}.communities_np;\n",
"staging.schema",  StringHandling.DQUOTE(context.Redshift_Staging_Schema)
);
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Communities_NP ProcessStaging_Communities_NPClass = new ProcessStaging_Communities_NP();

        int exitCode = ProcessStaging_Communities_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Communities_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_communities_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Communities_NP");
        }
...
/************************************************************************************************
 *     137545 characters generated by Talend Open Studio for Data Integration 
