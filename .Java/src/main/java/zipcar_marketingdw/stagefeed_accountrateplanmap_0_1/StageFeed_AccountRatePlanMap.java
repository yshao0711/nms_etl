...
package zipcar_marketingdw.stagefeed_accountrateplanmap_0_1;
...
/**
 * Job: StageFeed_AccountRatePlanMap Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_AccountRatePlanMap implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_AccountRatePlanMap";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_NhmG4Ma9Eea-QdX5bFm04A", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_AccountRatePlanMap.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_AccountRatePlanMap.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.ACCOUNT_RATE_PLAN_MAP.filePattern());  
 ...
 */
	...
	NB_ITERATE_tJava_2++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("Record_Account_Rate_Plan_Map", 3, 0);
					}           			
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("Row_Account_Rate_Plan_Map", 3, 0);
					}           			
...
globalMap.put("tableName", FeedFile.FileType.ACCOUNT_RATE_PLAN_MAP.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.ACCOUNT_RATE_PLAN_MAP;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public String START_DATE_TZ;

				public String getSTART_DATE_TZ () {
					return this.START_DATE_TZ;
				}
			    ...
			    public String END_DATE_TZ;

				public String getEND_DATE_TZ () {
					return this.END_DATE_TZ;
				}
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.ACCOUNT_ID = this.ACCOUNT_ID;
	            ...
	            other.START_DATE_TZ = this.START_DATE_TZ;
	            other.END_DATE = this.END_DATE;
	            other.END_DATE_TZ = this.END_DATE_TZ;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.START_DATE_TZ = readString(dis);
					
					this.END_DATE = readDate(dis);
					
					this.END_DATE_TZ = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.START_DATE_TZ,dos);
					...
					// String
						...
						writeString(this.END_DATE_TZ,dos);
    ...
    public String toString() {
		...
		sb.append(",START_DATE_TZ="+START_DATE_TZ);
		sb.append(",END_DATE="+String.valueOf(END_DATE));
		sb.append(",END_DATE_TZ="+END_DATE_TZ);
...
public static class Record_Account_Rate_Plan_MapStruct implements routines.system.IPersistableRow<Record_Account_Rate_Plan_MapStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Record_Account_Rate_Plan_MapStruct other = (Record_Account_Rate_Plan_MapStruct) obj;
	...
	public void copyDataTo(Record_Account_Rate_Plan_MapStruct other) {
	...
	public void copyKeysDataTo(Record_Account_Rate_Plan_MapStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(Record_Account_Rate_Plan_MapStruct other) {
...
public static class Row_Account_Rate_Plan_MapStruct implements routines.system.IPersistableRow<Row_Account_Rate_Plan_MapStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountRatePlanMap = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(Row_Account_Rate_Plan_MapStruct other) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		Row_Account_Rate_Plan_MapStruct Row_Account_Rate_Plan_Map = new Row_Account_Rate_Plan_MapStruct();
Record_Account_Rate_Plan_MapStruct Record_Account_Rate_Plan_Map = new Record_Account_Rate_Plan_MapStruct();
	...
	currentComponent="tRedshiftOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Record_Account_Rate_Plan_Map" + iterateId, 0, 0);
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c1(java.util.Date START_DATE){
							this.START_DATE = START_DATE;
							return this;
						}				
						String START_DATE_TZ;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String START_DATE_TZ){
							this.START_DATE_TZ = START_DATE_TZ;
							return this;
						}				
						java.util.Date END_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c3(java.util.Date END_DATE){
							this.END_DATE = END_DATE;
							return this;
						}				
						String END_DATE_TZ;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String END_DATE_TZ){
							this.END_DATE_TZ = END_DATE_TZ;
							return this;
						}				
						Long RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c5(Long RATE_PLAN_ID){
							this.RATE_PLAN_ID = RATE_PLAN_ID;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c6(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c7(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c8(java.util.Date DELETED_DATE){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ACCOUNT_ID\",\"START_DATE\",\"START_DATE_TZ\",\"END_DATE\",\"END_DATE_TZ\",\"RATE_PLAN_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
	...
	currentComponent="tJavaRow_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Row_Account_Rate_Plan_Map" + iterateId, 0, 0);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
	        	...
	        	while ( limittFileInputDelimited_1 != 0 && csvReadertFileInputDelimited_1!=null && csvReadertFileInputDelimited_1.readNext() ) { 
	            	...
	            	if (limittFileInputDelimited_1 > 0 && outputLinetFileInputDelimited_1 > limittFileInputDelimited_1) {
	                	break;
	    							...
	    							Row_Account_Rate_Plan_Map = null;			
								
								boolean whetherReject_tFileInputDelimited_1 = false;
								Row_Account_Rate_Plan_Map = new Row_Account_Rate_Plan_MapStruct();
								try {			
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_Account_Rate_Plan_Map.ACCOUNT_ID = null;
					
							Row_Account_Rate_Plan_Map.START_DATE = null;
					
							Row_Account_Rate_Plan_Map.END_DATE = null;
					
							Row_Account_Rate_Plan_Map.RATE_PLAN_ID = null;
					
							Row_Account_Rate_Plan_Map.CREATION_DATE = null;
					
							Row_Account_Rate_Plan_Map.LAST_MODIFIED = null;
					
							Row_Account_Rate_Plan_Map.DELETED_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Account_Rate_Plan_Map.ACCOUNT_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Account_Rate_Plan_Map.START_DATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_Account_Rate_Plan_Map.END_DATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Account_Rate_Plan_Map.RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Account_Rate_Plan_Map.CREATION_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Account_Rate_Plan_Map.LAST_MODIFIED = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Account_Rate_Plan_Map.DELETED_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
 ...
 */
// Start of branch "Row_Account_Rate_Plan_Map"
if(Row_Account_Rate_Plan_Map != null) { 
	...
	currentComponent="tJavaRow_2";
			...
			//Row_Account_Rate_Plan_Map
			//Row_Account_Rate_Plan_Map


			
				if(execStat){
					runStat.updateStatOnConnection("Row_Account_Rate_Plan_Map"+iterateId,1, 1);
				} 
...
Record_Account_Rate_Plan_Map.ACCOUNT_ID = Row_Account_Rate_Plan_Map.ACCOUNT_ID;
Record_Account_Rate_Plan_Map.START_DATE = FeedFile.getDateTime(Row_Account_Rate_Plan_Map.START_DATE);
Record_Account_Rate_Plan_Map.START_DATE_TZ = FeedFile.getTimeZoneOffset(Row_Account_Rate_Plan_Map.START_DATE);
Record_Account_Rate_Plan_Map.END_DATE = FeedFile.getDateTime(Row_Account_Rate_Plan_Map.END_DATE);
Record_Account_Rate_Plan_Map.END_DATE_TZ = FeedFile.getTimeZoneOffset(Row_Account_Rate_Plan_Map.END_DATE);
Record_Account_Rate_Plan_Map.RATE_PLAN_ID = Row_Account_Rate_Plan_Map.RATE_PLAN_ID;
Record_Account_Rate_Plan_Map.CREATION_DATE = Row_Account_Rate_Plan_Map.CREATION_DATE;
Record_Account_Rate_Plan_Map.LAST_MODIFIED = Row_Account_Rate_Plan_Map.LAST_MODIFIED;
Record_Account_Rate_Plan_Map.DELETED_DATE = Row_Account_Rate_Plan_Map.DELETED_DATE;
 ...
 */
	...
	currentComponent="tRedshiftOutput_1";
			...
			//Record_Account_Rate_Plan_Map
			//Record_Account_Rate_Plan_Map


			
				if(execStat){
					runStat.updateStatOnConnection("Record_Account_Rate_Plan_Map"+iterateId,1, 1);
				} 
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_Account_Rate_Plan_Map.ACCOUNT_ID);
							
						countertRedshiftOutput_1++;
						

						
							if(Record_Account_Rate_Plan_Map.START_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Account_Rate_Plan_Map.START_DATE.getTime();
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Account_Rate_Plan_Map.START_DATE_TZ==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Account_Rate_Plan_Map.START_DATE_TZ);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Account_Rate_Plan_Map.END_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Account_Rate_Plan_Map.END_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Account_Rate_Plan_Map.END_DATE_TZ==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_Account_Rate_Plan_Map.END_DATE_TZ);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Account_Rate_Plan_Map.RATE_PLAN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_Account_Rate_Plan_Map.RATE_PLAN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Account_Rate_Plan_Map.CREATION_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Account_Rate_Plan_Map.CREATION_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Account_Rate_Plan_Map.LAST_MODIFIED!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Account_Rate_Plan_Map.LAST_MODIFIED.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_Account_Rate_Plan_Map.DELETED_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_Account_Rate_Plan_Map.DELETED_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_Account_Rate_Plan_Map.ACCOUNT_ID)
                        .c1(Record_Account_Rate_Plan_Map.START_DATE)
                        .c2(Record_Account_Rate_Plan_Map.START_DATE_TZ)
                        .c3(Record_Account_Rate_Plan_Map.END_DATE)
                        .c4(Record_Account_Rate_Plan_Map.END_DATE_TZ)
                        .c5(Record_Account_Rate_Plan_Map.RATE_PLAN_ID)
                        .c6(Record_Account_Rate_Plan_Map.CREATION_DATE)
                        .c7(Record_Account_Rate_Plan_Map.LAST_MODIFIED)
                        .c8(Record_Account_Rate_Plan_Map.DELETED_DATE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.ACCOUNT_ID = Record_Account_Rate_Plan_Map.ACCOUNT_ID;
                                After_Insert.START_DATE = Record_Account_Rate_Plan_Map.START_DATE;
                                After_Insert.START_DATE_TZ = Record_Account_Rate_Plan_Map.START_DATE_TZ;
                                After_Insert.END_DATE = Record_Account_Rate_Plan_Map.END_DATE;
                                After_Insert.END_DATE_TZ = Record_Account_Rate_Plan_Map.END_DATE_TZ;
                                After_Insert.RATE_PLAN_ID = Record_Account_Rate_Plan_Map.RATE_PLAN_ID;
                                After_Insert.CREATION_DATE = Record_Account_Rate_Plan_Map.CREATION_DATE;
                                After_Insert.LAST_MODIFIED = Record_Account_Rate_Plan_Map.LAST_MODIFIED;
                                After_Insert.DELETED_DATE = Record_Account_Rate_Plan_Map.DELETED_DATE;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.START_DATE_TZ = After_Insert.START_DATE_TZ;
               Log_Rows.END_DATE = After_Insert.END_DATE;
               Log_Rows.END_DATE_TZ = After_Insert.END_DATE_TZ;
...
} // End of branch "Row_Account_Rate_Plan_Map"
...
globalMap.put("tJavaRow_2_NB_LINE",nb_line_tJavaRow_2);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Row_Account_Rate_Plan_Map"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ACCOUNT_ID\",\"START_DATE\",\"START_DATE_TZ\",\"END_DATE\",\"END_DATE_TZ\",\"RATE_PLAN_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.START_DATE_TZ==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.START_DATE_TZ);
					...
					if(bufferLtRedshiftOutput_1.END_DATE_TZ==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.END_DATE_TZ);
	...
	nb_line_rejected_tRedshiftOutput_1=nb_line_rejected_tRedshiftOutput_1 + rejectedCount_tRedshiftOutput_1;
        ...
        globalMap.put("tRedshiftOutput_1_NB_LINE_REJECTED", nb_line_rejected_tRedshiftOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Record_Account_Rate_Plan_Map"+iterateId,2, 0); 
			 	}
			}
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.START_DATE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.END_DATE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.START_DATE = FeedFile.getDateTime(row1.START_DATE);
row2.START_DATE_TZ = FeedFile.getTimeZoneOffset(row1.START_DATE);
row2.END_DATE = FeedFile.getDateTime(row1.END_DATE);
row2.END_DATE_TZ = FeedFile.getTimeZoneOffset(row1.END_DATE);
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[9];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.ACCOUNT_ID);
                            rowtFileOutputDelimited_1[1]=row2.START_DATE == null ? null : FormatterUtils.format_Date(row2.START_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[2]=row2.START_DATE_TZ == null ? null : row2.START_DATE_TZ;
                            rowtFileOutputDelimited_1[3]=row2.END_DATE == null ? null : FormatterUtils.format_Date(row2.END_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[4]=row2.END_DATE_TZ == null ? null : row2.END_DATE_TZ;
                            rowtFileOutputDelimited_1[5]=row2.RATE_PLAN_ID == null ? null : String.valueOf(row2.RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[6]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[7]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[8]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_AccountRatePlanMap StageFeed_AccountRatePlanMapClass = new StageFeed_AccountRatePlanMap();

        int exitCode = StageFeed_AccountRatePlanMapClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_AccountRatePlanMap.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_accountrateplanmap_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_AccountRatePlanMap");
        }
...
/************************************************************************************************
 *     330067 characters generated by Talend Open Studio for Data Integration 
