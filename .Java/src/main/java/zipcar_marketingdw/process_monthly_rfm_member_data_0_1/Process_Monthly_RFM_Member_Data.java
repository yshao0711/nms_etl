...
package zipcar_marketingdw.process_monthly_rfm_member_data_0_1;
...
/**
 * Job: Process_Monthly_RFM_Member_Data Purpose: Computes Monthly RFM member values<br>
 * Description: Computes Monthly RFM member values from reservation data <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status DEV
 */
public class Process_Monthly_RFM_Member_Data implements TalendJob {
...
public String getRedshift_Monitoring_Server(){
	...
	private final String jobName = "Process_Monthly_RFM_Member_Data";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_J08FcGT3Eei9_4qgNN-AHg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Process_Monthly_RFM_Member_Data.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Process_Monthly_RFM_Member_Data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
globalMap.put("START_DATE", DateUtils.getMonthlyStartDate(context.RunDate, context.RfmWeeksOffset));
...
public static class deleted_rowsStruct implements routines.system.IPersistableRow<deleted_rowsStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data) {
...
"\nDELETE FROM {{marketing.schema}}.s_rfm_monthly\nWHERE end_date = {{endDate}}\n",
...
if(deleted_rows != null) { 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO","","Deleted Monthly RFM Records for Restart date: " + DateUtils.dateToSqlStr((Date) globalMap.get("END_DATE")),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_3", 3, "Deleted Monthly RFM Records for Restart date: " + DateUtils.dateToSqlStr((Date) globalMap.get("END_DATE")), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_3_WARN_MESSAGES", "Deleted Monthly RFM Records for Restart date: " + DateUtils.dateToSqlStr((Date) globalMap.get("END_DATE"))); 
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_RFM_Member_Data, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Monthly Member RFM data inserted into (s_rfm_monthly) for Run Date: " + DateUtils.dateToSqlStr((Date) globalMap.get("RUN_DATE")),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Monthly Member RFM data inserted into (s_rfm_monthly) for Run Date: " + DateUtils.dateToSqlStr((Date) globalMap.get("RUN_DATE")), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Monthly Member RFM data inserted into (s_rfm_monthly) for Run Date: " + DateUtils.dateToSqlStr((Date) globalMap.get("RUN_DATE"))); 
 ...
 */
    ...
    public static void main(String[] args){
        final Process_Monthly_RFM_Member_Data Process_Monthly_RFM_Member_DataClass = new Process_Monthly_RFM_Member_Data();

        int exitCode = Process_Monthly_RFM_Member_DataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Process_Monthly_RFM_Member_Data.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/process_monthly_rfm_member_data_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Process_Monthly_RFM_Member_Data");
        }
...
/************************************************************************************************
 *     121763 characters generated by Talend Open Studio for Data Integration 
