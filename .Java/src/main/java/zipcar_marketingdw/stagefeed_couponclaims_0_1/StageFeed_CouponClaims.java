...
package zipcar_marketingdw.stagefeed_couponclaims_0_1;
...
/**
 * Job: StageFeed_CouponClaims Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_CouponClaims implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_CouponClaims";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_BoBdEJzLEeiRFIAwSyk92Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_CouponClaims.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_CouponClaims.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_CouponClaims) {
...
globalMap.put("currentFeed", FeedFile.FileType.COUPON_CLAIMS);
...
int count_tRedshiftOutput_2=0;
			...
			class BufferLine_tRedshiftOutput_2 {				
	            		...
	            		public BufferLine_tRedshiftOutput_2 c0(long claim_id){
							this.claim_id = claim_id;
							return this;
						}				
						Long credit_id;
						
	            		public BufferLine_tRedshiftOutput_2 c1(Long credit_id){
							this.credit_id = credit_id;
							return this;
						}				
						long coupon_id;
						
	            		public BufferLine_tRedshiftOutput_2 c2(long coupon_id){
							this.coupon_id = coupon_id;
							return this;
						}				
						Long person_id;
						
	            		public BufferLine_tRedshiftOutput_2 c3(Long person_id){
							this.person_id = person_id;
							return this;
						}				
						java.util.Date creation_date;
						
	            		public BufferLine_tRedshiftOutput_2 c4(java.util.Date creation_date){
							this.creation_date = creation_date;
							return this;
						}				
						java.util.Date last_modified;
						
	            		public BufferLine_tRedshiftOutput_2 c5(java.util.Date last_modified){
							this.last_modified = last_modified;
							return this;
						}				
						java.util.Date deleted_date;
						
	            		public BufferLine_tRedshiftOutput_2 c6(java.util.Date deleted_date){
			...
			String insert_tRedshiftOutput_2 = "INSERT INTO \"" + tableName_tRedshiftOutput_2 + "\" (\"claim_id\",\"credit_id\",\"coupon_id\",\"person_id\",\"creation_date\",\"last_modified\",\"deleted_date\") VALUES " + extendInsertValueStmt_tRedshiftOutput_2.toString();
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.claim_id = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'claim_id' in 'Row_Feed' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.credit_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_Feed.person_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_Feed.deleted_date = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
...
Row_Mapped.claim_id = Row_Feed.claim_id;
Row_Mapped.credit_id = Row_Feed.credit_id;
Row_Mapped.coupon_id = Row_Feed.coupon_id;
Row_Mapped.person_id = Row_Feed.person_id;
Row_Mapped.creation_date = Row_Feed.creation_date;
Row_Mapped.last_modified = Row_Feed.last_modified;
Row_Mapped.deleted_date = Row_Feed.deleted_date;
	...
	currentComponent="tRedshiftOutput_2";
        ...
        whetherReject_tRedshiftOutput_2 = false;
				...
				+ 1;
							...
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.claim_id);
							
						countertRedshiftOutput_2++;
						

						
							if(Row_Mapped.credit_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.credit_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.person_id==null){
								pstmt_tRedshiftOutput_2.setNull(countertRedshiftOutput_2,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_2.setLong(countertRedshiftOutput_2,Row_Mapped.person_id);
						...
						countertRedshiftOutput_2++;
							...
							if(Row_Mapped.deleted_date!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_2 = Row_Mapped.deleted_date.getTime();
								if (date_tRedshiftOutput_2 < year1_tRedshiftOutput_2 || date_tRedshiftOutput_2 >= year10000_tRedshiftOutput_2) {
									pstmt_tRedshiftOutput_2.setString(countertRedshiftOutput_2, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_2.setTimestamp(countertRedshiftOutput_2, new java.sql.Timestamp(date_tRedshiftOutput_2));
				...
				exInsertColValuetRedshiftOutput_2 = new BufferLine_tRedshiftOutput_2();
                        ...
                        .c0(Row_Mapped.claim_id)
                        .c1(Row_Mapped.credit_id)
                        .c2(Row_Mapped.coupon_id)
                        .c3(Row_Mapped.person_id)
                        .c4(Row_Mapped.creation_date)
                        .c5(Row_Mapped.last_modified)
                        .c6(Row_Mapped.deleted_date)
				;
            ...
            if(!whetherReject_tRedshiftOutput_2) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.claim_id = Row_Mapped.claim_id;
                                After_Insert.credit_id = Row_Mapped.credit_id;
                                After_Insert.coupon_id = Row_Mapped.coupon_id;
                                After_Insert.person_id = Row_Mapped.person_id;
                                After_Insert.creation_date = Row_Mapped.creation_date;
                                After_Insert.last_modified = Row_Mapped.last_modified;
                                After_Insert.deleted_date = Row_Mapped.deleted_date;
            }
	...
	currentComponent="tRedshiftOutput_2";
	    ...
	    if(rowCounttRedshiftOutput_2!=0){
	        ...
	        for(int i_tRedshiftOutput_2=0 ; i_tRedshiftOutput_2 < rowCounttRedshiftOutput_2 ; i_tRedshiftOutput_2++){
				...
				insert_tRedshiftOutput_2 = "INSERT INTO \"" + tableName_tRedshiftOutput_2 + "\" (\"claim_id\",\"credit_id\",\"coupon_id\",\"person_id\",\"creation_date\",\"last_modified\",\"deleted_date\") VALUES "+extendInsertValue_tRedshiftOutput_2.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_2 bufferLtRedshiftOutput_2 : exInsertColValueListtRedshiftOutput_2){
				...
				+ 1;
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.claim_id);
					
	                    counttRedshiftOutput_2++;
	                    
					if(bufferLtRedshiftOutput_2.credit_id==null){
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.credit_id);
					...
					if(bufferLtRedshiftOutput_2.person_id==null){
						pstmt_tRedshiftOutput_2.setNull(counttRedshiftOutput_2,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_2.setLong(counttRedshiftOutput_2,bufferLtRedshiftOutput_2.person_id);
					...
					if(bufferLtRedshiftOutput_2.deleted_date!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_2 = bufferLtRedshiftOutput_2.deleted_date.getTime();
						if (date_tRedshiftOutput_2 < year1_tRedshiftOutput_2 || date_tRedshiftOutput_2 >= year10000_tRedshiftOutput_2) {
							pstmt_tRedshiftOutput_2.setString(counttRedshiftOutput_2, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_2.setTimestamp(counttRedshiftOutput_2, new java.sql.Timestamp(date_tRedshiftOutput_2));
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.claim_id = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'claim_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.person_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[7];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.claim_id);
                            rowtFileOutputDelimited_1[1]=row2.credit_id == null ? null : String.valueOf(row2.credit_id);
                            rowtFileOutputDelimited_1[2]=String.valueOf(row2.coupon_id);
                            rowtFileOutputDelimited_1[3]=row2.person_id == null ? null : String.valueOf(row2.person_id);
                            rowtFileOutputDelimited_1[4]=row2.creation_date == null ? null : FormatterUtils.format_Date(row2.creation_date, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[5]=row2.last_modified == null ? null : FormatterUtils.format_Date(row2.last_modified, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[6]=row2.deleted_date == null ? null : FormatterUtils.format_Date(row2.deleted_date, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_CouponClaims StageFeed_CouponClaimsClass = new StageFeed_CouponClaims();

        int exitCode = StageFeed_CouponClaimsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_CouponClaims.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_couponclaims_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_CouponClaims");
        }
...
/************************************************************************************************
 *     311538 characters generated by Talend Open Studio for Data Integration 
