...
package zipcar_marketingdw.loadfeedsintostaging_0_1;
...
/**
 * Job: LoadFeedsIntoStaging Purpose: Processes the Inbound Daily Feeds Into Staging<br>
 * Description: Scans the inbound feed folder and loads the feeds into the staging tables. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class LoadFeedsIntoStaging implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "LoadFeedsIntoStaging";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_RBAkkMFNEeajxINgXND0SQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LoadFeedsIntoStaging.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LoadFeedsIntoStaging.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tRunJob_48_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				((java.util.Map)threadLocal.get()).put("status", "failure");
				
					tRunJob_48_onSubJobError(exception, errorComponent, globalMap);
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tRunJob_48_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.stagefeed_member_0_1.StageFeed_Member childJob_tRunJob_2 = new zipcar_marketingdw.stagefeed_member_0_1.StageFeed_Member();
	    // pass DataSources
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging) {
...
public static class File_UnprocessedStruct implements routines.system.IPersistableRow<File_UnprocessedStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_LoadFeedsIntoStaging = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final File_UnprocessedStruct other = (File_UnprocessedStruct) obj;
	...
	public void copyDataTo(File_UnprocessedStruct other) {
	...
	public void copyKeysDataTo(File_UnprocessedStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(File_UnprocessedStruct other) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		File_UnprocessedStruct File_Unprocessed = new File_UnprocessedStruct();
 ...
 */
	NB_ITERATE_tFileCopy_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("File_Unprocessed", 3, 0);
					}           			
	...
	currentComponent="tWarn_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("File_Unprocessed" + iterateId, 0, 0);
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String desDirName_tFileCopy_1 = context.feedError;
 ...
 */
	...
	currentComponent="tWarn_2";
			...
			//File_Unprocessed
				...
				if(execStat){
					runStat.updateStatOnConnection("File_Unprocessed"+iterateId,1, 1);
				} 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "WARN","","Moving unprocessed file to error folder: " + ((String)globalMap.get("tFileList_1_CURRENT_FILE")),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 4, "Moving unprocessed file to error folder: " + ((String)globalMap.get("tFileList_1_CURRENT_FILE")), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Moving unprocessed file to error folder: " + ((String)globalMap.get("tFileList_1_CURRENT_FILE"))); 
 ...
 */
	...
	currentComponent="tWarn_2";
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("File_Unprocessed"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		zipcar_marketingdw.task_clearexpungedmembersfromfeeds_0_1.Task_ClearExpungedMembersFromFeeds childJob_tRunJob_10 = new zipcar_marketingdw.task_clearexpungedmembersfromfeeds_0_1.Task_ClearExpungedMembersFromFeeds();
	    // pass DataSources
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Loading Feeds to Staging Completed","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Loading Feeds to Staging Completed", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Loading Feeds to Staging Completed"); 
...
Logging.componentName(jobName, "tWarn_1", "Log_Staging_Completed");
Logging.componentName(jobName, "tWarn_2", "Log_Unprocessed_File");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.stagefeed_accountrateplanmap_0_1.StageFeed_AccountRatePlanMap childJob_tRunJob_1 = new zipcar_marketingdw.stagefeed_accountrateplanmap_0_1.StageFeed_AccountRatePlanMap();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.stagefeed_accountmembermap_0_1.StageFeed_AccountMemberMap childJob_tRunJob_3 = new zipcar_marketingdw.stagefeed_accountmembermap_0_1.StageFeed_AccountMemberMap();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		zipcar_marketingdw.stagefeed_rateplans_0_1.StageFeed_RatePlans childJob_tRunJob_4 = new zipcar_marketingdw.stagefeed_rateplans_0_1.StageFeed_RatePlans();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		zipcar_marketingdw.stagefeed_reservations_0_1.StageFeed_Reservations childJob_tRunJob_5 = new zipcar_marketingdw.stagefeed_reservations_0_1.StageFeed_Reservations();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		zipcar_marketingdw.stagefeed_addresses_0_1.StageFeed_Addresses childJob_tRunJob_6 = new zipcar_marketingdw.stagefeed_addresses_0_1.StageFeed_Addresses();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_7 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_7.put("feedArchive", context.feedArchive);
			paraList_tRunJob_7.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_7.put("feedError", context.feedError);
			paraList_tRunJob_7.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_7.put("feedInput", context.feedInput);
			paraList_tRunJob_7.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_7 = null;
		...
		zipcar_marketingdw.stagefeed_locations_0_1.StageFeed_Locations childJob_tRunJob_7 = new zipcar_marketingdw.stagefeed_locations_0_1.StageFeed_Locations();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_8 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_8.put("feedArchive", context.feedArchive);
			paraList_tRunJob_8.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_8.put("feedError", context.feedError);
			paraList_tRunJob_8.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_8.put("feedInput", context.feedInput);
			paraList_tRunJob_8.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_8 = null;
		...
		zipcar_marketingdw.stagefeed_accountadmins_0_1.StageFeed_AccountAdmins childJob_tRunJob_8 = new zipcar_marketingdw.stagefeed_accountadmins_0_1.StageFeed_AccountAdmins();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_9 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_9.put("feedArchive", context.feedArchive);
			paraList_tRunJob_9.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_9.put("feedError", context.feedError);
			paraList_tRunJob_9.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_9.put("feedInput", context.feedInput);
			paraList_tRunJob_9.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_9 = null;
		...
		zipcar_marketingdw.stagefeed_applicationsfinal_0_1.StageFeed_ApplicationsFinal childJob_tRunJob_9 = new zipcar_marketingdw.stagefeed_applicationsfinal_0_1.StageFeed_ApplicationsFinal();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_11 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_11.put("feedArchive", context.feedArchive);
			paraList_tRunJob_11.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_11.put("feedError", context.feedError);
			paraList_tRunJob_11.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_11.put("feedInput", context.feedInput);
			paraList_tRunJob_11.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_11 = null;
		...
		zipcar_marketingdw.stagefeed_accounts_0_1.StageFeed_Accounts childJob_tRunJob_11 = new zipcar_marketingdw.stagefeed_accounts_0_1.StageFeed_Accounts();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_12 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_12.put("feedArchive", context.feedArchive);
			paraList_tRunJob_12.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_12.put("feedError", context.feedError);
			paraList_tRunJob_12.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_12.put("feedInput", context.feedInput);
			paraList_tRunJob_12.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_12 = null;
		...
		zipcar_marketingdw.stagefeed_accountaffiliates_0_1.StageFeed_AccountAffiliates childJob_tRunJob_12 = new zipcar_marketingdw.stagefeed_accountaffiliates_0_1.StageFeed_AccountAffiliates();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_13 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_13.put("feedArchive", context.feedArchive);
			paraList_tRunJob_13.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_13.put("feedError", context.feedError);
			paraList_tRunJob_13.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_13.put("feedInput", context.feedInput);
			paraList_tRunJob_13.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_13 = null;
		...
		zipcar_marketingdw.stagefeed_credits_0_1.StageFeed_Credits childJob_tRunJob_13 = new zipcar_marketingdw.stagefeed_credits_0_1.StageFeed_Credits();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_14 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_14.put("feedArchive", context.feedArchive);
			paraList_tRunJob_14.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_14.put("feedError", context.feedError);
			paraList_tRunJob_14.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_14.put("feedInput", context.feedInput);
			paraList_tRunJob_14.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_14 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewmailingdata_0_1.StageFeed_StrongviewMailingData childJob_tRunJob_14 = new zipcar_marketingdw.stagefeed_strongviewmailingdata_0_1.StageFeed_StrongviewMailingData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_15 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_15.put("feedArchive", context.feedArchive);
			paraList_tRunJob_15.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_15.put("feedError", context.feedError);
			paraList_tRunJob_15.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_15.put("feedInput", context.feedInput);
			paraList_tRunJob_15.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_15 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewtrackdata_0_1.StageFeed_StrongviewTrackData childJob_tRunJob_15 = new zipcar_marketingdw.stagefeed_strongviewtrackdata_0_1.StageFeed_StrongviewTrackData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_16 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_16.put("feedArchive", context.feedArchive);
			paraList_tRunJob_16.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_16.put("feedError", context.feedError);
			paraList_tRunJob_16.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_16.put("feedInput", context.feedInput);
			paraList_tRunJob_16.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_16 = null;
		...
		zipcar_marketingdw.stagefeed_vehicles_0_1.StageFeed_Vehicles childJob_tRunJob_16 = new zipcar_marketingdw.stagefeed_vehicles_0_1.StageFeed_Vehicles();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_17 = null;
		...
		zipcar_marketingdw.stagefeed_zipfleets_0_1.StageFeed_Zipfleets childJob_tRunJob_17 = new zipcar_marketingdw.stagefeed_zipfleets_0_1.StageFeed_Zipfleets();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_18 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_18.put("feedArchive", context.feedArchive);
			paraList_tRunJob_18.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_18.put("feedError", context.feedError);
			paraList_tRunJob_18.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_18.put("feedInput", context.feedInput);
			paraList_tRunJob_18.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_18 = null;
		...
		zipcar_marketingdw.stagefeed_supersededreservations_0_1.StageFeed_SupersededReservations childJob_tRunJob_18 = new zipcar_marketingdw.stagefeed_supersededreservations_0_1.StageFeed_SupersededReservations();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_19 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_19.put("feedArchive", context.feedArchive);
			paraList_tRunJob_19.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_19.put("feedError", context.feedError);
			paraList_tRunJob_19.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_19.put("feedInput", context.feedInput);
			paraList_tRunJob_19.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_19 = null;
		...
		zipcar_marketingdw.stagefeed_affiliates_0_1.StageFeed_Affiliates childJob_tRunJob_19 = new zipcar_marketingdw.stagefeed_affiliates_0_1.StageFeed_Affiliates();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_20 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_20.put("feedArchive", context.feedArchive);
			paraList_tRunJob_20.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_20.put("feedError", context.feedError);
			paraList_tRunJob_20.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_20.put("feedInput", context.feedInput);
			paraList_tRunJob_20.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_20 = null;
		...
		zipcar_marketingdw.stagefeed_memberattritionreasons_0_1.StageFeed_MemberAttritionReasons childJob_tRunJob_20 = new zipcar_marketingdw.stagefeed_memberattritionreasons_0_1.StageFeed_MemberAttritionReasons();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_21 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_21.put("feedArchive", context.feedArchive);
			paraList_tRunJob_21.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_21.put("feedError", context.feedError);
			paraList_tRunJob_21.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_21.put("feedInput", context.feedInput);
			paraList_tRunJob_21.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_21 = null;
		...
		zipcar_marketingdw.stagefeed_memberjoininfo_0_1.StageFeed_MemberJoinInfo childJob_tRunJob_21 = new zipcar_marketingdw.stagefeed_memberjoininfo_0_1.StageFeed_MemberJoinInfo();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_22 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_22.put("feedArchive", context.feedArchive);
			paraList_tRunJob_22.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_22.put("feedError", context.feedError);
			paraList_tRunJob_22.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_22.put("feedInput", context.feedInput);
			paraList_tRunJob_22.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_22 = null;
		...
		zipcar_marketingdw.stagefeed_memberlastapplicationinfo_0_1.StageFeed_MemberLastApplicationInfo childJob_tRunJob_22 = new zipcar_marketingdw.stagefeed_memberlastapplicationinfo_0_1.StageFeed_MemberLastApplicationInfo();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_23 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_23.put("feedArchive", context.feedArchive);
			paraList_tRunJob_23.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_23.put("feedError", context.feedError);
			paraList_tRunJob_23.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_23.put("feedInput", context.feedInput);
			paraList_tRunJob_23.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_23 = null;
		...
		zipcar_marketingdw.stagefeed_memberlastregistrationsess_0_1.StageFeed_MemberLastRegistrationSess childJob_tRunJob_23 = new zipcar_marketingdw.stagefeed_memberlastregistrationsess_0_1.StageFeed_MemberLastRegistrationSess();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_24 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_24.put("feedArchive", context.feedArchive);
			paraList_tRunJob_24.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_24.put("feedError", context.feedError);
			paraList_tRunJob_24.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_24.put("feedInput", context.feedInput);
			paraList_tRunJob_24.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_24 = null;
		...
		zipcar_marketingdw.stagefeed_memberleftinfo_0_1.StageFeed_MemberLeftInfo childJob_tRunJob_24 = new zipcar_marketingdw.stagefeed_memberleftinfo_0_1.StageFeed_MemberLeftInfo();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_25 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_25.put("feedArchive", context.feedArchive);
			paraList_tRunJob_25.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_25.put("feedError", context.feedError);
			paraList_tRunJob_25.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_25.put("feedInput", context.feedInput);
			paraList_tRunJob_25.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_25 = null;
		...
		zipcar_marketingdw.stagefeed_memberrejoinhistory_0_1.StageFeed_MemberRejoinHistory childJob_tRunJob_25 = new zipcar_marketingdw.stagefeed_memberrejoinhistory_0_1.StageFeed_MemberRejoinHistory();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_26 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_26.put("feedArchive", context.feedArchive);
			paraList_tRunJob_26.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_26.put("feedError", context.feedError);
			paraList_tRunJob_26.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_26.put("feedInput", context.feedInput);
			paraList_tRunJob_26.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_26 = null;
		...
		zipcar_marketingdw.stagefeed_registrationsessions_0_1.StageFeed_RegistrationSessions childJob_tRunJob_26 = new zipcar_marketingdw.stagefeed_registrationsessions_0_1.StageFeed_RegistrationSessions();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_27 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_27.put("feedArchive", context.feedArchive);
			paraList_tRunJob_27.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_27.put("feedError", context.feedError);
			paraList_tRunJob_27.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_27.put("feedInput", context.feedInput);
			paraList_tRunJob_27.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_27 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewaggdata_0_1.StageFeed_StrongviewAggData childJob_tRunJob_27 = new zipcar_marketingdw.stagefeed_strongviewaggdata_0_1.StageFeed_StrongviewAggData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_28 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_28.put("feedArchive", context.feedArchive);
			paraList_tRunJob_28.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_28.put("feedError", context.feedError);
			paraList_tRunJob_28.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_28.put("feedInput", context.feedInput);
			paraList_tRunJob_28.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_28 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewconvdata_0_1.StageFeed_StrongviewConvData childJob_tRunJob_28 = new zipcar_marketingdw.stagefeed_strongviewconvdata_0_1.StageFeed_StrongviewConvData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_29 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_29.put("feedArchive", context.feedArchive);
			paraList_tRunJob_29.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_29.put("feedError", context.feedError);
			paraList_tRunJob_29.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_29.put("feedInput", context.feedInput);
			paraList_tRunJob_29.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_29 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewdevicedata_0_1.StageFeed_StrongviewDeviceData childJob_tRunJob_29 = new zipcar_marketingdw.stagefeed_strongviewdevicedata_0_1.StageFeed_StrongviewDeviceData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_30 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_30.put("feedArchive", context.feedArchive);
			paraList_tRunJob_30.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_30.put("feedError", context.feedError);
			paraList_tRunJob_30.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_30.put("feedInput", context.feedInput);
			paraList_tRunJob_30.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_30 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewdownloadfiles_0_1.StageFeed_StrongviewDownloadFiles childJob_tRunJob_30 = new zipcar_marketingdw.stagefeed_strongviewdownloadfiles_0_1.StageFeed_StrongviewDownloadFiles();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_31 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_31.put("feedArchive", context.feedArchive);
			paraList_tRunJob_31.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_31.put("feedError", context.feedError);
			paraList_tRunJob_31.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_31.put("feedInput", context.feedInput);
			paraList_tRunJob_31.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_31 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewsuccessdata_0_1.StageFeed_StrongviewSuccessData childJob_tRunJob_31 = new zipcar_marketingdw.stagefeed_strongviewsuccessdata_0_1.StageFeed_StrongviewSuccessData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_32 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_32.put("feedArchive", context.feedArchive);
			paraList_tRunJob_32.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_32.put("feedError", context.feedError);
			paraList_tRunJob_32.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_32.put("feedInput", context.feedInput);
			paraList_tRunJob_32.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_32 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewprogexportdata_0_1.StageFeed_StrongviewProgExportData childJob_tRunJob_32 = new zipcar_marketingdw.stagefeed_strongviewprogexportdata_0_1.StageFeed_StrongviewProgExportData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_33 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_33.put("feedArchive", context.feedArchive);
			paraList_tRunJob_33.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_33.put("feedError", context.feedError);
			paraList_tRunJob_33.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_33.put("feedInput", context.feedInput);
			paraList_tRunJob_33.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_33 = null;
		...
		zipcar_marketingdw.stagefeed_strongviewprogramfiles_0_1.StageFeed_StrongviewProgramFiles childJob_tRunJob_33 = new zipcar_marketingdw.stagefeed_strongviewprogramfiles_0_1.StageFeed_StrongviewProgramFiles();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_34 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_34.put("feedArchive", context.feedArchive);
			paraList_tRunJob_34.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_34.put("feedError", context.feedError);
			paraList_tRunJob_34.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_34.put("feedInput", context.feedInput);
			paraList_tRunJob_34.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_34 = null;
		...
		zipcar_marketingdw.stagefeed_waiverplans_0_1.StageFeed_WaiverPlans childJob_tRunJob_34 = new zipcar_marketingdw.stagefeed_waiverplans_0_1.StageFeed_WaiverPlans();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_35 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_35.put("feedArchive", context.feedArchive);
			paraList_tRunJob_35.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_35.put("feedError", context.feedError);
			paraList_tRunJob_35.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_35.put("feedInput", context.feedInput);
			paraList_tRunJob_35.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_35 = null;
		...
		zipcar_marketingdw.stagefeed_waivers_0_1.StageFeed_Waivers childJob_tRunJob_35 = new zipcar_marketingdw.stagefeed_waivers_0_1.StageFeed_Waivers();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_36 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_36.put("feedArchive", context.feedArchive);
			paraList_tRunJob_36.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_36.put("feedError", context.feedError);
			paraList_tRunJob_36.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_36.put("feedInput", context.feedInput);
			paraList_tRunJob_36.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_36 = null;
		...
		zipcar_marketingdw.stagefeed_membersext_0_1.StageFeed_MembersExt childJob_tRunJob_36 = new zipcar_marketingdw.stagefeed_membersext_0_1.StageFeed_MembersExt();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_37 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_37.put("feedArchive", context.feedArchive);
			paraList_tRunJob_37.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_37.put("feedError", context.feedError);
			paraList_tRunJob_37.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_37.put("feedInput", context.feedInput);
			paraList_tRunJob_37.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_37 = null;
		...
		zipcar_marketingdw.stagefeed_corporateapplications_0_1.StageFeed_CorporateApplications childJob_tRunJob_37 = new zipcar_marketingdw.stagefeed_corporateapplications_0_1.StageFeed_CorporateApplications();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_38 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_38.put("feedArchive", context.feedArchive);
			paraList_tRunJob_38.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_38.put("feedError", context.feedError);
			paraList_tRunJob_38.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_38.put("feedInput", context.feedInput);
			paraList_tRunJob_38.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_38 = null;
		...
		zipcar_marketingdw.stagefeed_exchangerates_0_1.StageFeed_ExchangeRates childJob_tRunJob_38 = new zipcar_marketingdw.stagefeed_exchangerates_0_1.StageFeed_ExchangeRates();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_39 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_39.put("feedArchive", context.feedArchive);
			paraList_tRunJob_39.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_39.put("feedError", context.feedError);
			paraList_tRunJob_39.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_39.put("feedInput", context.feedInput);
			paraList_tRunJob_39.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_39 = null;
		...
		zipcar_marketingdw.stagefeed_registrationsessionhistories_0_1.StageFeed_RegistrationSessionHistories childJob_tRunJob_39 = new zipcar_marketingdw.stagefeed_registrationsessionhistories_0_1.StageFeed_RegistrationSessionHistories();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_40 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_40.put("feedArchive", context.feedArchive);
			paraList_tRunJob_40.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_40.put("feedError", context.feedError);
			paraList_tRunJob_40.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_40.put("feedInput", context.feedInput);
			paraList_tRunJob_40.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_40 = null;
		...
		zipcar_marketingdw.stagefeed_wexfueldata_0_1.StageFeed_WexFuelData childJob_tRunJob_40 = new zipcar_marketingdw.stagefeed_wexfueldata_0_1.StageFeed_WexFuelData();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_41 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_41.put("feedArchive", context.feedArchive);
			paraList_tRunJob_41.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_41.put("feedError", context.feedError);
			paraList_tRunJob_41.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_41.put("feedInput", context.feedInput);
			paraList_tRunJob_41.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_41 = null;
		...
		zipcar_marketingdw.stagefeed_zones_0_1.StageFeed_Zones childJob_tRunJob_41 = new zipcar_marketingdw.stagefeed_zones_0_1.StageFeed_Zones();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_42 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_42.put("feedArchive", context.feedArchive);
			paraList_tRunJob_42.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_42.put("feedError", context.feedError);
			paraList_tRunJob_42.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_42.put("feedInput", context.feedInput);
			paraList_tRunJob_42.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_42 = null;
		...
		zipcar_marketingdw.stagefeed_reservations_np_0_1.StageFeed_Reservations_NP childJob_tRunJob_42 = new zipcar_marketingdw.stagefeed_reservations_np_0_1.StageFeed_Reservations_NP();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_43 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_43.put("feedArchive", context.feedArchive);
			paraList_tRunJob_43.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_43.put("feedError", context.feedError);
			paraList_tRunJob_43.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_43.put("feedInput", context.feedInput);
			paraList_tRunJob_43.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_43 = null;
		...
		zipcar_marketingdw.stagefeed_vehicles_np_0_1.StageFeed_Vehicles_NP childJob_tRunJob_43 = new zipcar_marketingdw.stagefeed_vehicles_np_0_1.StageFeed_Vehicles_NP();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_44 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_44.put("feedArchive", context.feedArchive);
			paraList_tRunJob_44.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_44.put("feedError", context.feedError);
			paraList_tRunJob_44.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_44.put("feedInput", context.feedInput);
			paraList_tRunJob_44.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_44 = null;
		...
		zipcar_marketingdw.stagefeed_couponclaims_0_1.StageFeed_CouponClaims childJob_tRunJob_44 = new zipcar_marketingdw.stagefeed_couponclaims_0_1.StageFeed_CouponClaims();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_45 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_45.put("feedArchive", context.feedArchive);
			paraList_tRunJob_45.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_45.put("feedError", context.feedError);
			paraList_tRunJob_45.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_45.put("feedInput", context.feedInput);
			paraList_tRunJob_45.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_45 = null;
		...
		zipcar_marketingdw.stagefeed_coupons_0_1.StageFeed_Coupons childJob_tRunJob_45 = new zipcar_marketingdw.stagefeed_coupons_0_1.StageFeed_Coupons();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_46 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_46.put("feedArchive", context.feedArchive);
			paraList_tRunJob_46.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_46.put("feedError", context.feedError);
			paraList_tRunJob_46.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_46.put("feedInput", context.feedInput);
			paraList_tRunJob_46.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_46 = null;
		...
		zipcar_marketingdw.stagefeed_transactions_0_1.StageFeed_Transactions childJob_tRunJob_46 = new zipcar_marketingdw.stagefeed_transactions_0_1.StageFeed_Transactions();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_47 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_47.put("feedArchive", context.feedArchive);
			paraList_tRunJob_47.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_47.put("feedError", context.feedError);
			paraList_tRunJob_47.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_47.put("feedInput", context.feedInput);
			paraList_tRunJob_47.add("--context_type " + "feedInput" + "=" + "id_Directory");
	...
	Object obj_tRunJob_47 = null;
		...
		zipcar_marketingdw.stagefeed_locations_np_0_1.StageFeed_Locations_NP childJob_tRunJob_47 = new zipcar_marketingdw.stagefeed_locations_np_0_1.StageFeed_Locations_NP();
	    // pass DataSources
...
public void tRunJob_48Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tRunJob_48_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tRunJob_48", false);
		start_Hash.put("tRunJob_48", System.currentTimeMillis());
		
	
	currentComponent="tRunJob_48";

	
		int tos_count_tRunJob_48 = 0;
		
    	class BytesLimit65535_tRunJob_48{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tRunJob_48().limitLog4jByte();
...
/**
 * [tRunJob_48 begin ] stop
 */
	
	/**
	 * [tRunJob_48 main ] start
	 */
	...
	java.util.List<String> paraList_tRunJob_48 = new java.util.ArrayList<String>();
	
	        			paraList_tRunJob_48.add("--father_pid="+pid);
	      			
	        			paraList_tRunJob_48.add("--root_pid="+rootPid);
	      			
	        			paraList_tRunJob_48.add("--father_node=tRunJob_48");
	      			
	        			paraList_tRunJob_48.add("--context=external");
	      			
	//for feature:10589
	
		paraList_tRunJob_48.add("--stat_port=" + portStats);
	

	if(resuming_logs_dir_path != null){
		paraList_tRunJob_48.add("--resuming_logs_dir_path=" + resuming_logs_dir_path);
	}
	String childResumePath_tRunJob_48 = ResumeUtil.getChildJobCheckPointPath(resuming_checkpoint_path);
	String tRunJobName_tRunJob_48 = ResumeUtil.getRighttRunJob(resuming_checkpoint_path);
	if("tRunJob_48".equals(tRunJobName_tRunJob_48) && childResumePath_tRunJob_48 != null){
		paraList_tRunJob_48.add("--resuming_checkpoint_path=" + ResumeUtil.getChildJobCheckPointPath(resuming_checkpoint_path));
	}
	paraList_tRunJob_48.add("--parent_part_launcher=JOB:" + jobName + "/NODE:tRunJob_48");
	
	java.util.Map<String, Object> parentContextMap_tRunJob_48 = new java.util.HashMap<String, Object>();

	
		
		context.synchronizeContext();
		
			parentContextMap_tRunJob_48.put("clearStagingTable", context.clearStagingTable);
			paraList_tRunJob_48.add("--context_type " + "clearStagingTable" + "=" + "id_Boolean");
		
			parentContextMap_tRunJob_48.put("feedArchive", context.feedArchive);
			paraList_tRunJob_48.add("--context_type " + "feedArchive" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_48.put("feedError", context.feedError);
			paraList_tRunJob_48.add("--context_type " + "feedError" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_48.put("feedInput", context.feedInput);
			paraList_tRunJob_48.add("--context_type " + "feedInput" + "=" + "id_Directory");
		
			parentContextMap_tRunJob_48.put("Redshift_Marketing_AdditionalParams", context.Redshift_Marketing_AdditionalParams);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Marketing_AdditionalParams" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Marketing_Database", context.Redshift_Marketing_Database);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Marketing_Database" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Marketing_Login", context.Redshift_Marketing_Login);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Marketing_Login" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Marketing_Password", context.Redshift_Marketing_Password);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Marketing_Password" + "=" + "id_Password");
		
			parentContextMap_tRunJob_48.put("Redshift_Marketing_Port", context.Redshift_Marketing_Port);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Marketing_Port" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Marketing_Schema", context.Redshift_Marketing_Schema);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Marketing_Schema" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Marketing_Server", context.Redshift_Marketing_Server);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Marketing_Server" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Monitoring_AdditionalParams", context.Redshift_Monitoring_AdditionalParams);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Monitoring_AdditionalParams" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Monitoring_Database", context.Redshift_Monitoring_Database);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Monitoring_Database" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Monitoring_Login", context.Redshift_Monitoring_Login);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Monitoring_Login" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Monitoring_Password", context.Redshift_Monitoring_Password);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Monitoring_Password" + "=" + "id_Password");
		
			parentContextMap_tRunJob_48.put("Redshift_Monitoring_Port", context.Redshift_Monitoring_Port);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Monitoring_Port" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Monitoring_Schema", context.Redshift_Monitoring_Schema);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Monitoring_Schema" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Monitoring_Server", context.Redshift_Monitoring_Server);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Monitoring_Server" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Staging_AdditionalParams", context.Redshift_Staging_AdditionalParams);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Staging_AdditionalParams" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Staging_Database", context.Redshift_Staging_Database);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Staging_Database" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Staging_Login", context.Redshift_Staging_Login);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Staging_Login" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Staging_Password", context.Redshift_Staging_Password);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Staging_Password" + "=" + "id_Password");
		
			parentContextMap_tRunJob_48.put("Redshift_Staging_Port", context.Redshift_Staging_Port);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Staging_Port" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Staging_Schema", context.Redshift_Staging_Schema);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Staging_Schema" + "=" + "id_String");
		
			parentContextMap_tRunJob_48.put("Redshift_Staging_Server", context.Redshift_Staging_Server);
			paraList_tRunJob_48.add("--context_type " + "Redshift_Staging_Server" + "=" + "id_String");
		 
		java.util.Enumeration<?> propertyNames_tRunJob_48 = context.propertyNames();
		while (propertyNames_tRunJob_48.hasMoreElements()) {
			String key_tRunJob_48 = (String) propertyNames_tRunJob_48.nextElement();
			Object value_tRunJob_48 = (Object) context.get(key_tRunJob_48);
			if(value_tRunJob_48!=null) {  
				paraList_tRunJob_48.add("--context_param " + key_tRunJob_48 + "=" + value_tRunJob_48);
			} else {
				paraList_tRunJob_48.add("--context_param " + key_tRunJob_48 + "=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
			}
			
		}
		

	Object obj_tRunJob_48 = null;

	
	
		zipcar_marketingdw.stagefeed_communities_np_0_1.StageFeed_Communities_NP childJob_tRunJob_48 = new zipcar_marketingdw.stagefeed_communities_np_0_1.StageFeed_Communities_NP();
	    // pass DataSources
	    java.util.Map<String, routines.system.TalendDataSource> talendDataSources_tRunJob_48 = (java.util.Map<String, routines.system.TalendDataSource>) globalMap
	            .get(KEY_DB_DATASOURCES);
	    if (null != talendDataSources_tRunJob_48) {
	        java.util.Map<String, javax.sql.DataSource> dataSources_tRunJob_48 = new java.util.HashMap<String, javax.sql.DataSource>();
	        for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_tRunJob_48 : talendDataSources_tRunJob_48
			        .entrySet()) {
	            dataSources_tRunJob_48.put(talendDataSourceEntry_tRunJob_48.getKey(),
	                    talendDataSourceEntry_tRunJob_48.getValue().getRawDataSource());
	        }
	        childJob_tRunJob_48.setDataSources(dataSources_tRunJob_48);
	    }
		  
			childJob_tRunJob_48.parentContextMap = parentContextMap_tRunJob_48;
		  
		
		String[][] childReturn_tRunJob_48 = childJob_tRunJob_48.runJob((String[]) paraList_tRunJob_48.toArray(new String[paraList_tRunJob_48.size()]));
		
	  	
				((java.util.Map)threadLocal.get()).put("errorCode", childJob_tRunJob_48.getErrorCode());
			
	            
	    	if(childJob_tRunJob_48.getErrorCode() == null){
				globalMap.put("tRunJob_48_CHILD_RETURN_CODE", childJob_tRunJob_48.getStatus() != null && ("failure").equals(childJob_tRunJob_48.getStatus()) ? 1 : 0);
	    	}else{
				globalMap.put("tRunJob_48_CHILD_RETURN_CODE", childJob_tRunJob_48.getErrorCode());
		    }
		    if (childJob_tRunJob_48.getExceptionStackTrace() != null) { 
		    	globalMap.put("tRunJob_48_CHILD_EXCEPTION_STACKTRACE", childJob_tRunJob_48.getExceptionStackTrace());
		    }
	  
			 
				if (childJob_tRunJob_48.getErrorCode() != null || ("failure").equals(childJob_tRunJob_48.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_48.getExceptionStackTrace());
				}
	...
	tos_count_tRunJob_48++;

/**
 * [tRunJob_48 main ] stop
 */
	
	/**
	 * [tRunJob_48 end ] start
	 */
...
ok_Hash.put("tRunJob_48", true);
end_Hash.put("tRunJob_48", System.currentTimeMillis());
 ...
 */
		...
		globalMap.put("tRunJob_48_SUBPROCESS_STATE", 1);
	}
    ...
    public static void main(String[] args){
        final LoadFeedsIntoStaging LoadFeedsIntoStagingClass = new LoadFeedsIntoStaging();

        int exitCode = LoadFeedsIntoStagingClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LoadFeedsIntoStaging.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/loadfeedsintostaging_0_1/contexts/"+contextStr+".properties");
...
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_4;
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tRunJob_5Process(globalMap);
if ( !"failure".equals(((java.util.Map)threadLocal.get()).get("status")) ) {
((java.util.Map) threadLocal.get()).put("status", "end");
}
...
globalMap.put("tRunJob_5_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_5;
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tRunJob_6Process(globalMap);
if ( !"failure".equals(((java.util.Map)threadLocal.get()).get("status")) ) {
((java.util.Map) threadLocal.get()).put("status", "end");
}
...
globalMap.put("tRunJob_6_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_6;
...
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_14;
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tRunJob_15Process(globalMap);
if ( !"failure".equals(((java.util.Map)threadLocal.get()).get("status")) ) {
((java.util.Map) threadLocal.get()).put("status", "end");
}
...
}catch (java.lang.Error e_tRunJob_15) {
globalMap.put("tRunJob_15_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_15;
...
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_40;
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tRunJob_41Process(globalMap);
if ( !"failure".equals(((java.util.Map)threadLocal.get()).get("status")) ) {
((java.util.Map) threadLocal.get()).put("status", "end");
}
}catch (TalendException e_tRunJob_41) {
globalMap.put("tRunJob_41_SUBPROCESS_STATE", -1);

e_tRunJob_41.printStackTrace();

}catch (java.lang.Error e_tRunJob_41) {
globalMap.put("tRunJob_41_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_41;
...
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_47;
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tRunJob_48Process(globalMap);
if ( !"failure".equals(((java.util.Map)threadLocal.get()).get("status")) ) {
((java.util.Map) threadLocal.get()).put("status", "end");
}
}catch (TalendException e_tRunJob_48) {
globalMap.put("tRunJob_48_SUBPROCESS_STATE", -1);

e_tRunJob_48.printStackTrace();

}catch (java.lang.Error e_tRunJob_48) {
globalMap.put("tRunJob_48_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tRunJob_48;
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadFeedsIntoStaging");
        }
...
/************************************************************************************************
 *     760810 characters generated by Talend Open Studio for Data Integration 
