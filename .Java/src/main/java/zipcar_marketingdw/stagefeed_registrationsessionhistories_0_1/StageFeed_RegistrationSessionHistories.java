...
package zipcar_marketingdw.stagefeed_registrationsessionhistories_0_1;
...
/**
 * Job: StageFeed_RegistrationSessionHistories Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_RegistrationSessionHistories implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_RegistrationSessionHistories";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_UApY4BfyEeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_RegistrationSessionHistories.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_RegistrationSessionHistories.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.REGISTRATION_SESSION_HISTORIES.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.REGISTRATION_SESSION_HISTORIES.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.REGISTRATION_SESSION_HISTORIES;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public java.util.Date VIEW_DATE;

				public java.util.Date getVIEW_DATE () {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.SESSION_ID;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.SESSION_ID = this.SESSION_ID;
	            ...
	            other.REGISTRATION_MODE = this.REGISTRATION_MODE;
	            other.STEP = this.STEP;
	            other.URL = this.URL;
	            other.VIEW_DATE = this.VIEW_DATE;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RegistrationSessionHistories) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.REGISTRATION_MODE = readString(dis);
					
					this.STEP = readString(dis);
					
					this.URL = readString(dis);
					
					this.VIEW_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.REGISTRATION_MODE,dos);
					
					// String
				
						writeString(this.STEP,dos);
    ...
    public String toString() {
		...
		sb.append(",REGISTRATION_MODE="+REGISTRATION_MODE);
		sb.append(",STEP="+STEP);
		sb.append(",URL="+URL);
		sb.append(",VIEW_DATE="+String.valueOf(VIEW_DATE));
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(long SESSION_ID){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c2(String REGISTRATION_MODE){
							this.REGISTRATION_MODE = REGISTRATION_MODE;
							return this;
						}				
						String STEP;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String STEP){
							this.STEP = STEP;
							return this;
						}				
						String URL;
						
	            		public BufferLine_tRedshiftOutput_1 c4(String URL){
							this.URL = URL;
							return this;
						}				
						java.util.Date VIEW_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(java.util.Date VIEW_DATE){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"SESSION_ID\",\"USER_ID\",\"REGISTRATION_MODE\",\"STEP\",\"URL\",\"VIEW_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.SESSION_ID = 0;
					
							Row_FeedRecord.USER_ID = null;
					
							Row_FeedRecord.REGISTRATION_MODE = null;
					
							Row_FeedRecord.STEP = null;
					
							Row_FeedRecord.URL = null;
					
							Row_FeedRecord.VIEW_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.SESSION_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'SESSION_ID' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.REGISTRATION_MODE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.STEP = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.URL = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.VIEW_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
...
Record_OutputToDB.SESSION_ID = Row_FeedRecord.SESSION_ID;
Record_OutputToDB.USER_ID = Row_FeedRecord.USER_ID;
Record_OutputToDB.REGISTRATION_MODE = StringUtils.trimToNull(Row_FeedRecord.REGISTRATION_MODE);
Record_OutputToDB.STEP = StringUtils.trimToNull(Row_FeedRecord.STEP);
Record_OutputToDB.URL = StringUtils.trimToNull(Row_FeedRecord.URL);
Record_OutputToDB.VIEW_DATE = Row_FeedRecord.VIEW_DATE;
    nb_line_tJavaRow_2++;   
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.SESSION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.REGISTRATION_MODE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.REGISTRATION_MODE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.STEP==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.STEP);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.URL==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.URL);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.SESSION_ID)
                        .c1(Record_OutputToDB.USER_ID)
                        .c2(Record_OutputToDB.REGISTRATION_MODE)
                        .c3(Record_OutputToDB.STEP)
                        .c4(Record_OutputToDB.URL)
                        .c5(Record_OutputToDB.VIEW_DATE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.SESSION_ID = Record_OutputToDB.SESSION_ID;
                                After_Insert.USER_ID = Record_OutputToDB.USER_ID;
                                After_Insert.REGISTRATION_MODE = Record_OutputToDB.REGISTRATION_MODE;
                                After_Insert.STEP = Record_OutputToDB.STEP;
                                After_Insert.URL = Record_OutputToDB.URL;
                                After_Insert.VIEW_DATE = Record_OutputToDB.VIEW_DATE;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.SESSION_ID = After_Insert.SESSION_ID;
               Log_Rows.USER_ID = After_Insert.USER_ID;
               Log_Rows.REGISTRATION_MODE = After_Insert.REGISTRATION_MODE;
               Log_Rows.STEP = After_Insert.STEP;
               Log_Rows.URL = After_Insert.URL;
               Log_Rows.VIEW_DATE = After_Insert.VIEW_DATE;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"SESSION_ID\",\"USER_ID\",\"REGISTRATION_MODE\",\"STEP\",\"URL\",\"VIEW_DATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SESSION_ID);
					...
					if(bufferLtRedshiftOutput_1.REGISTRATION_MODE==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.REGISTRATION_MODE);
					...
					if(bufferLtRedshiftOutput_1.STEP==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.STEP);
					...
					if(bufferLtRedshiftOutput_1.URL==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.URL);
					...
					if(bufferLtRedshiftOutput_1.VIEW_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.VIEW_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.SESSION_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'SESSION_ID' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.REGISTRATION_MODE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.STEP = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.VIEW_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.SESSION_ID = row1.SESSION_ID;
row2.USER_ID = row1.USER_ID;
row2.REGISTRATION_MODE = StringUtils.trimToNull(row1.REGISTRATION_MODE);
row2.STEP = StringUtils.trimToNull(row1.STEP);
row2.URL = StringUtils.trimToNull(row1.URL);
row2.VIEW_DATE = row1.VIEW_DATE;
    nb_line_tJavaRow_3++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[6];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.SESSION_ID);
                            rowtFileOutputDelimited_1[1]=row2.USER_ID == null ? null : String.valueOf(row2.USER_ID);
                            rowtFileOutputDelimited_1[2]=row2.REGISTRATION_MODE == null ? null : row2.REGISTRATION_MODE;
                            rowtFileOutputDelimited_1[3]=row2.STEP == null ? null : row2.STEP;
                            rowtFileOutputDelimited_1[4]=row2.URL == null ? null : row2.URL;
                            rowtFileOutputDelimited_1[5]=row2.VIEW_DATE == null ? null : FormatterUtils.format_Date(row2.VIEW_DATE, FeedFile.DF_DATETIME);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_RegistrationSessionHistories StageFeed_RegistrationSessionHistoriesClass = new StageFeed_RegistrationSessionHistories();

        int exitCode = StageFeed_RegistrationSessionHistoriesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_RegistrationSessionHistories.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_registrationsessionhistories_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_RegistrationSessionHistories");
        }
...
/************************************************************************************************
 *     312290 characters generated by Talend Open Studio for Data Integration 
