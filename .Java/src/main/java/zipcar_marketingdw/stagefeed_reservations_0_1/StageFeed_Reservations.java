...
package zipcar_marketingdw.stagefeed_reservations_0_1;
...
/**
 * Job: StageFeed_Reservations Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Reservations implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Reservations";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_VWr6IMeJEeaNnPzz-LXA-g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Reservations.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Reservations.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Reservations = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Reservations) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.RESERVATIONS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.RESERVATIONS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.RESERVATIONS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Reservations = new byte[0];
			    ...
			    public Long ORIGINAL_RESERVATION_ID;

				public Long getORIGINAL_RESERVATION_ID () {
					return this.ORIGINAL_RESERVATION_ID;
				}
			    ...
			    public Double UP_REVENUE;

				public Double getUP_REVENUE () {
					return this.UP_REVENUE;
				}
			    ...
			    public Double BUNDLE_CHARGE;

				public Double getBUNDLE_CHARGE () {
					return this.BUNDLE_CHARGE;
				}
				
			    public Double CREDITS_UNCONVERTED_REV;

				public Double getCREDITS_UNCONVERTED_REV () {
					return this.CREDITS_UNCONVERTED_REV;
				}
				...
				public String getDISTANCE_MEASURE () {
					return this.DISTANCE_MEASURE;
				}
				
			    public Double HOURLY_CHARGE;

				public Double getHOURLY_CHARGE () {
					return this.HOURLY_CHARGE;
				}
				
			    public String LATE_RETURNS_P;

				public String getLATE_RETURNS_P () {
					return this.LATE_RETURNS_P;
				}
				
			    public Double MILEAGE_CHARGE;

				public Double getMILEAGE_CHARGE () {
					return this.MILEAGE_CHARGE;
				}
				
			    public String NOBILL_P;

				public String getNOBILL_P () {
					return this.NOBILL_P;
				}
				
			    public String OVERNIGHTER_P;

				public String getOVERNIGHTER_P () {
					return this.OVERNIGHTER_P;
				}
				
			    public java.util.Date SWIPED_OUT_DATE;

				public java.util.Date getSWIPED_OUT_DATE () {
					return this.SWIPED_OUT_DATE;
				}
			    ...
			    public String REDEEM_VOUCHERS_P;

				public String getREDEEM_VOUCHERS_P () {
					return this.REDEEM_VOUCHERS_P;
				}
			    ...
			    public java.util.Date SWIPED_IN_DATE;

				public java.util.Date getSWIPED_IN_DATE () {
					return this.SWIPED_IN_DATE;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CANCEL_DATE = readDate(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.TOTAL_HOURS = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.END_LOCATION_ID = null;
           				} else {
           			    	this.END_LOCATION_ID = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.VEHICLE_ID = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.ORIGINAL_RESERVATION_ID = null;
           				} else {
           			    	this.ORIGINAL_RESERVATION_ID = dis.readLong();
           				}
					...
					this.LAST_MODIFIED = readDate(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.TOTAL_DISTANCE = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.TOTAL_CHARGE = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.TOTAL_PAYMENT = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.UP_REVENUE = null;
           				} else {
           			    	this.UP_REVENUE = dis.readDouble();
           				}
					...
					this.TYPE = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.BUNDLE_CHARGE = null;
           				} else {
           			    	this.BUNDLE_CHARGE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.CREDITS_UNCONVERTED_REV = null;
           				} else {
           			    	this.CREDITS_UNCONVERTED_REV = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.DAILY_CHARGE = null;
           				} else {
           			    	this.DAILY_CHARGE = dis.readDouble();
           				}
					
					this.DISTANCE_MEASURE = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.HOURLY_CHARGE = null;
           				} else {
           			    	this.HOURLY_CHARGE = dis.readDouble();
           				}
					
					this.LATE_RETURNS_P = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.MILEAGE_CHARGE = null;
           				} else {
           			    	this.MILEAGE_CHARGE = dis.readDouble();
           				}
					
					this.NOBILL_P = readString(dis);
					
					this.OVERNIGHTER_P = readString(dis);
					
					this.SWIPED_OUT_DATE = readDate(dis);
					...
					this.REDEEM_VOUCHERS_P = readString(dis);
					
					this.SOURCE = readString(dis);
					
					this.SWIPED_IN_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Double
						...
						if(this.TOTAL_HOURS == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.TOTAL_HOURS);
		            	}
					...
					// Long
						...
						if(this.END_LOCATION_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.END_LOCATION_ID);
		            	}
					...
					// Long
						...
						if(this.VEHICLE_ID == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeLong(this.VEHICLE_ID);
		            	}
					
					// Long
				
						if(this.ORIGINAL_RESERVATION_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.ORIGINAL_RESERVATION_ID);
		            	}
					...
					// Double
						...
						if(this.TOTAL_DISTANCE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.TOTAL_DISTANCE);
		            	}
					...
					// Double
						...
						if(this.TOTAL_CHARGE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.TOTAL_CHARGE);
		            	}
					...
					// Double
						...
						if(this.TOTAL_PAYMENT == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.TOTAL_PAYMENT);
		            	}
					
					// Double
				
						if(this.UP_REVENUE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.UP_REVENUE);
		            	}
					...
					// Double
						...
						if(this.BUNDLE_CHARGE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.BUNDLE_CHARGE);
		            	}
					
					// Double
				
						if(this.CREDITS_UNCONVERTED_REV == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.CREDITS_UNCONVERTED_REV);
		            	}
					
					// Double
				
						if(this.DAILY_CHARGE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.DAILY_CHARGE);
		            	}
					
					// String
				
						writeString(this.DISTANCE_MEASURE,dos);
					
					// Double
				
						if(this.HOURLY_CHARGE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.HOURLY_CHARGE);
		            	}
					
					// String
				
						writeString(this.LATE_RETURNS_P,dos);
					
					// Double
				
						if(this.MILEAGE_CHARGE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.MILEAGE_CHARGE);
		            	}
					
					// String
				
						writeString(this.NOBILL_P,dos);
					
					// String
				
						writeString(this.OVERNIGHTER_P,dos);
					
					// java.util.Date
				
						writeDate(this.SWIPED_OUT_DATE,dos);
					...
					// String
						...
						writeString(this.REDEEM_VOUCHERS_P,dos);
					...
					// java.util.Date
						...
						writeDate(this.SWIPED_IN_DATE,dos);
    ...
    public String toString() {
		...
		sb.append(",TOTAL_HOURS="+String.valueOf(TOTAL_HOURS));
		sb.append(",LOCATION_ID="+String.valueOf(LOCATION_ID));
		sb.append(",END_LOCATION_ID="+String.valueOf(END_LOCATION_ID));
		sb.append(",VEHICLE_ID="+String.valueOf(VEHICLE_ID));
		sb.append(",ORIGINAL_RESERVATION_ID="+String.valueOf(ORIGINAL_RESERVATION_ID));
		sb.append(",CREATION_DATE="+String.valueOf(CREATION_DATE));
		sb.append(",LAST_MODIFIED="+String.valueOf(LAST_MODIFIED));
		sb.append(",TOTAL_DISTANCE="+String.valueOf(TOTAL_DISTANCE));
		sb.append(",TOTAL_CHARGE="+String.valueOf(TOTAL_CHARGE));
		sb.append(",TOTAL_PAYMENT="+String.valueOf(TOTAL_PAYMENT));
		sb.append(",UP_REVENUE="+String.valueOf(UP_REVENUE));
		sb.append(",CURRENCY_ISO="+CURRENCY_ISO);
		sb.append(",TYPE="+TYPE);
		sb.append(",RATE_PLAN_ID="+String.valueOf(RATE_PLAN_ID));
		sb.append(",BUNDLE_CHARGE="+String.valueOf(BUNDLE_CHARGE));
		sb.append(",CREDITS_UNCONVERTED_REV="+String.valueOf(CREDITS_UNCONVERTED_REV));
		sb.append(",DAILY_CHARGE="+String.valueOf(DAILY_CHARGE));
		sb.append(",DISTANCE_MEASURE="+DISTANCE_MEASURE);
		sb.append(",HOURLY_CHARGE="+String.valueOf(HOURLY_CHARGE));
		sb.append(",LATE_RETURNS_P="+LATE_RETURNS_P);
		sb.append(",MILEAGE_CHARGE="+String.valueOf(MILEAGE_CHARGE));
		sb.append(",NOBILL_P="+NOBILL_P);
		sb.append(",OVERNIGHTER_P="+OVERNIGHTER_P);
		sb.append(",SWIPED_OUT_DATE="+String.valueOf(SWIPED_OUT_DATE));
		...
		sb.append(",REDEEM_VOUCHERS_P="+REDEEM_VOUCHERS_P);
		sb.append(",SOURCE="+SOURCE);
		sb.append(",SWIPED_IN_DATE="+String.valueOf(SWIPED_IN_DATE));
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(Long RESERVATION_ID){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c2(Long DRIVER_ID){
							this.DRIVER_ID = DRIVER_ID;
							return this;
						}				
						java.util.Date START_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c3(java.util.Date START_DATE){
							this.START_DATE = START_DATE;
							return this;
						}				
						java.util.Date END_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(java.util.Date END_DATE){
							this.END_DATE = END_DATE;
							return this;
						}				
						java.util.Date CANCEL_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(java.util.Date CANCEL_DATE){
							this.CANCEL_DATE = CANCEL_DATE;
							return this;
						}				
						Double TOTAL_HOURS;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Double TOTAL_HOURS){
							this.TOTAL_HOURS = TOTAL_HOURS;
							return this;
						}				
						Long LOCATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c7(Long LOCATION_ID){
							this.LOCATION_ID = LOCATION_ID;
							return this;
						}				
						Long END_LOCATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Long END_LOCATION_ID){
							this.END_LOCATION_ID = END_LOCATION_ID;
							return this;
						}				
						Long VEHICLE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c9(Long VEHICLE_ID){
							this.VEHICLE_ID = VEHICLE_ID;
							return this;
						}				
						Long ORIGINAL_RESERVATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Long ORIGINAL_RESERVATION_ID){
							this.ORIGINAL_RESERVATION_ID = ORIGINAL_RESERVATION_ID;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c11(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c12(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						Double TOTAL_DISTANCE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(Double TOTAL_DISTANCE){
							this.TOTAL_DISTANCE = TOTAL_DISTANCE;
							return this;
						}				
						Double TOTAL_CHARGE;
						
	            		public BufferLine_tRedshiftOutput_1 c14(Double TOTAL_CHARGE){
							this.TOTAL_CHARGE = TOTAL_CHARGE;
							return this;
						}				
						Double TOTAL_PAYMENT;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Double TOTAL_PAYMENT){
							this.TOTAL_PAYMENT = TOTAL_PAYMENT;
							return this;
						}				
						Double UP_REVENUE;
						
	            		public BufferLine_tRedshiftOutput_1 c16(Double UP_REVENUE){
							this.UP_REVENUE = UP_REVENUE;
							return this;
						}				
						String CURRENCY_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String CURRENCY_ISO){
							this.CURRENCY_ISO = CURRENCY_ISO;
							return this;
						}				
						String TYPE;
						
	            		public BufferLine_tRedshiftOutput_1 c18(String TYPE){
							this.TYPE = TYPE;
							return this;
						}				
						Long RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c19(Long RATE_PLAN_ID){
							this.RATE_PLAN_ID = RATE_PLAN_ID;
							return this;
						}				
						Double BUNDLE_CHARGE;
						
	            		public BufferLine_tRedshiftOutput_1 c20(Double BUNDLE_CHARGE){
							this.BUNDLE_CHARGE = BUNDLE_CHARGE;
							return this;
						}				
						Double CREDITS_UNCONVERTED_REV;
						
	            		public BufferLine_tRedshiftOutput_1 c21(Double CREDITS_UNCONVERTED_REV){
							this.CREDITS_UNCONVERTED_REV = CREDITS_UNCONVERTED_REV;
							return this;
						}				
						Double DAILY_CHARGE;
						
	            		public BufferLine_tRedshiftOutput_1 c22(Double DAILY_CHARGE){
							this.DAILY_CHARGE = DAILY_CHARGE;
							return this;
						}				
						String DISTANCE_MEASURE;
						
	            		public BufferLine_tRedshiftOutput_1 c23(String DISTANCE_MEASURE){
							this.DISTANCE_MEASURE = DISTANCE_MEASURE;
							return this;
						}				
						Double HOURLY_CHARGE;
						
	            		public BufferLine_tRedshiftOutput_1 c24(Double HOURLY_CHARGE){
							this.HOURLY_CHARGE = HOURLY_CHARGE;
							return this;
						}				
						String LATE_RETURNS_P;
						
	            		public BufferLine_tRedshiftOutput_1 c25(String LATE_RETURNS_P){
							this.LATE_RETURNS_P = LATE_RETURNS_P;
							return this;
						}				
						Double MILEAGE_CHARGE;
						
	            		public BufferLine_tRedshiftOutput_1 c26(Double MILEAGE_CHARGE){
							this.MILEAGE_CHARGE = MILEAGE_CHARGE;
							return this;
						}				
						String NOBILL_P;
						
	            		public BufferLine_tRedshiftOutput_1 c27(String NOBILL_P){
							this.NOBILL_P = NOBILL_P;
							return this;
						}				
						String OVERNIGHTER_P;
						
	            		public BufferLine_tRedshiftOutput_1 c28(String OVERNIGHTER_P){
							this.OVERNIGHTER_P = OVERNIGHTER_P;
							return this;
						}				
						java.util.Date SWIPED_OUT_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c29(java.util.Date SWIPED_OUT_DATE){
							this.SWIPED_OUT_DATE = SWIPED_OUT_DATE;
							return this;
						}				
						String VEHICLE_CLASS;
						
	            		public BufferLine_tRedshiftOutput_1 c30(String VEHICLE_CLASS){
							this.VEHICLE_CLASS = VEHICLE_CLASS;
							return this;
						}				
						Long ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c31(Long ZIPFLEET_ID){
							this.ZIPFLEET_ID = ZIPFLEET_ID;
							return this;
						}				
						Long AFFILIATE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c32(Long AFFILIATE_ID){
							this.AFFILIATE_ID = AFFILIATE_ID;
							return this;
						}				
						String REDEEM_VOUCHERS_P;
						
	            		public BufferLine_tRedshiftOutput_1 c33(String REDEEM_VOUCHERS_P){
							this.REDEEM_VOUCHERS_P = REDEEM_VOUCHERS_P;
							return this;
						}				
						String SOURCE;
						
	            		public BufferLine_tRedshiftOutput_1 c34(String SOURCE){
							this.SOURCE = SOURCE;
							return this;
						}				
						java.util.Date SWIPED_IN_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c35(java.util.Date SWIPED_IN_DATE){
							this.SWIPED_IN_DATE = SWIPED_IN_DATE;
							return this;
						}				
						Long WAIVER_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c36(Long WAIVER_PLAN_ID){
			...
			for(int i_tRedshiftOutput_1=0;i_tRedshiftOutput_1 < 800;i_tRedshiftOutput_1++){
				 extendInsertValueStmt_tRedshiftOutput_1.append("(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				 if (i_tRedshiftOutput_1!=800-1) extendInsertValueStmt_tRedshiftOutput_1.append(",");
			}

			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"RESERVATION_ID\",\"ACCOUNT_ID\",\"DRIVER_ID\",\"START_DATE\",\"END_DATE\",\"CANCEL_DATE\",\"TOTAL_HOURS\",\"LOCATION_ID\",\"END_LOCATION_ID\",\"VEHICLE_ID\",\"ORIGINAL_RESERVATION_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"TOTAL_DISTANCE\",\"TOTAL_CHARGE\",\"TOTAL_PAYMENT\",\"UP_REVENUE\",\"CURRENCY_ISO\",\"TYPE\",\"RATE_PLAN_ID\",\"BUNDLE_CHARGE\",\"CREDITS_UNCONVERTED_REV\",\"DAILY_CHARGE\",\"DISTANCE_MEASURE\",\"HOURLY_CHARGE\",\"LATE_RETURNS_P\",\"MILEAGE_CHARGE\",\"NOBILL_P\",\"OVERNIGHTER_P\",\"SWIPED_OUT_DATE\",\"VEHICLE_CLASS\",\"ZIPFLEET_ID\",\"AFFILIATE_ID\",\"REDEEM_VOUCHERS_P\",\"SOURCE\",\"SWIPED_IN_DATE\",\"WAIVER_PLAN_ID\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.TOTAL_HOURS = null;
					
							Row_FeedRecord.LOCATION_ID = null;
					
							Row_FeedRecord.END_LOCATION_ID = null;
					
							Row_FeedRecord.VEHICLE_ID = null;
					
							Row_FeedRecord.ORIGINAL_RESERVATION_ID = null;
					
							Row_FeedRecord.CREATION_DATE = null;
					
							Row_FeedRecord.LAST_MODIFIED = null;
					
							Row_FeedRecord.TOTAL_DISTANCE = null;
					
							Row_FeedRecord.TOTAL_CHARGE = null;
					
							Row_FeedRecord.TOTAL_PAYMENT = null;
					
							Row_FeedRecord.UP_REVENUE = null;
					
							Row_FeedRecord.CURRENCY_ISO = null;
					
							Row_FeedRecord.TYPE = null;
					
							Row_FeedRecord.RATE_PLAN_ID = null;
					
							Row_FeedRecord.BUNDLE_CHARGE = null;
					
							Row_FeedRecord.CREDITS_UNCONVERTED_REV = null;
					
							Row_FeedRecord.DAILY_CHARGE = null;
					
							Row_FeedRecord.DISTANCE_MEASURE = null;
					
							Row_FeedRecord.HOURLY_CHARGE = null;
					
							Row_FeedRecord.LATE_RETURNS_P = null;
					
							Row_FeedRecord.MILEAGE_CHARGE = null;
					
							Row_FeedRecord.NOBILL_P = null;
					
							Row_FeedRecord.OVERNIGHTER_P = null;
					
							Row_FeedRecord.SWIPED_OUT_DATE = null;
					
							Row_FeedRecord.VEHICLE_CLASS = null;
					
							Row_FeedRecord.ZIPFLEET_ID = null;
					
							Row_FeedRecord.AFFILIATE_ID = null;
					
							Row_FeedRecord.REDEEM_VOUCHERS_P = null;
					
							Row_FeedRecord.SOURCE = null;
					
							Row_FeedRecord.SWIPED_IN_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.DRIVER_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.TOTAL_HOURS = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.END_LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.VEHICLE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ORIGINAL_RESERVATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.TOTAL_DISTANCE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.TOTAL_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.TOTAL_PAYMENT = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.UP_REVENUE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.TYPE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.BUNDLE_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.CREDITS_UNCONVERTED_REV = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.DAILY_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.DISTANCE_MEASURE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.HOURLY_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LATE_RETURNS_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.MILEAGE_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.NOBILL_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.OVERNIGHTER_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SWIPED_OUT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.VEHICLE_CLASS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.AFFILIATE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.REDEEM_VOUCHERS_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SOURCE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.SWIPED_IN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
...
Record_OutputToDB.DRIVER_ID = Row_FeedRecord.DRIVER_ID;
...
Record_OutputToDB.TOTAL_HOURS = Row_FeedRecord.TOTAL_HOURS;
Record_OutputToDB.LOCATION_ID = Row_FeedRecord.LOCATION_ID;
Record_OutputToDB.END_LOCATION_ID = Row_FeedRecord.END_LOCATION_ID;
Record_OutputToDB.VEHICLE_ID = Row_FeedRecord.VEHICLE_ID;
Record_OutputToDB.ORIGINAL_RESERVATION_ID = Row_FeedRecord.ORIGINAL_RESERVATION_ID;
Record_OutputToDB.CREATION_DATE = Row_FeedRecord.CREATION_DATE;
Record_OutputToDB.LAST_MODIFIED = Row_FeedRecord.LAST_MODIFIED;
Record_OutputToDB.TOTAL_DISTANCE = Row_FeedRecord.TOTAL_DISTANCE;
Record_OutputToDB.TOTAL_CHARGE = Row_FeedRecord.TOTAL_CHARGE;
Record_OutputToDB.TOTAL_PAYMENT = Row_FeedRecord.TOTAL_PAYMENT;
Record_OutputToDB.UP_REVENUE = Row_FeedRecord.UP_REVENUE;
Record_OutputToDB.CURRENCY_ISO = StringUtils.trimToNull(Row_FeedRecord.CURRENCY_ISO);
Record_OutputToDB.TYPE = StringUtils.trimToNull(Row_FeedRecord.TYPE);
Record_OutputToDB.RATE_PLAN_ID = Row_FeedRecord.RATE_PLAN_ID;
Record_OutputToDB.BUNDLE_CHARGE = Row_FeedRecord.BUNDLE_CHARGE;
Record_OutputToDB.CREDITS_UNCONVERTED_REV = Row_FeedRecord.CREDITS_UNCONVERTED_REV;
Record_OutputToDB.DAILY_CHARGE = Row_FeedRecord.DAILY_CHARGE;
Record_OutputToDB.DISTANCE_MEASURE = StringUtils.trimToNull(Row_FeedRecord.DISTANCE_MEASURE);
Record_OutputToDB.HOURLY_CHARGE = Row_FeedRecord.HOURLY_CHARGE;
Record_OutputToDB.LATE_RETURNS_P = BooleanUtils.boolChar(Row_FeedRecord.LATE_RETURNS_P);
Record_OutputToDB.MILEAGE_CHARGE = Row_FeedRecord.MILEAGE_CHARGE;
Record_OutputToDB.NOBILL_P = BooleanUtils.boolChar(Row_FeedRecord.NOBILL_P);
Record_OutputToDB.OVERNIGHTER_P = BooleanUtils.boolChar(Row_FeedRecord.OVERNIGHTER_P);
Record_OutputToDB.SWIPED_OUT_DATE = Row_FeedRecord.SWIPED_OUT_DATE;
Record_OutputToDB.VEHICLE_CLASS = StringUtils.trimToNull(Row_FeedRecord.VEHICLE_CLASS);
Record_OutputToDB.ZIPFLEET_ID = Row_FeedRecord.ZIPFLEET_ID;
Record_OutputToDB.AFFILIATE_ID = Row_FeedRecord.AFFILIATE_ID;
Record_OutputToDB.REDEEM_VOUCHERS_P = BooleanUtils.boolChar(Row_FeedRecord.REDEEM_VOUCHERS_P);
Record_OutputToDB.SOURCE = StringUtils.trimToNull(Row_FeedRecord.SOURCE);
Record_OutputToDB.SWIPED_IN_DATE = Row_FeedRecord.SWIPED_IN_DATE;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DRIVER_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.DRIVER_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TOTAL_HOURS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.TOTAL_HOURS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LOCATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.LOCATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.END_LOCATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.END_LOCATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.VEHICLE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.VEHICLE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ORIGINAL_RESERVATION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ORIGINAL_RESERVATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TOTAL_DISTANCE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.TOTAL_DISTANCE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TOTAL_CHARGE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.TOTAL_CHARGE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TOTAL_PAYMENT==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.TOTAL_PAYMENT);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.UP_REVENUE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.UP_REVENUE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TYPE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.TYPE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RATE_PLAN_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.RATE_PLAN_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.BUNDLE_CHARGE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.BUNDLE_CHARGE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.CREDITS_UNCONVERTED_REV==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.CREDITS_UNCONVERTED_REV);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DAILY_CHARGE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.DAILY_CHARGE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.DISTANCE_MEASURE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.DISTANCE_MEASURE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.HOURLY_CHARGE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.HOURLY_CHARGE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LATE_RETURNS_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LATE_RETURNS_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.MILEAGE_CHARGE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.MILEAGE_CHARGE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.NOBILL_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.NOBILL_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.OVERNIGHTER_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.OVERNIGHTER_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SWIPED_OUT_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SWIPED_OUT_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.VEHICLE_CLASS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.VEHICLE_CLASS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.AFFILIATE_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.AFFILIATE_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.REDEEM_VOUCHERS_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.REDEEM_VOUCHERS_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SOURCE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SOURCE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SWIPED_IN_DATE!=null){
								// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
								date_tRedshiftOutput_1 = Record_OutputToDB.SWIPED_IN_DATE.getTime();
								if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
									pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1, "0000-00-00 00:00:00");
								} else {
									pstmt_tRedshiftOutput_1.setTimestamp(countertRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.RESERVATION_ID)
                        .c1(Record_OutputToDB.ACCOUNT_ID)
                        .c2(Record_OutputToDB.DRIVER_ID)
                        .c3(Record_OutputToDB.START_DATE)
                        .c4(Record_OutputToDB.END_DATE)
                        .c5(Record_OutputToDB.CANCEL_DATE)
                        .c6(Record_OutputToDB.TOTAL_HOURS)
                        .c7(Record_OutputToDB.LOCATION_ID)
                        .c8(Record_OutputToDB.END_LOCATION_ID)
                        .c9(Record_OutputToDB.VEHICLE_ID)
                        .c10(Record_OutputToDB.ORIGINAL_RESERVATION_ID)
                        .c11(Record_OutputToDB.CREATION_DATE)
                        .c12(Record_OutputToDB.LAST_MODIFIED)
                        .c13(Record_OutputToDB.TOTAL_DISTANCE)
                        .c14(Record_OutputToDB.TOTAL_CHARGE)
                        .c15(Record_OutputToDB.TOTAL_PAYMENT)
                        .c16(Record_OutputToDB.UP_REVENUE)
                        .c17(Record_OutputToDB.CURRENCY_ISO)
                        .c18(Record_OutputToDB.TYPE)
                        .c19(Record_OutputToDB.RATE_PLAN_ID)
                        .c20(Record_OutputToDB.BUNDLE_CHARGE)
                        .c21(Record_OutputToDB.CREDITS_UNCONVERTED_REV)
                        .c22(Record_OutputToDB.DAILY_CHARGE)
                        .c23(Record_OutputToDB.DISTANCE_MEASURE)
                        .c24(Record_OutputToDB.HOURLY_CHARGE)
                        .c25(Record_OutputToDB.LATE_RETURNS_P)
                        .c26(Record_OutputToDB.MILEAGE_CHARGE)
                        .c27(Record_OutputToDB.NOBILL_P)
                        .c28(Record_OutputToDB.OVERNIGHTER_P)
                        .c29(Record_OutputToDB.SWIPED_OUT_DATE)
                        .c30(Record_OutputToDB.VEHICLE_CLASS)
                        .c31(Record_OutputToDB.ZIPFLEET_ID)
                        .c32(Record_OutputToDB.AFFILIATE_ID)
                        .c33(Record_OutputToDB.REDEEM_VOUCHERS_P)
                        .c34(Record_OutputToDB.SOURCE)
                        .c35(Record_OutputToDB.SWIPED_IN_DATE)
                        .c36(Record_OutputToDB.WAIVER_PLAN_ID)
				;
				...
				if(rowCounttRedshiftOutput_1 == 800){
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.DRIVER_ID = Record_OutputToDB.DRIVER_ID;
                                ...
                                After_Insert.TOTAL_HOURS = Record_OutputToDB.TOTAL_HOURS;
                                After_Insert.LOCATION_ID = Record_OutputToDB.LOCATION_ID;
                                After_Insert.END_LOCATION_ID = Record_OutputToDB.END_LOCATION_ID;
                                After_Insert.VEHICLE_ID = Record_OutputToDB.VEHICLE_ID;
                                After_Insert.ORIGINAL_RESERVATION_ID = Record_OutputToDB.ORIGINAL_RESERVATION_ID;
                                After_Insert.CREATION_DATE = Record_OutputToDB.CREATION_DATE;
                                After_Insert.LAST_MODIFIED = Record_OutputToDB.LAST_MODIFIED;
                                After_Insert.TOTAL_DISTANCE = Record_OutputToDB.TOTAL_DISTANCE;
                                After_Insert.TOTAL_CHARGE = Record_OutputToDB.TOTAL_CHARGE;
                                After_Insert.TOTAL_PAYMENT = Record_OutputToDB.TOTAL_PAYMENT;
                                After_Insert.UP_REVENUE = Record_OutputToDB.UP_REVENUE;
                                After_Insert.CURRENCY_ISO = Record_OutputToDB.CURRENCY_ISO;
                                After_Insert.TYPE = Record_OutputToDB.TYPE;
                                After_Insert.RATE_PLAN_ID = Record_OutputToDB.RATE_PLAN_ID;
                                After_Insert.BUNDLE_CHARGE = Record_OutputToDB.BUNDLE_CHARGE;
                                After_Insert.CREDITS_UNCONVERTED_REV = Record_OutputToDB.CREDITS_UNCONVERTED_REV;
                                After_Insert.DAILY_CHARGE = Record_OutputToDB.DAILY_CHARGE;
                                After_Insert.DISTANCE_MEASURE = Record_OutputToDB.DISTANCE_MEASURE;
                                After_Insert.HOURLY_CHARGE = Record_OutputToDB.HOURLY_CHARGE;
                                After_Insert.LATE_RETURNS_P = Record_OutputToDB.LATE_RETURNS_P;
                                After_Insert.MILEAGE_CHARGE = Record_OutputToDB.MILEAGE_CHARGE;
                                After_Insert.NOBILL_P = Record_OutputToDB.NOBILL_P;
                                After_Insert.OVERNIGHTER_P = Record_OutputToDB.OVERNIGHTER_P;
                                After_Insert.SWIPED_OUT_DATE = Record_OutputToDB.SWIPED_OUT_DATE;
                                After_Insert.VEHICLE_CLASS = Record_OutputToDB.VEHICLE_CLASS;
                                After_Insert.ZIPFLEET_ID = Record_OutputToDB.ZIPFLEET_ID;
                                After_Insert.AFFILIATE_ID = Record_OutputToDB.AFFILIATE_ID;
                                After_Insert.REDEEM_VOUCHERS_P = Record_OutputToDB.REDEEM_VOUCHERS_P;
                                After_Insert.SOURCE = Record_OutputToDB.SOURCE;
                                After_Insert.SWIPED_IN_DATE = Record_OutputToDB.SWIPED_IN_DATE;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.TOTAL_HOURS = After_Insert.TOTAL_HOURS;
               Log_Rows.LOCATION_ID = After_Insert.LOCATION_ID;
               Log_Rows.END_LOCATION_ID = After_Insert.END_LOCATION_ID;
               Log_Rows.VEHICLE_ID = After_Insert.VEHICLE_ID;
               Log_Rows.ORIGINAL_RESERVATION_ID = After_Insert.ORIGINAL_RESERVATION_ID;
               Log_Rows.CREATION_DATE = After_Insert.CREATION_DATE;
               Log_Rows.LAST_MODIFIED = After_Insert.LAST_MODIFIED;
               Log_Rows.TOTAL_DISTANCE = After_Insert.TOTAL_DISTANCE;
               Log_Rows.TOTAL_CHARGE = After_Insert.TOTAL_CHARGE;
               Log_Rows.TOTAL_PAYMENT = After_Insert.TOTAL_PAYMENT;
               Log_Rows.UP_REVENUE = After_Insert.UP_REVENUE;
               Log_Rows.CURRENCY_ISO = After_Insert.CURRENCY_ISO;
               Log_Rows.TYPE = After_Insert.TYPE;
               Log_Rows.RATE_PLAN_ID = After_Insert.RATE_PLAN_ID;
               Log_Rows.BUNDLE_CHARGE = After_Insert.BUNDLE_CHARGE;
               Log_Rows.CREDITS_UNCONVERTED_REV = After_Insert.CREDITS_UNCONVERTED_REV;
               Log_Rows.DAILY_CHARGE = After_Insert.DAILY_CHARGE;
               Log_Rows.DISTANCE_MEASURE = After_Insert.DISTANCE_MEASURE;
               Log_Rows.HOURLY_CHARGE = After_Insert.HOURLY_CHARGE;
               Log_Rows.LATE_RETURNS_P = After_Insert.LATE_RETURNS_P;
               Log_Rows.MILEAGE_CHARGE = After_Insert.MILEAGE_CHARGE;
               Log_Rows.NOBILL_P = After_Insert.NOBILL_P;
               Log_Rows.OVERNIGHTER_P = After_Insert.OVERNIGHTER_P;
               Log_Rows.SWIPED_OUT_DATE = After_Insert.SWIPED_OUT_DATE;
               Log_Rows.VEHICLE_CLASS = After_Insert.VEHICLE_CLASS;
               Log_Rows.ZIPFLEET_ID = After_Insert.ZIPFLEET_ID;
               Log_Rows.AFFILIATE_ID = After_Insert.AFFILIATE_ID;
               Log_Rows.REDEEM_VOUCHERS_P = After_Insert.REDEEM_VOUCHERS_P;
               Log_Rows.SOURCE = After_Insert.SOURCE;
               Log_Rows.SWIPED_IN_DATE = After_Insert.SWIPED_IN_DATE;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"RESERVATION_ID\",\"ACCOUNT_ID\",\"DRIVER_ID\",\"START_DATE\",\"END_DATE\",\"CANCEL_DATE\",\"TOTAL_HOURS\",\"LOCATION_ID\",\"END_LOCATION_ID\",\"VEHICLE_ID\",\"ORIGINAL_RESERVATION_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"TOTAL_DISTANCE\",\"TOTAL_CHARGE\",\"TOTAL_PAYMENT\",\"UP_REVENUE\",\"CURRENCY_ISO\",\"TYPE\",\"RATE_PLAN_ID\",\"BUNDLE_CHARGE\",\"CREDITS_UNCONVERTED_REV\",\"DAILY_CHARGE\",\"DISTANCE_MEASURE\",\"HOURLY_CHARGE\",\"LATE_RETURNS_P\",\"MILEAGE_CHARGE\",\"NOBILL_P\",\"OVERNIGHTER_P\",\"SWIPED_OUT_DATE\",\"VEHICLE_CLASS\",\"ZIPFLEET_ID\",\"AFFILIATE_ID\",\"REDEEM_VOUCHERS_P\",\"SOURCE\",\"SWIPED_IN_DATE\",\"WAIVER_PLAN_ID\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.DRIVER_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DRIVER_ID);
					...
					if(bufferLtRedshiftOutput_1.TOTAL_HOURS==null){
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TOTAL_HOURS);
					...
					if(bufferLtRedshiftOutput_1.LOCATION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					if(bufferLtRedshiftOutput_1.END_LOCATION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.END_LOCATION_ID);
					...
					if(bufferLtRedshiftOutput_1.VEHICLE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.VEHICLE_ID);
					...
					if(bufferLtRedshiftOutput_1.ORIGINAL_RESERVATION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ORIGINAL_RESERVATION_ID);
					...
					if(bufferLtRedshiftOutput_1.TOTAL_DISTANCE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TOTAL_DISTANCE);
					...
					if(bufferLtRedshiftOutput_1.TOTAL_CHARGE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TOTAL_CHARGE);
					...
					if(bufferLtRedshiftOutput_1.TOTAL_PAYMENT==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TOTAL_PAYMENT);
					...
					if(bufferLtRedshiftOutput_1.UP_REVENUE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.UP_REVENUE);
					...
					if(bufferLtRedshiftOutput_1.TYPE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TYPE);
					...
					if(bufferLtRedshiftOutput_1.RATE_PLAN_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RATE_PLAN_ID);
					...
					if(bufferLtRedshiftOutput_1.BUNDLE_CHARGE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.BUNDLE_CHARGE);
					...
					if(bufferLtRedshiftOutput_1.CREDITS_UNCONVERTED_REV==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CREDITS_UNCONVERTED_REV);
					...
					if(bufferLtRedshiftOutput_1.DAILY_CHARGE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DAILY_CHARGE);
					...
					if(bufferLtRedshiftOutput_1.DISTANCE_MEASURE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.DISTANCE_MEASURE);
					...
					if(bufferLtRedshiftOutput_1.HOURLY_CHARGE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.HOURLY_CHARGE);
					...
					if(bufferLtRedshiftOutput_1.LATE_RETURNS_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LATE_RETURNS_P);
					...
					if(bufferLtRedshiftOutput_1.MILEAGE_CHARGE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.DOUBLE);
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.MILEAGE_CHARGE);
					...
					if(bufferLtRedshiftOutput_1.NOBILL_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.NOBILL_P);
					...
					if(bufferLtRedshiftOutput_1.OVERNIGHTER_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.OVERNIGHTER_P);
					...
					if(bufferLtRedshiftOutput_1.SWIPED_OUT_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SWIPED_OUT_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
					...
					if(bufferLtRedshiftOutput_1.VEHICLE_CLASS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.VEHICLE_CLASS);
					...
					if(bufferLtRedshiftOutput_1.AFFILIATE_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.AFFILIATE_ID);
					...
					if(bufferLtRedshiftOutput_1.REDEEM_VOUCHERS_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.REDEEM_VOUCHERS_P);
					...
					if(bufferLtRedshiftOutput_1.SOURCE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SOURCE);
					...
					if(bufferLtRedshiftOutput_1.SWIPED_IN_DATE!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.SWIPED_IN_DATE.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
							pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1, "0000-00-00 00:00:00");
						} else {
							pstmt_tRedshiftOutput_1.setTimestamp(counttRedshiftOutput_1, new java.sql.Timestamp(date_tRedshiftOutput_1));
...
String fileName_tFileOutputDelimited_1 = "";
    ...
    globalMap.put("tFileOutputDelimited_1_FILE_NAME",fileName_tFileOutputDelimited_1);
                String[] headColutFileOutputDelimited_1=new String[37];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.TOTAL_HOURS = null;
					
							row1.LOCATION_ID = null;
					
							row1.END_LOCATION_ID = null;
					
							row1.VEHICLE_ID = null;
					
							row1.ORIGINAL_RESERVATION_ID = null;
					
							row1.CREATION_DATE = null;
					
							row1.LAST_MODIFIED = null;
					
							row1.TOTAL_DISTANCE = null;
					
							row1.TOTAL_CHARGE = null;
					
							row1.TOTAL_PAYMENT = null;
					
							row1.UP_REVENUE = null;
					
							row1.CURRENCY_ISO = null;
					
							row1.TYPE = null;
					
							row1.RATE_PLAN_ID = null;
					
							row1.BUNDLE_CHARGE = null;
					
							row1.CREDITS_UNCONVERTED_REV = null;
					
							row1.DAILY_CHARGE = null;
					
							row1.DISTANCE_MEASURE = null;
					
							row1.HOURLY_CHARGE = null;
					
							row1.LATE_RETURNS_P = null;
					
							row1.MILEAGE_CHARGE = null;
					
							row1.NOBILL_P = null;
					
							row1.OVERNIGHTER_P = null;
					
							row1.SWIPED_OUT_DATE = null;
					
							row1.VEHICLE_CLASS = null;
					
							row1.ZIPFLEET_ID = null;
					
							row1.AFFILIATE_ID = null;
					
							row1.REDEEM_VOUCHERS_P = null;
					
							row1.SOURCE = null;
					
							row1.SWIPED_IN_DATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.TOTAL_HOURS = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.END_LOCATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.VEHICLE_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ORIGINAL_RESERVATION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.TOTAL_DISTANCE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.TOTAL_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.TOTAL_PAYMENT = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.UP_REVENUE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.TYPE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.RATE_PLAN_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.BUNDLE_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.CREDITS_UNCONVERTED_REV = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.DAILY_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.DISTANCE_MEASURE = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.HOURLY_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LATE_RETURNS_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.MILEAGE_CHARGE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.NOBILL_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.OVERNIGHTER_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SWIPED_OUT_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.VEHICLE_CLASS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.REDEEM_VOUCHERS_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.SWIPED_IN_DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
...
row2.TOTAL_HOURS = row1.TOTAL_HOURS;
row2.LOCATION_ID = row1.LOCATION_ID;
row2.END_LOCATION_ID = row1.END_LOCATION_ID;
row2.VEHICLE_ID = row1.VEHICLE_ID;
row2.ORIGINAL_RESERVATION_ID = row1.ORIGINAL_RESERVATION_ID;
row2.CREATION_DATE = row1.CREATION_DATE;
row2.LAST_MODIFIED = row1.LAST_MODIFIED;
row2.TOTAL_DISTANCE = row1.TOTAL_DISTANCE;
row2.TOTAL_CHARGE = row1.TOTAL_CHARGE;
row2.TOTAL_PAYMENT = row1.TOTAL_PAYMENT;
row2.UP_REVENUE = row1.UP_REVENUE;
row2.CURRENCY_ISO = StringUtils.trimToNull(row1.CURRENCY_ISO);
row2.TYPE = StringUtils.trimToNull(row1.TYPE);
row2.RATE_PLAN_ID = row1.RATE_PLAN_ID;
row2.BUNDLE_CHARGE = row1.BUNDLE_CHARGE;
row2.CREDITS_UNCONVERTED_REV = row1.CREDITS_UNCONVERTED_REV;
row2.DAILY_CHARGE = row1.DAILY_CHARGE;
row2.DISTANCE_MEASURE = StringUtils.trimToNull(row1.DISTANCE_MEASURE);
row2.HOURLY_CHARGE = row1.HOURLY_CHARGE;
row2.LATE_RETURNS_P = BooleanUtils.boolChar(row1.LATE_RETURNS_P);
row2.MILEAGE_CHARGE = row1.MILEAGE_CHARGE;
row2.NOBILL_P = BooleanUtils.boolChar(row1.NOBILL_P);
row2.OVERNIGHTER_P = BooleanUtils.boolChar(row1.OVERNIGHTER_P);
row2.SWIPED_OUT_DATE = row1.SWIPED_OUT_DATE;
row2.VEHICLE_CLASS = StringUtils.trimToNull(row1.VEHICLE_CLASS);
row2.ZIPFLEET_ID = row1.ZIPFLEET_ID;
row2.AFFILIATE_ID = row1.AFFILIATE_ID;
row2.REDEEM_VOUCHERS_P = BooleanUtils.boolChar(row1.REDEEM_VOUCHERS_P);
row2.SOURCE = StringUtils.trimToNull(row1.SOURCE);
row2.SWIPED_IN_DATE = row1.SWIPED_IN_DATE;
			...
			//row2
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[37];
                            rowtFileOutputDelimited_1[0]=row2.RESERVATION_ID == null ? null : String.valueOf(row2.RESERVATION_ID);
                            rowtFileOutputDelimited_1[1]=row2.ACCOUNT_ID == null ? null : String.valueOf(row2.ACCOUNT_ID);
                            rowtFileOutputDelimited_1[2]=row2.DRIVER_ID == null ? null : String.valueOf(row2.DRIVER_ID);
                            rowtFileOutputDelimited_1[3]=row2.START_DATE == null ? null : FormatterUtils.format_Date(row2.START_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[4]=row2.END_DATE == null ? null : FormatterUtils.format_Date(row2.END_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[5]=row2.CANCEL_DATE == null ? null : FormatterUtils.format_Date(row2.CANCEL_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[6]=row2.TOTAL_HOURS == null ? null : String.valueOf(row2.TOTAL_HOURS);
                            rowtFileOutputDelimited_1[7]=row2.LOCATION_ID == null ? null : String.valueOf(row2.LOCATION_ID);
                            rowtFileOutputDelimited_1[8]=row2.END_LOCATION_ID == null ? null : String.valueOf(row2.END_LOCATION_ID);
                            rowtFileOutputDelimited_1[9]=row2.VEHICLE_ID == null ? null : String.valueOf(row2.VEHICLE_ID);
                            rowtFileOutputDelimited_1[10]=row2.ORIGINAL_RESERVATION_ID == null ? null : String.valueOf(row2.ORIGINAL_RESERVATION_ID);
                            ...
                            rowtFileOutputDelimited_1[12]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[13]=row2.TOTAL_DISTANCE == null ? null : String.valueOf(row2.TOTAL_DISTANCE);
                            rowtFileOutputDelimited_1[14]=row2.TOTAL_CHARGE == null ? null : String.valueOf(row2.TOTAL_CHARGE);
                            rowtFileOutputDelimited_1[15]=row2.TOTAL_PAYMENT == null ? null : String.valueOf(row2.TOTAL_PAYMENT);
                            rowtFileOutputDelimited_1[16]=row2.UP_REVENUE == null ? null : String.valueOf(row2.UP_REVENUE);
                            rowtFileOutputDelimited_1[17]=row2.CURRENCY_ISO == null ? null : row2.CURRENCY_ISO;
                            rowtFileOutputDelimited_1[18]=row2.TYPE == null ? null : row2.TYPE;
                            rowtFileOutputDelimited_1[19]=row2.RATE_PLAN_ID == null ? null : String.valueOf(row2.RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[20]=row2.BUNDLE_CHARGE == null ? null : String.valueOf(row2.BUNDLE_CHARGE);
                            rowtFileOutputDelimited_1[21]=row2.CREDITS_UNCONVERTED_REV == null ? null : String.valueOf(row2.CREDITS_UNCONVERTED_REV);
                            rowtFileOutputDelimited_1[22]=row2.DAILY_CHARGE == null ? null : String.valueOf(row2.DAILY_CHARGE);
                            rowtFileOutputDelimited_1[23]=row2.DISTANCE_MEASURE == null ? null : row2.DISTANCE_MEASURE;
                            rowtFileOutputDelimited_1[24]=row2.HOURLY_CHARGE == null ? null : String.valueOf(row2.HOURLY_CHARGE);
                            rowtFileOutputDelimited_1[25]=row2.LATE_RETURNS_P == null ? null : row2.LATE_RETURNS_P;
                            rowtFileOutputDelimited_1[26]=row2.MILEAGE_CHARGE == null ? null : String.valueOf(row2.MILEAGE_CHARGE);
                            rowtFileOutputDelimited_1[27]=row2.NOBILL_P == null ? null : row2.NOBILL_P;
                            rowtFileOutputDelimited_1[28]=row2.OVERNIGHTER_P == null ? null : row2.OVERNIGHTER_P;
                            rowtFileOutputDelimited_1[29]=row2.SWIPED_OUT_DATE == null ? null : FormatterUtils.format_Date(row2.SWIPED_OUT_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[30]=row2.VEHICLE_CLASS == null ? null : row2.VEHICLE_CLASS;
                            rowtFileOutputDelimited_1[31]=row2.ZIPFLEET_ID == null ? null : String.valueOf(row2.ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[32]=row2.AFFILIATE_ID == null ? null : String.valueOf(row2.AFFILIATE_ID);
                            rowtFileOutputDelimited_1[33]=row2.REDEEM_VOUCHERS_P == null ? null : row2.REDEEM_VOUCHERS_P;
                            rowtFileOutputDelimited_1[34]=row2.SOURCE == null ? null : row2.SOURCE;
                            rowtFileOutputDelimited_1[35]=row2.SWIPED_IN_DATE == null ? null : FormatterUtils.format_Date(row2.SWIPED_IN_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[36]=row2.WAIVER_PLAN_ID == null ? null : String.valueOf(row2.WAIVER_PLAN_ID);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Reservations StageFeed_ReservationsClass = new StageFeed_Reservations();

        int exitCode = StageFeed_ReservationsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Reservations.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_reservations_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Reservations");
        }
...
/************************************************************************************************
 *     494422 characters generated by Talend Open Studio for Data Integration 
