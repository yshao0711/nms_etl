...
package zipcar_marketingdw.stagefeed_accountmembermap_0_1;
...
/**
 * Job: StageFeed_AccountMemberMap Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_AccountMemberMap implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_AccountMemberMap";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_WWOM4Md7EeaFYPxYNXDYYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_AccountMemberMap.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_AccountMemberMap.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_AccountMemberMap) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.ACCOUNT_MEMBER_MAP.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.ACCOUNT_MEMBER_MAP.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.ACCOUNT_MEMBER_MAP;
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c2(java.util.Date START_DATE){
							this.START_DATE = START_DATE;
							return this;
						}				
						String START_DATE_TZ;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String START_DATE_TZ){
	            		...
	            		public BufferLine_tRedshiftOutput_1 c5(String END_DATE_TZ){
							this.END_DATE_TZ = END_DATE_TZ;
							return this;
						}				
						String STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String STATUS){
							this.STATUS = STATUS;
							return this;
						}				
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ACCOUNT_ID\",\"MEMBER_ID\",\"START_DATE\",\"START_DATE_TZ\",\"END_DATE\",\"END_DATE_TZ\",\"STATUS\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.START_DATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.END_DATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.START_DATE = FeedFile.getDateTime(Row_FeedRecord.START_DATE);
Record_OutputToDB.START_DATE_TZ = FeedFile.getTimeZoneOffset(Row_FeedRecord.START_DATE);
Record_OutputToDB.END_DATE = FeedFile.getDateTime(Row_FeedRecord.END_DATE);
Record_OutputToDB.END_DATE_TZ = FeedFile.getTimeZoneOffset(Row_FeedRecord.END_DATE);
Record_OutputToDB.STATUS = StringUtils.trimToNull(Row_FeedRecord.STATUS);
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.START_DATE_TZ==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.START_DATE_TZ);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.END_DATE_TZ==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.END_DATE_TZ);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.STATUS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.STATUS);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c2(Record_OutputToDB.START_DATE)
                        .c3(Record_OutputToDB.START_DATE_TZ)
                        .c4(Record_OutputToDB.END_DATE)
                        .c5(Record_OutputToDB.END_DATE_TZ)
                        .c6(Record_OutputToDB.STATUS)
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.START_DATE_TZ = Record_OutputToDB.START_DATE_TZ;
                                After_Insert.END_DATE = Record_OutputToDB.END_DATE;
                                After_Insert.END_DATE_TZ = Record_OutputToDB.END_DATE_TZ;
                                After_Insert.STATUS = Record_OutputToDB.STATUS;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"ACCOUNT_ID\",\"MEMBER_ID\",\"START_DATE\",\"START_DATE_TZ\",\"END_DATE\",\"END_DATE_TZ\",\"STATUS\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[10];
                            ...
                            rowtFileOutputDelimited_1[1]=String.valueOf(row2.MEMBER_ID);
                            rowtFileOutputDelimited_1[2]=row2.START_DATE == null ? null : FormatterUtils.format_Date(row2.START_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[3]=row2.START_DATE_TZ == null ? null : row2.START_DATE_TZ;
                            rowtFileOutputDelimited_1[4]=row2.END_DATE == null ? null : FormatterUtils.format_Date(row2.END_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[5]=row2.END_DATE_TZ == null ? null : row2.END_DATE_TZ;
                            rowtFileOutputDelimited_1[6]=row2.STATUS == null ? null : row2.STATUS;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_AccountMemberMap StageFeed_AccountMemberMapClass = new StageFeed_AccountMemberMap();

        int exitCode = StageFeed_AccountMemberMapClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_AccountMemberMap.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_accountmembermap_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_AccountMemberMap");
        }
...
/************************************************************************************************
 *     330296 characters generated by Talend Open Studio for Data Integration 
