...
package zipcar_marketingdw.processstaging_registrationsessionhistories_0_1;
...
/**
 * Job: ProcessStaging_RegistrationSessionHistories Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_RegistrationSessionHistories implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_RegistrationSessionHistories";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Mz0T4Bf0EeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_RegistrationSessionHistories.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_RegistrationSessionHistories.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessionHistories) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "registration_session_histories";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_registration_session_history";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_registration_session_history\n(\n	session_id,\n	member_id,\n	registration_mode,\n	step,\n	url,\n	view_date,\n    imported_date\n)\nSELECT \n	session_id,\n	user_id as member_id,\n	registration_mode,\n	step,\n	url,\n	view_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.registration_session_histories\nMINUS\nSELECT \n	session_id,\n	member_id,\n	registration_mode,\n	step,\n	url,\n	view_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_registration_session_history\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".registration_session_histories";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_RegistrationSessionHistories ProcessStaging_RegistrationSessionHistoriesClass = new ProcessStaging_RegistrationSessionHistories();

        int exitCode = ProcessStaging_RegistrationSessionHistoriesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_RegistrationSessionHistories.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_registrationsessionhistories_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_RegistrationSessionHistories");
        }
...
/************************************************************************************************
 *     136316 characters generated by Talend Open Studio for Data Integration 
