...
package zipcar_marketingdw.processstaging_addresses_0_1;
...
/**
 * Job: ProcessStaging_Addresses Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Addresses implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Addresses";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_F2aAQAWcEeegZMdJV5SAAg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Addresses.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Addresses.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Addresses) {
...
"\nINSERT INTO {{marketing.schema}}.r_address\n(\n    address_id,\n    member_id,\n	account_id,\n    address_type,\n    latitude,\n    longitude,\n    postal_code,\n    region_name,\n    country_name,\n    creation_date,\n    last_modified,\n    deleted_date,\n	phone_number_one,\n	phone_number_two,\n	line_one,\n	line_two,\n	line_three,\n	line_four,\n	municipality_name,\n	preferred_p,\n	tract_id,\n	zone_id,\n    imported_date\n)\nWITH latest_addresses AS (\n   SELECT t1.*\n   FROM {{marketing.schema}}.r_address t1\n   LEFT JOIN {{marketing.schema}}.r_address t2\n   ON t1.address_id = t2.address_id\n   AND (\n      CASE WHEN t1.member_id IS NOT NULL and t2.member_id IS NOT NULL THEN\n        t1.member_id = t2.member_id\n      ELSE 1=1\n      END\n   )\n   AND (\n      CASE WHEN t1.account_id IS NOT NULL and t2.account_id IS NOT NULL THEN\n        t1.account_id = t2.account_id\n      ELSE 1=1\n      END\n   )\n   AND t1.imported_date < t2.imported_date\n   WHERE\n   t2.imported_date IS NULL\n)\nSELECT \n    address_id,\n    CASE WHEN (party_id in (select DISTINCT member_id from {{marketing.schema}}.vw_r_member)) THEN party_id\n    ELSE NULL\n    END AS member_id,\n    CASE WHEN (party_id in (select DISTINCT account_id from {{marketing.schema}}.vw_r_account)) THEN party_id\n    ELSE NULL\n    END AS account_id,\n    address_type,\n    latitude,\n    longitude,\n    postal_code,\n    region_name,\n    country_name,\n    creation_date,\n    last_modified,\n    deleted_date, \n	phone_number_one,\n	phone_number_two,\n	line_one,\n	line_two,\n	line_three,\n	line_four,\n	municipality_name,\n	preferred_p,\n	tract_id,\n	zone_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.addresses\nWHERE (\n	party_id IS NULL\n	OR party_id IN (SELECT DISTINCT member_id FROM {{marketing.schema}}.vw_r_member)\n	OR party_id IN (select DISTINCT account_id from {{marketing.schema}}.vw_r_account)\n)\nMINUS\nSELECT \n    address_id,\n    member_id,\n	account_id,\n    address_type,\n    latitude,\n    longitude,\n    postal_code,\n    region_name,\n    country_name,\n    creation_date,\n    last_modified,\n    deleted_date, \n	phone_number_one,\n	phone_number_two,\n	line_one,\n	line_two,\n	line_three,\n	line_four,\n	municipality_name,\n	preferred_p,\n	tract_id,\n	zone_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM latest_addresses\n;\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".addresses";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Addresses ProcessStaging_AddressesClass = new ProcessStaging_Addresses();

        int exitCode = ProcessStaging_AddressesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Addresses.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_addresses_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Addresses");
        }
...
/************************************************************************************************
 *     137498 characters generated by Talend Open Studio for Data Integration 
