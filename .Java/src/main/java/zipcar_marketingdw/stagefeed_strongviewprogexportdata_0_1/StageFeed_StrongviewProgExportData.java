...
package zipcar_marketingdw.stagefeed_strongviewprogexportdata_0_1;
...
/**
 * Job: StageFeed_StrongviewProgExportData Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_StrongviewProgExportData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_StrongviewProgExportData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_4-bycMsTEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_StrongviewProgExportData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_StrongviewProgExportData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.STRONGVIEW_PROG_EXPORT_DATA.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.STRONGVIEW_PROG_EXPORT_DATA.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.STRONGVIEW_PROG_EXPORT_DATA;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData = new byte[0];
			    ...
			    public Long EXPORT_ACTION_ID;

				public Long getEXPORT_ACTION_ID () {
					return this.EXPORT_ACTION_ID;
				}
				
			    public java.util.Date CREATED_TIME;
			    ...
			    public String PROGRAM_NODE_NAME;

				public String getPROGRAM_NODE_NAME () {
					return this.PROGRAM_NODE_NAME;
				}
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_StrongviewProgExportData) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.RECIPIENT_ADDRESS = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.EXPORT_ACTION_ID = null;
           				} else {
           			    	this.EXPORT_ACTION_ID = dis.readLong();
           				}
					
					this.CREATED_TIME = readDate(dis);
					
					this.PROGRAM_NAME = readString(dis);
					
					this.PROGRAM_NODE_NAME = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.RECIPIENT_ADDRESS,dos);
					
					// Long
				
						if(this.EXPORT_ACTION_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.EXPORT_ACTION_ID);
		            	}
					
					// java.util.Date
				
						writeDate(this.CREATED_TIME,dos);
					
					// String
				
						writeString(this.PROGRAM_NAME,dos);
					
					// String
				
						writeString(this.PROGRAM_NODE_NAME,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("PROGRAM_ID="+String.valueOf(PROGRAM_ID));
		sb.append(",USER_ID="+String.valueOf(USER_ID));
		sb.append(",RECIPIENT_ADDRESS="+RECIPIENT_ADDRESS);
		sb.append(",EXPORT_ACTION_ID="+String.valueOf(EXPORT_ACTION_ID));
		sb.append(",CREATED_TIME="+String.valueOf(CREATED_TIME));
		sb.append(",PROGRAM_NAME="+PROGRAM_NAME);
		sb.append(",PROGRAM_NODE_NAME="+PROGRAM_NODE_NAME);
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(Long PROGRAM_ID){
							this.PROGRAM_ID = PROGRAM_ID;
							return this;
						}				
						Long USER_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c1(Long USER_ID){
							this.USER_ID = USER_ID;
							return this;
						}				
						String RECIPIENT_ADDRESS;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String RECIPIENT_ADDRESS){
							this.RECIPIENT_ADDRESS = RECIPIENT_ADDRESS;
							return this;
						}				
						Long EXPORT_ACTION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Long EXPORT_ACTION_ID){
							this.EXPORT_ACTION_ID = EXPORT_ACTION_ID;
							return this;
						}				
						java.util.Date CREATED_TIME;
						
	            		public BufferLine_tRedshiftOutput_1 c4(java.util.Date CREATED_TIME){
							this.CREATED_TIME = CREATED_TIME;
							return this;
						}				
						String PROGRAM_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String PROGRAM_NAME){
							this.PROGRAM_NAME = PROGRAM_NAME;
							return this;
						}				
						String PROGRAM_NODE_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String PROGRAM_NODE_NAME){
							this.PROGRAM_NODE_NAME = PROGRAM_NODE_NAME;
							return this;
						}				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c9(String CONTINENT){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"PROGRAM_ID\",\"USER_ID\",\"RECIPIENT_ADDRESS\",\"EXPORT_ACTION_ID\",\"CREATED_TIME\",\"PROGRAM_NAME\",\"PROGRAM_NODE_NAME\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"CONTINENT\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.PROGRAM_ID = null;
					
							Row_FeedRecord.USER_ID = null;
					
							Row_FeedRecord.RECIPIENT_ADDRESS = null;
					
							Row_FeedRecord.EXPORT_ACTION_ID = null;
					
							Row_FeedRecord.CREATED_TIME = null;
					
							Row_FeedRecord.PROGRAM_NAME = null;
					
							Row_FeedRecord.PROGRAM_NODE_NAME = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.PROGRAM_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.RECIPIENT_ADDRESS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.EXPORT_ACTION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.CREATED_TIME = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PROGRAM_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PROGRAM_NODE_NAME = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.PROGRAM_NODE_NAME = StringUtils.trimToNull(Row_FeedRecord.PROGRAM_NODE_NAME);
Record_OutputToDB.EXPORT_ACTION_ID = Row_FeedRecord.EXPORT_ACTION_ID;
Record_OutputToDB.CREATION_DATE = Row_FeedRecord.CREATION_DATE;
Record_OutputToDB.PROGRAM_NAME = StringUtils.trimToNull(Row_FeedRecord.PROGRAM_NAME);
Record_OutputToDB.RECIPIENT_ADDRESS = StringUtils.trimToNull(Row_FeedRecord.RECIPIENT_ADDRESS);
Record_OutputToDB.CREATED_TIME = Row_FeedRecord.CREATED_TIME;
Record_OutputToDB.LAST_MODIFIED = Row_FeedRecord.LAST_MODIFIED;
Record_OutputToDB.PROGRAM_ID = Row_FeedRecord.PROGRAM_ID;
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							if(Record_OutputToDB.PROGRAM_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.PROGRAM_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RECIPIENT_ADDRESS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.RECIPIENT_ADDRESS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.EXPORT_ACTION_ID==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.EXPORT_ACTION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PROGRAM_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PROGRAM_NAME);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PROGRAM_NODE_NAME==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PROGRAM_NODE_NAME);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.PROGRAM_ID)
                        .c1(Record_OutputToDB.USER_ID)
                        .c2(Record_OutputToDB.RECIPIENT_ADDRESS)
                        .c3(Record_OutputToDB.EXPORT_ACTION_ID)
                        .c4(Record_OutputToDB.CREATED_TIME)
                        .c5(Record_OutputToDB.PROGRAM_NAME)
                        .c6(Record_OutputToDB.PROGRAM_NODE_NAME)
                        .c7(Record_OutputToDB.CREATION_DATE)
                        .c8(Record_OutputToDB.LAST_MODIFIED)
                        .c9(Record_OutputToDB.CONTINENT)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.PROGRAM_ID = Record_OutputToDB.PROGRAM_ID;
                                After_Insert.USER_ID = Record_OutputToDB.USER_ID;
                                After_Insert.RECIPIENT_ADDRESS = Record_OutputToDB.RECIPIENT_ADDRESS;
                                After_Insert.EXPORT_ACTION_ID = Record_OutputToDB.EXPORT_ACTION_ID;
                                After_Insert.CREATED_TIME = Record_OutputToDB.CREATED_TIME;
                                After_Insert.PROGRAM_NAME = Record_OutputToDB.PROGRAM_NAME;
                                After_Insert.PROGRAM_NODE_NAME = Record_OutputToDB.PROGRAM_NODE_NAME;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.PROGRAM_ID = After_Insert.PROGRAM_ID;
               Log_Rows.USER_ID = After_Insert.USER_ID;
               Log_Rows.RECIPIENT_ADDRESS = After_Insert.RECIPIENT_ADDRESS;
               Log_Rows.EXPORT_ACTION_ID = After_Insert.EXPORT_ACTION_ID;
               Log_Rows.CREATED_TIME = After_Insert.CREATED_TIME;
               Log_Rows.PROGRAM_NAME = After_Insert.PROGRAM_NAME;
               Log_Rows.PROGRAM_NODE_NAME = After_Insert.PROGRAM_NODE_NAME;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"PROGRAM_ID\",\"USER_ID\",\"RECIPIENT_ADDRESS\",\"EXPORT_ACTION_ID\",\"CREATED_TIME\",\"PROGRAM_NAME\",\"PROGRAM_NODE_NAME\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"CONTINENT\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					if(bufferLtRedshiftOutput_1.PROGRAM_ID==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PROGRAM_ID);
					...
					if(bufferLtRedshiftOutput_1.RECIPIENT_ADDRESS==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RECIPIENT_ADDRESS);
					...
					if(bufferLtRedshiftOutput_1.EXPORT_ACTION_ID==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.EXPORT_ACTION_ID);
					...
					if(bufferLtRedshiftOutput_1.CREATED_TIME!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.CREATED_TIME.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.PROGRAM_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PROGRAM_NAME);
					...
					if(bufferLtRedshiftOutput_1.PROGRAM_NODE_NAME==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PROGRAM_NODE_NAME);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.PROGRAM_ID = null;
					
							row1.USER_ID = null;
					
							row1.RECIPIENT_ADDRESS = null;
					
							row1.EXPORT_ACTION_ID = null;
					
							row1.CREATED_TIME = null;
					
							row1.PROGRAM_NAME = null;
					
							row1.PROGRAM_NODE_NAME = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.PROGRAM_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.RECIPIENT_ADDRESS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.EXPORT_ACTION_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.CREATED_TIME = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PROGRAM_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PROGRAM_NODE_NAME = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.PROGRAM_NODE_NAME = StringUtils.trimToNull(row1.PROGRAM_NODE_NAME);
row2.EXPORT_ACTION_ID = row1.EXPORT_ACTION_ID;
row2.CREATION_DATE = row1.CREATION_DATE;
row2.PROGRAM_NAME = StringUtils.trimToNull(row1.PROGRAM_NAME);
row2.RECIPIENT_ADDRESS = StringUtils.trimToNull(row1.RECIPIENT_ADDRESS);
row2.CREATED_TIME = row1.CREATED_TIME;
row2.LAST_MODIFIED = row1.LAST_MODIFIED;
row2.PROGRAM_ID = row1.PROGRAM_ID;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[10];
                            rowtFileOutputDelimited_1[0]=row2.PROGRAM_ID == null ? null : String.valueOf(row2.PROGRAM_ID);
                            rowtFileOutputDelimited_1[1]=row2.USER_ID == null ? null : String.valueOf(row2.USER_ID);
                            rowtFileOutputDelimited_1[2]=row2.RECIPIENT_ADDRESS == null ? null : row2.RECIPIENT_ADDRESS;
                            rowtFileOutputDelimited_1[3]=row2.EXPORT_ACTION_ID == null ? null : String.valueOf(row2.EXPORT_ACTION_ID);
                            rowtFileOutputDelimited_1[4]=row2.CREATED_TIME == null ? null : FormatterUtils.format_Date(row2.CREATED_TIME, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[5]=row2.PROGRAM_NAME == null ? null : row2.PROGRAM_NAME;
                            rowtFileOutputDelimited_1[6]=row2.PROGRAM_NODE_NAME == null ? null : row2.PROGRAM_NODE_NAME;
                            ...
                            rowtFileOutputDelimited_1[9]=row2.CONTINENT == null ? null : row2.CONTINENT;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_StrongviewProgExportData StageFeed_StrongviewProgExportDataClass = new StageFeed_StrongviewProgExportData();

        int exitCode = StageFeed_StrongviewProgExportDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_StrongviewProgExportData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_strongviewprogexportdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_StrongviewProgExportData");
        }
...
/************************************************************************************************
 *     333161 characters generated by Talend Open Studio for Data Integration 
