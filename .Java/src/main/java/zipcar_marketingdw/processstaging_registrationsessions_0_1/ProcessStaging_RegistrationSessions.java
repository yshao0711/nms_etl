...
package zipcar_marketingdw.processstaging_registrationsessions_0_1;
...
/**
 * Job: ProcessStaging_RegistrationSessions Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_RegistrationSessions implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_RegistrationSessions";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_ZELOYMrpEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_RegistrationSessions.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_RegistrationSessions.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_RegistrationSessions) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "registration_sessions";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_registration_session";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_registration_session\n(\n	member_id,\n	creation_date,\n	last_modified,\n	app_status,\n	archival_reason,\n	app_mode,\n	app_step,\n	remarketed,\n	preferred_address_id,\n	preferred_zipfleet_id,\n	residence_country_id,\n	residence_year_p,\n	corporate_id,\n	phone,\n	phone_type,\n	birth_date,\n	account_zipfleet_id,\n	account_id,\n	affiliate_id,\n	rate_plan_id,\n	promo_code,\n	waiver_plan_id,\n	partner_token_id,\n    imported_date\n)\nSELECT \n	user_id,\n	creation_date,\n	last_modified,\n	app_status,\n	archival_reason,\n	app_mode,\n	app_step,\n	remarketed,\n	preferred_address_id,\n	preferred_zipfleet_id,\n	residence_country_id,\n	residence_year_p,\n	corporate_id,\n	phone,\n	phone_type,\n	birth_date,\n	account_zipfleet_id,\n	account_id,\n	affiliate_id,\n	rate_plan_id,\n	promo_code,\n	waiver_plan_id,\n	partner_token_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.registration_sessions\nMINUS\nSELECT \n	member_id,\n	creation_date,\n	last_modified,\n	app_status,\n	archival_reason,\n	app_mode,\n	app_step,\n	remarketed,\n	preferred_address_id,\n	preferred_zipfleet_id,\n	residence_country_id,\n	residence_year_p,\n	corporate_id,\n	phone,\n	phone_type,\n	birth_date,\n	account_zipfleet_id,\n	account_id,\n	affiliate_id,\n	rate_plan_id,\n	promo_code,\n	waiver_plan_id,\n	partner_token_id,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_registration_session\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".registration_sessions";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_RegistrationSessions ProcessStaging_RegistrationSessionsClass = new ProcessStaging_RegistrationSessions();

        int exitCode = ProcessStaging_RegistrationSessionsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_RegistrationSessions.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_registrationsessions_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_RegistrationSessions");
        }
...
/************************************************************************************************
 *     136955 characters generated by Talend Open Studio for Data Integration 
