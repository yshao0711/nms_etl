...
package zipcar_marketingdw.processstaging_applicationsfinal_0_1;
...
/**
 * Job: ProcessStaging_ApplicationsFinal Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_ApplicationsFinal implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_ApplicationsFinal";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_xzTwAAipEeewFdGcJavr5Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_ApplicationsFinal.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_ApplicationsFinal.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_ApplicationsFinal) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "applications_final";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_applications_final";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO{{marketing.schema}}.r_applications_final\n(\n        application_id,\n        member_id,\n        account_id,\n        rate_plan_id,\n        source,\n        driver_status,\n        application_type,\n        application_approval_state,\n        creation_date,\n        finished_date,\n        deleted_date,\n        imported_date,\n        member_zipfleet_id,\n		application_category,\n		callback_note,\n		incomplete_app_p,\n		application_creation_date,\n		application_approval_date, \n		driver_confirmed_zipcard_p,\n		driver_zipcard,\n		rejection_date, \n		zipcard_activated_p, \n		zipcard_address_id, \n		zipcard_arrival_date, \n		zipcard_arrival_state, \n		zipcard_arrival_user, \n		zipcard_received_p, \n		application_zipcard\n)\nSELECT \n        application_id,\n        member_id,\n        account_id,\n        rate_plan_id,\n        source,\n        driver_status,\n        application_type,\n        application_approval_state,\n        creation_date,\n        finished_date,\n        deleted_date,\n        to_date({{rundate}}, 'yyyy-MM-dd') as imported_date,\n        member_zipfleet_id,\n		application_category,\n		callback_note,\n		incomplete_app_p,\n		application_creation_date,\n		application_approval_date, \n		driver_confirmed_zipcard_p,\n		driver_zipcard,\n		rejection_date, \n		zipcard_activated_p, \n		zipcard_address_id, \n		zipcard_arrival_date, \n		zipcard_arrival_state, \n		zipcard_arrival_user, \n		zipcard_received_p, \n		zipcard\nFROM    {{staging.schema}}.applications_final\nMINUS\nSELECT \n        application_id,\n        member_id,\n        account_id,\n        rate_plan_id,\n        source,\n        driver_status,\n        application_type,\n        application_approval_state,\n        creation_date,\n        finished_date,\n        deleted_date,\n        to_date({{rundate}}, 'yyyy-MM-dd') as imported_date,\n        member_zipfleet_id,\n		application_category,\n		callback_note,\n		incomplete_app_p,\n		application_creation_date,\n		application_approval_date, \n		driver_confirmed_zipcard_p,\n		driver_zipcard,\n		rejection_date, \n		zipcard_activated_p, \n		zipcard_address_id, \n		zipcard_arrival_date, \n		zipcard_arrival_state, \n		zipcard_arrival_user, \n		zipcard_received_p, \n		application_zipcard\nFROM    {{marketing.schema}}.vw_r_applications_final\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".applications_final";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_ApplicationsFinal ProcessStaging_ApplicationsFinalClass = new ProcessStaging_ApplicationsFinal();

        int exitCode = ProcessStaging_ApplicationsFinalClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_ApplicationsFinal.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_applicationsfinal_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_ApplicationsFinal");
        }
...
/************************************************************************************************
 *     137695 characters generated by Talend Open Studio for Data Integration 
