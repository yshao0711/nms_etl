...
package zipcar_marketingdw.process_update_member_data_0_1;
...
/**
 * Job: Process_Update_Member_Data Purpose: Updates the Member dimensin.<br>
 * Description: This job reads the daily fact tables and updates the member tables. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class Process_Update_Member_Data implements TalendJob {
...
public Boolean getClearStagingTable(){
	...
	private final String jobName = "Process_Update_Member_Data";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_S4UZkNdIEeaaPbkbdLbqJw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Process_Update_Member_Data.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Process_Update_Member_Data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Member_Data) {
 ...
 */
    ...
    Logging.logMessage(log_message.moment, log_message.job, log_message.priority, log_message.origin, log_message.message);
    nb_line_tJavaRow_1++;   
...
public void tRedshiftRow_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tRedshiftRow_3 = false;
			String driverClass_tRedshiftRow_3 = "com.amazon.redshift.jdbc41.Driver";
		    java.lang.Class.forName(driverClass_tRedshiftRow_3);
		
				String url_tRedshiftRow_3 = "jdbc:redshift://" + context.Redshift_Marketing_Server + ":" + context.Redshift_Marketing_Port + "/" + context.Redshift_Marketing_Database + "?" + context.Redshift_Marketing_AdditionalParams;
					String dbUser_tRedshiftRow_3 = context.Redshift_Marketing_Login;
	        
            		
            		
            		
	final String decryptedPassword_tRedshiftRow_3 = context.Redshift_Marketing_Password; 
        		   	
        	        String dbPwd_tRedshiftRow_3 = decryptedPassword_tRedshiftRow_3;
	        
					
			conn_tRedshiftRow_3 = java.sql.DriverManager.getConnection(url_tRedshiftRow_3,dbUser_tRedshiftRow_3,dbPwd_tRedshiftRow_3);
		
					if(conn_tRedshiftRow_3.getAutoCommit()) {
						
				conn_tRedshiftRow_3.setAutoCommit(false);
			
					}        
					int commitEvery_tRedshiftRow_3 = 1;
					int commitCounter_tRedshiftRow_3 = 0;
...
"\nUPDATE {{marketing.schema}}.d_member\nSET is_estimated_history = false\nWHERE is_estimated_history IS NULL\n",
...
try {
	...
	if(!whetherReject_tRedshiftRow_3) {
		...
		commitCounter_tRedshiftRow_3++;
		if(commitEvery_tRedshiftRow_3 <= commitCounter_tRedshiftRow_3) {
			
			conn_tRedshiftRow_3.commit();
			
			commitCounter_tRedshiftRow_3=0;
		}
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "d_member";
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param tableName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param tableName=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("tableName", obj_tRunJob_6);
	
	
		zipcar_marketingdw.task_deduptablerecords_0_1.Task_DedupTableRecords childJob_tRunJob_6 = new zipcar_marketingdw.task_deduptablerecords_0_1.Task_DedupTableRecords();
	    // pass DataSources
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Update Member Data Completed","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Update Member Data Completed", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_1_WARN_MESSAGES", "Update Member Data Completed"); 
...
Logging.componentName(jobName, "tWarn_2", "Log_ResetMemberTable");
Logging.componentName(jobName, "tWarn_3", "Log_ResetMemberTable");
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tJava_1:OnSubjobOk1", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
							...
							tRedshiftRow_1Process(globalMap); 
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tJava_1:OnSubjobOk2", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public static class log_deletedStruct implements routines.system.IPersistableRow<log_deletedStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(log_deletedStruct other) {
...
public void tRedshiftRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		log_deletedStruct log_deleted = new log_deletedStruct();
	...
	currentComponent="tWarn_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("log_deleted" + iterateId, 0, 0);
 ...
 */
	...
	boolean whetherReject_tRedshiftRow_1 = false;
		    ...
		    java.lang.Class.forName(driverClass_tRedshiftRow_1);
				...
				String url_tRedshiftRow_1 = "jdbc:redshift://" + context.Redshift_Marketing_Server + ":" + context.Redshift_Marketing_Port + "/" + context.Redshift_Marketing_Database + "?" + context.Redshift_Marketing_AdditionalParams;
					String dbUser_tRedshiftRow_1 = context.Redshift_Marketing_Login;
	        
            		
            		
            		
	final String decryptedPassword_tRedshiftRow_1 = context.Redshift_Marketing_Password; 
        		   	
        	        String dbPwd_tRedshiftRow_1 = decryptedPassword_tRedshiftRow_1;
	        
					
			conn_tRedshiftRow_1 = java.sql.DriverManager.getConnection(url_tRedshiftRow_1,dbUser_tRedshiftRow_1,dbPwd_tRedshiftRow_1);
				...
				conn_tRedshiftRow_1.setAutoCommit(false);
					...
					int commitEvery_tRedshiftRow_1 = 1;
...
query_tRedshiftRow_1 = "DELETE FROM " + context.Redshift_Marketing_Schema +".d_member  "
...
try {
	...
	if(!whetherReject_tRedshiftRow_1) {
					...
					log_deleted = new log_deletedStruct();
...
if(log_deleted != null) { 
	...
	currentComponent="tWarn_2";
			...
			//log_deleted
				...
				if(execStat){
					runStat.updateStatOnConnection("log_deleted"+iterateId,1, 1);
				} 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Deleted Current Day Records for Restart","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 3, "Deleted Current Day Records for Restart", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_2_WARN_MESSAGES", "Deleted Current Day Records for Restart"); 
 ...
 */
	...
	currentComponent="tWarn_2";
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("log_deleted"+iterateId,2, 0); 
			 	}
			}
...
public static class log_restoredStruct implements routines.system.IPersistableRow<log_restoredStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Update_Member_Data = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(log_restoredStruct other) {
...
public void tRedshiftRow_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		log_restoredStruct log_restored = new log_restoredStruct();
	...
	currentComponent="tWarn_3";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("log_restored" + iterateId, 0, 0);
 ...
 */
	...
	boolean whetherReject_tRedshiftRow_2 = false;
		    ...
		    java.lang.Class.forName(driverClass_tRedshiftRow_2);
				...
				String url_tRedshiftRow_2 = "jdbc:redshift://" + context.Redshift_Marketing_Server + ":" + context.Redshift_Marketing_Port + "/" + context.Redshift_Marketing_Database + "?" + context.Redshift_Marketing_AdditionalParams;
					String dbUser_tRedshiftRow_2 = context.Redshift_Marketing_Login;
	        
            		
            		
            		
	final String decryptedPassword_tRedshiftRow_2 = context.Redshift_Marketing_Password; 
			...
			conn_tRedshiftRow_2 = java.sql.DriverManager.getConnection(url_tRedshiftRow_2,dbUser_tRedshiftRow_2,dbPwd_tRedshiftRow_2);
				...
				conn_tRedshiftRow_2.setAutoCommit(false);
					...
					int commitEvery_tRedshiftRow_2 = 1;
...
query_tRedshiftRow_2 = "UPDATE " + context.Redshift_Marketing_Schema +".d_member  "
+ " \nSET end_date = '3199-12-31' "  
+ "\nWHERE  end_date = " + DateUtils.dateToSqlStr(TalendDate.addDate(DateUtils.runDate(context.RunDate), -1, "dd"))
...
try {
	...
	if(!whetherReject_tRedshiftRow_2) {
					...
					log_restored = new log_restoredStruct();
 ...
 */
// Start of branch "log_restored"
if(log_restored != null) { 
	...
	currentComponent="tWarn_3";
			...
			//log_restored
				...
				if(execStat){
					runStat.updateStatOnConnection("log_restored"+iterateId,1, 1);
				} 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO","","Restored Prior Day Records for Restart","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_3", 3, "Restored Prior Day Records for Restart", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_3_WARN_MESSAGES", "Restored Prior Day Records for Restart"); 
 ...
 */
	...
	currentComponent="tWarn_3";
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("log_restored"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		zipcar_marketingdw.update_existingmembers_0_1.Update_ExistingMembers childJob_tRunJob_2 = new zipcar_marketingdw.update_existingmembers_0_1.Update_ExistingMembers();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		zipcar_marketingdw.insert_newmembers_0_1.Insert_NewMembers childJob_tRunJob_1 = new zipcar_marketingdw.insert_newmembers_0_1.Insert_NewMembers();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		zipcar_marketingdw.update_memberflags_0_1.Update_MemberFlags childJob_tRunJob_3 = new zipcar_marketingdw.update_memberflags_0_1.Update_MemberFlags();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		zipcar_marketingdw.update_memberisemployee_0_1.Update_MemberIsEmployee childJob_tRunJob_7 = new zipcar_marketingdw.update_memberisemployee_0_1.Update_MemberIsEmployee();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		zipcar_marketingdw.update_zipfleetid_0_1.Update_ZipfleetId childJob_tRunJob_5 = new zipcar_marketingdw.update_zipfleetid_0_1.Update_ZipfleetId();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		zipcar_marketingdw.update_memberphoneinfo_0_1.Update_MemberPhoneInfo childJob_tRunJob_4 = new zipcar_marketingdw.update_memberphoneinfo_0_1.Update_MemberPhoneInfo();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Process_Update_Member_Data Process_Update_Member_DataClass = new Process_Update_Member_Data();

        int exitCode = Process_Update_Member_DataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Process_Update_Member_Data.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/process_update_member_data_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Process_Update_Member_Data");
        }
...
/************************************************************************************************
 *     192529 characters generated by Talend Open Studio for Data Integration 
