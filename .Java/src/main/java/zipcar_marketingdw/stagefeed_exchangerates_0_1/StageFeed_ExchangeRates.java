...
package zipcar_marketingdw.stagefeed_exchangerates_0_1;
...
/**
 * Job: StageFeed_ExchangeRates Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_ExchangeRates implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_ExchangeRates";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_oGCEsBfwEeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_ExchangeRates.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_ExchangeRates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.EXCHANGE_RATES.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.EXCHANGE_RATES.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.EXCHANGE_RATES;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.MONTH = this.MONTH;
	            other.FROM_ISO = this.FROM_ISO;
	            other.TO_ISO = this.TO_ISO;
	            other.AVG_RATE = this.AVG_RATE;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_ExchangeRates) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.FROM_ISO = readString(dis);
					
					this.TO_ISO = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.AVG_RATE = null;
           				} else {
           			    	this.AVG_RATE = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.FROM_ISO,dos);
					
					// String
				
						writeString(this.TO_ISO,dos);
					
					// Double
				
						if(this.AVG_RATE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.AVG_RATE);
		            	}
    ...
    public String toString() {
		...
		sb.append(",FROM_ISO="+FROM_ISO);
		sb.append(",TO_ISO="+TO_ISO);
		sb.append(",AVG_RATE="+String.valueOf(AVG_RATE));
	    sb.append("]");
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(java.util.Date MONTH){
							this.MONTH = MONTH;
							return this;
						}				
						String FROM_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String FROM_ISO){
							this.FROM_ISO = FROM_ISO;
							return this;
						}				
						String TO_ISO;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String TO_ISO){
							this.TO_ISO = TO_ISO;
							return this;
						}				
						Double AVG_RATE;
						
	            		public BufferLine_tRedshiftOutput_1 c3(Double AVG_RATE){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MONTH\",\"FROM_ISO\",\"TO_ISO\",\"AVG_RATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.MONTH = null;
					
							Row_FeedRecord.FROM_ISO = null;
					
							Row_FeedRecord.TO_ISO = null;
					
							Row_FeedRecord.AVG_RATE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											Row_FeedRecord.MONTH = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.FROM_ISO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.TO_ISO = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.AVG_RATE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.MONTH = Row_FeedRecord.MONTH;
Record_OutputToDB.FROM_ISO = StringUtils.trimToNull(Row_FeedRecord.FROM_ISO);
Record_OutputToDB.TO_ISO = StringUtils.trimToNull(Row_FeedRecord.TO_ISO);
Record_OutputToDB.AVG_RATE = Row_FeedRecord.AVG_RATE;
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FROM_ISO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.FROM_ISO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.TO_ISO==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.TO_ISO);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.AVG_RATE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.AVG_RATE);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.MONTH)
                        .c1(Record_OutputToDB.FROM_ISO)
                        .c2(Record_OutputToDB.TO_ISO)
                        .c3(Record_OutputToDB.AVG_RATE)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.MONTH = Record_OutputToDB.MONTH;
                                After_Insert.FROM_ISO = Record_OutputToDB.FROM_ISO;
                                After_Insert.TO_ISO = Record_OutputToDB.TO_ISO;
                                After_Insert.AVG_RATE = Record_OutputToDB.AVG_RATE;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.MONTH = After_Insert.MONTH;
               Log_Rows.FROM_ISO = After_Insert.FROM_ISO;
               Log_Rows.TO_ISO = After_Insert.TO_ISO;
               Log_Rows.AVG_RATE = After_Insert.AVG_RATE;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"MONTH\",\"FROM_ISO\",\"TO_ISO\",\"AVG_RATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					if(bufferLtRedshiftOutput_1.MONTH!=null){
						// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL
						date_tRedshiftOutput_1 = bufferLtRedshiftOutput_1.MONTH.getTime();
						if (date_tRedshiftOutput_1 < year1_tRedshiftOutput_1 || date_tRedshiftOutput_1 >= year10000_tRedshiftOutput_1) {
					...
					if(bufferLtRedshiftOutput_1.FROM_ISO==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FROM_ISO);
					...
					if(bufferLtRedshiftOutput_1.TO_ISO==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.TO_ISO);
					...
					if(bufferLtRedshiftOutput_1.AVG_RATE==null){
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.AVG_RATE);
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.MONTH = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], FeedFile.DF_DATETIME, false);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.FROM_ISO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.TO_ISO = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.AVG_RATE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.FROM_ISO = StringUtils.trimToNull(row1.FROM_ISO);
row2.TO_ISO = StringUtils.trimToNull(row1.TO_ISO);
row2.AVG_RATE = row1.AVG_RATE;
    nb_line_tJavaRow_3++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[4];
                            rowtFileOutputDelimited_1[0]=row2.MONTH == null ? null : FormatterUtils.format_Date(row2.MONTH, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[1]=row2.FROM_ISO == null ? null : row2.FROM_ISO;
                            rowtFileOutputDelimited_1[2]=row2.TO_ISO == null ? null : row2.TO_ISO;
                            rowtFileOutputDelimited_1[3]=row2.AVG_RATE == null ? null : String.valueOf(row2.AVG_RATE);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_ExchangeRates StageFeed_ExchangeRatesClass = new StageFeed_ExchangeRates();

        int exitCode = StageFeed_ExchangeRatesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_ExchangeRates.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_exchangerates_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_ExchangeRates");
        }
...
/************************************************************************************************
 *     301699 characters generated by Talend Open Studio for Data Integration 
