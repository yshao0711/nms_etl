...
package zipcar_marketingdw.processstaging_affiliates_0_1;
...
/**
 * Job: ProcessStaging_Affiliates Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Affiliates implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Affiliates";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_cxLCoMo7EeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Affiliates.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Affiliates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Affiliates) {
...
"\nINSERT INTO {{marketing.schema}}.r_affiliate\n(\n    affiliate_id,\n	affiliate_name,\n	zipfleet_id,\n	master_account_id,\n	minimum_age,\n	allow_app_coupon_p,\n	have_zipcard_p,\n	creation_date,\n	last_modified,\n	deleted_date,\n	require_admin_approval_p,\n    imported_date\n)\nSELECT \n    affiliate_id,\n	affiliate_name,\n	zipfleet_id,\n	master_account_id,\n	minimum_age,\n	allow_app_coupon_p,\n	have_zipcard_p,\n	creation_date,\n	last_modified,\n	deleted_date,\n	require_admin_approval_p,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.affiliates\nMINUS\nSELECT \n    affiliate_id,\n	affiliate_name,\n	zipfleet_id,\n	master_account_id,\n	minimum_age,\n	allow_app_coupon_p,\n	have_zipcard_p,\n	creation_date,\n	last_modified,\n	deleted_date,\n	require_admin_approval_p,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_affiliate\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".affiliates";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Affiliates ProcessStaging_AffiliatesClass = new ProcessStaging_Affiliates();

        int exitCode = ProcessStaging_AffiliatesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Affiliates.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_affiliates_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Affiliates");
        }
...
/************************************************************************************************
 *     136044 characters generated by Talend Open Studio for Data Integration 
