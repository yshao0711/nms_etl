...
package zipcar_marketingdw.processstaging_strongviewprogramfiles_0_1;
...
/**
 * Job: ProcessStaging_StrongviewProgramFiles Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_StrongviewProgramFiles implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_StrongviewProgramFiles";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_qZLxkMsZEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_StrongviewProgramFiles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_StrongviewProgramFiles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgramFiles) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "strongview_program_files";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_strongview_program_file";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_strongview_program_file\n(\n	fileid,\n	filename,\n	file_creation_dt,\n	collectdate,\n	loaded_p,\n	loaddate,\n	error,\n	errorcount,\n	creation_date,\n	last_modified,\n	continent,\n	directory_name,\n    imported_date\n)\nSELECT \n	fileid,\n	filename,\n	file_creation_dt,\n	collectdate,\n	loaded_p,\n	loaddate,\n	error,\n	errorcount,\n	creation_date,\n	last_modified,\n	continent,\n	directory_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.strongview_program_files\nMINUS\nSELECT \n	fileid,\n	filename,\n	file_creation_dt,\n	collectdate,\n	loaded_p,\n	loaddate,\n	error,\n	errorcount,\n	creation_date,\n	last_modified,\n	continent,\n	directory_name,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_strongview_program_file\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".strongview_program_files";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_StrongviewProgramFiles ProcessStaging_StrongviewProgramFilesClass = new ProcessStaging_StrongviewProgramFiles();

        int exitCode = ProcessStaging_StrongviewProgramFilesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_StrongviewProgramFiles.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_strongviewprogramfiles_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_StrongviewProgramFiles");
        }
...
/************************************************************************************************
 *     136390 characters generated by Talend Open Studio for Data Integration 
