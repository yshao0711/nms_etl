...
package zipcar_marketingdw.processstaging_strongviewprogexportdata_0_1;
...
/**
 * Job: ProcessStaging_StrongviewProgExportData Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_StrongviewProgExportData implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_StrongviewProgExportData";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("__F3OQMsUEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_StrongviewProgExportData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_StrongviewProgExportData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewProgExportData) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "strongview_prog_export_data";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_strongview_prog_export_data";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_strongview_prog_export_data\n(\n	program_id,\n	member_id,\n	recipient_address,\n	export_action_id,\n	created_time,\n	program_name,\n	program_node_name,\n	creation_date,\n	last_modified,\n	continent,\n    imported_date\n)\nSELECT \n	program_id,\n	user_id,\n	recipient_address,\n	export_action_id,\n	created_time,\n	program_name,\n	program_node_name,\n	creation_date,\n	last_modified,\n	continent,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.strongview_prog_export_data\nMINUS\nSELECT \n	program_id,\n	member_id,\n	recipient_address,\n	export_action_id,\n	created_time,\n	program_name,\n	program_node_name,\n	creation_date,\n	last_modified,\n	continent,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_strongview_prog_export_data\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".strongview_prog_export_data";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_StrongviewProgExportData ProcessStaging_StrongviewProgExportDataClass = new ProcessStaging_StrongviewProgExportData();

        int exitCode = ProcessStaging_StrongviewProgExportDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_StrongviewProgExportData.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_strongviewprogexportdata_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_StrongviewProgExportData");
        }
...
/************************************************************************************************
 *     136467 characters generated by Talend Open Studio for Data Integration 
 *     on the October 16, 2018 5:21:51 PM CDT
 ************************************************************************************************/