...
package zipcar_marketingdw.stagefeed_locations_0_1;
...
/**
 * Job: StageFeed_Locations Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Locations implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Locations";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Bu2soARKEeevvquAUS6ZRg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Locations.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Locations.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Locations = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Locations) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.LOCATIONS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.LOCATIONS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.LOCATIONS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Locations = new byte[0];
			    ...
			    public String ONLINE_P;

				public String getONLINE_P () {
					return this.ONLINE_P;
				}
			    ...
			    public Integer ONEWAY_PARKING_SPACES;

				public Integer getONEWAY_PARKING_SPACES () {
					return this.ONEWAY_PARKING_SPACES;
				}
			    ...
			    public String RESTRICTED_P;

				public String getRESTRICTED_P () {
					return this.RESTRICTED_P;
				}
				
			    public String UNIVERSITY_STATUS;
        	...
        	try {
        		...
        		int length = 0;
					...
					this.LOCATION = readString(dis);
						...
						this.ONEWAY_PARKING_SPACES = readInteger(dis);
					
					this.REGION_NAME = readString(dis);
					
					this.RESTRICTED_P = readString(dis);
					
					this.UNIVERSITY_STATUS = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.ONEWAY_PARKING_SPACES,dos);
					...
					// String
						...
						writeString(this.RESTRICTED_P,dos);
					
					// String
				
						writeString(this.UNIVERSITY_STATUS,dos);
    ...
    public String toString() {
		...
		sb.append(",ONEWAY_PARKING_SPACES="+String.valueOf(ONEWAY_PARKING_SPACES));
		sb.append(",REGION_NAME="+REGION_NAME);
		sb.append(",RESTRICTED_P="+RESTRICTED_P);
		sb.append(",UNIVERSITY_STATUS="+UNIVERSITY_STATUS);
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c3(String ONLINE_P){
							this.ONLINE_P = ONLINE_P;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c4(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c5(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c6(java.util.Date DELETED_DATE){
							this.DELETED_DATE = DELETED_DATE;
							return this;
						}				
						String LOCATION;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String LOCATION){
							this.LOCATION = LOCATION;
							return this;
						}				
						Integer ONEWAY_PARKING_SPACES;
						
	            		public BufferLine_tRedshiftOutput_1 c8(Integer ONEWAY_PARKING_SPACES){
							this.ONEWAY_PARKING_SPACES = ONEWAY_PARKING_SPACES;
							return this;
						}				
						String REGION_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String REGION_NAME){
							this.REGION_NAME = REGION_NAME;
							return this;
						}				
						String RESTRICTED_P;
						
	            		public BufferLine_tRedshiftOutput_1 c10(String RESTRICTED_P){
							this.RESTRICTED_P = RESTRICTED_P;
							return this;
						}				
						String UNIVERSITY_STATUS;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String UNIVERSITY_STATUS){
							this.UNIVERSITY_STATUS = UNIVERSITY_STATUS;
							return this;
						}				
						Long ZONE_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c12(Long ZONE_ID){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"LOCATION_ID\",\"ZIPFLEET_ID\",\"ADDRESS_ID\",\"ONLINE_P\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"LOCATION\",\"ONEWAY_PARKING_SPACES\",\"REGION_NAME\",\"RESTRICTED_P\",\"UNIVERSITY_STATUS\",\"ZONE_ID\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.LOCATION = null;
					
							Row_FeedRecord.ONEWAY_PARKING_SPACES = null;
					
							Row_FeedRecord.REGION_NAME = null;
					
							Row_FeedRecord.RESTRICTED_P = null;
					
							Row_FeedRecord.UNIVERSITY_STATUS = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.ONLINE_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.LOCATION = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ONEWAY_PARKING_SPACES = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.RESTRICTED_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.UNIVERSITY_STATUS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.ONLINE_P = BooleanUtils.boolChar(Row_FeedRecord.ONLINE_P);
...
Record_OutputToDB.LOCATION = StringUtils.trimToNull(Row_FeedRecord.LOCATION);
Record_OutputToDB.ONEWAY_PARKING_SPACES = Row_FeedRecord.ONEWAY_PARKING_SPACES;
Record_OutputToDB.REGION_NAME = StringUtils.trimToNull(Row_FeedRecord.REGION_NAME);
Record_OutputToDB.RESTRICTED_P = BooleanUtils.boolChar(Row_FeedRecord.RESTRICTED_P);
Record_OutputToDB.UNIVERSITY_STATUS = StringUtils.trimToNull(Row_FeedRecord.UNIVERSITY_STATUS);
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ONLINE_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.ONLINE_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.LOCATION==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.LOCATION);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ONEWAY_PARKING_SPACES==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setInt(countertRedshiftOutput_1,Record_OutputToDB.ONEWAY_PARKING_SPACES);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RESTRICTED_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.RESTRICTED_P);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.UNIVERSITY_STATUS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.UNIVERSITY_STATUS);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c1(Record_OutputToDB.ZIPFLEET_ID)
                        .c2(Record_OutputToDB.ADDRESS_ID)
                        .c3(Record_OutputToDB.ONLINE_P)
                        .c4(Record_OutputToDB.CREATION_DATE)
                        .c5(Record_OutputToDB.LAST_MODIFIED)
                        .c6(Record_OutputToDB.DELETED_DATE)
                        .c7(Record_OutputToDB.LOCATION)
                        .c8(Record_OutputToDB.ONEWAY_PARKING_SPACES)
                        .c9(Record_OutputToDB.REGION_NAME)
                        .c10(Record_OutputToDB.RESTRICTED_P)
                        .c11(Record_OutputToDB.UNIVERSITY_STATUS)
                        .c12(Record_OutputToDB.ZONE_ID)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.ONLINE_P = Record_OutputToDB.ONLINE_P;
                                ...
                                After_Insert.LOCATION = Record_OutputToDB.LOCATION;
                                After_Insert.ONEWAY_PARKING_SPACES = Record_OutputToDB.ONEWAY_PARKING_SPACES;
                                After_Insert.REGION_NAME = Record_OutputToDB.REGION_NAME;
                                After_Insert.RESTRICTED_P = Record_OutputToDB.RESTRICTED_P;
                                After_Insert.UNIVERSITY_STATUS = Record_OutputToDB.UNIVERSITY_STATUS;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.ONLINE_P = After_Insert.ONLINE_P;
               ...
               Log_Rows.LOCATION = After_Insert.LOCATION;
               Log_Rows.ONEWAY_PARKING_SPACES = After_Insert.ONEWAY_PARKING_SPACES;
               Log_Rows.REGION_NAME = After_Insert.REGION_NAME;
               Log_Rows.RESTRICTED_P = After_Insert.RESTRICTED_P;
               Log_Rows.UNIVERSITY_STATUS = After_Insert.UNIVERSITY_STATUS;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"LOCATION_ID\",\"ZIPFLEET_ID\",\"ADDRESS_ID\",\"ONLINE_P\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"LOCATION\",\"ONEWAY_PARKING_SPACES\",\"REGION_NAME\",\"RESTRICTED_P\",\"UNIVERSITY_STATUS\",\"ZONE_ID\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.ONLINE_P==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ONLINE_P);
					...
					if(bufferLtRedshiftOutput_1.LOCATION==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.LOCATION);
					...
					if(bufferLtRedshiftOutput_1.ONEWAY_PARKING_SPACES==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setInt(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ONEWAY_PARKING_SPACES);
					...
					if(bufferLtRedshiftOutput_1.RESTRICTED_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RESTRICTED_P);
					...
					if(bufferLtRedshiftOutput_1.UNIVERSITY_STATUS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.UNIVERSITY_STATUS);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.ONEWAY_PARKING_SPACES = null;
					
							row1.REGION_NAME = null;
					
							row1.RESTRICTED_P = null;
					
							row1.UNIVERSITY_STATUS = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ONLINE_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.LOCATION = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ONEWAY_PARKING_SPACES = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.RESTRICTED_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.UNIVERSITY_STATUS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.ONLINE_P = BooleanUtils.boolChar(row1.ONLINE_P);
row2.CREATION_DATE = row1.CREATION_DATE;
row2.LAST_MODIFIED = row1.LAST_MODIFIED;
row2.DELETED_DATE = row1.DELETED_DATE;
row2.LOCATION = StringUtils.trimToNull(row1.LOCATION);
row2.ONEWAY_PARKING_SPACES = row1.ONEWAY_PARKING_SPACES;
row2.REGION_NAME = StringUtils.trimToNull(row1.REGION_NAME);
row2.RESTRICTED_P = BooleanUtils.boolChar(row1.RESTRICTED_P);
row2.UNIVERSITY_STATUS = StringUtils.trimToNull(row1.UNIVERSITY_STATUS);
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[13];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.ZIPFLEET_ID == null ? null : String.valueOf(row2.ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[2]=row2.ADDRESS_ID == null ? null : String.valueOf(row2.ADDRESS_ID);
                            rowtFileOutputDelimited_1[3]=row2.ONLINE_P == null ? null : row2.ONLINE_P;
                            ...
                            rowtFileOutputDelimited_1[7]=row2.LOCATION == null ? null : row2.LOCATION;
                            rowtFileOutputDelimited_1[8]=row2.ONEWAY_PARKING_SPACES == null ? null : String.valueOf(row2.ONEWAY_PARKING_SPACES);
                            rowtFileOutputDelimited_1[9]=row2.REGION_NAME == null ? null : row2.REGION_NAME;
                            rowtFileOutputDelimited_1[10]=row2.RESTRICTED_P == null ? null : row2.RESTRICTED_P;
                            rowtFileOutputDelimited_1[11]=row2.UNIVERSITY_STATUS == null ? null : row2.UNIVERSITY_STATUS;
                            rowtFileOutputDelimited_1[12]=row2.ZONE_ID == null ? null : String.valueOf(row2.ZONE_ID);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Locations StageFeed_LocationsClass = new StageFeed_Locations();

        int exitCode = StageFeed_LocationsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Locations.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_locations_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Locations");
        }
...
/************************************************************************************************
 *     343658 characters generated by Talend Open Studio for Data Integration 
