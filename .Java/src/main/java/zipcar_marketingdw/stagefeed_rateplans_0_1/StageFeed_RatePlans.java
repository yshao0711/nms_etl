...
package zipcar_marketingdw.stagefeed_rateplans_0_1;
...
/**
 * Job: StageFeed_RatePlans Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_RatePlans implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_RatePlans";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_3QD3EMeDEeaiY9_IUEmgfg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_RatePlans.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_RatePlans.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RatePlans = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RatePlans = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RatePlans.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RatePlans.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RatePlans = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RatePlans = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RatePlans, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_RatePlans, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RatePlans) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.RATE_PLANS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.RATE_PLANS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.RATE_PLANS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public Double ADDL_FEE;

				public Double getADDL_FEE () {
					return this.ADDL_FEE;
				}
				
			    public Long ADDL_THRESHOLD;

				public Long getADDL_THRESHOLD () {
					return this.ADDL_THRESHOLD;
				}
			    ...
			    public String FEE_FREQ;

				public String getFEE_FREQ () {
					return this.FEE_FREQ;
				}
			    ...
			    public String RATE_PLAN_CLASS;

				public String getRATE_PLAN_CLASS () {
					return this.RATE_PLAN_CLASS;
				}
				
			    public String Z2B_P;

				public String getZ2B_P () {
					return this.Z2B_P;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.RATE_PLAN_ID == null) ? 0 : this.RATE_PLAN_ID.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final Log_RowsStruct other = (Log_RowsStruct) obj;
						...
						if (this.RATE_PLAN_ID == null) {
							if (other.RATE_PLAN_ID != null)
								return false;
						
						} else if (!this.RATE_PLAN_ID.equals(other.RATE_PLAN_ID))
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.RATE_PLAN_ID = this.RATE_PLAN_ID;
	            other.PLAN_CATEGORY = this.PLAN_CATEGORY;
	            other.ACTIVE_P = this.ACTIVE_P;
	            other.CREATION_DATE = this.CREATION_DATE;
	            other.LAST_MODIFIED = this.LAST_MODIFIED;
	            other.DELETED_DATE = this.DELETED_DATE;
	            other.SEGMENT_CLASS = this.SEGMENT_CLASS;
	            other.SUPER_CLASS = this.SUPER_CLASS;
	            other.PUBLIC_NAME = this.PUBLIC_NAME;
	            other.RATE_PLAN_KEY = this.RATE_PLAN_KEY;
	            other.ZIPFLEET_ID = this.ZIPFLEET_ID;
	            other.ADDL_FEE = this.ADDL_FEE;
	            other.ADDL_THRESHOLD = this.ADDL_THRESHOLD;
	            other.FEE = this.FEE;
	            other.FEE_FREQ = this.FEE_FREQ;
	            other.NAME = this.NAME;
	            other.RATE_PLAN_CLASS = this.RATE_PLAN_CLASS;
	            other.Z2B_P = this.Z2B_P;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_RatePlans) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.SUPER_CLASS = readString(dis);
					...
					this.RATE_PLAN_KEY = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.ADDL_FEE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.ADDL_THRESHOLD = null;
           				} else {
           			    	this.ADDL_THRESHOLD = dis.readLong();
           				}
					...
					this.FEE_FREQ = readString(dis);
					
					this.NAME = readString(dis);
					
					this.RATE_PLAN_CLASS = readString(dis);
					
					this.Z2B_P = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.SUPER_CLASS,dos);
					...
					// Double
						...
						if(this.ADDL_FEE == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.ADDL_FEE);
		            	}
					
					// Long
				
						if(this.ADDL_THRESHOLD == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.ADDL_THRESHOLD);
		            	}
					...
					// String
						...
						writeString(this.RATE_PLAN_CLASS,dos);
					
					// String
				
						writeString(this.Z2B_P,dos);
    ...
    public String toString() {
		...
		sb.append(",ADDL_FEE="+String.valueOf(ADDL_FEE));
		sb.append(",ADDL_THRESHOLD="+String.valueOf(ADDL_THRESHOLD));
		sb.append(",FEE="+String.valueOf(FEE));
		sb.append(",FEE_FREQ="+FEE_FREQ);
		sb.append(",NAME="+NAME);
		sb.append(",RATE_PLAN_CLASS="+RATE_PLAN_CLASS);
		sb.append(",Z2B_P="+Z2B_P);
	    sb.append("]");
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.RATE_PLAN_ID, other.RATE_PLAN_ID);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(Long RATE_PLAN_ID){
							this.RATE_PLAN_ID = RATE_PLAN_ID;
							return this;
						}				
						String PLAN_CATEGORY;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String PLAN_CATEGORY){
							this.PLAN_CATEGORY = PLAN_CATEGORY;
							return this;
						}				
						String ACTIVE_P;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String ACTIVE_P){
							this.ACTIVE_P = ACTIVE_P;
							return this;
						}				
						java.util.Date CREATION_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c3(java.util.Date CREATION_DATE){
							this.CREATION_DATE = CREATION_DATE;
							return this;
						}				
						java.util.Date LAST_MODIFIED;
						
	            		public BufferLine_tRedshiftOutput_1 c4(java.util.Date LAST_MODIFIED){
							this.LAST_MODIFIED = LAST_MODIFIED;
							return this;
						}				
						java.util.Date DELETED_DATE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(java.util.Date DELETED_DATE){
							this.DELETED_DATE = DELETED_DATE;
							return this;
						}				
						String SEGMENT_CLASS;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String SEGMENT_CLASS){
							this.SEGMENT_CLASS = SEGMENT_CLASS;
							return this;
						}				
						String SUPER_CLASS;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String SUPER_CLASS){
							this.SUPER_CLASS = SUPER_CLASS;
							return this;
						}				
						String PUBLIC_NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String PUBLIC_NAME){
							this.PUBLIC_NAME = PUBLIC_NAME;
							return this;
						}				
						String RATE_PLAN_KEY;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String RATE_PLAN_KEY){
							this.RATE_PLAN_KEY = RATE_PLAN_KEY;
							return this;
						}				
						Long ZIPFLEET_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Long ZIPFLEET_ID){
							this.ZIPFLEET_ID = ZIPFLEET_ID;
							return this;
						}				
						Double ADDL_FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c11(Double ADDL_FEE){
							this.ADDL_FEE = ADDL_FEE;
							return this;
						}				
						Long ADDL_THRESHOLD;
						
	            		public BufferLine_tRedshiftOutput_1 c12(Long ADDL_THRESHOLD){
							this.ADDL_THRESHOLD = ADDL_THRESHOLD;
							return this;
						}				
						Double FEE;
						
	            		public BufferLine_tRedshiftOutput_1 c13(Double FEE){
							this.FEE = FEE;
							return this;
						}				
						String FEE_FREQ;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String FEE_FREQ){
							this.FEE_FREQ = FEE_FREQ;
							return this;
						}				
						String NAME;
						
	            		public BufferLine_tRedshiftOutput_1 c15(String NAME){
							this.NAME = NAME;
							return this;
						}				
						String RATE_PLAN_CLASS;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String RATE_PLAN_CLASS){
							this.RATE_PLAN_CLASS = RATE_PLAN_CLASS;
							return this;
						}				
						String Z2B_P;
						
	            		public BufferLine_tRedshiftOutput_1 c17(String Z2B_P){
							this.Z2B_P = Z2B_P;
							return this;
						}		
			}
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"RATE_PLAN_ID\",\"PLAN_CATEGORY\",\"ACTIVE_P\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"SEGMENT_CLASS\",\"SUPER_CLASS\",\"PUBLIC_NAME\",\"RATE_PLAN_KEY\",\"ZIPFLEET_ID\",\"ADDL_FEE\",\"ADDL_THRESHOLD\",\"FEE\",\"FEE_FREQ\",\"NAME\",\"RATE_PLAN_CLASS\",\"Z2B_P\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.PLAN_CATEGORY = null;
							...
							Row_FeedRecord.SEGMENT_CLASS = null;
					
							Row_FeedRecord.SUPER_CLASS = null;
					
							Row_FeedRecord.PUBLIC_NAME = null;
					
							Row_FeedRecord.RATE_PLAN_KEY = null;
					
							Row_FeedRecord.ZIPFLEET_ID = null;
					
							Row_FeedRecord.ADDL_FEE = null;
					
							Row_FeedRecord.ADDL_THRESHOLD = null;
					
							Row_FeedRecord.FEE = null;
					
							Row_FeedRecord.FEE_FREQ = null;
					
							Row_FeedRecord.NAME = null;
					
							Row_FeedRecord.RATE_PLAN_CLASS = null;
					
							Row_FeedRecord.Z2B_P = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.PLAN_CATEGORY = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SEGMENT_CLASS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.SUPER_CLASS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.RATE_PLAN_KEY = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ADDL_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.ADDL_THRESHOLD = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.FEE_FREQ = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.RATE_PLAN_CLASS = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.Z2B_P = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.PLAN_CATEGORY = StringUtils.trimToNull(Row_FeedRecord.PLAN_CATEGORY);
...
Record_OutputToDB.SEGMENT_CLASS = StringUtils.trimToNull(Row_FeedRecord.SEGMENT_CLASS);
Record_OutputToDB.SUPER_CLASS = StringUtils.trimToNull(Row_FeedRecord.SUPER_CLASS);
Record_OutputToDB.PUBLIC_NAME = StringUtils.trimToNull(Row_FeedRecord.PUBLIC_NAME);
Record_OutputToDB.RATE_PLAN_KEY = StringUtils.trimToNull(Row_FeedRecord.RATE_PLAN_KEY);
Record_OutputToDB.ZIPFLEET_ID = Row_FeedRecord.ZIPFLEET_ID;
Record_OutputToDB.ADDL_FEE = Row_FeedRecord.ADDL_FEE;
Record_OutputToDB.ADDL_THRESHOLD = Row_FeedRecord.ADDL_THRESHOLD;
Record_OutputToDB.FEE = Row_FeedRecord.FEE;
Record_OutputToDB.FEE_FREQ = StringUtils.trimToNull(Row_FeedRecord.FEE_FREQ);
Record_OutputToDB.NAME = StringUtils.trimToNull(Row_FeedRecord.NAME);
Record_OutputToDB.RATE_PLAN_CLASS = StringUtils.trimToNull(Row_FeedRecord.RATE_PLAN_CLASS);
Record_OutputToDB.Z2B_P = BooleanUtils.boolChar(Row_FeedRecord.Z2B_P);
    nb_line_tJavaRow_2++;   
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.PLAN_CATEGORY==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.PLAN_CATEGORY);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SEGMENT_CLASS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SEGMENT_CLASS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.SUPER_CLASS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.SUPER_CLASS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RATE_PLAN_KEY==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.RATE_PLAN_KEY);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ADDL_FEE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.DOUBLE);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setDouble(countertRedshiftOutput_1,Record_OutputToDB.ADDL_FEE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.ADDL_THRESHOLD==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.ADDL_THRESHOLD);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.FEE_FREQ==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.FEE_FREQ);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.RATE_PLAN_CLASS==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.RATE_PLAN_CLASS);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.Z2B_P==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.Z2B_P);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.RATE_PLAN_ID)
                        .c1(Record_OutputToDB.PLAN_CATEGORY)
                        .c2(Record_OutputToDB.ACTIVE_P)
                        .c3(Record_OutputToDB.CREATION_DATE)
                        .c4(Record_OutputToDB.LAST_MODIFIED)
                        .c5(Record_OutputToDB.DELETED_DATE)
                        .c6(Record_OutputToDB.SEGMENT_CLASS)
                        .c7(Record_OutputToDB.SUPER_CLASS)
                        .c8(Record_OutputToDB.PUBLIC_NAME)
                        .c9(Record_OutputToDB.RATE_PLAN_KEY)
                        .c10(Record_OutputToDB.ZIPFLEET_ID)
                        .c11(Record_OutputToDB.ADDL_FEE)
                        .c12(Record_OutputToDB.ADDL_THRESHOLD)
                        .c13(Record_OutputToDB.FEE)
                        .c14(Record_OutputToDB.FEE_FREQ)
                        .c15(Record_OutputToDB.NAME)
                        .c16(Record_OutputToDB.RATE_PLAN_CLASS)
                        .c17(Record_OutputToDB.Z2B_P)
				;
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                ...
                                After_Insert.PLAN_CATEGORY = Record_OutputToDB.PLAN_CATEGORY;
                                ...
                                After_Insert.SEGMENT_CLASS = Record_OutputToDB.SEGMENT_CLASS;
                                After_Insert.SUPER_CLASS = Record_OutputToDB.SUPER_CLASS;
                                After_Insert.PUBLIC_NAME = Record_OutputToDB.PUBLIC_NAME;
                                After_Insert.RATE_PLAN_KEY = Record_OutputToDB.RATE_PLAN_KEY;
                                After_Insert.ZIPFLEET_ID = Record_OutputToDB.ZIPFLEET_ID;
                                After_Insert.ADDL_FEE = Record_OutputToDB.ADDL_FEE;
                                After_Insert.ADDL_THRESHOLD = Record_OutputToDB.ADDL_THRESHOLD;
                                After_Insert.FEE = Record_OutputToDB.FEE;
                                After_Insert.FEE_FREQ = Record_OutputToDB.FEE_FREQ;
                                After_Insert.NAME = Record_OutputToDB.NAME;
                                After_Insert.RATE_PLAN_CLASS = Record_OutputToDB.RATE_PLAN_CLASS;
                                After_Insert.Z2B_P = Record_OutputToDB.Z2B_P;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.PLAN_CATEGORY = After_Insert.PLAN_CATEGORY;
               ...
               Log_Rows.SEGMENT_CLASS = After_Insert.SEGMENT_CLASS;
               Log_Rows.SUPER_CLASS = After_Insert.SUPER_CLASS;
               Log_Rows.PUBLIC_NAME = After_Insert.PUBLIC_NAME;
               Log_Rows.RATE_PLAN_KEY = After_Insert.RATE_PLAN_KEY;
               Log_Rows.ZIPFLEET_ID = After_Insert.ZIPFLEET_ID;
               Log_Rows.ADDL_FEE = After_Insert.ADDL_FEE;
               Log_Rows.ADDL_THRESHOLD = After_Insert.ADDL_THRESHOLD;
               Log_Rows.FEE = After_Insert.FEE;
               Log_Rows.FEE_FREQ = After_Insert.FEE_FREQ;
               Log_Rows.NAME = After_Insert.NAME;
               Log_Rows.RATE_PLAN_CLASS = After_Insert.RATE_PLAN_CLASS;
               Log_Rows.Z2B_P = After_Insert.Z2B_P;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"RATE_PLAN_ID\",\"PLAN_CATEGORY\",\"ACTIVE_P\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\",\"SEGMENT_CLASS\",\"SUPER_CLASS\",\"PUBLIC_NAME\",\"RATE_PLAN_KEY\",\"ZIPFLEET_ID\",\"ADDL_FEE\",\"ADDL_THRESHOLD\",\"FEE\",\"FEE_FREQ\",\"NAME\",\"RATE_PLAN_CLASS\",\"Z2B_P\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					...
					if(bufferLtRedshiftOutput_1.PLAN_CATEGORY==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.PLAN_CATEGORY);
					...
					if(bufferLtRedshiftOutput_1.SEGMENT_CLASS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SEGMENT_CLASS);
					...
					if(bufferLtRedshiftOutput_1.SUPER_CLASS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.SUPER_CLASS);
					...
					if(bufferLtRedshiftOutput_1.RATE_PLAN_KEY==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RATE_PLAN_KEY);
					...
					if(bufferLtRedshiftOutput_1.ADDL_FEE==null){
					...
					pstmt_tRedshiftOutput_1.setDouble(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ADDL_FEE);
					...
					if(bufferLtRedshiftOutput_1.ADDL_THRESHOLD==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.ADDL_THRESHOLD);
					...
					if(bufferLtRedshiftOutput_1.FEE_FREQ==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.FEE_FREQ);
					...
					if(bufferLtRedshiftOutput_1.RATE_PLAN_CLASS==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.RATE_PLAN_CLASS);
					...
					if(bufferLtRedshiftOutput_1.Z2B_P==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.Z2B_P);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.SEGMENT_CLASS = null;
					
							row1.SUPER_CLASS = null;
					
							row1.PUBLIC_NAME = null;
					
							row1.RATE_PLAN_KEY = null;
					
							row1.ZIPFLEET_ID = null;
					
							row1.ADDL_FEE = null;
					
							row1.ADDL_THRESHOLD = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.PLAN_CATEGORY = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SEGMENT_CLASS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.SUPER_CLASS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.RATE_PLAN_KEY = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ADDL_FEE = ParserUtils.parseTo_Double(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ADDL_THRESHOLD = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.FEE_FREQ = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.RATE_PLAN_CLASS = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.Z2B_P = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row2.PLAN_CATEGORY = StringUtils.trimToNull(row1.PLAN_CATEGORY);
...
row2.SEGMENT_CLASS = StringUtils.trimToNull(row1.SEGMENT_CLASS);
row2.SUPER_CLASS = StringUtils.trimToNull(row1.SUPER_CLASS);
row2.PUBLIC_NAME = StringUtils.trimToNull(row1.PUBLIC_NAME);
row2.RATE_PLAN_KEY = StringUtils.trimToNull(row1.RATE_PLAN_KEY);
row2.ZIPFLEET_ID = row1.ZIPFLEET_ID;
row2.ADDL_FEE = row1.ADDL_FEE;
row2.ADDL_THRESHOLD = row1.ADDL_THRESHOLD;
row2.FEE = row1.FEE;
row2.FEE_FREQ = StringUtils.trimToNull(row1.FEE_FREQ);
row2.NAME = StringUtils.trimToNull(row1.NAME);
row2.RATE_PLAN_CLASS = StringUtils.trimToNull(row1.RATE_PLAN_CLASS);
row2.Z2B_P = BooleanUtils.boolChar(row1.Z2B_P);
    nb_line_tJavaRow_3++;   
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[18];
                            rowtFileOutputDelimited_1[0]=row2.RATE_PLAN_ID == null ? null : String.valueOf(row2.RATE_PLAN_ID);
                            rowtFileOutputDelimited_1[1]=row2.PLAN_CATEGORY == null ? null : row2.PLAN_CATEGORY;
                            rowtFileOutputDelimited_1[2]=row2.ACTIVE_P == null ? null : row2.ACTIVE_P;
                            rowtFileOutputDelimited_1[3]=row2.CREATION_DATE == null ? null : FormatterUtils.format_Date(row2.CREATION_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[4]=row2.LAST_MODIFIED == null ? null : FormatterUtils.format_Date(row2.LAST_MODIFIED, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[5]=row2.DELETED_DATE == null ? null : FormatterUtils.format_Date(row2.DELETED_DATE, FeedFile.DF_DATETIME);
                            rowtFileOutputDelimited_1[6]=row2.SEGMENT_CLASS == null ? null : row2.SEGMENT_CLASS;
                            rowtFileOutputDelimited_1[7]=row2.SUPER_CLASS == null ? null : row2.SUPER_CLASS;
                            rowtFileOutputDelimited_1[8]=row2.PUBLIC_NAME == null ? null : row2.PUBLIC_NAME;
                            rowtFileOutputDelimited_1[9]=row2.RATE_PLAN_KEY == null ? null : row2.RATE_PLAN_KEY;
                            rowtFileOutputDelimited_1[10]=row2.ZIPFLEET_ID == null ? null : String.valueOf(row2.ZIPFLEET_ID);
                            rowtFileOutputDelimited_1[11]=row2.ADDL_FEE == null ? null : String.valueOf(row2.ADDL_FEE);
                            rowtFileOutputDelimited_1[12]=row2.ADDL_THRESHOLD == null ? null : String.valueOf(row2.ADDL_THRESHOLD);
                            rowtFileOutputDelimited_1[13]=row2.FEE == null ? null : String.valueOf(row2.FEE);
                            rowtFileOutputDelimited_1[14]=row2.FEE_FREQ == null ? null : row2.FEE_FREQ;
                            rowtFileOutputDelimited_1[15]=row2.NAME == null ? null : row2.NAME;
                            rowtFileOutputDelimited_1[16]=row2.RATE_PLAN_CLASS == null ? null : row2.RATE_PLAN_CLASS;
                            rowtFileOutputDelimited_1[17]=row2.Z2B_P == null ? null : row2.Z2B_P;
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_RatePlans StageFeed_RatePlansClass = new StageFeed_RatePlans();

        int exitCode = StageFeed_RatePlansClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_RatePlans.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_rateplans_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_RatePlans");
        }
...
/************************************************************************************************
 *     379167 characters generated by Talend Open Studio for Data Integration 
