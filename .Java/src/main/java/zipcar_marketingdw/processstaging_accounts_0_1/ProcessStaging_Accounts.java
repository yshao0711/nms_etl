...
package zipcar_marketingdw.processstaging_accounts_0_1;
...
/**
 * Job: ProcessStaging_Accounts Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_Accounts implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_Accounts";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_LHRUcDWVEeeS5dX18WtAYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_Accounts.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_Accounts.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_Accounts) {
...
"\nINSERT INTO {{marketing.schema}}.r_account\n(\n    account_id,\n    account_type,\n    first_account_admin_id,\n    primary_billing_address_id,\n    service_account_p,\n    zipfleet_id,\n	account_name,\n	local_next_fee_date,\n	settlement_dom,\n    imported_date\n)\nSELECT \n    account_id,\n    account_type,\n    first_account_admin_id,\n    primary_billing_address_id,\n    service_account_p,\n    zipfleet_id,\n	account_name,\n	local_next_fee_date,\n	settlement_dom,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.accounts\nMINUS\nSELECT \n    account_id,\n    account_type,\n    first_account_admin_id,\n    primary_billing_address_id,\n    service_account_p,\n    zipfleet_id,\n	account_name,\n	local_next_fee_date,\n	settlement_dom,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_account\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".accounts";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_Accounts ProcessStaging_AccountsClass = new ProcessStaging_Accounts();

        int exitCode = ProcessStaging_AccountsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_Accounts.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_accounts_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_Accounts");
        }
...
/************************************************************************************************
 *     135919 characters generated by Talend Open Studio for Data Integration 
