...
package zipcar_marketingdw.stagefeed_communities_np_0_1;
...
/**
 * Job: StageFeed_Communities_NP Purpose: Stage the Feed files from NP<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_Communities_NP implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_Communities_NP";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_k6pGUKrmEeiSS9daonsVPw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_Communities_NP.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_Communities_NP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP) {
...
globalMap.put("currentFeed", FeedFile.FileType.COMMUNITIES_NP);
...
end_Hash.put("tFileList_2", System.currentTimeMillis());
   			...
   			if (((Integer)globalMap.get("tFileList_2_NB_FILE")) == 0) {
...
globalMap.put("fileName", (String)globalMap.get("tFileList_1_CURRENT_FILE"));
globalMap.put("cleanedFileName", FeedFile.getCleanFeedFileName((String)globalMap.get("fileName")));
globalMap.put("filePath", (String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public Long parent_community_id;

				public Long getParent_community_id () {
					return this.parent_community_id;
				}
				...
				public String getDefault_booking_type () {
					return this.default_booking_type;
				}
				
			    public String allow_tap_and_go;

				public String getAllow_tap_and_go () {
					return this.allow_tap_and_go;
				}
				
			    public String show_gps_during_ride;

				public String getShow_gps_during_ride () {
					return this.show_gps_during_ride;
				}
				
			    public Short early_start_grace_minutes;

				public Short getEarly_start_grace_minutes () {
					return this.early_start_grace_minutes;
				}
				
			    public String sleep_enabled;

				public String getSleep_enabled () {
					return this.sleep_enabled;
				}
				
			    public String sleep_begin_hour;

				public String getSleep_begin_hour () {
					return this.sleep_begin_hour;
				}
				
			    public String sleep_end_hour;

				public String getSleep_end_hour () {
					return this.sleep_end_hour;
				}
				
			    public String sleep_weekends;

				public String getSleep_weekends () {
					return this.sleep_weekends;
				}
				
			    public Short sleep_percent_cars;

				public Short getSleep_percent_cars () {
					return this.sleep_percent_cars;
				}
				
			    public String allow_floating;

				public String getAllow_floating () {
					return this.allow_floating;
				}
				
			    public Short on_demand_auto_cancel_minutes;

				public Short getOn_demand_auto_cancel_minutes () {
					return this.on_demand_auto_cancel_minutes;
				}
				
			    public Short overbook_limit_percent;

				public Short getOverbook_limit_percent () {
					return this.overbook_limit_percent;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.community_id;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.community_id = this.community_id;
	            other.community_name = this.community_name;
	            other.active = this.active;
	            other.timezone = this.timezone;
	            other.parent_community_id = this.parent_community_id;
	            other.locale = this.locale;
	            other.currency_code = this.currency_code;
	            other.default_booking_type = this.default_booking_type;
	            other.allow_tap_and_go = this.allow_tap_and_go;
	            other.show_gps_during_ride = this.show_gps_during_ride;
	            other.early_start_grace_minutes = this.early_start_grace_minutes;
	            other.sleep_enabled = this.sleep_enabled;
	            other.sleep_begin_hour = this.sleep_begin_hour;
	            other.sleep_end_hour = this.sleep_end_hour;
	            other.sleep_weekends = this.sleep_weekends;
	            other.sleep_percent_cars = this.sleep_percent_cars;
	            other.allow_floating = this.allow_floating;
	            other.on_demand_auto_cancel_minutes = this.on_demand_auto_cancel_minutes;
	            other.overbook_limit_percent = this.overbook_limit_percent;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.community_id = dis.readLong();
					
					this.community_name = readString(dis);
					...
					this.timezone = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.parent_community_id = null;
           				} else {
           			    	this.parent_community_id = dis.readLong();
           				}
					...
					this.default_booking_type = readString(dis);
					
					this.allow_tap_and_go = readString(dis);
					
					this.show_gps_during_ride = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.early_start_grace_minutes = null;
           				} else {
           			    	this.early_start_grace_minutes = dis.readShort();
           				}
					
					this.sleep_enabled = readString(dis);
					
					this.sleep_begin_hour = readString(dis);
					
					this.sleep_end_hour = readString(dis);
					
					this.sleep_weekends = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.sleep_percent_cars = null;
           				} else {
           			    	this.sleep_percent_cars = dis.readShort();
           				}
					
					this.allow_floating = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.on_demand_auto_cancel_minutes = null;
           				} else {
           			    	this.on_demand_auto_cancel_minutes = dis.readShort();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.overbook_limit_percent = null;
           				} else {
           			    	this.overbook_limit_percent = dis.readShort();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// long
		            	...
		            	dos.writeLong(this.community_id);
					
					// String
				
						writeString(this.community_name,dos);
					...
					// Long
						...
						if(this.parent_community_id == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.parent_community_id);
		            	}
					...
					// String
						...
						writeString(this.default_booking_type,dos);
					
					// String
				
						writeString(this.allow_tap_and_go,dos);
					
					// String
				
						writeString(this.show_gps_during_ride,dos);
					
					// Short
				
						if(this.early_start_grace_minutes == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeShort(this.early_start_grace_minutes);
		            	}
					
					// String
				
						writeString(this.sleep_enabled,dos);
					
					// String
				
						writeString(this.sleep_begin_hour,dos);
					
					// String
				
						writeString(this.sleep_end_hour,dos);
					
					// String
				
						writeString(this.sleep_weekends,dos);
					
					// Short
				
						if(this.sleep_percent_cars == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeShort(this.sleep_percent_cars);
		            	}
					
					// String
				
						writeString(this.allow_floating,dos);
					
					// Short
				
						if(this.on_demand_auto_cancel_minutes == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeShort(this.on_demand_auto_cancel_minutes);
		            	}
					
					// Short
				
						if(this.overbook_limit_percent == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeShort(this.overbook_limit_percent);
		            	}
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("community_id="+String.valueOf(community_id));
		sb.append(",community_name="+community_name);
		sb.append(",active="+active);
		sb.append(",timezone="+timezone);
		sb.append(",parent_community_id="+String.valueOf(parent_community_id));
		sb.append(",locale="+locale);
		sb.append(",currency_code="+currency_code);
		sb.append(",default_booking_type="+default_booking_type);
		sb.append(",allow_tap_and_go="+allow_tap_and_go);
		sb.append(",show_gps_during_ride="+show_gps_during_ride);
		sb.append(",early_start_grace_minutes="+String.valueOf(early_start_grace_minutes));
		sb.append(",sleep_enabled="+sleep_enabled);
		sb.append(",sleep_begin_hour="+sleep_begin_hour);
		sb.append(",sleep_end_hour="+sleep_end_hour);
		sb.append(",sleep_weekends="+sleep_weekends);
		sb.append(",sleep_percent_cars="+String.valueOf(sleep_percent_cars));
		sb.append(",allow_floating="+allow_floating);
		sb.append(",on_demand_auto_cancel_minutes="+String.valueOf(on_demand_auto_cancel_minutes));
		sb.append(",overbook_limit_percent="+String.valueOf(overbook_limit_percent));
	    sb.append("]");
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.community_id, other.community_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
	            		...
	            		public BufferLine_tRedshiftOutput_1 c0(long community_id){
							this.community_id = community_id;
							return this;
						}				
						String community_name;
						
	            		public BufferLine_tRedshiftOutput_1 c1(String community_name){
							this.community_name = community_name;
							return this;
						}				
						String active;
						
	            		public BufferLine_tRedshiftOutput_1 c2(String active){
							this.active = active;
							return this;
						}				
						String timezone;
						
	            		public BufferLine_tRedshiftOutput_1 c3(String timezone){
							this.timezone = timezone;
							return this;
						}				
						Long parent_community_id;
						
	            		public BufferLine_tRedshiftOutput_1 c4(Long parent_community_id){
							this.parent_community_id = parent_community_id;
							return this;
						}				
						String locale;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String locale){
							this.locale = locale;
							return this;
						}				
						String currency_code;
						
	            		public BufferLine_tRedshiftOutput_1 c6(String currency_code){
							this.currency_code = currency_code;
							return this;
						}				
						String default_booking_type;
						
	            		public BufferLine_tRedshiftOutput_1 c7(String default_booking_type){
							this.default_booking_type = default_booking_type;
							return this;
						}				
						String allow_tap_and_go;
						
	            		public BufferLine_tRedshiftOutput_1 c8(String allow_tap_and_go){
							this.allow_tap_and_go = allow_tap_and_go;
							return this;
						}				
						String show_gps_during_ride;
						
	            		public BufferLine_tRedshiftOutput_1 c9(String show_gps_during_ride){
							this.show_gps_during_ride = show_gps_during_ride;
							return this;
						}				
						Short early_start_grace_minutes;
						
	            		public BufferLine_tRedshiftOutput_1 c10(Short early_start_grace_minutes){
							this.early_start_grace_minutes = early_start_grace_minutes;
							return this;
						}				
						String sleep_enabled;
						
	            		public BufferLine_tRedshiftOutput_1 c11(String sleep_enabled){
							this.sleep_enabled = sleep_enabled;
							return this;
						}				
						String sleep_begin_hour;
						
	            		public BufferLine_tRedshiftOutput_1 c12(String sleep_begin_hour){
							this.sleep_begin_hour = sleep_begin_hour;
							return this;
						}				
						String sleep_end_hour;
						
	            		public BufferLine_tRedshiftOutput_1 c13(String sleep_end_hour){
							this.sleep_end_hour = sleep_end_hour;
							return this;
						}				
						String sleep_weekends;
						
	            		public BufferLine_tRedshiftOutput_1 c14(String sleep_weekends){
							this.sleep_weekends = sleep_weekends;
							return this;
						}				
						Short sleep_percent_cars;
						
	            		public BufferLine_tRedshiftOutput_1 c15(Short sleep_percent_cars){
							this.sleep_percent_cars = sleep_percent_cars;
							return this;
						}				
						String allow_floating;
						
	            		public BufferLine_tRedshiftOutput_1 c16(String allow_floating){
							this.allow_floating = allow_floating;
							return this;
						}				
						Short on_demand_auto_cancel_minutes;
						
	            		public BufferLine_tRedshiftOutput_1 c17(Short on_demand_auto_cancel_minutes){
							this.on_demand_auto_cancel_minutes = on_demand_auto_cancel_minutes;
							return this;
						}				
						Short overbook_limit_percent;
						
	            		public BufferLine_tRedshiftOutput_1 c18(Short overbook_limit_percent){
							this.overbook_limit_percent = overbook_limit_percent;
							return this;
						}		
			}
			...
			for(int i_tRedshiftOutput_1=0;i_tRedshiftOutput_1 < 1500;i_tRedshiftOutput_1++){
				 extendInsertValueStmt_tRedshiftOutput_1.append("(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				 if (i_tRedshiftOutput_1!=1500-1) extendInsertValueStmt_tRedshiftOutput_1.append(",");
			}

			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"community_id\",\"community_name\",\"active\",\"timezone\",\"parent_community_id\",\"locale\",\"currency_code\",\"default_booking_type\",\"allow_tap_and_go\",\"show_gps_during_ride\",\"early_start_grace_minutes\",\"sleep_enabled\",\"sleep_begin_hour\",\"sleep_end_hour\",\"sleep_weekends\",\"sleep_percent_cars\",\"allow_floating\",\"on_demand_auto_cancel_minutes\",\"overbook_limit_percent\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.community_id = 0;
					
							Row_FeedRecord.community_name = null;
					
							Row_FeedRecord.active = null;
					
							Row_FeedRecord.timezone = null;
					
							Row_FeedRecord.parent_community_id = null;
					
							Row_FeedRecord.locale = null;
					
							Row_FeedRecord.currency_code = null;
					
							Row_FeedRecord.default_booking_type = null;
					
							Row_FeedRecord.allow_tap_and_go = null;
					
							Row_FeedRecord.show_gps_during_ride = null;
					
							Row_FeedRecord.early_start_grace_minutes = null;
					
							Row_FeedRecord.sleep_enabled = null;
					
							Row_FeedRecord.sleep_begin_hour = null;
					
							Row_FeedRecord.sleep_end_hour = null;
					
							Row_FeedRecord.sleep_weekends = null;
					
							Row_FeedRecord.sleep_percent_cars = null;
					
							Row_FeedRecord.allow_floating = null;
					
							Row_FeedRecord.on_demand_auto_cancel_minutes = null;
					
							Row_FeedRecord.overbook_limit_percent = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.community_id = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'community_id' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.community_name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.active = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.timezone = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.parent_community_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.locale = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.currency_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.default_booking_type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.allow_tap_and_go = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.show_gps_during_ride = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.early_start_grace_minutes = ParserUtils.parseTo_Short(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.sleep_enabled = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.sleep_begin_hour = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.sleep_end_hour = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.sleep_weekends = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.sleep_percent_cars = ParserUtils.parseTo_Short(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.allow_floating = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.on_demand_auto_cancel_minutes = ParserUtils.parseTo_Short(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.overbook_limit_percent = ParserUtils.parseTo_Short(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
Record_OutputToDB.community_id = Row_FeedRecord.community_id;
Record_OutputToDB.community_name = StringUtils.trimToNull(Row_FeedRecord.community_name);
Record_OutputToDB.active = BooleanUtils.boolChar(Row_FeedRecord.active);
Record_OutputToDB.timezone = StringUtils.trimToNull(Row_FeedRecord.timezone);
Record_OutputToDB.parent_community_id = Row_FeedRecord.parent_community_id;
Record_OutputToDB.locale = StringUtils.trimToNull(Row_FeedRecord.locale);
Record_OutputToDB.currency_code = StringUtils.trimToNull(Row_FeedRecord.currency_code);
Record_OutputToDB.default_booking_type = StringUtils.trimToNull(Row_FeedRecord.default_booking_type);
Record_OutputToDB.allow_tap_and_go = BooleanUtils.boolChar(Row_FeedRecord.allow_tap_and_go);
Record_OutputToDB.show_gps_during_ride = BooleanUtils.boolChar(Row_FeedRecord.show_gps_during_ride);
Record_OutputToDB.early_start_grace_minutes = Row_FeedRecord.early_start_grace_minutes;
Record_OutputToDB.sleep_enabled = BooleanUtils.boolChar(Row_FeedRecord.sleep_enabled);
Record_OutputToDB.sleep_begin_hour = StringUtils.trimToNull(Row_FeedRecord.sleep_begin_hour);
Record_OutputToDB.sleep_end_hour = StringUtils.trimToNull(Row_FeedRecord.sleep_end_hour);
Record_OutputToDB.sleep_weekends = BooleanUtils.boolChar(Row_FeedRecord.sleep_weekends);
Record_OutputToDB.sleep_percent_cars = Row_FeedRecord.sleep_percent_cars;
Record_OutputToDB.allow_floating = BooleanUtils.boolChar(Row_FeedRecord.allow_floating);
Record_OutputToDB.on_demand_auto_cancel_minutes = Row_FeedRecord.on_demand_auto_cancel_minutes;
Record_OutputToDB.overbook_limit_percent = Row_FeedRecord.overbook_limit_percent;
    nb_line_tJavaRow_2++;   
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.community_id);
							
						countertRedshiftOutput_1++;
						

						
							if(Record_OutputToDB.community_name==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.community_name);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.active==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.active);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.timezone==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.timezone);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.parent_community_id==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.parent_community_id);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.locale==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.locale);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.currency_code==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.currency_code);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.default_booking_type==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.default_booking_type);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.allow_tap_and_go==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.allow_tap_and_go);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.show_gps_during_ride==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.show_gps_during_ride);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.early_start_grace_minutes==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setShort(countertRedshiftOutput_1,Record_OutputToDB.early_start_grace_minutes);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.sleep_enabled==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.sleep_enabled);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.sleep_begin_hour==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.sleep_begin_hour);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.sleep_end_hour==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.sleep_end_hour);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.sleep_weekends==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.sleep_weekends);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.sleep_percent_cars==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setShort(countertRedshiftOutput_1,Record_OutputToDB.sleep_percent_cars);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.allow_floating==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.allow_floating);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.on_demand_auto_cancel_minutes==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setShort(countertRedshiftOutput_1,Record_OutputToDB.on_demand_auto_cancel_minutes);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.overbook_limit_percent==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.INTEGER);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setShort(countertRedshiftOutput_1,Record_OutputToDB.overbook_limit_percent);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.community_id)
                        .c1(Record_OutputToDB.community_name)
                        .c2(Record_OutputToDB.active)
                        .c3(Record_OutputToDB.timezone)
                        .c4(Record_OutputToDB.parent_community_id)
                        .c5(Record_OutputToDB.locale)
                        .c6(Record_OutputToDB.currency_code)
                        .c7(Record_OutputToDB.default_booking_type)
                        .c8(Record_OutputToDB.allow_tap_and_go)
                        .c9(Record_OutputToDB.show_gps_during_ride)
                        .c10(Record_OutputToDB.early_start_grace_minutes)
                        .c11(Record_OutputToDB.sleep_enabled)
                        .c12(Record_OutputToDB.sleep_begin_hour)
                        .c13(Record_OutputToDB.sleep_end_hour)
                        .c14(Record_OutputToDB.sleep_weekends)
                        .c15(Record_OutputToDB.sleep_percent_cars)
                        .c16(Record_OutputToDB.allow_floating)
                        .c17(Record_OutputToDB.on_demand_auto_cancel_minutes)
                        .c18(Record_OutputToDB.overbook_limit_percent)
				;
				...
				if(rowCounttRedshiftOutput_1 == 1500){
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.community_id = Record_OutputToDB.community_id;
                                After_Insert.community_name = Record_OutputToDB.community_name;
                                After_Insert.active = Record_OutputToDB.active;
                                After_Insert.timezone = Record_OutputToDB.timezone;
                                After_Insert.parent_community_id = Record_OutputToDB.parent_community_id;
                                After_Insert.locale = Record_OutputToDB.locale;
                                After_Insert.currency_code = Record_OutputToDB.currency_code;
                                After_Insert.default_booking_type = Record_OutputToDB.default_booking_type;
                                After_Insert.allow_tap_and_go = Record_OutputToDB.allow_tap_and_go;
                                After_Insert.show_gps_during_ride = Record_OutputToDB.show_gps_during_ride;
                                After_Insert.early_start_grace_minutes = Record_OutputToDB.early_start_grace_minutes;
                                After_Insert.sleep_enabled = Record_OutputToDB.sleep_enabled;
                                After_Insert.sleep_begin_hour = Record_OutputToDB.sleep_begin_hour;
                                After_Insert.sleep_end_hour = Record_OutputToDB.sleep_end_hour;
                                After_Insert.sleep_weekends = Record_OutputToDB.sleep_weekends;
                                After_Insert.sleep_percent_cars = Record_OutputToDB.sleep_percent_cars;
                                After_Insert.allow_floating = Record_OutputToDB.allow_floating;
                                After_Insert.on_demand_auto_cancel_minutes = Record_OutputToDB.on_demand_auto_cancel_minutes;
                                After_Insert.overbook_limit_percent = Record_OutputToDB.overbook_limit_percent;
            }
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.community_name = After_Insert.community_name;
               Log_Rows.active = After_Insert.active;
               Log_Rows.timezone = After_Insert.timezone;
               Log_Rows.parent_community_id = After_Insert.parent_community_id;
               Log_Rows.locale = After_Insert.locale;
               Log_Rows.currency_code = After_Insert.currency_code;
               Log_Rows.default_booking_type = After_Insert.default_booking_type;
               Log_Rows.allow_tap_and_go = After_Insert.allow_tap_and_go;
               Log_Rows.show_gps_during_ride = After_Insert.show_gps_during_ride;
               Log_Rows.early_start_grace_minutes = After_Insert.early_start_grace_minutes;
               Log_Rows.sleep_enabled = After_Insert.sleep_enabled;
               Log_Rows.sleep_begin_hour = After_Insert.sleep_begin_hour;
               Log_Rows.sleep_end_hour = After_Insert.sleep_end_hour;
               Log_Rows.sleep_weekends = After_Insert.sleep_weekends;
               Log_Rows.sleep_percent_cars = After_Insert.sleep_percent_cars;
               Log_Rows.allow_floating = After_Insert.allow_floating;
               Log_Rows.on_demand_auto_cancel_minutes = After_Insert.on_demand_auto_cancel_minutes;
               Log_Rows.overbook_limit_percent = After_Insert.overbook_limit_percent;    
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"community_id\",\"community_name\",\"active\",\"timezone\",\"parent_community_id\",\"locale\",\"currency_code\",\"default_booking_type\",\"allow_tap_and_go\",\"show_gps_during_ride\",\"early_start_grace_minutes\",\"sleep_enabled\",\"sleep_begin_hour\",\"sleep_end_hour\",\"sleep_weekends\",\"sleep_percent_cars\",\"allow_floating\",\"on_demand_auto_cancel_minutes\",\"overbook_limit_percent\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.community_id);
					
	                    counttRedshiftOutput_1++;
	                    
					if(bufferLtRedshiftOutput_1.community_name==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.community_name);
					...
					if(bufferLtRedshiftOutput_1.active==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.active);
					...
					if(bufferLtRedshiftOutput_1.timezone==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.timezone);
					...
					if(bufferLtRedshiftOutput_1.parent_community_id==null){
					...
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.parent_community_id);
					...
					if(bufferLtRedshiftOutput_1.locale==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.locale);
					...
					if(bufferLtRedshiftOutput_1.currency_code==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.currency_code);
					...
					if(bufferLtRedshiftOutput_1.default_booking_type==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.default_booking_type);
					...
					if(bufferLtRedshiftOutput_1.allow_tap_and_go==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.allow_tap_and_go);
					...
					if(bufferLtRedshiftOutput_1.show_gps_during_ride==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.show_gps_during_ride);
					...
					if(bufferLtRedshiftOutput_1.early_start_grace_minutes==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setShort(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.early_start_grace_minutes);
					...
					if(bufferLtRedshiftOutput_1.sleep_enabled==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.sleep_enabled);
					...
					if(bufferLtRedshiftOutput_1.sleep_begin_hour==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.sleep_begin_hour);
					...
					if(bufferLtRedshiftOutput_1.sleep_end_hour==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.sleep_end_hour);
					...
					if(bufferLtRedshiftOutput_1.sleep_weekends==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.sleep_weekends);
					...
					if(bufferLtRedshiftOutput_1.sleep_percent_cars==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setShort(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.sleep_percent_cars);
					...
					if(bufferLtRedshiftOutput_1.allow_floating==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.allow_floating);
					...
					if(bufferLtRedshiftOutput_1.on_demand_auto_cancel_minutes==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setShort(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.on_demand_auto_cancel_minutes);
					...
					if(bufferLtRedshiftOutput_1.overbook_limit_percent==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.INTEGER);
					...
					pstmt_tRedshiftOutput_1.setShort(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.overbook_limit_percent);
...
public static class file_successStruct implements routines.system.IPersistableRow<file_successStruct> {
    ...
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_Communities_NP = new byte[0];
			    ...
			    public Long FIRST_ACCOUNT_ADMIN_ID;

				public Long getFIRST_ACCOUNT_ADMIN_ID () {
					return this.FIRST_ACCOUNT_ADMIN_ID;
				}
				
			    public Long PRIMARY_BILLING_ADDRESS_ID;

				public Long getPRIMARY_BILLING_ADDRESS_ID () {
					return this.PRIMARY_BILLING_ADDRESS_ID;
				}
				
			    public String SERVICE_ACCOUNT_P;

				public String getSERVICE_ACCOUNT_P () {
					return this.SERVICE_ACCOUNT_P;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ACCOUNT_TYPE = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.FIRST_ACCOUNT_ADMIN_ID = null;
           				} else {
           			    	this.FIRST_ACCOUNT_ADMIN_ID = dis.readLong();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.PRIMARY_BILLING_ADDRESS_ID = dis.readLong();
           				}
					
					this.SERVICE_ACCOUNT_P = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.FIRST_ACCOUNT_ADMIN_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.FIRST_ACCOUNT_ADMIN_ID);
		            	}
					
					// Long
				
						if(this.PRIMARY_BILLING_ADDRESS_ID == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.PRIMARY_BILLING_ADDRESS_ID);
		            	}
					
					// String
				
						writeString(this.SERVICE_ACCOUNT_P,dos);
    ...
    public String toString() {
		...
		sb.append(",FIRST_ACCOUNT_ADMIN_ID="+String.valueOf(FIRST_ACCOUNT_ADMIN_ID));
		sb.append(",PRIMARY_BILLING_ADDRESS_ID="+String.valueOf(PRIMARY_BILLING_ADDRESS_ID));
		sb.append(",SERVICE_ACCOUNT_P="+SERVICE_ACCOUNT_P);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.community_name = null;
					
							row1.active = null;
					
							row1.timezone = null;
					
							row1.parent_community_id = null;
					
							row1.locale = null;
					
							row1.currency_code = null;
					
							row1.default_booking_type = null;
					
							row1.allow_tap_and_go = null;
					
							row1.show_gps_during_ride = null;
					
							row1.early_start_grace_minutes = null;
					
							row1.sleep_enabled = null;
					
							row1.sleep_begin_hour = null;
					
							row1.sleep_end_hour = null;
					
							row1.sleep_weekends = null;
					
							row1.sleep_percent_cars = null;
					
							row1.allow_floating = null;
					
							row1.on_demand_auto_cancel_minutes = null;
					
							row1.overbook_limit_percent = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.community_id = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'community_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.community_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.active = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.timezone = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.parent_community_id = ParserUtils.parseTo_Long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.locale = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.currency_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.default_booking_type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.allow_tap_and_go = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.show_gps_during_ride = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.early_start_grace_minutes = ParserUtils.parseTo_Short(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.sleep_enabled = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.sleep_begin_hour = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.sleep_end_hour = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.sleep_weekends = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.sleep_percent_cars = ParserUtils.parseTo_Short(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.allow_floating = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.on_demand_auto_cancel_minutes = ParserUtils.parseTo_Short(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.overbook_limit_percent = ParserUtils.parseTo_Short(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
row2.community_name = StringUtils.trimToNull(row1.community_name);
row2.active = BooleanUtils.boolChar(row1.active);
row2.timezone = StringUtils.trimToNull(row1.timezone);
row2.parent_community_id = row1.parent_community_id;
row2.locale = StringUtils.trimToNull(row1.locale);
row2.currency_code = StringUtils.trimToNull(row1.currency_code);
row2.default_booking_type = StringUtils.trimToNull(row1.default_booking_type);
row2.allow_tap_and_go = BooleanUtils.boolChar(row1.allow_tap_and_go);
row2.show_gps_during_ride = BooleanUtils.boolChar(row1.show_gps_during_ride);
row2.early_start_grace_minutes = row1.early_start_grace_minutes;
row2.sleep_enabled = BooleanUtils.boolChar(row1.sleep_enabled);
row2.sleep_begin_hour = StringUtils.trimToNull(row1.sleep_begin_hour);
row2.sleep_end_hour = StringUtils.trimToNull(row1.sleep_end_hour);
row2.sleep_weekends = BooleanUtils.boolChar(row1.sleep_weekends);
row2.sleep_percent_cars = row1.sleep_percent_cars;
row2.allow_floating = BooleanUtils.boolChar(row1.allow_floating);
row2.on_demand_auto_cancel_minutes = row1.on_demand_auto_cancel_minutes;
row2.overbook_limit_percent = row1.overbook_limit_percent;
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[19];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.community_id);
                            rowtFileOutputDelimited_1[1]=row2.community_name == null ? null : row2.community_name;
                            rowtFileOutputDelimited_1[2]=row2.active == null ? null : row2.active;
                            rowtFileOutputDelimited_1[3]=row2.timezone == null ? null : row2.timezone;
                            rowtFileOutputDelimited_1[4]=row2.parent_community_id == null ? null : String.valueOf(row2.parent_community_id);
                            rowtFileOutputDelimited_1[5]=row2.locale == null ? null : row2.locale;
                            rowtFileOutputDelimited_1[6]=row2.currency_code == null ? null : row2.currency_code;
                            rowtFileOutputDelimited_1[7]=row2.default_booking_type == null ? null : row2.default_booking_type;
                            rowtFileOutputDelimited_1[8]=row2.allow_tap_and_go == null ? null : row2.allow_tap_and_go;
                            rowtFileOutputDelimited_1[9]=row2.show_gps_during_ride == null ? null : row2.show_gps_during_ride;
                            rowtFileOutputDelimited_1[10]=row2.early_start_grace_minutes == null ? null : String.valueOf(row2.early_start_grace_minutes);
                            rowtFileOutputDelimited_1[11]=row2.sleep_enabled == null ? null : row2.sleep_enabled;
                            rowtFileOutputDelimited_1[12]=row2.sleep_begin_hour == null ? null : row2.sleep_begin_hour;
                            rowtFileOutputDelimited_1[13]=row2.sleep_end_hour == null ? null : row2.sleep_end_hour;
                            rowtFileOutputDelimited_1[14]=row2.sleep_weekends == null ? null : row2.sleep_weekends;
                            rowtFileOutputDelimited_1[15]=row2.sleep_percent_cars == null ? null : String.valueOf(row2.sleep_percent_cars);
                            rowtFileOutputDelimited_1[16]=row2.allow_floating == null ? null : row2.allow_floating;
                            rowtFileOutputDelimited_1[17]=row2.on_demand_auto_cancel_minutes == null ? null : String.valueOf(row2.on_demand_auto_cancel_minutes);
                            rowtFileOutputDelimited_1[18]=row2.overbook_limit_percent == null ? null : String.valueOf(row2.overbook_limit_percent);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_Communities_NP StageFeed_Communities_NPClass = new StageFeed_Communities_NP();

        int exitCode = StageFeed_Communities_NPClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_Communities_NP.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_communities_np_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_Communities_NP");
        }
...
/************************************************************************************************
 *     378956 characters generated by Talend Open Studio for Data Integration 
