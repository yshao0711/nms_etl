...
package zipcar_marketingdw.processstaging_strongviewdownloadfiles_0_1;
...
/**
 * Job: ProcessStaging_StrongviewDownloadFiles Purpose: ETL the Staging Table into the DB<br>
 * Description: Load the Staging Tables into the Marketing DB. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class ProcessStaging_StrongviewDownloadFiles implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "ProcessStaging_StrongviewDownloadFiles";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Y0m2oMsQEeeWvJmMpPutVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProcessStaging_StrongviewDownloadFiles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProcessStaging_StrongviewDownloadFiles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_ProcessStaging_StrongviewDownloadFiles) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "strongview_download_files";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "r_strongview_download_file";
		if(obj_tRunJob_1!=null) {
...
"\nINSERT INTO {{marketing.schema}}.r_strongview_download_file\n(\n	fileid,\n	filename,\n	file_creation_dt,\n	collectdate,\n	loaded_p,\n	loaddate,\n	error,\n	errorcount,\n	creation_date,\n	last_modified,\n	deleted_date,\n    imported_date\n)\nSELECT \n	fileid,\n	filename,\n	file_creation_dt,\n	collectdate,\n	loaded_p,\n	loaddate,\n	error,\n	errorcount,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{staging.schema}}.strongview_download_files\nMINUS\nSELECT \n	fileid,\n	filename,\n	file_creation_dt,\n	collectdate,\n	loaded_p,\n	loaddate,\n	error,\n	errorcount,\n	creation_date,\n	last_modified,\n	deleted_date,\n    to_date({{rundate}}, 'yyyy-MM-dd') as imported_date\nFROM {{marketing.schema}}.vw_r_strongview_download_file\n",
...
query_tRedshiftRow_3 = "truncate table " + context.Redshift_Staging_Schema + ".strongview_download_files";
 ...
 */
    ...
    public static void main(String[] args){
        final ProcessStaging_StrongviewDownloadFiles ProcessStaging_StrongviewDownloadFilesClass = new ProcessStaging_StrongviewDownloadFiles();

        int exitCode = ProcessStaging_StrongviewDownloadFilesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProcessStaging_StrongviewDownloadFiles.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/processstaging_strongviewdownloadfiles_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessStaging_StrongviewDownloadFiles");
        }
...
/************************************************************************************************
 *     136382 characters generated by Talend Open Studio for Data Integration 
