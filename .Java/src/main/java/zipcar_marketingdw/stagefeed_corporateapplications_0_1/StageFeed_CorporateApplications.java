...
package zipcar_marketingdw.stagefeed_corporateapplications_0_1;
...
/**
 * Job: StageFeed_CorporateApplications Purpose: Stage the Feed files<br>
 * Description: Load the Feed Files and Stage into its staging table. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class StageFeed_CorporateApplications implements TalendJob {
...
public String getRedshift_Staging_Server(){
	...
	private final String jobName = "StageFeed_CorporateApplications";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_-cCPoBfrEeirWMBnHQG66g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StageFeed_CorporateApplications.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StageFeed_CorporateApplications.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(FeedFile.FileType.CORPORATE_APPLICATIONS.filePattern());  
...
globalMap.put("tableName", FeedFile.FileType.CORPORATE_APPLICATIONS.toString());
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		tables_to_clear.tableName = context.Redshift_Staging_Schema + "." + FeedFile.FileType.CORPORATE_APPLICATIONS;
...
public static class Log_RowsStruct implements routines.system.IPersistableRow<Log_RowsStruct> {
    ...
    public String loopKey;
			    ...
			    public long CORPORATE_APPLICATION_ID;

				public long getCORPORATE_APPLICATION_ID () {
					return this.CORPORATE_APPLICATION_ID;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.CORPORATE_APPLICATION_ID;
	...
	public boolean equals(Object obj) {
		...
		final Log_RowsStruct other = (Log_RowsStruct) obj;
						...
						if (this.CORPORATE_APPLICATION_ID != other.CORPORATE_APPLICATION_ID)
							return false;
	...
	public void copyDataTo(Log_RowsStruct other) {
		...
		other.CORPORATE_APPLICATION_ID = this.CORPORATE_APPLICATION_ID;
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_StageFeed_CorporateApplications) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.CORPORATE_APPLICATION_ID = dis.readLong();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// long
		            	...
		            	dos.writeLong(this.CORPORATE_APPLICATION_ID);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("CORPORATE_APPLICATION_ID="+String.valueOf(CORPORATE_APPLICATION_ID));
    ...
    public int compareTo(Log_RowsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.CORPORATE_APPLICATION_ID, other.CORPORATE_APPLICATION_ID);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tRedshiftOutput_1=0;
			...
			class BufferLine_tRedshiftOutput_1 {				
						long CORPORATE_APPLICATION_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c0(long CORPORATE_APPLICATION_ID){
							this.CORPORATE_APPLICATION_ID = CORPORATE_APPLICATION_ID;
							return this;
						}				
						Long USER_ID;
	            		...
	            		public BufferLine_tRedshiftOutput_1 c3(String STATE){
							this.STATE = STATE;
							return this;
						}				
						Long ADDRESS_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c4(Long ADDRESS_ID){
							this.ADDRESS_ID = ADDRESS_ID;
							return this;
						}				
						String COUPON_CODE;
						
	            		public BufferLine_tRedshiftOutput_1 c5(String COUPON_CODE){
							this.COUPON_CODE = COUPON_CODE;
							return this;
						}				
						Long RATE_PLAN_ID;
						
	            		public BufferLine_tRedshiftOutput_1 c6(Long RATE_PLAN_ID){
			...
			String insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"CORPORATE_APPLICATION_ID\",\"USER_ID\",\"ZIPFLEET_ID\",\"STATE\",\"ADDRESS_ID\",\"COUPON_CODE\",\"RATE_PLAN_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES " + extendInsertValueStmt_tRedshiftOutput_1.toString();
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							Row_FeedRecord.CORPORATE_APPLICATION_ID = 0;
					
							Row_FeedRecord.USER_ID = null;
					
							Row_FeedRecord.ZIPFLEET_ID = null;
					
							Row_FeedRecord.STATE = null;
					
							Row_FeedRecord.ADDRESS_ID = null;
					
							Row_FeedRecord.COUPON_CODE = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										Row_FeedRecord.CORPORATE_APPLICATION_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'CORPORATE_APPLICATION_ID' in 'Row_FeedRecord' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.STATE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									Row_FeedRecord.COUPON_CODE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Record_OutputToDB.CORPORATE_APPLICATION_ID = Row_FeedRecord.CORPORATE_APPLICATION_ID;
Record_OutputToDB.USER_ID = Row_FeedRecord.USER_ID;
Record_OutputToDB.ZIPFLEET_ID = Row_FeedRecord.ZIPFLEET_ID;
Record_OutputToDB.STATE = StringUtils.trimToNull(Row_FeedRecord.STATE);
Record_OutputToDB.ADDRESS_ID = Row_FeedRecord.ADDRESS_ID;
Record_OutputToDB.COUPON_CODE = StringUtils.trimToNull(Row_FeedRecord.COUPON_CODE);
	...
	currentComponent="tRedshiftOutput_1";
        ...
        whetherReject_tRedshiftOutput_1 = false;
				...
				+ 1;
							...
							pstmt_tRedshiftOutput_1.setLong(countertRedshiftOutput_1,Record_OutputToDB.CORPORATE_APPLICATION_ID);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.STATE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.STATE);
						...
						countertRedshiftOutput_1++;
							...
							if(Record_OutputToDB.COUPON_CODE==null){
								pstmt_tRedshiftOutput_1.setNull(countertRedshiftOutput_1,java.sql.Types.VARCHAR);
								
							}else{
							
							pstmt_tRedshiftOutput_1.setString(countertRedshiftOutput_1,Record_OutputToDB.COUPON_CODE);
				...
				exInsertColValuetRedshiftOutput_1 = new BufferLine_tRedshiftOutput_1();
                        ...
                        .c0(Record_OutputToDB.CORPORATE_APPLICATION_ID)
                        .c1(Record_OutputToDB.USER_ID)
                        .c2(Record_OutputToDB.ZIPFLEET_ID)
                        .c3(Record_OutputToDB.STATE)
                        .c4(Record_OutputToDB.ADDRESS_ID)
                        .c5(Record_OutputToDB.COUPON_CODE)
                        .c6(Record_OutputToDB.RATE_PLAN_ID)
            ...
            if(!whetherReject_tRedshiftOutput_1) {
                            After_Insert = new After_InsertStruct();
                                After_Insert.CORPORATE_APPLICATION_ID = Record_OutputToDB.CORPORATE_APPLICATION_ID;
                                After_Insert.USER_ID = Record_OutputToDB.USER_ID;
                                After_Insert.ZIPFLEET_ID = Record_OutputToDB.ZIPFLEET_ID;
                                After_Insert.STATE = Record_OutputToDB.STATE;
                                After_Insert.ADDRESS_ID = Record_OutputToDB.ADDRESS_ID;
                                After_Insert.COUPON_CODE = Record_OutputToDB.COUPON_CODE;
...
((java.util.concurrent.atomic.AtomicInteger)globalMap.get("File_Processed_Records")).incrementAndGet() % Logging.PROGRESS_ROW_COUNT  == 0), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(Log_Rows == null){ 
               ...
               Log_Rows.CORPORATE_APPLICATION_ID = After_Insert.CORPORATE_APPLICATION_ID;
               Log_Rows.USER_ID = After_Insert.USER_ID;
               Log_Rows.ZIPFLEET_ID = After_Insert.ZIPFLEET_ID;
               Log_Rows.STATE = After_Insert.STATE;
	...
	currentComponent="tRedshiftOutput_1";
	    ...
	    if(rowCounttRedshiftOutput_1!=0){
	        ...
	        for(int i_tRedshiftOutput_1=0 ; i_tRedshiftOutput_1 < rowCounttRedshiftOutput_1 ; i_tRedshiftOutput_1++){
				...
				insert_tRedshiftOutput_1 = "INSERT INTO \"" + tableName_tRedshiftOutput_1 + "\" (\"CORPORATE_APPLICATION_ID\",\"USER_ID\",\"ZIPFLEET_ID\",\"STATE\",\"ADDRESS_ID\",\"COUPON_CODE\",\"RATE_PLAN_ID\",\"CREATION_DATE\",\"LAST_MODIFIED\",\"DELETED_DATE\") VALUES "+extendInsertValue_tRedshiftOutput_1.toString();
	        ...
	        for(BufferLine_tRedshiftOutput_1 bufferLtRedshiftOutput_1 : exInsertColValueListtRedshiftOutput_1){
				...
				+ 1;
					pstmt_tRedshiftOutput_1.setLong(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.CORPORATE_APPLICATION_ID);
					...
					if(bufferLtRedshiftOutput_1.STATE==null){
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.STATE);
					...
					if(bufferLtRedshiftOutput_1.COUPON_CODE==null){
						pstmt_tRedshiftOutput_1.setNull(counttRedshiftOutput_1,java.sql.Types.VARCHAR);
					...
					pstmt_tRedshiftOutput_1.setString(counttRedshiftOutput_1,bufferLtRedshiftOutput_1.COUPON_CODE);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.CORPORATE_APPLICATION_ID = 0;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.CORPORATE_APPLICATION_ID = ParserUtils.parseTo_long(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
    										...
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'CORPORATE_APPLICATION_ID' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
...
if(row1 != null) { 
    ...
    //Code generated according to input schema and output schema
row2.CORPORATE_APPLICATION_ID = row1.CORPORATE_APPLICATION_ID;
row2.USER_ID = row1.USER_ID;
row2.ZIPFLEET_ID = row1.ZIPFLEET_ID;
row2.STATE = StringUtils.trimToNull(row1.STATE);
				...
				if(execStat){
					runStat.updateStatOnConnection("row2"+iterateId,1, 1);
                        ...
                        String[] rowtFileOutputDelimited_1=new String[10];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row2.CORPORATE_APPLICATION_ID);
                            ...
                            rowtFileOutputDelimited_1[3]=row2.STATE == null ? null : row2.STATE;
                            rowtFileOutputDelimited_1[4]=row2.ADDRESS_ID == null ? null : String.valueOf(row2.ADDRESS_ID);
                            rowtFileOutputDelimited_1[5]=row2.COUPON_CODE == null ? null : row2.COUPON_CODE;
                            rowtFileOutputDelimited_1[6]=row2.RATE_PLAN_ID == null ? null : String.valueOf(row2.RATE_PLAN_ID);
 ...
 */
    ...
    public static void main(String[] args){
        final StageFeed_CorporateApplications StageFeed_CorporateApplicationsClass = new StageFeed_CorporateApplications();

        int exitCode = StageFeed_CorporateApplicationsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = StageFeed_CorporateApplications.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/stagefeed_corporateapplications_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StageFeed_CorporateApplications");
        }
...
/************************************************************************************************
 *     343298 characters generated by Talend Open Studio for Data Integration 
