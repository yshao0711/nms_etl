...
package zipcar_marketingdw.process_monthly_member_activity_0_1;
...
/**
 * Job: Process_Monthly_Member_Activity Purpose: Computes Monthly member activity values<br>
 * Description: Computes member values from monthly aggregations. <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status DEV
 */
public class Process_Monthly_Member_Activity implements TalendJob {
...
public String getRedshift_Monitoring_Server(){
	...
	private final String jobName = "Process_Monthly_Member_Activity";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_rocvUGUPEei9_4qgNN-AHg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Process_Monthly_Member_Activity.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Process_Monthly_Member_Activity.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
globalMap.put("START_DATE", DateUtils.getMonthlyStartDate(context.RunDate, context.MemberWeeksOffset));
globalMap.put("END_DATE", DateUtils.getMonthlyEndDate(context.RunDate));
...
public static class deleted_rowsStruct implements routines.system.IPersistableRow<deleted_rowsStruct> {
    final static byte[] commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity = new byte[0];
    static byte[] commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity) {
...
"\nDELETE FROM {{marketing.schema}}.s_member_activity_monthly\nWHERE end_date = {{enddate}}\n",
...
if(deleted_rows != null) { 
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO","","Deleted Monthly Member Activity Records for Restart date: " + DateUtils.dateToSqlStr((Date) globalMap.get("END_DATE")),"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_3", 3, "Deleted Monthly Member Activity Records for Restart date: " + DateUtils.dateToSqlStr((Date) globalMap.get("END_DATE")), 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_3_WARN_MESSAGES", "Deleted Monthly Member Activity Records for Restart date: " + DateUtils.dateToSqlStr((Date) globalMap.get("END_DATE"))); 
...
public static class log_messageStruct implements routines.system.IPersistableRow<log_messageStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity.length) {
				if(length < 1024 && commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity.length == 0) {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity = new byte[1024];
				} else {
   					commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity, 0, length);
			strReturn = new String(commonByteArray_ZIPCAR_MARKETINGDW_Process_Monthly_Member_Activity, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_6", "", Thread.currentThread().getId() + "", "INFO","","Monthly Member Activity inserted into (s_member_activity_monthly)","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_6", 3, "Monthly Member Activity inserted into (s_member_activity_monthly)", 42);
	tLogCatcher_1Process(globalMap);
globalMap.put("tWarn_6_WARN_MESSAGES", "Monthly Member Activity inserted into (s_member_activity_monthly)"); 
 ...
 */
    ...
    public static void main(String[] args){
        final Process_Monthly_Member_Activity Process_Monthly_Member_ActivityClass = new Process_Monthly_Member_Activity();

        int exitCode = Process_Monthly_Member_ActivityClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Process_Monthly_Member_Activity.class.getClassLoader().getResourceAsStream("zipcar_marketingdw/process_monthly_member_activity_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Process_Monthly_Member_Activity");
        }
...
/************************************************************************************************
 *     153747 characters generated by Talend Open Studio for Data Integration 
 *     on the October 16, 2018 5:21:56 PM CDT
 ************************************************************************************************/