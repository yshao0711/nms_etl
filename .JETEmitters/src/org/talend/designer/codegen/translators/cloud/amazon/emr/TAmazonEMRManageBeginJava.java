...
public class TAmazonEMRManageBeginJava
{
  ...
  protected final String TEXT_72 = "," + NL + "\t\tcom.amazonaws.PredefinedClientConfigurations.defaultConfig().withUserAgent(routines.system.Constant.TALEND_USER_AGENT)" + NL + "\t);" + NL + "\t" + NL + "\t";
