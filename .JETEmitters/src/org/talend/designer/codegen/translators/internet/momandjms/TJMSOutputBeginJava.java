...
public class TJMSOutputBeginJava
{
  ...
  protected final String TEXT_75 = ".createSession(false, javax.jms.Session.AUTO_ACKNOWLEDGE);" + NL + "\t";
  protected final String TEXT_76 = NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_77 = " = (javax.jms.Destination)context_";
  protected final String TEXT_78 = ".lookup(";
  ...
  protected final String TEXT_85 = NL + NL + "\tjavax.jms.MessageProducer producer_";
  protected final String TEXT_86 = " = session_";
  protected final String TEXT_87 = ".createProducer(dest_";
  protected final String TEXT_88 = ");" + NL + "" + NL + "\tproducer_";
  protected final String TEXT_89 = ".setDeliveryMode(javax.jms.DeliveryMode.";
  protected final String TEXT_90 = ");" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_91 = " = 0;" + NL + "" + NL + "" + NL + "" + NL + "\t\t";
