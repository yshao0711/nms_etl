...
public class TJMSInputBeginJava
{
  ...
  protected final String TEXT_78 = ".createSession(false, javax.jms.Session.CLIENT_ACKNOWLEDGE);" + NL + "\t";
  ...
  protected final String TEXT_88 = NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_89 = " = session_";
  protected final String TEXT_90 = ".createDurableSubscriber((javax.jms.Topic)dest_";
  protected final String TEXT_91 = ",";
  protected final String TEXT_92 = ",";
  protected final String TEXT_93 = ",false);" + NL + "\t";
  protected final String TEXT_94 = NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_95 = "\t= session_";
  protected final String TEXT_96 = ".createConsumer(dest_";
  protected final String TEXT_97 = ", ";
  protected final String TEXT_98 = ");" + NL + "\t";
  protected final String TEXT_99 = NL + "\t" + NL + "\tconnection_";
  protected final String TEXT_100 = ".start();" + NL + "" + NL + "\tSystem.out.println(\"Ready to receive message\");" + NL + "\tSystem.out.println(\"Waiting...\");" + NL + "\t";
  protected final String TEXT_101 = NL + "\t";
  protected final String TEXT_102 = NL + NL + "\tjavax.jms.Message message_";
  protected final String TEXT_103 = ";" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_104 = " = 0;" + NL + "" + NL + "\twhile ((message_";
  protected final String TEXT_105 = " = consumer_";
  protected final String TEXT_106 = ".receive(";
  protected final String TEXT_107 = "*1000)) != null) {" + NL + "\t\t";
  protected final String TEXT_108 = NL + "\t\t";
  protected final String TEXT_109 = ".message=message_";
  protected final String TEXT_110 = ";\t";
  protected final String TEXT_111 = NL + "\t\t";
  protected final String TEXT_112 = ".messageContent=ParserUtils.parseTo_Document(((javax.jms.ObjectMessage) message_";
  protected final String TEXT_113 = ").getObject().toString());";
  protected final String TEXT_114 = NL + "\t\t";
  protected final String TEXT_115 = ".messageContent=((javax.jms.TextMessage) message_";
  protected final String TEXT_116 = ").getText();";
