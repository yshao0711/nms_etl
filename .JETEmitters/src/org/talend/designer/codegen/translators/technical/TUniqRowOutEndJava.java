...
public class TUniqRowOutEndJava
{
  ...
  protected final String TEXT_40 = " next() {" + NL + "                    if (index >= count) {" + NL + "                        load();" + NL + "                    }" + NL + "" + NL + "                    return buffer[index++];" + NL + "                }" + NL + "" + NL + "                public void remove() {" + NL + "                    throw new UnsupportedOperationException();" + NL + "                }" + NL + "" + NL + "                public void close() throws IOException {" + NL + "                    if (ois != null) {" + NL + "                        ois.close();" + NL + "                        ois = null;" + NL + "                    }" + NL + "                }" + NL + "            }" + NL;
