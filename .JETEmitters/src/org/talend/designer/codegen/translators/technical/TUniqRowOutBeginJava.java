...
public class TUniqRowOutBeginJava
{
  ...
  protected final String TEXT_217 = NL + "        return Long.compare(arg0.id_";
  ...
  protected final String TEXT_237 = " = new java.util.ArrayList<java.io.File>();" + NL + "" + NL + "String temp_file_path_prefix_";
  protected final String TEXT_238 = " = ";
  protected final String TEXT_239 = " + \"/\" + jobName + \"_";
  protected final String TEXT_240 = "_\" + Thread.currentThread().getId() + \"_\" + pid  + \"_\";" + NL;
