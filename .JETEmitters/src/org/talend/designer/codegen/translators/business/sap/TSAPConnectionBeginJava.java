...
public class TSAPConnectionBeginJava
{
  ...
  protected final String TEXT_84 = NL + NL + "\tclass PropertyUil_";
  protected final String TEXT_85 = " {" + NL + "\t\t" + NL + "        void validateAndSet(java.util.Properties p, String key, Object value) {" + NL + "        \tif(value==null) {" + NL + "        \t\tSystem.err.println(\"WARN : will ignore the property : \" + key + \" as setting the null value.\"); " + NL + "        \t\treturn;" + NL + "        \t}" + NL + "        \t" + NL + "        \tp.setProperty(key, String.valueOf(value));" + NL + "        }" + NL + "        " + NL + "\t}" + NL + "\t" + NL + "\tPropertyUil_";
  protected final String TEXT_86 = " pu_";
  protected final String TEXT_87 = " = new PropertyUil_";
  ...
  protected final String TEXT_95 = NL + "\tjava.util.Properties properties_";
  protected final String TEXT_96 = " = new java.util.Properties();" + NL + "    pu_";
  protected final String TEXT_97 = ".validateAndSet(properties_";
  protected final String TEXT_98 = ", org.talend.sap.ISAPConnection.PROP_CLIENT, ";
  protected final String TEXT_99 = ");" + NL + "    pu_";
  protected final String TEXT_100 = ".validateAndSet(properties_";
  protected final String TEXT_101 = ", org.talend.sap.ISAPConnection.PROP_USER, ";
  protected final String TEXT_102 = ");" + NL + "    pu_";
  protected final String TEXT_103 = ".validateAndSet(properties_";
  protected final String TEXT_104 = ", org.talend.sap.ISAPConnection.PROP_PASSWORD, decryptedPassword_";
  protected final String TEXT_105 = ");" + NL + "    pu_";
  protected final String TEXT_106 = ".validateAndSet(properties_";
  protected final String TEXT_107 = ", org.talend.sap.ISAPConnection.PROP_LANGUAGE, ";
  protected final String TEXT_108 = ");" + NL + "    ";
  protected final String TEXT_109 = NL + "    pu_";
  protected final String TEXT_110 = ".validateAndSet(properties_";
  protected final String TEXT_111 = ", org.talend.sap.ISAPConnection.PROP_APPLICATION_SERVER_HOST, ";
  protected final String TEXT_112 = ");" + NL + "    pu_";
  protected final String TEXT_113 = ".validateAndSet(properties_";
  protected final String TEXT_114 = ", org.talend.sap.ISAPConnection.PROP_SYSTEM_NUMBER, ";
  protected final String TEXT_115 = ");";
  protected final String TEXT_116 = NL + "    pu_";
  protected final String TEXT_117 = ".validateAndSet(properties_";
  protected final String TEXT_118 = ", \"jco.client.mshost\", ";
  protected final String TEXT_119 = ");" + NL + "    pu_";
  protected final String TEXT_120 = ".validateAndSet(properties_";
  protected final String TEXT_121 = ", \"jco.client.r3name\", ";
  protected final String TEXT_122 = ");" + NL + "    pu_";
  protected final String TEXT_123 = ".validateAndSet(properties_";
  protected final String TEXT_124 = ", \"jco.client.group\", ";
  protected final String TEXT_125 = ");";
  protected final String TEXT_126 = NL + "    " + NL + "\t";
  protected final String TEXT_127 = NL + "\t\tpu_";
  protected final String TEXT_128 = ".validateAndSet(properties_";
  protected final String TEXT_129 = ", ";
  protected final String TEXT_130 = " ,";
  protected final String TEXT_131 = ");" + NL + "\t\t";
  protected final String TEXT_132 = NL + "    " + NL + "\tconnection_";
  protected final String TEXT_133 = " = org.talend.sap.impl.SAPConnectionFactory.getInstance().createConnection(properties_";
  protected final String TEXT_134 = ");";
  protected final String TEXT_135 = NL + "\t\t//{" + NL + "\t\t}";
  protected final String TEXT_136 = NL + "\tconnection_";
  protected final String TEXT_137 = ".beginTransaction();" + NL + "\tglobalMap.put(\"conn_";
