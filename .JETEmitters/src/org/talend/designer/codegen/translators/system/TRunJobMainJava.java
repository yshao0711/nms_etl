...
public class TRunJobMainJava
{
  ...
  protected final String TEXT_160 = "();" + NL + "\t    // pass DataSources" + NL + "\t    java.util.Map<String, routines.system.TalendDataSource> talendDataSources_";
  protected final String TEXT_161 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap" + NL + "\t            .get(KEY_DB_DATASOURCES);" + NL + "\t    if (null != talendDataSources_";
  protected final String TEXT_162 = ") {" + NL + "\t        java.util.Map<String, javax.sql.DataSource> dataSources_";
  protected final String TEXT_163 = " = new java.util.HashMap<String, javax.sql.DataSource>();" + NL + "\t        for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_";
  protected final String TEXT_164 = " : talendDataSources_";
  protected final String TEXT_165 = NL + "\t\t\t        .entrySet()) {" + NL + "\t            dataSources_";
  protected final String TEXT_166 = ".put(talendDataSourceEntry_";
  protected final String TEXT_167 = ".getKey()," + NL + "\t                    talendDataSourceEntry_";
  protected final String TEXT_168 = ".getValue().getRawDataSource());" + NL + "\t        }" + NL + "\t        childJob_";
  protected final String TEXT_169 = ".setDataSources(dataSources_";
  protected final String TEXT_170 = ");" + NL + "\t    }" + NL + "\t\t";
  protected final String TEXT_171 = "  " + NL + "\t\t\tchildJob_";
  protected final String TEXT_172 = ".parentContextMap = parentContextMap_";
  protected final String TEXT_173 = ";" + NL + "\t\t";
  protected final String TEXT_174 = "  " + NL + "\t\t";
  protected final String TEXT_175 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_176 = " - The child job '";
  protected final String TEXT_177 = "\"+";
  protected final String TEXT_178 = "+\"";
  protected final String TEXT_179 = "' starts on the version '";
  protected final String TEXT_180 = "' with the context '";
  protected final String TEXT_181 = "'.\");" + NL + "\t\t";
  protected final String TEXT_182 = NL + "\t\tString[][] childReturn_";
  protected final String TEXT_183 = " = childJob_";
  protected final String TEXT_184 = ".runJob((String[]) paraList_";
  protected final String TEXT_185 = ".toArray(new String[paraList_";
  protected final String TEXT_186 = ".size()]));" + NL + "\t\t";
  protected final String TEXT_187 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_188 = " - The child job '";
  protected final String TEXT_189 = "\"+";
  protected final String TEXT_190 = "+\"";
  protected final String TEXT_191 = "' is done.\");" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t  \t";
  protected final String TEXT_193 = NL + "\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", childJob_";
  protected final String TEXT_194 = ".getErrorCode());" + NL + "\t\t\t";
  protected final String TEXT_195 = NL + "\t\t\t\terrorCode = childJob_";
  protected final String TEXT_196 = ".getErrorCode();" + NL + "\t\t    ";
  protected final String TEXT_197 = NL + "\t            " + NL + "\t    \tif(childJob_";
  protected final String TEXT_198 = ".getErrorCode() == null){" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_199 = "_CHILD_RETURN_CODE\", childJob_";
  protected final String TEXT_200 = ".getStatus() != null && (\"failure\").equals(childJob_";
  protected final String TEXT_201 = ".getStatus()) ? 1 : 0);" + NL + "\t    \t}else{" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_202 = "_CHILD_RETURN_CODE\", childJob_";
  protected final String TEXT_203 = ".getErrorCode());" + NL + "\t\t    }" + NL + "\t\t    if (childJob_";
  protected final String TEXT_204 = ".getExceptionStackTrace() != null) { " + NL + "\t\t    \tglobalMap.put(\"";
  protected final String TEXT_205 = "_CHILD_EXCEPTION_STACKTRACE\", childJob_";
  protected final String TEXT_206 = ".getExceptionStackTrace());" + NL + "\t\t    }" + NL + "\t  " + NL + "\t\t\t";
  protected final String TEXT_207 = " " + NL + "\t\t\t\tif (childJob_";
  protected final String TEXT_208 = ".getErrorCode() != null || (\"failure\").equals(childJob_";
  protected final String TEXT_209 = ".getStatus())) {" + NL + "\t        \t\tthrow new RuntimeException(\"Child job running failed.\\n\"+childJob_";
  protected final String TEXT_210 = ".getExceptionStackTrace());" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_211 = NL + "\t  \t";
  protected final String TEXT_212 = NL + "\t\t\tfor (String[] item_";
  protected final String TEXT_213 = " : childReturn_";
  protected final String TEXT_214 = ") { " + NL + "\t\t\t\tif(childJob_";
  protected final String TEXT_215 = ".hastBufferOutputComponent() || ";
  protected final String TEXT_216 = "){" + NL + "\t\t\t    \t";
  protected final String TEXT_217 = "\t\t" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_218 = " < item_";
  ...
  protected final String TEXT_227 = " = ParserUtils.parseTo_Date(item_";
  ...
  protected final String TEXT_235 = "].getBytes();" + NL + "\t\t\t           \t\t";
  ...
  protected final String TEXT_245 = "(item_";
  ...
  protected final String TEXT_259 = NL + "\t\tRuntime runtime_";
  protected final String TEXT_260 = " = Runtime.getRuntime();" + NL + "\t\tfinal Process ps_";
  protected final String TEXT_261 = ";" + NL + "\t\tps_";
  protected final String TEXT_262 = " = runtime_";
  protected final String TEXT_263 = ".exec((String[])paraList_";
  protected final String TEXT_264 = ".toArray(new String[paraList_";
  protected final String TEXT_265 = ".size()]));" + NL + "" + NL + "\t\tThread normal_";
  protected final String TEXT_266 = " = new Thread() {" + NL + "\t\t\tpublic void run() {" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_267 = ".getInputStream()));" + NL + "\t\t\t\t\tString line = \"\";" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_269 = " - \" + ioe.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t    \t}" + NL + "  \t\t};" + NL + "\t\t";
  protected final String TEXT_271 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_272 = " - The child job '";
  protected final String TEXT_273 = "\"+";
  protected final String TEXT_274 = "+\"";
  protected final String TEXT_275 = "' starts on the version '";
  protected final String TEXT_276 = "' with the context '";
  protected final String TEXT_277 = "'.\");" + NL + "\t\t";
  protected final String TEXT_278 = NL + "\t\tnormal_";
  protected final String TEXT_279 = ".start();" + NL + "\t\t";
  protected final String TEXT_280 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_281 = " - The child job '";
  protected final String TEXT_282 = "\"+";
  protected final String TEXT_283 = "+\"";
  protected final String TEXT_284 = "' is done.\");" + NL + "\t\t";
  protected final String TEXT_285 = NL + NL + "\t\tfinal StringBuffer errorMsg_";
  protected final String TEXT_286 = " = new StringBuffer();" + NL + "\t\tThread error_";
  protected final String TEXT_287 = " = new Thread() {" + NL + "\t\t\tpublic void run() {" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_288 = ".getErrorStream()));" + NL + "\t\t\t\t\tString line = \"\";" + NL + "        \t\t\ttry {" + NL + "          \t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "            \t\t\t\terrorMsg_";
  protected final String TEXT_289 = ".append(line).append(\"\\n\");" + NL + "          \t\t\t\t}" + NL + "        \t\t\t} finally {" + NL + "          \t\t\t\treader.close();" + NL + "        \t\t\t}" + NL + "      \t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_290 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_291 = " - \" + ioe.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_292 = NL + "\t\t\t        ioe.printStackTrace();" + NL + "      \t\t\t}" + NL + "    \t\t}" + NL + "\t\t};" + NL + "\t\terror_";
  protected final String TEXT_293 = ".start();" + NL + "" + NL + "\t\t//0 indicates normal termination\t" + NL + "\t\tint result_";
  protected final String TEXT_294 = " = ps_";
  protected final String TEXT_295 = ".waitFor();" + NL + "\t\tnormal_";
  protected final String TEXT_296 = ".join(10000);" + NL + "\t\terror_";
  protected final String TEXT_297 = ".join(10000);" + NL + "  " + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_298 = "_CHILD_RETURN_CODE\",result_";
  protected final String TEXT_299 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_300 = " != 0){" + NL + "   \t\t\tglobalMap.put(\"";
  protected final String TEXT_301 = "_CHILD_EXCEPTION_STACKTRACE\",errorMsg_";
  protected final String TEXT_302 = ".toString());" + NL + "\t\t\t";
  protected final String TEXT_303 = "  " + NL + "\t    \t\tthrow new RuntimeException(\"Child job returns \" + result_";
  protected final String TEXT_304 = " + \". It doesn't terminate normally.\\n\" + errorMsg_";
  protected final String TEXT_305 = ".toString());" + NL + "\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_308 = " - Child job returns \" + result_";
  protected final String TEXT_309 = " + \". It doesn't terminate normally.\\n\" + errorMsg_";
  protected final String TEXT_310 = ".toString());" + NL + "\t\t\t\t";
  protected final String TEXT_311 = NL + "\t\t\t\tSystem.err.println(\"Child job returns \" + result_";
  ...
  protected final String TEXT_317 = " - Child job returns \" + result_";
  protected final String TEXT_318 = " + \". It doesn't terminate normally.\\n\" + errorMsg_";
  protected final String TEXT_319 = ".toString());" + NL + "\t\t\t\t";
  protected final String TEXT_320 = NL + "  \t\t\t\tSystem.err.println(\"when tRunJob runs in an independent process, it can't extract datas from tBufferOutput of child job.\"); " + NL + "\t\t\t";
