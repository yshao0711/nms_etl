...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_993 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_994 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_995 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_996 = " = 0;";
  protected final String TEXT_997 = NL + "                        status_";
  protected final String TEXT_998 = " = pstmt_";
  protected final String TEXT_999 = ".executeBatch();";
  protected final String TEXT_1000 = NL + "                        for(int countEach_";
  protected final String TEXT_1001 = ": status_";
  protected final String TEXT_1002 = ") {" + NL + "                            countSum_";
  protected final String TEXT_1003 = " += (countEach_";
  protected final String TEXT_1004 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1005 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1006 = NL + "                            throw(e);";
  ...
  protected final String TEXT_1012 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1013 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_1014 = " = pstmt_";
  protected final String TEXT_1015 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_1016 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_1017 = " = tmp_batchUpdateCount_";
  ...
  protected final String TEXT_1022 = NL + "                        insertedCount_";
  protected final String TEXT_1023 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1024 = ";";
  protected final String TEXT_1025 = NL + "                        updatedCount_";
  protected final String TEXT_1026 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1027 = ";";
  protected final String TEXT_1028 = NL + "                        deletedCount_";
  protected final String TEXT_1029 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1030 = ";";
  protected final String TEXT_1031 = NL + "               }";
  protected final String TEXT_1032 = NL + "                commitCounter_";
  protected final String TEXT_1033 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_1034 = "<=commitCounter_";
  protected final String TEXT_1035 = ") {";
  protected final String TEXT_1036 = NL + "                                if(batchSize_";
  protected final String TEXT_1037 = " > 0){";
  protected final String TEXT_1038 = NL + "                                      conn_";
  protected final String TEXT_1039 = ".commit();";
  protected final String TEXT_1040 = NL + "                                      commitCounter_";
  protected final String TEXT_1041 = "=0;" + NL + "                                }";
