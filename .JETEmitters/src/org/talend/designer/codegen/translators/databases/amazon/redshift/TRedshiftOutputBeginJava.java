...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_523 = ";" + NL + "\t\t\t\t\t\t" + NL + "\t            \t\tpublic BufferLine_";
  protected final String TEXT_524 = " c";
  protected final String TEXT_525 = "(";
  protected final String TEXT_526 = " ";
  protected final String TEXT_527 = "){" + NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_528 = " = ";
  protected final String TEXT_529 = ";" + NL + "\t\t\t\t\t\t\treturn this;" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_530 = "\t\t" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_531 = "> exInsertColValueList";
  protected final String TEXT_532 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_533 = " exInsertColValue";
  protected final String TEXT_534 = " = null;" + NL + "" + NL + "" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_535 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_536 = "=0;i_";
  protected final String TEXT_537 = " < ";
  protected final String TEXT_538 = ";i_";
  protected final String TEXT_539 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_540 = ".append(\"(";
  protected final String TEXT_541 = ")\");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_542 = "!=";
  protected final String TEXT_543 = "-1) extendInsertValueStmt_";
  protected final String TEXT_544 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  protected final String TEXT_545 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_546 = " + \"\\\" (";
  protected final String TEXT_547 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_548 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_554 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_562 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_563 = " = conn_";
  protected final String TEXT_564 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_569 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_570 = " + \"\\\" SET ";
  protected final String TEXT_571 = " WHERE ";
  protected final String TEXT_572 = "\");" + NL + "\t    ";
  protected final String TEXT_573 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_574 = " = conn_";
  protected final String TEXT_575 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_580 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_586 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_587 = " + \"\\\" WHERE ";
  protected final String TEXT_588 = "\");" + NL + "\t    ";
  protected final String TEXT_589 = NL + "\tclass BufferLine_";
  protected final String TEXT_590 = " {";
  protected final String TEXT_591 = NL + "\t\t\t";
  protected final String TEXT_592 = " ";
  protected final String TEXT_593 = ";" + NL + "\t\t\t" + NL + "    \t\tpublic BufferLine_";
  protected final String TEXT_594 = " c";
  protected final String TEXT_595 = "(";
  protected final String TEXT_596 = " ";
  protected final String TEXT_597 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_598 = " = ";
  protected final String TEXT_599 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}";
  protected final String TEXT_600 = NL + "\t\t\troutines.system.Dynamic ";
  protected final String TEXT_601 = ";" + NL + "\t\t\t" + NL + "\t\t\tpublic BufferLine_";
  protected final String TEXT_602 = " c";
  protected final String TEXT_603 = "(routines.system.Dynamic ";
  protected final String TEXT_604 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_605 = " = ";
  protected final String TEXT_606 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_607 = NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_608 = "> exInsertColValueList";
  protected final String TEXT_609 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_610 = " exInsertColValue";
  protected final String TEXT_611 = " = null;" + NL + "    String insert_";
  protected final String TEXT_612 = " = \"\";" + NL + "    int rowCount";
