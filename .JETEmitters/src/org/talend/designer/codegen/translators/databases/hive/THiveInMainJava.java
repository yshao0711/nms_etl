...
public class THiveInMainJava
{
  ...
  protected final String TEXT_196 = ",\" (GPN:Talend)\",null);" + NL + "            service_";
  protected final String TEXT_197 = ".getAccountOwner();" + NL + "" + NL + "            java.util.regex.Matcher m = org.talend.bigdata.launcher.google.dataproc.DataprocJobUtil.GS_URI_PATTERN.matcher(";
