...
public class TMDMBulkLoadBeginJava
{
  ...
  protected final String TEXT_81 = "\")) {" + NL + "                String sessionID_";
  protected final String TEXT_82 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getSessionID(turl_";
  ...
  protected final String TEXT_95 = ".setSessionId(sessionID_";
  ...
  protected final String TEXT_107 = ".setSessionId(mdmTransaction_";
  protected final String TEXT_108 = ".getSessionId());" + NL + "    }";
