...
public class TBigQueryBulkExecBeginJava
{
  ...
  protected final String TEXT_122 = ",\" (GPN:Talend)\",null);" + NL + "" + NL + "\t\tjava.io.File fileData_";
  ...
  protected final String TEXT_244 = ";" + NL + "" + NL + "\t\tif ((doneJob_";
  protected final String TEXT_245 = ".getStatus() != null) && (doneJob_";
  protected final String TEXT_246 = ".getStatus().getErrors() != null)) {" + NL + "\t\t\tstatus = \"failure\";" + NL + "\t\t\tthrow new Exception(doneJob_";
  protected final String TEXT_247 = ".getStatus().getErrors().toString());" + NL + "\t\t}" + NL + "" + NL + "\t\tSystem.out.println(\"Done: \" + doneJob_";
  protected final String TEXT_248 = ".toString());" + NL + "\t\tcom.google.api.services.bigquery.model.JobStatistics jobStatistics_";
  protected final String TEXT_249 = "= doneJob_";
  protected final String TEXT_250 = ".getStatistics();" + NL + "\t\tif(jobStatistics_";
  protected final String TEXT_251 = "!=null && jobStatistics_";
  protected final String TEXT_252 = ".getLoad() != null){" + NL + "\t\t\tcom.google.api.services.bigquery.model.JobStatistics3 loadObject_";
  protected final String TEXT_253 = " = jobStatistics_";
  protected final String TEXT_254 = ".getLoad();" + NL + "\t\t\tif(loadObject_";
  protected final String TEXT_255 = "!= null){" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_256 = " = loadObject_";
  protected final String TEXT_257 = ".getOutputRows();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_258 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_259 = " - Load Done: \" + doneJob_";
  protected final String TEXT_260 = ".toString());" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_261 = " - \" + nb_line_";
  protected final String TEXT_262 = " + \" records load successfully.\");" + NL + "\t\t";
  protected final String TEXT_263 = NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_264 = NL + "\t\t\tthrow new Exception(jobExec_";
  protected final String TEXT_265 = ".toString());" + NL + "\t\t";
  protected final String TEXT_266 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_267 = " - Error: \" + jobExec_";
  protected final String TEXT_268 = ".toString());" + NL + "\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\tSystem.err.println(\"Error: \" + jobExec_";
  protected final String TEXT_270 = ".toString());" + NL + "\t\t";
