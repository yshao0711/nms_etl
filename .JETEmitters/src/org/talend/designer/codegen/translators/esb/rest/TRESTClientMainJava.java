...
public class TRESTClientMainJava
{
  ...
  protected final String TEXT_238 = " = null;" + NL + "" + NL + "        try {" + NL + "\t\t\tif (!inOSGi) {" + NL + "\t\t\t\torg.springframework.context.support.ClassPathXmlApplicationContext context_";
  protected final String TEXT_239 = " =" + NL + "\t\t\t\t\tnew org.springframework.context.support.ClassPathXmlApplicationContext(\"META-INF/tesb/oidc-context.xml\");" + NL + "\t\t\t\torg.talend.esb.security.oidc.OidcConfiguration oidcConfiguration_";
  protected final String TEXT_240 = " = context_";
  protected final String TEXT_241 = ".getBean(org.talend.esb.security.oidc.OidcConfiguration.class);" + NL + "\t\t\t\tbearerHeader_";
  protected final String TEXT_242 = " = org.talend.esb.security.oidc.OidcClientUtils.oidcClientBearer(username_";
  protected final String TEXT_243 = ", password_";
  protected final String TEXT_244 = ", oidcConfiguration_";
  protected final String TEXT_245 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tbearerHeader_";
  protected final String TEXT_246 = " = org.talend.esb.security.oidc.OidcClientUtils.oidcClientBearer(username_";
  protected final String TEXT_247 = ", password_";
  protected final String TEXT_248 = ");" + NL + "\t\t\t}" + NL + "\t\t} catch (Exception ex) {" + NL + "            throw new javax.ws.rs.WebApplicationException(\"Failed to get OIDC access token: \", ex);" + NL + "        }" + NL + "" + NL + "\t\twebClient_";
  protected final String TEXT_249 = ".header(\"Authorization\", bearerHeader_";
  protected final String TEXT_250 = ");" + NL + "\t}" + NL + "    " + NL + "\t// if FORM request then capture query parameters into Form, otherwise set them as queries" + NL + "\t";
  protected final String TEXT_251 = NL + "\t\tjavax.ws.rs.core.Form form_";
  protected final String TEXT_252 = " = new javax.ws.rs.core.Form();" + NL + "\t\t";
  protected final String TEXT_253 = NL + "\t\t\tform_";
  protected final String TEXT_254 = ".param(";
  protected final String TEXT_255 = " ,";
  protected final String TEXT_256 = ");" + NL + "\t\t";
  protected final String TEXT_257 = NL + "\t\trequestBody_";
  protected final String TEXT_258 = " = form_";
  protected final String TEXT_259 = ";" + NL + "\t";
  protected final String TEXT_260 = NL + "\t\t";
  protected final String TEXT_261 = NL + "\t\t\twebClient_";
  protected final String TEXT_262 = ".query(";
  protected final String TEXT_263 = " ,";
  protected final String TEXT_264 = ");" + NL + "\t\t";
  protected final String TEXT_265 = NL + "\t";
  protected final String TEXT_266 = NL + NL + NL + "\ttry {" + NL + "\t\t// start send request" + NL + "\t\t";
  protected final String TEXT_267 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_268 = " = webClient_";
  protected final String TEXT_269 = ".get";
  protected final String TEXT_270 = "Collection";
  ...
  protected final String TEXT_275 = ".post";
  protected final String TEXT_276 = "ObjectGetCollection";
  protected final String TEXT_277 = "(requestBody_";
  protected final String TEXT_278 = ", responseClass_";
  protected final String TEXT_279 = ");" + NL + "\t\t";
  protected final String TEXT_280 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_281 = " = webClient_";
  protected final String TEXT_282 = ".put(requestBody_";
  protected final String TEXT_283 = ", responseClass_";
  protected final String TEXT_284 = ");" + NL + "\t\t";
  protected final String TEXT_285 = NL + "\t\t\torg.apache.cxf.jaxrs.client.WebClient.getConfig(webClient_";
  protected final String TEXT_286 = ").getRequestContext().put(\"use.httpurlconnection.method.reflection\", true);" + NL + "\t\t\tresponseDoc_";
  protected final String TEXT_287 = " = webClient_";
  protected final String TEXT_288 = ".invoke(\"PATCH\", requestBody_";
  protected final String TEXT_289 = ", responseClass_";
  protected final String TEXT_290 = ");" + NL + "\t\t";
  protected final String TEXT_291 = NL + "\t\t\twebClient_";
  protected final String TEXT_292 = ".invoke(\"";
  protected final String TEXT_293 = "\", requestBody_";
  protected final String TEXT_294 = ");" + NL + "\t\t";
  protected final String TEXT_295 = NL + NL + NL + "\t\tint webClientResponseStatus_";
  protected final String TEXT_296 = " = webClient_";
  protected final String TEXT_297 = ".getResponse().getStatus();" + NL + "\t\tif (webClientResponseStatus_";
  protected final String TEXT_298 = " >= 300) {" + NL + "\t\t\tthrow new javax.ws.rs.WebApplicationException(webClient_";
  protected final String TEXT_299 = ".getResponse());" + NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_300 = NL + "\t\t\tif (";
  protected final String TEXT_301 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_302 = " = new ";
  protected final String TEXT_303 = "Struct();" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_304 = ".statusCode = webClientResponseStatus_";
  protected final String TEXT_305 = ";" + NL + "\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\tif (responseDoc_";
  protected final String TEXT_307 = " != null) {" + NL + "\t\t\t\tif (responseClass_";
  protected final String TEXT_308 = " == String.class) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_309 = ".string = (String) responseDoc_";
  protected final String TEXT_310 = ";" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\troutines.system.Document responseTalendDoc_";
  protected final String TEXT_311 = " = null;" + NL + "\t\t\t\t\tif (null != responseDoc_";
  protected final String TEXT_312 = ") {" + NL + "\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_313 = " = new routines.system.Document();" + NL + "\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_314 = ".setDocument((org.dom4j.Document) responseDoc_";
  protected final String TEXT_315 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_316 = ".body = responseTalendDoc_";
  protected final String TEXT_317 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_318 = NL + NL + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_319 = "_HEADERS\", webClient_";
  protected final String TEXT_320 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_322 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_323 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_324 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_325 = NL + "\t\t";
  protected final String TEXT_326 = NL + NL + "\t} catch (javax.ws.rs.WebApplicationException ex_";
  protected final String TEXT_327 = ") {" + NL + "\t\t";
  protected final String TEXT_328 = NL + "\t\t\tif (";
  protected final String TEXT_329 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_330 = " = new ";
  protected final String TEXT_331 = "Struct();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_332 = ".errorCode = ex_";
  protected final String TEXT_333 = ".getResponse().getStatus();" + NL + "" + NL + "\t\t\tString errorMessage_";
  protected final String TEXT_334 = " = null;" + NL + "\t\t\ttry {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_335 = " = ex_";
  protected final String TEXT_336 = ".getResponse().readEntity(String.class);" + NL + "\t\t\t} catch (Exception exe_";
  protected final String TEXT_337 = ") {" + NL + "\t\t\t\t// ignore" + NL + "\t\t\t}" + NL + "\t\t\tif (null == errorMessage_";
  protected final String TEXT_338 = " || 0 == errorMessage_";
  protected final String TEXT_339 = ".trim().length()) {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_340 = " = ex_";
  protected final String TEXT_341 = ".getMessage();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_342 = ".errorMessage = errorMessage_";
  protected final String TEXT_343 = ";" + NL + "" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_344 = "_HEADERS\", ex_";
  protected final String TEXT_345 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_347 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_348 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_349 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_350 = NL + "\t\t";
  protected final String TEXT_351 = NL + "\t\t\tthrow ex_";
  protected final String TEXT_352 = ";" + NL + "\t\t";
  protected final String TEXT_353 = NL + "\t}" + NL + "" + NL + "} catch(Exception e_";
  protected final String TEXT_354 = ") {" + NL + "\t";
  protected final String TEXT_355 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_356 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_357 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_358 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_359 = NL + "}" + NL;
  protected final String TEXT_360 = NL + "java.util.Collection<String> responseParts_";
  protected final String TEXT_361 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_362 = NL + "org.apache.cxf.jaxrs.ext.multipart.MultipartBody multipartBody_";
  protected final String TEXT_363 = " =responseDoc_";
  protected final String TEXT_364 = ".readEntity(org.apache.cxf.jaxrs.ext.multipart.MultipartBody.class);" + NL + "try {" + NL + "\tfor (org.apache.cxf.jaxrs.ext.multipart.Attachment att_";
  protected final String TEXT_365 = " : multipartBody_";
  protected final String TEXT_366 = ".getAllAttachments()) {" + NL + "       java.io.InputStream is_";
  protected final String TEXT_367 = " = att_";
  protected final String TEXT_368 = ".getDataHandler().getInputStream();" + NL + "       java.util.Scanner s_";
  protected final String TEXT_369 = " = new java.util.Scanner(is_";
  protected final String TEXT_370 = ").useDelimiter(\"\\\\A\");" + NL + "       responseParts_";
  protected final String TEXT_371 = ".add(s_";
  protected final String TEXT_372 = ".hasNext() ? s_";
  protected final String TEXT_373 = ".next() : \"\");" + NL + "       is_";
  protected final String TEXT_374 = ".close();" + NL + "   }" + NL + "} catch (java.io.IOException e_";
  protected final String TEXT_375 = ") {" + NL + "\t";
  protected final String TEXT_376 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_377 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_378 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_379 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_380 = NL + "}";
  protected final String TEXT_381 = NL + "for (String responsePart_";
  protected final String TEXT_382 = " : responseDoc_";
  protected final String TEXT_383 = ") {" + NL + "    responseParts_";
  protected final String TEXT_384 = ".add(responsePart_";
  protected final String TEXT_385 = ");" + NL + "}";
  protected final String TEXT_386 = NL + "for (String responsePart_";
  protected final String TEXT_387 = " : responseParts_";
  protected final String TEXT_388 = ") {" + NL + "    row1 = new row1Struct();" + NL + "    row1.string = responsePart_";
